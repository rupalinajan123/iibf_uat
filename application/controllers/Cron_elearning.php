<?php
  ...
  * Updated on: 01-07-2021
  ...
  class Cron_elearning extends CI_Controller 
  {
    ...
    {
      $vendor_name = 'KESDEE';
      $cron_date = date('Y-m-d'); //'2021-07-12'; //
    ...
    public function elearning_teamlease()
    {
    ...
    public function generate_data_for_vendors_common($vendor_name='', $cron_date='')
    {
      if($vendor_name != '' && $cron_date != '')
      {
        ...
        $cron_file_dir = $this->create_directory("uploads/elearning_".$vendor_name."/".$current_date); //create required directory
