...
class Cron_invoice_custom extends CI_Controller {
	...
	public function __construct(){
		...
		define('DL_EXAM_INVOICE_FILE_PATH','/fromweb/testscript/images/invoice/'); 		// Digital eL Invoice
