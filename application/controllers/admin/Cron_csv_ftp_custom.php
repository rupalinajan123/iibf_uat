...
class Cron_csv_ftp_custom extends CI_Controller {
	...
	public function index($current_date = "")
	{
		...
		// Custom Date For date
		//$current_date = '20180610';
		...
		// NEW FTP Account Server from Vinod - 14 JUNE 2018
		$ftp_host 		= '115.124.123.29';
		$ftp_user_name 	= 'phptesting';
		$ftp_user_pass 	= 'aI9?9sw9';
