...
class Cron_ftp_custom extends CI_Controller {
	...
	{ 
		...
		// files list
		 $file_list = array(
							...
							"dra_edited_cand_details_".$current_date.".txt",
		...
		$path_list = array(
							...
							"/fromweb/testscript/newmem/",
							"/fromweb/testscript/newmem/",
                            "/fromweb/testscript/edit/data/",
                            "/fromweb/testscript/edit/data/",
                            "/fromweb/testscript/edit/data/",
                            "/fromweb/testscript/edit/data/",
							"/fromweb/testscript/edit/data/",
                            "/fromweb/testscript/iibfdup/",
                            "/fromweb/testscript/exam/data/",
                            "/fromweb/testscript/exam/data/",
                            "/fromweb/testscript/dra/",
                            "/fromweb/testscript/dra/",
                            "/fromweb/testscript/dra/",
                            "/fromweb/testscript/dupcert/",
                            "/fromweb/testscript/renewal/",
                            "/fromweb/testscript/admitcard/",
                            "/fromweb/testscript/bankquest/",
                            "/fromweb/testscript/iibfvision/",
                            "/fromweb/testscript/finquest/",
                            "/fromweb/testscript/cpd/",
                            "/fromweb/testscript/blended/",
                            "/fromweb/testscript/drainst/",
                            "/fromweb/testscript/exam/data/",
                            "/fromweb/testscript/admitcard/",
                            "/fromweb/testscript/blendedfeedback/",
                            "/fromweb/testscript/blendedfeedback/",
                            "/fromweb/testscript/digitalelearning/",
							"/fromweb/testscript/exam/data/",
							"/fromweb/testscript/edit/data/",
							"/fromweb/testscript/exam/data/",
							"/fromweb/testscript/exam/data/",
							...
							"/fromweb/testscript/admitcard/",
							"/fromweb/testscript/admitcard/",
							"/fromweb/testscript/scribe/",
							

                            "/fromweb/testscript/newmem/images/",
                            "/fromweb/testscript/newmem/images/",
							"/fromweb/testscript/newmem/images/",
                            "/fromweb/testscript/edit/images/",
							"/fromweb/testscript/edit/images/",
                            "/fromweb/testscript/dra/images/",
                            "/fromweb/testscript/dra/images/",
                            "/fromweb/testscript/renewal/images/",
                            "/fromweb/testscript/images/scribe/",
	...
	public function sendmail($current_date = "", $msg = "")
	{
		...
		$recipient_list = array('bhagwan.sahane@esds.co.in', 'bhushan.amrutkar@esds.co.in');
