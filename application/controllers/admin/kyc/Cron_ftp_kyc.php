...
class Cron_ftp_kyc extends CI_Controller {
	...
	public function index($current_date = "")
	{
		...
		$local_server_dir_path = '/home/supp0rttest/public_html/uploads/kyc_cronfiles_pg/'.$current_date.'/';
	...
	public function sendmail($current_date = "", $msg = "")
	{
		...
		$attachment_path = './uploads/kyc_cronfiles_pg/'.$current_date.'/' . $attachment_filename;
