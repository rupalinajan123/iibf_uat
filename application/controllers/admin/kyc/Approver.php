...
class Approver extends CI_Controller
{
  ...
  public function approver_pending_member($regnumber = NULL, $srno = NULL, $totalRecCount = NULL)
  {
    ...
    if ($regnumber)
    {
      ...
      {
        $select = 'regnumber,registrationtype,email,createdon,excode,date_of_commenc_bc'; //excode added by pooja mane for Fedai 2024-08-06 
        ...
        if ($data[0]['registrationtype'] == 'O')
        {
          ...
          if ($data[0]['createdon'] >= '2022-04-01')
          {
            ...
            {
              $select = 'namesub,firstname,middlename,lastname,dateofbirth,associatedinstitute,scannedphoto,scannedsignaturephoto,idproofphoto,declaration,empidproofphoto,excode,date_of_commenc_bc,bank_bc_id_card';
              ...
              $insert_data = array(
                ...
                'mem_bank_bc_id_card' => isset($bcempidprf_checkbox) ? $bcempidprf_checkbox : '0', // Store 0 if NULL
      ...
      if (isset($_POST['btnSubmitkyc']))
      {
        ...
        $this->db->where('isactive', '1');
        $member_regtype = $this->master_model->getRecords('member_registration', '', 'registrationtype,createdon,excode,date_of_commenc_bc');
      ...
      if ($regnumber)
      {
        $select = 'regnumber,namesub,firstname,middlename,lastname,email,DATE_FORMAT(dateofbirth,"%d-%m-%Y") dateofbirth,registrationtype,associatedinstitute,scannedphoto,scannedsignaturephoto,idproofphoto,declaration,empidproofphoto,excode,date_of_commenc_bc,bank_bc_id_card,createdon';
  ...
  public function approver_allocated_member($regnumber = NULL, $srno = NULL, $totalRecCount = NULL)
  {
    ...
    if ($regnumber)
    {
      ...
      if (isset($_POST['btnSubmitRecmd']))
      {
        $select = 'regnumber,registrationtype,email,createdon,excode,date_of_commenc_bc';
        $data = $this->master_model->getRecords('member_registration', array(
          'regnumber' => $regnumber,
          'isactive' => '1',
          'kyc_status' => '0'
        ...
        if (count($check_arr) > 0)
        {
          ...
          ###-- added for bcbf emp id 2024-10-18 --###
        ...
        if ($data[0]['registrationtype'] == 'O')
        {
          ...
          if ($data[0]['createdon'] >= '2022-04-01')
          {
            // echo $data[0]['date_of_commenc_bc'];die;
            // echo $name_checkbox;
            // echo $dob_checkbox ;
            // echo $photo_checkbox;
            // echo $sign_checkbox;
            ...
            {
              // echo 'Please  unchecked atleast one checkbox!';die;
              $this->session->set_flashdata('error', 'Please uncheck atleast one checkbox!!');
            }
            ...
            {
              // echo 'Please  unchecked atleast one checkbox!!';die;// $error='Please  unchecked atleast one checkbox!!';
              $this->session->set_flashdata('error', 'Please uncheck atleast one checkbox!!');
            }
            else
            {
              // echo 'Email for Rectification sent successfully';die;
              $select = 'namesub,firstname,middlename,lastname,dateofbirth,associatedinstitute,scannedphoto,scannedsignaturephoto,idproofphoto,declaration,empidproofphoto,excode,date_of_commenc_bc,bank_bc_id_card';
              $old_user_data = $this->master_model->getRecords('member_registration', array(
                'regnumber' => $regnumber,
                'isactive' => '1'
          ...
          else
          {
            ...
            elseif ($name_checkbox == '1' && $dob_checkbox == '1' && $emp_checkbox == '1' && $photo_checkbox == '1' && $sign_checkbox == '1' && $idprf_checkbox == '1' && $declaration_checkbox == '1')
            {
              // $error='Please  unchecked atleast one checkbox!!';
              $this->session->set_flashdata('error', 'Please uncheck atleast one checkbox!! (except declaration - its optional for this user)');
            }
        ...
        else
        {
          ...
          elseif ((!in_array($data[0]['excode'], $fedai_array)) && $data[0]['date_of_commenc_bc'] =='' && $name_checkbox == '1' && $dob_checkbox == '1' && $emp_checkbox == '1' && $photo_checkbox == '1' && $sign_checkbox == '1' && $idprf_checkbox == '1')
          {
            // $error='Please  unchecked atleast one checkbox!!';
            $this->session->set_flashdata('error', 'Please  uncheck atleast one checkbox!!');
          }
          else
          {
            ...
            if ($this->Emailsending->mailsend($info_arr))
            {
              ...
              // ------- check for BCBF employment proof added by pooja mane 2024-10-18-----------#
              if (in_array('Bcbf-Employment-proof', $update_data))
              {
                $updatedata['bank_bc_id_card'] = '';
                $oldfilepath = get_img_name($regnumber, 'bank_bc_id_card');
              ...
              // ------- check for BCBF employment proof added by pooja ends 2024-10-18-----------#
      ...
      if (isset($_POST['btnSubmitkyc']))
      {
        ...
        // Kyc complet for NM fedai member 6 fileds are consider by pooja mane 2024-08-13
        if ($member_regtype[0]['registrationtype'] == 'NM' && $member_regtype[0]['date_of_commenc_bc'] != '')
        {
          if (in_array('name_checkbox', $check_arr) && in_array('dob_checkbox', $check_arr) && in_array('photo_checkbox', $check_arr) && in_array('sign_checkbox', $check_arr) && in_array('idprf_checkbox', $check_arr) && in_array('bcempidprf_checkbox', $check_arr))
          {
            // echo '********';die;
            $new_arrayid = $members = $old_user_data = array();
            $status = '0';
        ...
        // code ends Kyc complet for NM bcbf member 6 fileds are consider by pooja mane 2024-08-13
        // Kyc complet for NM fedai member 7 fileds are consider by pooja mane 2024-08-13
        elseif ($member_regtype[0]['registrationtype'] == 'NM' && $member_regtype[0]['date_of_commenc_bc'] == '' && in_array($member_regtype[0]['excode'], $fedai_array))
        {
        ...
        elseif ($member_regtype[0]['registrationtype'] == 'O')
        {
          ...
          if ($member_regtype[0]['createdon'] >= '2022-04-01')
          {
            ...
            if ($member_regtype[0]['date_of_commenc_bc'] != '' && in_array('name_checkbox', $check_arr) && in_array('dob_checkbox', $check_arr) && in_array('photo_checkbox', $check_arr) && in_array('sign_checkbox', $check_arr) && in_array('idprf_checkbox', $check_arr) && in_array('bcempidprf_checkbox', $check_arr) && in_array('declaration_checkbox', $check_arr))
            {
              // print_r($check_arr);die;
              // echo '***********';die;
              $new_arrayid = $members = array();
              ...
              #####---- added for bcbf employment 2024-10-18 ---######
              if (in_array('bcempidprf_checkbox', $check_arr))
              {
                $bcempidprf_checkbox = '1';
              }
            ...
            elseif ($member_regtype[0]['date_of_commenc_bc'] == '' && in_array('name_checkbox', $check_arr) && in_array('dob_checkbox', $check_arr) && in_array('photo_checkbox', $check_arr) && in_array('sign_checkbox', $check_arr) && in_array('idprf_checkbox', $check_arr) && in_array('declaration_checkbox', $check_arr))
            {
              // print_r($check_arr);die;
              // echo '***********';die;
              $new_arrayid = $members = array();
          ...
          {
            if($member_regtype[0]['date_of_commenc_bc'] != '' && in_array('name_checkbox', $check_arr) && in_array('dob_checkbox', $check_arr) && in_array('photo_checkbox', $check_arr) && in_array('sign_checkbox', $check_arr) && in_array('idprf_checkbox', $check_arr) && in_array('bcempidprf_checkbox', $check_arr))
            {
              $new_arrayid = $members = array();
              $status = '0';
              $state = '1';
              ...
              ### --- added for bcbf empid proof 2024-10-18 --- ###
              if (in_array('bcempidprf_checkbox', $check_arr))
              {
                $bcempidprf_checkbox = '1';
              }
            ...
            elseif ($member_regtype[0]['date_of_commenc_bc'] == '' && in_array('name_checkbox', $check_arr) && in_array('dob_checkbox', $check_arr) && in_array('photo_checkbox', $check_arr) && in_array('sign_checkbox', $check_arr) && in_array('idprf_checkbox', $check_arr))
            {
              $new_arrayid = $members = array();
              $status = '0';
              $state = '1';
      ...
      if ($regnumber)
      {
        $select = 'regnumber,namesub,firstname,middlename,lastname,email,DATE_FORMAT(dateofbirth,"%d-%m-%Y") dateofbirth,registrationtype,associatedinstitute,scannedphoto,scannedsignaturephoto,idproofphoto,declaration,empidproofphoto,excode,date_of_commenc_bc,bank_bc_id_card,registrationtype,createdon';
        $members = $this->master_model->getRecords("member_registration a", array(
          'regnumber' => $regnumber,
          'isactive' => '1'
        ), $select, "", '0', '1');
  ...
  public function recommended_list()
  {
    ...
    $r_list = $this->master_model->getRecords("member_kyc", array('recommended_by' => $this->session->userdata('kyc_id')), 'member_kyc.regnumber,kyc_id,namesub,firstname,middlename,lastname,recommended_date,registrationtype,email,record_source,member_kyc.kyc_status,mem_name,
		mem_dob,mem_sign,mem_proof,employee_proof,mem_declaration,mem_photo,mem_declaration,mem_associate_inst,member_registration.dateofbirth,member_registration.associatedinstitute,member_registration.excode,member_registration.empidproofphoto,member_registration.date_of_commenc_bc,member_registration.bank_bc_id_card', array('kyc_id' => 'DESC')); //,employee_proof,mem_declaration added by pooja mane 2024-08-13
    ...
    if ($regnumber)
    {
      ...
      if (isset($_POST['btnSubmitRecmd']))
      {
        ...
        if (count($check_arr) > 0)
        {
          ...
          ###-- added for bcbf employment id 2024-10-21 --###
          if($data[0]['date_of_commenc_bc'] != '')
          {
            if (in_array('bcempidprf_checkbox', $check_arr))
            {
        ...
        else
        {
          ...
          ###-- added for bcbf emp id 2024-10-21 --###
          $bcempidprf_checkbox = '0';
          if($data[0]['date_of_commenc_bc'] != ''){
            $msg .= 'Bcbf-Employment-proof,';
            $field_count++;
        ...
        $email = $data[0]['email'];
        $emp_checkbox = '1';//We don not want to update employer details
        if ($data[0]['registrationtype'] == 'O')
        {
          // Declaration mandatory for those users who are registered from 1 april 2022 
          // (its a date of declaration feature upload date on live)
          if ($data[0]['createdon'] >= '2022-04-01')
          {
            if ($data[0]['date_of_commenc_bc'] !='' && $name_checkbox == '1' && $dob_checkbox == '1' && $emp_checkbox == '1' && $photo_checkbox == '1' && $sign_checkbox == '1' && $idprf_checkbox == '1' &&  $bcempidprf_checkbox == '1' && $declaration_checkbox == '1')
            {
              // $error='Please  unchecked atleast one checkbox!!';
              $this->session->set_flashdata('error', 'Please uncheck atleast one checkbox!!');
            }
            ...
            else
            {
              ...
              if ($this->Emailsending->mailsend($info_arr))
              {
                ...
                // ------- check for BCBF employment proof added by pooja mane 2024-10-21-----------#
                if (in_array('Bcbf-Employment-proof', $update_data))
                {
                  $updatedata['bank_bc_id_card'] = '';
                  $oldfilepath = get_img_name($regnumber, 'bank_bc_id_card');
                ...
                // ------- check for BCBF employment proof added by pooja ends 2024-10-21-----------#
        ...
        else
        {
          ...
          elseif ($data[0]['date_of_commenc_bc'] == '' && $data[0]['registrationtype'] == 'NM' && in_array($data[0]['excode'], $fedai_array) && $name_checkbox == '1' && $dob_checkbox == '1' && $photo_checkbox == '1' && $sign_checkbox == '1' && $idprf_checkbox == '1' && $empidprf_checkbox == '1' && $declaration_checkbox == '1')
          { //echo 'Please  uncheck atleast one checkbox';die;
            $this->session->set_flashdata('error', 'Please  uncheck atleast one checkbox!!');
          }
          elseif(($data[0]['date_of_commenc_bc'] == '' && !in_array($data[0]['excode'], $fedai_array)) && $name_checkbox == '1' && $dob_checkbox == '1' && $emp_checkbox == '1' && $photo_checkbox == '1' && $sign_checkbox == '1' && $idprf_checkbox == '1')
          {
            // $error='Please  unchecked atleast one checkbox!!';
            $this->session->set_flashdata('error', 'Please  uncheck atleast one checkbox!');
          }
      ...
      if (isset($_POST['btnSubmitkyc']))
      {
        ...
        }elseif ($member_regtype[0]['registrationtype'] == 'NM' && in_array($member_regtype[0]['excode'], $fedai_array))
        {
          if (in_array('name_checkbox', $check_arr) && in_array('dob_checkbox', $check_arr) && in_array('photo_checkbox', $check_arr) && in_array('sign_checkbox', $check_arr) && in_array('idprf_checkbox', $check_arr) && in_array('empidprf_checkbox', $check_arr) && in_array('declaration_checkbox', $check_arr))
          {
            // echo '********';die;
          ...
          else
          {
            ...
            echo  $error = 'Select all check box to complete the Kyc !!';
            die;
        ...
        elseif ($member_regtype[0]['registrationtype'] == 'O')
        {
          // Declaration mandatory for those users who are registered from 1 april 2022 
          // (its a date of declaration feature upload date on live)
          // echo $member_regtype[0]['createdon'];die;
          if ($member_regtype[0]['createdon'] >= '2022-04-01')
          {
            // echo $member_regtype[0]['date_of_commenc_bc'];die;
            if ($member_regtype[0]['date_of_commenc_bc'] != '' && in_array('name_checkbox', $check_arr) && in_array('dob_checkbox', $check_arr) && in_array('photo_checkbox', $check_arr) && in_array('sign_checkbox', $check_arr) && in_array('idprf_checkbox', $check_arr) && in_array('bcempidprf_checkbox', $check_arr) && in_array('declaration_checkbox', $check_arr))
            {
              $new_arrayid = $members = array();
              $status = '0';
  ...
  public function completed_details($regnumber = NULL)
  {
    ...
    if ($regnumber)
    {
      /*
			...
			*/
      $select = 'regnumber,namesub,firstname,middlename,lastname,email,DATE_FORMAT(dateofbirth,"%d-%m-%Y") dateofbirth,registrationtype,associatedinstitute,scannedphoto,scannedsignaturephoto,idproofphoto,declaration,empidproofphoto,excode,date_of_commenc_bc,bank_bc_id_card,registrationtype';
  ...
  public function edited_member($regnumber)
  {
    ...
    if ($regnumber)
    {
      $select = 'regnumber,namesub,firstname,middlename,lastname,email,DATE_FORMAT(dateofbirth,"%d-%m-%Y") dateofbirth,registrationtype,associatedinstitute,scannedphoto,scannedsignaturephoto,idproofphoto,empidproofphoto,bank_bc_id_card,date_of_commenc_bc,registrationtype';
  ...
  function benchmark_approver_edited_member($regnumber = NULL, $srno = NULL, $totalRecCount = NULL)
  {
    if ($regnumber)
    {
      ...
      if ($regnumber)
      {
        $select = 'regnumber,namesub,firstname,middlename,lastname,email,DATE_FORMAT(dateofbirth,"%d-%m-%Y") dateofbirth,registrationtype,associatedinstitute,scannedphoto,,vis_imp_cert_img,orth_han_cert_img,cer_palsy_cert_img,scannedsignaturephoto,idproofphoto,empidproofphoto,bank_bc_id_card,date_of_commenc_bc,registrationtype';
        $members = $this->master_model->getRecords("member_registration a", array(
          'regnumber' => $regnumber,
          'isactive' => '1'
        ), $select, "", '0', '1');
  ...
  /*START: Added send mail function to send custom mails pooja mane - 30-01-2025*/
  public function send_mail()
  {
    ...
    if ($this->Emailsending->mailsend_attch($info_arr, ''))
    {
      ...
      $titlt = "Mail Send to Member by Approver";
      $logs = array(
        'title' => $titlt,
