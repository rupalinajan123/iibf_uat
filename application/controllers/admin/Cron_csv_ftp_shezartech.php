<?php
/*
 * Controller Name	:	Cron File Transfer : Shezartech Vendor
 * Created By		:	Bhushan
 * Created Date		:	08 April 2019
 *
*/
defined('BASEPATH') OR exit('No direct script access allowed');
class Cron_csv_ftp_shezartech extends CI_Controller {
	...
	public function index($current_date = "")
	{
        ...
        $array = $this->master_model->getRecords('cron_csv_shezartech','','new_file_name,record_count');
		...
		$local_server_dir_path = '/home/supp0rttest/public_html/uploads/cronCSV_shezartech/'.$current_date.'/';
	...
	public function sendmail($current_date = "", $msg = "")
	{
		...
		$subject = 'Member Exam Applications CSV File Transfer To Shezartech Vendor';
		...
		$attachment_path = './uploads/cronCSV_shezartech/'.$current_date.'/' . $attachment_filename;
