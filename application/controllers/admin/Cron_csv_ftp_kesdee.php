...
class Cron_csv_ftp_kesdee extends CI_Controller {
	...
	public function index($current_date = "")
	{
        ...
        $array = $this->master_model->getRecords('cron_csv_kesdee','','new_file_name,record_count');
		...
		$local_server_dir_path = '/home/supp0rttest/public_html/uploads/cronCSV_kesdee/'.$current_date.'/';
	...
	public function sendmail($current_date = "", $msg = "")
	{
		...
		$subject = 'Member Exam Applications CSV File Transfer To KESDEE Vendor';
	
		$recipient_list = 
array('kalpanashetty@iibf.org.in','priti@iibf.org.in','dd.aca4@iibf.org.in','elearning@iibf.org.in','smuralidaran@iibf.org.in','iibfdevp@esds.co.in','manoj@kesdee.com','venuk@kesdee.com','info@kesdee.com','dd.aca2@iibf.org.in','Je.aca7@iibf.org.in');
		
		//$recipient_list = array('bhushan.amrutkar@esds.co.in');
		
		$attachment_filename = 'logs_'.$current_date.'.txt';
		$attachment_path = './uploads/cronCSV_kesdee/'.$current_date.'/' . $attachment_filename;
	...
	public function kesdee_jaiib($current_date = "")
	{
		$start_time = date("Y-m-d H:i:s");
		$success = array();
		$error = array();
		...
		$CurrentDate = date('Y-m-d',strtotime($current_date));
		$this->db->where('CurrentDate', $CurrentDate);
        $array = $this->master_model->getRecords('cron_csv_JAIIB','','new_file_name,record_count');
		$new_file_name = $array[0]['new_file_name'];
		$record_count = $array[0]['record_count'];
		...
		$local_server_dir_path = '/home/supp0rttest/public_html/uploads/jaiib_kesdee/'.$current_date.'/';
		...
		// send email notification -
		$result = $this->sendmail_kesdee_jaiib($current_date, $msg);
	}
	
	public function sendmail_kesdee_jaiib($current_date = "", $msg = "")
	{
		if($current_date == "")
		{
			$current_date = date("Ymd");	
		...
		//$from_email = 'noreply@iibf.org.in';
		$from_email = 'logs@iibf.esdsconnect.com';
		$subject = 'JAIIB: Member Exam Applications CSV File Transfer To KESDEE Vendor';
...
array('kalpanashetty@iibf.org.in','priti@iibf.org.in','dd.aca4@iibf.org.in','elearning@iibf.org.in','smuralidaran@iibf.org.in','iibfdevp@esds.co.in','manoj@kesdee.com','venuk@kesdee.com','info@kesdee.com','dd.aca2@iibf.org.in','je.aca7@iibf.org.in'); 
		...
		$attachment_filename = 'logs_'.$current_date.'.txt';
		$attachment_path = './uploads/jaiib_kesdee/'.$current_date.'/' . $attachment_filename;
