<?php
/*
 	* Controller Name	:	Bulk Cron "FTP" File Generation
 	* Created By		:	Bhushan
 	* Created Date		:	23-08-2019
*/
defined('BASEPATH') OR exit('No direct script access allowed');
class Cron_ftp_bulk extends CI_Controller {
	...
	public function index($current_date = "")
	{
		...
		// files list
		$file_list = array(
							"iibf_bulk_mem_details_".$current_date.".txt",
							"bulk_".$current_date.".csv",
							
							"bulk_regd_image_".$current_date.".zip",
					);
		...
		$local_server_dir_path = '/home/supp0rttest/public_html/uploads/bulk_data/'.$current_date.'/';
		...
		// mail details -
		$msg = '';
		$msg .= 'Bulk Photo, Sign And CSV Sync to IIBF FTP completed for the following files: <br><br>';
	...
	public function sendmail($current_date = "", $msg = "")
	{
		...
		$subject = 'Bulk Photo, Sign And CSV Sync to IIBF FTP completed';
		
		// email receipient list -
		$recipient_list = array('dattatreya@iibf.org.in', 'sgbhatia@iibf.org.in','sajan@iibf.org.in','spnair@iibf.org.in','iibfdevp@esds.co.in','dspandit@iibf.org.in');
		
		//$recipient_list = array('iibfdevp@esds.co.in');
		
		$attachment_filename = 'logs_'.$current_date.'.txt';
		$attachment_path = './uploads/bulk_data/'.$current_date.'/' . $attachment_filename;
