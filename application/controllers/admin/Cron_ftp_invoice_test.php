...
class Cron_ftp_invoice_test extends CI_Controller {
	...
	public function index($current_date = "")
	{
		...
		$file_list = array(
							...
							"amp_exam_invoice_image_20220221.zip"
							
					);
					
		// file wise remote server path -
		$path_list = array(
							"/fromweb/testscript/invoice/data/",
							"/fromweb/testscript/invoice/data/",
							"/fromweb/testscript/invoice/data/",
							"/fromweb/testscript/invoice/data/",
							"/fromweb/testscript/invoice/data/",
							...
							"/fromweb/testscript/invoice/images/",
							"/fromweb/testscript/invoice/images/",
							"/fromweb/testscript/invoice/images/",
							"/fromweb/testscript/invoice/images/",
							"/fromweb/testscript/invoice/images/",
	...
	public function sendmail($current_date = "", $msg = "")
	{
		...
		/*$success = array("Successfully file transfer : iibf_new_mem_details_20170216.txt (size : 3153).","Successfully file transfer : edited_cand_details_20170216.txt (size : 226).","Successfully file transfer : edited_cand_details_photo_20170216.txt (size : 0).","Successfully file transfer : edited_cand_details_sign_20170216.txt (size : 0).","Successfully file transfer : edited_cand_details_id_20170216.txt (size : 0).","Successfully file transfer : iibf_dup_icard_details_20170216.txt (size : 0).","Successfully file transfer : exam_cand_report_20170216.txt (size : 0).","Successfully file transfer : dra_mem_details_20170216.txt (size : 0).","Successfully file transfer : dra_exam_cand_report_20170216.txt (size : 0).","Successfully file transfer : regd_image_20170216.zip (size : 57696).");
		
		$error = array("File not exist : edited_image_20170216.zip.","File not exist : dra_regd_image_20170216.zip.");
		
		$start_time = '2017-02-16 10:00:01';
		$end_time = '2017-02-16 10:00:01';
		...
		//$recipient_list = array('bhagwan.sahane@esds.co.in', 'prafull.tupe@esds.co.in', 'pawansing.pardeshi@esds.co.in', 'pooja.godse@esds.co.in', 'bhushan.amrutkar@esds.co.in', 'ronit.powar@esds.co.in', 'anilr@esds.co.in', 'dattatreya@iibf.org.in', 'anishrivastava@iibf.org.in', 'sgbhatia@iibf.org.in');
		
		$recipient_list = array('bhagwan.sahane@esds.co.in', 'prafull.tupe@esds.co.in', 'pawansing.pardeshi@esds.co.in', 'pooja.godse@esds.co.in', 'bhushan.amrutkar@esds.co.in', 'tejasvi.bhavsar@esds.co.in', 'ronit.powar@esds.co.in', 'anilr@esds.co.in');
		
		$attachment_filename = 'logs_'.$current_date.'.txt';
		$attachment_path = './uploads/invoice_cronfiles/'.$current_date.'/' . $attachment_filename;
