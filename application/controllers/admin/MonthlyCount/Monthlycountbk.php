...
class Monthlycountbk extends CI_Controller
{
    ...
    public function index(){
		...
		//$this->load->view('admin/MonthlycountbkDashboard/module_list');
    }
	...
	public function date_count()
	{
		...
		$this->load->view('admin/MonthlycountDashboard/count_listbk',$output);
	}
