...
class Transaction_hit extends CI_Controller {
	public $UserID;
	...
	public function getTransactions()
	{
		...
		if($res)
		{
			...
			foreach($result as $row)
			{
				...
				// action -
				$action = '<a href="'.base_url().'bulk/admin/transaction_hit/view_inst_receipt/'.base64_encode($row['id']).'" target="_blank">Receipt</a>';
				...
				{
					$action .= ' <br> | <a href="'.base_url().'bulk/admin/transaction_hit/mem_admit_card_list/'.base64_encode($row['id']).'" target="_blank">Admit Card</a>';
				}
			...
			$url = base_url()."bulk/admin/transaction_hit/getTransactions/";
	...
	public function getNeftTransactions()
	{
		...
		if($res)
		{
			...
			$url = base_url()."bulk/admin/transaction_hit/getNeftTransactions/";
