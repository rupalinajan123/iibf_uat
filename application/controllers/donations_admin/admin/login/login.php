...
<html>
    <head>
        ...
        <title>Career - Admin Login</title>
            ...
            <div class="login-box-body">
                ...
                <form action="" method="post" name="loginFrm" id="loginFrm">
                    <div class="form-group has-feedback">
                    	<label for="roleid" class="">Username</label>
                    ...
                    <div class="form-group has-feedback">
                    <label for="roleid" class="">Password</label>
                    ...
                    <div class="row">
                    	<label class="col-md-6"><?php echo $captchaImg; ?></label>
                    	<div class="form-group has-feedback col-md-6">
                    		<input type="text" class="form-control" name="code"  placeholder="Enter Captcha " autocomplete="off"  style="padding-right:10px !important" required>
                    	</div>
                    </div>
                    <div class="row">
                    	<!-- /.col -->
