...
class Dbfuser extends CI_Controller {
	...
	{
		if( $this->get_ip() != '115.124.115.75' &&  $this->get_ip() != '115.124.115.69' &&  $this->get_ip() != '182.73.101.70' &&  $this->get_ip() != '192.168.11.253' ) 
		{	 
		 ...
		 if(isset($_POST['btnSubmit']))  	
		 {
			...
			//	$this->form_validation->set_rules('nameoncard','Name as to appear on Card','trim|max_length[35]|required|alpha_numeric_spaces|xss_clean');
				...
				if($this->form_validation->run()==TRUE)
				{
					...
					$scannedphoto_file = 'ID_proof.jpg'; $idproof_file = 'ID_proof.jpg'; $scannedsignaturephoto_file = 'ID_proof.jpg';
