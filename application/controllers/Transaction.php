...
class Transaction extends CI_Controller {
	...
	public function index()
	{
		...
		$transData1 = array();
		$transData1 = $this->master_model->getRecords('payment_transaction',array('member_regnumber'=>$this->session->userdata('regnumber'),'status'=>'1'),'',array('payment_transaction.id'=>'DESC'));
		...
		$data['middle_content']= 'transaction_history';
		
		//echo $this->db->last_query();exit;
		//echo "<pre>";print_r($transData);
		//$data=array('middle_content'=>'transaction_history','transData'=>$transData);
