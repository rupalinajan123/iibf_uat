...
class Cron1_gst extends CI_Controller {
...

	{
		...
		//if (flock($filehandle, LOCK_EX | LOCK_NB)) {
			...
			$query='SELECT receipt_no FROM payment_transaction WHERE receipt_no = "902837347" AND gateway = "sbiepay" AND status = 2 LIMIT 1';
			...
			$this->Emailsending->mailsend_attch($info_arr,$attachpath);
					  ...
					  if (!empty($applicationNo)) {
									...
									{ 
...

										{
...

											{
												...
												echo "<br/>gst_recovery_details_pk=>".$gst_recovery_details_pk;

												echo $invoiceNumber = generate_gst_recovery_invoice_number($gst_recovery_details_pk);
						...
						else if($responsedata[6] == "iibfcc") ## iibfcc code added on 16 Mar 2021
