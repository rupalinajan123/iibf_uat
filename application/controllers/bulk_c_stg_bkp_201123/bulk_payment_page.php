                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td width="55%">
																	...
																	{
																		if($row['app_category']=='B1_1' && $row['member_type']=='NM')
																		{
																		
																			echo 'Fresher Non member(NM)' ;
																		}elseif($row['app_category']=='B1_1' && $row['member_type']=='O')
																		{
																		...
																		elseif($row['member_type']=='NM')
																		{
																		echo 'Repeater Non member(NM) -Subsequent attempts' ;
																		}elseif($row['member_type']=='O')
																		{
																			echo 'Repeater Ordinary(O) member -Subsequent attempts' ;
																		}
																	}
																		?>
                                                                </td>
                                                            ...
                                                            <?php }}?>
                                                               ...
                                                               <tr>
                                                                    ...
                                                                    <td width="55%" style="text-align:right; font-weight:bold;">
                                                                        <?php
																				echo 'Total';	?>
                                                                    </td>
                                                                    <td width="10%">
                                                                    ...
                                                                    <td width="10%">
                                                                  <?php 	echo  $no_unit_base;?>
                                                                     </td>
                                                                    <td width="15%">
                                                                        <?php 	echo $base_amt_total;?>
                                                                    </td>
	  														   </tr>
                                                                <tr>
                                                                    ...
                                                                    <td width="10%">
                                                                        <?php if(isset($discount_rate))
																	{	echo  intval($discount_rate[0]['discount']). '%';
																	}	?>
                                                                    </td>
                                                                    <td width="10%">
                                                                     </td>
                                                                    <td width="15%">
                                                                        <?php 	echo $base_amt_after_dsct;?>
                                                                    </td>
	  														   </tr>
                                                                <tr>
													            <td width="10%">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="15%">
                                                                        ...
                                                                        <input type="text" id="txtPassportNumber" placeholder="     Enter TDS "  class="form-control" onkeyup="tds()"  />
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="15%">
                                                                     ...
                                                                     <input type='hidden' name='amount_after_gst' id='amount_after_gst' value="<?php echo $amount_after_gst;?>" />
