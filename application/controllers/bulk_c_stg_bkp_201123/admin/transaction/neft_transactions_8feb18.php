          ...
          <form id="loginForm" method="post" class="form-horizontal">
            <div class="modal-body" id="confirmMessage"> 
              ...
              <div class="form-group">
                ...
                <div class="col-xs-6">
                  <input type="text" class="form-control" name="form_mem_count" id="form_mem_count" />
                </div>
              </div>
              <div class="form-group">
                <label class="col-xs-4 control-label">Amount *</label>
                <div class="col-xs-6">
                  <input type="text" class="form-control" name="form_payment_amt" id="form_payment_amt" />
                </div>
              </div>
              <div class="form-group">
...
{
	 var a = confirm("Do you want to check capacity");
	 if(a == true){
		...
		$.ajax({
			...
			type: 'POST',
			dataType:"json",
			data: {id: txn_id, action: action, utr_no: utr_no, mem_count: mem_count, payment_amt: payment_amt, payment_date: payment_date,chk_cap: chk_cap},
			success: function(res) {
				if(res)
				{
					if(res.success == 'success')
