        ...
        <div class="row">
            <div class="col-md-12">
			 ...
			 ?>
                    ...
                    <div class="box-body">
                        <form class="form-horizontal" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>bulk/BulkApplyNM/add_member/">
				   ...
				   print_r($mem_info); ?>
                        ...
                        <form class="form-horizontal" name="nonmemAddForm" id="nonmemAddForm" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>bulk/BulkApplyNM/comApplication_reg/">
                ...
                <?php //echo form_error('dob');?>
                  ...
                  <?php //echo form_error('mobile');?>
                                        ...
                                        <?php if($this->session->userdata('examcode')==101 && $this->session->userdata('examcode')==1010)
				{?>
                                            <div class="form-group">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <p style="color:#F00"> <strong>VERY IMPORTANT</strong>
                                                    ...
                                                    <br /> In case, if you do not have Aadhaar number, request you to obtain it on or before 31st march 2018 . and update the Aadhaar number in your membership profile. </p>
                                            </div>
