...
<table width="980px" border="0" cellspacing="0" cellpadding="0" class="bordeTable" align="center">
  ...
  <tr>
    <td colspan="2"><p class="invoiceInfo">Tax Invoice cum receipt</p>
</td>
  </tr>
  <tr>
    <td colspan="2">&nbsp;</td>
  ...
  <tr>
    <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td style="border-bottom: none;"><p>-</p></td>
        <td style=" border-bottom: none;"><p>-</p></td>
      ...
      <tr>
        <td colspan="3" style=" border-bottom: none; border-left: none; border-right: none;"><p style="text-decoration:underline;"><strong>Amout in Words: <?php echo $wmt;?> only. </strong></p>
          <p>&nbsp;</p>
