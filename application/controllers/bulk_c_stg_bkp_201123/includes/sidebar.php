...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview <?php if(stristr(current_url(),'bulk/BulkApply/examlist') || stristr(current_url(),'bulk/BulkApply/examdetails') || stristr(current_url(),'bulk/BulkApply/exam_applicantlst') || stristr(current_url(),'bulk/BulkApplyNM/add_member')) { echo 'active'; } ?>"> <a href="<?php echo base_url();?>bulk/BulkApply/examlist"><i class="fa fa-tasks"></i> Apply For Exam </a> </li>
