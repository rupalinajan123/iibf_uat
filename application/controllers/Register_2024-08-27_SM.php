    ...
    public function member()
    {
        ...
        if (isset($_POST['btnSubmit'])) 
        {
            ...
            if ($this->form_validation->run() == true) {
                ...
                $scannedphoto_file    = $scannedsignaturephoto_file    = $idproof_file    = $outputphoto1    = $outputsign1    = $outputsign1    = $declaration_file    = '';
                ...
                if($middlename_post != "") { $ins_nameoncard .= ' '.$middlename_post; }
                if($lastname_post != "") { $ins_nameoncard .= ' '.$lastname_post; }
...
echo $applicationId = $timeStr.'-'.$last_count;
    ...
    {
        // echo'****'; die; 
        /*if($this->get_client_ip() !='115.124.115.69' && $this->get_client_ip() !='182.73.101.70'){
        ...
        $examcodes = array('528', '529', '530', '531', '534', '991', '997', '1031', '1032'); // Exam code 1031 for SBI New Exam & 1032 for AML/KYC and Risk Management  
