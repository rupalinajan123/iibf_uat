...
class Croncc_custom extends CI_Controller 
{
	...
	{ 
		...
		{ */
			...
			$aes->require_pkcs5(); 
			      echo $query='SELECT receipt_no FROM payment_transaction WHERE receipt_no IN(903815600,903815621,903815624,903816951,903815643) AND gateway = "billdesk" AND status = 2 AND pay_type="11"';        
