...
defined('BASEPATH') OR exit('No direct script access allowed');
	...
	class SplexamM123 extends CI_Controller {
   ...
   public function acknowledge()
   {
	...
	public function preview()
	{
		...
		//{		
			...
			{
				$data=array('middle_content'=>'specialexams/exam_preview','user_info'=>$user_info,'medium'=>$medium,'center'=>$center,'misc'=>$misc,'states'=>$states,'compulsory_subjects'=>$this->session->userdata['examinfo']['subject_arr']);
			}
			$this->load->view('common_view',$data);
		/*}
		else
