<?php
	...
	class Cron1_billdesk extends CI_Controller 
	{
        ...
        //START : PAYMENT TRANSACTION QUERY
				...
				//$query='SELECT receipt_no, pg_flag FROM payment_transaction WHERE id IN (00)'; //6920199,6920198,6920197,6920196,6920195
        ...
        //$query_bcbf = 'SELECT receipt_no, pg_flag FROM iibfbcbf_payment_transaction WHERE id IN (176,175)';//179,178,177,176,175
