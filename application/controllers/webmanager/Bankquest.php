  	...
  	{ 		
		...
		public function index()
		{
			...
			if(isset($_POST['submit']))
			{
				...
				if($from_date != "") { $this->db->where('created_on >=', $from_date." 00:00:00"); }
				if($to_date != "") { $this->db->where('created_on <=', $to_date." 23:59:59"); }
				$count = $this->master_model->getRecordCount('bank_vision');				
			}
			
			$data['count'] = $count;
			$data['from_date'] = $from_date;
			$data['to_date'] = $to_date;
			$this->load->view('webmanager/bankquest',$data);
		}
	}		