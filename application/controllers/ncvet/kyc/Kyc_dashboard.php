<?php 
    ...
    public function index()
		{   
			...
			$data['sub_act_id'] = "";
      $data['page_title'] = 'NCVET - KYC Dashboard';
      ...
      $this->load->view('ncvet/kyc/kyc_dashboard', $data);
    }
    ...
    public function dashboard_counts($kyc_status_list='',$kyc_type=''){
      ...
      $this->db->where("nc.kyc_eligible_date != '' AND nc.kyc_eligible_date IS NOT NULL AND nc.kyc_eligible_date != '0000-00-00 00:00:00' AND nc.benchmark_disability = 'N'");
    ...
    function change_password()
      ...
      $data['form_data'] = $form_data = $this->master_model->getRecords('ncvet_kyc_admin', array('kyc_admin_id' => $this->login_admin_id, 'kyc_admin_type' => $this->login_user_type), 'kyc_admin_id, is_active, is_deleted');
          ...
          redirect(site_url('ncvet/kyc/kyc_dashboard/change_password'));
				}
			}
