<?php 
  ...
  ********************************************************************************************************************/
	...
	class Benchmark_kyc_all extends CI_Controller 
	{
      ...
      $this->ncvet_disability_path = 'uploads/ncvet/disability';
    ...
    function get_common_data($module_name='')
    {
      ...
      { 
        ...
        $disability_path = $this->ncvet_disability_path;
      }
      ...
      $result['disability_path'] = $disability_path;
      return $result;
    ...
    public function index($module_name='')
      ...
      if(count($kyc_inprogress_candidate_data) > 0)
      {
        ...
        redirect(site_url('ncvet/kyc/benchmark_kyc_all/kyc_start/'.$module_name.'/'.$kyc_inprogress_candidate_data[0]['registration_type'].'/'.$member_type.'/'.$kyc_inprogress_candidate_data[0]['exam_code']));
      ...
      if(isset($_POST) && count($_POST) > 0 && isset($_POST['form_type']) && $_POST['form_type'] == 'search_form')
        ...
        if($_POST['s_membership_type'] == 'NM')
        {
          ...
          redirect(site_url('ncvet/kyc/benchmark_kyc_all/kyc_start/'.$module_name.'/'.$membership_type.'/'.$member_type.'/'.$exam_code));
				}
			}
      ...
      $this->load->view('ncvet/kyc/benchmark_kyc_all', $data);
    } 
      ...
      if(isset($_POST) && COUNT($_POST) > 0)
      {
        ...
        { 
          ...
          else
          {
            ...
            redirect(site_url('ncvet/kyc/benchmark_kyc_all/kyc_start/'.$_POST['module_name'].'/'.$_POST['membership_type'].'/'.$_POST['member_type'].'/'.$_POST['exam_code']));
          }
        }
        else
        {
    ...
    {    
      ...
      $this->load->view('ncvet/kyc/benchmark_kyc_candidate_list', $data);
    }
    /*List All New Candidate (Enrolled Candidates) KYC */
    ...
    function get_new_common_candidate_data_for_kyc_ajax($kyc_status_list='',$page_url='')
    {
      ...
      $WhereForTotal = "WHERE nc.kyc_eligible_date != '' AND nc.kyc_eligible_date IS NOT NULL AND nc.kyc_eligible_date != '0000-00-00 00:00:00' AND nc.is_deleted = 0 AND nc.regnumber != '' AND nc.benchmark_disability = 'Y' "; //DEFAULT WHERE CONDITION FOR ALL RECORDS 
      $Where = "WHERE nc.kyc_eligible_date != '' AND nc.kyc_eligible_date IS NOT NULL AND nc.kyc_eligible_date != '0000-00-00 00:00:00' AND nc.is_deleted = 0 AND nc.regnumber != '' AND nc.benchmark_disability = 'Y' ";      
      ...
      foreach ($Rows as $Res) 
      {
        ...
        if($kyc_status_list == "recommend"){
          $btn_str .= ' <a href="' . site_url('ncvet/kyc/benchmark_kyc_all/candidate_details/'.url_encode($Res['candidate_id']).'/NM/new/'.$page_url).'" class="btn btn-success btn-xs" title="View for KYC"><i class="fa fa-eye" aria-hidden="true"></i></a> ';
        }
        else
        {
          //$Where .= " AND nc.recommender_id = '0' AND (nc.kyc_recommender_status IS NULL OR nc.kyc_recommender_status = '' OR nc.kyc_recommender_status = '0') AND nc.approver_id = '0' AND nc.kyc_status IN(0,2) "; 
          ...
          if( $this->login_user_type == '1' && ($kyc_status_list == "enrolled" || $kyc_status_list == "pending") && $Res['recommender_id'] == "0" && $Res['approver_id'] == "0" && $Res['kyc_status'] == "0" && (empty($Res['kyc_recommender_status']) || $Res['kyc_recommender_status'] == '' || $Res['kyc_recommender_status'] == '0') && (empty($Res['img_ediited_on']) || $Res['img_ediited_on'] == '' || $Res['img_ediited_on'] == '0000-00-00 00:00:00') ){
            $btn_str .= ' <a href="' . site_url('ncvet/kyc/benchmark_kyc_all/update_as_recommend/'.url_encode($Res['candidate_id']).'/NM/new').'" class="btn btn-success" title="DO KYC">DO KYC</a> ';
    ...
    function get_common_candidate_data_for_kyc_ajax($kyc_status_list='',$page_url='')
    {
      ...
      $WhereForTotal = "WHERE nc.kyc_eligible_date != '' AND nc.kyc_eligible_date IS NOT NULL AND nc.kyc_eligible_date != '0000-00-00 00:00:00' AND nc.is_deleted = 0 AND nc.benchmark_disability = 'Y' "; //DEFAULT WHERE CONDITION FOR ALL RECORDS 
      $Where = "WHERE nc.kyc_eligible_date != '' AND nc.kyc_eligible_date IS NOT NULL AND nc.kyc_eligible_date != '0000-00-00 00:00:00' AND nc.is_deleted = 0 AND nc.benchmark_disability = 'Y' ";      
      ...
      foreach ($Rows as $Res) 
      {
        ...
        $btn_str .= ' <a href="' . site_url('ncvet/kyc/benchmark_kyc_all/view_kyc_details/'.url_encode($Res['candidate_id']).'/'.$page_url).'" class="btn btn-success btn-xs" title="View KYC Status"><i class="fa fa-eye" aria-hidden="true"></i></a> ';
    ...
    function get_edit_common_candidate_data_for_kyc_ajax($kyc_status_list='',$page_url='')
    {
      ...
      foreach ($Rows as $Res) 
      {
        ...
        if($kyc_status_list == "editrecommend"){
          $btn_str .= ' <a href="' . site_url('ncvet/kyc/benchmark_kyc_all/candidate_details/'.url_encode($Res['candidate_id']).'/NM/edited/'.$page_url).'" class="btn btn-success btn-xs" title="View for KYC"><i class="fa fa-eye" aria-hidden="true"></i></a> ';
        }
        else
        {
          $btn_str .= ' <a href="' . site_url('ncvet/kyc/benchmark_kyc_all/update_as_recommend/'.url_encode($Res['candidate_id']).'/NM/edited').'" class="btn btn-success" title="DO KYC">DO RE-KYC</a> ';
        } 
    ...
    public function candidate_details($enc_candidate_id='', $membership_type='', $member_type='', $page_url='')
    {
      ...
      $disp_title = 'KYC';
      $form_membership_type_arr = $form_member_type_arr = $form_exam_codes_arr = array();
      $photo_path = $sign_path = $id_proof_path = $declaration_path = $institute_idproof_path = $qualification_certificate_path = $exp_certificate_path = $aadhar_file_path = $disability_path = '';
      ...
      { 
        ...
        $disability_path = $common_data['disability_path'];
      }
      else
      {
        //echo "==".$module_name;die;
      ...
      if(count($kyc_pending_candidate_data) > 0 && count($kyc_inprogress_candidate_data) == 0)
      {
        ...
        if($update_qry_res)
        {
          $session_msg = $this->session->flashdata('success');
          $this->session->set_flashdata('success',$session_msg);
          redirect(site_url('ncvet/kyc/benchmark_kyc_all/candidate_details/'.url_encode($kyc_pending_candidate_data[0]['candidate_id']).'/'.$membership_type.'/'.$member_type.'/'.$exam_code));
        }
      }
      else if(count($kyc_pending_candidate_data) == 0 && count($kyc_inprogress_candidate_data) == 0)
      {
      ...
      $data['disability_path'] = $disability_path;
      $this->load->view('ncvet/kyc/benchmark_candidate_details', $data);
    }
    ...
    function process_kyc_details()
    {
      ...
      if(isset($_POST) && COUNT($_POST) > 0)
      {
        ...
        { 
          ...
          $fullname_kyc = $dob_kyc = $aadhar_kyc = $apaar_kyc = $eligibility_kyc = $photo_file_kyc = $sign_file_kyc = $id_proof_file_kyc = $declaration_file_kyc = $institute_idproof_file_kyc = $qualification_certificate_file_kyc = $exp_certificate_file_kyc = $aadhar_file_kyc = $vis_imp_cert_img_file_kyc = $orth_han_cert_img_file_kyc = $cer_palsy_cert_img_file_kyc = $declaration_show_hide = $institute_idproof_show_hide = $qualification_certificate_file_show_hide = $exp_certificate_show_hide = $vis_imp_cert_img_show_hide = $orth_han_cert_img_show_hide = $cer_palsy_cert_img_show_hide = '';
          ...
          if(isset($_POST['vis_imp_cert_img_file_kyc'])) { $vis_imp_cert_img_file_kyc = $this->input->post('vis_imp_cert_img_file_kyc'); }
          if(isset($_POST['orth_han_cert_img_file_kyc'])) { $orth_han_cert_img_file_kyc = $this->input->post('orth_han_cert_img_file_kyc'); }
          if(isset($_POST['cer_palsy_cert_img_file_kyc'])) { $cer_palsy_cert_img_file_kyc = $this->input->post('cer_palsy_cert_img_file_kyc'); }
          ...
          if(isset($_POST['vis_imp_cert_img_show_hide'])) { $vis_imp_cert_img_show_hide = $this->input->post('vis_imp_cert_img_show_hide'); }
          if(isset($_POST['orth_han_cert_img_show_hide'])) { $orth_han_cert_img_show_hide = $this->input->post('orth_han_cert_img_show_hide'); }
          if(isset($_POST['cer_palsy_cert_img_show_hide'])) { $cer_palsy_cert_img_show_hide = $this->input->post('cer_palsy_cert_img_show_hide'); }
          ...
          // Start Benchmark KYC Document  
          if($vis_imp_cert_img_file_kyc != '' && $vis_imp_cert_img_show_hide == "" && $candidate_data[0]['benchmark_disability'] == "Y" && $candidate_data[0]['visually_impaired'] == "Y")
          { 
              $up_candidiate['kyc_vis_imp_cert_flag'] = $vis_imp_cert_img_file_kyc; 
              if($vis_imp_cert_img_file_kyc == 'N') //IF Visually impaired REJECT IN KYC, THEN UPDATE THE TABLE COLUMN & RENAME THE Visually impaired
              { 
                $approve_reject_flag = 'N'; 
                $up_candidiate['vis_imp_cert_img'] = '';  
                rename($disability_path.'/'.$candidate_data[0]['vis_imp_cert_img'], $disability_path.'/k_'.$candidate_data[0]['vis_imp_cert_img']);

                $log_message .= ($log_message != '' ? ' & ' : '').'Rejected the Visually impaired Certificate';
                $kyc_action .= ($kyc_action != '' ? ' & ' : '').'Visually impaired Certificate'; 
              }
              else if($vis_imp_cert_img_file_kyc == 'Y')
              {
                if(($this->login_user_type == '1' && $candidate_data[0]['kyc_vis_imp_cert_flag'] != $vis_imp_cert_img_file_kyc) || $this->login_user_type == '2') 
                {
                  $log_message .= ($log_message != '' ? ' & ' : '').'Approved the Visually impaired Certificate';
                }
              }
          }

          if($orth_han_cert_img_file_kyc != '' && $orth_han_cert_img_show_hide == "" && $candidate_data[0]['benchmark_disability'] == "Y" && $candidate_data[0]['orthopedically_handicapped'] == "Y")
          { 
              $up_candidiate['kyc_orth_han_cert_flag'] = $orth_han_cert_img_file_kyc; 
              if($orth_han_cert_img_file_kyc == 'N') //IF Orthopedically handicapped REJECT IN KYC, THEN UPDATE THE TABLE COLUMN & RENAME THE Orthopedically handicapped
              { 
                $approve_reject_flag = 'N'; 
                $up_candidiate['orth_han_cert_img'] = '';  
                rename($disability_path.'/'.$candidate_data[0]['orth_han_cert_img'], $disability_path.'/k_'.$candidate_data[0]['orth_han_cert_img']);

                $log_message .= ($log_message != '' ? ' & ' : '').'Rejected the Orthopedically handicapped Certificate';
                $kyc_action .= ($kyc_action != '' ? ' & ' : '').'Orthopedically handicapped Certificate'; 
              }
              else if($orth_han_cert_img_file_kyc == 'Y')
              {
                if(($this->login_user_type == '1' && $candidate_data[0]['kyc_orth_han_cert_flag'] != $orth_han_cert_img_file_kyc) || $this->login_user_type == '2') 
                {
                  $log_message .= ($log_message != '' ? ' & ' : '').'Approved the Orthopedically handicapped Certificate';
                }
              }
          }

          if($cer_palsy_cert_img_file_kyc != '' && $cer_palsy_cert_img_show_hide == "" && $candidate_data[0]['benchmark_disability'] == "Y" && $candidate_data[0]['cerebral_palsy'] == "Y")
          { 
              $up_candidiate['kyc_cer_palsy_cert_flag'] = $cer_palsy_cert_img_file_kyc; 
              if($cer_palsy_cert_img_file_kyc == 'N') //IF Cerebral palsy REJECT IN KYC, THEN UPDATE THE TABLE COLUMN & RENAME THE Cerebral palsy
              { 
                $approve_reject_flag = 'N'; 
                $up_candidiate['cer_palsy_cert_img'] = '';  
                rename($disability_path.'/'.$candidate_data[0]['cer_palsy_cert_img'], $disability_path.'/k_'.$candidate_data[0]['cer_palsy_cert_img']);

                $log_message .= ($log_message != '' ? ' & ' : '').'Rejected the Cerebral palsy Certificate';
                $kyc_action .= ($kyc_action != '' ? ' & ' : '').'Cerebral palsy Certificate'; 
              }
              else if($cer_palsy_cert_img_file_kyc == 'Y')
              {
                if(($this->login_user_type == '1' && $candidate_data[0]['kyc_cer_palsy_cert_flag'] != $cer_palsy_cert_img_file_kyc) || $this->login_user_type == '2') 
                {
                  $log_message .= ($log_message != '' ? ' & ' : '').'Approved the Cerebral palsy Certificate';
                }
              }
          }
          ...
          if($this->login_user_type == '1') //RECOMMENDER
          {
            ...
            { 
              $up_candidiate['kyc_recommender_status'] = '2'; 
              $up_candidiate['kyc_status'] = '1'; 
              $up_candidiate['benchmark_kyc_status'] = '1'; 
              $log_title = 'Approved'; 
            }
            else if($approve_reject_flag == 'N') 
            { 
              $up_candidiate['kyc_recommender_status'] = '3';
              $up_candidiate['kyc_status'] = '3'; 
              $up_candidiate['benchmark_kyc_status'] = '3'; 
              $log_title = 'Rejected';   
          ...
          else if($this->login_user_type == '2') //APPROVER
          {
            ...
            { 
              $up_candidiate['kyc_approver_status'] = '2';  
              $up_candidiate['kyc_status'] = '2';
              $up_candidiate['benchmark_kyc_status'] = '2';
              $log_title = 'Approved'; 
            }
            else if($approve_reject_flag == 'N') 
            { 
          ...
          if($update_qry_res)
          {
            ...
            { 
              //Send Email To Candidate For  
              //echo $this->session->flashdata('success_kyc');die;
              redirect(site_url('ncvet/kyc/benchmark_kyc_all/candidate_details/'.$module_name.'/'.$membership_type.'/'.$member_type.'/'.$exam_code));
            }
            else
            {
              //redirect(site_url('ncvet/kyc/kyc_dashboard'));
              ...
              if($member_type == 'new'){
                redirect(site_url('ncvet/kyc/benchmark_kyc_all/recommend_candidate/'));
              }else{
                redirect(site_url('ncvet/kyc/benchmark_kyc_all/edit_candidate/'));  
              }
              /*if($member_type == 'new'){
                redirect(site_url('ncvet/kyc/benchmark_kyc_all/new_candidate'));
              }else{
                redirect(site_url('ncvet/kyc/benchmark_kyc_all/edit_candidate'));
              }*/
          ...
          {
            $this->session->set_flashdata('error','Please submit the correct details');
            redirect(site_url('ncvet/kyc/benchmark_kyc_all/candidate_details/'.$_POST['module_name'].'/'.$_POST['membership_type'].'/'.$_POST['member_type'].'/'.$_POST['exam_code']));
          }
        }
        else
        {
    ...
    public function view_kyc_details($enc_candidate_id='', $page_url='')
    {
      ...
      $data['aadhar_file_path'] = $aadhar_file_path;
      $data['disability_path'] = $disability_path;
      $this->load->view('ncvet/kyc/benchmark_view_kyc_details', $data);
    }
