...
class Cron_elearning_csv_to_vendor_ftp_custom extends CI_Controller  
{
  ...
  public function send_elearning_data_to_vendor_common($vendor_name='', $cron_date='')
    ...
    if($vendor_name != '' && $cron_date != '')
    {
      ...
      {		
        ...
        {
          $local_server_dir_path = '/home/supp0rttest/public_html/uploads/rahultest/elearning_'.$vendor_name.'/'.$current_date.'/';
    ...
    else
    {
      $recipient_list = array('iibfdevp@esds.co.in');
		...
		$attachment_path = './uploads/rahultest/elearning_'.$vendor_name.'/'.$current_date.'/' . $attachment_filename;
