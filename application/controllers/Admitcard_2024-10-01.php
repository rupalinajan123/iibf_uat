...
class Admitcard extends CI_Controller
{
  ...
  public function getadmitcardpdfsp($enc_exam_code = '')
  {
    try
    {
      ...
      $html = $this->load->view('admitcardpdf', $data, true); /* echo $html; exit; */
      $this->load->library('m_pdf');
      $pdf = $this->m_pdf->load();
  ...
  public function getadmitcardjd()
  {
    try
    {
      ...
      {
        $drr = array('2024-07-07', '2024-07-13', '2024-07-14', '2024-07-21', '2024-07-27');
      }
      else
      {
      ...
      {
        $subject = $this->db->query("SELECT subject_description,date,time,venueid,seat_identification FROM admit_subject_master JOIN admitcard_info ON admit_subject_master.subject_code = LEFT(admitcard_info.sub_cd,3) WHERE admit_subject_master.exam_code = " . $exam_code . " AND admitcard_info.mem_mem_no = '" . $member_id . "' AND subject_delete = '0' AND date IN('2024-07-07','2024-07-13','2024-07-14','2024-07-21','2024-07-27') ORDER BY STR_TO_DATE(date, '%Y-%m-%d') ASC ");
      }
      else
      {
  ...
  public function getadmitcardpdfjd()
  {
    try
    {
      ...
      if ($exam_code == $this->config->item('examCodeJaiib') || $exam_code == $this->config->item('examCodeDBF') || $exam_code == $this->config->item('examCodeSOB'))
      {
        $drr = array('2023-10-08', '2023-10-14', '2023-10-15', '2023-10-29');
      }
      else if (in_array($exam_code, $dipcert_arr))
      {
        $drr = array('2024-01-01', '2024-01-07', '2024-01-28');
      }
      else if (in_array($exam_code, $caiib_arr))
      {
        $drr = array('2024-07-13', '2024-07-14', '2024-07-21', '2024-07-27', '2024-07-07');
      }
      else
      {
        $drr = array('2022-01-30', '2022-02-06', '2022-02-12');
      ...
      if ($exam_code == $this->config->item('examCodeJaiib') || $exam_code == $this->config->item('examCodeDBF') || $exam_code == $this->config->item('examCodeSOB'))
      {
        $subject = $this->db->query("SELECT subject_description,date,time,venueid,seat_identification FROM admit_subject_master JOIN admitcard_info ON admit_subject_master.subject_code = LEFT(admitcard_info.sub_cd,3) WHERE admit_subject_master.exam_code = " . $exam_code . " AND admitcard_info.mem_mem_no = '" . $member_id . "' AND subject_delete = '0'  AND date IN('2023-10-08','2023-10-14','2023-10-15','2023-10-29') ORDER BY STR_TO_DATE(date, '%Y-%m-%d') ASC ");
      }
      else if (in_array($exam_code, $dipcert_arr))
      {
        $subject = $this->db->query("SELECT subject_description,date,time,venueid,seat_identification FROM admit_subject_master JOIN admitcard_info ON admit_subject_master.subject_code = LEFT(admitcard_info.sub_cd,3) WHERE admit_subject_master.exam_code = " . $exam_code . " AND admitcard_info.mem_mem_no = '" . $member_id . "' AND subject_delete = '0'  AND date IN('2024-01-07','2024-01-28','2024-01-21') GROUP BY admitcard_info.date, admitcard_info.time ORDER BY STR_TO_DATE(date, '%Y-%m-%d') ASC ");
      ...
      {
        $subject = $this->db->query("SELECT subject_description,date,time,venueid,seat_identification FROM admit_subject_master JOIN admitcard_info ON admit_subject_master.subject_code = LEFT(admitcard_info.sub_cd,3) WHERE admit_subject_master.exam_code = " . $exam_code . " AND admitcard_info.mem_mem_no = '" . $member_id . "' AND subject_delete = '0' AND date IN('2024-07-13','2024-07-14','2024-07-21','2024-07-27','2024-07-07') ORDER BY STR_TO_DATE(date, '%Y-%m-%d') ASC ");
      }
      else
      {
        $subject = $this->db->query("SELECT subject_description,date,time,venueid,seat_identification FROM admit_subject_master JOIN admitcard_info ON admit_subject_master.subject_code = LEFT(admitcard_info.sub_cd,3) WHERE admit_subject_master.exam_code = " . $exam_code . " AND admitcard_info.mem_mem_no = '" . $member_id . "' AND subject_delete = '0'  AND date IN('2022-01-30','2022-02-06','2022-02-12') ORDER BY STR_TO_DATE(date, '%Y-%m-%d') ASC ");
  ...
  public function getadmitcardsp_new()
  {
    ...
    try
    {
      ...
      if ($exam_code == 1002 || $exam_code == 1003 || $exam_code == 1004  || $exam_code == 1005 || $exam_code == 1006 || $exam_code == 1007 || $exam_code == 1008 || $exam_code == 1009 || $exam_code == 1010 || $exam_code == 1011 || $exam_code == 1012 || $exam_code == 1013 || $exam_code == 1014 || $exam_code == 2027 || $exam_code == 1019 || $exam_code == 1020 || $exam_code == 1031 || $exam_code == 1032 || $exam_code == 1034)
      {
      ...
      if (sizeof($exm_arr) > 0)
      {
        if (count($exm_arr) > 1)
        {
          $record = $this->db->query("SELECT admitcard_info.exm_cd, admitcard_info.m_1, admitcard_info.sub_cd, admit_exam_master.description, admitcard_info.mode, admitcard_info.date as exam_date, admitcard_info.admitcard_id
					FROM admit_exam_master
					JOIN admitcard_info ON admitcard_info.exm_cd = admit_exam_master.exam_code
					WHERE admitcard_info.mem_mem_no = '" . $member_id . "' AND date IN ('2024-01-07','2024-01-21','2024-01-28')
					GROUP BY admitcard_info.exm_cd
					ORDER BY admitcard_info.admitcard_id DESC 
					 ");
          $result = $record->result();
