...
//echo '**';exit;
  ...
  public function editimagesX()
    ...
    public function examlist()
    {
        ...
        $flag       = 1;
        $exam_list  = array();
        $examcodes  = array('528', '529', '530', '531', '534', '991', '997', '1031', '1032', '1052', '1054', '1053');
    ...
    public function comApplication()
    {
	        ...
	        if(in_array($this->session->userdata('examcode'),$exam_codes_chk) && !in_array($get_ip_address,$set_client_ip_address) )
        {
	        ...
	        $dipcert_exam_codes_chk = array(8,11,19,151,153,156,158,78,79,163,165,166,220);
	        
	        if(in_array($this->session->userdata('examcode'),$dipcert_exam_codes_chk) && !in_array($get_ip_address,$dipcert_set_client_ip_address) )
	        {
	            // echo "<br>".$get_ip_address;
	            // echo "Site Under Maintenance. Please try again later."; exit;
	        } 
			...
			if($this->get_client_ip_nonmem()!='115.124.115.72'    && $this->get_client_ip_nonmem()!='115.124.115.75'    && $this->get_client_ip_nonmem()!='182.73.101.70'&& $this->get_client_ip_nonmem()!='192.168.11.253') 
			{
				...
				$excodes = array(220,8,11,19,78,79,151,153,156,158,163,165,166);
    ...
    public function examapplied($nmregnumber = null, $exam_code = null, $exam_date_arr=array())
    {
        ...
        if(in_array($exCode, $examCd_Arr)){
            ...
            $applied_exam_info = $this->master_model->getRecords('member_exam', array('member_exam.exam_period' => $get_exam_period[0]['exam_period'], 'regnumber' => $nmregnumber));
            //echo $this->db->last_query(); die;
        }    
