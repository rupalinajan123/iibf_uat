    ...
    { 
      ...
      foreach ($Rows as $Res) 
      {
        ...
        if($Res['candidate_photo'] != "")
        {
          ...
          $candidate_photo .= '<a href="'.$candidate_photo_link.'"  class="example-image-link" data-lightbox="candidate_photo_'.$Res['candidate_id'].'" data-title="'.$Res['DispName']." (".$Res['training_id'].")".'">
        ...
        if($Res['candidate_sign'] != "")
        {
          ...
          $candidate_sign .= '<a href="'.$candidate_sign_link.'"  class="example-image-link" data-lightbox="candidate_sign_'.$Res['candidate_id'].'" data-title="'.$Res['DispName']." (".$Res['training_id'].")".'">
        ...
        if($Res['id_proof_file'] != "")
        {
          ...
          $id_proof_file .= '<a href="'.$id_proof_file_link.'"  class="example-image-link" data-lightbox="id_proof_file_'.$Res['candidate_id'].'" data-title="'.$Res['DispName']." (".$Res['training_id'].")".'">
        ...
        if($Res['qualification_certificate_file'] != "")
        {
          ...
          $qualification_certificate_file .= '<a href="'.$qualification_certificate_file_link.'"  class="example-image-link" data-lightbox="qualification_certificate_file_'.$Res['candidate_id'].'" data-title="'.$Res['DispName']." (".$Res['training_id'].")".'">
