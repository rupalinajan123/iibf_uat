  ...
  class Training_batches_agency extends CI_Controller 
  {
    ...
    public function get_training_batches_agency_data_ajax()
    {
      ...
      foreach ($Rows as $Res) 
      {
        ...
        if($this->login_user_type == 'agency' && isset($_SESSION['IIBF_BCBF_AGENCY_CODE']) && in_array($_SESSION['IIBF_BCBF_AGENCY_CODE'], array('1019')) && date("Y-m-d") <= date('Y-m-d', strtotime("+2days", strtotime($Res['batch_end_date']))); && $Res['batch_status'] == '3')
        {
