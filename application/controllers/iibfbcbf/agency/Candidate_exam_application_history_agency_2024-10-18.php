  ...
  public function index($enc_training_id_or_regnumber = '')
  {
    ...
    if($enc_training_id_or_regnumber != '')
    {
      ...
      if(count($candidate_data) > 0)
      {
        ...
        $data['exam_application_data'] = $exam_application_data = $this->master_model->getRecords('iibfbcbf_member_exam me', array('me.is_deleted' => '0'), "me.*, ac.admitcard_id", array('me.member_exam_id'=>'DESC'));
        //_pq(1);
      }
    }
