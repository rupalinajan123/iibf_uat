  ...
  ********************************************************************************************************************/
  ...
  class Apply_exam_agency extends CI_Controller 
  {
    ...
    {      
      ...
      $data['page_title'] = $active_exam_data[0]['exam_period'].' - '.'IIBF - BCBF '.ucfirst($this->login_user_type).' : Apply for '.display_exam_name($active_exam_data[0]['description'], $active_exam_data[0]['exam_code'], $active_exam_data[0]['exam_type']); /* helpers/iibfbcbf/iibf_bcbf_helper.php */
    ...
    {      
      ...
      $data['act_id'] = "Exam ".$active_exam_data[0]['exam_code'];
      $data['sub_act_id'] = "Exam ".$active_exam_data[0]['exam_code'];
      $data['page_title'] = $active_exam_data[0]['exam_period'].' - '.'IIBF - BCBF '.ucfirst($this->login_user_type).' : Apply for '.$active_exam_data[0]['description']; 
    ...
    function make_payment($enc_exam_code='0')
    {
      ...
      $data['act_id'] = "Exam ".$active_exam_data[0]['exam_code'];
      $data['sub_act_id'] = "Exam ".$active_exam_data[0]['exam_code'];
      $data['page_title'] = $active_exam_data[0]['exam_period'].' - '.'IIBF - BCBF '.ucfirst($this->login_user_type).' : Make Payment '.$active_exam_data[0]['description'];
