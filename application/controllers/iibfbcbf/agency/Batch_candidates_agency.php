...
class Batch_candidates_agency extends CI_Controller
{
  ...
  public function get_batch_candidates_agency_data_ajax()
  {
    ...
    if (isset($_POST['s_centre']))
    {
      ...
      if ($s_centre != "")
      {
        $Where .= " AND bc.centre_id = '" . $s_centre . "'";
      }
    }
    ...
    if (isset($_POST['s_batch_code']))
    {
      ...
      if ($s_batch_code != "")
      {
        $Where .= " AND acb.batch_code LIKE '%" . $s_batch_code . "%'";
      }
    }
    ...
    if ($s_name != "")
    {
      $Where .= " AND CONCAT(bc.salutation, ' ', bc.first_name, IF(bc.middle_name != '', CONCAT(' ', bc.middle_name), ''), IF(bc.last_name != '', CONCAT(' ', bc.last_name), '')) LIKE '%" . $s_name . "%'";
    }

    $s_regnumber = trim($this->security->xss_clean($this->input->post('s_regnumber')));
    if ($s_regnumber != "")
    {
      $Where .= " AND bc.regnumber LIKE '%" . $s_regnumber . "%'";
    }
  ...
  public function add_candidates_agency($enc_batch_id = 0, $enc_candidate_id = 0)
  {
    ...
    else
    {
      ...
      {
        redirect(site_url('iibfbcbf/agency/batch_candidates_agency/add_candidates_agency'));
      }
          ...
          if ($candidate_id > 0)
          {
            ...
            if (count($candidate_data) > 0)
            {
              ...
              if (count($up_img_data) > 0)
              {
                ...
                $this->Iibf_bcbf_model->insert_common_log('Centre : Candidate Updated - image log', 'iibfbcbf_batch_candidates', $this->db->last_query(), $candidate_data[0]['candidate_id'], 'candidate_action_image_log', 'The candidate has successfully updated by the centre ' . $centreName['disp_name'], array());
              }
            }
          }
    ...
    if (isset($_POST) && count($_POST) > 0)
    {
      ...
      if (count($candidate_data) > 0)
      {
        ...
        if ($candidate_data[0]['hold_release_status'] != '3' || $candidate_data[0]['re_attempt'] == '3' || (date("Y-m-d", strtotime($candidate_data[0]['created_on'])) < $date_290_Days && date("Y-m-d", strtotime($candidate_data[0]['batch_end_date'])) < $date_290_Days) || in_array($candidate_data[0]['batch_status'], array(5, 7)))
        {
          ...
          $tmp_arr['bank_emp_id'] = $candidate_data[0]['bank_emp_id'];
          ...
          if ($id_proof_file != "")
          {
            $id_proof_file = base_url($this->id_proof_file_path) . '/' . $id_proof_file;
          }
          ...
          if ($qualification_certificate_file != "")
          {
            $qualification_certificate_file = base_url($this->qualification_certificate_file_path) . '/' . $qualification_certificate_file;
          }
          ...
          if ($candidate_photo != "")
          {
            $candidate_photo = base_url($this->candidate_photo_path) . '/' . $candidate_photo;
          }
          ...
          if ($candidate_sign != "")
          {
            $candidate_sign = base_url($this->candidate_sign_path) . '/' . $candidate_sign;
          }
      ...
      else
      {
        ...
        $candidate_data = $this->master_model->getRecords('member_registration mr', array('mr.regnumber' => $training_id_regnumber, 'mr.isactive' => '1', 'mr.isdeleted' => '0'), "mr.regid, mr.regnumber, mr.namesub, mr.firstname, mr.middlename, mr.lastname, mr.dateofbirth, mr.gender, mr.mobile, mr.email, mr.qualification, mr.address1, mr.address2, mr.address3, mr.address4, mr.state, cm.id AS city_id, mr.district, mr.pincode, mr.bank_emp_id, mr.idproof, mr.idNo, mr.aadhar_card, mr.registrationtype ", array('mr.regid' => 'DESC'));
        ...
        if (count($candidate_data) > 0)
        {
          ...
          $gender = '1';
          if ($candidate_data[0]['gender'] == 'female')
          {
            $gender = '2';
          }
          ...
          $qualification = '';
          if ($candidate_data[0]['qualification'] == 'U')
          {
            $qualification = '1';
          }
          else if ($candidate_data[0]['qualification'] == 'G')
          {
            $qualification = '2';
          }
          else if ($candidate_data[0]['qualification'] == 'P')
          {
            $qualification = '3';
          }
          ...
          $id_proof_type = '';
          if ($candidate_data[0]['idproof'] == '1')
          {
            $id_proof_type = '1';
          }
          else if ($candidate_data[0]['idproof'] == '2')
          {
            $id_proof_type = '2';
          }
          else if ($candidate_data[0]['idproof'] == '4')
          {
            $id_proof_type = '3';
          }
          else if ($candidate_data[0]['idproof'] == '5')
          {
            $id_proof_type = '4';
          }
          else if ($candidate_data[0]['idproof'] == '6')
          {
            $id_proof_type = '5';
          }
          ...
          $id_proof_number = '';
          if ($candidate_data[0]['idproof'] != '3')
          {
            $id_proof_number = $candidate_data[0]['idNo'];
          }
          ...
          if ($id_proof_file != "")
          {
            ...
            if ($id_proof_file != "")
            {
              $id_proof_file = base_url() . $id_proof_file;
            }
          }
          $tmp_arr['id_proof_file'] =  $id_proof_file;
          ...
          if ($candidate_photo != "")
          {
            ...
            if ($candidate_photo != "")
            {
              $candidate_photo = base_url() . $candidate_photo;
            }
          }
          $tmp_arr['candidate_photo'] =  $candidate_photo;
          ...
          if ($candidate_sign != "")
          {
            ...
            if ($candidate_sign != "")
            {
              $candidate_sign = base_url() . $candidate_sign;
            }
          }
          $tmp_arr['candidate_sign'] =  $candidate_sign;
