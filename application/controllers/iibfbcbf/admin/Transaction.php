  ...
  class Transaction extends CI_Controller 
  {
    ...
    public function get_transaction_data_ajax()
    {
      ...
      foreach ($Rows as $Res) 
      {
        ...
        {
          $btn_str .= ' <a target="_blank" href="'.site_url('iibfbcbf/download_file_common/index/'.url_encode($invoice_data[0]['invoice_id']).'/invoice_image').'" class="btn btn-danger btn-xs" title="View Invoice"><i class="fa fa-file-text"></i></a> ';
        }
    ...
    function generate_admit_card_manual($enc_pt_id='')
    { exit;
      if($enc_pt_id != '') 
      {
        $this->Iibf_bcbf_model->generate_admit_card_common($enc_pt_id);          
