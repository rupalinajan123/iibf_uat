                      ...
                      <tr class="final_result <?php if($error_cnt > 0) { echo "row_error"; } ?>">
                        <td colspan="8">
                          ...
                          { 
                            ...
                            {
                              //$this->master_model->updateRecord('iibfbcbf_agency_master', array('allow_exam_codes'=>''),  array('allow_exam_types'=>'Hybrid'));
                            }
                          } 
          ...
          if(is_array($decoded_res) && count($decoded_res) > 0)
          {
            ...
            foreach($decoded_res as $res)
            {
              ...
              if($response_exam_code ==  $exam_code)
              {
                ...
                //if($i == 0) { $this->master_model->deleteRecord($tbl_name,'exam_code',$response_exam_code); }
          ...
          if(is_array($decoded_res) && count($decoded_res) > 0)
          {
            ...
            foreach($decoded_res as $res)
            {
              ...
              if($response_exam_code == $exam_code && $response_exam_period == $exam_period)
              {
                ...
                //if($i == 0) { $this->master_model->deleteRecord($tbl_name,'exam_name',$response_exam_code); }
