  ...
  ********************************************************************************************************************/
  ...
  class Login_candidate extends CI_Controller 
  {
    ...
    {   
      ...
      {
        $this->form_validation->set_rules('iibf_bcbf_candidate_registration_number','Registration Number','trim|required|xss_clean|callback_validation_check_registration_number',array('required' => 'Please enter the %s'));
        ...
        if($this->form_validation->run())
        {
          ...
          $result_data = $this->master_model->getRecords('iibfbcbf_batch_candidates', array('regnumber'=>$iibf_bcbf_candidate_registration_number, 'is_deleted'=>'0', 'hold_release_status'=>'3'), 'candidate_id, regnumber, email_id, mobile_no, is_deleted', array('candidate_id'=>'DESC'),0,1);
    ...
    public function validation_check_registration_number($str='',$type=0)//$type : 0=>Server side, 1=>Ajax
    {
      ...
      if(isset($_POST) && $_POST['iibf_bcbf_candidate_registration_number'] != "")
      {
        ...
        $result_data = $this->master_model->getRecords('iibfbcbf_batch_candidates', array('regnumber'=>$iibf_bcbf_candidate_registration_number, 'is_deleted'=>'0', 'hold_release_status'=>'3'), 'candidate_id', array('candidate_id'=>'DESC'),0,1);
    ...
    function send_resend_otp()
    {
      ...
      if(isset($_POST) && count($_POST) > 0)
      {
        ...
        $this->db->where(' (mobile_no = "'.$iibf_bcbf_candidate_email_mobile.'" OR email_id = "'.$iibf_bcbf_candidate_email_mobile.'") ');
        $result_data = $this->master_model->getRecords('iibfbcbf_batch_candidates', array('regnumber'=>$iibf_bcbf_candidate_registration_number, 'is_deleted'=>'0', 'hold_release_status'=>'3'), 'candidate_id, training_id, regnumber, salutation, first_name, middle_name, last_name, mobile_no, email_id, is_deleted', array('candidate_id'=>'DESC'),0,1);
