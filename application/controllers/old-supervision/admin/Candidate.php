  ...
  class Candidate extends CI_Controller 
  {
    ...
    {      
      ...
      { 
        ...
        $selected_center= $this->master_model->getRecords('supervision_center_master', array('center_delete' => '0','center_code '=>$this->input->post('center_code'),'exam_name'=>$this->input->post('exam_code') ), 'id, center_code ,  center_name', array('center_name'=>'ASC'));
