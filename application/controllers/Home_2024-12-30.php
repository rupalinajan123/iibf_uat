...
//echo '**';exit;
    ...
    public function editimages()
    {
      ...
      if (isset($_POST) && count($_POST) > 0)
      {
        ...
        else if (isset($_POST['declaration_hidd']) && $_POST['declaration_hidd'] != "") { $declaration_req_flg = ''; }
    ...
    public function change_center()
    {
        ...
        $today_date = '2024-01-01';//date('Y-m-d');
        $exam_list  = array();
    ...
    public function getCentersByExamCode() {
        ...
        $this->db->where('center_master.exam_period', '224');
        $this->db->where("center_delete", '0');
