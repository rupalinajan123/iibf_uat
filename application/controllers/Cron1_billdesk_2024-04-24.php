<?php
	...
	class Cron1_billdesk extends CI_Controller 
	{
        ...
        $query_bcbf = 'SELECT receipt_no, pg_flag FROM iibfbcbf_payment_transaction WHERE date <= NOW() - INTERVAL 20 MINUTE AND date > NOW() - INTERVAL 40 MINUTE AND gateway = "Billdesk" AND status = "2" AND payment_mode = "Individual"';
