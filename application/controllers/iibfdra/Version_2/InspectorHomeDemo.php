...
class InspectorHomeDemo extends CI_Controller
{
  public $InspData;
  ...
  public function batch_list()
  {
    ...
    $selectCount = "SELECT b.id, b.agency_id, b.center_id, b.inspector_id, b.batch_code, b.batch_type, b.batch_online_offline_flag, b.hours, b.batch_name, b.batch_from_date, b.batch_to_date, b.batch_status, b.batch_active_period, b.total_candidates, c1.city_name, b.created_on
            FROM agency_batch b 
    ...
    $selectData = "SELECT b.batch_code, b.hours, c1.city_name, b.batch_from_date, b.total_candidates, b.created_on, b.batch_status, b.id, b.agency_id, b.center_id, b.inspector_id,  b.batch_type, b.batch_online_offline_flag,  b.batch_name,  b.batch_to_date, b.batch_active_period
            FROM agency_batch b 
            LEFT JOIN agency_center c ON b.center_id = c.center_id
            LEFT JOIN city_master c1 ON c1.id = c.location_name
            WHERE is_deleted = 0";
    ...
    foreach ($agency_list as $key => $agency)
    {
      ...
      $url = '<a href="' . base_url("iibfdra/Version_2/InspectorHomeDemo/view/" . base64_encode($agency['id'])) . '">View </a>';
  ...
  {  
    ...
    $query1  = "SELECT count(1) cnt FROM dra_batch_inspection_temp WHERE batch_id = " . $batch_id;
    ...
    {      
      ...
      if (!empty($_FILES['attachment']['name']))
      {
        ...
        {
          //$this->session->set_flashdata('error', 'File is empty.. Please upload valid file.');
          //redirect(base_url() . 'iibfdra/InspectorHomeDemo/show_batch_inspection_report/'.$btch_id);
        ...
        else
        {
          ...
          else
          {
            ...
            // exit;
            //$this->session->set_flashdata('error',$this->upload->display_errors());
            //redirect(base_url().'iibfdra/InspectorHomeDemo/inspection_report');
      ...
      else
      {
        ...
        $query1 = "SELECT count(1) cnt FROM dra_batch_inspection_temp WHERE batch_id = " . $this->input->post('batch_id'); //." AND inspector_id = ".$inspector_id
        ...
        $get_last_record = $this->master_model->getRecords('dra_batch_inspection_temp', array('agency_id' => $this->input->post('agency_id'), 'batch_id' => $this->input->post('batch_id'), 'inspector_id' => $inspector_id), 'id, agency_id, batch_id, inspector_id, inspection_no, inspection_start_time, created_on', array('created_on' => 'DESC'));
        ...
        else
        {
          $insert_data = array(
            ...
            'inspection_start_time' => 2,
            'created_by'   => $inspector_id,
            'created_on' => date('Y-m-d H:i:s')
          );

          $inserted_id = $this->master_model->insertRecord('dra_batch_inspection_temp',$insert_data,true);
          ...
          if ($inserted_id > 0)
          {
            ...
            if (count($remarkArr) > 0)
            {
              foreach ($remarkArr as $key => $remark)
              {
                if ($remark[0] != '')
                {
                  ...
                  $inserted_child_id = $this->master_model->insertRecord('dra_candidate_inspection_temp', $insert_child_data);
            ...
            if (count($attendanceArr) > 0)
            {
              foreach ($attendanceArr as $key => $attendance)
              {
                ...
                $candidate_data = $this->master_model->getRecords('dra_candidate_inspection_temp', $where);

                if (count($candidate_data) > 0)
                {
                  $update_data = array('attendance' => $attendance[0]);
                  $upd_child_id = $this->master_model->updateRecord('dra_candidate_inspection_temp', $update_data, $where);
                  //echo '---'.$this->db->last_query();
                }
                else
                {
            ...
            FROM dra_candidate_inspection_temp ci LEFT JOIN agency_batch ab ON ab.id = ci.batch_id
            ...
            redirect(base_url() . 'iibfdra/Version_2/InspectorHomeDemo/show_batch_inspection_report/'.$btch_id);
          }
          else
          {
    ...
    $data['middle_content']       = 'batch_inspector_report_view_demo';
    $this->load->view('iibfdra/Version_2/common_view_inspector', $data);
  }
  ...
  public function inspection_report()
  {
    ...
    $this->db->where_in('b.agency_id', $DRA_Version_2_instId);
    $data['batch'] = $batch = $this->master_model->getRecords('agency_batch b', $where1);
    $data['middle_content'] = 'inspector_report_demo';
  ...
  public function save_inspection_report()//not in use
  {
    ...
    if (!empty($_FILES['attachment']['name']))
    {
      ...
      else
      {
        ...
        else
        {
          ...
          exit;
          //$this->session->set_flashdata('error',$this->upload->display_errors());
          //redirect(base_url().'iibfdra/Version_2/InspectorHomeDemo/inspection_report');
          //$errorUploadType .= $_FILES['attachment']['name'].' | ';  
        }
      }
    }
    ...
    //print_r($insert_data);
    $inserted_id = $this->master_model->insertRecord('dra_batch_inspection_temp', $insert_data);
    //echo $this->db->last_query(); 
    if ($inserted_id)
    {
      $result['flag'] = "success";
  ...
  public function get_candidate_data()
  {
    ...
    $query1 = "SELECT count(1) cnt FROM dra_batch_inspection_temp WHERE batch_id = " . $batch_id; //." AND inspector_id = ".$inspector_id
  ...
  public function batch_inspection_report()
  {
    ...
    $selectQuery = "SELECT a.institute_name, b.id, b.agency_id, b.batch_code, b.batch_name, b.batch_from_date, b.batch_to_date, b.online_training_platform, b.timing_from, b.timing_to, b.hours, b.training_medium, b.total_candidates, f1.faculty_id as first_faculty_id, f1.faculty_name as first_faculty_name, f2.faculty_id as sec_faculty_id, f2.faculty_name as sec_faculty_name, f3.faculty_id as add_first_faculty_id, f3.faculty_name as add_first_faculty_name, f4.faculty_id as add_sec_faculty_id, f4.faculty_name as add_sec_faculty_name, b.contact_person_name, b.contact_person_phone, b.alt_contact_person_name, b.alt_contact_person_phone, b.platform_link, b.batch_online_offline_flag, b.training_schedule, b.created_on
          FROM agency_batch b LEFT JOIN  dra_accerdited_master a ON b.agency_id = a.dra_inst_registration_id LEFT JOIN faculty_master f1 ON b.first_faculty=f1.faculty_id LEFT JOIN faculty_master f2 ON b.sec_faculty=f2.faculty_id
    ...
    if ($inspector_name != 'DRA Cell') {
      $selectQuery .= " AND   b.inspector_id = " . $inspector_id;       
    }      
    
    $selectQuery .= " AND  EXISTS (SELECT i.batch_id FROM dra_batch_inspection_temp i WHERE b.id = i.batch_id)
          ORDER BY b.id DESC";
    ...
    $data['middle_content'] = 'batch_inspection_report_demo';
    $this->load->view('iibfdra/Version_2/common_view_inspector', $data);
  }
  ...
  public function get_data()
  {
    ...
    $query1 = "SELECT * FROM dra_batch_inspection_temp WHERE batch_id = " . $batch_id . " AND inspector_id =" . $inspector_id; //ACTUAL QUERY
    ...
    $query = "SELECT m.regid, m.training_id, concat(m.namesub, ' ', m.firstname, ' ', m.middlename, ' ', m.lastname) as name, m.dateofbirth, m.mobile_no, m.scannedphoto,
    ...
    /*$query1 = "SELECT regid, training_id, concat(namesub, ' ', firstname, ' ', middlename, ' ', lastname) as name, dateofbirth, mobile_no FROM dra_members WHERE batch_id = 10924"; //ACTUAL QUERY
    ...
    echo $str . ':::::' . json_encode($batch) . ':::::' . $str1;
  }
  ...
  public function export_to_pdf()
  {
    ...
    $query1 = $this->db->query("SELECT * FROM dra_batch_inspection_temp WHERE batch_id = " . $batch_id . " AND inspector_id =" . $inspector_id); //ACTUAL QUERY
          ...
          if ($this->form_validation->run()) {
           // echo"hu";
            ...
            $this->master_model->updateRecord('agency_inspector_master', $update_data, array('id' => $inspector_id));
              ...
              redirect(base_url().'iibfdra/Version_2/InspectorHomeDemo');
          } else {
