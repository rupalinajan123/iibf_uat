...
class MiscMaster extends CI_Controller {
	...
	public function index()
	{
		...
		$data["breadcrumb"] = '<ol class="breadcrumb"><li><a href="'.base_url().'iibfdra/Version_2/admin/MainController"><i class="fa fa-dashboard"></i> Home</a></li>
								<li><a href="'.base_url().'iibfdra/Version_2/admin/'.$this->router->fetch_class().'">Manage Misc</a></li>
							</ol>';
		
		$this->load->view('iibfdra/Version_2/admin/masters/misc_list',$data);
	}
	...
	public function getList()
	{
		...
		$url = base_url()."iibfdra/Version_2/admin/MiscMaster/getList/";
		...
		if($res)
		{
			...
			foreach($result as $row)
			{
				...
				$action = '<a href="'.base_url().'iibfdra/Version_2/admin/MiscMaster/edit/'.$row['misc_id'].'">Edit | </a> <a href="'.base_url().'iibfdra/Version_2/admin/MiscMaster/delete/'.$row['misc_id'].'" onclick="'.$confirm.'">Delete</a>';
				$data['action'][] = $action;
			}
	...
	public function add(){
			...
			if($this->form_validation->run()==TRUE)
			{
				...
				if($cnt == 0)
				{
					...
					if($this->master_model->insertRecord('dra_misc_master',$insert_data))
					{
						...
						redirect(base_url().'iibfdra/Version_2/admin/MiscMaster');
					}
					else
					{
						...
						redirect(base_url().'iibfdra/Version_2/admin/MiscMaster/add');
					}
				}
				else
				{
		...
		$this->load->view('iibfdra/Version_2/admin/masters/misc_add',$data);
	}
		...
		if(isset($_POST['btnSubmit']))
		{
			...
			if($this->form_validation->run()==TRUE)
			{
				...
				else
				{
					...
					redirect(base_url().'iibfdra/Version_2/admin/MiscMaster/edit/'.$id);
				}
			}
			else
			{
	...
	public function import(){
							...
							while (($line = fgets($handle)) !== false) {
								...
								else
								{
									...
									else
									{
										...
										redirect(base_url().'iibfdra/Version_2/admin/MiscMaster/import');
									}
								}
							}
							fclose($handle);
		...
		$this->load->view('iibfdra/Version_2/admin/masters/misc_import', $data);
	}
