...
class EligibleMaster extends CI_Controller {
	...
	public function index()
	{
		...
		$data["breadcrumb"] = '<ol class="breadcrumb"><li><a href="'.base_url().'iibfdra/Version_2/admin/MainController"><i class="fa fa-dashboard"></i> Home</a></li>
									<li><a href="'.base_url().'iibfdra/Version_2/admin/'.$this->router->fetch_class().'">Manage Eligible</a></li>
							   </ol>';
		
		$this->load->view('iibfdra/Version_2/admin/masters/eligible_list',$data);
	}
	...
	public function getList()
	{
		...
		$url = base_url()."iibfdra/Version_2/admin/EligibleMaster/getList/";
		...
		if($res)
		{
			...
			foreach($result as $row)
			{
				...
				$action = '<a href="'.base_url().'iibfdra/Version_2/admin/EligibleMaster/edit/'.$row['eligible_id'].'">Edit | </a> <a href="'.base_url().'iibfdra/Version_2/admin/EligibleMaster/delete/'.$row['eligible_id'].'" onclick="'.$confirm.'">Delete</a>';
				$data['action'][] = $action;
			}
	...
	public function add(){
		...
		if(isset($_POST['btnSubmit']))
		{
			...
			if($this->form_validation->run()==TRUE)
			{
				...
				if($this->master_model->insertRecord('dra_eligible_master',$insert_data))
				{
					...
					redirect(base_url().'iibfdra/Version_2/admin/EligibleMaster');
				}
				else
				{
					...
					redirect(base_url().'iibfdra/Version_2/admin/EligibleMaster/add');
				}
			}
			else
			{
		...
		$this->load->view('iibfdra/Version_2/admin/masters/eligible_add',$data);
	}
		...
		if(isset($_POST['btnSubmit']))
		{
			...
			if($this->form_validation->run()==TRUE)
			{
				...
				else
				{
					...
					redirect(base_url().'iibfdra/Version_2/admin/EligibleMaster/edit/'.$id);
				}
			}
			else
			{
	...
	public function import(){
							...
							while (($line = fgets($handle)) !== false) {
								...
								else
								{
									...
									else
									{
										...
										redirect(base_url().'iibfdra/Version_2/admin/EligibleMaster/import');
									}
								}
							}
		...
		$this->load->view('iibfdra/Version_2/admin/masters/eligible_import', $data);
	}
