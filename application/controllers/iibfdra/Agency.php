...
class Agency extends CI_Controller {	
	...
	{		
		...
		<li><a href="'.base_url().'iibfdra/agency/">
		<i class="fa fa-home"></i> Home</a></li>
		<li class="active"><a href="'.base_url().'iibfdra/agency/">Agency</a></li>
		</ol>';		
		...
		$this->load->view('iibfdra/admin/agency/agency_list',$data);
	}
	...
	public function agency_detail($agency_id)
	{
		...
		<li><a href="'.base_url().'iibfdra/agency/">
		<i class="fa fa-home"></i> Home</a></li>
		<li class=""><a href="'.base_url().'iibfdra/agency/">Agency</a></li>
		<li class="active"><a href="'.base_url().'iibfdra/agency/agency_detail/'.$agency_id.'">Agency Detail</a></li>
		 </ol>';
		$data['middle_content']	= 'iibfdra/admin/agency/agency_detail';		
		...
		$this->load->view('iibfdra/admin/agency/agency_detail',$data);	
    ...
    $this->load->helper('general_agency_helper');
		...
		<i class="fa fa-home"></i> Home</a></li>
		<li class=""><a href="'.base_url().'iibfdra/agency/">Agency</a></li>
		<li class="active"><a href="'.base_url().'iibfdra/agency/agency_detail/'.$agency_id.'">Agency Renew</a></li>
		 </ol>';
		$data['middle_content']	= 'iibfdra/admin/agency/agency_renew';		
    ...
    if(isset($_POST) && count($_POST) > 0 && isset($_POST['form_action']) && $_POST['form_action'] == 'update_center_validity_Form')
    {
      ...
      if(count($center_ids_arr) > 0)
      {
        ...
        redirect(site_url('iibfdra/agency/agency_renew/'.$agency_id));
      }
      else
      {
		...
		$data['center_result'] = $res_value;
		$data['result'] = $res_agency[0];			 
		$this->load->view('iibfdra/admin/agency/agency_renew',$data);	
	...
	{	
		...
		$data["breadcrumb"] = '<ol class="breadcrumb"><li><a href="'.base_url().'iibfdra/agency/agency_detail">
		<i class="fa fa-home"></i> Home</a></li>
			  <li class=""><a href="'.base_url().'iibfdra/agency/">Agency</a></li>
		...
		*/
		...
		$this->load->view('iibfdra/admin/agency/agency_center_detail',$data);		
	}
	...
	public function training_center_receipt($center_id)
	{
		...
		<i class="fa fa-home"></i> Home</a></li>
			  <li class=""><a href="'.base_url().'iibfdra/agency/">Agency</a></li>
			  <li class="active"><a href="'.base_url().'iibfdra/agency/training_center_detail/'.$center_id.'">Agency Center Details</a></li>
		...
		*/
		...
		$this->load->view('iibfdra/admin/agency/receipt',$data);	
	}
