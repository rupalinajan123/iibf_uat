...
class ExamActiveMaster extends CI_Controller {
	...
	public function index()
	{
		...
		$data["breadcrumb"] = '<ol class="breadcrumb"><li><a href="'.base_url().'iibfdra/admin/MainController"><i class="fa fa-dashboard"></i> Home</a></li>
									<li><a href="'.base_url().'iibfdra/admin/'.$this->router->fetch_class().'">Manage Exam Activation Master</a></li>
							   </ol>';
		
		$this->load->view('iibfdra/admin/masters/exam_active_list',$data);
	}
	...
	public function getList()
	{
		...
		$url = base_url()."iibfdra/admin/ExamActiveMaster/getList/";
		...
		if($res)
		{
			...
			foreach($result as $row)
			{
				...
				$action = '<a href="'.base_url().'iibfdra/admin/ExamActiveMaster/edit/'.$row['exam_active_id'].'">Edit | </a> <a href="'.base_url().'iibfdra/admin/ExamActiveMaster/delete/'.$row['exam_active_id'].'" onclick="'.$confirm.'">Delete</a>';
				$data['action'][] = $action;
	...
	public function add(){
		...
		if(isset($_POST['btnSubmit']))
		{
			...
			if($this->form_validation->run()==TRUE)
			{
				...
				if($this->master_model->insertRecord('dra_exam_activation_master',$insert_data))
				{
					...
					redirect(base_url().'iibfdra/admin/ExamActiveMaster');
				}
				else
				{
					...
					redirect(base_url().'iibfdra/admin/ExamActiveMaster/add');
				}
			}
			else
			{
		...
		$this->load->view('iibfdra/admin/masters/exam_active_add',$data);
	}
			...
			if($this->form_validation->run()==TRUE)
			{
				...
				if($from_time < $to_time)
				{
					...
					else
					{
						...
						redirect(base_url().'iibfdra/admin/ExamActiveMaster/edit/'.$id);
					}
				}
				else
				{
							...
							while (($line = fgets($handle)) !== false) {
								...
								else
								{
									...
									else
									{
										...
										redirect(base_url().'iibfdra/admin/ExamActiveMaster/import');
									}
								}
							}
