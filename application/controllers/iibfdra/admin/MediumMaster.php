...
class MediumMaster extends CI_Controller {
	...
	public function index()
	{
		...
		$data["breadcrumb"] = '<ol class="breadcrumb"><li><a href="'.base_url().'iibfdra/admin/MainController"><i class="fa fa-dashboard"></i> Home</a></li>
									<li><a href="'.base_url().'iibfdra/admin/'.$this->router->fetch_class().'">Manage Medium</a></li>
							   </ol>';
		
		$this->load->view('iibfdra/admin/masters/medium_list',$data);
	}
	...
	public function getList()
	{
		...
		$url = base_url()."iibfdra/admin/MediumMaster/getList/";
		...
		if($res)
		{
			...
			foreach($result as $row)
			{
				...
				$action = '<a href="'.base_url().'iibfdra/admin/MediumMaster/edit/'.$row['medium_id'].'">Edit | </a> <a href="'.base_url().'iibfdra/admin/MediumMaster/delete/'.$row['medium_id'].'" onclick="'.$confirm.'">Delete</a>';
				$data['action'][] = $action;
	...
	public function add(){
		...
		if(isset($_POST['btnSubmit']))
		{
			...
			if($this->form_validation->run()==TRUE)
			{
				...
				if($this->master_model->insertRecord('dra_medium_master',$insert_data))
				{
					...
					redirect(base_url().'iibfdra/admin/MediumMaster');
				}
				else
				{
					...
					redirect(base_url().'iibfdra/admin/MediumMaster/add');
				}
			}
			else
			{
		...
		$this->load->view('iibfdra/admin/masters/medium_add',$data);
	}
		...
		if(isset($_POST['btnSubmit']))
		{
			...
			if($this->form_validation->run()==TRUE)
			{
				...
				else
				{
					...
					redirect(base_url().'iibfdra/admin/MediumMaster/edit/'.$id);
				}
			}
			else
			{
							...
							while (($line = fgets($handle)) !== false) {
								...
								else
								{
									...
									else
									{
										...
										redirect(base_url().'iibfdra/admin/MediumMaster/import');
									}
								}
							}
