...
//echo $CI->db->last_query();exit;
	...
	function getExamFee($centerCode = NULL, $eprid =NULL ,$excd =NULL ,$grp_code=NULL,$memcategory=NULL,$elearning_flag=NULL)
	{
		...
		$rpe_exam_code_array = array('1002','1003','1004','1005','1006','1007','1008','1009','1010','1011','1012','1013','1014','1017','1019','1020','2027');
		...
		if($centerCode !=NULL  && $eprid !=NULL  && $excd !=NULL  && $grp_code !=NULL  && $memcategory !=NULL )
		{
			...
			if(count($getstate) > 0)
			{
				...
				if(count($getfees) > 0)
				{
					...
					{  
						$rpeEXCodes = array('1002','1003','1004','1005','1006','1007','1008','1009','1010','1011','1012','1013','1014','1017','1019','1020','2027');
