 ...
 */
 	...
 	function validate_userdata($register_id = NULL)
	{
		...
		if($register_id !=NULL)
		{
			...
			//This code added by pratibha borse on 20th April 22, for ordinary member who register after 1 april 2022
			
			if($user_info[0]['createdon'] >='2022-04-01' && ($user_info[0]['declaration']=='' || $user_info[0]['declaration']=='1') && $user_info[0]['registrationtype'] == 'O')
			{
				$flag=1;
			}
			/*if($user_info[0]['idNo']=='')
