        ...
        <tr>
          <td style="border:3px solid #619fda;"><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
              ...
              <?php
              	...
              	$frn = array('500108283','500126827','500200976','500216898','510185648','510308508');
			  ?>
              ...
              <?php }else{?>
              	 <?php if($scnt == count($record)) {?>
                 	<td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">
                    You have passed JAIIB Examination and eligible to appear for CAIIB - Dec 2017 examination per the rules for appearing from Foreign Centre. 
                    </td>
                 <?php }?>
                 <?php if($scnt != count($record)) {?>
                 <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">
                 You are required to apply afresh for Nov 2017 Examination as per the rules for appearing from Foreign Centre. Last date for receiving the application form at
the Member Support Services of the Institute Mumbai is 13th September, 2017 for JAIIB.
                 </td>
                 <?php }?>
              <?php }?>
              <?php }?>
                ...
                <td style="padding:20px 0;"><table style="border-collapse:collapse;" width="90%" align="center">
                  ...
                  <table width="10%" align="center" border="0" cellpadding="0" cellspacing="0" style="padding:30px 0 0;">
                    <tr>
                      ...
                      <td><a href="<?php echo base_url()?>result/jaiibdbfresult" style="background-color:#ddd; color:#000; text-align:center; padding:10px 15px; text-decoration:none;">Back</a></td>
    ...
    <td><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
        <tr>
          <td style="border:3px solid #619fda;"><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
              ...
              <?php if($user_info->no_of_attempt == 1 || $user_info->no_of_attempt == 3){?>
              <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">You will receive the Admit Letter only through Email for Nov 2017 examination one week before its scheduled date (Available on our website). In case of non receipt of the same you may download from our website www.iibf.org.in. Please note that you need not apply for the same again as you have already paid the exam fees for 2 attempts.
              <div style="float:right;margin-right:40px;text-align:center">
               <p><strong>Yours Faithfully</strong></p>
               <img src="<?php echo base_url();?>assets/images/iibf_officer_sign.jpg" style="max-width:40%" />
               <p>Joint Director<br />Examinations</p>
              ...
              <?php }?>
              <?php if($user_info->no_of_attempt == 2 ){?>
              <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">You have completed the 1st Block of 2 attempts, you are required to submit the application form for the 2nd Block of 2 attempts for appearing at the Nov  2017 examination. Application can be submitted only through Online Mode, for details visit our website www.iibf.org.in. Last date for applying ONLINE is 13th September, 2017 for JAIIB.
              <div style="float:right;margin-right:40px;text-align:center">
               <p><strong>Yours Faithfully</strong></p>
               <img src="<?php echo base_url();?>assets/images/iibf_officer_sign.jpg" style="max-width:40%" />
               <p>Joint Director<br />Examinations</p>
              ...
              <?php }?>
              <?php if($user_info->no_of_attempt == 4 ){?>
              <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">You have completed the 2nd Block of 2 attempts. You are required to submit the examination application form afresh for appearing at the Nov 2017 examination. You will not be eligible for credit of subjects passed, if any, earlier. Application can be submitted only through Online Mode for details visit our website www.iibf.org.in. Last date for applying ONLINE 13th September, 2017 for JAIIB.
              <div style="float:right;margin-right:40px;text-align:center">
               <p><strong>Yours Faithfully</strong></p>
               <img src="<?php echo base_url();?>assets/images/iibf_officer_sign.jpg" style="max-width:40%" />
               <p>Joint Director<br />Examinations</p>
