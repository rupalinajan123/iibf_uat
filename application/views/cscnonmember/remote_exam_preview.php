  ...
  <div class="content-wrapper">
	...
	$function = "add_member";
    ?>
	<form class="form-horizontal" name="member_exam_comApplication" id="member_exam_comApplication"  method="post"  enctype="multipart/form-data" action="<?php echo base_url();?>Remote_CSCNonMember/<?php echo $function;?>/">
            ...
            <div class="box-body">
             <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                <label for="roleid" class="col-sm-3 control-label">Exam venue *</label>
                	<div class="col-sm-5">
                    <?php 
						//echo '>>'. $this->session->userdata['examinfo']['csc_venue'];
						if($this->session->userdata['examinfo']['csc_venue'] == 'H'){
							echo "Self Venue (Home/Office etc.) ";
						}else{
							echo "CSC Venue/Centre ";
						}
