  ...
  <div class="content-wrapper">
    ...
    <?php
        ...
        { 	$function = "Msuccess";	}
    ?>
	<form class="form-horizontal" name="member_exam_comApplication" id="member_exam_comApplication"  method="post"  enctype="multipart/form-data" action="<?php echo base_url();?>CSCNonMember/<?php echo $function;?>/">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
                 ...
                 <?php 
				   if(count($compulsory_subjects) > 0)
				   {
					   ...
					   foreach($compulsory_subjects as $k=>$v)
					   {
						 ...
						 $get_venue_details=$this->master_model->getRecords('venue_master',array('venue_code'=>$v['venue'],'center_code'=>$this->session->userdata['examinfo']['selCenterName']));
            ...
            <div class="form-group">
                ...
                <?php if( $this->session->userdata('examcode') == 1052 || $this->session->userdata('examcode') == 1054 ) { ?>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                     <?php echo $this->session->userdata['examinfo']['are_you_corporate_bc']; ?>
                      <span class="error"><?php //echo form_error('are_you_corporate_bc');?></span>
                    </div>
                </div>
                <?php if($this->session->userdata['examinfo']['are_you_corporate_bc']=='Yes'){ ?>
                <div class="form-group">
                    <label for="roleid" class="col-sm-3 control-label">Corporate BC </label> 
                    <div class="col-sm-2">
                     <?php echo $this->session->userdata['examinfo']['corporate_bc_option']; ?>
                      <span class="error"><?php //echo form_error('corporate_bc_option');?></span>
                    </div>
                </div>
                <?php }
                if($this->session->userdata['examinfo']['corporate_bc_option']=='Other'){
                 ?>
                <div class="form-group">
                    <label for="roleid" class="col-sm-3 control-label">Corporate BC associated with</label>
                    <div class="col-sm-3">
                        <?php echo $this->session->userdata['examinfo']['corporate_bc_associated']; ?>
                    </div>
                </div>
                <?php } ?>
