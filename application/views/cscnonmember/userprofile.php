			 ...
			 ?> 
				...
				<?php 
                   ...
                   <div class="col-sm-2">
					...
					{?>
                        ...
                        <input type="hidden" name="hidd_firstname" id="hidd_firstname" value="<?php echo set_value('firstname');?>">
                     <?php 
					}
					else
					{
               ...
               <div class="form-group">
					...
					if($user_info[0]['firstname']=='')
				{
						...
						{?>
						  <input type="text" class="form-control" id="middlename" name="middlename" placeholder="Middle Name" value="<?php echo set_value('middlename');?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" >
						  <input type="hidden" name="hidd_middlename" id="hidd_middlename" value="<?php echo set_value('middlename');?>">
				...
				{if($user_info[0]['middlename']=='')
						{?>
						  <input type="text" class="form-control" id="middlename" name="middlename" placeholder="Middle Name" value="<?php echo set_value('middlename');?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" readonly="readonly">
						  <input type="hidden" name="hidd_middlename" id="hidd_middlename" value="<?php echo set_value('middlename');?>" readonly="readonly">
					 ...
					 if($user_info[0]['firstname']=='')
				{
						...
						{?>
						  <input type="text" class="form-control" id="lastname" name="lastname" placeholder="Last Name" value="<?php echo set_value('lastname');?>"  data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" >
						  <input type="hidden" name="hidd_lastname" id="hidd_lastname" value="<?php echo set_value('lastname');?>" >
						<?php 
						 }else
						{
				...
				}else
				{
						if($user_info[0]['lastname']=='')
						{?>
						  <input type="text" class="form-control" id="lastname" name="lastname" placeholder="Last Name" value="<?php echo set_value('lastname');?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" readonly="readonly">
						  <input type="hidden" name="hidd_lastname" id="hidd_lastname" value="<?php echo set_value('lastname');?>"  readonly="readonly">
						<?php 
						 }else
						{
						 echo $user_info[0]['lastname'];?>
...
<div class="sub_title">
            ...
            <div class="box-body">
                ...
                <label for="roleid" class="col-sm-3 control-label">Address line1 <span style="color:#F00">*</span></label>
                	<div class="col-sm-5">
                      <input type="text" class="form-control" id="addressline1" name="addressline1" placeholder="Address line1" required value="<?php if($user_info[0]['address1']!=''){echo $user_info[0]['address1'];}else{ echo set_value('addressline1');}?>"  data-parsley-maxlength="30" >
                      <input type="hidden" name="" id="addressline1_hidd" value="<?php if($user_info[0]['address1']!=''){echo $user_info[0]['address1'];}else{ echo set_value('addressline1');}?>">
                ...
                <label for="roleid" class="col-sm-3 control-label">Address line2</label>
                	<div class="col-sm-5">
                      <input type="text" class="form-control" id="addressline2" name="addressline2" placeholder="Address line2" value="<?php if($user_info[0]['address2']!=''){echo $user_info[0]['address2'];}else{ echo set_value('addressline2');}?>"  data-parsley-maxlength="30" >
                      <input type="hidden" name="" id="addressline2_hidd" value="<?php if($user_info[0]['address2']!=''){echo $user_info[0]['address2'];}else{ echo set_value('addressline2');}?>">
                ...
                <label for="roleid" class="col-sm-3 control-label">Address line3</label>
                	<div class="col-sm-5">
                      <input type="text" class="form-control" id="addressline3" name="addressline3" placeholder="Address line3" value="<?php if($user_info[0]['address3']!=''){echo $user_info[0]['address3'];}else{ echo set_value('addressline3');}?>"  data-parsley-maxlength="30" >
                      <input type="hidden" name="" id="addressline3_hidd" value="<?php if($user_info[0]['address3']!=''){echo $user_info[0]['address3'];}else{ echo set_value('addressline3');}?>">
                ...
                <label for="roleid" class="col-sm-3 control-label">Address line4</label>
                	<div class="col-sm-5">
                      <input type="text" class="form-control" id="addressline4" name="addressline4" placeholder="Address line4"  value="<?php if($user_info[0]['address4']!=''){echo $user_info[0]['address4'];}else{ echo set_value('addressline4');}?>" data-parsley-maxlength="30" >
                        <input type="hidden" name="" id="addressline4_hidd" value="<?php if($user_info[0]['address4']!=''){echo $user_info[0]['address4'];}else{ echo set_value('addressline4');}?>">
                ...
                <label for="roleid" class="col-sm-3 control-label">District <span style="color:#F00">*</span></label>
                	<div class="col-sm-5">
                      <input type="text" class="form-control" id="district" name="district" placeholder="District" required value="<?php if($user_info[0]['district']!=''){echo $user_info[0]['district'];}else{ echo set_value('district');} ?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" >
                        <input type="hidden" name="" id="district_hidd" value="<?php if($user_info[0]['district']!=''){echo $user_info[0]['district'];}else{ echo set_value('district');} ?>">
                ...
                <label for="roleid" class="col-sm-3 control-label">City <span style="color:#F00">*</span></label>
                	<div class="col-sm-5">
                      <input type="text" class="form-control" id="city" name="city" placeholder="City" required value="<?php if($user_info[0]['city']!=''){echo $user_info[0]['city'];}else{ echo set_value('city');} ?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" >
                        <input type="hidden" name="" id="city_hidd" value="<?php if($user_info[0]['city']!=''){echo $user_info[0]['city'];}else{ echo set_value('city');} ?>">
              ...
              <div class="form-group">
                <label for="roleid" class="col-sm-3 control-label">State <span style="color:#F00">*</span></label>
                    ...
                    <select class="form-control" id="state" name="state" required >
                     ...
                     <div class="col-sm-2">
                     <input class="form-control" id="pincode" name="pincode" placeholder="Pincode/Zipcode" required="" value="<?php  if($user_info[0]['pincode']!=''){echo $user_info[0]['pincode'];}else{ echo set_value('pincode');} ?>" data-parsley-maxlength="6" maxlength="6" size="6" data-parsley-nonmemcheckpin data-parsley-type="number" autocomplete="off" type="text" data-parsley-trigger-after-failure="focusout">
                     
                        
                         <input type="hidden" name="" id="pincode_hidd" value="<?php  if($user_info[0]['pincode']!=''){echo $user_info[0]['pincode'];}else{ echo set_value('pincode');} ?>">
            ...
            <div class="form-group">
                <label for="roleid" class="col-sm-3 control-label">Email <span style="color:#F00">*</span></label>
                	<div class="col-sm-5">
                    <input class="form-control" id="email" name="email" placeholder="Email" data-parsley-type="email" value="<?php if($user_info[0]['email']!=''){echo $user_info[0]['email'];}else{ echo set_value('email');}?>" data-parsley-maxlength="45" required="" data-parsley-nmeditemailcheck  autocomplete="off" type="text" data-parsley-trigger-after-failure="focusout">
                    
                      
                       <input type="hidden" name="" id="email_hidd" value="<?php if($user_info[0]['email']!=''){echo $user_info[0]['email'];}else{ echo set_value('email');}?>">
                ...
                <label for="roleid" class="col-sm-3 control-label">Phone </label>
                	<div class="col-sm-2">
                      STD Code
                      <input type="text" class="form-control pull-right" id="stdcode"  name="stdcode" placeholder="STD Code"  value="<?php if($user_info[0]['stdcode']!=''){echo $user_info[0]['stdcode'];}else{ echo set_value('stdcode');} ?>">
                      <input type="hidden" name="" id="stdcode_hidd" value="<?php if($user_info[0]['stdcode']!=''){echo $user_info[0]['stdcode'];}else{ echo set_value('stdcode');} ?>">
                    ...
                    Phone No
                      ...
                      data-parsley-type="number" data-parsley-maxlength="12"  value="<?php if($user_info[0]['office_phone']!=''){echo $user_info[0]['office_phone'];}else{ echo set_value('phone');} ?>" data-parsley-trigger-after-failure="focusout">
                        <input type="hidden" name="" id="phone_hidd" value="<?php if($user_info[0]['office_phone']!=''){echo $user_info[0]['office_phone'];}else{ echo set_value('phone');} ?>">
                ...
                <label for="roleid" class="col-sm-3  control-label">Mobile <span style="color:#F00">*</span></label>
                	<div class="col-sm-5">
                      ...
                      data-parsley-minlength="10" data-parsley-maxlength="10" value="<?php if($user_info[0]['mobile']!=''){echo $user_info[0]['mobile'];}else{ echo set_value('mobile');} ?>"  data-parsley-nmeditmobilecheck data-parsley-trigger-after-failure="focusout" required>
                      <input type="hidden" name="" id="mobile_hidd" value="<?php if($user_info[0]['mobile']!=''){echo $user_info[0]['mobile'];}else{ echo set_value('mobile');} ?>">
                ...
                <label for="roleid" class="col-sm-3 control-label">Aadhar Card Number<!--<span style="color:#F00">*</span>--></label>
					...
					<input type="text" class="form-control " id="aadhar_card"  name="aadhar_card" placeholder="Aadhar Card Number" 
                         ...
                         value="<?php echo $user_info[0]['aadhar_card'];?>" data-parsley-trigger-after-failure="focusout">
                         <input type="hidden" id="aadhar_hidd"  name="aadhar_hidd" value="<?php  echo set_value('aadhar_card');?>">
					<?php 
					}
					else
					{
			...
			<?php 	}?>
			 <label for="roleid" class="col-sm-12 text-center">Uploaded Photo</label>
                </label>
               <label for="roleid" class="col-sm-3 text-center">
               <?php 
               ...
               <label for="roleid" class="col-sm-12 text-center">uploaded Signature</label>
               </label>
                <label for="roleid" class="col-sm-3 text-center">
                <?php
				...
				{?>
				 ...
				 <label for="roleid" class="col-sm-12 text-center">Uploaded ID Proof</label>
                </label>
                </div>
			...
			{*/
			if(!is_file(get_img_name($this->session->userdata('cscnmregnumber'),'pr')) || !is_file(get_img_name($this->session->userdata('cscnmregnumber'),'s')) || !is_file(get_img_name($this->session->userdata('cscnmregnumber'),'p')))
			{?>
