    ...
    <section class="content">
      <div class="row">
		...
		if($payment_info[0]['status']==1)
          ...
          <div class="col-sm-12">
          <a class="noprintelm" href="<?php echo  base_url()?>CSCNonreg//logout/">Logout</a>
           &nbsp;&nbsp;
       	   <a class="noprintelm" href="<?php echo  base_url()?>NonMember/Dashboard/">Home</a>
           &nbsp;&nbsp;
           <?php
           $admit_card_details = $this->master_model->getRecords('admit_card_details',array('mem_exam_id'=>$payment_info[0]['ref_id'],'mem_mem_no'=>$result[0]['regnumber'],'exm_cd'=>$exam_info[0]['exam_code'],'remark'=>1),'admitcard_image',array('admitcard_id'=>'desc')); 
           //echo $this->db->last_query();
              if(isset($admit_card_details) && count($admit_card_details) > 0 && $admit_card_details[0]['admitcard_image'] != "" && ($exam_info[0]['exam_code']==1052 || $exam_info[0]['exam_code']==1054 || $exam_info[0]['exam_code']==1053)){
          ...
          <?php if($exam_info[0]['exam_code'] == 1052 || $exam_info[0]['exam_code'] == 1054){ ?>
          &nbsp;&nbsp;
