    ...
    <section class="sidebar">
     ...
     if($this->session->userdata('cscnmregid')!=''){?>
      <div class="user-panel">
        <!--<div class="pull-left">
         <p><?php //if($this->session->userdata('cscnmregid')!=''){ echo $this->session->userdata('cscnmregid'); } ?></p>
        </div>-->
        <div class="pull-left info">
          <p>
          <?php if($this->session->userdata('cscnmregid')!=''){ 
		 	  $username=$this->session->userdata('cscnmfirstname').' '.$this->session->userdata('cscnmmiddlename').' '.$this->session->userdata('cscnmlastname');
      ...
      <ul class="sidebar-menu">
       ...
       <li class="treeview">
          <a href="<?php echo  base_url()?>CSCNonreg//logout/">
