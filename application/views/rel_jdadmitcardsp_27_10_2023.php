...
<?php }?>
                ...
                <?php 
            if($exam_code == 1002 || $exam_code == 1003 || $exam_code == 1004 || $exam_code == 1005 || $exam_code == 1006 || $exam_code == 1007 || $exam_code == 1008 || $exam_code == 1009 || $exam_code == 1010 || $exam_code == 1011 || $exam_code == 1012 || $exam_code == 1013 || $exam_code == 1014 || $exam_code == 2027 || $exam_code == 1019 || $exam_code == 1020 || $exam_code == 1031){
          ?>
              ...
              <tr style="background-color:#dcf1fc;">
                ...
                <tr>
                        <td>
                          <?php 
						if($exam_code == 1002 || $exam_code == 1010 || $exam_code == 1011 || $exam_code == 1012 || $exam_code == 1013 || $exam_code == 1014 ||  $exam_code == 2027 || $exam_code == 1017 || $exam_code == 1019 || $exam_code == 1020 || $exam_code == 1031){
					?>
                    ...
                    <li><a href="<?php echo base_url('uploads/rules_regulations/20210301_Rules and regulation of RP exam 13-jul-20.docx'); ?>" target="_blank">Click here for Rules and Regulations for Remote Proctored Examinations.</a></li>
                    ...
                    <?php if($exam_code == 1020) { ?>
                      <li><a href="<?php echo  base_url('uploads/Teamlease_Instruction/Important Instructions teamlease_141023.docx'); ?>" target="_blank">Click here for Important Instructions/ Examination Links for Remote Proctored Examinations.</a></li>
                    <?php } 
                     else if($exam_code == 1006 || $exam_code == 1007 || $exam_code == 1008) { ?>
                ...
                <?php 
						if($exam_code == 1002 || $exam_code == 1010 || $exam_code == 1011 || $exam_code == 1012 || $exam_code == 1013 || $exam_code == 1014 ||  $exam_code == 2027 || $exam_code == 1017 || $exam_code == 1019){
					?>
...
(between 7:30AM to 5:00PM)
                ...
                <?php if($exam_code == 1002 || $exam_code == 1010 || $exam_code == 1011 || $exam_code == 1012 || $exam_code == 1013 || $exam_code == 1014 ||  $exam_code == 2027 || $exam_code == 1017 || $exam_code == 1003 || $exam_code == 1004 || $exam_code == 1005 || $exam_code == 1006 || $exam_code == 1007 || $exam_code == 1008  || $exam_code == 1009 || $exam_code == 1031 || $exam_code == 1020){ ?>
                  <table cellpadding="0" cellspacing="0" width="100%" border="0" style="border-top:1px solid #198cc3; border-left:1px solid #198cc3;">
                    <tbody>
                      <tr style="background-color:#dcf1fc;">
                        <td style="text-align:left; padding:7px; border-bottom:1px solid #198cc3; border-right:1px solid #198cc3; font-weight:bold; color:#0000ff;"> <?php echo $result->created_on.' '.$transaction_no; ?> </td>
                      </tr>
