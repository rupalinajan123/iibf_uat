...
<body class="hold-transition login-page">
            ...
            <div class="row">
              <div class="col-xs-12">
                <div class="links_outer">
                  <a href="<?php echo site_url('nonmem'); ?>" class="linksx forget">Click Here to Login</a>
                  <a href="<?php echo site_url('Nonmem/forgotpassword/'); ?>" class="linksx forget">Forgot Password?</a>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() 
    {
      $.validator.addMethod("validate_otp_custom", function(value, element)
      {
        ...
        else
        {
          ...
          {
            type: "POST",
            url: "<?php echo site_url('nonmem/validation_validate_otp_forgot/0/1'); ?>",
            data: parameters,
            async: false,
            cache : false,
            dataType: 'JSON',
      ...
      $("#loginFrm").validate(
      {
        ...
        rules: 
        {
          email_mobile: {
            required: true,
            remote: {
              url: "<?php echo site_url('nonmem/validation_email_mobile_forgot_membership_no/0/1'); ?>",
              type: "post"
            }
          },
          ...
          code: {
            required: true,
            remote: {
              url: "<?php echo site_url('nonmem/validation_check_captcha_forgot_membership_no/0/1'); ?>",
              type: "post"
            }
          },
        },
    ...
    function fun_resend_otp() {
      ...
      $.ajax({
        type: 'POST',
        url: "<?php echo site_url('nonmem/set_session_member_with_otp_ajax') ?>",
        data: parameters,
        dataType: 'JSON',
        success: function(data) {
    ...
    function fun_reset_form() {
      ...
      $.ajax({
        type: 'POST',
        url: "<?php echo site_url('nonmem/reset_form_forgot_ajax') ?>",
        data: parameters,
        dataType: 'JSON',
        success: function(data) {
          if (data.flag == "success") {
    ...
    function change_captcha_image() {
      ...
      $.ajax({
        type: 'POST',
        url: site_url + 'nonmem/generate_captcha_ajax_forgot_membership_no',
