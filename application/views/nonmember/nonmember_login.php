   ...
   <!--   <div class="form-group has-feedback">
    ...
    <?php } ?>
      ...
      <ul>
        ...
        <?php // skippadmit
          if(base64_decode($this->input->get('ExId')) != 19 && base64_decode($this->input->get('ExId')) != 156)
          {
            if(!in_array(base64_decode($this->input->get('ExId')),$this->config->item('examCodeDIPCERT'))) { 
          ?>
		        <li><a class="disability forget" href="<?php echo base_url()?>nonreg/member/?Mtype=<?php echo $this->input->get('Mtype');?>&ExId=<?php echo $this->input->get('ExId');?>">
...
<p>Due to non-availability of appropriate venues, the registration for below mentioned centres will available by next week</p>
<p>&nbsp;</p>
