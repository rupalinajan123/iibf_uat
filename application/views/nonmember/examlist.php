      ...
      ?>
            <div class="form-group has-feedback">
                ...
                <?php if($row['exam_category']==1)
                  ...
                  ?>
                    <a title="<?php echo $row['description']." - ".$row['exam_code']; ?>" href="<?php echo base_url();?>nonreg/memlogin/?Extype=<?php echo $Extype;?>&Mtype=<?php echo $Mtype;?>&ExId=<?php echo base64_encode($row['exam_code']);?>"><?php echo $row['description']." - ".$row['exam_code']." ".$exam_name_append;?></a>
