          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                (Max 30 Characters)
                <div class="col-sm-3">
                  <input type="text" class="form-control" id="firstname" name="firstname" placeholder="First Name" required value="<?php echo set_value('firstname'); ?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z- ]+$/" data-parsley-maxlength="30" onchange="createfullname()" onkeyup="createfullname()" onblur="createfullname()">
                  <span class="error">
                    <?php //echo form_error('firstname');
                    ?>
                  </span>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="middlename" name="middlename" placeholder="Middle Name" value="<?php echo set_value('middlename'); ?>" data-parsley-pattern="/^[a-zA-Z- ]+$/" data-parsley-maxlength="30" onchange="createfullname()" onkeyup="createfullname()" onblur="createfullname()">
                  <span class="error">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="lastname" name="lastname" placeholder="Last Name" value="<?php echo set_value('lastname'); ?>" data-parsley-pattern="/^[a-zA-Z- ]+$/" data-parsley-maxlength="30" onchange="createfullname()" onkeyup="createfullname()" onblur="createfullname()">
                  <span class="error">
                  ...
                  <select name="selCenterName" id="selCenterName" class="form-control" required onchange="valCentre(this.value);">
                    ...
                    <?php if (count($center) > 0) {
                      foreach ($center as $crow) { ?>
                        <!--<option value="<?php //echo $crow['center_code']
                                            ?>" class=<?php //echo $crow['exammode'];
                                                                                      ?> <?php //echo  set_select('selCenterName', $crow['center_code']); 
