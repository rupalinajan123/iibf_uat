...
<body class="hold-transition login-page">
      ...
      <form class="form-horizontal" action="" method="post" name="loginFrm" id="loginFrm" autocomplete="off">
        ...
        <div style="padding: 10px 15px 20px 15px;max-width: 420px;margin: 0 auto;">
          <div class="form-group">
            <label for="regnumber" class="col-sm-12 control-label">Registration No. <span class="red">*</span> :</label>
            <div class="col-sm-12">
              <input type="text" class="form-control" placeholder="Registration No. *" name="regnumber" id="regnumber" value='<?php if($session_regnumber != "") { echo $session_regnumber; } else if(set_value('regnumber') != "") { echo set_value('regnumber'); } ?>' required <?php if($show_otp_input_flag == '1') { echo "readonly='readonly'"; } ?> onkeypress="remove_spaces('regnumber')" onkeyup="remove_spaces('regnumber')" onkeydown="remove_spaces('regnumber')">
          ...
          <div class="btn_outer">
            <div class="row">
              <div class="col-xs-12">
                ...
                <a href="<?php echo site_url('nonmem'); ?>" class="btn btn-primary btn-flat btn-block">Login with Password</a>
  ...
  <script type="text/javascript">
    ...
    function fun_resend_otp()
    {
      ...
      $.ajax({
        type: 'POST',
        url: "<?php echo site_url('nonmem/set_session_login_with_otp_ajax') ?>",
        data: parameters,
        dataType: 'JSON',
    ...
    $(document).ready(function() 
    {
      ...
      $("#loginFrm").validate({
        ...
        rules: 
        {
          ...
          regnumber: { required: true, digits: true },
          input_otp: { required: true, digits: true, validate_otp_custom:true },
          code: { required: true, remote: { url: "<?php echo site_url('login/validation_check_captcha_login_with_otp/0/1'); ?>", type: "post" } },          
        },
        messages: 
