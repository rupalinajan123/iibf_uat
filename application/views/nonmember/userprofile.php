			...
			<div class="row">
								...
								<div class="col-sm-2">
									<select class="form-control" id="state" name="state" required>
										...
										<?php if (count($states) > 0) {
											...
											<option value="<?php echo $row1['state_code']; ?>" <?php if ($user_info[0]['state'] == $row1['state_code']) { echo  'selected="selected"'; } ?>><?php echo $row1['state_name']; ?></option>
                      <?php }
										} ?>
									</select>
                ...
                <?php
								...
								<div class="form-group">
									<label for="roleid" class="col-sm-3 control-label">Gender <span style="color:#F00">*</span></label>
									<div class="col-sm-2">
										<input type="radio" class="minimal cls_gender" id="female" name="gender" required value="female" <?php if ($user_info[0]['gender'] == 'female') { echo  'checked="checked"'; } ?>> Female
										<input type="radio" class="minimal cls_gender" id="male" name="gender" required value="male" <?php if ($user_info[0]['gender'] == 'male') { echo  'checked="checked"'; } ?>> Male
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <input type="radio" class="minimal" id="U" name="optedu" value="U" <?php if ($user_info[0]['qualification'] == 'U') { echo  'checked="checked"'; } ?> onclick="changedu(this.value)" <?php echo set_radio('optedu', 'U'); ?> required="required"> Under Graduate
                    <input type="radio" class="minimal" id="G" name="optedu" value="G" <?php if ($user_info[0]['qualification'] == 'G') { echo  'checked="checked"'; } ?> onclick="changedu(this.value)" <?php echo set_radio('optedu', 'G'); ?>> Graduate
                    <input type="radio" class="minimal" id="P" name="optedu" value="P" <?php if ($user_info[0]['qualification'] == 'P') { echo  'checked="checked"'; } ?> onclick="changedu(this.value)" <?php echo set_radio('optedu', 'P'); ?>> Post Graduate
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5" <?php if ($user_info[0]['specify_qualification'] != '' || $user_info[0]['qualification'] != '') { echo 'style="display:none"'; } else { echo 'style="display:block"'; } ?> id="edu">
                ...
                <div class="form-group"> <!--priyanka d disabled forippb_emp_id >>12-july-23 -->
                  ...
                  <div class="col-sm-5">
                    <input <?php /*if ($user_info[0]['ippb_emp_id'] != '0' && $user_info[0]['ippb_emp_id'] != '')*/ if ($user_info[0]['excode'] == '997' || $user_info[0]['excode'] == '1053' || $user_info[0]['bank_bc_id_no'] != '' || ($user_info[0]['ippb_emp_id'] != '0' && $user_info[0]['ippb_emp_id'] != '')) echo ' disabled="disabled"'; ?> class="form-control" id="email" name="email" placeholder="Email" data-parsley-type="email" value="<?php echo $user_info[0]['email']; ?>" data-parsley-maxlength="45" required="" data-parsley-nmeditemailcheck autocomplete="off" type="text" data-parsley-trigger-after-failure="focusout" readonly>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2">
                    Phone No
                    <input type="text" class="form-control pull-right" id="phone" name="phone" placeholder="Phone No" data-parsley-minlength="7" data-parsley-type="number" data-parsley-maxlength="12" value="<?php echo $user_info[0]['office_phone']; ?>" data-parsley-trigger-after-failure="focusout">
                ...
                <div class="form-group"> <!--priyanka d disabled forippb_emp_id >>12-july-23 -->
                  ...
                  <div class="col-sm-5">
                    <input <?php /*if ($user_info[0]['ippb_emp_id'] != '0' && $user_info[0]['ippb_emp_id'] != '')*/ if ($user_info[0]['excode'] == '997' || $user_info[0]['excode'] == '1053' || $user_info[0]['bank_bc_id_no'] != '' || ($user_info[0]['ippb_emp_id'] != '0' && $user_info[0]['ippb_emp_id'] != '')) echo ' disabled="disabled"'; ?> type="tel" class="form-control" id="mobile" name="mobile" placeholder="Mobile" data-parsley-type="number" data-parsley-minlength="10" data-parsley-maxlength="10" value="<?php echo $user_info[0]['mobile']; ?>" data-parsley-nmeditmobilecheck data-parsley-trigger-after-failure="focusout" required readonly>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <?php
                      ...
                      <input type="text" class="form-control " id="aadhar_card" name="aadhar_card" placeholder="Aadhar Card Number" data-parsley-minlength="12" data-parsley-maxlength="12" data-parsley-type="number" size="12" value="<?php echo $user_info[0]['aadhar_card']; ?>" data-parsley-trigger-after-failure="focusout">
                ...
                <div class="form-group">
                  <label for="roleid" class="col-sm-3 control-label">Person with Benchmark Disability <span style="color:#F00">*</span></label>
                  <div class="col-sm-5">
                ...
                <div id="benchmark_disability_div" style="display:none;">
                  <div class="form-group">
                    ...
                    <div class="col-sm-5">
                      <input value="Y" name="visually_impaired" id="visually_impaired" type="radio" class="visually_impaired_y" <?php if ($user_info[0]['visually_impaired'] == 'Y') { echo  'checked="checked"'; } ?>> Yes
                      <input value="N" name="visually_impaired" id="visually_impaired" type="radio" class="visually_impaired_n" <?php if ($user_info[0]['visually_impaired'] == 'N') { echo  'checked="checked"'; } 
											elseif ($user_info[0]['visually_impaired'] != 'Y') { echo  'checked=""'; } ?>> No 
                ...
                <div class="form-group">
                  <label class="col-sm-2 text-center">
                    <div style="min-height: 100px;">
                      <?php
												$this->db->select('mem_photo, mem_sign, mem_proof, employee_proof, mem_declaration, mem_bank_bc_id_card');
                        ...
                        <img src="<?php echo base_url(); ?><?php echo get_img_name($this->session->userdata('nmregnumber'), 'p'); ?><?php echo '?' . time(); ?>" style="max-width:100%; max-height:100px;">
                        <?php
                    ...
                    <label class="col-sm-12 text-center" style="line-height: 18px; margin:8px 0 0 0;">Uploaded Photo</label>
									</label>
                  ...
                  <label class="col-sm-2 text-center">
                    <div style="min-height: 100px;">
                      <?php
                        ...
                        <img src="<?php echo base_url(); ?><?php echo get_img_name($this->session->userdata('nmregnumber'), 's'); ?><?php echo '?' . time(); ?>"  style="max-width:100%; max-height:100px;">
                        <?php
													} else if (count($kyc_info) > 0) {
                    ...
                    <label class="col-sm-12 text-center" style="line-height: 18px; margin:8px 0 0 0;">Uploaded Signature</label>
									</label>
                  ...
                  <label class="col-sm-2 text-center">
                    <div style="min-height: 100px;">
                      <?php
                        ...
                        <img src="<?php echo base_url(); ?><?php echo get_img_name($this->session->userdata('nmregnumber'), 'pr'); ?><?php echo '?' . time(); ?>"  style="max-width:100%; max-height:100px;">
                        <?php
													} else if (count($kyc_info) > 0) {
                    ...
                    <label class="col-sm-12 text-center" style="line-height: 18px; margin:8px 0 0 0;">Uploaded ID Proof</label>
									</label>
									
                  <!-- Added for fedai id proof by pooja mane 2024-08-08-->
                  <?php if(in_array($user_info[0]['excode'], $fedai_array))
										{ ?>
                    <label class="col-sm-2 text-center">
                      <div style="min-height: 100px;">
                        <?php
													if (is_file(get_img_name($this->session->userdata('nmregnumber'), 'empr'))) { ?>
                          <img src="<?php echo base_url(); ?><?php echo get_img_name($this->session->userdata('nmregnumber'), 'empr'); ?><?php echo '?' . time(); ?>"  style="max-width:100%; max-height:100px;">
                          <?php
														} else if (count($kyc_info) > 0) {
                      ...
                      <label class="col-sm-12 text-center" style="line-height: 18px; margin:8px 0 0 0;">Uploaded Employment Proof</label>
										</label>
									<?php } ?>
									
                  <!-- Added for fedai id proof by pooja mane 2024-08-14-->
                  <?php if(in_array($user_info[0]['excode'], $fedai_array)){ ?>
                    <label class="col-sm-2 text-center">
                      <div style="min-height: 100px;">
                        <?php
													if (is_file(get_img_name($this->session->userdata('nmregnumber'), 'declaration'))) { ?>
                          <img src="<?php echo base_url(); ?><?php echo get_img_name($this->session->userdata('nmregnumber'), 'declaration'); ?><?php echo '?' . time(); ?>"  style="max-width:100%; max-height:100px;">
                          <?php
														} else if (count($kyc_info) > 0) {
                      ...
                      <label class="col-sm-12 text-center" style="line-height: 18px; margin:8px 0 0 0;">Uploaded Declaration Form</label>
										</label>
									<?php } ?>
									
                  <?php if($user_info[0]['date_of_commenc_bc'] != '' && $user_info[0]['date_of_commenc_bc'] != '0000-00-00') /* Bank BC ID Card */ 
										{ ?>
                    <label class="col-sm-2 text-center">
                      <div style="min-height: 100px;">
                        <?php
													if (is_file(get_img_name($this->session->userdata('nmregnumber'), 'bank_bc_id_card'))) { ?>
                          <img src="<?php echo base_url(); ?><?php echo get_img_name($this->session->userdata('nmregnumber'), 'bank_bc_id_card'); ?><?php echo '?' . time(); ?>"  style="max-width:100%; max-height:100px;">
                          <?php
														} else if (count($kyc_info) > 0) {
														if ($kyc_info[0]['mem_bank_bc_id_card'] == 1) { ?>
                            <img src="<?php echo base_url(); ?>assets/images/default1.png<?php echo '?' . time(); ?>" height="100" width="100">
														<?php
														} else { ?>
                            <img src="<?php echo base_url(); ?>assets/images/default1.png<?php echo '?' . time(); ?>" height="100" width="100">
                      ...
                      <label class="col-sm-12 text-center" style="line-height: 18px; margin:8px 0 0 0;">Uploaded Bank BC ID Card</label>
										</label>
									<?php } ?>
								</div>
                ...
                <div class="form-group">
                  <?php 
										if(in_array($user_info[0]['excode'], $fedai_array))
										{
											if (!is_file(get_img_name($this->session->userdata('nmregnumber'), 'declaration')) ||!is_file(get_img_name($this->session->userdata('nmregnumber'), 'empr')) || !is_file(get_img_name($this->session->userdata('nmregnumber'), 'pr')) || !is_file(get_img_name($this->session->userdata('nmregnumber'), 's')) || !is_file(get_img_name($this->session->userdata('nmregnumber'), 'p'))) 
                      { ?>
										...
										else if($user_info[0]['date_of_commenc_bc'] != '' && $user_info[0]['date_of_commenc_bc'] != '0000-00-00')
										{
											if (!is_file(get_img_name($this->session->userdata('nmregnumber'), 'pr')) || !is_file(get_img_name($this->session->userdata('nmregnumber'), 's')) || !is_file(get_img_name($this->session->userdata('nmregnumber'), 'p')) || !is_file(get_img_name($this->session->userdata('nmregnumber'), 'bank_bc_id_card'))) 
                      { ?>
											<label for="roleid" class="col-sm-3  text-center"><a class="btn btn-warning " href="<?php echo base_url(); ?>NonMember/editimages/">Edit Images</a></label>
											<?php
											} 
                      ...
                      { ?>
										...
										} ?> <!-- Added for fedai id proof end by pooja mane 2024-08-08-->
								</div>
                ...
                <?php if ($user_info[0]['idproof'] != '') { ?>
                    ...
                    <div class="col-sm-5">
                      <?php if (count($idtype_master) > 0) {
                        foreach ($idtype_master as $idrow) { ?>
												<?php if ($user_info[0]['idproof'] == $idrow['id']) {
													echo  $idrow['name'];
												} ?>
												<?php
												}
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-5">
                      <?php if (count($idtype_master) > 0) {
                        $i = 1;
                        foreach ($idtype_master as $idrow) { ?>
												<input name="idproof" value="<?php echo $idrow['id']; ?>" type="radio" class="minimal" <?php if (set_value('idproof')) { echo set_radio('idproof', $idrow['id'], TRUE); } ?> <?php if ($i == count($idtype_master)) { echo 'required'; } ?>>
                  ...
                  <input type="hidden" name="idproof_hidd" id="idproof_hidd" value="<?php echo $user_info[0]['idproof']; ?>">
                    ...
                    <img src="<?php echo base_url(); ?>uploads/idproof/<?php echo $user_info[0]['idproofphoto']; ?>" height="100" width="100">
						...
						<?php /* --------------------- EMAIL VERIFCATION CODE BY POOJA MANE ON : 2024-11-15---------------------*/ ?>
...
<script>
	/* --------------------- EMAIL VERIFCATION CODE BY POOJA MANE ON : 2024-11-15---------------------*/
	...
	function send_verify_otp(type,data,selector) {
		$.ajax({
			type: 'POST',
			url: site_url + 'NonMember/send_otp/',
	...
	function send_verify_otp_mobile(type,data,selector) {
		$.ajax({
			type : 'POST',
			url  : site_url + 'NonMember/send_otp_mobile/',
