          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <?php if(in_array($member_info[0]['excode'], array(1009))) /* Employment Proof */ 
									{ ?>
                ...
                <?php if(in_array($member_info[0]['excode'], array(1009))) /* Declaration */ 
									{ ?>
                  <label class="col-sm-2 control-labelx text-center">
                    ...
                    <span class="error"><?php //echo form_error('scannedphoto'); ?></span>
									...
									{ 
										...
										{ 
											...
											if(in_array($member_info[0]['excode'], array(1009))) /* Employment Proof */  /* START : Code Added by pooja mane 2024-08-06 */
											{
												if (!is_file(get_img_name($this->session->userdata('nmregnumber'), 'empr'))) 
												{ 
													$show_submit_btn_flag = '1';
											...
											if(in_array($member_info[0]['excode'], array(1009))) /* Declaration */ /* START : Code Added by pooja mane 2024-08-14 */
											{
