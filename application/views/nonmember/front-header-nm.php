...
<div class="wrapper">
  <header class="main-header">
    <!-- Logo -->
    <a href="<?php echo base_url();?>NonMember/dashboard/" class="logo">
    ...
    <nav class="navbar navbar-static-top">
      ...
      <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button">
        <span class="sr-only"><?php echo $this->session->userdata('nmfirstname');?></span> 
      ...
      <div class="navbar-custom-menu">
        ...
        <li><img src="<?php echo base_url();?>assets/images/iibf_logo_black.png"></li>
          <li class="dropdown user user-menu">
            <a href="<?php echo  base_url()?>Nonreg/logout" class="dropdown-toggle" >
    ...
    <div class="loading" id="page_loader" style="display:none;"><img src="<?php echo base_url(); ?>assets/images/loading.gif"></div>