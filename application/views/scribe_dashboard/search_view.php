	          ...
	          <div class="searchfilter">
	            <div class="box-header">
	              ...
	              <div class="collapsee" id="collapseExample">
	                <form  class="form-control" name="searchScribeDetails" id="searchScribeDetails" action="<?php echo site_url('scribe_dashboard/scribe_list/SearchQry')?>"; method="post">
	                  <div class="row">
                        ...
                        <select class="custom_filter form-control" name="searchBy" id="searchBy" required="">
                          ...
                          <option value="01" <?php if($searchBy == '01') { echo 'selected'; } ?>>Scrib URN</option>
                          <option value="02" <?php if($searchBy == '02') { echo 'selected'; } ?>>Member no</option>
                          <option value="03" <?php if($searchBy == '03') { echo 'selected'; } ?>>Exam</option>
                          <option value="04" <?php if($searchBy == '04') { echo 'selected'; } ?>>Exam Date</option>
                          <option value="05" <?php if($searchBy == '05') { echo 'selected'; } ?>>Scribe Name</option>
                          <option value="06" <?php if($searchBy == '06') { echo 'selected'; } ?>>Scribe Mobile</option>
                        </select>
			          	  </div>
			            </div>
			            <div class="col-sm-3">
			              ...
			              <input type="text" class="form-control" id="SearchVal" name="SearchVal" placeholder="" required="" value="<?php echo $searchValue; ?>">
			              </div>
			            </div>
	                    <div class="col-md-2">
	                      <div class="form-group">
