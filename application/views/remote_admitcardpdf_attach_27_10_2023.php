				...
				<td style="text-align:left; padding:7px;"><p>The cut-off date of guidelines / instructions issued by the regulator(s) and important developments in banking and finance up to 30th June, 2023  will only be considered for the purpose of inclusion in the question papers.</p></td>
                  ...
                  <?php }?>
                   ...
                   <?php //}?>
                          ...
                          <?php }?> 
                          <?php 
					if($exam_code == 1003 || $exam_code == 1004 || $exam_code == 1005 || $exam_code == 1006 || $exam_code == 1007 || $exam_code == 1008  || $exam_code == 1009 || $exam_code == 1026 || $exam_code == 1027 || $exam_code == 1029 || $exam_code == 1028){
				?>
...
<?php 
					if($exam_code == 1003 || $exam_code == 1004 || $exam_code == 1005 || $exam_code == 1006 || $exam_code == 1007 || $exam_code == 1008  || $exam_code == 1009 || $exam_code == 1026 || $exam_code == 1027 || $exam_code == 1029 || $exam_code == 1028 || $exam_code == 1031){
				?>
