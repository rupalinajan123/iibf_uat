          ...
          <table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
            <tr>
              <td style="border:3px solid #619fda;">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
                  <tr>
                    <td><?php /*?><img src="<?php echo  base_url()?>assets/images/iibfofferings_head.jpg" /><?php */?></td>
                  </tr>
                  <tr>
                    <td>
                      <table border="0" cellpadding="0" cellspacing="0" width="80%" align="center">
                        <tr>
                          <td style="text-align:center; padding:60px 0 25px; font-size:16px; font-family:Tahoma, Geneva, sans-serif; font-weight:bold; line-height:32px;">
                            Total Registration : <?php echo $total_cnt;?><br>
                            <a href="<?php echo base_url()?>amc/annual_dashboard/csv">Download CSV</a>
                          </td>
                        </tr>
                  ...
                  <tr>
                    <td class="footer" colspan="2" width="43%" valign="middle" height="24"><?php /* Copyright &copy; 2012. */ ?> INDIAN INSTITUTE OF BANKING AND FINANCE. All rights reserved.
                    </tr>
