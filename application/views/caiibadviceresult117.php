    ...
    <td><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
        <tr>
          <td style="border:3px solid #619fda;"><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
              ...
              <tr>
              <?php
              	$frn = array('500054760','500124580','510019602');
			  ?>
                ...
                <?php if(!in_array($user_info->member_number,$frn)){?>
                    ...
                    You have passed CAIIB and eligible to appear for any one of the remaining Elective subjects of CAIIB as a separate Certificate Examination at the Dec 2017 examination. Application can be registered through Online Mode, for details visit our website www.iibf.org.in. </strong>.
                    </td>
                    <?php }else{?>
                    <?php if($user_info->no_of_attempt == 1 || $user_info->no_of_attempt == 3){?>
                    <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">
                    You will receive the Admit Letter through Email for Dec, 2017 examination 10 days before its scheduled date. In case of non receipt of the same you may download from our website www.iibf.org.in. Please note that you need not apply for the next examination again as you have already paid the exam fees for 2 attempts.
                    
                    </td>
                    <?php }?>
                    <?php if($user_info->no_of_attempt == 2){?>
                    <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">
                    You have completed  2nd attempt.  You are required to apply for the 3rd attempt for appearing at the Dec, 2017 examination. Application can be registered through Online Mode. For details of examination dates and registration visit our website.
                    
                    </td>
                    <?php }?>
                    <?php if($user_info->no_of_attempt == 4){?>
                    <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">
                    You have completed 4 attempts. You are required to apply for the examination afresh for appearing at the Dec, 2017 examination. You will not be eligible for credit of subjects passed, if any, earlier. Application can be registered through Online Mode. For details of examination dates and registration visit our website.
                    </td>
                    <?php }?>
                    <?php }?>
                <?php }else{?>    
                	<?php if($scnt == count($record)) {?>
                 	<td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">
                    You have passed CAIIB Examination and eligible to appear for CAIIB Electives - Dec 2017 examination per the rules for appearing from Foreign Centre. For details pls contact Member Support Services of the Institute at Mumbai.
                    </td>
                 <?php }?>
                 <?php if($scnt != count($record)) {?>
                 <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">
                 You are required to apply afresh for Dec 2017 Examination as per the rules for appearing from Foreign Centre. For details pls contact to Member Support Services of the Institute at Mumbai.
                 </td>
                 <?php }?>
                <?php }?>
				<?php }?>
                ...
                <?php if($scnt == count($record)) { ?>
                <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">
                You have passed the above Certificate Examination. You are eligible to appear for any of the remaining Electives of CAIIB at the Dec, 2017 examination. Application can be registered through Online Mode. For details of examination dates and registration visit our website.
                </td>
                <?php }elseif($scnt != count($record)){?>
                <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">
                You are eligible to re-appear for the above certificate examination at the Dec, 2017 examination. Application can be registered through Online Mode. For details of examination dates and registration visit our website.
                </td>
                <?php }?>
                <?php }?>
              </tr>
                ...
                <td style="padding:20px 0;"><table style="border-collapse:collapse;" width="90%" align="center">
                  ...
                  <table width="10%" align="center" border="0" cellpadding="0" cellspacing="0" style="padding:30px 0 0;">
                    <tr>
                      ...
                      <td><a href="<?php echo base_url()?>result/caiibresult" style="background-color:#ddd; color:#000; text-align:center; padding:10px 15px; text-decoration:none;">Back</a></td>
