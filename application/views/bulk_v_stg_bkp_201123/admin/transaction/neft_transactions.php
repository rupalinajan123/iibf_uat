...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    ...
    <h1> Approve NEFT Transactions </h1>
  ...
  <div class="col-md-12"> <br />
    ...
    <div class="alert alert-danger alert-dismissible" id="neft_msg_error" style="display:none">
      ...
      Capcity not available for selected batch!!</div>
            ...
            <div class="modal-body" id="confirmMessage"> 
              ...
              <div class="form-group">
                ...
                <div class="col-xs-6">
                  ...
                  <input type="text" class="form-control" name="form_utr_no" id="form_utr_no" readonly="readonly"/>
              ...
              <div class="form-group">
                ...
                <div class="col-xs-6">
                  ...
                  <input type="text" class="form-control" name="form_mem_count" id="form_mem_count" readonly="readonly" />
              ...
              <div class="form-group">
                ...
                <div class="col-xs-6">
                  ...
                  <input type="text" class="form-control" name="form_payment_amt" id="form_payment_amt" readonly="readonly" />
              ...
              <div class="form-group">
                ...
                <div class="col-xs-6">
                  ...
                  <input type="text" class="form-control" name="form_payment_date" id="form_payment_date" readonly="readonly" />
              ...
              <div class="form-group">
                ...
                <label class="col-xs-4 control-label">Bank Name </label>
...
$(function () {
	...
	var listing_url = base_url+'bulk/admin/transaction/getNeftTransactions';

	//var listing_url = base_url+'bulk/admin/Transaction_hit/getNeftTransactions';
...

{
	...
	var url = base_url+'bulk/admin/transaction/getNeftTransactionDetails';
...
function confirmApprove(action)
{
	...
	var base_url = '<?php echo base_url(); ?>';
	var url = base_url+'bulk/admin/transaction/approveNeftTransactions';
		...
		success: function(res) {
			if(res)
			{
				if(res.success == 'success')
				{
					...
					/*var url_admitcard = base_url+'bulk/admin/transaction/bulk_generate_admitcard';
					$.ajax({
						url: url_admitcard,
						type: 'POST',
						dataType:"json",
				...
				{
					$("#neft_msg_error").html(res.success);
					$("#neft_msg_error").show();
					//return false;
				}
				$(".loading").hide();
