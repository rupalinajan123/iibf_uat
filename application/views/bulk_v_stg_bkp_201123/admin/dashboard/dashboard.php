...
<?php $this->load->view('iibfdra/admin/includes/sidebar');?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1> Dashboard </h1>
      <ol class="breadcrumb">
        <li><a href="<?php echo base_url(); ?>iibfdra/admin/dashboard"><i class="fa fa-dashboard"></i> Dashboard</a></li>
      </ol>
    </section>
    <!-- Main content -->
...
function getSearchResult()
{
	...
	var listing_url = base_url+'iibfdra/admin/dashboard/getSearchResult';
