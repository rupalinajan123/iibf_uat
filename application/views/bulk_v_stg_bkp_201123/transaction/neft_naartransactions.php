...
$(function () { 
	...
	var listing_url = base_url+'bulk/NaarBulkTransaction/getNeftTransactions';
...
function confirmVerify(id)
{
	...
	var base_url = '<?php echo base_url(); ?>';
	var url = base_url+'bulk/NaarBulkTransaction/getNeftTransactionDetails';
...
function updateNeft()
{
	...
	var base_url = '<?php echo base_url(); ?>';
	var url = base_url+'bulk/NaarBulkTransaction/updateNeftTransaction';
	
	$.ajax({
		url: url,
		type: 'POST',
		dataType:"json",
		data: {id: txn_id, utr_no: utr_no, payment_date: payment_date},
		success: function(res) {
			if(res)
			{
				if(res.success == 'success')
