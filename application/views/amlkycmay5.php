                    ...
                    <tr>
                      ...
                      <td class="content" width="55%" bgcolor="#d8e4f1">
                        <select name="exam" id="exam" class="text1" style="min-width:218px;">
                          ...
                          <option value="34_705">ANTI-MONEY LAUNDERING AND KNOW YOUR CUSTOMER</option>
                          <option value="53_705">SME FINANCE FOR BANKERS</option>
                          <option value="58_705">CUSTOMER SERVICE AND BANKING CODES AND STANDARDS</option>
                        </select>
                      </td>
                    </tr>
                    <tr>
