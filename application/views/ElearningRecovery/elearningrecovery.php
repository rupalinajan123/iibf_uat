...
<div class="container">
  <section class="content-header box-header with-border" style="height: 45px; background-color: #1287C0; ">
    <h1 class="register">E-learning Recovery Form</h1>
    <br />
  </section>
  <section class="">
    <div class="row">
      <div class="col-md-12 col-sm-12" style="">
        ...
        <?php }?>
        <form name="getDetailsForm" id="getDetailsForm" method="post" action="<?php echo base_url(); ?>ElearningRecovery">
          <br />
          <div class="">
...
?>" <?php if (isset($row['regnumber'])) { echo "readonly='readonly'";} elseif (set_value('regnumber')) { echo "readonly='readonly'"; } ?> style="border-color:#000;" title="Membership No.">
            ...
            <div class="col-sm-12 col-md-3">
              <?php 
				...
				?>
              <a href="<?php echo base_url();?>ElearningRecovery" class="btn btn-warning" id="modify" style="">Reset</a>
			  ...
			  ?>
                <tr>
                  ...
                  <td><?php 
                   ...
                   <td><?php 
				 	$i=1;  
				   foreach($admit_card_details as $r) {
								echo $i++.' '.$r['sub_dsc'].'<br><br>'; 
				   } ?></td>
                  ...
                  <td><?php  
                    ...
                    <?php
                        ...
                        ?>
                    <a href="<?php echo base_url();?>ElearningRecovery/stored_details/<?php echo base64_encode($value['invoice_id']); ?>" class="btn btn-info" style="width: 75px;">Pay Now</a>
                    <?php }?></td>
                </tr>
                <?php 
			  $sr++;
...
window.addEventListener('popstate', function(event) {
    window.location.assign(site_url+"ElearningRecovery/");
});
