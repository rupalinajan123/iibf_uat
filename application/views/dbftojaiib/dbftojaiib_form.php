          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <label for="roleid" class="col-sm-3 control-label">DB&F Membership Number <span style="color:#f00">*</span></label>

               

                <div class="col-sm-5">
                 
                  <input type="text" class="form-control exam_form_field" id="dbf_regnumber" name="dbf_regnumber" placeholder="DBF Membership Number" required value="<?php echo ('' !== set_value('dbf_regnumber'))?  set_value('dbf_regnumber') : $aCandidate['dbf_regnumber']; ?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z- ]+$/" data-parsley-maxlength="30" >
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  ...
                  <input readonly required type="text" class="form-control exam_form_field display_name"   id="display_name" name="display_name" placeholder="Full Name"  >
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  ...
                  <input type="text" required readonly class="form-control exam_form_field" id="dateofbirth" name="dateofbirth" placeholder="Date Of Birth"  >
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  ...
                  <input type="text" required readonly class="form-control exam_form_field mobile" id="mobile" name="mobile" placeholder="Mobile"  >
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  ...
                  <input type="text" required readonly class="form-control exam_form_field" id="email" name="email" placeholder="Email"  >
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5 "> 
                <input  type="text" class="form-control exam_form_field" id="certificate_number" name="certificate_number" placeholder="Certificate Number" required value="<?php echo ('' !== set_value('certificate_number'))?  set_value('certificate_number') : $aCandidate['certificate_number']; ?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z- ]+$/" data-parsley-maxlength="30" >

                  <div class="error" id="error_certificate_number"></div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  ...
                  <input required type="text"  id="certificate_date" name="certificate_date"  class="form-control pull-right exam_form_field certificate_date" readonly="readonly">
                  <br>
                 

                </div>
                <div class="col-sm-9 datemsgdisplay"  style="display:none;">
                <span>Physical DB&F certificate issued to you has to be couriered/sent to the IIBF at the address –  “The Examination Department, Indian Institute of Banking & Finance, Kohinoor City Commercial - II Tower-I, 2nd Floor, Kirol Road, Off-L.B.S Marg Kurla- West Mumbai - 400 070”. Only after receipt of the physical certificate will the JAIIB Certificate be issued which kindly note</span>
                </div>
              </div>
              </div>
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input  type="file" class="" name="offer_letter" id="offer_letter" required onchange="validateOfferLetterFile(event, 'error_photo_size', 'image_upload_offer_letter_preview', '1000kb')">
                  ...
                  <span class="note">Please Upload only .pdf  Files upto 1MB</span></br>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  ...
                  <input required type="text"  id="bank_letter_date" name="bank_letter_date"  class="form-control pull-right exam_form_field bank_letter_date" >
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  ...
                  <input required type="text"  id="bank_joining_date" name="bank_joining_date"  class="form-control pull-right exam_form_field bank_joining_date" >
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  ...
                  <ol>
                    ...
                    <li> Declaration content will be here </li>
...
$(function(){
  ...
  $('#dbf_regnumber').focusout(function(event){

    getDBFdetails();

});
getDBFdetails();
function getDBFdetails() {
  $('#display_name').val('');
        $('#mobile').val('');
        $('#email').val('');
        $('#dateofbirth').val('');
  ...
  if($('#dbf_regnumber').val()!=''){

    event.preventDefault();
    $('.dbf_regnumber_error').html('');
    $.ajax({

    type: 'POST',
    data: {dbf_regnumber : $('#dbf_regnumber').val(),regnumber:$('#regnumber').val()},

    url: site_url+'Dbftojaiib/ajax_cross_check_dob/',
    ...
    {	
...

      {
        ...
        $('#display_name').val(json.firstname+' '+json.lastname);
        $('#mobile').val(json.mobile);
        $('#email').val(json.email);
        $('#dateofbirth').val(json.dateofbirth);
      } 
      else {
        $('.dbf_regnumber_error').html('Details are not Matched with entered member number');
      }
...
$('#certificate_number').focusout(function(event){

    getCERdetails();

  });
  $('#preview').click(function(e) { // <- goes here !
  ...
  getCERdetails();
  function getCERdetails(formsubmit=0) {
    $('.datemsgdisplay').hide();
    $('#certificate_date').val('');
    if($('#certificate_number').val()!='' && $('#dbf_regnumber').val()!=''){

      event.preventDefault();
      $('#error_certificate_number').html('');
      $.ajax({

      type: 'POST',
      data: {dbf_regnumber : $('#dbf_regnumber').val(),certificate_number:$('#certificate_number').val()},

      url: site_url+'Dbftojaiib/ajax_cross_check_certificate/',
      ...
      {	
        ...
        {
          var json = $.parseJSON(res); 
          $('#certificate_date').val(json.certificate_date);
          if(json.certificate_date_msg=='1') {
            $('.datemsgdisplay').show();
          }
          else {
            $('.datemsgdisplay').hide();
          ...
          $('#error_certificate_number').html('Invalid Certificate Number');
        }
