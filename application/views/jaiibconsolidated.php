...
unfair practices being established.
   ...
   <table width="10%" align="center" border="0" cellpadding="0" cellspacing="0" style="padding:30px 0 0;">
                    <tr>
                      ...
                      <td>
                      <a href="<?php echo base_url();?>marksheet/jaiibresult/<?php echo base64_encode($exam_p)?>" style="background-color:#ddd; color:#000; text-align:center; padding:10px 15px; text-decoration:none;">Back</a>
     ...
     <table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
	   ...
	   <?php 
			...
			if(count($datearr) > 0) 
			{
				...
				$finaldate1 = date("d-m-Y",max($farr));
				echo date('d-M-Y',strtotime($finaldate1));
