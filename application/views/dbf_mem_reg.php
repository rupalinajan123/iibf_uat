...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      (Please read "Instructions to Applicants" before filling up the form)
       </h1>
      <!--<ol class="breadcrumb">
...
<div class="box-header with-border nobg">
			  ...
			  {echo 'style="display:block"';}?>  id="edu">
                ...
                <label for="roleid" class="col-sm-3 control-label">Phone </label>
                	<div class="col-sm-4">
                      ...
                      <input type="text" class="form-control" id="stdcode"  name="stdcode" placeholder="STD Code"  value="<?php echo set_value('stdcode');?>" style="width:55%;"  data-parsley-type="number" data-parsley-maxlength="4">
                ...
                <label for="roleid" class="col-sm-3 control-label">Aadhar Card Number <span style="color:#f00">*</span></label>
                	<div class="col-sm-5">
                       ...
                       required value="<?php echo set_value('aadhar_card');?>"  data-parsley-minlength="12" data-parsley-maxlength="12" data-parsley-type="number" size="12">
        ...
        <div class="box box-info">
          ...
          <h3 class="box-title">Exam Details:</h3>
            ...
            <input id="fee" name="fee" type="hidden" value="<?php echo $examinfo[0]['fee_amount'];?>">
