...
echo date('Y-m-d', strtotime($batch_info[0]['program_reg_to_date']));
                  ...
                  <td align="center">    <a href="<?php echo base_url();?>admin/trainingbatch/TrainingDashboard/download_CSV/<?php echo $row['batch_code']; ?>/<?php echo $row['training_type']; ?>/<?php echo $row['center_name'];?> ">
...
.pp0 ,.pp2, .pp3,.pp4,.pp5, .pp6 , .pp7, .pp8 , .pp9 ,.pp10 ,.pp11 {
 display:none;	
}
</style>
