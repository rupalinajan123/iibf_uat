		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box">    
					...
					<!--<a href="<?php echo base_url('Amp_dashboard/download_bulk_invoice/self'); ?>" class="btn btn-primary">Download Invoice <?php echo date('Y'); ?></a>
					<a href="<?php echo base_url('Amp_dashboard/download_bulk_examForm/self'); ?>" class="btn btn-primary">Download Exam Form <?php echo date('Y'); ?></a>   -->   	
                ...
                <tbody class="no-bd-y" id="list2">
									<?php 
										//echo "<pre>"; print_r($self_list); exit;
										$k = 1;
										if(count($self_list) > 0)
										{
											foreach($self_list as $res)
											{
												echo '<tr><td>'.$k.' </td>';
												...
												if($res['payment_option']==5){
												    echo '<td>Recovery Amount </td>';
												}else{
												    echo '<td>'.$res['payment'].' </td>';
												}
												
												echo '<td>'.$res['date'].' </td>';
											    echo '<td><a class="btn btn-xs vbtn" href="'.base_url().'amp_dashboard/self_pdf/'.base64_encode($res['receipt_no']).'">Exam Form</a>
											    <a class="btn btn-xs vbtn" href="'.base_url().'uploads/ampinvoice/user/'.$res['invoice_image'].'" download>Invoice</a </td></tr>';
...
<style>
	...
	.pp0 , .pp2,.pp3,.pp4, .pp6 , .pp7, .pp8 , .pp9 { display:none;	}
