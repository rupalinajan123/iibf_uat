			...
			<div class="col-xs-12">
				<div class="box">          	
					...
					<div class="row" >
						...
						<!--<a href="<?php echo base_url('Amp_dashboard/download_bulk_invoice/bank_paid'); ?>" class="btn btn-primary">Download Invoice <?php echo date('Y'); ?></a>  
						<a href="<?php echo base_url('Amp_dashboard/download_bulk_examForm/bank_paid'); ?>" class="btn btn-primary">Download Exam Form <?php echo date('Y'); ?></a> -->             
									...
									<?php 
										...
										if(count($bank_list) > 0)
										{
											foreach($bank_list as $res)
											{
												...
												echo '<td>'.$res['date'].' </td>';
											    echo '<td><a class="btn btn-xs vbtn" href="'.base_url().'amp_dashboard/bankpaid_pdf/'.base64_encode($res['receipt_no']).'">Exam Form</a>
