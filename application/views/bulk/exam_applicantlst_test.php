          ...
          <div class="box">
            <div class="box-header">
              ...
              <div class="pull-right">
                ...
                <?php if($exam_code != $this->config->item('examCodeDBF') && $exam_code != 1017 && $exam_code != 1018){?>
                <a href="<?php  echo base_url();?>bulk/BulkApply/add_member" class="btn btn-warning">Apply for Member</a> <a href="<?php  echo base_url();?>bulk/BulkApplyNM/add_member" class="btn btn-warning">Apply for Non Member</a>
              ...
              <table id="listitems2" class="table table-bordered table-striped dataTables-example">
                ...
                <tbody class="no-bd-y" id="list">
                  <?php
				  	$mname = '';
			              	    ...
			              	    if(count($member_list) > 0){
									 ...
									 $member_info = $this->master_model->getRecords('bulk_member_detail',array('regnumber'=>$row['regnumber']),'member_name,registrationtype,bank_emp_id,isactive');
									 
									 if(count($member_info) == 0 || empty($member_info)){
										 $member_info = $this->master_model->getRecords('member_registration',array('regnumber'=>$row['regnumber'],'isactive'=>'1'),'registrationtype,lastname,middlename,firstname,bank_emp_id,isactive,regnumber,regid');
										  if(empty($member_info))
										  {
												$member_info = $this->master_model->getRecords('member_registration',array('regid'=>$row['regnumber'],'isactive'=>'0'),'registrationtype,lastname,middlename,firstname,bank_emp_id,isactive,regnumber,regid');
									  	  }
									 } 
                  ...
                  <tr>
                    ...
                    <td>
						<?php 
						  		echo $member_info[0]['bank_emp_id'];
						?>
                     </td>
                    <td>
					<?php 
						
						if(isset($member_info[0]['member_name']) && $member_info[0]['member_name'] !=''){
							$mname = $member_info[0]['member_name'];	
						}else{
							$mname = $member_info[0]['firstname'].' '.$member_info[0]['middlename'].' '.$member_info[0]['lastname'];
						}
                    ...
                    <td align="center"><?php echo $member_info[0]['registrationtype']; ?></td>
