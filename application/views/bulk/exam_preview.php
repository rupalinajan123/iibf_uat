...
?>  <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <?php 
		...
		$function = "Msuccess";
    ?>
	<form class="form-horizontal" name="member_exam_comApplication" id="member_exam_comApplication"  method="post"  enctype="multipart/form-data" action="<?php echo base_url();?>bulk/BulkApplyNM/<?php echo $function;?>/">
               ...
               <div class="form-group">
                ...
                <label for="roleid" class="col-sm-3 control-label">Phone : STD Code </label>
                	<div class="col-sm-2">
					 ...
					 if(isset($user_info[0]['office_phone']))
					 {
					 	echo $user_info[0]['office_phone'];
					 }
					 elseif(isset($user_info[0]['phone']))
					 {
					 	echo $user_info[0]['phone'];
					 }
					 else
					 {
					 	echo '-';
            ...
            <div class="box-body">
				...
				{?>
                    <div class="form-group grayDiv">
                          	  <label for="roleid" class="col-sm-<?php echo $colsize; ?> control-label"><strong class="black_clr">Eligible Subject</strong></label>
                ...
                <label for="roleid" class="col-sm-3 control-label">Bank Branch</label>
                	<div class="col-sm-2">
                 	  <?php if(count($bulk_branch_master) > 0){
                       	...
                       	<?php if($this->session->userdata['examinfo']['bank_branch']==$row1['id']){echo  $row1['bname'];}?>
                        <?php } } ?>
					</div>
				</div>
				<?php } ?>
                ...
                <label for="roleid" class="col-sm-3 control-label">Bank Designation</label>
                	<div class="col-sm-2">
                 	  <?php if(count($bulk_designation_master) > 0){
                       	...
                       	<?php if($this->session->userdata['examinfo']['bank_designation']==$row1['id']){echo  $row1['dname'];}?>
                        <?php } } ?>
					</div>
		</div>
		<?php } ?>
