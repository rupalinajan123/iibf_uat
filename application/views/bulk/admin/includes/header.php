...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <header class="main-header">
        ...
        <!-- Logo -->
        <a href="#" class="logo"><strong>IIBF</strong></a>
        <!-- Header Navbar: style can be found in header.less -->
        <nav class="navbar navbar-static-top">
            <!-- Sidebar toggle button-->
            <a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button">
                <span class="sr-only"><?php echo $bulkuserdata['name'];?></span> 
			...
			<div class="navbar-custom-menu">
                <ul class="nav navbar-nav navlogo">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="<?php echo  base_url()?>bulk/admin/login/Logout" class="dropdown-toggle" ><!--data-toggle="dropdown"-->
                            <span class="hidden-xs"><?php if($bulkuserdata['username']!=''){ echo $bulkuserdata['username']; } ?></span>
