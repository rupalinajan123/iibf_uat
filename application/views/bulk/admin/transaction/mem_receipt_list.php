		...
		<td align='center'>	
			<table width="80%" border="1" align="center" cellpadding="5" cellspacing="" style="border-collapse:collapse">
				<tr>
                    ...
                    <td width="20%" align="center">Member No.</td>
                    <td width="35%" align="center">Candidate Name</td>
				...
				<tr>
					...
					<td width="35%" align="center"><?php echo $row['firstname'] . " " . $row['lastname']; ?></td>
					<!--<td width="10%" align="center"><?php //echo $row['exam_fee']; ?></td>-->
					<td width="25%" align="center" colspan="2">
						<a target="_blank" href="<?php echo base_url(); ?>bulk/admin/transaction/mem_receipt/<?php echo base64_encode($txn_id); ?>/<?php echo base64_encode($row['regid']); ?>"> View Receipt </a>
					</td>
				</tr>
