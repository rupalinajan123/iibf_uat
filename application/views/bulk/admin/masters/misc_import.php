        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Import Misc Master</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="box-body">
             ...
             <?php } ?>
                <div class="form-group">
                	<label for="password" class="col-sm-6 control-label">Upload Text File</label>
                     <div class="col-sm-6">
                        <input type="file" name="miscmasterfile" required id="miscmasterfile"> 
                         <span class="error"><?php echo form_error('miscmasterfile');?></span>
                         <small> (Please upload text file with 2MB Size)</small> 
                    </div>
                </div>
                <div class="form-group" align="center">
                	<a href="<?php echo base_url();?>uploads/admin/masters_sample_files/DRA_MISC_PARAMETER_ALL_212.TXT" target="_blank">Click here to check the sample file format</a>
                </div>
              ...
              <div class="box-footer">
                  <div class="col-sm-2 col-xs-offset-5">
                    ...
                    <a href="<?php echo base_url();?>iibfdra/admin/MiscMaster" class="btn btn-default pull-right">Back</a>
                    </div>
              </div>
           </div>
        </div>
