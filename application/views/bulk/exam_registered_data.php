...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1> CSC Bulk Exam Registered data </h1>
    <?php //echo $breadcrumb; ?>
  </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
			  ...
			  <div class="row">
              <div class="control-group col-md-2" id="div_authority_CC">
                    <label for="textfield" class="control-label"><strong>Exam code</strong></label>
                        <!-- Multiple Board Dropdown-->
                        <div class="controls" id="board_dd_CC">
                          <input class="input-large form-control exam_code" name="exam_code" value="<?php if(isset($_POST['exam_code'])) echo $_POST['exam_code']; ?>" id="exam_code" placeholder="Exam code" >
                        </div>
              </div>
           <div class="col-md-2" >
            <div class="control-group" id="div_authority_CC">
                    <label for="textfield" class="control-label"><strong>Exam Period</strong></label>
                        <!-- Multiple Board Dropdown-->
                        <div class="controls" id="board_dd_CC">
                          <input class="input-large form-control exam_period" autocomplete="off"  name="exam_period" value="<?php if(isset($_POST['exam_period'])) echo $_POST['exam_period']; ?>" id="exam_period" placeholder="Exam period">
                        </div>
            </div>
          </div>
          <div class="col-md-3" >
            <div class="control-group" id="div_authority_CC">
             ...
             <div class="control-group col-md-3" id="div_authority_CC">
          ...
          &nbsp;
            ...
            <div class="col-sm-4">
              ...
              <a href="javascript:void(0);" link="<?php echo base_url();?>admin/venue_master/Send_bulk_data_to_csc/?member_ids=<?php echo $_POST['member_ids']; ?>&exam_date=<?php echo $_POST['exam_date']; ?>&register_date=<?php echo $_POST['register_date']; ?>"> 
              <button type="button" class="btn btn-success sendDataToCsc ">Send Bulk Data To CSC</button>
...
<script type="text/javascript">
            ...
            $('.sendDataToCsc').on('click', function(e) {
              if($('.exam_date').val()=='' && $('.member_ids').val()=='' && $('.exam_code').val()=='' && $('.exam_period').val()=='')
              {
              ...
              $.ajax({
                  type: 'POST',
                  url: "<?php echo base_url();?>admin/venue_master/Send_bulk_data_to_csc/?member_ids="+$('.member_ids').val()+"&exam_date="+$('.exam_date').val()+"&exam_code="+$('.exam_code').val()+$('.exam_period').val(),//$(this).parent('a').attr('link'),
                 ...
                 // data: 'center_code=' + $(elm).attr('center_code')+'&venue_code='+ $(elm).attr('venue_code'),
                  success: function(html) {
                      ...
                      $('.sendDataToCsc').text('Send Bulk Data To CSC');
            ...
            $(function() {
               ...
               <?php if(isset($_POST) && !empty($_POST)) { ?>
                ...
                $('#listitems').DataTable({
                      ...
                      'serverMethod': 'get',
                      'ajax': {
                        'url':"<?=base_url()?>bulk/CSCBulkDashboard/showExamRegisteredData?exam_date="+$('.exam_date').val()+'&member_ids='+$('.member_ids').val()+'&exam_code='+$('.exam_code').val()+'&exam_period='+$('.exam_period').val(),
                     //   dataSrc:""
                      },
