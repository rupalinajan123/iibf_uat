...
<table width="980px" border="0" cellspacing="0" cellpadding="0" class="bordeTable" align="center">
  ...
  <tr>
    ...
    <?php if($exam_code == 1015){?>
    <p><strong>Center Code:</strong> <?php echo $center_name;?></p>
    <?php }?>
    </td>
    <td width="584">&nbsp;</td>
  </tr>
  ...
  <tr>
    <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td style="border-bottom: none;"><p><?php echo $fee_amount;?></p></td>
        <td style=" border-bottom: none;"><p>1</p></td>
        <td style="border-right: none; border-bottom:none; "><p><?php echo $fee_amount;?></p></td>
      </tr>
      <!--<tr>DBFMOUPAYMENTCHANGE
      ...
      <tr>
        ...
        <td style=" border-bottom: none; border-top: none;">&nbsp;</td>
        <td style=" border-right: none; border-top:none;"><p><?php echo $igst_amt;?></p></td>
      </tr>
      ...
      <tr>
        ...
        <td style=" border-top:none;">&nbsp;</td>
        <?php if($ste_code == 'MAH'){?>
        <td style=" border-right: none;"><p><strong><?php echo $cs_total;?></strong></p></td>
        <?php }elseif($ste_code != 'MAH'){?>
        <td style=" border-right: none;"><p><strong><?php echo $igst_total;?></strong></p></td>
        <?php }?>
