...
<?php $this->load->view('google_analytics_script_common'); ?>
  ...
  <link rel="stylesheet" href="<?php echo base_url()?>assets/css/bulk-subject-pre.css">
  
<!-- jQuery 2.2.3 -->
<!-- Data Tables -->
<script src="<?php echo base_url();?>assets/admin/dist/js/jquery.date-dropdowns.js"></script>
  <script src="<?php echo base_url()?>js/bulk_validation.js?<?php echo time(); ?>"></script>
<script>
...
<div class="wrapper">
  <header class="main-header">
    <!-- Logo -->
    <a href="<?php echo base_url();?>bulk/Bankdashboard" class="logo">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav navlogo">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="<?php echo  base_url()?>bulk/Moulogin/Logout" class="dropdown-toggle" >
            <?php }elseif($this->session->userdata('institute_id') != '10004NAR'){ ?>
            <a href="<?php echo  base_url()?>bulk/Banklogin/Logout" class="dropdown-toggle" ><!--data-toggle="dropdown"-->
            <?php }else{?>
            <a href="<?php echo  base_url()?>bulk/Naarlogin/Logout" class="dropdown-toggle" >
            <?php } ?> 
              <span class="hidden-xs"><?php if($this->session->userdata('username')!=''){ echo $this->session->userdata('username'); } ?></span>
           <?php //echo $this->session->userdata('institute_id')?>   Logout
