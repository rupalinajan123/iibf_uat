...
<div class="content-wrapper">
    ...
    <section class="content-header">
     ...
     <!-- <a  href="<?php echo base_url()?>bulk/BulkApplyNM/comApplication_reg/">Modify</a>->
      </h1>-->
      <br>
      <!--<ol class="breadcrumb">
    ...
    action="<?php echo base_url()?>bulk/BulkApplyDB/Msuccess_reg/">
       ...
       <!---->
        ...
        <div class="box-body">
           ...
           <?php 
              ...
              <?php } ?>
              <label for="roleid" class="col-sm-1 text-center"><strong class="black_clr">Exam Date</strong></label>
              <?php if(!in_array($this->session->userdata('examcode'),$this->config->item('skippedAdmitCardForExams')))  { ?>
