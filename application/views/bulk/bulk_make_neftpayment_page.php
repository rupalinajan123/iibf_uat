...
if ($this->session->flashdata('error') != '') {?>
        ...
        <?php } ?>
                            <div class="col-md-12 formprocessing" style="display:none;">Processing..Please do not refresh page..</div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                      ...
                                      <strong style="color:#000">  Bank : </strong> State bank of India
                                       ...
                                       <br>
                                       <strong style="color:#000">Type of Account : </strong> CURRENT
                                        <br>
                                       <strong style="color:#000">Current Account No. : </strong> 32344902738
                                        <br>
...
<script src="<?php echo base_url()?>assets/js/parsley.min.js"></script>
    ...
    <script>
    <?php
      if($this->session->userdata('mou_flg')==1 && $current_exam_code==420) { ?>  
