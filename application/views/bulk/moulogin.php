   ...
   <form action="" method="post" name="loginFrm" id="loginFrm">
	<!--<div style="background-color:#7fd1ea; color:#fff; padding:3px 10px; margin-bottom:5px; font-size:16px; text-align:center;"><strong>Bank Login</strong></div>-->
      <div class="form-group has-feedback clearfix">
        <label for="text" class="col-md-6">MOU College/Institute <span class="red">*</span> :</label>
         ...
         <input type="text" class="form-control" placeholder="MOU College/Institute" name="bankname" value='<?php echo set_value('bankname'); ?>' autocomplete="off" required>
...
<script>
  ...
  $(function () {
	...
	$('#new_captcha').click(function(event){
		...
		$.ajax({
			type: 'POST',
			url: site_url+'bulk/Moulogin/generatecaptchaajax/',
