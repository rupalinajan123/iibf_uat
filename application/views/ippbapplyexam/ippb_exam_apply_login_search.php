...
<div class="container">
	<section class="content-header">
		<h1 class="register">Login Form (For Candidates) India Post Payments Bank</h1><br />
	</section>
	<span class="error">
		<?php
					...
					<div class="box box-info">
						...
						<div class="box-body">
							...
							<div class="form-group">
								<label class="col-sm-4 control-label">Enter Employee ID/Agent ID<span style="color:#F00">*</span></label>
								<div class="col-sm-5">
					...
					<div class="box box-info">
						...
						<table class="table table-bordered">
							<thead>
								...
								<tbody>
									<tr>
										<td><?php echo $aCandidate['emp_id']; ?></td>
						...
						<div class="col-md-12 text-center mb20">
							<button type="button" class="btn btn-info send_otp" name="send_otp" id="send_otp" data-firstname="<?php echo $aCandidate['firstname']; ?>" data-emp_id="<?php echo $aCandidate['emp_id']; ?>" data-email="<?php echo $aCandidate['email']; ?>" data-mobile="<?php echo $aCandidate['mobile']; ?>">Send OTP <div class="ajax_loader hide_loader"></div></button>
						</div>
						<div class="col-md-12">
							<div class="otp_wrapper">
								...
								<div class="otp_wrapper_body">
									...
									<div class="form-group">
										<label for="pwd">Mobile OTP:</label>
										<input type="password" class="form-control" id="verify_otp_input" placeholder="Enter the OTP Received on Registered Mobile Number" autocomplete="new-password">
									...
									<input type="hidden" class="resend_emp_id" name="resend_emp_id" value="<?php echo $aCandidate['emp_id']; ?>">
...
<script>
	$(document).ready(function() {
		$('.send_otp').on('click', function() {
			...
			$.ajax({
				url: '<?php echo base_url(); ?>Ippbapplyexam/send_otp',
				type: 'post',
				dataType: "json",
				data: {
					emp_id: emp_id,
		...
		$('.verify_otp_btn').on('click', function() {
			...
			var otp_id = $('.otp_id').val();
			$.ajax({
				url: '<?php echo base_url(); ?>Ippbapplyexam/verify_otp',
				type: 'post',
				dataType: "json",
				data: {
				...
				success: function(data) {
					if (data.status == 'success') {
						...
						setTimeout(function() {
							window.location.href = "<?php echo base_url(); ?>Ippbapplyexam/candidate_details/<?php echo base64_encode($aCandidate['emp_id']); ?>";
						}, 1000);
					} else {
