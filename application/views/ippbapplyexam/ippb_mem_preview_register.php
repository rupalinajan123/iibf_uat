...
<div class="content-wrapper">
    ...
    action="<?php echo base_url()?>Ippbapplyexam/addmember/">
    <section class="content">
      <div class="row">
        ...
        <div class="form-group">
            <label for="roleid" class="col-sm-3 control-label">Are you associated with a Corporate BC? </label> 
            <div class="col-sm-2">
             <?php echo $this->session->userdata['enduserinfo']['are_you_corporate_bc']; ?>
              <span class="error"><?php //echo form_error('are_you_corporate_bc');?></span>
            </div>
        </div>
        <?php if($this->session->userdata['enduserinfo']['are_you_corporate_bc']=='Yes'){ ?>
        <div class="form-group">
            <label for="roleid" class="col-sm-3 control-label">Corporate BC </label> 
            <div class="col-sm-2">
             <?php echo $this->session->userdata['enduserinfo']['corporate_bc_option']; ?>
              <span class="error"><?php //echo form_error('corporate_bc_option');?></span>
            </div>
        </div>
        <?php }
        if($this->session->userdata['enduserinfo']['corporate_bc_option']=='Other'){
         ?>
        <div class="form-group">
            <label for="roleid" class="col-sm-3 control-label">Corporate BC associated with</label>
            <div class="col-sm-3">
                <?php echo $this->session->userdata['enduserinfo']['corporate_bc_associated']; ?>
            </div>
        </div>
        <?php } ?>
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <?php echo date("d-m-Y",strtotime($this->session->userdata['enduserinfo']['date_of_commenc_bc'])); ?>
            </div>
        </div>
        <div class="form-group">
            <label for="roleid" class="col-sm-3 control-label">Bank BC ID No</label>
            <div class="col-sm-5 ">
             <?php echo $this->session->userdata['enduserinfo']['bank_bc_id_no'];?>
        ...
        <label for="roleid" class="col-sm-3 control-label">Employee ID </label>
            <div class="col-sm-5">
            <?php echo $this->session->userdata['enduserinfo']['emp_id'];?>
            </div>
        </div>  
        
        <div class="form-group">
        <label for="roleid" class="col-sm-3 control-label">Branch Name </label>
            <div class="col-sm-5">
            <?php echo $this->session->userdata['enduserinfo']['branch'];?>
            </div>
        </div>  

        <div class="form-group">
        <label for="roleid" class="col-sm-3 control-label">Circle Name </label>
            <div class="col-sm-5">
            <?php echo $this->session->userdata['enduserinfo']['circle'];?>
            </div>
        </div>  
        ...
        <div class="box-body">
            ...
            <div class="col-sm-9 ">
             ...
             <div id="error_dob_size"></div>
              ...
              <label for="roleid" class="col-sm-3 text-center"><strong class="black_clr">Subject(s)</strong></label>
            ...
            <?php 
				   if(count($compulsory_subjects) > 0 ) 
				   {
					   ...
					   foreach($compulsory_subjects as $k=>$v)
					   {
						 ...
						 $get_venue_details=$this->master_model->getRecords('venue_master',array('venue_code'=>$v['venue'],'center_code'=>$this->session->userdata['enduserinfo']['selCenterName']));
						...
						$venue_add_finalstring= preg_replace('#[\*]+#', ',', $venue_add);
						   ...
						   ?>
            <div class="form-group">
              <label for="roleid" class="col-sm-3"><?php echo $v['subject_name'];?></label>
