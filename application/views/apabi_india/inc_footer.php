  ...
  <script src="<?php echo auto_version(base_url('assets/apabi_india/js/jquery-3.1.1.min.js')); ?>"></script>
  <script src="<?php echo auto_version(base_url('assets/apabi_india/js/popper.min.js')); ?>"></script>
  <script src="<?php echo auto_version(base_url('assets/apabi_india/js/bootstrap.js')); ?>"></script>
  <script src="<?php echo auto_version(base_url('assets/apabi_india/js/plugins/metisMenu/jquery.metisMenu.js')); ?>"></script>
  <script src="<?php echo auto_version(base_url('assets/apabi_india/js/plugins/slimscroll/jquery.slimscroll.min.js')); ?>"></script>
  <script src="<?php echo auto_version(base_url('assets/apabi_india/js/plugins/dataTables/datatables.min.js')); ?>"></script>
  <script src="<?php echo auto_version(base_url('assets/apabi_india/js/plugins/dataTables/dataTables.bootstrap4.min.js')); ?>"></script>	

  <script src="<?php echo auto_version(base_url('assets/apabi_india/js/bootstrap-toggle.js')); ?>"></script><!-- Toggle -->		
  <script src="<?php echo auto_version(base_url('assets/apabi_india/js/plugins/chosen/chosen.jquery.js')); ?>"></script>		
  <script src="<?php echo auto_version(base_url('assets/apabi_india/js/plugins/datapicker/bootstrap-datepicker.js')); ?>"></script>
  <script src="<?php echo auto_version(base_url('assets/apabi_india/lightbox/lightbox.min.js')); ?>"></script><!-- LIGHTBOX -->		
  <script src="<?php echo auto_version(base_url('assets/apabi_india/js/plugins/sweetalert/sweetalert.min.js')); ?>"></script>
  <!-- Custom and plugin javascript -->
  <script src="<?php echo auto_version(base_url('assets/apabi_india/js/inspinia.js')); ?>"></script>
  <script src="<?php echo auto_version(base_url('assets/apabi_india/js/plugins/pace/pace.min.js')); ?>"></script>
  ...
  <?php if($this->session->flashdata('success') || $this->session->flashdata('error') || $this->session->flashdata('alert')) { $_SESSION['success'] = $_SESSION['error'] = $_SESSION['alert'] = ''; } ?>