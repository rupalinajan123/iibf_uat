...
<label for="text" class="col-md-6">Type the exact characters you see in the picture <span class="red">*</span>.</label>
	...
	<label>     <div id="captcha_img"><?php echo $image;?></div></label>
      ...
      <ul>
		...
		<li><a class="disability forget" href="<?php echo base_url()?>ELNonreg/member/?Mtype=<?php echo $this->input->get('Mtype');?>&ExId=<?php echo $this->input->get('ExId');?>">
...
<script>
  ...
  $(function () {
    ...
    $.ajax({
 		type: 'POST',
 		url: site_url+'ELNonreg/generatecaptchaajax/',
