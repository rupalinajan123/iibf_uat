	 ...
	 if(count($exam_list) > 0)
	 {
	  ...
	  {?>
              <div class="form-group has-feedback">
				...
				{?>
                    <a  href="<?php echo base_url();?>ELNonreg/memlogin/?Extype=<?php echo $Extype;?>&Mtype=<?php echo $Mtype;?>&ExId=<?php echo base64_encode($row['exam_code']);?>"><?php echo $row['description'];?>
                    </a>
              <?php 
				}?>
              </div>
