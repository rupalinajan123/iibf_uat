...
<meta http-equiv="refresh">
  ...
  <div class="content-wrapper">
	...
	<!-- <form class="form-horizontal" name="member_conApplication" id="member_conApplication"  method="post"  enctype="multipart/form-data" action="<?php //echo base_url();?>home/profile/"> -->
    
    <form class="form-horizontal" name="member_conApplication" id="member_conApplication"  method="post"  enctype="multipart/form-data" action="<?php echo base_url();?>home/comApplication/">
    ...
    <section class="content">
      <div class="row">
	   ...
	   <!-- start exemption new changes - priyanka D -26-june-24 -->
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
                     ...
                     <input type="hidden" name="reg_no" id="reg_no" value="<?php echo $user_info[0]['regnumber'];?>">
                      ...
                      <input type="hidden" id="exname" name="exname"  value=" <?php echo $examinfo[0]['description'];?>">
                       <input type="hidden" id="excd" name="excd"  value="<?php echo base64_encode($this->session->userdata('examcode'));?>">
						...
						<?php 
            // echo 'Hereee'.$examinfo[0]['app_category']; exit;
            ...
            <div class="box-body">
                ...
                <!-- start and add the below field institute name -->
                <!-- <div class="form-group">
                  <label for="roleid" class="col-sm-3 control-label">Institute name</label>
                  <div class="col-sm-5 ">
                      <?php echo $examinfo['0']['description'];?>
              ...
              <?php $data_lightbox_title_common = "Ordinary Member Apply Exam"; ?>
              ...
              <?php /*<div class="form-group">
                ...
                <?php ## Caiib changes on 23-Mar-2021 only elective condition
        ...
        <div class="form-group" style="<?php echo $styleForELearning; ?>"> <!-- priyanka d - 02-feb-23 >> hide this as duplicate field -->
            ...
            <div class="col-sm-3">
              <input type="radio" name="elearning_flag" id="elearning_flag_Y" value="Y" <?php echo $checked; ?> >YES
                ...
                <div class="bordered-container">    
                  ...
                  <!-- end skipadmit -->
				   ...
				   if(count($compulsory_subjects) > 0 && $this->session->userdata('examcode')!=101 && $this->session->userdata('examcode')!=1046 && $this->session->userdata('examcode')!=1047)
				   {
					   $i=1;
						...
						foreach($compulsory_subjects as $subject)
					   { ?>
                            <div class="form-group div_subject " <?php if(in_array($this->session->userdata('examcode'),$this->config->item('skippedAdmitCardForExams'))) echo'style="display:none;"'?>>
             	...
             	<?php 
              //echo "compulsory_subjects: ".count($compulsory_subjects);
				 	if($sql[0]['sub_el_count'] == 'Y'){
						...
						{ ?>
										<?php if($this->session->userdata('examcode')!=1002 && $this->session->userdata('examcode')!=1006 && $this->session->userdata('examcode')!=1007 && $this->session->userdata('examcode')!=1011) { ?>
                            <div class="form-group" >
            ...
            //print_r($caiib_subjects);
                ...
                <?php 
				    if($this->session->userdata('examcode') == $this->config->item('examCodeCaiib'))
					{
					   ...
					   /* if($el_subject['subject_code'] == 601 || $el_subject['subject_code'] == 602 || $el_subject['subject_code'] == 603 || $el_subject['subject_code'] == 604)*/
					    { 
					...
					foreach($compulsory_subjects as $el_subject){ ?>
					<div class="form-group show_el_subject" <?php if($this->session->userdata('examcode')==1007) echo'style="display:none;"'; ?> >
                    <label for="roleid" class="col-sm-3 control-label"><?php echo $el_subject['subject_description']?><span style="color:#F00">*</span></label>
                        <div class="col-sm-3">
                       	<input type="checkbox" name="el_subject[<?php echo $el_subject['subject_code']?>]" value="Y" checked="checked" class="el_sub_prop" />
                        </div>
...
<?php 
			...
			{?>
               ...
               <?php 
				 ...
				 if(count($caiib_subjects) > 0 || $this->session->userdata('examcode')==$this->config->item('examCodeJaiib') ||$this->session->userdata('examcode')==$this->config->item('examCodeJaiib') || in_array($this->session->userdata('examcode'),$elective_exam_code))
				{?>
                     <div class="form-group">
				...
				<!--<div class="form-group">
                    <label for="roleid" class="col-sm-3 control-label">Are you a person with benchmark disability of 40% or above (PwBD)<span style="color:#F00">*</span></label> 
                        <div class="col-sm-3">
                           ...
                           <input type="radio" name="scribe_flag_d" id="scribe_flag_d" value="Y" onclick="showSelect();" required>YES
      ...
      <!-- Benchmark Disability Code Close -->
					...
					<?php if($benchmark_disability_info[0]['benchmark_disability']=='Y'){ ?>
                        <div class="col-sm-3">
                           ...
                           <input  type="radio" name="scribe_flag" id="scribe_flag" value="Y" onclick="showSelect_scribe_flagY();" requried>YES
...
<!--B) Since the Institute will not be sending the Admit Letter(hard copy) through post, Correct E-mail address is mandatory for receipt of Admit Letter/Hall Ticket through e-mail.-->
             ...
             <div class="box-footer">
                  <div class="col-sm-12 text-center">
                    <!-- <a href="javascript:void(0);" class="btn btn-info" onclick="javascript:return loginusercheckform();" id="preview">Preview</a> -->
                      <?php 
                      if($ButtonDisable) 
                      { ?>
                       <input type="submit" class="btn btn-info" name="btnPreviewSubmit" id="btnPreviewSubmit" value="Preview" onclick="javascript:return loginusercheckform();">
                  ...
                  <!--   <button type="reset" class="btn btn-info" name="btnReset" id="btnReset">Reset</button>-->
                     <a href="<?php echo base_url();?>Home/comApplication/" class="btn btn-info" id="Reset">Reset</a>
                     <?php } ?> 
		...
		if($('#myModal_jaiib').length > 0) {
			...
			$('.goAsFresher').click(function(){
				if (!confirm('You have selected Forgo Credits and register de-novo. Do you want to continue with the same? ')) 
					{
						//$('#myModal_jaiib').modal('show');
						//return false;
					}
					else
						setAsFresherOrOld(1);
				
			//	window.location.href = "<?php echo base_url();?>/Home/comApplication//?optval=1";
			//	$('#grp_code').val('B1_1');
			}); 
				...
				if (!confirm('You have selected Avail credits (as applicable) with Balance attempts . Do you want to continue with the same? ')) 
					{
						...
						setAsFresherOrOld(2);
			//	window.location.href = "<?php echo base_url();?>/Home/comApplication//?optval=2";
			...
			function setAsFresherOrOld(selectedoptVal=2) {
				...
				$.ajax({
					type: 'POST',
					url: site_url+'Home/getsetAsFresherOrOld/?method=set&optVal='+selectedoptVal,
					success: function(res)
					{	
						//alert(res);
						window.location.href = "<?php echo base_url();?>/Home/comApplication/?optval="+res;
					}
				});
			}
			...
			function getAsFresherOrOld() {
				...
				$.ajax({
					type: 'POST',
					url: site_url+'Home/getsetAsFresherOrOld/?method=get',
					success: function(res)
					{	
						if(res!='')
							window.location.href = "<?php echo base_url();?>/Home/comApplication/?optval="+res;
						else
						window.location.href = "<?php echo base_url();?>/Home/comApplication/";
					}
				});
			}
...
<?php 
	...
	function changeFeeFromElarningY() {
		...
		$.ajax({
				url:site_url+'Home/set_jaiib_elsub_cnt/',
				data: datastring_1,
				type:'POST',
				async: false,
				success: function(data) {
...
//$('#Sub_menue').removeAttr("required")
 ...
 var base_url = '<?php echo base_url();?>'
   function getsub_menue(deptid)
   {
   			$.ajax({
   		type:"POST",
   		url: base_url+"Home/getsub_menue",
   		data:{deptid:deptid},
   		success:function(data){
   			if(data != "")
   			{   
  ...
  function check_bank_bc_id_no(){
    ...
    var regnumber = '<?php echo $this->session->userdata('regnumber'); ?>';
