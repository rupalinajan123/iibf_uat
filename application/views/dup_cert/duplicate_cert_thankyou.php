...
<div class="content-wrapper" style="border:solid 1px #000; ">
    ...
    <section class="content-header" style="padding:0px;">
	  <h1 class="register">Duplicate Certificate Request Acknowledgment</h1>
      <!--<h1>
    ...
    <div class="row">
            ...
            <?php //echo validation_errors(); ?>
			 ...
			 ?> 
                ...
                <label for="roleid" class="col-sm-3 control-label">Registration Number :</label>
                	<div class="col-sm-5">
                  <?php if(isset($user_info[0]['regnumber'])){echo @$user_info[0]['regnumber'];}?>
                    </div>
                </div>
                ...
                <label for="roleid" class="col-sm-3 control-label">Name :</label>
                	<div class="col-sm-5">
                  <?php echo @$user_info[0]['namesub'].' '.$user_info[0]['firstname'].' '.$user_info[0]['middlename'].' '.$user_info[0]['lastname'];?>
                    </div>
                </div>
                ...
                <div class="form-group">
					 <label for="roleid" class="col-sm-3 control-label">Selected Examination :</label>
					  <div class="col-sm-5"  style="display:block" id="edu">
					  <?php if(count($exams))
					  {
						 foreach($exams as $exams_row)
						 {
							if($user_info[0]['exam_code']==$exams_row['exam_code']){echo  $exams_row['description'];}
							} 
					  } ?>
	   ...
	   {?>
          ...
          <a href="<?php echo  base_url()?>Nonreg/logout/">Logout</a>
           ...
           <div class="col-sm-2 col-xs-offset-5">
       	   <a href="http://www.iibf.org.in/" >Home</a>
          </div>
           </div>
       <?php 
	   }?> 
