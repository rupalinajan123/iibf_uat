          ...
          <div class="box">
			...
			<table id="listitems" class="table table-bordered table-striped dataTables-example">
                ...
                <tr>
                 ...
                 -->
                  <th id="srNo">S.No.</th>
                  <th id="member_regnumber">Membership No</th>
                  <th id="refund_request_id">Refund<br />Request ID</th>
                  <th id="transaction_no">Transaction<br />No</th>
                  <th id="receipt_no">Order ID</th>
                  <th id="amount">Amount</th>
                  <th id="ARRN">ARRN</th>
                  <th id="description">Description</th>
                 <!-- <th id="refund_details">Refund Details</th>
                  <th id="admin_user_id">User ID</th>-->
...
function searchOnRegNo()
{
	...
	if(flag)
	{
		...
		var searcharr = [];
		searcharr['field'] = 'member_regnumber';
...
$(function () {
	...
	var listing_url = base_url+'admin/Report/refund_transaction';
