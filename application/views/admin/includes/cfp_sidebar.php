    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
       <!-- <li class="header">MAIN NAVIGATION</li>-->
        <li class="treeview <?php if(current_url() == base_url().'admin/Cfp/examReg') { echo "active"; } ?>">
         <a href="<?php echo base_url();?>admin/Cfp/examReg">
            <i class="fa fa-dashboard"></i> <span>CFP Registrations</span>
          </a>
        </li>
