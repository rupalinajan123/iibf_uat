    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="box">
          ...
          <div class="box-body">
            <form class="form-horizontal" name="btnSearch" id="btnSearch" action="<?php echo base_url();?>admin/trainingbatch/TrainingDashboard/unpaid_count"  method="post">
              <!--<div class="col-sm-2">
          ...
          <div class="box-body">
			...
			if(count($mem_info)){
              ...
              <tr>
				...
				<td align="center"> 
				<a class = "btn btn-info" href="<?php echo base_url();?>admin/trainingbatch/TrainingDashboard/send_mail_vc/<?php echo $row['member_no'];?>/<?php echo $row['program_code'];?>" >Send Mail</a>
				  </td>
              </tr>
              <?php $row_count++; }} ?>
                </tbody>
