...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1> Examination Counts </h1>
    <?php //echo $breadcrumb; ?>
  </section>
  <section class="content">
    <form class="form-horizontal" name="addForm" id="addForm" action="<?php echo base_url();?>admin/ExamVenueCount/dowanload" method="post">
      <!-- Main content -->
      <div class="row">
        <div class="col-md-12">
          <!-- Horizontal Form -->
            ...
            <label for="textfield" class="control-label"><strong>Exam period</strong></label>
                ...
                <div class="controls" id="board_dd_CC">
                  <select class="input-large form-control" id="authority" name="exm_prd[]" multiple required size="10" width="5">
					...
					<?php 
					$C_date =date('Y-m-d');
					$date =  date('Y-m-d', strtotime($C_date .' -35 day')); // chaitali chnage from -15 to -35 on amit ale request
					$exam_activation = $this->Master_model->getRecords("exam_activation_master", array(
					'exam_to_date >=' => $date,
					));
					//print_r($exam_activation);
    ...
    <div class="control-group" id="div_department_CC">
          ...
          <div class="box-footer">
            <div class="col-sm-2 col-xs-offset-5">
              ...
              <a href="<?php echo base_url();?>admin/ExamVenueCount/dowanload" class="btn btn-default pull-right">Refresh</a> </div>
          </div>
          <?php //if($result_text!=''){?>
          <div class="box-footer">
            <div class="box-body">
            ...
            $(document).ready(function() {
                ...
                $('#authority').on('change', function() {
                    ...
                    if (period) {
                        $.ajax({
                            type: 'POST',
                            url: base_url + "/admin/ExamVenueCount/get_multiple_exam",
