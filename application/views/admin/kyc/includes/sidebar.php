...
<aside class="main-sidebar">
   ...
   <section class="sidebar">
      ...
      <ul class="sidebar-menu">
         ...
         <li class="treeview">
            <a href="<?php echo base_url();?>admin/kyc/Kyc/dashboard">
            <i class="fa fa-dashboard"></i> <span>Dashboard</span>
            </a>
         </li>
         <li class="treeview">
            <a href="<?php echo base_url();?>admin/kyc/Kyc/pending_member_list">
            <i class="fa fa-list-alt"></i> <span>Pending Member List</span>
            </a>
         </li>
         <?php
               if(strpos(current_url(),base_url().'admin/kyc/Kyc/pending_allocation_type') !== false || 
                  strpos(current_url(),base_url().'admin/kyc/Kyc/pending_member') !== false  || 
                  strpos(current_url(),base_url().'admin/kyc/Kyc/pending_allocated_list')  !== false || 
                  strpos(current_url(),base_url().'admin/kyc/Kyc/next_pending_allocated_list') !== false || 
                  strpos(current_url(),base_url().'admin/kyc/Kyc/next_pending_allocation_type') !== false)
               $home_active = "active";
         ?>
         <li class="treeview">
            <a href="<?php echo base_url();?>admin/kyc/Kyc/pending_allocation_type">
         ...
         <?php 
            $home_active = '';
            /*if(stristr(current_url(),'./recommended_list'))
            	$home_active = "active";
            ...
            if(strpos(current_url(),base_url().'admin/kyc/Kyc/recommender_recommend_list') !== false || strpos(current_url(),base_url().'admin/kyc/Kyc/recommended_list') !== false)
            	...
            	else	if(strpos(current_url(),base_url().'admin/kyc/Kyc/allocation_type') !== false || 
                  strpos(current_url(),base_url().'admin/kyc/Kyc/member') !== false  || 
                  strpos(current_url(),base_url().'admin/kyc/Kyc/allocated_list')  !== false || 
                  strpos(current_url(),base_url().'admin/kyc/Kyc/next_allocated_list') !== false || 
                  strpos(current_url(),base_url().'admin/kyc/Kyc/next_allocation_type') !== false)
            	$home_active = "active";

            	else	if(strpos(current_url(),base_url().'admin/kyc/Kyc/edited_allocation_type') !== false || 
                  strpos(current_url(),base_url().'admin/kyc/Kyc/edited_member') !== false  || 
                  strpos(current_url(),base_url().'admin/kyc/Kyc/next_edited_allocation_type') !== false || 
                  strpos(current_url(),base_url().'admin/kyc/Kyc/edited_list') !== false || 
                  strpos(current_url(),base_url().'admin/kyc/Kyc/next_edited_list') !== false  )
            	$home_active = "active";
         ...
         <li class="treeview <?php echo $home_active; ?>">
            ...
            <li <?php if(stristr(current_url(),'Kyc/allocation_type') || 
               stristr(current_url(),'Kyc/member') || 
               stristr(current_url(),'Kyc/allocated_list' ) || 
               stristr(current_url(),'Kyc/next_allocated_list') || 
               stristr(current_url(),'Kyc/next_allocation_type')) { echo 'class="active"'; } ?>>
                  <?php
                  ...
                  <?php 
                     ...
                     {?>
                  <a href="<?php echo base_url();?>admin/kyc/Kyc/allocated_list"><i class="fa fa-circle-o"></i>New member list</a>
                  <?php 
                     }
                     }
                     else
               ...
               <li <?php if(stristr(current_url(),'Kyc/edited_allocation_type') || 
               stristr(current_url(),'Kyc/edited_member')|| 
               stristr(current_url(),'Kyc/edited_list') || 
               stristr(current_url(),'Kyc/next_edited_list') || 
               stristr(current_url(),'Kyc/next_edited_allocation_type')) { echo 'class="active"'; } ?>>
                  <?php 
               ...
               <li <?php if(stristr(current_url(),'Kyc/recommender_recommend_list') || stristr(current_url(),'Kyc/recommended_list')) { echo 'class="active"'; } ?>>
                  <a href="<?php echo base_url();?>admin/kyc/Kyc/recommended_list"><i class="fa fa-circle-o"></i>Recommended member list</a>
               </li>
            </ul>
         <li><a href="<?php echo base_url();?>admin/kyc/kyc/benchmark_recommender" class=""><i class="fa fa-circle-o"></i>Benchmark Recommender</a></li>
         <li><a href="<?php echo base_url();?>admin/kyc/kyc/scribe_recommender" class=""><i class="fa fa-circle-o"></i>Scribe Recommender</a></li>
         </li>
         <?php 
            $dra_home_active = '';
