				...
				<div class="box min-height">
					...
					<div class="box-body">
						<?php 
							...
							//print_r($result[0]['mobile_scribe']);die; 
							//print_r($result);die;
											...
											<tr>
												...
												<td>
													<?php $actual_photoid = "uploads/scribe/idproof/".$row['idproofphoto']; 
														if($row['idproofphoto'] != ''){
														?>
														<a href="javascript:void(0)" onclick="open_modal('<?php echo base_url().$actual_photoid.'?'.time(); ?>')">
															<img class="img-responsive" src="<?php echo base_url(); ?><?php echo $actual_photoid; ?><?php echo '?'.time(); ?>"  name="idproof" id="idproof" style="height:100px; width:100px;" />
														</a>
														<?php
														} 
														else
												...
												<td>
													<?php $actual_declaration = "uploads/scribe/declaration/".$row['declaration_img']; 
														...
														?>
														<a href="javascript:void(0)" onclick="open_modal('<?php echo base_url().$actual_declaration.'?'.time(); ?>')">
															<img class="img-responsive" src="<?php echo base_url(); ?><?php echo $actual_declaration; ?><?php echo '?'.time(); ?>"  name="declaration" id="declaration" style="height:100px; width:100px;" />
														</a>
														<?php
														} 
														else
												...
												<td>
													<?php $actual_visually = "uploads/scribe/disability/".$row['vis_imp_cert_img'];
														...
														<a href="javascript:void(0)" onclick="open_modal('<?php echo base_url().$actual_visually.'?'.time(); ?>')">
															<img class="img-responsive" src="<?php echo base_url(); ?><?php echo $actual_visually; ?><?php echo '?'.time(); ?>"  name="visually" id="visually" style="height:100px; width:100px;" />
														</a>
														<?php
														} 
														else
												...
												<td>
													<?php $actual_orthopedically = "uploads/scribe/disability/".$row['orth_han_cert_img'];
														...
														<a href="javascript:void(0)" onclick="open_modal('<?php echo base_url().$actual_orthopedically.'?'.time(); ?>')">
															<img class="img-responsive" src="<?php echo base_url();?><?php echo $actual_orthopedically;?><?php echo '?'.time(); ?>"  name="orthopedically" id="orthopedically" style="height:100px; width:100px;" />
														</a>
														<?php
														} 
														else
												...
												<td>
													<?php $actual_cerebral = "uploads/scribe/disability/".$row['cer_palsy_cert_img'];
														...
														<a href="javascript:void(0)" onclick="open_modal('<?php echo base_url().$actual_cerebral.'?'.time(); ?>')">
															<img class="img-responsive" src="<?php echo base_url();?><?php echo $actual_cerebral;?><?php echo '?'.time(); ?>"  name="cerebral" id="cerebral" style="height:100px; width:100px;" />
														</a>
														<?php
														} 
														else
						...
						?>
						<center>
							<a href="<?php echo base_url()?>admin/kyc/Approver/scribe_allocation_type/"  class="btn btn-info"  >Back</a>
							<?php 
								...
								$check_kyc_status = $this->master_model->getRecords("scribe_member_kyc", array('regnumber'=>$this->uri->segment(5)),'',array('kyc_id'=>'DESC'),'','1');
							?>
...
<?php  $actual_photoid = "uploads/scribe/idproof/".$row['idproofphoto'];
		if($row['idproofphoto'] != ''){
		?>
		<div id="openModalidproof" class="modalDialog">
			<div>	<a href="#close" title="Close" class="close">X</a>
				<img class="img-responsive" src="<?php echo base_url();?><?php echo $actual_photoid;?><?php echo '?'.time(); ?>"  name="idproof" id="idproof" height="500" width="500"  />
			</div>
		</div>
	<?php 	
		}  $actual_declaration = "uploads/scribe/declaration/".$row['declaration_img'];
		if($row['declaration_img'] != ''){
		?>
		<div id="openModaldeclaration" class="modalDialog">
			<div>	<a href="#close" title="Close" class="close">X</a>
				<img class="img-responsive" src="<?php echo base_url();?><?php echo $actual_declaration;?><?php echo '?'.time(); ?>"  name="declaration" id="declaration" height="500" width="500"  />
			</div>
		</div>
	<?php 	
		}  $actual_visually = "uploads/scribe/disability/".$row['vis_imp_cert_img'];
		if($row['vis_imp_cert_img'] != ''){
		?>
