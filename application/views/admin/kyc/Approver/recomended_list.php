                ...
                <tbody class="no-bd-y" id="list">
				  ...
				  ?>
                    <tr>
                        ...
                        <td><?php if($row['dateofbirth']!='' && $row['dateofbirth']!='0000-00-00'){echo date('d-m-Y',strtotime($row['dateofbirth']));}?></td>
                        <td><?php echo $row['email'];?></td>
                        <td><?php echo $row['registrationtype'];?></td>
                        <td><?php echo $recommended_name;?></td>
                        <td><?php echo date('d-m-Y',strtotime($row['recommended_date'])) ;?></td>
                        <td>
                        	<a href="<?php echo base_url(); ?>admin/kyc/Approver/details/<?php echo $row['regnumber']; ?>">View Details</a>
                        </td>
                    </tr>
                  <?php }} ?>                  
                </tbody>
...
$(function () {
	...
	var listing_url = base_url+'admin/kyc/Approver/recommneder_list';
