              ...
              <div class="table-responsive">
                <table class="table table-bordered">
                  <tr>
                    <td>Members</td>
                    <td>
                      >>&nbsp;<a href="<?php echo base_url();?>admin/kyc/Approver/pending_member_list">Pending member list&nbsp;&nbsp;&nbsp;

                      >>&nbsp;<a href="<?php echo base_url();?>admin/kyc/Approver/pending_allocation_type">Allocate pending members&nbsp;&nbsp;&nbsp;
                      ...
                      <?php  $new_allocated_member_list=array();
                        ...
                        if(count($new_allocated_member_list) >0 )
                        {
                          ...
                          {?>
                          		    >><a href="<?php echo base_url();?>admin/kyc/Approver/next_allocation_type">KYC member list</a>&nbsp;&nbsp;&nbsp;&nbsp; <?php 
                              }
                              else
                              {?>
                           		   >><a href="<?php echo base_url();?>admin/kyc/Approver/allocation_type">KYC member list</a>&nbsp;&nbsp;&nbsp;&nbsp; <?php 
                              }
                            }
                            else
                            {?>
                            ...
                            // <!-- edited member list tab added (pooja mane -8-12-2023) -->
                            $new_allocated_member_list=array();
                            ...
                            if(count($new_allocated_member_list) >0 )
                            {
                              if($new_allocated_member_list[0]['allotted_member_id']=='')
                              {?>
                                  >><a href="<?php echo base_url();?>admin/kyc/Approver/next_edited_allocation_type">KYC edited member list</a>&nbsp;&nbsp;&nbsp;&nbsp; <?php 
                              }
                          else
                          {?>
                                 >><a href="<?php echo base_url();?>admin/kyc/Approver/edited_allocation_type">KYC edited member list</a>&nbsp;&nbsp;&nbsp;&nbsp; <?php 
                          }
                        }
                        else
                        {?>
