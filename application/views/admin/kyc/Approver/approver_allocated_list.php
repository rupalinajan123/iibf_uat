...
<div class="content-wrapper">
  ...
  <div class="collapsee" id="collapseExample">
    ...
    <?php echo base_url('admin/kyc/Approver/approver_allocated_list'); ?>" method="post">
      <div class="row">
        <div class="col-sm-3">
      ...
      <div class="col-xs-12">
        <div class="box">
          ...
          <div class="box-body">
            <?php 
              /*?>           
                <form class="form-horizontal" name="checkmember" id="checkmember" action="<?php echo base_url();?>/admin/kyc/Approver/allocation_type/" method="post">
              <?php */?>           <?php
              if(count($result)>0)
              {?>
                    ...
                    <?php 
                      ...
                      if(count($result)){
                        ...
                        {  
                          ...
                          //print_r($member_exam[0]['exam_code']);die;
                          if($member_exam)
                          {
                        ...
                        <tr>
                          ...
                          <td><?php
                            ...
                            ?>      
                            <td><a href="<?php echo base_url(); ?>admin/kyc/Approver/approver_allocated_member/<?php echo $row['regnumber'];?>/<?php echo $srno; ?>/<?php echo $totalRecCount;?>">Approve/Recommend</a></td>
                        </tr>
                        <?php 
                          $row_count++;				
                        } ?>
