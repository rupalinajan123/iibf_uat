											...
											<tr>
												...
												<td>
													<?php $actual_visually = "uploads/disability/v_".$row['regnumber'].".jpg"; 
														...
														?>
														<a href="#openModalvisually">
															<img class="img-responsive" src="<?php echo base_url(); ?><?php echo $actual_visually; ?><?php echo '?'.time(); ?>"  name="visually" id="visually" height="100" width="100"  />
														</a>
														<?php
														} 
														else
												...
												<td>
													<?php $actual_orthopedically = "uploads/disability/o_".$row['regnumber'].".jpg";
														...
														?>
														<a href="#openModalorthopedically">
															<img class="img-responsive" src="<?php echo base_url();?><?php echo $actual_orthopedically;?><?php echo '?'.time(); ?>"  name="orthopedically" id="orthopedically" height="100" width="100"  />
														</a>
														<?php
														} 
														else
												...
												<td>
													<?php $actual_cerebral = "uploads/disability/c_".$row['regnumber'].".jpg"; 
														...
														?>
														<a href="#openModalcerebral">
															<img class="img-responsive" src="<?php echo base_url();?><?php echo $actual_cerebral;?><?php echo '?'.time(); ?>"  name="cerebral" id="cerebral" height="100" width="100"  />
														</a>
														<?php
														} 
														else
