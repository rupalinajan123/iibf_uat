...
<!-- Added by pooja mane for fedai exam code check 2024-08-14 -->
        ...
        <div class="box min-height">
          ...
          <div class="box-body">
              ...
              <table id="listitems" class="table table-bordered table-striped dataTables-example">
                <thead>
                  <tr>
                    ...
                    <th id="">Id-Proof</th>
                    <?php 
                        if($row['registrationtype'] == 'NM' && in_array($result[0]['excode'], $fedai_array) && $result[0]['createdon'] >='2024-07-01'){?>
                    ...
                    <?php
                      ...
                      ?>
                      <th id="">    Declaration <span style="color: red;">(Required)</span>
</th>
                      <?php
                      }
                    ?>
                    ...
                    if(count($result))
                    {
                      ...
                      ?>
                              ...
                              <td><?php echo $row['regnumber'];?><?php 
                                    ...
                                    $this->db->limit('1');
                                    $edited_hist = $this->master_model->getRecords('member_kyc',array('regnumber' => $row['regnumber'],'record_source'=>'Edit','user_edited_date !='=>'0000-00-00 00:00:00'));
                                    //print_r($edited_hist[0]['edited_mem_photo']);
                                    //echo $this->db->last_query();die; ?></td>
                      ...
                      -->
                      <?php if ($row['registrationtype'] == 'NM' && in_array($result[0]['excode'], $fedai_array) && $result[0]['createdon'] >='2024-07-01') { ?>
                        <td>
                      ...
                      <?php if (isset($result[0]['registrationtype']) && $result[0]['registrationtype'] == 'O') { ?>
                        <td>
                          <?php $actual_declaration = get_img_name($row['regnumber'], 'declaration');
                            if (is_file($actual_declaration)) {
                            ?>
                    ...
                    <tr>
                      ...
                      <?php 
                        ...
                        <?php 
                              ...
                              <!-- code added by pooja mane for fedai NM empid proof checkbox-->
                              ...
                              <!-- code ends added by pooja mane for fedai NM empid proof checkbox-->

                              <!-- Pooja mane code starts: 2024-08-14 -->
                              <?php //print_r($result[0]);die;
                              if ($result[0]['date_of_commenc_bc'] != '' && $recomended_mem_data[0]['edited_bank_bc_id_card'] == '1' && is_file(get_img_name($row['regnumber'], 'bank_bc_id_card'))) {
                                  // ID Proof value Not updated by candidate, so display fixed checkbox disabled 
                              ?>
                                  <td>
                                      <input type="checkbox" checked="checked" disabled> 
            ...
            echo 'Showing '.$this->uri->segment(6).' of '. count($arraid). ' entries' ; ?><?php */?>
                     <center>
                        <a href="<?php echo base_url()?>admin/kyc/Approver/edited_allocation_type/"  class="btn btn-info"  >Back</a>
              <?php 
...
-->
<?php
    if (!empty($result) && isset($result[0]['registrationtype']) && ($result[0]['registrationtype'] == 'O' || $result[0]['registrationtype'] == 'NM' && in_array($result[0]['excode'], $fedai_array) && $result[0]['createdon'] >='2024-07-01')) { //Added fedai member check for declaration by pooja mane 2024-08-14
...
<!-- START : Send Custom Mail button functionality by pooja mane 31-01-2025 -->
