...
<?php $this->load->view('admin/kyc/includes/approver_sidebar');?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
   Approver recommended member list
     </h1>
              ...
              <th id="">Candidate Name</th>
				  ...
				  if(count($result )){
					  $row_count = 1;
						...
						{  
							 ...
							 $fields=$var=array();
				  ?>
				<?php    $r_list = $this->master_model->getRecords("member_kyc",array('regnumber'=>$row['regnumber'],'recommended_by'=>$this->session->userdata('kyc_id'),'recommended_date'=>$date),'old_data',array('kyc_id'=>'DESC')); 
                
                //echo $r_list[0]['old_data']; 	
                if(count( $r_list )>0)
                {   
            		    $var=unserialize($r_list[0]['old_data']);
                }
                ...
                ?>
                    <tr>
                        ...
                        <td><?php if($row['firstname']=='' && $row['middlename']=='' && $row['lastname']=='' )
						{	
					...
					?>
                        ...
                        <td><?php if($row['kyc_status']==1)
									...
									?></td>
                             <td><?php echo $row['record_source'];?></td>       
                           <td><?php 
						            if($row['mem_name']==0)
						            {
										$fields[]='Name';
									...
									if($row['employee_proof']==0 && $row['excode']== '1009')
									{
										$fields[]='Fedai Id-proof';
									}
									if($row['mem_bank_bc_id_card']==0  && $row['date_of_commenc_bc'] !='')
									{
                        ...
                        <?php /*?><td>
                        	<a href="<?php echo base_url(); ?>admin/kyc/Approver/details/<?php echo $row['regnumber']; ?>">View </a>
                        </td><?php */?>
                    </tr>
                  <?php $row_count++; }} ?>                  
                </tbody>
