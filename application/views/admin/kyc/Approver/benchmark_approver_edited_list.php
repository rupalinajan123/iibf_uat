...
<div class="content-wrapper">
	...
	<section class="content-header">
		<h1> Benchmark KYC member list </h1>
	</section>
	<br />
	<div class="col-md-12">
			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Benchmark Allocated  records </h3>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
									...
									<?php 
										...
										if(count($result)){
											...
											<tr>
												...
												?>
												<td><a href="<?php echo base_url(); ?>admin/kyc/Approver/benchmark_approver_edited_member/<?php echo $row['regnumber'];?>/<?php echo $srno; ?>/<?php echo $totalRecCount;?>">Approve/Recommend</a></td>
											</tr>
											<?php 
												$row_count++;				
											} ?>
