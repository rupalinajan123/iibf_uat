		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box">
					...
					<div class="box-body">
						<div class="col-sm-12">
							<form class="form-horizontal" name="Select By" id="Select By" action="<?php echo base_url();?>admin/kyc/Approver/benchmark_approver_edited_list" method="post">
								<div class="col-sm-2">
...
<script type="application/javascript">
	...
	$(function () {
		...
		var listing_url = base_url+'admin/kyc/Kyc/benchmark_allocated_list/';
