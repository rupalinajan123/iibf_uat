 ...
 <!--end of fancybox-->   
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        KYC Verification For <?php echo $reg_no?>
     </h1>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
 <form class="form-horizontal" name="checkmember" id="checkmember" action="<?php echo base_url();?>/admin/kyc/Approver/checkmember/<?php echo $reg_no?>" method="post">
				 ...
				 if(count($result))
				 {
				  ...
				  ?>
                    <tr>
                        ...
                        <td><?php if($row['dateofbirth']!='0000-00-00' && $row['dateofbirth']!=''){echo date('d-m-Y',strtotime($row['dateofbirth']));}?></td>
                        <td><?php echo $row['associatedinstitute'];?></td>
		...
		<a class="fancybox-effects-a" href="<?php echo base_url();?><?php echo $actual_idproof;?><?php echo '?'.time(); ?>" title=""><img src="<?php echo base_url();?><?php echo $actual_idproof;?><?php echo '?'.time(); ?>" name="scannedphoto" id="scannedphoto" width="100" height="100" /></a>
				...
				{?>
                	...
                	<td><input type="checkbox" name="cbox[]" id="cbox" value="emp_checkbox" <?php if($recomended_mem_data[0]['mem_associate_inst']==1){echo 'checked="checked"';}?>></td>
           ...
           <center>
	            ...
	            <a href="<?php echo base_url()?>admin/kyc/Approver/recommended_list/"  class="btn btn-info"  >Back</a>
