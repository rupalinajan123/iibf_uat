									...
									<?php
										...
										if(count($result))
										{
											...
											<tr>
												...
												?>
												<td><a href="<?php echo base_url(); ?>admin/kyc/Kyc/benchmark_member/<?php echo $row['regnumber']; ?>/<?php echo $srno; ?>/<?php echo $totalRecCount; ?>">Recommend</a></td>
											</tr>
											<?php 
												$row_count++;		
											} 
