                ...
                <tbody class="no-bd-y" id="list">
                  ...
                  <?php 
                    ...
                    <tr>
                      ...
                      <td><input type="checkbox" name="cbox[]" id="cbox" value="dob_checkbox"<?php  if($row['dateofbirth']!=""  &&  $row['dateofbirth']!='00-00-0000' && $row['dateofbirth']!='0000-00-00'){echo 'checked="checked"';}?>></td>
                      <?php 
