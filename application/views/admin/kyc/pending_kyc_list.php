      ...
      <div class="col-xs-12">
        <div class="box min-height">
          ...
          <div class="box-body">
            ...
            ?>
            <form class="form-horizontal" name="checkmember" id="checkmember" action="<?php echo base_url(); ?>admin/kyc/Kyc/pending_member/<?php echo $reg_no ?>/<?php echo $selected_srno; ?>/<?php echo $totalCount; ?>" method="post">
              <?php
            ...
            <center>
              <a href="<?php echo base_url() ?>admin/kyc/Kyc/pending_allocation_type/" class="btn btn-info">Back</a>
              <?php
                ...
                <?php /*?><?php if($next_id!='')
                  {?>
                  <a href="<?php echo base_url()?>admin/kyc/Kyc/pending_member/<?php echo $next_id?>"  class="btn btn-info"  >Next</a>
                  <?php 
                  }
                  else
                  {?>
