  ...
  <section class="content">
            ...
            <div class="col-md-12">
              ...
              <div class="form-group">
                <form class="form-horizontal" name="searchDate" id="searchDate" action="" method="post">
                  ...
                  <label for="list" class="col-sm-2">Membership No:</label>
                  <div class="col-sm-2">
                    <input class="form-control" id="regnumber" name="regnumber" placeholder="Membership No." required="" value="" type="text">
                  </div>
                  <label for="list" class="col-sm-2">Email Id:</label>
                  <div class="col-sm-2">
                    <input class="form-control" id="email" name="email" placeholder="Email-Id." required="" value="" type="text">
                  </div>
                  ...
                  <center>  <input type="submit" class="btn btn-info" name="btnSearch" id="btnSearch" value="Search" >
                  <input type="reset" class="btn btn-info" name="btnReset" id="btnReset" value="Reset" > </center>
                </form>
              </div>
    ...
    <div class="row">
      <div class="col-xs-12">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">You Have Allocated 100 Member </h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
              ...
              <tbody class="no-bd-y" id="list">
                <?php if(count($result)){
                  ...
                  <tr>
                    ...
                    <td><?php echo $row['mem_associate_inst'];?></td>
                    <td><?php echo $row['mem_photo'];?></td>
                    <td><?php echo $row['mem_sign'];?></td>
                    <td><?php echo $row['mem_proof'];?></td>
                    <td><?php echo $row['kyc_status'];?></td>
                    <td><?php echo $row['kyc_state'];?></td>
                    <td><?php echo $row['recommended_date'];?></td>
                    <td><?php echo $row['user_edited_date'];?></td>
