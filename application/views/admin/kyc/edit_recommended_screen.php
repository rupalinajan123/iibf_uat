      ...
      <div class="col-xs-12">
        <div class="box min-height">
          ...
          <div class="box-body">
            ...
            ?>
            <form class="form-horizontal" name="checkmember" id="checkmember" action="<?php echo base_url(); ?>/admin/kyc/Kyc/edited_member/<?php echo $reg_no ?>/<?php echo $selected_srno; ?>/<?php echo $totalCount; ?>" method="post">
              <?php /*?> <?php 
                ...
                echo 'Showing '.$final_remaning_count1.' of '.$alloction_count.'   entries' ;
              }?>	<?php */ ?>
              
              <?php //echo '<pre>'; print_r($recomended_mem_data); echo '</pre>'; ?>
              <table id="listitems" class="table table-bordered table-striped dataTables-example">
                <thead>
                  <tr>
                    ...
                    <th id="">Sign</th>
                    <th id="">Id-Proof</th>
                    <!-- Pooja mane code starts: 2024-08-14 -->
                    <?php 
                        if(in_array($result[0]['excode'], $fedai_array) && $result[0]['createdon'] >='2024-07-01'){?>
                    ...
                    <?php }?>
                      <!-- Pooja mane code ends: 2024-08-14 -->
                      <!-- Pooja mane BCBF code starts: 2024-10-17 -->
                      
                      <!-- Pooja mane BCBF code ends: 2024-10-17 -->
                ...
                <tbody class="no-bd-y" id="list">
                  <?php
                    if (count($result)) 
                    {
                      foreach ($result as $row) 
                      {
                        ...
                        <tr>
                          ...
                          <td>
                            <?php if ($row['dateofbirth'] != '0000-00-00' && $row['dateofbirth'] != '' && $row['dateofbirth'] != '00-00-0000') {
                        ...
                        <td><!--idproofphoto -->
                          ...
                          <?php if($result[0]['registrationtype']== 'NM' && in_array($result[0]['excode'], $fedai_array) && $result[0]['createdon'] >='2024-07-01'){?>
                          <td>
                        ...
                        -->
                        <?php if ($row['registrationtype'] == 'O' || ($row['registrationtype'] == 'NM' && in_array($result[0]['excode'], $fedai_array)) && $result[0]['createdon'] >='2024-07-01') { ?>
                          <td>
                    ...
                    <tr>
                      ...
                      <td>
                        <?php /* <input type="checkbox" name="cbox[]" id="cbox" value="dob_checkbox" <?php if ($row['dateofbirth'] != ""  &&  $row['dateofbirth'] != '00-00-0000' && $row['dateofbirth'] != '0000-00-00') { echo 'checked="checked"'; } ?>> */ ?>
                      ...
                      <?php
                        ...
                        { ?>
                        <td>
                          <input type="checkbox" name="cbox[]" id="cbox" value="emp_checkbox" disabled style="display:none">
                        </td>
                        <?php } 
                        else 
                        { ?>
                        <td>
                          <?php 
                            if($recomended_mem_data[0]['edited_mem_associate_inst'] == '0' && $row['associatedinstitute'] != "")//Employer value Not updated by  candidate, so display fixed checkbox 
                            { ?>
                            <!-- <input type="checkbox" checked="checked" disabled>  -->
                            <!-- <input type="checkbox" name="cbox[]" id="cbox" value="emp_checkbox" checked="checked" style="display:none">  -->
                            <?php }
                            else //Employer value updated by  candidate, so display functional checkbox
                            { ?>
                            <!-- <input type="checkbox" name="cbox[]" id="cbox" value="emp_checkbox" <?php //if ($row['associatedinstitute'] != "") { echo  'checked="checked"'; } ?>> -->
                          <?php } ?>
                        </td>
                      <?php } ?>
                      ...
                      <td>
                        <?php 
                          if($recomended_mem_data[0]['edited_mem_photo'] == '0' && is_file(get_img_name($row['regnumber'], 'p')))//Photo value Not updated by candidate, so display fixed checkbox 
                          { ?>
                          <input type="checkbox" checked="checked" disabled> 
                          <input type="checkbox" name="cbox[]" id="cbox" value="photo_checkbox" checked="checked" style="display:none"> 
                          <?php }
                          else //Photo value updated by candidate, so display functional checkbox
                          { ?>
                          <input type="checkbox" name="cbox[]" id="cbox" value="photo_checkbox" <?php if (is_file(get_img_name($row['regnumber'], 'p'))) { echo 'checked="checked"'; } ?>>
                        <?php } ?>                            
                      </td>
                      
                      <td>
                        <?php 
                          if($recomended_mem_data[0]['edited_mem_sign'] == '0' && is_file(get_img_name($row['regnumber'], 's')))//Signature value Not updated by candidate, so display fixed checkbox 
                          { ?>
                          <input type="checkbox" checked="checked" disabled> 
                          <input type="checkbox" name="cbox[]" id="cbox" value="sign_checkbox" checked="checked" style="display:none"> 
                          <?php }
                          else //Signature value updated by candidate, so display functional checkbox
                          { ?>
                          <input type="checkbox" name="cbox[]" id="cbox" value="sign_checkbox" <?php if (is_file(get_img_name($row['regnumber'], 's'))) { echo 'checked="checked"'; } ?>>
                        <?php } ?>                            
                      </td>
                      
                      <td>
                        <?php 
                          if($recomended_mem_data[0]['edited_mem_proof'] == '0' && is_file(get_img_name($row['regnumber'], 'pr')))//ID Proof value Not updated by candidate, so display fixed checkbox 
                          { ?>
                          <input type="checkbox" checked="checked" disabled> 
                          <input type="checkbox" name="cbox[]" id="cbox" value="idprf_checkbox" checked="checked" style="display:none"> 
                          <?php }
                          else //ID Proof value updated by candidate, so display functional checkbox
                          { ?>
                          <input type="checkbox" name="cbox[]" id="cbox" value="idprf_checkbox" <?php if (is_file(get_img_name($row['regnumber'], 'pr'))) { echo 'checked="checked"'; } ?>>
                        <?php } ?>                            
                      </td>
                      
                      <!-- Pooja mane code starts: 2024-08-14 -->
                        <?php 
                          if($row['registrationtype'] == 'NM' && $recomended_mem_data[0]['edited_employee_proof'] == '0' && is_file(get_img_name($row['regnumber'], 'empr')))//ID Proof value Not updated by candidate, so display fixed checkbox 
                          { ?>
                          <td>
                          <input type="checkbox" checked="checked" disabled> 
                          <input type="checkbox" name="cbox[]" id="cbox" value="empidprf_checkbox" checked="checked" style="display:none"> 
                          <?php 
                          }
                          elseif($row['registrationtype'] == 'NM' && in_array($result[0]['excode'], $fedai_array) && $result[0]['createdon'] >='2024-07-01') //ID Proof value updated by candidate, so display functional checkbox
                          { ?>
                          <input type="checkbox" name="cbox[]" id="cbox" value="empidprf_checkbox" <?php if (is_file(get_img_name($row['regnumber'], 'empr'))) { echo 'checked="checked"'; } ?>>
                          </td>
                          <?php 
                          } ?>                            
                        ...
                        <?php 
                        if ($result[0]['date_of_commenc_bc'] != '' && $recomended_mem_data[0]['edited_bank_bc_id_card'] == '0' && is_file(get_img_name($row['regnumber'], 'bank_bc_id_card'))) {
                            // ID Proof value Not updated by candidate, so display fixed checkbox 
                        ?>
                            <td>
                                <input type="checkbox" checked="checked" disabled> 
                                <input type="checkbox" name="cbox[]" id="cbox" value="bcempidprf_checkbox" checked="checked" style="display:none">  
                            </td>
                        <?php 
                        } elseif ($result[0]['date_of_commenc_bc'] != '') {
                            // ID Proof value updated by candidate, so display functional checkbox
                        ?>
                            <td>
                                <input type="checkbox" name="cbox[]" id="cbox" value="bcempidprf_checkbox" <?php if (is_file(get_img_name($row['regnumber'], 'bank_bc_id_card'))) { echo 'checked="checked"'; } ?>>
                            </td>
                        <?php 
                        } 
                        ?>

                        <!-- Pooja mane code ends: 2024-10-17 -->
                      ...
                      <?php /*  
                        - SAGAR WALZADE : Code start here. 
                      - Changes : adding new field and data that is : "declaration" */
                      if ($row['registrationtype'] == 'O' || ($row['registrationtype'] == 'NM' && in_array($result[0]['excode'], $fedai_array) && $result[0]['createdon'] >='2024-07-01'))
                      { ?>
                      <td>
                        <?php 
                          if($recomended_mem_data[0]['edited_mem_declaration'] == '0' && is_file(get_img_name($row['regnumber'], 'declaration')))//Declaration value Not updated by candidate, so display fixed checkbox 
                          { ?>
                          <input type="checkbox" checked="checked" disabled> 
                          <input type="checkbox" name="cbox[]" id="cbox" value="declaration_checkbox" checked="checked" style="display:none"> 
                          <?php }
                          else  //Declaration value updated by candidate, so display functional checkbox
                          { ?>
                          <input type="checkbox" name="cbox[]" id="cbox" value="declaration_checkbox" <?php if (is_file(get_img_name($row['regnumber'], 'declaration'))) { echo 'checked="checked"'; } ?>>
                        <?php } ?>                                
                      </td>
                      <?php } ?><?php /* SAGAR WALZADE : Code end here */?>
                    </tr>
                    <?php }
                  } 
                  else 
            ...
            <center>
              ...
              <a href="<?php echo base_url() ?>admin/kyc/Kyc/edited_allocation_type/" class="btn btn-info">Back</a>
              <?php
                //$where = ("(user_edited_date = '0000-00-00 00:00:00' OR user_edited_date > '".date('Y-m-d H:i:s')."')");
                $this->db->select('*');
                //$where = ("(user_edited_date = '0000-00-00 00:00:00' OR user_edited_date >recommended_date)");
                //$this->db->where($where);
                //$this->db->group_by('member_kyc.regnumber');
                //$members = $this->master_model->getRecords("member_kyc", array('regnumber'=>$this->uri->segment(5),'recommended_by'=>$this->session->userdata('kyc_id'),'record_source '=>'Edit'),'MAX(kyc_id),regnumber,kyc_state',array('kyc_id'=>'DESC'),'','1');
                /*	$members = $this->master_model->getRecords("member_kyc", array('regnumber'=>$this->uri->segment(5)),'',array('kyc_id'=>'DESC'),'','1');
                  //echo $this->db->last_query();
                  if(count($members) > 0)
                  {
                  if($members[0]['kyc_state']!=2)
                  {
                  ?>
                  ...
                  <?php /*?>   <?php if($next_id!='')
                  {?>
                	<a href="<?php echo base_url()?>admin/kyc/Kyc/edited_member/<?php echo $next_id?>"  class="btn btn-info"  >Next</a>
                  <?php 
                  }
                  else
                  {?>
                  <a href="<?php echo base_url().'admin/kyc/Kyc/next_edited_allocation_type'?>"  class="btn btn-info">Next</a>
                  <?php 
                }?><?php */ ?>
                ...
                <?php /*?> <a href="javascript:void(0)"  class="btn btn-info" onclick="check_next()">Next</a><?php */ ?>
                ...
                <div style="color:#F00; display:none" id="next_id"> You need to submit to proceed for next record</div>
                <div style="color:#F00; display:none" id="next_id_sub"> You cannot submit the record again </div>
            </center>
...
<?php
  ...
  */
  if (!empty($result) && isset($result[0]['registrationtype']) && ($result[0]['registrationtype'] == 'O' || $result[0]['registrationtype'] == 'NM' && in_array($result[0]['excode'], $fedai_array))) { //Added fedai member check for declaration by pooja mane 2024-08-14
