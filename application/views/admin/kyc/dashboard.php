              ...
              <div class="table-responsive">
                <table class="table table-bordered">
                  <tr>
                    <td>Members</td>
                    <td>
                      >>&nbsp;<a href="<?php echo base_url();?>admin/kyc/Kyc/pending_member_list">Pending member list&nbsp;&nbsp;&nbsp;
                        
                        >>&nbsp;<a href="<?php echo base_url();?>admin/kyc/Kyc/pending_allocation_type">Allocate pending members&nbsp;&nbsp;&nbsp;
