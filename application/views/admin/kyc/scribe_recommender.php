			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header">
						<h3 class="box-title">Member Records</h3>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
						<?php
									...
									<?php
										...
										if(count($result))
										{
											...
											<tr>
												...
												?>
												<td><a href="<?php echo base_url(); ?>admin/kyc/Kyc/scribe_member/<?php echo $row['regnumber']; ?>/<?php echo $srno; ?>/<?php echo $totalRecCount; ?>">Recommend</a></td>
											</tr>
											<?php 
												$row_count++;		
											} 
...
<script type="application/javascript">
	...
	$(function () {
		...
		var listing_url = base_url+'admin/kyc/Kyc/scribe_recommender/';
