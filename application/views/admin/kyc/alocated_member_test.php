...
<div class="content-wrapper"> 
  ...
  <div class="collapsee" id="collapseExample">
    ...
    <form class="form-control" name="searchExamDetails" id="searchExamDetails" action="
      <?php echo base_url('admin/kyc/Kyc/allocated_list'); ?>" method="post">
      <div class="row">
        <div class="col-sm-3">
					   ...
					   if(count($result))
				   	   {
                            ...
                            <tr>
                                ...
                                ?>
                              	...
                              	<td><a href="<?php echo base_url(); ?>admin/kyc/Kyc/member/<?php echo $row['regnumber']; ?>/<?php echo $srno; ?>/<?php echo $totalRecCount; ?>">Recommend</a></td>
                            </tr>
               	   <?php 
						$row_count++;		
				  			} 
