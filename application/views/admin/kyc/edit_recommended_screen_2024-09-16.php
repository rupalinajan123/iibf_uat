              ...
              <table id="listitems" class="table table-bordered table-striped dataTables-example">
                <thead>
                  <tr>
                    ...
                    <?php 
                        if(in_array($result[0]['excode'], $fedai_array)){?>
                ...
                <tbody class="no-bd-y" id="list">
                  <?php
                    ...
                    <tr>
                      ...
                      <td>
                        <?php 
                          if($recomended_mem_data[0]['edited_employee_proof'] == '0' && is_file(get_img_name($row['regnumber'], 'empr')))//ID Proof value Not updated by candidate, so display fixed checkbox 
                          { ?>
                          <input type="checkbox" checked="checked" disabled> 
                      ...
                      <?php /*  
                        - SAGAR WALZADE : Code start here. 
                      - Changes : adding new field and data that is : "declaration" */
                      if ($row['registrationtype'] == 'O' || ($row['registrationtype'] == 'NM' && in_array($result[0]['excode'], $fedai_array)))
                      { ?>
                      <td>
                        <?php 
