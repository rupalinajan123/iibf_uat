...
<div class="content-wrapper"> 
	...
	<section class="content-header">
		<h1>  Scribe Member Allocation </h1>
	</section>
	<br />
	<div class="col-md-12">
		...
		<div class="row">
			<div class="col-xs-12">
				<div class="box">
					...
					<!-- /.box-header -->
					<div class="box-body">
						<form class="form-horizontal" name="Select By" id="Select By" action="<?php echo base_url();?>admin/kyc/Kyc/scribe_allocated_list" method="post">  
							<div class="col-sm-2">
