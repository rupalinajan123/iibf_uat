    ...
    <section class="content">
		<div class="row">
			<div class="col-xs-12">
						...
						<form class="form-horizontal" name="checkmember" id="checkmember" action="<?php echo base_url();?>admin/kyc/Kyc/benchmark_member/<?php echo $reg_no?>/<?php echo $selected_srno;?>/<?php echo $totalCount; ?>" method="post">
							<table id="listitems" class="table table-bordered table-striped dataTables-example">
								...
								<tbody class="no-bd-y" id="list">
                                    ...
                                    <img src="<?php echo base_url().$actual_visually; ?>" style="height:150px; width:auto;">
                                  </a>
                                    ...
                                    <img src="<?php echo base_url().$actual_orthopedically; ?>" style="height:150px; width:auto;">
                                  </a>
                                    ...
                                    <img src="<?php echo base_url().$actual_cerebral; ?>" style="height:150px; width:auto;">
                                  </a>
				...
				<div class="col-sm-6">
				<textarea id="mailtext" class="textarea1" name="mailtext"  >Hello <?php echo $row['firstname']." ".$row['lastname'];?>,
	...
	$.ajax({
		...
		success:function(data){
			...
			{  
				...
				//var mailtext = divide();   alert(mailtext);
			}
