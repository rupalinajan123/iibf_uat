<?php $this->load->view('admin/blendedDashboard/includes/header');?>
<?php $this->load->view('admin/blendedDashboard/includes/sidebar');?>
    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="box">
          ...
          <div class="box-body">
            <form class="form-horizontal" name="btnSearch" id="btnSearch" action="<?php echo base_url();?>admin/blended/BlendedData/getMembers"  method="post">
              <!--<div class="col-sm-2">
                <input type="text" class="form-control" id="member_no" name="member_no" placeholder="Membership No."/>
              </div>-->
              <div class="col-sm-2">
                <input type="text" class="form-control" id="program_code" name="program_code" placeholder="Program Code"/>
              </div>
              <div class="col-sm-2">
                <input type="text" class="form-control" id="batch_code" name="batch_code" placeholder="Batch Code"/>
              </div>
              <div class="col-sm-2">
                <input type="text" class="form-control" id="training_type" name="training_type" placeholder="Training Type"/>
              </div>
              <div class="col-sm-2">
            ...
            <table id="listitems" class="table table-bordered table-striped dataTables-example">
              <thead>
                <tr>
                  <th id="">Sr No</th>
                  <th id="5%">Date</th>
                  <th id="5%">Member No.</th>
                  <th id="5%">Program Code</th>
                  <th id="5%">Batch Code</th>
                  <th id="5%">Zone Code</th>
                  <th id="5%">Traning Type</th>
                  <th id="5%">Center Code</th>
                  <th id="10%">Course Date</th>
                </tr>
              </thead>
              <?php 
			   $row_count=1;
...
<?php $this->load->view('admin/blendedDashboard/includes/footer');?>
