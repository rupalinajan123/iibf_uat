    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
       <!-- <li class="header">MAIN NAVIGATION</li>-->
        <li class="treeview">
         <a href="<?php echo base_url();?>admin/DupCert/Dupcertdash/">
            ...
            <li class="treeview">
                ...
                <li <?php if(stristr(current_url(),'admin/DupCert/Dupcertdash/dup_cert_data') || stristr(current_url(),'admin/finquest/Finquest/')) { echo 'class="active"'; } ?>>
               			<a href="<?php echo base_url();?>admin/DupCert/Dupcertdash/dup_cert_data"><i class="fa fa-circle-o"></i> Duplicate Certificate Statistic </a>
                 	
                  </li>
		</li>
		<li class="treeview">
          
                <li <?php if(stristr(current_url(),'admin/DupCert/Dupcertdash/cpd_data') || stristr(current_url(),'admin/finquest/Finquest/')) { echo 'class="active"'; } ?>>
               			<a href="<?php echo base_url();?>admin/DupCert/Dupcertdash/cpd_data"><i class="fa fa-circle-o"></i> CPD statistic</a>
                 	
                </li>
		</li> 
		<li class="treeview">
          
                <li <?php if(stristr(current_url(),'admin/DupCert/Dupcertdash/dra_data') || stristr(current_url(),'admin/DupCert/Dupcertdash/')) { echo 'class="active"'; } ?>>
               			<a href="<?php echo base_url();?>admin/DupCert/Dupcertdash/dra_data"><i class="fa fa-circle-o"></i>DRA statistic</a>
                 	
                </li>
		</li> 
		<li class="treeview">
          
                <li <?php if(stristr(current_url(),'admin/DupCert/Dupcertdash/AMP_Data') || stristr(current_url(),'admin/DupCert/Dupcertdash/')) { echo 'class="active"'; } ?>>
               			<a href="<?php echo base_url();?>admin/DupCert/Dupcertdash/AMP_Data"><i class="fa fa-circle-o"></i>Amp statistic</a>
