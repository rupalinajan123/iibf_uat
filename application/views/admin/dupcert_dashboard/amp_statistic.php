    ...
    <section class="content">
			...
			<div class="col-sm-12">
				<div class="panel panel-default">
					<div class="panel-body">
                        <a  data-toggle="tooltip" class="btn btn-warning" href="<?php echo base_url('admin/DupCert/Dupcertdash/download_CSV_amp'); ?>"> Download CSV </a>
	  ...
	  <!-------------------Count div start--------------->
			<div class="col-sm-12">
				<div class="panel panel-default">
					<div class="panel-body">
                          <b> Total Members Applied For AMP</b>
                    </div>
					<div class="panel-footer"><?php echo $total_count; ?></div>
				</div>
			</div>
