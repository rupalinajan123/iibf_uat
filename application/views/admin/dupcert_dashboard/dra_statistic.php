    ...
    <section class="content">
			...
			<div class="col-sm-12">
				<div class="panel panel-default">
					<div class="panel-body">
                        <a  data-toggle="tooltip" class="btn btn-warning" href="<?php echo base_url('admin/DupCert/Dupcertdash/download_CSV_dra'); ?>"> Download CSV </a>
	  ...
	  <!-------------------Count div start--------------->
			<div class="col-sm-12">
				<div class="panel panel-default">
					<div class="panel-body">
                          <b> Total Members Applied For DRA</b>
                    </div>
					<div class="panel-footer"><?php echo $total_count; ?></div>
				</div>
			</div>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
          <form class="form-horizontal" name="searchDate" id="searchDate" action="<?php echo base_url();?>admin/DupCert/Dupcertdash/dra_data" method="post">
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
			...
			<table id="listitems" class="table table-bordered table-striped dataTables-example">
                ...
                <tr>
                  <th id="">Sr No</th> 
                  <th id="">Institute Name</th> 
                  <th id="">Institute Type</th>
                  <th id="">Date</th>
                  <th id="">due diligence</th>
			...
			if(count($success_data)){
						...
						<tr>
							...
							<td><?php echo $row['due_diligence'];?></td>
						</tr>
                  <?php $row_count++; }} ?>   
