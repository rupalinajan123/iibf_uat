    ...
    <section class="content">
	  ...
	  <!-------------------Count div start--------------->
			<div class="col-sm-12">
				<div class="panel panel-default">
					<div class="panel-body">
                          <b> Total Members Applied For Duplicate Certificate</b>
                    </div>
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
          <form class="form-horizontal" name="searchDate" id="searchDate" action="<?php echo base_url();?>admin/DupCert/Dupcertdash/dup_cert_data" method="post">
