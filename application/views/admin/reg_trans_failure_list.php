          ...
          <div class="box">
            <div class="box-header">
              ...
              <!--<div class="pull-right">
              	<a href="<?php echo base_url();?>admin/Search/search_failure" class="btn btn-info">Refresh</a>
              </div>-->
            </div>
           <div class="box-body">
            
                <div class="col-sm-12">
                <form class="form-horizontal" name="search" id="search" action="<?php echo base_url();?>admin/Search/failure/1" method="post">
                   ...
                   <div class="form-group">
                        ...
                        <input type="reset" class="btn btn-warning" name="btnReset" id="btnReset" value="Clear">
                   </div>
                 </form>
                 </div>
          ...
          <div class="box">
			...
			<table id="listitems" class="table table-bordered table-striped dataTables-example">
                ...
                <tr>
                  ...
                  <th id="">Send Registration <br /> Mail</th>
                  <th id="">Edit</th>
                </tr>
                </thead>
                <tbody class="no-bd-y" id="list">
				  ...
				  ?>
                    <tr>
                        ...
                        <td>
                        	<!--<a href="<?php echo base_url(); ?>admin/Report/send_mail/<?php echo base64_encode($row['regid']); ?>/<?php echo base64_encode($row['regnumber']); ?>" onclick="return confirm('Do you want to re-send registration mail?');">Send Mail</a>-->
                        </td>
                        <td>
                        	<!--<a href="<?php echo base_url(); ?>admin/Report/reg_edit/<?php echo base64_encode($row['regid']); ?>">Edit</a>-->
                        </td>
                    </tr>
                  <?php }} else{ ?>
                  		<tr>
