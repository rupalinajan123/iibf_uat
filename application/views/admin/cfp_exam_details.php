...
<?php } else {
  ?>
  <?php $this->load->view('admin/includes/cfp_sidebar');?>
  <?php
} ?>
          ...
          <div class="box">
            <div class="box-header">
              ...
              <div class="pull-right">
              	<a href="<?php echo base_url(); ?>admin/Cfp/exportToCSV?from_date=<?php echo $from_date;?>&end_date=<?php echo $end_date;?>" class="btn btn-warning" id="exportBtn">Export To CSV</a>
            ...
            <div class="table-responsive">
			        <table id="cfplistitems" class="table table-bordered ">
                <thead>
                <tr>
                  <th id="srNo">S.No.</th>                  
                  ...
                  <th id="transaction_no">Mobile Number</th>
                  <th id="medium_description">Member Type</th>
                  <th id="center_name">CFP Processing Fees</th>
                  <th id="transaction_details">Total</th>
                  <th id="date">Option to Share Exam Results</th>
                </tr>
                </thead>
