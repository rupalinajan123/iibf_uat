          ...
          <div class="box">
            <div class="box-header">
              ...
              <div class="pull-right">
              	<a href="<?php echo base_url(); ?>admin/Center_change/exportToCSV?from_date=<?php echo $from_date;?>&end_date=<?php echo $end_date;?>" class="btn btn-warning" id="exportBtn">Export To CSV</a>
            ...
            <div class="table-responsive">
                ...
                <tr>
                  ...
                  <th id="exam_fee">Old Center</th>
                  <th id="exam_fee">New Center</th>
                  <th id="">Status</th>
                  <th id="">Date</th>
                  <th id="transaction_no">View</th>
                </tr>
                </thead>
                  ...
                  $i=1;
                    foreach($result as $row) {
                     ...
                     if($row['status']=='Approved')
                      ...
                      $status ='<span class="btn btn-sm btn-success">Pending</span>';
                      if($row['status']=='Rejected')
                      $status ='<span class="btn btn-sm btn-success">Rejected</span>';
                      ?>
                     <tr>
                      <td><?php echo $i++; ?></td>
                      ...
                      <td><?php echo $row['old_center_name'] ?></td>
                      <td><?php echo $row['center_name'] ?></td>
                      <td><?php echo $status ?></td>
                      <td><?php echo $row['createdon'] ?></td>
                      <td><a class="btn btn-sm btn-info" href="<?php echo base_url(); ?>admin/Center_change/details/<?php echo base64_encode($row['id']) ; ?>">View</a></td>
                     </tr>
                    <?php } ?>
                </tbody>
              </table>
