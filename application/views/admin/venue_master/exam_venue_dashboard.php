...
<div class="content-wrapper">
  ...
  <section class="content">
    <form class="form-horizontal" name="addForm" id="addForm" action="<?php echo base_url();?>admin/venue_master/ExamVenueDashboard" method="post">
      <!-- Main content -->
      <div class="row">
        <div class="col-md-12">
          <!-- Horizontal Form -->
    ...
    <div class="control-group" id="div_department_CC">
          ...
          <div class="box-footer">
            <div class="col-sm-2 col-xs-offset-5">
              ...
              <a href="<?php echo base_url();?>admin/venue_master/ExamVenueDashboard" class="btn btn-default pull-right">Refresh</a> </div>
          </div>
          <?php //if($result_text!=''){?>
          <div class="box-footer">
            <div class="box-body">
        ...
        <div class="box">
          ...
          <div class="box-body">
            <?php  if(!empty($Total_registration) )
			 {?>
            <a href="<?php echo base_url();?>admin/venue_master/ExamVenueDashboard/download_CSV/<?php echo $exm_prd; ?>/<?php echo $exm_cd; ?>">
...
<script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                $('#authority').on('change', function() {
                    ...
                    if (period) {
                        $.ajax({
                            type: 'POST',
                            url: base_url + "/admin/venue_master/ExamVenueDashboard/get_multiple_exam",
            ...
            $(function() {
                $("#listitems").DataTable();
                var base_url = '<?php echo base_url(); ?>';
                var listing_url = base_url + 'admin/venue_master/ExamVenueDashboard';
