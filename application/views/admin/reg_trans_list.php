...
<?php $this->load->view('admin/includes/sidebar');?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Success Transaction(Only Registration)
     </h1>
      <?php echo $breadcrumb; ?>
    </section>
    <br />
        ...
        <div class="col-xs-12">
          ...
          <div class="box">
           ...
           <div class="box-body">
                ...
                <div class="col-sm-12">
                <form class="form-horizontal" name="search" id="search" action="<?php echo base_url();?>admin/Search/success/1" method="post">
                ...
                <tbody class="no-bd-y" id="list">
				  ...
				  ?>
                    <tr>
                        ...
                        <td>
                        	<a href="<?php echo base_url(); ?>admin/Report/send_mail/<?php echo base64_encode($row['regid']); ?>/<?php echo base64_encode($row['regnumber']); ?>/1" onclick="return confirm('Do you want to re-send registration mail?');">Send Mail</a>
                        </td>
                        <td>
