  ...
  <section class="content">
    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Employee/Agent Details</h3>
              <div class="pull-right">
              	<a href="<?php echo base_url();?>admin/ippb/IppbDashboard/add" class="btn btn-warning">Add</a>                
                <a href="<?php echo base_url();?>admin/ippb/IppbDashboard/download_CSV" class="btn btn-primary">Download All</a>
            ...
            <table id="listitems" class="table table-bordered table-striped dataTables-example">
              <thead>
                <tr>
                  ...
                  <th id="circle">Circle</th> -->
                  <th id="createdon">Created Date</th>
...
$(function () {
	var listitems = $("#listitems").DataTable();
  
	var base_url = '<?php echo base_url(); ?>';
	var listing_url = base_url+'admin/ippb/IppbDashboard/getList';
