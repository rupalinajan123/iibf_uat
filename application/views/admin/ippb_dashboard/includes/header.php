...
<title>IIBF | IPPB Dashboard</title>
...
<header class="main-header"> 
  <!-- Logo --> 
  <a href="<?php echo base_url();?>admin/ippb/IppbDashboard" class="logo"> 
  ...
  <nav class="navbar navbar-static-top"> 
    ...
    <div class="navbar-custom-menu">
      <ul class="nav navbar-nav navlogo">
        ...
        <li class="dropdown user user-menu"> <a href="<?php echo  base_url()?>ippb_login/admin/login/Logout" class="dropdown-toggle" ><!--data-toggle="dropdown"--> 
