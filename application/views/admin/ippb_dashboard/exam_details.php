     ...
     <div class="searchfilter">
          <div class="box-header">
            ...
            <div class="collapsee" id="collapseExample">
              ...
              <form class="form-control" name="searchExamDetails" id="searchExamDetails" action="<?php echo base_url('admin/ippb/IppbDashboard/csv'); ?>" autocomplete="off" method="post">
                <div class="row">
                  <div class="col-sm-2">
    ...
    <section class="content">
      ...
      <table id="listitems" class="table table-bordered table-striped dataTables-example" role="grid">
                ...
                <tr>
                  ...
                  <th id="selected_vendor">Vendor</th>
                  ...
                  <th id="admitcard_image">Admit card</th>
                </tr>
                </thead>
                ...
                <table class="table" style="width:100%;">
                    <thead>
                        <tr>
                            ...
                            <th id="transaction_details">Payment Status</th>
                            <th id="date">Transaction Time</th>
                            <th id="admitcard_image">Admitcard Image</th>
                        </tr>
                    </thead>
