                    ...
                    <div class="form-group">
                      <form class="form-horizontal" name="searchDate" id="searchDate" action="" method="post">
                        <label for="from_date" class="col-sm-1">From:</label>
                             <div class="col-sm-2">
                                <input type="text" class="form-control" id="from_date" name="from_date" placeholder="From Date" required value="<?php if($this->session->userdata('from_date')!=''){ echo $this->session->userdata('from_date');}?>" readonly>
                                 <span class="error"><?php echo form_error('from_date');?></span>
                            </div>
                        
                        <label for="to_date" class="col-sm-1">To:</label>
                             <div class="col-sm-2">
                                <input type="text" class="form-control" id="to_date" name="to_date" placeholder="To Date" required value="<?php if($this->session->userdata('to_date')!=''){ echo $this->session->userdata('to_date');}?>" readonly>
