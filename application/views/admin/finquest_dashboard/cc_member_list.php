        ...
        <div class="col-xs-12">
          ...
          <div class="box">
			...
			if(count($cc_mem_info)){
                    ...
                    <td><?php if($row['program_code']!='')
                    {
                    echo $row['program_code'];
                    }
                    
                    ?></td> 
                    <td><?php if($row['program_prd']!='')
                    {
                    echo $row['program_prd'];
                    }
                    
                    ?></td>    <td><?php 
					
					echo $row['center_code'];
					
	?></td>
                    <td><?php 
				if(count($cc_sub_info))
				{
					foreach($cc_sub_info as $val)
					{
						if($val['sub_code']!='')
						{
						echo $val['sub_code'];
