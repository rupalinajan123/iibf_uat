            ...
            <?php echo validation_errors(); ?>
                ...
                <div class="form-group">
                	<label for="exam_month" class="col-sm-2 control-label">Qualifying Exam1</label>
                         <div class="col-sm-3">
                            <input type="text" class="form-control" id="qualifying_exam1" name="qualifying_exam1" placeholder="Qualifying Exam1"  value="<?php echo $examRes['qualifying_exam1']; ?>" onkeypress="return (alphanumber(event) && alphanumberctrl(event));" data-parsley-pattern="/^[a-zA-Z0-9 ]+$/" >
                    ...
                    <label for="trg_value" class="col-sm-2 control-label">Qualifying Part1</label>
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="qualifying_part1" name="qualifying_part1" placeholder="Qualifying Part1" value="<?php echo $examRes['qualifying_part1']; ?>" onkeypress="return (alphanumber(event) && alphanumberctrl(event));" data-parsley-pattern="/^[a-zA-Z0-9 ]+$/">
                ...
                <div class="form-group">
                	<label for="exam_month" class="col-sm-2 control-label">Qualifying Exam2</label>
                         <div class="col-sm-3">
                            <input type="text" class="form-control" id="qualifying_exam2" name="qualifying_exam2" placeholder="Qualifying Exam2"  value="<?php echo $examRes['qualifying_exam2']; ?>" onkeypress="return (alphanumber(event) && alphanumberctrl(event));" data-parsley-pattern="/^[a-zA-Z0-9 ]+$/">
                    ...
                    <label for="trg_value" class="col-sm-2 control-label">Qualifying Part2</label>
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="qualifying_part2" name="qualifying_part2" placeholder="Qualifying Part2" value="<?php echo $examRes['qualifying_part2']; ?>" onkeypress="return (alphanumber(event) && alphanumberctrl(event));" data-parsley-pattern="/^[a-zA-Z0-9 ]+$/">
                ...
                <div class="form-group">
                	<label for="exam_month" class="col-sm-2 control-label">Qualifying Exam3</label>
                         <div class="col-sm-3">
                            <input type="text" class="form-control" id="qualifying_exam3" name="qualifying_exam3" placeholder="Qualifying Exam3"  value="<?php echo $examRes['qualifying_exam3']; ?>" onkeypress="return (alphanumber(event) && alphanumberctrl(event));" data-parsley-pattern="/^[a-zA-Z0-9 ]+$/">
                    ...
                    <label for="trg_value" class="col-sm-2 control-label">Qualifying Part3</label>
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="qualifying_part3" name="qualifying_part3" placeholder="Qualifying Part3" value="<?php echo $examRes['qualifying_part3']; ?>" onkeypress="return (alphanumber(event) && alphanumberctrl(event));" data-parsley-pattern="/^[a-zA-Z0-9 ]+$/">
                ...
                <div class="form-group">
                    ...
                    <label for="trg_value" class="col-sm-2 control-label">Exam Priority</label>
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="examprty" name="examprty" placeholder="Exam Priority" value="<?php echo $examRes['examprty']; ?>" >
                ...
                <div class="form-group">
                	<label for="exam_month" class="col-sm-2 control-label">Existing Instruction File</label>
                         <div class="col-sm-6">
                            <input type="hidden" id="exam_instruction_file_hidden" name="exam_instruction_file_hidden" value="<?php echo $examRes['exam_instruction_file']; ?>">
                            	<a href="<?php echo base_url(); ?>uploads/exam_instruction/<?php echo $examRes['exam_instruction_file']; ?>" target="_blank"><?php echo $examRes['exam_instruction_file']; ?></a>
                        </div>
                </div>
                <?php } ?>
                <div class="form-group">
