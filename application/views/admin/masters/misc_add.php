          ...
          <div class="box box-info">
            ...
            <?php //echo validation_errors(); ?>
             ...
             <?php } ?> 
                ...
                <label for="roleid" class="col-sm-2 control-label">Exam Name *</label>
                	<div class="col-sm-3">
                     <?php 
                    ...
                    <label for="exam_period" class="col-sm-2 control-label">Exam Period *</label>
                     <div class="col-sm-3">
                        <input type="text" class="form-control" id="exam_period" name="exam_period" placeholder="Exam Period" required value="<?php echo $miscRes['exam_period'];?>" data-parsley-pattern="/^[a-zA-Z0-9]+$/" onkeypress="return alphanumber(event);">
