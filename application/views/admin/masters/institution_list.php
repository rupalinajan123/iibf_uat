          ...
          <div class="box">
            <div class="box-header">
              ...
              <div class="pull-right">
              	<a href="<?php echo base_url();?>admin/InstitutionMaster/add" class="btn btn-warning">Add</a>
                <a href="<?php echo base_url();?>admin/InstitutionMaster/import" class="btn  btn-primary">Import</a>
                <a href="<?php echo base_url();?>admin/InstitutionMaster/download" class="btn  btn-primary">Download</a>
            ...
            <?php } ?> 
              ...
              <table id="listitems" class="table table-bordered table-striped dataTables-example">
                ...
                <tr>
                  ...
                  <th id="srNo">S.No.</th>
                  <th id="name">Institute Name</th>
                  <th id="institude_id">Institute Code</th>
...
$(function () {
	...
	var listing_url = base_url+'admin/InstitutionMaster/getList';
