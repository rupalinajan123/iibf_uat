...
<?php $this->load->view('admin/includes/sidebar');?>
  ...
  <div class="content-wrapper">
	...
	<?php //echo form_open_multipart('admin/DesignationMaster/import');?>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Import Designation Master</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <div class="box-body">
             ...
             <?php } ?>  
                ...
                <div class="form-group">
                	<label for="password" class="col-sm-6 control-label">Upload Text File</label>
                     <div class="col-sm-6">
                        <input type="file" name="designationmasterfile" required id="designationmasterfile"> 
                         <span class="error"><?php echo form_error('designationmasterfile');?></span>
                         <small> (Please upload text file with 2MB Size)</small> 
                    </div>
                </div>
                <div class="form-group" align="center">
                	<a href="<?php echo base_url();?>uploads/admin/masters_sample_files/DESIGN_MASTER_ALL_112.TXT" target="_blank">Click here to check the sample file format</a>
                </div>
