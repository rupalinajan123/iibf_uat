            ...
            <?php echo validation_errors(); ?>
             ...
             <?php } ?> 
                ...
                <div class="form-group" align="center">
                	<a href="<?php echo base_url();?>uploads/admin/masters_sample_files/MISC_PARAMETER_ALL_212.TXT" target="_blank">Click here to check the sample file format</a>
                </div>
              ...
              <div class="box-footer">
                  <div class="col-sm-2 col-xs-offset-5">
                    ...
                    <a href="<?php echo base_url();?>admin/MiscMaster" class="btn btn-default pull-right">Back</a>
                    </div>
              </div>
           </div>
        </div>
