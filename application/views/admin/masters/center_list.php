          ...
          <div class="box">
            <div class="box-header">
              ...
              <div class="pull-right">
              	<a href="<?php echo base_url();?>admin/CenterMaster/add" class="btn btn-warning">Add</a>
                <a href="<?php echo base_url();?>admin/CenterMaster/import" class="btn  btn-primary">Import</a>
                <a href="<?php echo base_url();?>admin/CenterMaster/download" class="btn  btn-primary">Download</a>
...
$(function () {
	...
	var listing_url = base_url+'admin/CenterMaster/getList';
