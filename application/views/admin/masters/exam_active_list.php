          ...
          <div class="box">
            <div class="box-header">
              ...
              <div class="pull-right">
              	<a href="<?php echo base_url();?>admin/ExamActiveMaster/add" class="btn btn-warning">Add</a>
                <a href="<?php echo base_url();?>admin/ExamActiveMaster/import" class="btn  btn-primary">Import</a>
                <a href="<?php echo base_url();?>admin/ExamActiveMaster/download" class="btn  btn-primary">Download</a>
...
$(function () {
	...
	var listing_url = base_url+'admin/ExamActiveMaster/getList';
