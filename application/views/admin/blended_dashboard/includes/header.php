...
<title>IIBF | Blended Dashboard</title>
  ...
  <nav class="navbar navbar-static-top"> 
    ...
    <div class="navbar-custom-menu">
      <ul class="nav navbar-nav navlogo">
        ...
        <li class="dropdown user user-menu"> <a href="<?php echo  base_url()?>blended_login/admin/login/Logout" class="dropdown-toggle" ><!--data-toggle="dropdown"--> 
