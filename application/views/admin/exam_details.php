              ...
              <div class="pull-left" style="700px;">
                <div class="col-sm-12">
                  <form class="form-horizontal" name="searchExamDetails" id="searchExamDetails" action="" method="post">      
                        <label for="to_date" class="col-sm-2">Search By</label>
                         <div class="col-sm-3">
                            ...
                            <select class="form-control" name="searchBy" id="searchBy" required>
                                ...
                                <option value="01">Exam Code</option>
                        ...
                        <div class="col-sm-3">
                       		<input type="button" class="btn btn-info" name="btnSearch" id="btnSearch" value="Search" onclick="return searchOnFields();">
                        </div> 
                    </form> 
                </div>
              </div>
...
$(function () {
	$("#listitems").DataTable();
	var base_url = '<?php echo base_url(); ?>';
	var listing_url = base_url+'admin/Report/getExamReport';
