  ...
  <div><a>INDIAN INSTITUTE OF BANKING &amp; FINANCE<br><small>(An ISO 9001:2008 Certified)</small></a></div>
            ...
            <div class="login-box-body">
				...
				<?php /*	<p class="text-center blue">Please verify your humanity by solving the puzzle.</p>
                    ...
                    <div class="row">
                        ...
                        <!-- <div class="col-xs-4">
                            <button type="button" onclick="location.href='<?php echo base_url('case_writing_competition/registration'); ?>';" class="btn btn-primary btn-block btn-flat" name="submit">New Registration</button>
                        </div> -->
        ...
        <script type="text/javascript">
			...
			function refresh_captcha_img()
            {
                ...
                {
                    type: 'POST',
                    url: '<?php echo site_url("case_writing_competition/login/generate_captcha_ajax/"); ?>',
                    data: { "session_name":"CASE_WRITING_COMPETITION" },
                    async: false,
