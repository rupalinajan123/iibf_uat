<?php $this->load->view('case_writing_competition/admin/includes/header');?>
<?php $this->load->view('case_writing_competition/admin/includes/sidebar');?>
...
<div id="page_loader"><div class="loading">Processing...</div></div>
  ...
  <div class="content-wrapper">
    <section class="content-header">      
      <h1>
        Case Study Writing Competition List
        <?php if($batch_id != "") 
        { ?>
          <!-- <a href="<?php echo site_url('case_writing_competition/batch');?>" class="btn btn-warning pull-right">Back</a> -->
        <?php } ?> 
        <?php //echo $breadcrumb; ?>
      </h1>
    </section>  
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">           
            <div class="box-body"> 
              <form class="form-control border-0" action="<?php echo base_url('case_writing_competition/Dashboard/get_case_study_comp_registration'); ?>" method="post">
              <div class="row">    
          ...
          <table id="listitems22" class="table table-bordered table-striped dataTables-examplexx">
                ...
                <th class="text-center">Case Study Title</th>
...
<script type="text/javascript">
  $(document).ready(function()
  {
    ...
    var dataTable = $('#listitems22').DataTable(
    {
      ...
      "ajax": {
        "url": '<?php echo site_url("case_writing_competition/Dashboard/get_case_study_comp_registration"); ?>', 
        "type": "POST",
        "data": function (data) 
        {
...
<?php $this->load->view('case_writing_competition/admin/includes/footer');?>