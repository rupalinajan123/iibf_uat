...
<form class="form-horizontal" name="usersAddForm" id="usersAddForm" method="post" enctype="multipart/form-data">
	<input type="hidden" id="position_id" name="position_id" value="12">
	<div class="container">
		<section class="content-header">
			<!-- <h1 class="register">Application for the post of Head PDC (SZ) - Chennai on contract basis</h1> -->
			<h1 class="register">Application for the post of Head PDC (WZ) - Mumbai on contract basis</h1>
		</section>
						...
						<div class="box-body">
							...
							<!-- <div class="form-group">
								...
								<div class="col-sm-5">
									<select name="position_selection" id="position_selection" class="form-control" required>
										...
										<option value="Head PDC (SZ) - Chennai on contract basis" <?php echo  set_select('position_selection', 'Head PDC (SZ) - Chennai on contract basis'); ?>>Head PDC (SZ) - Chennai on contract basis</option>
									</select>
							...
							<div class="form-group">
								...
								<div class="col-sm-2 example">
									<input type="hidden" id="head_pdc_nz_dob_new" name="dob" required value="<?php echo $dob; ?>">
									<?php
									...
									<span id="head_pdc_nz_dob_new_error" class="error"></span>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="tel" class="form-control" id="alternate_mobile" name="alternate_mobile" placeholder="Alternate Mobile Number" data-parsley-type="number" data-parsley-minlength="10" data-parsley-maxlength="10" value="<?php echo set_value('alternate_mobile'); ?>" data-parsley-trigger-after-failure="focusout">
									<span class="error"></span>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input required type="tel" class="form-control" id="pan_no" name="pan_no" placeholder="PAN Number" data-parsley-minlength="10" data-parsley-maxlength="10" data-parsley-pannocheck value="<?php echo set_value('pan_no'); ?>" data-parsley-trigger-after-failure="focusout">
									<span class="error"></span>
								</div>
							</div>
							<div class="form-group">
					...
					<div class="box box-info">
						...
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<select class="form-control" id="state" name="state" required onchange="javascript:checksate(this.value)" data-parsley-trigger="change keyup">
										<option value="">Select</option>
							...
							<div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">Address Line I <span style="color:#F00">*</span></label>
								<div class="col-sm-5">
									<input type="text" class="form-control" id="addressline1_pr" name="addressline1_pr" placeholder="Address Line I" value="<?php echo set_value('addressline1_pr'); ?>" data-parsley-maxlength="30" maxlength="30" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/" required>
									<span class="error"></span>
								</div>
								(Max 30 Characters)
							</div>
							<div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">Address Line II <span style="color:#F00">*</span></label>
								<div class="col-sm-5">
									<input type="text" class="form-control" id="addressline2_pr" name="addressline2_pr" placeholder="Address Line II" value="<?php echo set_value('addressline2_pr'); ?>" data-parsley-maxlength="30" maxlength="30" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/" required>
									<span class="error"> </span>
								</div>
								(Max 30 Characters)
							</div>
							...
							<!-- <div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="ess_course_name" required name="ess_course_name" placeholder="Qualification" value="<?php echo set_value('ess_course_name'); ?>" data-parsley-maxlength="30" maxlength="30" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
								</div>
							</div> -->
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="ess_pg_stream_subject" required name="ess_pg_stream_subject" placeholder="Subject" value="<?php echo set_value('ess_pg_stream_subject'); ?>" data-parsley-maxlength="30" maxlength="30" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
									<span class="error"></span>
								</div>
							</div>
							...
							<div id="postgraduation_dynamic_field">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="number" class="form-control" id="post_aggregate_marks_obtained" name="post_aggregate_marks_obtained[]" placeholder="Aggregate Marks Obtained" value="" step="0.01" maxlength="20" data-parsley-maxlength="20" step="0.01" data-parsley-type="number">
										<span class="error"></span>
									</div>
								</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<div class="col-sm-5 date">
										<input type="text" class="form-control" id="year_of_passing" name="year_of_passing" placeholder="Year of passing" required value="<?php echo set_value('year_of_passing'); ?>" style="width: 150px;" readonly>
									</div>
								</div>
							</div>
							<div class="form-group">
									...
									<div id="job_dynamic_field">
										<div id="job_row<?php echo $i; ?>">
											<div class="form-group">
												...
												<div class="col-sm-5">
													<input type="text" class="form-control" id="organization" name="organization[]" placeholder="Name of the Organisation" value="<?php echo $organization_val; ?>">
													<span class="error"> </span>
												</div>
												(Max 30 Characters)
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-6">
													<div class="col-sm-3 date">
														<input type="text" class="form-control job_from_date" id="job_from_date" name="job_from_date[]" placeholder="From Date" value="<?php echo $job_from_date_val; ?>">
													</div>

													<div class="col-sm-3 date">
														<input type="text" class="form-control job_to_date" id="job_to_date" name="job_to_date[]" placeholder="To Date" value="<?php echo $job_to_date_val; ?>">
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-5">
													<input type="text" class="form-control" id="designation" name="designation[]" placeholder="Designation" value="<?php echo $designation_val; ?>">
													<span class=" error"> </span>
												</div>
												(Max 40 Characters)
											</div>
											...
											<div class="form-group">
												...
												<div class="col-sm-5">
													<input type="text" class="form-control" id="responsibilities" name="responsibilities[]" placeholder="Responsibilities/Nature of Duties Performed" value="<?php echo $responsibilities_val; ?>">
													<span class=" error"> </span>
												</div>
												(Max 300 Characters)
											</div>
							...
							?>
								...
								<div id="job_dynamic_field">
									...
									<div class="form-group">
										<label for="roleid" class="col-sm-4 control-label">Last Designation/Last Post Held <span style="color:#F00">*</span></label>
										<div class="col-sm-5">
											<input type="text" class="form-control" id="designation" name="designation[]" placeholder="Last Designation/Last Post Held" value="">
											<span class=" error"> </span>
										</div>
										(Max 40 Characters)
									</div>
									...
									<div class="form-group">
										<label for="roleid" class="col-sm-4 control-label">Responsibilities/Nature of Duties Performed <span style="color:#F00">*</span></label>
										<div class="col-sm-5">
											<input type="text" class="form-control" id="responsibilities" name="responsibilities[]" placeholder="Responsibilities/Nature of Duties Performed" value="">
											<span class="error"> </span>
										</div>
										(Max 300 Characters)
									</div>
...
<script>
	...
	$(function() {
		$("#head_pdc_nz_dob_new").dateDropdowns({
			submitFieldName: 'head_pdc_nz_dob_new',
			minAge: 55,
			maxAge: 61
		});
	...
	$(document).ready(function() {
		...
		$("#head_pdc_nz_dob_new").change(function() {
			var sel_dob = $("#head_pdc_nz_dob_new").val();
			if (sel_dob != '') {
