...
<form class="form-horizontal" name="usersAddForm" id="usersAddForm" method="post" enctype="multipart/form-data">
	...
	<div class="container">
		<section class="content-header">
			<h1 class="register">Application for the post of Assistant Director (Accounts)</h1>
		</section>
		<section class="content">
			...
			<div class="row">
						...
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-2 example">
									...
									?>
									(Age of the applicant should not be above 35 years as on 31/01/2022)
					...
					<div class="box box-info">
						...
						<div class="box-body">
							...
							<div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">Contact No.</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" id="contact_number_pr" name="contact_number_pr" placeholder="Contact No" data-parsley-type="number" data-parsley-minlength="10" data-parsley-maxlength="12" value="<?php echo set_value('contact_number_pr'); ?>" data-parsley-trigger-after-failure="focusout">
									<span class="error"></span>
								</div>
							</div>
							<!--  <div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<select name="ess_course_name" id="ess_course_name" class="form-control" required>
										...
										<!--<option value="B.Com" <?php //echo  set_select('ess_course_name', 'B.Com');
																	?>>B.Com</option>
											<option value="BBA" <?php //echo  set_select('ess_course_name', 'BBA'); 
																?>>BBA</option>
											<option value="B.E" <?php //echo  set_select('ess_course_name', 'B.E'); 
																?>>B.E</option>
										<option value="B.Tech" <?php //echo  set_select('ess_course_name', 'B.Tech'); 
																?>>B.Tech</option>-->
									</select>
								</div>
							</div>
                ...
                <option value="">-Select-</option>
                <option value="Commerce" <?php //echo  set_select('ess_subject', 'Commerce'); 
											?>>Commerce</option>
                <option value="Economics" <?php //echo  set_select('ess_subject', 'Economics'); 
											?>>Economics</option>
                <option value="Business Management" <//?php echo  set_select('ess_subject', 'Business Management'); ?>>Business Management</option>
                <option value="Information Technology" <?php //echo  set_select('ess_subject', 'Information Technology'); 
														?>>Information Technology</option>
                <option value="Computer Science" <?php //echo  set_select('ess_subject', 'Computer Science'); 
													?>>Computer Science</option>
                <option value="Computer Applications" <?php //echo  set_select('ess_subject', 'Computer Applications'); 
							...
							<!--<div class="form-group">
								...
								<div class="col-sm-5">
								<input type="text" class="form-control" id="ess_university" name="ess_university" placeholder="University" required value="<?php //echo set_value('ess_university');
                ...
                <option value="">-Select-</option>
                <option value="First Class" <?php //echo  set_select('ess_class', 'First Class'); 
											?>>First Class</option>
								</select>
								</div>
							</div>-->
							...
							<!--<div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">University <span style="color:#F00">*</span></label>
								<div class="col-sm-5">
								<input type="text" class="form-control" id="university" name="university" placeholder="University" required value="<?php //echo set_value('university');
																																					?>" data-parsley-maxlength="30" maxlength="30" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
								<span class="error"></span> </div>
							(Max 30 Characters) </div>-->
							<div class="form-group">
                ...
                <option value="">-Select-</option>
                <option value="First Class" <?php // echo  set_select('class', 'First Class'); 
											?>>First Class</option>
                <option value="Second Class" <?php // echo  set_select('class', 'Second Class'); 
												?>>Second Class</option>
                <option value="Pass Class" <?php //echo  set_select('class', 'Pass Class'); 
											?>>Pass Class</option>
								</select>
								</div>
							</div>-->
