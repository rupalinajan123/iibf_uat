      ...
      <div class="box box-info">
        ...
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-2 example">
              ...
              <?php 
				...
				$max_year = date('Y', strtotime("- 59 year"));
			?>
              <span style="color:#F00">(Age Limit Min 50 - Max 60) <br> (AGE NOT BE LESS THAN 50 AND NOT MORE THAN 60 AS ON 30.09.2020)</span><br>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5">
              <input type="tel" class="form-control" id="pan_no" name="pan_no" placeholder="PAN No"  data-parsley-minlength="10" data-parsley-maxlength="10" data-parsley-pannocheck  value="<?php echo set_value('pan_no');?>"  required  data-parsley-trigger-after-failure="focusout" >
              <span class="error"></span> </div>
          </div>
          <div class="form-group">
      ...
      <div class="box box-info">
        ...
        <div class="box-body">
          <div class="form-group">
            ...
            <div class="col-sm-5">
              <input type="text" class="form-control" id="addressline1" name="addressline1" placeholder="Address line1" value="<?php echo set_value('addressline1');?>"  data-parsley-maxlength="30" maxlength="30" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
              <span class="error"> </span> </div>
            (Max 30 Characters) </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label for="roleid" class="col-sm-4 control-label">Address line1</label>
            <div class="col-sm-5">
              <input type="text" class="form-control" id="addressline1_pr" name="addressline1_pr" placeholder="Address line1" value="<?php echo set_value('addressline1_pr');?>"  data-parsley-maxlength="30" maxlength="30" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
              <span class="error"></span> </div>
            (Max 30 Characters) </div>
          <div class="form-group">
            <label for="roleid" class="col-sm-4 control-label">Address line2</label>
          ...
          <div class="form-group">
			...
			<input type="text" class="form-control" id="ess_course_name" name="ess_course_name" placeholder="Post Graduation" required value="<?php echo set_value('ess_course_name');?>" data-parsley-maxlength="40" maxlength="40" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5">
              <input type="text" class="form-control" id="ess_college_name" name="ess_college_name" placeholder="College Name and Address" value="<?php echo set_value('ess_college_name');?>" data-parsley-maxlength="200" maxlength="200" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
              <span class="error"></span> </div>
          ...
          <div class="form-group">
			...
			<div class="col-sm-5">
			    <!--<input type="text" class="form-control" id="ess_class" name="ess_class" placeholder="Class"  value="<?php //echo set_value('ess_class');?>"  data-parsley-maxlength="20" maxlength="20" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/" required>	-->	   <select name="ess_class" id="ess_class" class="form-control" required>
                <option value="">-Select-</option>
		  ...
		  <div class="form-group">
            ...
            <div class="col-sm-6">
              <div class="col-sm-5 date">
                <input type="text" class="form-control" id="year_of_passing" name="year_of_passing" placeholder="Year of passing" value="<?php echo set_value('year_of_passing');?>">
              </div>
            </div>
          </div>
		  ...
		  <!--<div class="form-group">
            ...
            <div class="col-sm-6">
              <div class="col-sm-3 date">
                <input type="text" class="form-control phd_from_date" id="phd_from_date" 
				name="phd_from_date" placeholder="From Date" value="<?php echo set_value('phd_from_date');?>">
              </div>
              <div class="col-sm-3 date">
                <input type="text" class="form-control phd_to_date" id="phd_to_date" name="phd_to_date" placeholder="To Date" value="<?php // echo set_value('phd_to_date');?>">
              </div> 
            </div>
          </div>-->
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <div class="col-sm-3 date">
				...
				name="from_date" placeholder="From Date" value="<?php echo set_value('from_date');?>">
              </div>
              <div class="col-sm-3 date">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5">
			   ...
			   <!-- <input type="text" class="form-control" id="class" name="class" placeholder="class"  value="<?php //echo set_value('class');?>"  data-parsley-maxlength="20" maxlength="20" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">-->
 ...
 <div class="box-title box-header"><strong>Publication</strong> </div>
		  ...
		  ?>
         	...
         	<div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="experience_as_principal" name="experience_as_principal[]" placeholder="Experience as Principal"  value="<?php echo $experience_as_principal_val;//echo set_value('experience_as_principal');?>"  data-parsley-maxlength="300" maxlength="300" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/" >
                  <span class="error"> </span> </div>
                (Max 300 Characters) </div>
			...
			<div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="experience_as_faculty" name="experience_as_faculty[]" placeholder="Experience as Faculty"  value="<?php echo $experience_as_faculty_val;//echo set_value('experience_as_faculty');?>"  data-parsley-maxlength="300" maxlength="300" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/" >
                  <span class="error"> </span> </div>
                (Max 300 Characters) </div>
		...
		<?php }
		  ...
		  else
		  {
			...
			<div class="form-group">
                <label for="roleid" class="col-sm-4 control-label">Experience as Principal / Director of a banking staff training college / centre/ management institution </label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="experience_as_principal" name="experience_as_principal[]" placeholder="Experience as Principal"  value="<?php //echo set_value('experience_as_principal');?>"  data-parsley-maxlength="300" maxlength="300" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/" >
                  <span class="error"> </span> </div>
                (Max 300 Characters) </div>
			...
			<div class="form-group">
                <label for="roleid" class="col-sm-4 control-label">Experience as Faculty , Professor, Lecturer</label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="experience_as_faculty" name="experience_as_faculty[]" placeholder="Experience as Faculty"  value="<?php //echo set_value('experience_as_faculty');?>"  data-parsley-maxlength="300" maxlength="300" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/" >
                  <span class="error"> </span> </div>
                (Max 300 Characters) </div>
			<?php
...
<div class="form-group">
            <label for="roleid" class="col-sm-4 control-label">1. Earliest date of Joining if Selected </label>
            <div class="col-sm-5">
              <textarea rows="4" cols="50" class="form-control" id="earliest_date_of_joining" name="earliest_date_of_joining" placeholder="Earliest date of Joining if Selected" data-parsley-maxlength="500" maxlength="500" data-parsley-pattern="/^[a-zA-Z-0-9 , / ]+$/"><?php echo set_value('earliest_date_of_joining');?></textarea>
              <span class="error"> </span> </div>
...
<div class="form-group">
            ...
            <div class="col-sm-5">
              <textarea rows="4" cols="50" class="form-control" id="suitable_of_the_post_of_CEO" name="suitable_of_the_post_of_CEO" placeholder="Why do you consider yourself suitable fo the post of CEO of this Institute" data-parsley-maxlength="2000" maxlength="2000" data-parsley-pattern="/^[a-zA-Z-0-9 , / ]+$/"><?php echo set_value('suitable_of_the_post_of_CEO');?></textarea>
              <span class="error"> </span> </div>
            (Max 2000 Characters) </div>

		  
          <div class="form-group">
            <label for="roleid" class="col-sm-4 control-label">3. Any other information that the candidate would like to add</label>
            <div class="col-sm-5">
              <textarea rows="4" cols="50" class="form-control" id="comment" name="comment" placeholder="Any other information that the candidate would like to add" data-parsley-maxlength="2000" maxlength="2000" data-parsley-pattern="/^[a-zA-Z-0-9 , / ]+$/"><?php echo set_value('comment');?></textarea>
              <span class="error"> </span> </div>
            (Max 2000 Characters) </div>
          <div class="box box-info">
            <div class="box-header with-border">
...
<script>
	...
	$(document).ready(function() 
	{
		...
		$('#year_of_passing').datepicker({format: 'yyyy',viewMode: "years",minViewMode: "years",endDate: today,autoclose: true});
	...
	$('.phd_from_date').datepicker({format: 'yyyy-mm-dd',endDate: today,autoclose: true}).on('changeDate', function(){
			$('.phd_to_date').datepicker('setStartDate', new Date($(this).val()));
		}); 
		
		$('.phd_to_date').datepicker({format: 'yyyy-mm-dd',endDate: today,autoclose: true}).on('changeDate', function(){
			$('.phd_from_date').datepicker('setEndDate', new Date($(this).val()));
		});
		...
		$(".year").change(function(){
			...
			var date_max = new Date(60, '09', '30');
			var date_min = new Date(70, '09', '30');
			...
			if( date_max > dob_date || date_min < dob_date )
			{
				...
				$(".year").focus();
				$("#dob_error").focus();
				$("#dob_error").html('Your Age should be between 50 and 60 Year.');
				return false;
			}
			else
			{	
