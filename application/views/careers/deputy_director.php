...
<form class="form-horizontal" name="usersAddForm" id="usersAddForm" method="post" enctype="multipart/form-data">
	...
	<div class="container">
		<section class="content-header">
			<h1 class="register">Application for the post of Deputy Director (Accounts)</h1>
		</section>
					...
					<div class="box box-info">
						...
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="lastname" name="lastname" placeholder="Last Name" required value="<?php echo set_value('lastname'); ?>" data-parsley-pattern="/^[a-zA-Z]+$/" data-parsley-maxlength="30" maxlength="30">
									<span class="error"> </span>
								</div>
								(Max 30 Characters)
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-2 example">
									<input type="hidden" id="deputy_director_dob" name="dob" required value="<?php echo $dob; ?>">
									<?php
									$min_year = date('Y', strtotime("- 20 year"));
									$max_year = date('Y', strtotime("- 45 year"));
									?>
									(Age of the applicant should not be above 45 years as on 01.11.2022)
									...
									<span id="deputy_director_dob_error" class="error"></span>
								</div>
					...
					<div class="box box-info">
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="addressline1" name="addressline1" placeholder="Address line1" value="<?php echo set_value('addressline1'); ?>" data-parsley-maxlength="30" required maxlength="30" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
									<span class="error"> </span>
								</div>
								(Max 30 Characters)
							</div>
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="addressline2" name="addressline2" placeholder="Address line2" value="<?php echo set_value('addressline2'); ?>" data-parsley-maxlength="30" required maxlength="30" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
									<span class="error"> </span>
								</div>
								(Max 30 Characters)
							</div>
							...
							<div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">Address line1 <span style="color:#F00">*</span></label>
								<div class="col-sm-5">
									<input type="text" class="form-control" required id="addressline1_pr" name="addressline1_pr" placeholder="Address line1" value="<?php echo set_value('addressline1_pr'); ?>" data-parsley-maxlength="30" maxlength="30" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
									<span class="error"></span>
								</div>
								(Max 30 Characters)
							</div>
							<div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">Address line2 <span style="color:#F00">*</span></label>
								<div class="col-sm-5">
									<input type="text" class="form-control" required id="addressline2_pr" name="addressline2_pr" placeholder="Address line2" value="<?php echo set_value('addressline2_pr'); ?>" data-parsley-maxlength="30" maxlength="30" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
									<span class="error"> </span>
								</div>
								(Max 30 Characters)
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<select class="form-control" id="ess_course_name" name="ess_course_name">
										<option value="">Select</option>
										<option value="Chartered Accountant" <?php echo  set_select('ess_course_name', 'Chartered Accountant'); ?>>Chartered Accountant</option>
										<?php /*<option value="CMA" <?php echo  set_select('ess_course_name', 'CMA'); ?>>CMA</option>
										<option value="Post Graduate" <?php echo  set_select('ess_course_name', 'Post Graduate'); ?>>Post Graduate</option>
										<option value="CS" <?php echo  set_select('ess_course_name', 'CS'); ?>>CS</option>
										<option value="CFA" <?php echo  set_select('ess_course_name', 'CFA'); ?>>CFA</option> */ ?>
									</select>
								</div>
							</div>
							...
							<?php /* <div class="form-group">
								...
								<div class="col-sm-5">
								<input type="text" class="form-control" id="deputy_subject" name="deputy_subject" placeholder="Subject" value="<?php echo set_value('deputy_subject');?>" data-parsley-maxlength="100" maxlength="100" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="ess_university" name="ess_university" placeholder="Institute Name" required value="<?php echo set_value('ess_university'); ?>" data-parsley-maxlength="200" maxlength="200" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
									<span class="error"></span>
								</div>
								(Max 200 Characters)
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="ess_percentage" name="ess_percentage" placeholder="Percentage" value="<?php echo set_value('ess_percentage'); ?>" data-parsley-maxlength="20" maxlength="20" max="100" data-parsley-pattern="/^[0-9.]+$/" required>
									<span class="error"></span>
								</div>
							</div>
							...
							<?php /* <div class="box-title box-header"><strong>CAIIB</strong> </div>
							<br />
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<select class="form-control" id="course_code" name="course_code">
										...
										<option value="CMA" <?php echo  set_select('course_code', 'CMA'); ?>>CMA</option>
										<option value="CS" <?php echo  set_select('course_code', 'CS'); ?>>CS</option> */ ?>
									</select>
								</div>
							</div>

							<?php /* <div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">Specialisation <!--<span style="color:#F00">*</span>--></label>
								<div class="col-sm-5">
									<input type="text" class="form-control" id="specialisation" name="specialisation" placeholder="Specialisation" value="<?php echo set_value('specialisation');?>" data-parsley-maxlength="100" maxlength="100" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
								<span class="error"></span> </div>
							(Max 100 Characters) </div> */ ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="university" name="university" placeholder="Institute Name" value="<?php echo set_value('university'); ?>" data-parsley-maxlength="200" maxlength="200" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
									<span class="error"></span>
								</div>
								(Max 200 Characters)
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="percentage" name="percentage" placeholder="Percentage" value="<?php echo set_value('percentage'); ?>" data-parsley-maxlength="20" maxlength="20" data-parsley-pattern="/^[0-9.]+$/" max="100">
									<span class="error"></span>
								</div>
							</div>
							...
							<?php /* <div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">Experience as Faculty in Banks/Financial Institutions</label>
								<div class="col-sm-5">
									<textarea rows="4" cols="50" class="form-control" id="exp_in_bank" name="exp_in_bank" placeholder="Experience as Faculty in Banks/Financial Institutions"  data-parsley-maxlength="1000" maxlength="1000" data-parsley-pattern="/^[a-zA-Z-0-9 , / ]+$/"><?php echo set_value('exp_in_bank');?></textarea>
									
								</div>(Max 1000 Characters)
							</div>
							<div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">Experience in one or more covering the functional areas</label>
								<div class="col-sm-5">
									<select name="exp_in_functional_area[]" id="exp_in_functional_area" class="form-control" multiple>
										...
										<option value="International Banking" <?php echo  set_select('exp_in_functional_area','International Banking');?>>International Banking</option>
										<option value="Capital Markets/Mutual Funds & Insurance" <?php echo set_select('exp_in_functional_area','Capital Markets/Mutual Funds & Insurance');?>>Capital Markets/Mutual Funds & Insurance</option>
										<option value="Audit & Compliance" <?php echo set_select('exp_in_functional_area','Audit & Compliance');?>>Audit & Compliance</option>
										<option value="Credit Management" <?php echo set_select('exp_in_functional_area','Credit Management');?>>Credit Management</option>
									</select>
								</div>
							</div> */ ?>
							...
							<div class="form-group">
								...
								<div class="col-sm-8" align="justify">
									...
									&nbsp; I undertake to execute an agreement to the effect that I will serve the Institute for a minimum period of Two (2) years (active service) from the date of joining the Institute. In case I leave the service of the Institute before the expiry of the said period, a sum of Rs. 2,00,000/- (Rupees Two Lakh only) will have to be paid by me to the Institute as mentioned in the recruitment notification for the post of Deputy Director (Accounts) dated 17.11.2022.<span class="error"></span>
								</div>
							</div>
							<div class="box box-info">
								<div class="box-header with-border">
...
<script>
	$(function() {
		$("#deputy_director_dob").dateDropdowns({
			submitFieldName: 'deputy_director_dob',
			minAge: 21,
			maxAge: 44
		});
	...
	$(document).ready(function() {
		...
		$("#deputy_director_dob").change(function() {
			var sel_dob = $("#deputy_director_dob").val();
			if (sel_dob != '') {
				...
				if (dob_arr.length == 3) {
					...
					if (date_max > dob_date || date_min < dob_date) {
						$("#deputy_director_dob_error").html('Your Age should be between 18 and 45');
						flag = 0;
						return false;
					} else {
