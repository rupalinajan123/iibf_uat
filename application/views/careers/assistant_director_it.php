...
<form class="form-horizontal" name="usersAddForm" id="usersAddForm"  method="post"  enctype="multipart/form-data">
  ...
  <div class="container">
		<section class="content-header">
			<h1 class="register">Application for the post of Assistant Director (IT)</h1>
		</section>
					...
					<div class="box box-info">
						...
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="middlename" name="lastname" placeholder="Last Name" required value="<?php echo set_value('lastname');?>" data-parsley-pattern="/^[a-zA-Z]+$/" data-parsley-maxlength="30" maxlength="30">
								<span class="error"> </span> </div>
							(Max 30 Characters) </div>
							<div class="form-group">
							...
							<div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">Father's/Spouse's Name <span style="color:#F00">*</span></label>
								<div class="col-sm-5">
									<input type="text" class="form-control" id="father_husband_name" name="father_husband_name" placeholder="Father's/Spouse's Name"  value="<?php echo set_value('father_husband_name');?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" maxlength="30" required>
								<span class="error"></span> </div>
							(Max 30 Characters) </div>
							<div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">Date of Birth <span style="color:#F00">*</span></label>
								<div class="col-sm-2 example">
									<input type="hidden" id="assistant_director_it_dob1" name="dob" required value="<?php echo $dob;?>">
									<?php 
										$min_year = date('Y', strtotime("- 18 year"));
										$max_year = date('Y', strtotime("- 40 year")); 
									?>
									(Not exceeding 40 years as of 01.11.2022)
								...
								<br><span id="assistant_director_it_dob_error" class="error"></span> </div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									...
									value="<?php echo set_value('aadhar_card_no');?>" required data-parsley-trigger-after-failure="focusout">
								<span class="error"> </span> </div>
							</div>
						</div>
					</div>
					...
					<div class="box box-info">
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="addressline1" name="addressline1" placeholder="Address line1" value="<?php echo set_value('addressline1');?>" required data-parsley-maxlength="30" maxlength="30" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
								<span class="error"> </span> </div>
							(Max 30 Characters) </div>
							<div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">Address line2<span style="color:#F00">*</span></label>
								<div class="col-sm-5">
									<input type="text" class="form-control" id="addressline2" name="addressline2" placeholder="Address line2"  value="<?php echo set_value('addressline2');?>" required data-parsley-maxlength="30" maxlength="30" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
								<span class="error"> </span> </div>
							(Max 30 Characters) </div>
							<div class="form-group">
							...
							<div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">Landline No.</label>
								<div class="col-sm-5">
                ...
                <h6 class="box-title-hd">
                  ...
                  <em>Same as Communication address</em></h6>
							...
							<div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">Address line1<span style="color:#F00">*</span></label>
								<div class="col-sm-5">
									<input type="text" class="form-control" id="addressline1_pr" name="addressline1_pr" placeholder="Address line1" value="<?php echo set_value('addressline1_pr');?>" required data-parsley-maxlength="30" maxlength="30" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
								<span class="error"></span> </div>
							(Max 30 Characters) </div>
							<div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">Address line2<span style="color:#F00">*</span></label>
								<div class="col-sm-5">
									<input type="text" class="form-control" id="addressline2_pr" name="addressline2_pr" placeholder="Address line2"  value="<?php echo set_value('addressline2_pr');?>" required data-parsley-maxlength="30" maxlength="30" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
								<span class="error"> </span> </div>
							(Max 30 Characters) </div>
							<div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">Address line3</label>
							...
							<br />
							<div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">Name of course <span style="color:#F00">*</span></label>
								<div class="col-sm-5">
									<select name="ess_course_name" id="ess_course_name" class="form-control" required>
										<option value="">-Select-</option>
										<option value="B. Tech (IT)" <?php echo  set_select('ess_course_name', 'B. Tech'); ?>>B. Tech</option>
										<option value="B.E. (IT)" <?php echo  set_select('ess_course_name', 'B.E.'); ?>>B.E.</option>
										<option value="M.C.A" <?php echo  set_select('ess_course_name', 'M.C.A'); ?>>M.C.A</option>
										<?php /* <option value="B. Tech (Computer Science)" <?php echo  set_select('ess_course_name', 'B. Tech (Computer Science)'); ?>>B. Tech (Computer Science)</option>
										<option value="B.E. (Computer)" <?php echo  set_select('ess_course_name', 'B.E. (Computer Science)'); ?>>B.E. (Computer Science)</option> */ ?>
									</select>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-5">
									<select name="ess_subject" id="ess_subject" class="form-control" required>
										...
										<?php /* <option value="Computer Applications" <?php echo  set_select('ess_subject', 'Computer Applications'); ?>>Computer Applications</option> */ ?>
									</select>
								</div>
							</div>
							<div class="form-group">
              ...
              <div class="form-group"><?php //Aggregate Maximum Marks * ?>
                ...
                <div class="col-sm-5">
                  ...
                  <span class="error"></span> 
							...
							<div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">Percentage <span style="color:#F00">*</span></label>
								<div class="col-sm-5">
									<input type="text" class="form-control" id="ess_percentage" name="ess_percentage" placeholder="Percentage"  value="<?php echo set_value('ess_percentage');?>"  data-parsley-type="number" data-parsley-minlength="2" data-parsley-maxlength="2" required data-parsley-pattern="/^[0-9.]+$/">
								<span class="error"></span></div> (60% and above) 
							</div>
                ...
                <div class="col-sm-5">
                  ...
                  <span class="error"></span> 
								...
								<br />
								<div class="form-group">
									<label for="roleid" class="col-sm-4 control-label">Name Of Certification Course</label>
									<div class="col-sm-5">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" id="percentage" name="percentage" placeholder="Percentage"  value="<?php echo set_value('percentage');?>" data-parsley-type="number" data-parsley-minlength="2" data-parsley-maxlength="2" data-parsley-percentage_it data-parsley-pattern="/^[0-9.]+$/">
									<span class="error"></span> </div> (60% and above) 
								</div>
								...
								<?php
										...
										<div id="job_dynamic_field">
											<div id="job_row<?php echo $i;?>">
												...
												<div class="form-group">
													...
													<div class="col-sm-6">
														<div class="col-sm-3 date">
															<input type="text" class="form-control job_from_date" id="job_from_date" name="job_from_date[]" placeholder="From Date"  value="<?php echo $job_from_date_val;//echo set_value('job_from_date');?>" required>
														</div>
														<div class="col-sm-3 date">
															<input type="text" class="form-control job_to_date" id="job_to_date" name="job_to_date[]" placeholder="To Date" value="<?php echo $job_to_date_val;//echo set_value('job_to_date');?>" required>
														</div>
													</div>
												</div>
												<div class="form-group">
									...
									<div id="job_dynamic_field">
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
												<div class="col-sm-3 date">
													<input type="text" class="form-control job_from_date" id="job_from_date" name="job_from_date[]" placeholder="From Date"  value="<?php //echo set_value('job_from_date');?>" required>
												</div>
												<div class="col-sm-3 date">
													<input type="text" class="form-control job_to_date" id="job_to_date" name="job_to_date[]" placeholder="To Date" value="<?php //echo set_value('job_to_date');?>" required>
												</div>
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="form-group">
												...
												<div class="col-sm-2">
													...
													Yes
													<br><input type="radio" class="minimal declaration_no" id="No"  name="declaration1"  required value="No" <?php echo set_radio('declaration1', 'No'); ?>>
											...
											<div class="form-group">
												...
												&nbsp;I undertake to execute an agreement to the effect that I will serve the Institute for a minimum period of Two (2) years (active service) from the date of joining the Institute. In case I leave the service of the Institute before the expiry of the said period, a sum of Rs. 2,00,000/- (Rupees Two Lakh only) will have to be paid by me to the Institute as mentioned in the recruitment notification for the post of Assistant Director (IT) dated 17.11.2022 <span class="error"></span> </div>
											</div>
											<div class="box box-info">
												<div class="box-header with-border">
	...
	<script>
		...
		$(function() {
		$("#assistant_director_it_dob1").dateDropdowns({
		submitFieldName: 'assistant_director_it_dob',
		minAge: 18,
		maxAge:39
		});
		...
		$(document).on("change","#ess_percentage", function(){
		if($("#ess_percentage").val() < 60 )
		{
		alert('Essential Percentage should be 60% and above');
		$("#ess_percentage").val('');
		}
		else if($("#ess_percentage").val() > 100 )
		{
		alert('Essential Percentage should be more than 100%');
		$("#ess_percentage").val('');
		}
		});
		
		$(document).on("change","#percentage", function(){
		if($("#percentage").val() < 60 )
		{
		alert('Desirable Percentage should be 60% and above');
		$("#percentage").val('');
		}
		else if($("#percentage").val() > 100 )
		{
		alert('Desirable Percentage should be more than 100%');
		$("#percentage").val('');
		}
		});
		...
		$('#submit_date').datepicker({format: 'yyyy-mm-dd',endDate: today,autoclose: true});
		
		$('.from_date').datepicker({format: 'yyyy-mm',viewMode: "months",minViewMode: "months",endDate: today,autoclose: true}).on('changeDate', function(){
		$('.to_date').datepicker('setStartDate', new Date($(this).val()));
		}); 
		
		$('.to_date').datepicker({format: 'yyyy-mm',viewMode: "months",minViewMode: "months",endDate: today,autoclose: true}).on('changeDate', function(){
		$('.from_date').datepicker('setEndDate', new Date($(this).val()));
		});
		
		$('#ess_from_date').datepicker({format: 'yyyy-mm',viewMode: "months",minViewMode: "months",endDate: today,autoclose: true}).on('changeDate', function(){
		$('#ess_to_date').datepicker('setStartDate', new Date($(this).val()));
		}); 
		
		$('#ess_to_date').datepicker({format: 'yyyy-mm',viewMode: "months",minViewMode: "months",endDate: today,autoclose: true}).on('changeDate', function(){
		...
		$('#pro_from_date').datepicker({format: 'yyyy-mm-dd',endDate: '+0d',autoclose: true}).on('changeDate', function(){
		$('#pro_to_date').datepicker('setStartDate', new Date($(this).val()));
		}); 
		
		$('#pro_to_date').datepicker({format: 'yyyy-mm-dd',endDate: '+0d',autoclose: true}).on('changeDate', function(){
		...
		$("#assistant_director_it_dob1").change(function(){
		var sel_dob = $("#assistant_director_it_dob1").val();
		if(sel_dob!='')
		{
		...
		//chkage(dob_arr[2],dob_arr[1],dob_arr[0]);	
			...
			dojYear = dob_arr[0];
			var minjoinyear = parseInt(dyear) + parseInt(35);
				//alert(dob_date+'='+date_max);
			if( date_max > dob_date || date_min < dob_date)
			{
			$("#assistant_director_it_dob_error").html('Not exceeding 40 years as of 01.11.2022');
			flag = 0;
			return false;
			}
			else
