        ...
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                <label for="roleid" class="col-sm-4 control-label">Fathers/Spouse's Name</label>
                <div class="col-sm-5"><?php echo $this->session->userdata['enduserinfo']['father_husband_name']; ?></div>
              </div>

              <div class="form-group">
                <label for="roleid" class="col-sm-4 control-label">Mother Name</label>
              ...
              <div class="form-group">
                <label for="roleid" class="col-sm-4 control-label">Are you a person with Physically Disability? </label>
                <div class="col-sm-6">
            ...
            <div class="box-body">
              ...
              <div class="box-body">
                ...
                <!--  <div class="form-group">
                  ...
                  <div class="col-sm-6"><?php //echo $this->session->userdata['enduserinfo']['exam_center'];
                                        ?> </div>
                </div> -->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5" style="word-wrap: break-word;">
                    <?php echo $this->session->userdata['enduserinfo']['ess_course_name']; ?>
                  </div>
                </div>
                <!-- <label for="roleid" class="col-sm-4 control-label">Subject</label>
                <div class="col-sm-5" style="word-wrap: break-word;">
                  <?php //$this->session->userdata['enduserinfo']['ess_subject']; 
                  ?>
                </div> -->
              </div>
              <div class="form-group">
              ...
              // find total PG entries
              $total_pg = 0;
              if (isset($endinfo['post_qua_name']) && is_array($endinfo['post_qua_name'])) {
                $total_pg = count($endinfo['post_qua_name']);
              }
              
              for ($i = 0; $i < $total_pg; $i++) {
              ?>
                <b>Education Qualification II - Post Graduation (<?php echo $i + 1; ?>)</b><br>

                <div class="form-group">
                  <label class="col-sm-4 control-label">Qualification Name</label>
                  <div class="col-sm-5"><?php echo $endinfo['post_qua_name'][$i]; ?></div>
                </div>

                <div class="form-group">
                  <label class="col-sm-4 control-label">Post Graduation Stream & Subject</label>
                  <div class="col-sm-5"><?php echo $endinfo['post_gra_sub'][$i]; ?></div>
                </div>

                <div class="form-group">
                  <label class="col-sm-4 control-label">College/ Institution Name</label>
                  <div class="col-sm-5"><?php echo $endinfo['post_gra_college_name'][$i]; ?></div>
                </div>

                <div class="form-group">
                  <label class="col-sm-4 control-label">University Name</label>
                  <div class="col-sm-5"><?php echo $endinfo['post_gra_university'][$i]; ?></div>
                </div>

                <div class="form-group">
                  <label class="col-sm-4 control-label">Period</label>
                  <div class="col-sm-5">From: <?php echo $endinfo['post_gra_from_date'][$i]; ?>
                    - To: <?php echo $endinfo['post_gra_to_date'][$i]; ?>
                  </div>
                </div>

                <div class="form-group">
                  <label class="col-sm-4 control-label">Aggregate Marks Obtained</label>
                  <div class="col-sm-5"><?php echo $endinfo['post_aggregate_marks_obtained'][$i]; ?></div>
                </div>

                <div class="form-group">
                  <label class="col-sm-4 control-label">Aggregate Maximum Marks</label>
                  <div class="col-sm-5"><?php echo $endinfo['post_gra_aggregate_max_marks'][$i]; ?></div>
                </div>

                <div class="form-group">
                  <label class="col-sm-4 control-label">Final Percentage</label>
                  <div class="col-sm-5"><?php echo $endinfo['post_gra_percentage'][$i]; ?></div>
                </div>

                <div class="form-group">
                  <label class="col-sm-4 control-label">Class/Grade</label>
                  <div class="col-sm-6"><?php echo $endinfo['post_gra_class'][$i]; ?></div>
                </div>
              ...
              <?php
              $endinfo = $this->session->userdata['enduserinfo'];
              $course_list = $careers_course_mst;

              // If multiple desirable entries exist

              if (!empty($endinfo['course_code']) && is_array($endinfo['course_code'])) {

                for ($i = 0; $i < count($endinfo['course_code']); $i++) {
              ?>


                  <div class="box-title"><strong>Desirable <?php echo $i + 1; ?></strong></div>
                  <br />
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <?php
                      $selected_course = $endinfo['course_code'][$i];
                      foreach ($course_list as $row1) {
                        if ($selected_course == $row1['course_code']) {
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <?php echo $endinfo['college_name'][$i]; ?>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <label class="col-sm-4 control-label">Period</label>
                    <div class="col-sm-6">
                      From: <?php echo $endinfo['from_date'][$i]; ?>
                      - To: <?php echo $endinfo['to_date'][$i]; ?>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <label class="col-sm-4 control-label">Aggregate Marks Obtained</label>
                    <div class="col-sm-6">
                      <?php echo $endinfo['aggregate_marks_obtained'][$i]; ?>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <label class="col-sm-4 control-label">Aggregate Maximum Marks</label>
                    <div class="col-sm-6">
                      <?php echo $endinfo['aggregate_max_marks'][$i]; ?>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <?php echo $endinfo['grade_marks'][$i]; ?>
                    </div>
                  </div>
              ...
              <div class="box-title box-header"><strong>Service Details</strong> </div>
              <br />
              <div class="form-group">
              ...
              <div class="form-group">
                <label for="roleid" class="col-sm-4 control-label">Period</label>
                <div class="col-sm-5" style="word-wrap: break-word;"> <?php echo $this->session->userdata['enduserinfo']['exp_faculty_from_date']; ?> - <?php echo $this->session->userdata['enduserinfo']['exp_faculty_to_date']; ?> </div>
              </div>
              <div class="form-group">
                <label for="roleid" class="col-sm-4 control-label">Subject Handled</label>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8" align="justify"> <strong><?php echo $this->session->userdata['enduserinfo']['declaration1']; ?></strong> &nbsp;
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8" align="justify"> <strong><?php echo $this->session->userdata['enduserinfo']['declaration2']; ?></strong> &nbsp;
                  &nbsp;I undertake to execute an agreement to the effect that I will serve the Institute for a minimum period of Two (2) years (active service) from the date of joining the Institute. In case I leave the service of the Institute before the expiry of the said period, a sum of Rs. 2,00,000/- (Rupees Two Lakh only) will have to be paid by me to the Institute as mentioned in the recruitment notification for the post of Assistant Director (Training/Academics) dated 07.11.2025.</div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-8" align="justify"> <strong><?php echo $this->session->userdata['enduserinfo']['declaration3']; ?></strong> &nbsp;
                  &nbsp; I further certify that no disciplinary / vigilance proceedings are either pending or contemplated against me and that there are no legal cases pending against me. There have been no major / minor penalties</div>
              </div>
              <div class="box box-info">
                <div class="box-header with-border">
