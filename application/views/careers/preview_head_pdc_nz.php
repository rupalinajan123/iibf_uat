          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5"> Head PDC (WZ) - Chennai on contract basis</div>
              ...
              <div class="form-group">
                <label for="roleid" class="col-sm-4 control-label">Alternate Mobile No.</label>
          ...
          <div class="box box-info">
            ...
            <div class="col-sm-6"><?php echo $this->session->userdata['enduserinfo']['contact_number']; ?> </div>
              ...
              <div class="col-sm-6"><?php echo $this->session->userdata['enduserinfo']['contact_number_pr']; ?> </div>
                ...
                <b>Education Qualification II - Post Graduation </b></br>
                <?php
                $enduserinfo = $this->session->userdata('enduserinfo');

                if (!empty($enduserinfo['post_qua_name']) && is_array($enduserinfo['post_qua_name'])) {
                  for ($i = 0; $i < count($enduserinfo['post_qua_name']); $i++) {
                ?>
                    <div class="form-group">
                      <label class="col-sm-4 control-label">Qualification</label>
                      <div class="col-sm-5"><?php echo $enduserinfo['post_qua_name'][$i]; ?></div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-4 control-label">Subject</label>
                      <div class="col-sm-5"><?php echo $enduserinfo['post_gra_sub'][$i]; ?></div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-4 control-label">College/Institution</label>
                      <div class="col-sm-5"><?php echo $enduserinfo['post_gra_college_name'][$i]; ?></div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-4 control-label">University</label>
                      <div class="col-sm-5"><?php echo $enduserinfo['post_gra_university'][$i]; ?></div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-4 control-label">Period</label>
                      <div class="col-sm-5">From: <?php echo $enduserinfo['post_gra_from_date'][$i]; ?> - To: <?php echo $enduserinfo['post_gra_to_date'][$i]; ?></div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-4 control-label">Aggregate Marks Obtained</label>
                      <div class="col-sm-5"><?php echo $enduserinfo['post_aggregate_marks_obtained'][$i]; ?></div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-4 control-label">Aggregate Maximum Marks</label>
                      <div class="col-sm-5"><?php echo $enduserinfo['post_gra_aggregate_max_marks'][$i]; ?></div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-4 control-label">Final Percentage</label>
                      <div class="col-sm-5"><?php echo $enduserinfo['post_gra_percentage'][$i]; ?></div>
                    </div>
                    <div class="form-group">
                      <label class="col-sm-4 control-label">Class/Grade</label>
                      <div class="col-sm-5"><?php echo $enduserinfo['post_gra_class'][$i]; ?></div>
                    </div>
                ...
                <!-- <b>Education Qualification 3: Additional Qualifications/Certification </b></br>
                <div class="form-group">
                  <label for="roleid" class="col-sm-4 control-label">Qualification </label>
              ...
              <?php
              $enduserinfo = $this->session->userdata['enduserinfo'];
              $careers_course_mst = isset($careers_course_mst) ? $careers_course_mst : [];

              if (!empty($enduserinfo['course_code']) && is_array($enduserinfo['course_code'])) {
                for ($i = 0; $i < count($enduserinfo['course_code']); $i++) {
              ?>
                  <h4><b>Qualification <?php echo $i + 1; ?></b></h4>
                  <div class="form-group">
                    <label class="col-sm-4 control-label">Name Of Course</label>
                    <div class="col-sm-6" style="word-wrap: break-word;">
                      <?php
                      $course_code = $enduserinfo['course_code'][$i];
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-5">
                      <?php echo isset($enduserinfo['name_subject_of_course'][$i]) ? $enduserinfo['name_subject_of_course'][$i] : ''; ?>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <label class="col-sm-4 control-label">College/Institution</label>
                    <div class="col-sm-5">
                      <?php echo isset($enduserinfo['college_name'][$i]) ? $enduserinfo['college_name'][$i] : ''; ?>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <label class="col-sm-4 control-label">University</label>
                    <div class="col-sm-5">
                      <?php echo isset($enduserinfo['university'][$i]) ? $enduserinfo['university'][$i] : ''; ?>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <label class="col-sm-4 control-label">Period</label>
                    <div class="col-sm-5">
                      From: <?php echo isset($enduserinfo['from_date'][$i]) ? $enduserinfo['from_date'][$i] : ''; ?>
                      - To: <?php echo isset($enduserinfo['to_date'][$i]) ? $enduserinfo['to_date'][$i] : ''; ?>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <label class="col-sm-4 control-label">Aggregate Marks Obtained</label>
                    <div class="col-sm-5">
                      <?php echo isset($enduserinfo['aggregate_marks_obtained'][$i]) ? $enduserinfo['aggregate_marks_obtained'][$i] : ''; ?>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <label class="col-sm-4 control-label">Aggregate Maximum Marks</label>
                    <div class="col-sm-5">
                      <?php echo isset($enduserinfo['aggregate_max_marks'][$i]) ? $enduserinfo['aggregate_max_marks'][$i] : ''; ?>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-5">
                      <?php echo isset($enduserinfo['percentage'][$i]) ? $enduserinfo['percentage'][$i] : ''; ?>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <label class="col-sm-4 control-label">Class/Grade</label>
                    <div class="col-sm-6">
                      <?php echo isset($enduserinfo['class'][$i]) ? $enduserinfo['class'][$i] : ''; ?>
                    </div>
                  </div>
              ...
              ?>
                <div class="form-group">
                  <label for="roleid" class="col-sm-4 control-label">Name of the Organization/Employer/Bank</label>
              ...
              <?php if ($this->session->userdata['enduserinfo']['whether_in_service'] == 'yes') { ?>
                ...
                <div class="form-group">
                  <label for="roleid" class="col-sm-4 control-label">Communication Address of the Organization</label>
