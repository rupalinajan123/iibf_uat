    ...
    <div class="col-md-12">
      <div class="box box-info">
        ...
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5"> Head PDC (WZ) - MUMBAI on contract basis</div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <?php if($this->session->userdata['enduserinfo']['physical_disbaility']=='no'){echo 'No';}?>
              <?php if($this->session->userdata['enduserinfo']['physical_disbaility']=='yes'){echo 'Yes';}?>
            </div>
          </div>
        ...
        <div class="box-body">
         ...
         <!-- <div class="form-group">
          ...
          <div class="box-body">
            ...
            <br />
            <b>Education Qualification 1 - Academic (Graduation Onward)*</b></br>
            <div class="form-group">
              <label for="roleid" class="col-sm-4 control-label">Graduation Name</label>
              <div class="col-sm-5" style="word-wrap: break-word;"> <?php echo $this->session->userdata['enduserinfo']['ess_course_name']; ?> </div>
            </div>
            <div class="form-group">
              <label for="roleid" class="col-sm-4 control-label">Graduation Stream & Subject </label>
            ...
            <b>Education Qualification 2 - Post Graduation </b></br>
            <div class="form-group">
            ...
            <div class="form-group">
              <label for="roleid" class="col-sm-4 control-label">Post Graduation Stream & Subject </label>
              <div class="col-sm-5" style="word-wrap: break-word;"> <?php echo $this->session->userdata['enduserinfo']['post_gra_sub']; ?> </div>
            </div>
            <div class="form-group">
              <label for="roleid" class="col-sm-4 control-label">College/ Institution Name </label>
            ...
            <?php /* <div class="form-group">
              ...
              <div class="col-sm-5"><?php echo $this->session->userdata['enduserinfo']['grade_marks'];?></div>
            </div> */ ?>
            <div class="form-group">
              <label for="roleid" class="col-sm-4 control-label">Class/Grade </label>
            ...
            <?php 
				...
				?>
            <div class="form-group">
              <label for="roleid" class="col-sm-4 control-label">Name of the Organization/Employeer/Bank</label>
      ...
      ?>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8" align="justify"> <strong><?php echo $this->session->userdata['enduserinfo']['declaration4'];?></strong> &nbsp;
