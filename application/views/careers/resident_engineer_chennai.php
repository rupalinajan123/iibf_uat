				...
				<div class="col-md-12">
					...
					<div class="box box-info">
						...
						<div class="box-body">
							...
							<div class="form-group">
								<label for="rec_dob" class="col-sm-4 control-label">Date of Birth <span style="color:#F00">*</span></label>
								<div class="col-sm-5">
									<input autocomplete="off" type="text" onchange="check_dob_validation(this.value);" class="form-control" id="rec_dob" name="rec_dob" placeholder="Date of Birth" value="<?php echo set_value('rec_dob'); ?>" required>
									<?php
									$min_year = date('Y', strtotime("- 55 year"));
									$max_year = date('Y', strtotime("- 65 year"));
									?>
									(Age should not be less than 55 years and Should not exceed 65 years as on 01-11-2025)
									<span id="rec_dob_error" class="error"></span>
								</div>
						...
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<select name="ess_course_name" id="ess_course_name" class="form-control new-qualification" required>
										<option value="">-Select-</option>
										<option value="Bachelor of Engineering in Civil Engineering/Architecture">Bachelor of Engineering in Civil Engineering/Architecture</option>
										<!-- <option value="Bachelor Degree in Civil Engineering and Architectur" <?php echo  set_select('ess_course_name', 'Arts'); ?>>Bachelor Degree in Civil Engineering and Architectur</option> -->
							...
							<div id="postgraduation_dynamic_field">
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" id="post_qua_name" name="post_qua_name[]" placeholder="Qualification" value="" data-parsley-maxlength="30" maxlength="30" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
                    ...
                    <div class="row">
						...
						<div class="box box-info">
							<div class="form-group m_t_15">
								...
								<div class="col-sm-2">
									<input type="text" name="code" id="code" required class="form-control" placeholder="Security Code" autocomplete="off">
...
<script>
	...
	function check_dob_validation(val) {
		//alert(val);
		if (val < '1960-11-01') {
			$("#rec_dob_error").html('The maximum age limit to apply is 65 years as on 1960-11-01');
			flag = false;
		} else if (val > '1970-11-01') {
			$("#rec_dob_error").html('The minimum age limit to apply is 55 years as on 1970-11-01');
			flag = false;
		} else {
			$("#rec_dob_error").html('');
		}
