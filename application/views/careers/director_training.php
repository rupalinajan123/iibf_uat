...
<form class="form-horizontal" name="usersAddForm" id="usersAddForm" method="post" enctype="multipart/form-data">
  ...
  <div class="container">
    <section class="content-header">
      <h1 class="register">Application for the post of Director (Training) on Contract</h1>
    </section>
          ...
          <div class="box box-info">
            ...
            <div class="col-sm-5">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="ess_class" name="ess_class" placeholder="Class" value="<?php echo set_value('ess_class'); ?>" data-parsley-maxlength="20" maxlength="20" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/" required>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <div class="col-sm-5 date">
                    <input type="text" class="form-control" id="year_of_passing" name="year_of_passing" placeholder="Year of passing" required value="<?php echo set_value('year_of_passing'); ?>">
                  </div>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  ...
                  <!-- <input type="text" class="form-control" id="class" name="class" placeholder="class"  value="<?php //echo set_value('class');
                                                                                                                    ?>"  data-parsley-maxlength="20" maxlength="20" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">-->
