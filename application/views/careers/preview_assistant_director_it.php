        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                <label for="roleid" class="col-sm-4 control-label">Landline Number</label>
              ...
              <div class="box-body">
               ...
               <!-- <div class="form-group">
                ...
                <div class="col-sm-5" style="word-wrap: break-word;">
                  <?php echo $this->session->userdata['enduserinfo']['ess_subject']; ?>
                </div>
              </div>
              <div class="form-group">
      ...
      ?></div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8" align="justify"> <strong><?php echo $this->session->userdata['enduserinfo']['declaration3'];?></strong> &nbsp;
                  &nbsp;I undertake to execute an agreement to the effect that I will serve the Institute for a minimum period of Two (2) years (active service) from the date of joining the Institute. In case I leave the service of the Institute before the expiry of the said period, a sum of Rs. 2,00,000/- (Rupees Two Lakh only) will have to be paid by me to the Institute as mentioned in the recruitment notification for the post of Assistant Director (IT) dated 17.11.2022 </div>
              </div>
              <div class="box box-info">
                <div class="box-header with-border">
