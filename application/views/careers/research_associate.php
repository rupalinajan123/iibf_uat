...
<style>
  ...
  #parsley-id-multiple-course_code {
    position: absolute;
    bottom: -14px;
  }
</style>
...
<form class="form-horizontal" name="usersAddForm" id="usersAddForm" method="post" enctype="multipart/form-data" autocomplete="off">
  <input type="hidden" id="position_id" name="position_id" value="10">
  <div class="container">
    <section class="content-header" style="padding:0;">
      <h1 class="register">Application for the post of Research Associate </h1>
    </section>
        ...
        <div class="col-md-12">
          <div class="box box-info"><!-- START : BASIC DETAILS -->
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-2"><?php //First Name Prefix * 
                                      ?>
                ...
                <div class="col-sm-3"><?php //First Name * 
                                      ?>
              ...
              <div class="form-group"><?php //Father's/Husband's Name * 
                                      ?>
                <label class="col-sm-4 control-label">Father's/Husband's Name <span style="color:#F00">*</span></label>
                <div class="col-sm-5">
              ...
              <div class="form-group"><?php //Date of Birth * 
                ...
                <div class="col-sm-8">
                  <input type="hidden" id="research_associate_dob" name="dob" required value="<?php echo $dob; ?>">
                  <?php
                  $min_year = date('Y', strtotime("- 18 year"));
                  $max_year = date('Y', strtotime("- 29 year"));
                  ?>
                  (Age of the applicant should not be above 30 years as on 31/01/2022)
                  ...
                  <span id="research_associate_dob_error" class="error"></span>
                </div>
              ...
              <div class="form-group"><?php //Alternate Mobile * 
                                      ?>
                <label class="col-sm-4 control-label">Alternate Mobile<span style="color:#F00">*</span></label>
                <div class="col-sm-5">
              ...
              <div class="form-group"><?php //PAN No 
                                      ?>
                <label class="col-sm-4 control-label">PAN No<span style="color:#F00">*</span> </label>
                <div class="col-sm-5">
                  <input type="tel" class="form-control" id="pan_no" name="pan_no" placeholder="PAN No" data-parsley-minlength="10" data-parsley-maxlength="10" data-parsley-pannocheck value="<?php echo set_value('pan_no'); ?>" data-parsley-trigger-after-failure="focusout" required>
                  <span class="error"></span>
                </div>
              </div>
              ...
              <div class="form-group"><?php //Aadhar Card Number 
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="aadhar_card_no" name="aadhar_card_no" placeholder="Aadhar Card Number"
                    data-parsley-minlength="12" data-parsley-maxlength="12" data-parsley-type="number" size="12" value="<?php echo set_value('aadhar_card_no'); ?>" data-parsley-trigger-after-failure="focusout">
                  <span class="error"> </span>
                </div>
              </div>
            </div>
          ...
          <div class="box box-info"><!-- START : COMMUNICATION ADDRESS -->
            ...
            <div class="box-body">
              ...
              <div class="form-group"><?php //Contact No. 
                                      ?>
          ...
          <?php /* <div class="box box-info"><!-- START : EXAM CENTER -->
            <div class="box-header with-border"><h3 class="box-title">Exam Center</h3></div>
          ...
          <div class="box box-info"><!-- START : EDUCATIONAL QUALIFICATION -->
            <div class="box-header with-border">
            ...
            <div class="box-title box-header" style="margin-bottom:10px;"><strong>ESSENTIAL</strong></div>
            <div class="box-body">
              <div class="form-group"><?php //Name of course * 
                                      ?>
                <label class="col-sm-4 control-label">Degree <span style="color:#F00">*</span></label>
                <div class="col-sm-5">
                  <select name="ess_course_name" id="ess_course_name" class="form-control" required>
                    <option value="">-Select-</option>
                    <option value="Masters" <?php echo  set_select('ess_course_name', 'Masters'); ?>>Masters</option>
                    <?php /*<option value="B.Com" <?php echo  set_select('ess_course_name', 'B.Com'); ?>>B.Com</option>
              ...
              <div class="form-group"><?php //Subject * 
                ...
                <div class="col-sm-5">
                  <select name="ess_subject" id="ess_subject" class="form-control" required>
                    ...
                    <option value="Statistics" <?php echo  set_select('ess_subject', 'Statistics'); ?>>Statistics</option>
                    <option value="Business Management" <?php echo  set_select('ess_subject', 'Business Management'); ?>>Business Management</option>
                    <option value="Finance" <?php echo  set_select('ess_subject', 'Finance'); ?>>Finance</option>
              ...
              <div class="form-group"><?php //University * 
                                      ?>
                <label class="col-sm-4 control-label">University <span style="color:#F00">*</span></label>
                <div class="col-sm-5">
              ...
              <div class="form-group"><?php //Percentage  * 
                ...
                <div class="col-sm-5">
                  <input type="number" class="form-control" id="ess_percentage" name="ess_percentage" placeholder="Percentage" value="<?php echo set_value('ess_percentage'); ?>" data-parsley-maxlength="20" step="0.01" data-parsley-type="number" required data-parsley-pattern="/^[0-9.]+$/">
                  <span class="error"></span>
                </div>
              </div>
            ...
            <div class="box-body">
              <div class="form-group" style="padding-bottom:15px;"><?php //Name Of Course 
                                                                    ?>
                <div class="col-sm-12" style="position:relative;">
                  <?php
                  $course_code_arr = array(
                    'Experience in the area of Econometrics/ Quantitative techniques/ Data analysis/ Banking',
                    'Familiarity with research software (e.g. SPSS/ Stata / Eviews / MATLAB / R / Gauss)',
                    'Published high index research papers',
                    'Should have understanding & knowledge of regulatory guidelines in the area of Banking & Finance',
                    'Qualified UGCs Junior Research Fellowship (JRF) from subjects like Economics/ Management/Commerce'
                  );

                  $ii = 1;
                  foreach ($course_code_arr as $course_code) { ?>
                    <div>
                      <input type="checkbox" class="minimal" id="course_code<?php echo $ii; ?>" name="course_code[]" value="<?php echo $course_code; ?>" <?php echo set_checkbox('course_code', $course_code); ?> required />
                      <label><?php echo $course_code; ?></label>
                    </div>
                  <?php } ?>
                </div>
                <?php /* <label class="col-sm-4 control-label">Name Of Course</label>
                <div class="col-sm-5">
              ...
              <?php /* <div class="form-group"><?php //College Name and Address * ?>
          ...
          </div><!-- END : EDUCATIONAL QUALIFICATION -->
          ...
          <div class="box box-info"><!-- START : Languages, Extracurricular, Achievements -->
            ...
            <div class="form-group"><?php //Languages Known 1  * 
                                    ?>
              <label class="col-sm-4 control-label">Languages Known 1 <span style="color:#F00">*</span></label>
              <div class="col-sm-3">
            ...
            <div class="form-group"><?php //Languages Known 2 
                                    ?>
              <label class="col-sm-4 control-label">Languages Known 2</label>
              <div class="col-sm-3">
            ...
            <div class="form-group"><?php //Languages Known 3 
                                    ?>
              <label class="col-sm-4 control-label">Languages Known 3</label>
              <div class="col-sm-3">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-2">
                ...
                <input type="radio" class="minimal declaration_no" id="No" name="declaration1" required value="No" <?php echo set_radio('declaration1', 'No'); ?> data-parsley-errors-container="#declaration1_err_id"> No
                <span class="error"></span>
              </div>
          ...
          <div class="box box-info"><!-- START : REFERENCE -->
            ...
            <div class="box-title box-header" style="margin-bottom:10px;"><strong>PROFESSIONAL REFERENCE 1</strong></div>
            <div class="box-body">
              ...
              <div class="form-group"><?php //Organisation (If employed) 
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="reforganisation_one" name="reforganisation_one" placeholder="Organisation" value="<?php echo set_value('reforganisation_one'); ?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" maxlength="30">
                  <span class="error"></span>
                </div>(Max 30 Characters)
              </div>
            ...
            <div class="box-title box-header" style="margin-bottom:10px;"><strong>PROFESSIONAL REFERENCE 2</strong></div>
            <div class="box-body">
              <div class="form-group"><?php //Name * 
                                      ?>
                <label class="col-sm-4 control-label">Name <span style="color:#F00">*</span></label>
              ...
              <div class="form-group"><?php //Organisation (If employed) 
                ...
                <label class="col-sm-4 control-label">Organisation </label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="reforganisation_two" name="reforganisation_two" placeholder="Organisation" value="<?php echo set_value('reforganisation_two'); ?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" maxlength="30">
                  <span class="error"></span>
                </div>(Max 30 Characters)
              </div>
...
<script type="text/javascript">
  $(function() {
    $("#research_associate_dob").dateDropdowns({
      submitFieldName: 'research_associate_dob',
      minAge: 18,
      maxAge: 29
    });
  ...
  $(document).ready(function() {
    ...
    $("#research_associate_dob").change(function() {
      var sel_dob = $("#research_associate_dob").val();
      if (sel_dob != '') {
