...
<form class="form-horizontal" name="usersAddForm" id="usersAddForm"  method="post"  enctype="multipart/form-data">
  ...
  <div class="container">
		<section class="content-header">
			<h1 class="register">Application for the post of Assistant Director (Academics)</h1>
		</section>
		<section class="content">
			...
			<div class="row">
						...
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-2 example">
									...
									?>
									(Age of the applicant should not be above 35 years as on 01.11.2022)
					...
					<div class="box box-info">
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" required class="form-control" id="addressline1" name="addressline1" placeholder="Address line1" value="<?php echo set_value('addressline1');?>"  data-parsley-maxlength="30" maxlength="30" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
								<span class="error"> </span> </div>
							(Max 30 Characters) </div>
							<div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">Address line2  <span style="color:#F00">*</span></label>
								<div class="col-sm-5">
									<input type="text" required class="form-control" id="addressline2" name="addressline2" placeholder="Address line2"  value="<?php echo set_value('addressline2');?>"  data-parsley-maxlength="30" maxlength="30" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
								<span class="error"> </span> </div>
							(Max 30 Characters) </div>
							<div class="form-group">
							...
							<div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">Address line1 <span style="color:#F00">*</span></label>
								<div class="col-sm-5">
									<input type="text" required class="form-control" id="addressline1_pr" name="addressline1_pr" placeholder="Address line1" value="<?php echo set_value('addressline1_pr');?>"  data-parsley-maxlength="30" maxlength="30" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
								<span class="error"></span> </div>
							(Max 30 Characters) </div>
							<div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">Address line2 <span style="color:#F00">*</span></label>
								<div class="col-sm-5">
									<input type="text" required class="form-control" id="addressline2_pr" name="addressline2_pr" placeholder="Address line2"  value="<?php echo set_value('addressline2_pr');?>"  data-parsley-maxlength="30" maxlength="30" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
								<span class="error"> </span> </div>
							(Max 30 Characters) </div>
							<div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">Address line3</label>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<select name="ess_course_name" id="ess_course_name" class="form-control" required>
										...
										<option value="Economics" <?php echo  set_select('ess_course_name', 'Economics'); ?>>Economics</option>
										<option value="Banking" <?php echo  set_select('ess_course_name', 'Banking'); ?>>Banking</option>
										<option value="Finance" <?php echo  set_select('ess_course_name', 'Finance'); ?>>Finance</option>
										<option value="CA" <?php echo  set_select('ess_course_name', 'CA'); ?>>CA</option>
										<option value="CMA" <?php echo  set_select('ess_course_name', 'CMA'); ?>>CMA</option>
										<option value="CS" <?php echo  set_select('ess_course_name', 'CS'); ?>>CS</option>
                ...
                <option value="Computer Applications" <?php //echo  set_select('ess_subject', 'Computer Applications'); ?>>Computer Applications</option>
							...
							<div class="form-group"> 
								<label for="roleid" class="col-sm-4 control-label">Institute Name <span style="color:#F00">*</span></label>
								<div class="col-sm-5">
									<input type="text" class="form-control" id="ess_college_name" name="ess_college_name" placeholder="Institute Name" required value="<?php echo set_value('ess_college_name');?>" data-parsley-maxlength="200" maxlength="200" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
								<span class="error"></span> </div>
							(Max 200 Characters) </div>
							<!--<div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">University <span style="color:#F00">*</span></label>
								<div class="col-sm-5">
								<input type="text" class="form-control" id="ess_university" name="ess_university" placeholder="University" required value="<?php //echo set_value('ess_university');?>" data-parsley-maxlength="30" maxlength="30" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
								<span class="error"></span> </div>
							(Max 30 Characters) </div>-->
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="ess_grade_marks" name="ess_grade_marks" placeholder="Percentage"  value="<?php echo set_value('ess_grade_marks');?>"  data-parsley-maxlength="20" maxlength="20" data-parsley-pattern="/^[0-9.]+$/" required>
								<span class="error"></span> </div>
							</div>
							<!--<div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">Class <span style="color:#F00">*</span></label>
								<div class="col-sm-5">
                ...
                <option value="First Class" <?php //echo  set_select('ess_class', 'First Class'); ?>>First Class</option>
							...
							<div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">Institute Name</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" id="college_name" name="college_name" placeholder="Institute Name" value="<?php echo set_value('college_name');?>" data-parsley-maxlength="200" maxlength="200" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
								<span class="error"></span> </div>
							(Max 200 Characters) </div>
							<!--<div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">University <span style="color:#F00">*</span></label>
								<div class="col-sm-5">
								<input type="text" class="form-control" id="university" name="university" placeholder="University" required value="<?php //echo set_value('university');?>" data-parsley-maxlength="30" maxlength="30" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
								<span class="error"></span> </div>
							(Max 30 Characters) </div>-->
							<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="grade_marks" name="grade_marks" placeholder="Percentage"  value="<?php echo set_value('grade_marks');?>"  data-parsley-maxlength="20" maxlength="20" data-parsley-pattern="/^[0-9.]+$/">
								<span class="error"></span> </div>
							</div>
							<!--<div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">Class <span style="color:#F00">*</span></label>
                ...
                <option value="Pass Class" <?php //echo  set_select('class', 'Pass Class'); ?>>Pass Class</option>
						...
						<div class="form-group">
							...
							&nbsp;I undertake to execute an agreement to the effect that I will serve the Institute for a minimum period of Two (2) years (active service) from the date of joining the Institute. In case I leave the service of the Institute before the expiry of the said period, a sum of Rs. 2,00,000/- (Rupees Two Lakh only) will have to be paid by me to the Institute as mentioned in the recruitment notification for the post of Assistant Director (Academics) dated 17.11.2022.<span class="error"></span></div>
						</div>
						<div class="box box-info">
							<div class="box-header with-border">
