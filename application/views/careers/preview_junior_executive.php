...
<div class="container">
  ...
  <form class="form-horizontal" name="usersAddForm" id="usersAddForm"  method="post"  enctype="multipart/form-data" 
    ...
    <section class="content">
            ...
            <div class="col-sm-5"> Junior Executive</div>
					...
					<div class="box box-info">
						...
						<div class="box-body">
							...
							<div class="box-body">
								...
								<div class="box-title box-header"><strong>ESSENTIAL(GRADUATION)</strong> </div><br />
								<div class="form-group">
              ...
              <div class="col-sm-5"><?php echo $this->session->userdata['enduserinfo']['name_subject_of_course'];?></div>
								...
								<div class="box box-info">
									...
									<div class="form-group">
										...
										<div class="col-sm-8" align="justify"> <strong><?php echo $this->session->userdata['enduserinfo']['declaration2'];?></strong> &nbsp;
										&nbsp;I undertake to execute an agreement to the effect that I will serve the Institute for a minimum period of Two (2) years (active service) from the date of joining the Institute. In case I leaves the service of the Institute before the expiry of the said period, a sum of Rs. 1,00,000/- (Rupees One Lakh only) will have to be paid by me to the Institute as mentioned in the recruitment notification for the post of Junior Executive dated 17.11.2022.</div>
									</div>
									<div class="box box-info">
										<div class="box-header with-border">
								...
								<div class="box box-info">
									<div class="box-footer">
										<div class="col-sm-4 col-xs-offset-3">
											<input type="submit" class="btn btn-info" name="btnSubmit" id="btnSubmit" value="Proceed to pay">
										</div>
									</div>
								</div>
							</div>
