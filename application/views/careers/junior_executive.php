...
<div id="confirmBox">
  <div class="message" style="color:#F00">
    <strong>VERY IMPORTANT</strong> I confirm that the Photo, Signature images uploaded belongs to me and they are clear and readable.
  </div>
...
<form class="form-horizontal" name="usersAddForm" id="usersAddForm" method="post" enctype="multipart/form-data" autocomplete="off">
  ...
  <div class="container">
    <section class="content-header" style="padding:0;">
      <h1 class="register">Recruitment application of Junior Executive</h1>
    </section>
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-info"><!-- START : BASIC DETAILS -->
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <select readonly name="position_selection" id="position_selection" class="form-control" required>
                    ...
                    <option value="Junior Executive" <?php echo  set_select('position_selection', 'Junior Executive'); ?>>Junior Executive</option>
                  </select>
                  <span class="error" id="position_selection_error"></span>
                </div>

              </div>
              <div class="form-group"><?php //Middle Name 
                                      ?>
                <label class="col-sm-4 control-label">Title <span style="color:#F00">*</span></label>
                <div class="col-sm-5">
              ...
              <div class="form-group">
                <label class="col-sm-4 control-label">First Name <span style="color:#F00">*</span></label>

                <div class="col-sm-5"><?php //First Name * 
                                      ?>
                  <input type="text" class="form-control" id="firstname" name="firstname" placeholder="First Name" required value="<?php echo set_value('firstname'); ?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" maxlength="30">
                  <span class="error"> </span>
              ...
              <div class="form-group"><?php //Last Name * 
                                      ?>
                <label class="col-sm-4 control-label">Last Name <span style="color:#F00">*</span></label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="middlename" name="lastname" placeholder="Last Name" required value="<?php echo set_value('lastname'); ?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" maxlength="30">
                  <span class="error"> </span>
                </div>(Max 30 Characters)
              </div>
              <div class="form-group"><?php //Marital Status * 
                                      ?>
                <label class="col-sm-4 control-label">Marital Status <span style="color:#F00">*</span> </label>
                <div class="col-sm-5">
              ...
              <div class="form-group"><?php //Date of Birth * 
                                      ?>
                <label class="col-sm-4 control-label">Date of Birth <span style="color:#F00">*</span></label>
                <div class="col-sm-8">
                  <input type="hidden" id="jun_ex_dob1" name="" required value="<?php echo $dob; ?>">
                  <input type="hidden" id="dobtopass" name="dob1" value="<?php echo $dob; ?>">


                  <?php
                  $min_year = date('Y', strtotime("- 18 year"));
                  $max_year = date('Y', strtotime("- 28 year"));
                  ?>
                  (Age of the applicant should not be above 28 years as on 01.10.2024.)
                  ...
                  <br /> <span id="dob_error" class="error"></span>
                </div>
              ...
              <div class="form-group"><?php //Gender * 
                                      ?>
                <label class="col-sm-4 control-label">Gender <span style="color:#F00">*</span></label>
                <div class="col-sm-3">
                  <input type="radio" class="minimal cls_gender" checked="checked" id="female" name="gender" required value="female" <?php echo set_radio('gender', 'female'); ?>>Female
                  <input type="radio" class="minimal cls_gender" id="male" name="gender" required value="male" <?php echo set_radio('gender', 'male'); ?>>Male
                  <span class="error"></span>
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group"><?php //Email Id * 
                                      ?>
              ...
              <div class="form-group"><?php //Mobile * 
                                      ?>
              ...
              <div class="form-group"><?php //Alternate Mobile * 
                                      ?>
                <label class="col-sm-4 control-label">Alternate Mobile No.<span style="color:#F00">*</span></label>
                <div class="col-sm-5">
              ...
              <div class="form-group"><?php //PAN No 
                                      ?>
              ...
              <div class="form-group"><?php //Aadhar Card Number 
                                      ?>
                <label class="col-sm-4 control-label">Aadhar Card Number <span style="color:#F00">*</span></label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="aadhar_card_no" name="aadhar_card_no" placeholder="Aadhar Card Number"
                    data-parsley-minlength="12" data-parsley-maxlength="12" data-parsley-type="number" required size="12" value="<?php echo set_value('aadhar_card_no'); ?>" data-parsley-trigger-after-failure="focusout">
                  <span class="error"> </span>
                </div>
              </div>
            </div>
          ...
          <div class="box box-info"><!-- START : COMMUNICATION ADDRESS -->
            <div class="box-header with-border">
              <h3 class="box-title">COMMUNICATION ADDRESS</h3>
            </div>

            <div class="box-body">
              <div class="form-group"><?php //Address line1 * 
                                      ?>
                <label class="col-sm-4 control-label">Address line 1 <span style="color:#F00">*</span></label>
                <div class="col-sm-5">
              ...
              <div class="form-group"><?php //Address line2 * 
                                      ?>
                <label class="col-sm-4 control-label">Address line 2 <span style="color:#F00">*</span></label>
                <div class="col-sm-5">
              ...
              <div class="form-group"><?php //Address line3 
                                      ?>
              ...
              <div class="form-group"><?php //Address line4 
                                      ?>
                <label class="col-sm-4 control-label">Address line 4</label>
                <div class="col-sm-5">
              ...
              <div class="form-group"><?php //District * 
                                      ?>
                <label class="col-sm-4 control-label">District <span style="color:#F00">*</span></label>
                <div class="col-sm-5">
              ...
              <div class="form-group">
                ...
                <label class="col-sm-2 control-label">Pincode/Zipcode <span style="color:#F00">*</span></label>
                <div class="col-sm-3"><?php //Pincode/Zipcode * 
                                      ?>
                  ...
                  <span style="display: inline-block;width: 100%;">(Max 6 digits)</span>
                  <span class="error"> </span>
                </div>
              </div>
          ...
          </div><!-- END : COMMUNICATION ADDRESS -->

          <div class="box box-info"><!-- START : PERMANENT ADDRESS -->
            <div class="box-header with-border">
            ...
            <div class="box-header with-border nobg">
              <h6 class="box-title-hd">
                ...
                <em>Click here if Permanent Address is same as Communication Address</em>
              </h6>
            </div>
            <div class="box-body">
              <div class="form-group"><?php //Address line1 * 
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control communication_address_field" id="addressline1_pr" name="addressline1_pr" placeholder="Address line1" value="<?php echo set_value('addressline1_pr'); ?>" data-parsley-maxlength="30" maxlength="30" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/" required>
                  <span class="error"></span>
                </div>(Max 30 Characters)
              </div>
              ...
              <div class="form-group"><?php //Address line2 * 
                                      ?>
                <label class="col-sm-4 control-label">Address line2 <span style="color:#F00">*</span></label>
                <div class="col-sm-5">
                  <input type="text" class="form-control communication_address_field" id="addressline2_pr" name="addressline2_pr" placeholder="Address line2" value="<?php echo set_value('addressline2_pr'); ?>" data-parsley-maxlength="30" maxlength="30" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/" required>
                  <span class="error"> </span>
                </div>(Max 30 Characters)
              </div>
              ...
              <div class="form-group"><?php //Address line3 
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control communication_address_field" id="addressline3_pr" name="addressline3_pr" placeholder="Address line3" value="<?php echo set_value('addressline3_pr'); ?>" data-parsley-maxlength="30" maxlength="30" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
                  <span class="error"> </span>
                </div>(Max 30 Characters)
              </div>
              ...
              <div class="form-group"><?php //Address line4 
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control communication_address_field" id="addressline4_pr" name="addressline4_pr" placeholder="Address line4" value="<?php echo set_value('addressline4_pr'); ?>" data-parsley-maxlength="30" maxlength="30" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
                  <span class="error"> </span>
                </div>(Max 30 Characters)
              </div>
              ...
              <div class="form-group"><?php //City * 
                ...
                <label class="col-sm-4 control-label">City <span style="color:#F00">*</span></label>
                <div class="col-sm-5">
                  <input type="text" class="form-control communication_address_field" id="city_pr" name="city_pr" placeholder="City" required value="<?php echo set_value('city'); ?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" maxlength="30">
                  <span class="error"> </span>
                </div>(Max 30 Characters)
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3"><?php //Pincode/Zipcode * 
                                      ?>
                  <input type="text" class="form-control communication_address_field" id="pincode_pr" name="pincode_pr" placeholder="Pincode/Zipcode" required value="<?php echo set_value('pincode_pr'); ?>" data-parsley-maxlength="6" maxlength="6" size="6" data-parsley-checkpin_pr data-parsley-type="number" data-parsley-trigger-after-failure="focusout">
                  <span style="display: inline-block;width: 100%;">(Max 6 digits)</span>
                  <span class="error"> </span>
                </div>
              </div>
          ...
          <div class="box box-info"><!-- START : EXAM CENTER -->
            <div class="box-header with-border">
              <h3 class="box-title">Exam Center</h3>
            </div>

            <div class="box-body">
              <div class="form-group"><?php //Exam Center * 
                                      ?>
                <label class="col-sm-4 control-label">Exam Center <span style="color:#F00">*</span></label>
                <div class="col-sm-5">
                  <select name="exam_center" id="exam_center" class="form-control" required>
                    <option value="">-Select-</option>
                    <option value="Chennai" <?php echo  set_select('exam_center', 'Chennai'); ?>>Chennai</option>
                    <option value="Kolkata" <?php echo  set_select('exam_center', 'Kolkata'); ?>>Kolkata</option>
                    <option value="Mumbai" <?php echo  set_select('exam_center', 'Mumbai'); ?>>Mumbai</option>
                    <option value="New Delhi" <?php echo  set_select('exam_center', 'New Delhi'); ?>>New Delhi</option>
                  </select>
                </div>
              </div>
            </div>
          ...
          <div class="box box-info"><!-- START : EDUCATION QUALIFICATION -->
            <div class="box-header with-border">
            ...
            <div class="box-title box-header" style="margin-bottom:10px;"><strong>ESSENTIAL(GRADUATION)</strong></div>
            <div class="box-body">
              <div class="form-group"><?php //Name of course * 
                                      ?>
                <label class="col-sm-4 control-label">Course Name<span style="color:#F00">*</span></label>
                <div class="col-sm-5">
                  <select name="ess_course_name" id="ess_course_name" class="form-control" required>
                    <option value="">-Select-</option>
                    <option value="BA" <?php echo  set_select('ess_course_name', 'BA'); ?>>BA</option>
                    <option value="B.Com" <?php echo  set_select('ess_course_name', 'B.Com'); ?>>B.Com</option>
                    <option value="BBA" <?php echo  set_select('ess_course_name', 'BBA'); ?>>BBA</option>
                    <option value="B.E" <?php echo  set_select('ess_course_name', 'B.E'); ?>>B.E</option>
                    <option value="B.Tech" <?php echo  set_select('ess_course_name', 'B.Tech'); ?>>B.Tech</option>
                    <option value="B.Sc." <?php echo  set_select('ess_course_name', 'B.Sc.'); ?>>B.Sc.</option>
                    <option value="BCA" <?php echo  set_select('ess_course_name', 'BCA'); ?>>BCA</option>
                  </select>
                </div>
              </div>

              <div class="form-group"><?php //Subject * 
                                      ?>
                <label class="col-sm-4 control-label">Subject <span style="color:#F00">*</span></label>
                <div class="col-sm-5">
                  <select name="ess_subject" id="ess_subject" class="form-control" required>
                    <option value="">-Select-</option>
                    <option value="Commerce" <?php echo  set_select('ess_subject', 'Commerce'); ?>>Commerce</option>
                    <option value="Economics" <?php echo  set_select('ess_subject', 'Economics'); ?>>Economics</option>
                    <option value="Business Management" <?php echo  set_select('ess_subject', 'Business Management'); ?>>Business Management</option>
                    <option value="Information Technology" <?php echo  set_select('ess_subject', 'Information Technology'); ?>>Information Technology</option>
                    <option value="Computer Science" <?php echo  set_select('ess_subject', 'Computer Science'); ?>>Computer Science</option>
                    <option value="Computer Applications" <?php echo  set_select('ess_subject', 'Computer Applications'); ?>>Computer Applications</option>
                  </select>
                </div>
              </div>

              <div class="form-group"><?php //College Name and Address * 
                                      ?>
                <label class="col-sm-4 control-label">College Name and Address <span style="color:#F00">*</span></label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="ess_college_name" name="ess_college_name" placeholder="College Name and Address" required value="<?php echo set_value('ess_college_name'); ?>" data-parsley-maxlength="200" maxlength="200" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
                  <span class="error"></span>
                </div>(Max 200 Characters)
              </div>

              <div class="form-group"><?php //University * 
                                      ?>
                <label class="col-sm-4 control-label">University Name<span style="color:#F00">*</span></label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="ess_university" name="ess_university" placeholder="University" required value="<?php echo set_value('ess_university'); ?>" data-parsley-maxlength="200" maxlength="200" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
                  <span class="error"></span>
                </div>(Max 200 Characters)
              </div>

              <div class="form-group"><?php //Period * 
                                      ?>
                <label class="col-sm-4 control-label">Period<span style="color:#F00">*</span></label>
                <div class="col-sm-6">
                  <div class="col-sm-3 date" style="padding-left:0"><?php //From Date * 
                                                                    ?>
                  ...
                  <div class="col-sm-3 date"><?php //To Date * 
                                              ?>
              ...
              <div class="form-group"><?php //Date of completion of the Degree * 
                                      ?>
                <label class="col-sm-4 control-label">Date of completion of the Degree<span style="color:#F00">*</span></label>
                <div class="col-sm-6 date">
                  <input type="text" class="form-control" id="ess_degree_completion_date" name="ess_degree_completion_date" placeholder="Date of completion of the Degree" required value="<?php echo set_value('ess_degree_completion_date'); ?>">
                </div>
              </div>
              ...
              <div class="form-group"><?php //Percentage  * 
                ...
                <div class="col-sm-5">
                  <input type="number" class="form-control" id="ess_percentage" name="ess_percentage" placeholder="Percentage" value="<?php echo set_value('ess_percentage'); ?>" data-parsley-maxlength="20" step="0.01" data-parsley-type="number" required>
                  <span class="error"></span>
                </div>
              </div>

              <div class="form-group"><?php //Class/Grade * 
                                      ?>
                <label class="col-sm-4 control-label">Class/Grade <span style="color:#F00">*</span></label>
                <div class="col-sm-5">
            ...
            <div class="box-title box-header" style="margin-bottom:10px;"><strong>DESIRABLE</strong> </div>
            <div class="box-body">
              <div class="form-group"><?php //Name Of Course 
                                      ?>
              ...
              <div class="form-group"><?php //College Name and Address * 
                                      ?>
                <label class="col-sm-4 control-label">College Name and Address</label>
                <div class="col-sm-5">
              ...
              <div class="form-group"><?php //Period * 
                ...
                <div class="col-sm-6">
                  <div class="col-sm-3 date" style="padding-left:0;"><?php //From Date * 
                                                                      ?>
                    <input type="text" class="form-control from_date" id="from_date" name="from_date" placeholder="From Date" value="<?php echo set_value('from_date'); ?>">
                  </div>
                  <div class="col-sm-3 date"><?php //To Date * 
                                              ?>
                    <input type="text" class="form-control to_date" id="to_date" name="to_date" placeholder="To Date" value="<?php echo set_value('to_date'); ?>">
                  </div>
                </div>
              </div>
              ...
              <div class="form-group"><?php //Date of completion of the Degree * 
                                      ?>
                <label class="col-sm-4 control-label">Date of completion of the Degree</label>
                <div class="col-sm-6 date">
                  <input type="text" class="form-control" id="degree_completion_date" name="degree_completion_date" placeholder="Date of completion of the Degree" value="<?php echo set_value('degree_completion_date'); ?>">
                </div>
              </div>
              ...
              <div class="form-group"><?php //Percentage  * 
                ...
                <div class="col-sm-5">
                  <input type="number" class="form-control" id="percentage" name="percentage" step="0.01" placeholder="Percentage" value="<?php echo set_value('percentage'); ?>" data-parsley-maxlength="20" step="0.01" data-parsley-type="number">
                  <span class="error"></span>
                </div>
              </div>
          ...
          </div><!-- END : EDUCATION QUALIFICATION -->

          <div class="box box-info"><!-- START : EMPLOYMENT HISTORY -->
            <div class="box-header with-border">
              <!-- <h3 class="box-title">EMPLOYMENT HISTORY (From Recent employment to Oldest employment)</h3> -->
                ...
                foreach ($organization as $job_key => $job_val) {
                  ...
                  <div id="job_dynamic_field">
                    <div id="job_row<?php echo $i; ?>">
                      <div class="form-group"><?php //Name of the Organization 
                                              ?>
                        <label class="col-sm-4 control-label">Name of the Organization </label>
                        <div class="col-sm-5">
                          <input type="text" class="form-control" id="organization" name="organization[]" placeholder="Name of the Organization" value="<?php echo $organization_val; //set_value('organization');
                                                                                                                                                        ?>" data-parsley-maxlength="30" maxlength="30" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
                          <span class="error"> </span>
                        </div>(Max 30 Characters)
                      </div>
                      ...
                      <div class="form-group"><?php //Designation 
                        ...
                        <div class="col-sm-5">
                          <input type="text" class="form-control" id="designation" name="designation[]" placeholder="Designation" value="<?php echo $designation_val; //echo set_value('designation');
                                                                                                                                          ?>" data-parsley-maxlength="40" maxlength="40" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
                          <span class="error"> </span>
                      ...
                      <div class="form-group"><?php //Period 
                        ...
                        <label class="col-sm-4 control-label">Period</label>
                        <div class="col-sm-6">
                          <div class="col-sm-3 date" style="padding-left:0">
                      ...
                      <div class="form-group"><?php //Responsibilities 
                                              ?>
              ...
              <?php } else { ?>
                ...
                <div id="job_dynamic_field">
                  <div class="form-group"><?php //Name of the Organization 
                    ...
                    <label class="col-sm-4 control-label">Name of the Organization </label>
                    <div class="col-sm-5">
                      <input type="text" class="form-control" id="organization" name="organization[]" placeholder="Name of the Organization" value="<?php  //echo set_value('organization');
                                                                                                                                                    ?>" data-parsley-maxlength="30" maxlength="30" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
                      <span class="error"> </span>
                    </div>(Max 30 Characters)
                  </div>
          ...
          <div class="box box-info"><!-- START : Languages, Extracurricular, Achievements -->
            <div class="box-header with-border">
              <h3 class="box-title">Languages, Extracurricular, Achievements</h3>
            </div>

            <div class="form-group"><?php //Languages Known 1  * 
                                    ?>
              <label class="col-sm-4 control-label">Language Known 1 <span style="color:#F00">*</span></label>
              <div class="col-sm-3">
            ...
            <div class="form-group"><?php //Languages Known 2 
                                    ?>
              <label class="col-sm-4 control-label">Language Known 2</label>
              <div class="col-sm-3">
            ...
            <div class="form-group"><?php //Languages Known 3 
                                    ?>
              <label class="col-sm-4 control-label">Language Known 3</label>
              <div class="col-sm-3">
            ...
            <div class="form-group"><?php //Extracurricular (Games / Membership / Association) 
                                    ?>
              <label class="col-sm-4 control-label">Extracurricular (Games / Membership / Association)</label>
              <div class="col-sm-5">
            ...
            <div class="form-group"><?php //Hobbies 
                                    ?>
            ...
            <div class="form-group"><?php //Achievements 
                                    ?>
            ...
            <div class="form-group">
              <label style="text-align: left;" class="col-sm-10 control-label">Have your ever been arrested, or kept under detention or bound down/ fined/ convicted by a court of law for any offence or a case against you is pending in respect of any criminal offence/ charge is under investigation, inquiry or trial or otherwise. YES or NO. If YES full particulars of the case should be given. Canvassing in any form will be a disqualification.&nbsp;<span style="color:#F00">*</span> </label>
              <div class="col-sm-2">
                <input type="radio" class="minimal declaration_yes" id="Yes" name="declaration1" required value="Yes" <?php echo set_radio('declaration1', 'Yes'); ?> data-parsley-errors-container="#declaration1_err_id"> Yes
                <br /><input type="radio" class="minimal declaration_no" id="No" name="declaration1" required value="No" <?php echo set_radio('declaration1', 'No'); ?> data-parsley-errors-container="#declaration1_err_id"> No
                <span class="error"></span>
              </div>
              <span id="declaration1_err_id" style="display:inline-block"></span>
            </div>

            <div class="form-group" id="declaration_note_div" style="display:none;"><?php //Declaration Note 
                                                                                    ?>
              <label class="col-sm-4 control-label">Declaration Note <span style="color:#F00">*</span></label>
              <div class="col-sm-5">
          ...
          </div><!-- END : Languages, Extracurricular, Achievements -->

          <div class="box box-info"><!-- START : REFERENCE -->
            <div class="box-header with-border">
            ...
            <div class="box-title box-header" style="margin-bottom:10px;"><strong>REFERENCE 1</strong></div>
            <div class="box-body">
              <div class="form-group"><?php //Name * 
                ...
                <div class="col-sm-5">
                  ...
                  <span class="error"><?php //echo form_error('refname_one');
                                      ?></span>
                </div>(Max 30 Characters)
              </div>

              <div class="form-group"><?php //Complete Address * 
                                      ?>
                <label class="col-sm-4 control-label">Complete Address <span style="color:#F00">*</span></label>
                <div class="col-sm-5">
                  ...
                  <span class="error"><?php //echo form_error('refaddressline_one');
                                      ?></span>
                </div>(Max 250 Characters)
              </div>
              ...
              <div class="form-group"><?php //Designation 
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="refdesignation_one" required name="refdesignation_one" placeholder="Designation" value="<?php echo set_value('refdesignation_one'); ?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" maxlength="30">
                  <span class="error"></span>
                </div>(Max 30 Characters)
              </div>
              ...
              <div class="form-group"><?php //Email Id * 
                ...
                <div class="col-sm-5">
                  ...
                  <span class="error"><?php //echo form_error('refemail_one');
                                      ?></span>
                </div>
              </div>
              ...
              <div class="form-group"><?php //Mobile * 
                                      ?>
                <label class="col-sm-4 control-label">Mobile <span style="color:#F00">*</span></label>
                <div class="col-sm-5">
                  ...
                  <span class="error"><?php //echo form_error('refmobile_one');
                                      ?></span>
                </div>
              </div>
            </div>

            <div class="box-title box-header" style="margin-bottom:10px;"><strong>REFERENCE 2</strong></div>
            <div class="box-body">
              <div class="form-group"><?php //Name * 
                                      ?>
                <label class="col-sm-4 control-label">Name <span style="color:#F00">*</span></label>
              ...
              <div class="form-group"><?php //Organisation (If employed) 
                ...
                <label class="col-sm-4 control-label">Organisation (If employed) <span style="color:#F00">*</span></label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="reforganisation_two" required name="reforganisation_two" placeholder="Organisation (If employed)" value="<?php echo set_value('reforganisation_two'); ?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" maxlength="30">
                  <span class="error"></span>
                </div>(Max 30 Characters)
              </div>
              ...
              <div class="form-group"><?php //Designation 
                ...
                <label class="col-sm-4 control-label">Designation <span style="color:#F00">*</span></label>
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="refdesignation_two" required name="refdesignation_two" placeholder="Designation" value="<?php echo set_value('refdesignation_two'); ?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" maxlength="30">
                  <span class="error"></span>
                </div>(Max 30 Characters)
              </div>
              ...
              <div class="form-group"><?php //Email Id * 
                ...
                <div class="col-sm-5">
                  ...
                  <span class="error"><?php //echo form_error('refemail_two');
                                      ?></span>
                </div>
              </div>
              ...
              <div class="form-group"><?php //Mobile * 
                ...
                <div class="col-sm-5">
                  ...
                  <span class="error"><?php //echo form_error('refmobile_two');
                                      ?></span>
                </div>
              </div>
            </div>
          ...
          <div class="box box-info"><!-- START : OTHER INFORMATION -->
            <div class="box-header with-border">
              <h3 class="box-title">Other Information</h3>
            </div>
            <div class="box-body">
              <div class="form-group">
                <label class="col-sm-4 control-label">Any other information that the candidate would like to add</label>
                <div class="col-sm-5">
          ...
          </div><!-- END : OTHER INFORMATION -->

          <div class="box box-info"><!-- START : DECLARATION -->
            <div class="box-header with-border">
              <h3 class="box-title">Declaration</h3>
            </div>
            <div class="box-body">
              <div class="form-group"><?php //Declaration * 
                                      ?>
                <label class="col-sm-4 control-label">Declaration 1&nbsp;<span style="color:#F00">*</span> </label>
                <div class="col-sm-8" align="justify">
                  <input type="checkbox" name="declaration1" id="declaration1" value="Yes" required <?php echo set_checkbox('declaration1', 'Yes'); ?>> &nbsp;I declare that all statements made in this application are true, complete and correct to the best of my knowledge and belief . I also declare that I have not suppressed any material fact(s)/information. I understand that in the event of any information being found untrue or incomplete at any stage or my not satisfying any of the eligibility criteria according to the requirements of the related advertisement of Indian Institute Banking & Finance, my candidature / appointment for the said post is liable to be cancelled at any stage and even after appointment, my services are liable to be terminated without any notice. <span class="error"></span>
                </div>
              </div>
              <div class="form-group"><?php //Declaration * 
                                      ?>
                <label class="col-sm-4 control-label">Declaration 2&nbsp;<span style="color:#F00">*</span> </label>
                <div class="col-sm-8" align="justify">
                  <input type="checkbox" name="declaration2" id="declaration2" value="Yes" required <?php echo set_checkbox('declaration2', 'Yes'); ?>> &nbsp;I undertake to execute an agreement to the effect that I will serve the Institute for a minimum period of Two (2) years (active service) from the date of joining the Institute. In case I leaves the service of the Institute before the expiry of the said period, a sum of Rs. 1,00,000/- (Rupees One Lakh only) will have to be paid by me to the Institute as mentioned in the recruitment notification for the post of Junior Executive dated 01-10-2024. <span class="error"></span>
                </div>
              </div>
            </div>
          </div><!-- END : DECLARATION -->

          <div class="box box-info"><!-- START : UPLOAD -->
            <div class="box-header with-border">
              <h3 class="box-title">UPLOAD OF PHOTO AND SIGNATURE</h3>
            </div>
            <div class="box-body">
              <div class="form-group">
                <label class="col-sm-4 control-label">Photo <span style="color:#F00">*</span></label>
                <div class="col-sm-5">
                  ...
                  <div id="error_photo"></div> <br>
                  <div id="error_photo_size"></div>
                  <span class="photo_text" style="display:none;"></span>
                  <span class="error"><?php //echo form_error('scannedphoto');
                                      ?></span>
                  (Image dimension of photograph as 100(Width)* 120 (Pixel) )
                </div>
                <img id="image_upload_scanphoto_preview" height="100" width="100" />
              </div>

              <div class="form-group">
                <label class="col-sm-4 control-label">Signature <span style="color:#F00">*</span></label>
                <div class="col-sm-5">
                  ...
                  <div id="error_signature"></div><br>
                  <div id="error_signature_size"></div>
                  <span class="signature_text" style="display:none;"></span>
                  <span class="error"><?php //echo form_error('scannedsignaturephoto');
                                      ?></span>
                  ( Image dimension of signature as 140(Width)* 60 (Pixel) )
                </div>
                <img id="image_upload_sign_preview" height="100" width="100" />
              </div>
              <!--<div class="form-group">
                <label class="col-sm-4 control-label">Resume/CV <span style="color:#F00">*</span></label>
                <div class="col-sm-5">
          ...
          <div class="box box-info"><!-- START : PLACE & DATE -->
            <div class="box-header with-border">
              <h3 class="box-title">Place &amp; Date</h3>
            </div>
            <div class="box-body">
              <div class="form-group">
                <label class="col-sm-4 control-label">Place<span style="color:#F00">*</span></label>
                <div class="col-sm-5">
              ...
              <div class="form-group">
                <label class="col-sm-4 control-label">Date<span style="color:#F00">*</span></label>
                <div class="col-sm-6 date">
                  <input type="text" class="form-control" id="submit_date" name="submit_date" placeholder="Date" required value="<?php echo set_value('submit_date'); ?>">
                </div>
              </div>
              ...
              <div class="box box-info">
                ...
                <div class="form-group">
                  <label for="roleid" class="col-sm-4 control-label">Application Fee</label>
...
<script type="text/javascript">
  ...
  $(function() {
    $("#jun_ex_dob1").dateDropdowns({
      submitFieldName: 'jun_ex_dob1',
      minAge: 18,
      maxAge: 27
    });
  ...
  $(document).ready(function() {
    ...
    if ($('#submit_date').val() == '') $('#submit_date').val("<?php echo date('Y-m-d'); ?>");
    $('.from_date').datepicker({
        format: 'yyyy-mm-dd',
        viewMode: "day",
        minViewMode: "day",
        endDate: '2022-10-31' /* today */ ,
        autoclose: true
      })
    ...
    $('#ess_degree_completion_date').datepicker({
      format: 'yyyy-mm-dd',
      viewMode: "day",
      minViewMode: "day",
      endDate: '2022-10-31',
    ...
    $('#degree_completion_date').datepicker({
      format: 'yyyy-mm-dd',
      viewMode: "day",
      minViewMode: "day",
      endDate: '2022-10-31',
    ...
    $("#preview").click(function(e) {
      e.preventDefault();
      if ($("#dob_error").text() != '') return false;
    });
    $("#jun_ex_dob1").change(function(e) {

      var sel_dob = $("#jun_ex_dob1").val();
      $("#dobtopass").val($("#jun_ex_dob1").val());
      var dojYear = 0;
      // $('#doj1').val('');
      if (sel_dob != '') {
        ...
        if (dob_arr.length == 3) {
          ...
          if (date_max > dob_date || date_min < dob_date || dob_date == new Date('1994-10-31')) {
            $("#dob_error").html('Your Age should be between 18 and 28');
            flag = 0;
            return false;
          } else {
            $("#dob_error").html('');
    ...
    if (statecode != '') {
      if (statecode == 'ASS' || statecode == 'JAM' || statecode == 'MEG') {
        //getElementById('mendatory_state').style.display = "none";
  ...
  $(function() {
    ...
    $('#new_captcha').click(function(event) {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo site_url('Careers/generate_captcha_ajax'); ?>",
        data: {
          'session_name': 'CAPTCH_JUNIOR_EXECUTIVE'
        },
        success: function(res) {
          if (res) {
            jQuery("#captcha_img").html(res);
