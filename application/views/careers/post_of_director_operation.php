...
<form class="form-horizontal" name="usersAddForm" id="usersAddForm" method="post" enctype="multipart/form-data">
	<input type="hidden" id="position_id" name="position_id" value="11">
	<div class="container">
		<section class="content-header">
			<h1 class="register">Application for the Post of Director on contract basis</h1>
		</section>
						...
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-2 example">
									<input type="hidden" id="post_of_director_operation_dob" name="dob" required value="<?php echo $dob; ?>">
									<?php
									$min_year = date('Y', strtotime("- 55 year"));
									$max_year = date('Y', strtotime("- 61 year"));
									?>
									(Not less than 55 years and not more than 61 years as on 31/01/2022)
									...
									<span id="post_of_director_operation_dob_error" class="error"></span>
								</div>
					...
					<div class="box box-info">
						...
						<div class="box-body">
							...
							<div class="box box-info">
								...
								<?php /*<div class="box-body" style="margin-bottom:10px;text-align:justify;">
							...
							<div class="box-title box-header"><strong>ESSENTIAL (Graduate with flair for Administration, HR, Accounts)</strong></div>
							<br />
							<div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">Graduation Stream <span style="color:#F00">*</span></label>
								<div class="col-sm-5">
									<input type="text" class="form-control" id="ess_course_name" name="ess_course_name" placeholder="Graduation Stream" required value="<?php echo set_value('ess_course_name'); ?>" data-parsley-maxlength="300" maxlength="300" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">

									<?php /* <select name="ess_course_name" id="ess_course_name" class="form-control" required>
										<option value="">-Select-</option>
										<option value="Graduate with flair for Administration" <?php echo  set_select('ess_course_name', 'Graduate with flair for Administration'); ?>>Graduate with flair for Administration</option>
										<option value="HR" <?php echo  set_select('ess_course_name', 'HR'); ?>>HR</option>
										<option value="Accounts" <?php echo  set_select('ess_course_name', 'Accounts'); ?>>Accounts</option>
										<option value="B. Tech (Computer Science)" <?php echo  set_select('ess_course_name', 'B. Tech (Computer Science)'); ?>>B. Tech (Computer Science)</option>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="ess_subject" name="ess_subject" placeholder="Subject" required value="<?php echo set_value('ess_subject'); ?>" data-parsley-maxlength="300" maxlength="300" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">

									<?php /* <select name="ess_subject" id="ess_subject" class="form-control" required>
										<option value="">-Select-</option>
										<option value="IT" <?php echo  set_select('ess_subject', 'IT'); ?>>IT</option>
							...
							<?php /* <div class="form-group"><?php //Aggregate Marks Obtained * ?>
              ...
              <div class="form-group"><?php //Aggregate Maximum Marks * ?>
                ...
                <div class="col-sm-5">
                  ...
                  <span class="error"></span> 
							...
							<div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">Percentage/Grade <span style="color:#F00">*</span></label>
								<div class="col-sm-5">
									<input type="text" class="form-control" id="ess_percentage" name="ess_percentage" placeholder="Percentage/Grade" value="<?php echo set_value('ess_percentage'); ?>" required>
									<span class="error"></span>
								</div>
							</div>

							<?php /* <div class="form-group"><?php //Class/Grade * ?>
                ...
                <div class="col-sm-5">
                  ...
                  <span class="error"></span> 
							...
							<div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">University/Institute</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" id="university" name="university" placeholder="University/Institute" value="<?php echo set_value('university'); ?>" data-parsley-maxlength="200" maxlength="200" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
									<span class="error"></span>
								</div>
								(Max 200 Characters)
							</div>
							...
							<div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">Percentage/Grade</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" id="percentage" name="percentage" placeholder="Percentage/Grade" value="<?php echo set_value('percentage'); ?>" data-parsley-percentage_it>
									<span class="error"></span>
								</div>
							</div>
...
<script>
	$(function() {
		$("#post_of_director_operation_dob").dateDropdowns({
			submitFieldName: 'post_of_director_operation_dob',
			minAge: 55,
			maxAge: 60
		});
	...
	$(document).ready(function() {
		...
		$("#post_of_director_operation_dob").change(function() {
			var sel_dob = $("#post_of_director_operation_dob").val();
			if (sel_dob != '') {
