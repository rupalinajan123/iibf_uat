        ...
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <div class="box-body">
             ...
             <div class="form-group">
                <label for="roleid" class="col-sm-4 control-label">Fathers/Husband Name</label>
            ...
            <div class="box-body">
             ...
             <!-- <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5"><?php echo $this->session->userdata['enduserinfo']['ess_grade_marks'];?></div>
              </div>
              <!--<div class="form-group">
