				...
				<div class="col-md-12">
						...
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<select name="position_selection" id="position_selection" class="form-control" required>
										...
										<option value="Head PDC (WZ) - MUMBAI on contract basis" <?php echo  set_select('position_selection', 'Head PDC (WZ) - MUMBAI on contract basis'); ?>>Head PDC (WZ) - MUMBAI on contract basis</option>
									</select>
							...
							<div class="form-group">
								...
								<div class="col-sm-2 example">
									...
									?>
									(Age should not be less than 55 years and Should not exceed 62 years as on 01-10-2023.)
							...
							<div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">Are you a person with Physically Disbaility? <span style="color:#F00">*</span></label>
								<div class="col-sm-3">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="tel" class="form-control" id="alternate_mobile" name="alternate_mobile" placeholder="Alternate Mobile" data-parsley-type="number"  data-parsley-minlength="10" data-parsley-maxlength="10"  value="<?php echo set_value('alternate_mobile');?>"    data-parsley-trigger-after-failure="focusout" >
								<span class="error"></span> </div>
							</div>
							<div class="form-group">
					...
					<div class="box box-info">
						...
						<div class="box-body">
							...
							<br />
							<b>Education Qualification 1 - Academic (Graduation Onward)*</b>
												<br/>
							<div class="form-group">
							...
							<b>Education Qualification 2 - Post Graduation *</b>
												<br/>
							<div class="form-group">
							...
							<b>Education Qualification 3: Additional Qualifications/Certification</b>
												<br/>
							<div class="form-group">
								...
								if(count($organization) > 0)
								{
									...
									<div id="job_dynamic_field">
										<div id="job_row<?php echo $i;?>">
											<div class="form-group">
												<label for="roleid" class="col-sm-4 control-label">Name of the Organization/Employeer/Bank <span style="color:#F00">*</span></label>
												<div class="col-sm-5">
													<input type="text" class="form-control" id="organization" name="organization[]" placeholder="Name of the Organization/Employeer/Bank"  value="<?php echo $organization_val; //set_value('organization');?>"  data-parsley-maxlength="30" maxlength="30" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/" required>
												<span class="error"> </span> </div>
											(Max 30 Characters)</div>
								...
								<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="form-group">
											...
											&nbsp;I further certify that no disciplinary / vigilance proceedings are either pending or contemplated against me and that there are no legal cases pending against me. There have been no major / minor penalty  <span class="error"></span> </div>
										</div>
						...
						<div class="box box-info">
							<div class="form-group m_t_15">
								...
								<div class="col-sm-3">
									<div id="captcha_img"><?php echo $captcha_for_head_pdc_nz; //$image;?></div>
									<span class="error">
...
<script>
	...
	function refresh_captcha_img()
  {
    ...
    $.ajax(
    {
      ...
      data: { 'session_name':'CAPTCH_HEAD_PDC_NZ' },
