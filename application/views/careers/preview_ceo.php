          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="roleid" class="col-sm-4 control-label">Percentage Obtained </label>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5" style="word-wrap: break-word;"> <?php echo strtoupper($this->session->userdata['enduserinfo']['whether_in_service']); ?> </div>
                </div>
                ...
                ?>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-5" style="word-wrap: break-word;">
                      <?php echo isset($this->session->userdata['enduserinfo']['vrs_register_date']) ? $this->session->userdata['enduserinfo']['vrs_register_date'] : ''; ?>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <label for="roleid" class="col-sm-4 control-label">Reason for Resignation/Leaving</label>
                    <div class="col-sm-5" style="word-wrap: break-word;">
                      <?php echo isset($this->session->userdata['enduserinfo']['reason_of_resign']) ? $this->session->userdata['enduserinfo']['reason_of_resign'] : ''; ?>
                    </div>
                  </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5" style="word-wrap: break-word;"> <?php echo $this->session->userdata['enduserinfo']['area_of_specialisation']; ?> </div>
                </div>
                ...
                <div class="form-group">
                  <label for="roleid" class="col-sm-4 control-label">2. Why do you consider yourself suitable for the post of CEO of this Institute</label>
                  <div class="col-sm-6" style="word-wrap: break-word;">
                    <?php
