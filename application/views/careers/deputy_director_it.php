...
<form class="form-horizontal" name="usersAddForm" id="usersAddForm"  method="post"  enctype="multipart/form-data">
  <input type="hidden" id="position_id" name="position_id" value="9">
  <div class="container">
		<section class="content-header">
			<h1 class="register">Application for the post of Deputy Director (IT)</h1>
		</section>
						...
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-2 example">
									<input type="hidden" id="deputy_director_it_dob" name="dob" required value="<?php echo $dob;?>">
									<?php 
										$min_year = date('Y', strtotime("- 18 year"));
										$max_year = date('Y', strtotime("- 45 year")); 
									?>
									(Age of the applicant should not be above 45 years as on 31/01/2022)
								...
								<span id="deputy_director_it_dob_error" class="error"></span> </div>
	...
	<script>
		...
		$(function() {
		$("#deputy_director_it_dob").dateDropdowns({
		submitFieldName: 'deputy_director_it_dob',
		minAge: 21,
		maxAge:44
		});
		...
		$("#deputy_director_it_dob").change(function(){
		var sel_dob = $("#deputy_director_it_dob").val();
		if(sel_dob!='')
		{
