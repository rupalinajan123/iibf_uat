    ...
    <div class="col-md-12">
      <div class="box box-info">
        ...
        <div class="box-body">
          ...
          <div class="form-group">
            <label for="roleid" class="col-sm-4 control-label">Father's/Spouse's Name</label>
        ...
        <div class="box-body">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6"><?php echo $this->session->userdata['enduserinfo']['deputy_subject'];?> </div>
            </div> */ ?>
            <?php /* <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6"><?php echo $this->session->userdata['enduserinfo']['specialisation'];?> </div>
            </div>
            <div class="form-group">
              <label for="roleid" class="col-sm-4 control-label">College Name and Address </label>
            ...
            <?php
			  ...
			  <?php /* <div class="form-group">
              <label for="roleid" class="col-sm-4 control-label">Experience as Faculty experience in Banks / Financial Institutions</label>
