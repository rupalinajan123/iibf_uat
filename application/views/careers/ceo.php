                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="firstname" name="firstname" placeholder="First Name" required
                                        value="<?php echo set_value('firstname'); ?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" maxlength="30" data-parsley-trigger="change keyup">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="middlename" name="middlename" placeholder="Middle Name" value="<?php echo set_value('middlename'); ?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" maxlength="30" data-parsley-trigger="change keyup">
                                    <span class="error"></span>
                                </div>
                                (Max 30 Characters)
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="lastname" name="lastname" placeholder="Last Name" value="<?php echo set_value('lastname'); ?>" required data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" maxlength="30" data-parsley-trigger="change keyup">
                                    <span class="error"> </span>
                                </div>
                                (Max 30 Characters)
                            </div>
                            ...
                            <div class="form-group">
                                <label for="roleid" class="col-sm-4 control-label">Aadhaar Card Number<span style="color:#F00">*</span></label>
                                <div class="col-sm-5">
                                    <input required type="text" class="form-control" id="aadhar_card_no" name="aadhar_card_no" placeholder="Aadhaar Card Number"
                    ...
                    <div class="box box-info">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="addressline1" name="addressline1" placeholder="Address Line 1" value="<?php echo set_value('addressline1'); ?>" data-parsley-maxlength="30" maxlength="30" required>
                                    <span class="error"> </span>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="addressline2" name="addressline2" placeholder="Address Line 2" value="<?php echo set_value('addressline2'); ?>" data-parsley-maxlength="30" maxlength="30" required>
                                    <span class="error"> </span>
                                </div>
                                (Max 30 Characters)
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="addressline3" name="addressline3" placeholder="Address Line 3" value="<?php echo set_value('addressline3'); ?>" data-parsley-maxlength="30" maxlength="30" >
                                    <span class="error"> </span>
                                </div>
                                (Max 30 Characters)
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="addressline4" name="addressline4" placeholder="Address Line 4" value="<?php echo set_value('addressline4'); ?>" data-parsley-maxlength="30" maxlength="30">
                                    <span class="error"> </span>
                                </div>
                                (Max 30 Characters)
                            </div>
                            ...
                            <div class="form-group">
                                <label for="roleid" class="col-sm-4 control-label">Address line 1 <span style="color:#F00">*</span></label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="addressline1_pr" name="addressline1_pr" placeholder="Address line 1" value="<?php echo set_value('addressline1_pr'); ?>" data-parsley-maxlength="30" maxlength="30" required>
                                    <span class="error"></span>
                                </div>
                                (Max 30 Characters)
                            </div>
                            <div class="form-group">
                                <label for="roleid" class="col-sm-4 control-label">Address line 2 <span style="color:#F00">*</span></label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="addressline2_pr" name="addressline2_pr" placeholder="Address line 2" value="<?php echo set_value('addressline2_pr'); ?>" data-parsley-maxlength="30" maxlength="30" required>
                                    <span class="error"> </span>
                                </div>
                                (Max 30 Characters)
                            </div>
                            <div class="form-group">
                                <label for="roleid" class="col-sm-4 control-label">Address line 3</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="addressline3_pr" name="addressline3_pr" placeholder="Address line 3" value="<?php echo set_value('addressline3_pr'); ?>" data-parsley-maxlength="30" maxlength="30">
                                    <span class="error"> </span>
                                </div>
                                (Max 30 Characters)
                            </div>
                            <div class="form-group">
                                <label for="roleid" class="col-sm-4 control-label">Address line 4</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="addressline4_pr" name="addressline4_pr" placeholder="Address line 4" value="<?php echo set_value('addressline4_pr'); ?>" data-parsley-maxlength="30" maxlength="30">
                                    <span class="error"> </span>
                                </div>
                                (Max 30 Characters)
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="post_qua_name" name="post_qua_name" required placeholder="Qualification" value="<?php echo set_value('post_qua_name'); ?>" data-parsley-maxlength="30" maxlength="30">
                                    <!-- data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/" -->
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="post_gra_sub" required name="post_gra_sub" placeholder="Post Graduation Subject" value="<?php echo set_value('post_gra_sub'); ?>" data-parsley-maxlength="30" maxlength="30" >
                                    <span class="error"></span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="roleid" class="col-sm-4 control-label">College/Institution <span style="color:#F00">*</span></label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="post_gra_college_name" name="post_gra_college_name" placeholder="College/Institution" value="<?php echo set_value('post_gra_college_name'); ?>" data-parsley-maxlength="30" maxlength="30" required>
                                    <span class="error"></span>
                                </div>
                                (Max 30 Characters)
                            </div>
                            <div class="form-group">
                                <label for="roleid" class="col-sm-4 control-label">University <span style="color:#F00">*</span></label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="post_gra_university" name="post_gra_university" placeholder="University" value="<?php echo set_value('post_gra_university'); ?>" data-parsley-maxlength="30" maxlength="30" required>
                                    <span class="error"></span>
                                </div>
                                (Max 30 Characters)
                            </div>
                            ...
                            <div id="eduqual_dynamic_field">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" id="cer_qua_name" name="cer_qua_name[]" placeholder="Qualification" value="" data-parsley-maxlength="50" maxlength="50">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" id="cer_gra_sub" name="cer_gra_sub[]" placeholder="Name of the Subject" value="" data-parsley-maxlength="30" maxlength="30" >
                                        <span class="error"></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" id="cer_college_name" name="cer_college_name[]" placeholder="College/Institution" value="" data-parsley-maxlength="30" maxlength="30">
                                        <span class="error"></span>
                                    </div>
                                    (Max 30 Characters)
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" id="cer_university" name="cer_university[]" placeholder="University" value="" data-parsley-maxlength="30" maxlength="30">
                                        <span class="error"></span>
                                    </div>
                                    (Max 30 Characters)
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="col-sm-3 date">
                                            <input type="text" class="form-control qualification-from-date" id="cer_from_date" name="cer_from_date[]" placeholder="From Date" value="" readonly>
                                        </div>
                                        <div class="col-sm-3 date">
                                            <input type="text" class="form-control qualification-to-date" id="cer_to_date" name="cer_to_date[]" placeholder="To Date" value="" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group"><?php //Percentage  * 
                                    ...
                                    <div class="col-sm-5">
                                        <input type="number" class="form-control" id="cer_percentage" name="cer_percentage[]" placeholder="Percentage Obtained" value="" data-parsley-maxlength="20" step="0.01" data-parsley-type="number" max="100">
                                        <span class="error"></span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <input type="text" class="form-control" id="cer_class" name="cer_class[]" placeholder="Class/Grade" value="" data-parsley-maxlength="50" maxlength="50" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/" >
                                    </div>
                                </div>
                                <hr class="co-md-12">
                            </div>
                            ...
                            <input type="hidden" name="eduqual_add" id="eduqual_add" value="1">
                            <!-- <div class="box-title box-header"><strong>Area of Specialisation</strong> </div>
                            <br />


                            <div class="form-group">
                                <label for="roleid" class="col-sm-4 control-label">Area of Specialisation<span style="color:#F00">*</span></label>
                                <div class="col-sm-6">
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="area_of_specialization" name="area_of_specialization" placeholder="Area of Specialisation" required value="<?php echo set_value('area_of_specialization'); ?>">
                                    </div>
                                </div>
                            </div> -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="name_subject_of_course" name="name_subject_of_course" placeholder="Specialisation" value="<?php echo set_value('name_subject_of_course'); ?>" data-parsley-maxlength="200" maxlength="200" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/">
                                    <span class="error"></span>
                                </div>
                            </div>
                            ...
                            <div class="form-group any_other_details_div">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="any_other_details" name="any_other_details" placeholder="Responsibilities" value="<?php echo set_value('any_other_details'); ?>" data-parsley-maxlength="100" maxlength="100" required data-parsley-trigger="change keyup">
                                    <span class="error"> </span>
                                </div>
                                (Max 300 Characters)
                            </div>
...
<hr class="co-md-12"> -->
                            ...
                            <div id="add_fac_exp_dynamic_field">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <textarea rows="4" cols="50" class="form-control" id="exp_in_bank" name="exp_in_bank[]" placeholder="Experience as Faculty" data-parsley-maxlength="1000" maxlength="1000" data-parsley-trigger="change keyup" ></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="col-sm-3 date">
                                            <input type="text" class="form-control exp_faculty_from_date" id="exp_faculty_from_date" name="exp_faculty_from_date[]" placeholder="From Date" value="" readonly>
                                        </div>

                                        <div class="col-sm-3 date">
                                            <input type="text" class="form-control exp_faculty_to_date" id="exp_faculty_to_date" name="exp_faculty_to_date[]" placeholder="To Date" value="" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <textarea rows="4" cols="50" class="form-control" id="subject_handled" name="subject_handled[]" placeholder="Subjects Handled" data-parsley-maxlength="500" maxlength="500" data-parsley-trigger="change keyup" ></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" id="exp_in_functional_area" name="exp_in_functional_area[]" placeholder="Area of Specialisation" value="">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <textarea rows="4" cols="50" class="form-control" id="professional_ass" name="professional_ass[]" placeholder="Membership of Professional Associations" data-parsley-maxlength="500" maxlength="500" data-parsley-pattern="/^[a-zA-Z-0-9 , / ]+$/" data-parsley-maxlength="500" maxlength="500" data-parsley-trigger="change keyup"  ></textarea>
                                    </div>(Max 500 Characters)
                                </div>
                                <hr class="co-md-12">
                            </div>    
                            ...
                            <div class="form-group">
                                <label for="roleid" class="col-sm-4 control-label">Area of Specialisation</label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="area_of_specialization" name="area_of_specialization" placeholder="Area of Specialisation" value="<?php echo set_value('area_of_specialization'); ?>" data-parsley-maxlength="1000" maxlength="1000" data-parsley-pattern="/^[a-zA-Z-0-9/ , ]+$/">
                                    <span class="error"></span>
                                </div>
                                (Max 1000 Characters)
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <textarea rows="4" cols="50" class="form-control" id="earliest_date_of_joining" name="earliest_date_of_joining" required placeholder="Earliest date of joining if selected" data-parsley-maxlength="500" maxlength="100" data-parsley-trigger="change keyup"><?php echo set_value('earliest_date_of_joining'); ?></textarea>
                                    <span class="error"> </span>
                                </div>
                                (Max 100 Characters)
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <textarea rows="4" cols="50" class="form-control" id="comment" name="comment" placeholder="Any other information that the candidate would like to add" data-parsley-maxlength="4000" maxlength="4000" ><?php echo set_value('comment'); ?></textarea>
                                    <span class="error"> </span>
                                </div>
                                (Max 4000 Characters)
                            </div>
...
today.setHours(0, 0, 0, 0); 
    ...
    $('.org_from_date').datepicker({
        format: 'yyyy-mm-dd',
        endDate: today,
        autoclose: true,
        forceParse: true
    }).on('changeDate', function() {
        var $currentGroup = $(this).closest('.form-group'); // Find the specific row
        $currentGroup.find('.org_to_date').datepicker('setStartDate', new Date($(this).val()));
    });    

    $('.org_to_date').datepicker({
        format: 'yyyy-mm-dd',
        endDate: today,
        autoclose: true,
        forceParse: true
        ...
        var $currentGroup = $(this).closest('.form-group'); // Find the specific row
        $currentGroup.find('.org_from_date').datepicker('setEndDate', new Date($(this).val()));
    });
    
    $(document).on("click", "#orgnsn_add", function() {
        $('.org_from_date').last().datepicker({ 
            format: 'yyyy-mm-dd',
            endDate: today,
            autoclose: true,
            forceParse: true
    ...
    $('.exp_from_date').datepicker({
        ...
        var $currentGroup = $(this).closest('.form-group'); // Find the specific row
        $currentGroup.find('.exp_to_date').datepicker('setStartDate', new Date($(this).val()));
    });    
    ...
    $('.exp_to_date').datepicker({
        ...
        var $currentGroup = $(this).closest('.form-group'); // Find the specific row
        $currentGroup.find('.exp_from_date').datepicker('setEndDate', new Date($(this).val()));
    });
    
    $(document).on("click", "#faculty_exp_add", function() {
        $('.exp_from_date').last().datepicker({ 
            format: 'yyyy-mm-dd',
            endDate: today,
            autoclose: true,
            forceParse: true
    ...
    $('.exp_faculty_from_date').datepicker({
        ...
        var $currentGroup = $(this).closest('.form-group'); // Find the specific row
        $currentGroup.find('.exp_faculty_to_date').datepicker('setStartDate', new Date($(this).val()));
    });    
    ...
    $('.exp_faculty_to_date').datepicker({
        ...
        var $currentGroup = $(this).closest('.form-group'); // Find the specific row
        $currentGroup.find('.exp_faculty_from_date').datepicker('setEndDate', new Date($(this).val()));
    });

    
    $(document).on("click", "#add_fac_exp_add", function() {
        $('.exp_faculty_from_date').last().datepicker({ 
            format: 'yyyy-mm-dd',
            endDate: today,
            autoclose: true,
            forceParse: true
    ...
    $(document).on("click", "#add_fac_exp_add", function() {
        $('.exp_faculty_to_date').last().datepicker({
            format: 'yyyy-mm-dd',
            endDate: today,
            autoclose: true,
            forceParse: true
...
<script>
    ...
    $(document).ready(function() {
        ...
        function toggleSpouseField() {
            ...
            var requiredStatuses = ['Married', 'Widowed'];
