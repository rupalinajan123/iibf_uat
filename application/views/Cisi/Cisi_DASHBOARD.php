				...
				<div class="col-md-12">
					...
					<div class="box box-info">
						<div class="box-header with-border">
							<h3 class="box-title">Candidate Details <span style="margin-left:125px;">Registration for CISI examination (Level - II)</span></h3>
						</div>
						...
						<table class="table table-bordered">
							...
							<tr>
								...
								<td>
								<a href="<?php echo base_url().'Cisi/sbi_make_payment/'; ?>" onclick="return confirm('Are you sure to proceed for payment?')">
									Payment
								</a>
								</td>
							</tr>
