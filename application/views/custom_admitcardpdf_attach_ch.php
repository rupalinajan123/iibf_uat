                      ...
                      <tr>
                        ...
                        <td align="center">
                          <table cellpadding="0" cellspacing="0" border="0">
                            <tr>
                              <td>
                               <!-- <img src="https://iibf.esdsconnect.com/uploads/photograph/p_510341214.jpg" width="100" height="125" />-->
                                <img src="<?php echo $scannedphoto; ?>" width="100" height="125" />
                              </td>
                              </tr> 	
                              <tr> 
                                 <td height="5"></td>
                            ...
                            <tr>
                              <td>
                                <!--<img src="https://iibf.esdsconnect.com/uploads/scansignature/s_510341214.jpg" width="100" height="50" />-->
                                <img src="<?php echo $scannedsignaturephoto; ?>" width="100" height="50" />
                              </td>
                            </tr>
                          </table><!--table-4-->
                        </td>
...
<?php if($exam_code !=34 && $exam_code !=160 && $exam_code !=58 && $exam_code !=81 && $exam_code !=340 && $exam_code !=580 && $exam_code !=20 && $exam_code !=1600){?>
...
<?php if($exam_code == 34 || $exam_code == 58 || $exam_code == 160){?>

<table cellpadding="0" cellspacing="0" width="800" border="0" align="center" style="background-color:#fff;">
	<tr>
           <td style="background-color:#7fd1ea; color:#fff; text-align:center; font-weight:bold; font-size:13px; padding:7px 0; text-transform:uppercase;">IMPORTANT RULES/INSTRUCTIONS FOR CANDIDATES</td>
    </tr>
  <tr>
    <td style="background-color:#dcf1fc; padding:7px 0; border:1px solid #1287c0;">
      <table cellpadding="0" cellspacing="0" border="0">
...
<?php }?>
<?php if($exam_code == 340 || $exam_code == 580 || $exam_code == 20 || $exam_code == 81 || $exam_code == 810){?>
...
<table cellpadding="0" cellspacing="0" width="800" border="0" align="center" style="background-color:#fff;">
  ...
  <tr>
    ...
    <td >5.00</td>
              ...
              <tr>
                <td width="2%" valign="top" style="font-size:13px;">a.</td>
                <td style="font-size:13px;">Candidates are advised to report to the Examination Venue as per the timing mentioned above. No candidate/s will be permitted to enter the Examination Venue/hall after the gate closing time for any reason whatsoever. Institute has instructed the examination conducting authorities of all the venues to strictly follow the timelines (CANDIDATE PLEASE NOTE).</strong></td>
              </tr>
              <tr>
                <td width="2%" valign="top" style="font-size:13px;">b.</td>
                <td style="font-size:13px;"><strong>No candidate will be permitted to leave the hall in the first 60 minutes from the scheduled start time of the examination.</strong> </td>
