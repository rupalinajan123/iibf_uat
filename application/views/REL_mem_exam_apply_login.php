    ...
    <tr>
      ...
      <td valign="top"><p align="center">120</p></td>
       <td valign="top"><p align="center">SURAT</p></td>
        ...
        <?php
        	$exarr = array($this->config->item('examCodeCaiib'),62,63,64,65,66,67,$this->config->item('examCodeCaiibElective68'),$this->config->item('examCodeCaiibElective69'),$this->config->item('examCodeCaiibElective70'),$this->config->item('examCodeCaiibElective71'),72);
			 if(in_array(base64_decode($this->input->get('ExId')),$exarr)){
		?>	
        <ul>
