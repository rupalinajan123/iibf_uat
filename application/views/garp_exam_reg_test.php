...
if ($this->session->flashdata('error') != '') {?>
        ...
        <?php } ?>
        <form name="getDetailsForm" autocomplete="off" id="getDetailsForm" method="post" action="<?php echo base_url(); ?>Garp_exam_test">
          <br />
          <?php
...
?>" <?php if (isset($row['regnumber'])) { echo "readonly='readonly'";} elseif (set_value('regnumber')) { echo "readonly='readonly'"; } ?> style="border-color:#000;" title="Membership No.">
        ...
        ?>
              <a href="<?php echo base_url();?>garp_exam_test" class="btn btn-info" id="modify" style="height: 32px; width: 150px">Modify</a>
