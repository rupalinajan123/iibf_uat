...
<form class="form-horizontal" name="XLRIForm" id="XLRIForm"  method="post"  enctype="multipart/form-data">
	<div class="container">
		<section class="content-header">
			<h1 class="register">XLRI  Candidate Details</h1><br/>
		</section>
		<span class="error">
					...
					<div class="box box-info">
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-5">
									<img src="<?php echo base_url().'uploads/XLRI/photograph/'.$aCandidate[0]['photograph']; ?>" height="100" width="100"/>
								</div>
							</div>
						</div>
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-5">
									<img src="<?php echo base_url().'uploads/XLRI/idproof/'.$aCandidate[0]['idproof']; ?>" height="100" width="100"/>
								</div>
							</div>
						</div>
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-5">
									<img src="<?php echo base_url().'uploads/XLRI/signature/'.$aCandidate[0]['signature']; ?>" height="100" width="100"/>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-12">
									...
									<input type="radio" id="payment" name="payment" required value="second" checked >Second Installment (<?php echo $this->config->item('XLRI_second_cs_total'); ?>/-) 
									<table border="2" style="width:100%">
									<!--<tr><th>Rs.118000/- in one lump sum</th></tr>-->
									<tr>
									<!--<td>course fee</td>-->
									<td>Fee - <?php echo $this->config->item('XLRI_second_course_fee'); ?>/-</td>
									<td>GST - <?php echo $this->config->item('XLRI_second_GST_amt'); ?>/-</td>
									<td>Total - <?php echo $this->config->item('XLRI_second_cs_total'); ?>/-</td>
									</tr>
									</table>
									<?php }elseif($aCandidate[0]['payment']=='second'){ ?>
									<input type="radio" id="payment" name="payment" required value="third" checked >Third Installment (<?php echo $this->config->item('XLRI_third_cs_total'); ?>/-) 
									<table border="2" style="width:100%">
									<!--<tr><th>Rs.118000/- in one lump sum</th></tr>-->
									<tr>
									<!--<td>course fee</td>-->
									<td>Fee - <?php echo $this->config->item('XLRI_third_course_fee'); ?>/-</td>
									<td>GST - <?php echo $this->config->item('XLRI_third_GST_amt'); ?>/-</td>
									<td>Total - <?php echo $this->config->item('XLRI_third_cs_total'); ?>/-</td>
									</tr>
									</table>
									<?php }else{ ?>
									Full Paid
...
<script src="<?php echo base_url();?>js/XLRI_validation.js"></script>