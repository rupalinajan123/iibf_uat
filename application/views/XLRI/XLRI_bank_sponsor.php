...
?>
<form class="form-horizontal" name="XLRIForm" id="XLRIForm"  method="post"  enctype="multipart/form-data" >
<!-- data-parsley-validate="parsley"-->
	<div class="container">
		<section class="content-header">
			<h1 class="register">LEADERSHIP DEVELOPMENT PROGRAMME FOR BANKS/FIs IIBF -XLRI October 2021
					...
					<div class="box box-info">
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="work_experiance" name="work_experiance" value="<?php echo set_value('work_experiance');?>" data-parsley-type="number" data-parsley-minlength="2" data-parsley-maxlength="3"  maxlength="3" minlength="2" >
