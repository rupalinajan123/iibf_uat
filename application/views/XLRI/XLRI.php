...
<form class="form-horizontal" name="XLRIForm" id="ampForm"  method="post"  enctype="multipart/form-data" data-parsley-validate="parsley">
  <div class="container">
    <section class="content-header">
      <h1 class="register">XLRI Form</h1><br/>
    </section>
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="work_experiance" name="work_experiance" value="<?php echo set_value('work_experiance');?>" data-parsley-type="number" data-parsley-maxlength="3"  maxlength="3" >
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="radio" id="payment" name="payment" required value="full" <?php if(isset($_POST['payment']) && $_POST['payment'] == 'full'){ echo 'checked'; } ?> >Full payment <?php echo $this->config->item('amp_full_cs_total'); ?>/-
                
                  <?php if($sponsor!="Bank"){ ?>
                  <input type="radio" id="payment" name="payment" required value="first" <?php if(isset($_POST['payment']) && $_POST['payment'] == 'first'){ echo 'checked'; } ?> >1st Installment <?php echo $this->config->item('amp_first_cs_total'); ?>/-
                  <?php } ?>
                </div>
              </div>
              <!--<div class="form-group">-->
