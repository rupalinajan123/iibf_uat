...
?>
<form class="form-horizontal" name="XLRIForm" id="ampForm"  method="post"  enctype="multipart/form-data" data-parsley-validate="parsley">
  <div class="container">
    <section class="content-header">
      <h1 class="register">LEADERSHIP DEVELOPMENT PROGRAMME FOR BANKS/FIs IIBF -XLRI October 2021<br>
        ...
        <div class="col-md-12">
            ...
            <div class="form-group">
                <label for="roleid" class="col-sm-4 control-label">State<span style="color:#F00">*</span></label>
                  ...
                  <input hidden="statepincode" id="statepincode" value="">
                   ...
                   <div class="col-sm-3">
                    <input type="text" class="form-control" id="pincode_address" name="pincode_address" placeholder="Pincode/Zipcode" required value="<?php echo set_value('pincode');?>"  data-parsley-maxlength="6" maxlength="6" size="6" data-parsley-checkpin data-parsley-type="number" data-parsley-trigger-after-failure="focusout"  > (Max 6 digits)
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" required class="form-control" id="name_employer" name="name_employer" value="<?php echo set_value('name_employer');?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" maxlength="30" >
                </div>
              </div>
            </div>
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="work_experiance" name="work_experiance" value="<?php echo set_value('work_experiance');?>" data-parsley-type="number" data-parsley-maxlength="3"  maxlength="3" data-parsley-minlength="2"  minlength="2">
                </div>(More than 5 years experience required)
              </div>
            </div>
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="radio" id="payment" name="payment" required value="full" <?php if(isset($_POST['payment']) && $_POST['payment'] == 'full'){ echo 'checked'; } ?> >Full payment <?php echo $this->config->item('XLRI_full_cs_total'); ?>/- (Including GST)
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              <div class="form-group">                
                <div class="col-sm-12">
                  1. I hereby declare that all the information given in this application is true, complete and correct. I understand that in the event of any information being found false or incorrect, my enrollment in XLRI is liable to be cancelled/ terminated.
                </div>
                <div class="col-sm-12">
                ...
                <div class="col-sm-12">
                  3. If your application rejected by the Institute for enrolment in XLRI then fee will be refunded.
                </div>
                <div class="col-sm-12">
                  4. I understand that IIBF reserves the right to accept or reject my enrolment in XLRI without assigning any reason what so ever. 
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="box box-info">
            <div class="form-group">                
              ...
              <div class="col-sm-4">
                <input type="hidden" name="form_type" value="XLRI_form" />
