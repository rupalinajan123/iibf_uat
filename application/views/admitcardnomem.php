              ...
              <table cellpadding="0" cellspacing="0" width="100%" border="0" align="center">
                ...
                <tr>
                  ...
                  <?php
					...
					?>
                  <div align="right">
                  <?php if($this->session->userdata('nmregnumber')!=''){?>
                  	<a href="<?php echo base_url();?>NonMember/dashboard/">Home</a> &nbsp;
                   <?php }?>
                   <?php if($this->session->userdata('dbregnumber')!=''){?>
                   <a href="<?php echo base_url();?>Dbf/dashboard/">Home</a> &nbsp;
                   <?php }?>
                  	<a href="<?php echo base_url();?>admitcard/getadmitcardpdfnomem/<?php echo base64_encode($exam_code)?>" style="color:#F00">Save as pdf</a>&nbsp;
                ...
                <tr>
                        ...
                        <td align="center">
						  ...
						  ?>
                            <tr>
                              <td>
                              	<?php if($this->session->userdata('nmregnumber')!=''){?>
                                <img src="<?php echo base_url();?><?php echo get_img_name($this->session->userdata('nmregnumber'),'p');?>" width="100" height="125" />
                                <?php }?>
                                <?php if($this->session->userdata('dbregnumber')!=''){?>
                                <img src="<?php echo base_url();?><?php echo get_img_name($this->session->userdata('dbregnumber'),'p');?>" width="100" height="125" />
                                <?php }?>
                              </td>
                              </tr>
                              <tr>
                  <td height="5"></td>
                              ...
                              <td>
                              <?php if($this->session->userdata('nmregnumber')!=''){?>
                                <img src="<?php echo base_url();?><?php echo get_img_name($this->session->userdata('nmregnumber'),'s');?>" width="100" height="50" />
                                <?php }?>
                                
                                <?php if($this->session->userdata('dbregnumber')!=''){?>
                                <img src="<?php echo base_url();?><?php echo get_img_name($this->session->userdata('dbregnumber'),'s');?>" width="100" height="50" />
                                <?php }?>
                              </td>
                            </tr>
                          </table><!--table-4-->
