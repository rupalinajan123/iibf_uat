         ...
         <tr>
           <td>
             <table border="0" cellpadding="0" cellspacing="0" width="80%" align="center">
               <tr>
                 <td style="text-align:center; padding:60px 0 25px; font-size:22px; font-family:Tahoma, Geneva, sans-serif; font-weight:bold; line-height:32px;">Results for JAIIB/DB&amp;F</td>
               </tr>
               <tr>
                <td bgcolor="#6699CC">
                    ...
                    <tr>
                      ...
                      <td class="content" width="55%" bgcolor="#d8e4f1">
                        <select name="exam" id="exam" class="text1" style="min-width:218px;">
                          ...
                          <option value="<?php echo $this->config->item('examCodeJaiib') ?>">JAIIB</option>
                          <option value="<?php echo $this->config->item('examCodeDBF'); ?>">DIPLOMA IN BANKING &amp; FINANCE</option>
                          <option value="<?php echo $this->config->item('examCodeSOB'); ?>">Specialist Officers of Banks</option>
                        </select>
                      </td>
                    </tr>
                    <tr>
