                                  ...
                                  <tr>
                                    ...
                                    <td class="content" width="55%" bgcolor="#d8e4f1">
                                      <select name="exam" id="exam" class="text1" style="min-width:218px;">
                                        ...
                                        <option value="1027">CERTIFICATE EXAM ON KYC-AML & COMPLIANCE FOR EMPLOYEES OF UCO BANK</option>
                                        <option value="1026">CASH & CURRENCY CHEST MANAGEMENT</option> <!-- ADDED BY POOJA MANE :23-10-2023 -->
                           <!-- <option value="1028">CERTIFICATE EXAMINATION ON AUDITING</option> -->
                             <option value="1029">Certificate in Ethics and Ethical Mindset</option>
                                        <option value="1030">CERTIFICATE EXAM ON AML-KYC & COMPLIANCE FOR EMPLOYEES OF INDIAN BANK</option>
                                        <option value="1033">Certificate on AML/KYC & Compliance in Banks</option>
                                        <option value="1034">Certificate on Compliance for employees of Indian Overseas Bank</option>
                                        <option value="1037">CERTIFICATE EXAMINATION FOR BUSINESS CORRESPONDENTS / FACILITATORS (ADVANCED)</option>
                                        <option value="1038">CERTIFICATE EXAMINATION FOR BUSINESS CORRESPONDENTS / FACILITATORS (BASIC)</option>
                                      </select>
                                    </td>
                                  </tr>
                                  <tr> 
