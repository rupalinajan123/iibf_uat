...
<html lang="en">
			...
			<tr>
				<td style="background-color:#fff;">
					...
					<table cellpadding="0" cellspacing="0" width="100%" border="0" align="center">
								...
								<table cellpadding="0" cellspacing="0" width="100%" border="0" align="center">
									...
									<tr>
										<td style="background-color:#1287c0; color:#fff; text-align:center; font-weight:bold; font-size:14px; padding:10px 0;">
											<?php
                      $dipcert = array(8,11,18,19,24,25,26,78,79,151,153,156,158,162,163,165,166,$this->config->item('examCodeSOB'));
                      ...
                      {												
                        ...
                        { ?>
                          ...
                          <?php if($exam_code != 101 && $exam_code != 991 && $exam_code != 997 && $exam_code != 1052 && $exam_code != 1054 && $exam_code != 1053){ echo "Examination"; }?>
                          - 
                          <?php echo $examdate;?>
                        <?php } 
                      }
                      ...
                      {
                        echo "Admit letter for Online CAIIB Examination – Jan 2025";
                        //echo "Admit Letters for CAIIB - August 2024";
                      }
                      if(in_array($exam_code,$elective))
                      {
                        echo "Admit letter for Online CAIIB Electives - Jan 2025";
                      }
                      ...
                      <?php } ?>
																...
																<td>
																	<table>
																		<tr>
																			...
																			<td> <?php
                                          if(in_array($exam_code,$caiib) || in_array($exam_code,$jaiibarr)) {
                                        ?>
                                        <div style="border:1px solid black;padding:10px;">
                                          <b>Medium : </b><?php echo $medium;?><br><br>
                                          <b>Center : </b><?php echo $center;?>
                                          </div>
                                        <?php } ?></td>
																		</tr>
																	</table>
                            ...
                            <?php } ?>
														...
														<?php if($exam_code == $this->config->item('examCodeCaiib') || $exam_code == $this->config->item('examCodeJaiib') || $exam_code == $this->config->item('examCodeDBF') || $exam_code == $this->config->item('examCodeSOB') || in_array($exam_code,$caiib) ){
									...
									<tr>
										<td style="text-align:right; line-height:24px; font-size:13px;">
											<?php if($exam_code!=34 && $exam_code!=160 && $exam_code!=58 && $exam_code!=101){?>
												...
												<?php } ?>
												@ No candidate/s will be permitted to enter the Exam Venue/Hall later than the time mentioned above for any reason whatsoever.” 
												<?php
													if($exam_code != $this->config->item('examCodeCaiib') && !in_array($exam_code,$elective)) {   //priyanka d - 20-feb-23
													?>
													Below the exam time/reporting time table
												<?php } ?>
											<?php }?>
										</td>
									</tr>
                    ...
                    <td height="10" style="color:red;"><strong>#Candidates are advised to check Institute's Website, a day before the Examination Date, for any Information/Notice or Change in Examination Venue.</strong></td>
									...
									<tr>
										<td>
											<?php if($vcenter == 3){ if($exam_code == 991 || $exam_code == 1052 || $exam_code == 1054){ ?>
												<p><strong>In case of any technical issues, please dial +91 9582597373 (available on exam day and previous day only). For all other queries email to iibfexam@cscacademy.org
												</strong></p>
												...
												<p><strong>
													...
													In case of any Technical Issue/Problem please dial +91 9582597373 Ext. 662  (available on exam day and the previous day only). for all other queries email to ippbexam@cscacademy.org.
													<?php } ?>
												</strong></p>
												<?php }else{
												?>
												<p><strong>In case of any queries regarding venue, please dial 1800 419 2929 (available on exam day and previous day only). For all other queries email to care@iibf.org.in
												</strong></p>     
											<?php } }?>
											<?php if($vcenter == 4){ if($exam_code == 991 || $exam_code == 1052 || $exam_code == 1054){ ?>
												<p><strong>In case of any technical issues, please dial +91 9582597373 (available on exam day and previous day only). For all other queries email to iibfexam@cscacademy.org
												</strong></p>
												<?php }else if($exam_code == 997 || $exam_code == 1053){ ?>
												<p><strong>
											...
											<?php } }?>
											<?php if($vcenter == 1){
												if($exam_code == 991 || $exam_code == 1052 || $exam_code == 1054){ ?>
												<p><strong>In case of any technical issues, please dial +91 9582597373 (available on exam day and previous day only). For all other queries email to iibfexam@cscacademy.org
												</strong></p>
												<?php  }else if($exam_code == 997 || $exam_code == 1053){ ?>
												<p><strong>
												...
												<?php  }else{ ?>
												<p>
													<strong>In case of any queries regarding venue, please dial 011-35454694 and press option 7.(available on exam day and previous day only). For all other queries email to care@iibf.org.in</strong>
												</p>
											<?php } } ?>
											...
											<?php }?><?php */?>
											<?php if($exam_code == 991 || $exam_code == 1052 || $exam_code == 1054){ ?>
    ...
    <?php if($exam_code != $this->config->item('examCodeCaiib') ) { ?>
			<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
			<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
			<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
			<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
    ...
    {
      if($exam_code == $this->config->item('examCodeCaiib') || $exam_code == $this->config->item('examCodeJaiib') ||$exam_code == $this->config->item('examCodeDBF') || $exam_code == $this->config->item('examCodeSOB')  || $exam_code == $this->config->item('examCodeCaiibElective63') || $exam_code == 64 || $exam_code == 65 || $exam_code == 66 || $exam_code == 67 || $exam_code == $this->config->item('examCodeCaiibElective68') || $exam_code == $this->config->item('examCodeCaiibElective69') || $exam_code == $this->config->item('examCodeCaiibElective70') || $exam_code == $this->config->item('examCodeCaiibElective71') || $exam_code == 72 || in_array($exam_code, $dipcert))
      {
        if($exam_code == $this->config->item('examCodeCaiibElective63') ||  $exam_code == $this->config->item('examCodeCaiibElective68') || $exam_code == $this->config->item('examCodeCaiibElective69') || $exam_code == $this->config->item('examCodeCaiibElective70') || $exam_code == $this->config->item('examCodeCaiibElective71')) 
        { ?>
					<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
					<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
					<?php 
        ...
        <table  cellpadding="0" cellspacing="0" border="0"  width="800"  align="center">
          <?php if(in_array($exam_code, $dipcert)) {?> 
            <tr>
            ...
            { ?>
              <tr>
                <td style="font-size:14px;background-color:#7fd1ea; color:#fff; text-align:center; font-weight:bold; font-size:14px;   padding:7px 0; text-transform:uppercase;">IMPORTANT INSTRUCTIONS FOR CANDIDATES</td>
              </tr>
          <?php }?>
          <tr>
            <td style="background-color:#dcf1fc; padding:7px 0; border:1px solid #1287c0; font-size:10px;" >
              ...
              <table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin:7px;margin-left: 22px; width:96%">
                <tr>
                  ...
                  <td style="">Candidates are required to report to the Examination Venue as per the timing mentioned above. <strong>No candidate/s will be permitted to enter the Examination Venue/hall after the gate closing time for any reason whatsoever. Institute has instructed the examination conducting authorities of all the venues to strictly follow the timelines.</strong>
                  </td>
                </tr>
                <tr>
                  <td width="2%" valign="top" style="">b.</td>
                  <td style=""><strong>No candidate will be permitted to leave the hall in the first 60 minutes from the scheduled start time of the examination.</strong> </td>
                </tr>
              </table>
                ...
                <tr>
                  <td colspan="2" style="padding-left:30px;">
                    <table cellpadding="0" cellspacing="0" border="0">
                      ...
                      <tr>
                        <td width="2%" valign="top" style="">b.</td>
                        <td style="">Candidate can download provisional score card from the website by 3-4 days from Institute’s website. 
                        </td>
                      </tr>
                      <!-- <tr>
                        ...
                        <td colspan="2" style="padding-left:30px;">
                          <table cellpadding="0" cellspacing="0" border="0">
                            ...
                            <tr>
                              ...
                              <td style=""><strong>PLEASE REFER INSTITUTE’S WEBSITE UNDER THE MENU “EXAM RELATED” FOR DETAILS OF DEBARMENT PERIOD FOR:
                              </strong>
                              <br>
                              <strong>UNFAIR PRACTICES ADOPTED BY CANDIDATES DURING CONDUCT OF INSTITUTE’S EXAMINATIONS.</strong>
                              </td>
                            </tr>
                          </table>
                        </td>
        ...
        <?php if(in_array($exam_code, $dipcert) || $exam_code == $this->config->item('examCodeSOB')) { }
        else if(!in_array($exam_code,$caiib) && !in_array($exam_code,array(210,420)))
        { ?>
          <table cellpadding="0" cellspacing="0" width="800" border="0" align="center" style="background-color:#fff;">
            <tr>
              <td style="background-color:#7fd1ea; color:#fff; text-align:center; font-weight:bold;  padding:7px 0; text-transform:uppercase;">IMPORTANT INSTRUCTIONS FOR CANDIDATES</td>
            </tr>
            <tr>
              <td style="background-color:#dcf1fc; padding:7px 0; border:1px solid #1287c0;">
                <table cellpadding="0" cellspacing="0" border="0">
                  <tr>
                    <td width="10" style="padding-left:15px;">1.</td>
                    <td><strong style="">Guidelines to be followed by the candidates during the Examinations under COVID-19 Pandemic environment:</strong></td>
                  </tr><!--1.-->
                  <tr>
                    <td colspan="2" style="padding-left:30px;">
                      <table cellpadding="0" cellspacing="0" border="0">
                        ...
                        <tr>
                          <td width="2%" valign="top" style="">1.</td>
                          <td style="">As a precautionary measure against COVID-19, candidates should reach the exam centre before the reporting time mentioned in the admit letter, to avoid any delay and  crowding at the exam centre at the time of entry and to maintain social distancing</td>
                        </tr>
                        <tr>
                          <td width="2%" valign="top" style="">2.</td>
                          <td style="">Candidates should bring the printed admit letter along with hard copy valid photo identity proof (in original) along with duly completed Self Declaration Form given in Annexure – A</td>
                        </tr>
                        <tr>
                          <td width="2%" valign="top" style="">3.</td>
                          <td style="">The Self-Declaration Form printed and duly completed should be submitted to the Invigilator</td>
                        </tr>               
                        <tr>
                          <td width="2%" valign="top" style="">4.</td>
                          <td style="">Candidates must maintain social distancing & wear mask starting from point of entry in the exam venue till the candidates exit from the exam venue. Candidates must follow the guidelines issued by Ministry of Health & Family Welfare, Govt of India from time to time relating to  Covid-19 Pandemic</td>
                        </tr>
                        <tr>
                          <td width="2%" valign="top" style="">5.</td>
                          <td style="">The body temperature of the candidates will be checked at the entranceof the exam venue using Thermal Gun and candidates who are detected with high body temperature may not be allowed entry for the examination</td>
                        </tr>
                        <tr>
                          <td width="2%" valign="top" style="">6.</td>
                          <td style="">Candidates will be frisked using a Handheld Metal Detector but no contact with the body would be ensured</td>
                        </tr>
                        <tr>
                          <td width="2%" valign="top" style="">7.</td>
                          <td style="">Candidates need to maintain a space of at least 01 meter from each other at all the time after reporting to exam venue and make use of Hand sanitizers and/or Hand Wash made available at the venue during the entire exam process and follow the instructions provided by centre staff</td>
                        </tr>        
                        <tr>
                          <td width="2%" valign="top" style="">8.</td>
                          <td style="">Do NOT bring any prohibited items (electronic gadget, mobile phone, scientific/financial calculator, metal instrument or any other unauthorized devices etc) to exam centre as there are no arrangements available for safe keeping of your belongings</td>
                        </tr>
                        <tr>
                          <td width="2%" valign="top" style="">9.</td>
                          <td style="">Candidates are advised to use stairs instead of lifts to avoid any risk of contact at the Examination Centre</td>
                        </tr>  
                        <tr>
                          <td width="2%" valign="top" style="">10.</td>
                          <td style="">Candidates would NOT be provided with any blank A4 size sheets for rough work at the exam centre, to avoid any risk due to contact with an infected person. However, the candidates may use the online rough sheet on the exam screen to do any rough work/ calculations during the examination</td>
                        </tr>
                        <tr>
                          <td width="2%" valign="top" style="">11.</td>
                          <td style="">Please note that candidates would NOT be provided with any hard copy Scorecard printout at the exam venue, after the examination. The scorecard will only be sent over mail to the registered e-mail ID of  the candidate's within  03 / 04 working days from the exam date</td>
                        </tr>
                        <tr>
                          <td width="2%" valign="top" style="">12.</td>
                          <td style="">After reporting to their respective desk, before start of exam, during exam and after completion of the exam, candidates must not leave their seats without the permission of the invigilator/centre staff. They must wait for the instructions</td>
                        </tr>
                        <tr>
                          <td width="2%" valign="top" style="">13.</td>
                          <td style="">Candidates are required to co-operate with the examination conducting authorities for conducting the examination smoothly under COVID-19 Pandemic environment</td>
                        </tr>
                      </table>
                    </td>
                  </tr><!--Content of No.:1-->
          ...
          <?php if(!in_array($exam_code,$caiib))
          { ?> 
      ...
      { ?>
        ...
        <table cellpadding="0" cellspacing="0" border="0"  width="800"  align="center">
          <tr>
            <td style="font-size:14px;background-color:#7fd1ea; color:#fff; text-align:center; font-weight:bold;    padding:7px 0; text-transform:uppercase;">IMPORTANT INSTRUCTIONS FOR CANDIDATES</td>
          </tr>
          <tr>
            <td style="background-color:#dcf1fc; padding:7px 0; border:1px solid #1287c0; font-size:10px;" >
              <table cellpadding="0" cellspacing="0" border="0" width="100%" >
                ...
                <tr>
                  <td colspan="2" style="padding-left:30px;">
                    <table cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td width="2%" valign="top" style="">a.</td>
                        <td style=""><strong>After submitting of the question paper provisional score card/result will be displayed on the computer screen. This Score card will be sent to the Candidate's email ID as registered with the Institute. </strong></td>
                      </tr>
                      <tr>
                        <td width="2%" valign="top" style="">b.</td>
                        <td style="">Candidate can provide alternate email ID if he wishes to receive the score card on different email ID
                        </td>
                      </tr>
                      <tr>
                        <td width="2%" valign="top" style="font-size:13px;">c.</td>
        ...
        <table cellpadding="0" cellspacing="0" border="0"  width="800"  align="center">
              ...
              <table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin:7px;width:99%">
                <tr>
                  ...
                  <td><strong style="padding-left:0px;"><br>Rules, Penalities for Misconduct / Unfair Practices :</strong></td>
                </tr><!--8.-->
                <tr>
                  <td colspan="2" style="padding-left:30px;">
                    <table cellpadding="0" cellspacing="0" border="0">
      ...
      if($exam_period == 912 || $exam_period == 913 )
      { ?> 
        <table cellpadding="0" cellspacing="0" width="800" border="0" align="center" style="background-color:#fff;">
          <tr>
            <td style="background-color:#7fd1ea; color:#fff; text-align:center; font-weight:bold; font-size:13px; padding:7px 0; text-transform:uppercase;">IMPORTANT INSTRUCTIONS FOR CANDIDATES</td>
      ...
      if($exam_code == 991  || $exam_code == 997 || $exam_code == 1052 || $exam_code == 1054 || $exam_code == 1053)
      { ?>
        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
              ...
              <tr>
                <td colspan="2" style="padding-left:30px;">
                  <table cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                      <td width="5" style="padding-left:15px;font-size:13px;">&nbsp;</td>
                      <td style="font-size:13px;"><strong>PLEASE REFER INSTITUTE’S WEBSITE UNDER THE MENU “EXAM RELATED” FOR DETAILS OF DEBARMENT PERIOD FOR:</strong>
                      </td>
                    </tr>
                    <table>
                      <tr>
                        <td width="2%" valign="top" style="padding-left:30px;font-size:13px;"><strong>1)</strong></td>
                        <td style="font-size:13px;"><strong>UNFAIR PRACTICES ADOPTED BY CANDIDATES DURING CONDUCT OF INSTITUTE’S EXAMINATIONS.</strong></td>
                      </tr>
                    </table> 
                  </td>
    ...
    { ?>
      <table  cellpadding="0" cellspacing="0" width="800" border="0" align="center">
        <tr><td>
          <img style="margin-top: 30px; width: 95%;"  src="https://iibf.esdsconnect.com/uploads/jaiib-books-horizontal.jpeg">
        </td></tr> 
      </table> 
    <?php }
  
    $bannerexamcodes = array(505,506,507,508,509,600); 
    if(in_array($exam_code,$bannerexamcodes)) 
    { ?>
      <table  cellpadding="0" cellspacing="0" width="800" border="0" align="center">
        <tr><td>
          <img style="margin-top: 30px; width: 95%;"  src="https://iibf.esdsconnect.com/uploads/caiib_horizontal.jpg">
        </td></tr>
      </table> 
    <?php }

    if($this->router->fetch_method()=='getadmitcardpdfsp_new')
    {
      ?>
      <div style="font-size:9px;margin-left: 0%;">gen.on.<?php echo date('dmY:h:i:s') ; ?></div>
      <?php
    } ?>
  </body>
  <script>
