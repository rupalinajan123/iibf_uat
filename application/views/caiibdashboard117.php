 ...
 <table border="0" cellpadding="0" cellspacing="0" width="900px" align="center" style=" margin-bottom:10px;">
   ...
   <td rowspan="2" width="75%">
  	<ul>
    	...
    	<li class="resultlink"><a href="<?php echo base_url()?>result/caiib_result_consolidated" target="_blank">Consolidated Marksheet</a></li>
        <?php }?>
        <li class="resultlink"><a href="<?php echo base_url()?>result/caiib_result_advice" target="_blank">Result Advice</a></li>
    </ul>
   </td>
   </tr>
   </table>
