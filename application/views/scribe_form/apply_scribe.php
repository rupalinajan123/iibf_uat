	...
	<body class="hold-transition skin-blue layout-top-nav">
							...
							<div class="box box-info">
								<form class="form-horizontal" name="usersAddForm" id="usersAddForm1"  method="post"  action="" autocomplete="off">
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<select class="form-control chosen-select" id="exam_code1" name="exam_code" required autofocus data-placeholder="<?php if(!empty($active_exam_data) && count($active_exam_data) > 0) { echo 'Select Exam'; } else { echo 'No Exam Available'; } ?>">
											<?php
									...
									<div style="text-align: center; width: 100%; margin-top: 8%;">
		...
		<script type="text/javascript">
			function change_scribe()
		    {
		        ...
		        var scribe_uid = '';
		        // var url = '<?php echo site_url("/Scribe_form/change_scribe"); ?>';
		        // alert(url);
		        // alert(member_no);
		        //alert(exam_code1);
		        //alert(sel_subject1);
