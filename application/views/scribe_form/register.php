...
.example {
  ...
  <form class="form-horizontal" name="usersAddForm" id="usersAddForm"  method="post"  action="<?php echo site_url('Scribe_form/member/'); ?>" enctype="multipart/form-data" autocomplete="off">
   ...
   <?php 						
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <input type="text" class="form-control" id="firstname" name="firstname" placeholder="First Name" required value="<?php if (isset($member_details[0]['firstname'])) {echo $member_details[0]['firstname'];
}?>" readonly="readonly">
                </div>
              </div>
			  ...
			  <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="exam_name" name="exam_name" placeholder="exam name"   value="<?php if (isset($exam_name[0]['description'])) { echo $exam_name[0]['description'];
} ?>"  readonly="readonly">
			  ...
			  <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="email" name="email" placeholder="Email"  data-parsley-type="email" value="<?php if (isset($member_details[0]['email'])) { echo $member_details[0]['email'];
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <input type="tel" class="form-control" id="mobile" name="mobile" placeholder="Mobile" data-parsley-type="number"  data-parsley-minlength="10" data-parsley-maxlength="10"  value="<?php if (isset($member_details[0]['mobile'])) {
    echo $member_details[0]['mobile'];} ?>"  required  data-parsley-trigger-after-failure="focusout" readonly="readonly">
                    <span class="error"></span> </div>
                </div>
				<?php //print_r($center_master); ?>
				<!--<div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <select name="selCenterName" id="selCenterName" class="form-control" required onchange="valCentre(this.value);">
								...
								{
									foreach($center_master as $crow)
									{?>
										<option value="<?php echo $crow[0]['center_code']?>" class=<?php echo $crow[0]['exammode'];?>><?php echo $crow[0]['center_name']?></option>
									<?php }
								}?>
								</select>
                  </div>
    ...
    echo $member_details[0]['center_name'];} ?>"  required  data-parsley-trigger-after-failure="focusout" readonly="readonly">
                    <span class="error"></span> </div>
                </div>
				<div class="form-group">
    ...
    echo $member_details[0]['center_code'];} ?>"  required  data-parsley-trigger-after-failure="focusout" readonly="readonly">
                    <span class="error"></span> </div>
                </div>
				 <!-- <div class="form-group">
									<label for="roleid" class="col-sm-4 control-label">Centre Code *</label>
									<div class="col-sm-2">
                  ...
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="scribe_name" name="scribe_name" placeholder="Scribe name"   value="" required>
                    <span class="error"> </span> </div>
                </div>
				<div class="form-group">
                  <label for="roleid" class="col-sm-4 control-label">Scribe Mobile&nbsp;<span style="color:#F00">*</span>&nbsp;:</label>
                  <div class="col-sm-5">
                    <input type="tel" class="form-control" id="scribe_mobile" name="scribe_mobile" placeholder="Scribe Mobile" data-parsley-type="number"  data-parsley-minlength="10" data-parsley-maxlength="10"  value=""  required  data-parsley-trigger-after-failure="focusout" >
                    <span class="error"></span> </div>
                </div>
				 <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="hidden" id="education_type" value="">
				...
				<div class="form-group">
                  <label for="roleid" class="col-sm-4 control-label">Employment details of Scribe&nbsp;<span style="color:#F00">*</span>&nbsp;:</label>
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="emp_scribe" name="emp_scribe" placeholder="Details Scribe"   value="" required>
                    <span class="error"> </span> </div>
                </div>
			...
			<div class="form-group">
			  ...
			  <div class="col-sm-3">
				...
				Yes
				<input value="N" name="benchmark_disability" id="benchmark_disability" type="radio"  <?php echo set_radio('benchmark_disability', 'N'); ?> class="benchmark_disability_n">
		  ...
		  <div class="form-group">
			  ...
			  <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input  type="file" name="declarationform" id="declarationform" required>
