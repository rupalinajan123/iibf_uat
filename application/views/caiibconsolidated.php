...
<body>
 <table border="0" cellpadding="0" cellspacing="0" width="900px" align="center" style=" margin-bottom:10px;">
   ...
   <?php if($exam_p == 119){?>
   You have not passed this examination, so consolidated mark sheet is not available
   <?php }elseif($exam_p == 219){?>
   Consolidated Marks sheet will be available within a day or two.
   <?php }elseif($exam_p == 220){?>
   You have not passed this examination, so consolidated mark sheet is not available
   <?php }else{// Else for remaining exam code 03-01-23?>
   You have not passed this examination, so consolidated mark sheet is not available
   <?php }//else end 03-01-23?>
   </td>
   </tr>
   <?php }else{?>
   <tr>
...
unfair practices being established.
   ...
   <table width="10%" align="center" border="0" cellpadding="0" cellspacing="0" style="padding:30px 0 0;">
                    <tr>
                      ...
                      <td>
                      <a href="<?php echo base_url();?>marksheet/caiibresult/<?php echo base64_encode($exam_p)?>" style="background-color:#ddd; color:#000; text-align:center; padding:10px 15px; text-decoration:none;">Back</a>
