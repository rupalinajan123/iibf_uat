		...
		<div class="wrapper">
			...
			<div class="content-wrapper">
				<section class="content-header">
					<h1>Payment History - Institute <span style="font-size: 20px; text-transform: capitalize; ">(<?php echo strtolower($institute_name); ?>)</h1>
				</section>
							...
							<div class="box box-info">
                              ...
                              <td class="text-center"><?php echo strtoupper($res['is_gst_tds_applicable']); ?></td>
															...
															<td class="text-center">
																<?php 
																	if($res['PaymentStatus'] == 0 || $res['PaymentStatus'] == 7) { echo 'Fail'; }
															...
															<td class="text-center no-sort"><a href="<?php echo site_url('institute_subscription/invoice/'.base64_encode($res['receipt_no'])); ?>" class="btn btn-sm btn-primary" style="padding:1px 5px 2px" target="_blank">View</a></td>
															<td class="text-center no-sort"><a href="<?php echo site_url('institute_subscription/receipt/'.base64_encode($res['receipt_no'])); ?>" class="btn btn-sm btn-primary" style="padding:1px 5px 2px" target="_blank">View</a></td>
														</tr>
														<?php $sr_no++;
														}
													}	?>
