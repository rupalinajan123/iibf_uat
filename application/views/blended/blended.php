...
if ($this->session->flashdata('error') != '') {?>
	   ...
	   <form name="getDetailsForm" id="getDetailsForm" method="post" action="<?php echo base_url(); ?>blended"  autocomplete="off">
          <br />
          <?php
		  if(validation_errors() != '')
		  { 
		  ?>
          <input type="hidden" id="flag" value="1" autocomplete="false" />
          <?php 
		  }
		  ?>
          <div class="">
...
?>" <?php if (isset($row['regnumber'])) { echo "readonly='readonly'";} elseif (set_value('regnumber')) { echo "readonly='readonly'"; } ?> style="border-color:#000;" title="Membership No.">
			...
			<!-- Added by chaitali on 2021-10-15 -->
			 ...
			 <?php if(empty($row['regnumber'])){?>
                ...
                <label for="roleid" class="col-sm-4 control-label text-center" style="text-align: center;padding-center: 20px;">Security Code<span style="color:#F00">*</span></label>
                	<div class="col-sm-2">
                    ...
                    <div class="col-sm-3">
                          <a href="javascript:void(0);" id="new_captcha" onclick="refresh_captcha_img_blended();" class="forget">Change Image</a>
                         <span class="error"><?php //echo form_error('code');?></span>
                    </div>
  ...
  <form class="form-horizontal" name="blendedAddForm" id="blendedAddForm"  method="post"  enctype="multipart/form-data"  autocomplete="off">
        ...
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <div class="form-group">
              <input type="hidden" class="form-control" id="regnumberHidden" name="regnumberHidden" value="<?php if (isset($row['regnumber'])) { echo $row['regnumber'];} else { echo set_value('regnumber'); }?>" autocomplete="false">
              <input type="hidden" class="form-control" id="batch_code" name="batch_code" value="" autocomplete="false">
              
              <input type="hidden" class="form-control" id="registrationtype" name="registrationtype" value="<?php if (isset($row['registrationtype'])) { echo $row['registrationtype'];}?>" autocomplete="false">
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              ...
              <input type="hidden" name="regnumber" id="regnumber" value="<?php if (isset($row['regnumber'])) {echo $row['regnumber'];}?>" autocomplete="false"/>
              <div class="form-group">
...
if (isset($row['state'])) { echo $row['state'];}?>" autocomplete="false">
...
if (isset($row['designation'])) {echo $row['designation'];}?>" autocomplete="false">
                    <span class="error"></span> </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-5"  style="display:block" >
                    ...
                    <input type="hidden" class="form-control" id="institutionworking" name="institutionworking" required value="<?php if (isset($row['associatedinstitute'])) { echo $row['associatedinstitute'];}?>" autocomplete="false">
                    <span class="error"></span> </div>
                </div>
...
if (isset($row['qualification'])) {echo $row['qualification']; }?>" autocomplete="false"/>
                    <span class="error"></span> </div>
                </div>
                <div class="form-group">
...
if (isset($row['qualification']) && $row['qualification'] == 'U') {echo $row['specify_qualification'];}?>" autocomplete="false" />
                    <span class="error"> </span> </div>
...
if (isset($row['qualification']) && $row['qualification'] == 'G') { echo $row['specify_qualification']; }?>" autocomplete="false" />
                    <span class="error"></span> </div>
          ...
          <div class="box box-info">
            ...
            <div class="form-group m_t_15">
              ...
              <div class="col-sm-3">
                <div id="captcha_img"> <?php echo $image; ?></div>
                <span class="error"> </span> </div>
              <div class="col-sm-2"> <a href="javascript:void(0);" id="new_captcha" onclick = "refresh_captcha_img();" class="forget" >Change Image</a> <span class="error"></span> </div>
            </div>
			<?php }?>
...
function refresh_captcha_img_blended()
{
	$.ajax({
		type: 'POST',
		url: site_url+'blended/generatecaptchaajax/',
