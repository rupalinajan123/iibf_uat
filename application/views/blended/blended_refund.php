              ...
              <div class="box box-info">
                ...
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <div class="col-sm-6"> <strong style="color:#000">Capacity is full for this course.</strong> </div>
                  </div>
                  <div class="form-group">
                    <label for="roleid" class="col-sm-3 control-label">Transaction Number&nbsp;:&nbsp;</label>
                    <div class="col-sm-6"> <?php echo $payment_info[0]['transaction_no'];?> </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-6"> <?php echo $payment_info[0]['date'];?> </div>
                  </div>
                  <div class="form-group">
