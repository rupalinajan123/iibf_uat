                              ...
                              <tr>
                                 <td style="font-family: Tahoma, Geneva, sans-serif; font-size:12px;">
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
                                       ...
                                       <tr>
                                          <td style="border-right:1px solid #28aae2; padding:5px 10px;border-bottom:1px solid #28aae2;"><?php echo preg_replace("/\([^)]+\)/","",$exam_name);?></td>
                                          <td style="padding:5px 10px;border-bottom:1px solid #28aae2;">
                                             <?php 
                                                echo $exam_result_date;
                                    ...
                                    <table style="border-collapse:collapse;" width="98%" align="center">
                                       <tbody>
                                          ...
                                          <tr>
                                             ...
                                             <td style="border: 1px #6699CC solid;" class="text2" align="center">
                                                <?php
                                                   $member_array = array(500184564,500034864,510032261,500155381,510140698,510184003,500088452,500110205,500000979,510031843,510337251,500210528,510137697,510173939,510222998,510276913,500099579,500053200,500061891,500112899,500192219,500010372,510185486);
                                                   
                                                   
                                                   if(in_array($this->session->userdata('result_mem_no'),$member_array)){
                                                     if($result['exam_period'] == 16 && $result['part_no'] == 2){
                                                       echo '25-APR-2018 ' ; 
                                                     }else{
                                                      if( !empty($dates)){
                                                       if($dates[0]['exam_date'] !=''){
                                                         echo $dates[0]['exam_date'];
                                                       }else{
                                                         echo '' ; 
                                                       }
                                                       }else{
