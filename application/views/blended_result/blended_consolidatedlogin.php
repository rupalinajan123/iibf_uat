                    ...
                    <tr>
                      ...
                      <td class="content" width="55%" bgcolor="#d8e4f1">
                        <select name="exam" id="exam" class="text1" style="min-width:218px;">
                          ...
                          <option value="1005">CERTIFIED CREDIT PROFESSIONA-NEWL</option>
                          <option value="1006">CERTIFIED TREASURY PROFESSIONALS-NEW</option>
                          <option value="1007">CERTIFICATE IN RISK IN FINANCIAL SERVICES LEVEL-1-NEW</option>
                          <option value="1008">CERTIFIED ACCOUNTING & AUDIT PROFESSIONAL-NEW</option>
                        </select>
                      </td>
                    </tr>
                    <tr>
