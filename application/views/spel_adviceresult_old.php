                  ...
                  <tr>
                     <td style="border:3px solid #619fda;">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
                              ...
                              <td style="border-bottom:3px solid #619fda; padding:10px; font-family:'Times New Roman', Times, serif; font-size:15px;">
                                 ...
                                 <!-- <table width="100%">
                                    <tr>
                                       ...
                                       <tr>
                                       <td align="center" valign="top"><img src="<?php echo base_url();?><?php echo get_img_name($this->session->userdata('result_mem_no'),'s');?><?php echo '?'.time(); ?>" style="max-width:40%" />
                                       </td>
                           ...
                           <tr>
                              <?php 
                                 if($exam_code == 1002 || $exam_code == 1003 || $exam_code == 1004 || $exam_code == 1012 || $exam_code == 1014 || $exam_code == 528 || $exam_code == 529 || $exam_code == 530 || $exam_code == 531 || $exam_code == 534 ){?>
