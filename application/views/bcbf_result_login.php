            ...
            <tr>
              <td style="border:3px solid #619fda;">
                <table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
                                  ...
                                  <tr>
                                    ...
                                    <td class="content" width="55%" bgcolor="#d8e4f1">
                                      <select name="exam" id="exam" class="text1" style="min-width:218px;">
                                        ...
                                        <?php /* 
                                          <option value="101">CERTIFICATE EXAMINATION FOR BUSINESS CORRESPONDENTS/FACILITATORS</option>
                                          <option value="1028">CERTIFICATE EXAMINATION ON AUDITING</option>
                                        */ ?>
                                        <option value="1027" <?php echo set_value('exam')== '1027'?'selected':'' ?>>CERTIFICATE EXAM ON KYC-AML & COMPLIANCE FOR EMPLOYEES OF UCO BANK</option>
                                        <option value="1026" <?php echo set_value('exam')== '1026'?'selected':'' ?>>CASH & CURRENCY CHEST MANAGEMENT</option> <!-- ADDED BY POOJA MANE :23-10-2023 -->
                                        <option value="1029" <?php echo set_value('exam')== '1029'?'selected':'' ?>>Certificate in Ethics and Ethical Mindset</option>
                                        <option value="1030" <?php echo set_value('exam')== '1030'?'selected':'' ?>>CERTIFICATE IN AML-KYC & COMPLIANCE- INDIAN BANK</option>
                                        <option value="1033" <?php echo set_value('exam')== '1033'?'selected':'' ?>>Certificate on AML/KYC & Compliance in Banks</option>
                                        <option value="1034" <?php echo set_value('exam')== '1034'?'selected':'' ?>>Certificate on Compliance for employees of Indian Overseas Bank</option>
                                        <option value="1037" <?php echo set_value('exam')== '1037'?'selected':'' ?>>CERTIFICATE EXAMINATION FOR BUSINESS CORRESPONDENTS / FACILITATORS (ADVANCED)</option>
                                        <option value="1038" <?php echo set_value('exam')== '1038'?'selected':'' ?>>CERTIFICATE EXAMINATION FOR BUSINESS CORRESPONDENTS / FACILITATORS (BASIC)</option>
                                        <option value="1043" <?php echo set_value('exam')== '1043'?'selected':'' ?>>Certificate on AML/KYC and Compliance in Banks & NBFCs</option>
                                        <option value="1046" <?php echo set_value('exam')== '1046'?'selected':'' ?>>CERTIFICATE EXAMINATION FOR BUSINESS CORRESPONDENTS / FACILITATORS (ADVANCED) - Without Training</option>
                                        <option value="1047" <?php echo set_value('exam')== '1047'?'selected':'' ?>>CERTIFICATE EXAMINATION FOR BUSINESS CORRESPONDENTS / FACILITATORS (BASIC) - Without Training</option>
                                      </select>
                                    </td>
                                  </tr>
                                  <tr> 
                  ...
                  <tr>
                    <td class="footer" colspan="2" width="43%" valign="middle" height="24">Copyright &copy; 2012. INDIAN INSTITUTE OF BANKING AND FINANCE. All rights reserved.</td>
                  </tr>
