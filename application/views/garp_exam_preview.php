...
<div class="container">
  <div class="content-wrapper"> 
    ...
    <br />
    <form class="form-horizontal" name="blendedForm" id="blendedForm" method="post" enctype="multipart/form-data" action="<?php echo base_url()?>garp_exam/addmember/">
      <div class="content-wrapper">
            ...
            <div class="col-md-12"> 
              ...
              <div class="box box-info">
                ...
                <div class="box-body">
                  ...
                  --> <!-- priyanka d >> 25-aur >> removed this row as no jaiib/caiib now -->
                 
                  
                  <div class="form-group">
                    <label for="roleid" class="col-sm-4 control-label">Fee Amount&nbsp;:</label>
                    <div class="col-sm-5"> <strong><?php echo $this->session->userdata['enduserinfo']['preview_fees']; ?> </strong> </div>
                  </div>
