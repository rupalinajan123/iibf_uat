...
if ($this->session->flashdata('error') != '') {?>
        ...
        <?php } ?>
        <form name="getDetailsForm" id="getDetailsForm" method="post" action="<?php echo base_url(); ?>blendedTraining">
          <br />
          <?php
...
?>" <?php if (isset($row['regnumber'])) { echo "readonly='readonly'";} elseif (set_value('regnumber')) { echo "readonly='readonly'"; } ?> style="border-color:#000;" title="Membership No.">
            ...
            <div class="col-sm-3" style="padding-bottom: 10px">
              <?php 
				...
				?>
              <a href="<?php echo base_url();?>blendedTraining" class="btn btn-info" id="modify" style="height: 32px; width: 150px">Modify</a>
          ...
          <div class="box box-info">
            ...
            <div class="box-footer">
              ...
              <div class="col-sm-6 col-sm-offset-3">
                ...
                <a href="<?php echo base_url();?>blendedTraining" class="btn btn-default" >Reset</a> </div>
...
<script src="<?php echo base_url();?>js/validation_blendedtraining.js?<?php echo time();?>"></script> 
<script>
...
window.addEventListener('popstate', function(event) {
    window.location.assign(site_url+"blendedTraining/");
});
...
$('#reload_captcha').click(function(event){
	...
	$.ajax({
		type: 'POST',
		url: site_url+'blendedTraining/generatecaptchaajax/',
