    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-12">
            ...
            <?php //echo validation_errors(); ?>
             ...
             <div class="col-sm-9">
               ...
               <div class="form-group">
                <label style="text-align: left;" for="roleid" class="col-sm-5 control-label">Membership No :</label>
                	<div class="col-sm-5">
                 ...
                 <div class="form-group">
                <label style="text-align: left;" for="roleid" class="col-sm-5 control-label">Password : </label>
                	<div class="col-sm-5">
                  <?php 
               ...
               <div class="form-group">
                <label style="text-align: left;" for="roleid" class="col-sm-5 control-label">Full Name :</label>
                	<div class="col-sm-5">
                  <?php 
                ...
                <div class="form-group">
                <label style="text-align: left;" for="roleid" class="col-sm-5 control-label">Name as to appear on Card:</label>
                	<div class="col-sm-5">
                ...
                <div class="form-group">
                <label style="text-align: left;" for="roleid" class="col-sm-5 control-label">Office/Residential Address for communication :</label>
                	<div class="col-sm-5">
                      <?php 
                ...
                <div class="form-group">
                <label style="text-align: left;" for="roleid" class="col-sm-5 control-label">Date of Birth :</label>
                	<div class="col-sm-2">
                ...
                <div class="form-group">
                <label style="text-align: left;" for="roleid" class="col-sm-5 control-label">Gender :</label>
       		    <div class="col-sm-2">
                ...
                <div class="form-group">
                <label style="text-align: left;" for="roleid" class="col-sm-5 control-label">Qualification :</label>
                	<div class="col-sm-4">
                ...
                <div class="form-group">
                <label style="text-align: left;" for="roleid" class="col-sm-5 control-label">specify :</label>
                <div class="col-sm-5">
                ...
                <div class="form-group">
             <label style="text-align: left;" for="roleid" class="col-sm-5 control-label">Bank/Institution working :</label>
              <div class="col-sm-5" >
         ...
         <div class="form-group">
            <label style="text-align: left;" for="roleid" class="col-sm-5 control-label">Branch/Office :</label>
                <div class="col-sm-5">
            ...
            <div class="form-group">
             <label style="text-align: left;" for="roleid" class="col-sm-5 control-label">Designation :</label>
         ...
         <div class="form-group">
        <label style="text-align: left;" for="roleid" class="col-sm-5 control-label">Date of joining :</label>
            <div class="col-sm-3">
            <?php echo date('d-m-Y',strtotime($user_info[0]['dateofjoin']));?>
                ...
                <div class="form-group">
        <label style="text-align: left;" for="roleid" class="col-sm-5 control-label">Email :</label>
            <div class="col-sm-5">
        ...
        <div class="form-group">
        <label style="text-align: left;" for="roleid" class="col-sm-5 control-label">Mobile :</label>
            <div class="col-sm-5">
        ...
        <!-- <div class="form-group">
        <label style="text-align: left;" for="roleid" class="col-sm-5 control-label">Select Id Proof :</label>
        <div class="col-sm-5">
        <?php
        ...
        <div class="form-group">
        <label style="text-align: left;" for="roleid" class="col-sm-5 control-label">Aadhar Card Number :</label>
        <div class="col-sm-5">
        ...
        <div class="form-group">
        <label style="text-align: left;" for="roleid" class="col-sm-5 control-label">I agree to receive the Annual report from the Institute in a softcopy, at my registered email ID, in place of physical copy</label>
        <div class="col-sm-5">
          <?php if($user_info[0]['optnletter']=='Y'){echo  'Yes';}?>
          <?php if($user_info[0]['optnletter']=='N'){echo  'No';}?>
        </div>
        </div>
                
                
        <div class="form-group">
        <label style="text-align: left;" for="roleid" class="col-sm-5 control-label">ID Proof :</label>
        <div class="col-sm-5">
        <img src="<?php echo base_url();?><?php echo get_img_name($user_info[0]['regnumber'],'pr');?><?php echo '?'.time(); ?>"  height="180" width="100">
        </div>
        </div>

        <div class="form-group">
        <label style="text-align: left;" for="roleid" class="col-sm-5 control-label">Declaration :</label>
        <div class="col-sm-5">
        <img src="<?php echo base_url();?><?php echo get_img_name($user_info[0]['regnumber'],'declaration');?><?php echo '?'.time(); ?>"  height="100" width="100">
        </div>
        </div>
        
        <div class="form-group">
        <label style="text-align: left;" for="roleid" class="col-sm-5 control-label">Signature :</label>
        <div class="col-sm-5">
  		  <img src="<?php echo base_url();?><?php echo get_img_name($user_info[0]['regnumber'],'s');?><?php echo '?'.time(); ?>" height="100" width="100">
        </div>
        </div>
        
        
        	<div class="form-group">
        <label style="text-align: left;" for="roleid" class="col-sm-5 control-label">Date :</label>
        <div class="col-sm-5">
...
<label style="text-align: left;" for="roleid" class="col-sm-5 control-label"><img src="<?php echo base_url();?><?php echo get_img_name($user_info[0]['regnumber'],'p');?><?php echo '?'.time(); ?>" height="100" width="100" ></label>
...
<tr>
			...
			<img src="<?php echo base_url();?><?php echo get_img_name($user_info[0]['regnumber'],'p');?><?php echo '?'.time(); ?>" height="100" width="100" style=" right:15px;" >
			</td>
		</tr>
				<tr>
		...
		<tr>
			...
			<td colspan="3" class="tablecontent2" nowrap="nowrap"> <?php if($user_info[0]['optnletter']=='Y'){echo  'Yes';}?>
          <?php if($user_info[0]['optnletter']=='N'){echo  'No';}?> </td>
		</tr>

		<tr>
			<td class="tablecontent2">ID Proof :</td>
			<td colspan="3" class="tablecontent2" nowrap="nowrap">  <img src="<?php echo base_url();?><?php echo get_img_name($user_info[0]['regnumber'],'pr');?>"  height="180" width="100"></td>
		</tr>

    <tr>
      <td class="tablecontent2">Declaration :</td>
      <td colspan="3" class="tablecontent2" nowrap="nowrap">  <img src="<?php echo base_url();?><?php echo get_img_name($user_info[0]['regnumber'],'declaration');?>"  height="180" width="100"></td>
    </tr>

    <tr>
      <td class="tablecontent2">Signature :</td>
      <td colspan="3" class="tablecontent2" nowrap="nowrap"><img src="<?php echo base_url();?><?php echo get_img_name($user_info[0]['regnumber'],'s');?>" height="100" width="100"></td>
    </tr>
