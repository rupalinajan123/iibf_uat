    ...
    <div class="row">
      <div class="col-md-12" style=""> 
        ...
        <?php 
			 ...
			 ?>
        <form name="getDetailsForm" id="getDetailsForm" method="post" action="<?php echo base_url()?>renewal" autocomplete="off">
          <div class="" > 
            ...
            <div class="col-sm-3" style="padding-bottom: 10px">
			  ...
			  {
			  ?>
              <a href="<?php echo base_url()?>renewal" class="btn btn-info" style="height: 32px; width: 150px">Modify</a>
              <?php
			  }
			  else
			  {?>
        ...
        <div class="col-md-12"> 
          ...
          <div class="box box-info">
			...
			?>
                ...
                <a href="<?php echo base_url()?>renewal" class="btn btn-default" >Reset</a> 
...
$(function(){
    ...
    $.ajax({
 		type: 'POST',
 		url: site_url+'Renewal/generatecaptchaajax/',
