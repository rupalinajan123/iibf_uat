                ...
                <tr>
                  ...
                  <?php 
				  		foreach($exam_name as $exam_name){
							...
							$dates=$this->master_model->getRecords('admitcard_info_190',array('exm_cd'=>$exam_name->exm_cd,"mem_mem_no"=>$mid ),'date');
				  ...
				  ?>
                        ...
                        <a href="<?php echo base_url()?>admitcard/getadmitcardjdres/<?php echo base64_encode($exam_name->exm_cd)?>">
                        Admit Letter for
						<?php 
