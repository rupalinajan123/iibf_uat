            ...
            <td style="border:1px solid #1287c0; padding:5px;">
              ...
              <table cellpadding="0" cellspacing="0" width="100%" border="0" align="center">
                ...
                <tr>
                  ...
                  <?php if($exam_code != 101 && $exam_code != 991  || $exam_code != 997){ echo "Examination"; }?>
                  ...
                  <?php
						...
						if($exam_code == $this->config->item('examCodeCaiib')){
							...
							echo "Admit letter for Online CAIIB Examination – June 2023";

						}

						if(in_array($exam_code,$elective)){

							echo "Admit letter for Online CAIIB Electives – June 2023";
                ...
                if($this->router->fetch_method()=='getadmitcardsp_new') { ?>
                  <div align="right">
                   
                  	
                   
                   <a href="<?php echo base_url();?>Admitcard/getadmitcardpdfsp_new/<?php echo base64_encode($exam_code)?>/<?php echo $mem_exam_id;?>" style="color:#F00">Save as pdf</a>&nbsp;
                            ...
                            <td>
                          	...
                          	<table>
                                ...
                                if(isset($optFlgRecord)){
                                  if($optFlgRecord=='F')
                                  echo'<br>You have opted Forgo Credits and register de-novo';
                                  if( $optFlgRecord=='R')
                                  echo'<br>You have opted Avail credits(as applicable) with Balance attempts';
                                }
                               ?>
                               </div>
                                </td>
...
<?php } ?>
                  ...
                  <tr style="background-color:#dcf1fc;">
					  ...
					  $member_array = array('510226867','510389638','510301080','510393405','510361474','510401894','510101714','510421937','510421696','510417442','510211075','510097805','510167853','510258584','510373233','510114208','510345227','510226631','510366787','510370236','510366089','510344326','510395741','510420473','510129344','510330138','510389193','500107649','500196270','500006944','510338530','510375077','510096245','500037876','510399921','510366774','510404958','510164102','510374350','510341059','510332391','510340787','510319695','500039655','510234836','510029479','510332955','510366937','510222314','510369556','510344605','510335884','510298514','510390434','510338967','510306643','510021256','500154275','510097191','510342810','510096188','510085914','510254612','510254505','510250764','510042343','510316066','500186032','500067383','510231108','510135528','510246896','510422289','510343747','510065882','500039717','510389757','500199651','510226567','510207766','510368572','510415838','510348710','510370253','510402003','510088573','510193489','510182785','200059961','510081236','510337099','510239156','510027929','510137814','510202492','510167517','510241742','510247957','500038368','500207963');
					  	...
					  	if($exam_code == $this->config->item('examCodeCaiib') || $exam_code == $this->config->item('examCodeJaiib') || $exam_code == $this->config->item('examCodeDBF') || $exam_code == $this->config->item('examCodeSOB') || in_array($exam_code,$caiib)){
                ...
                <tr>
                	...
                	<td style="text-align:right; line-height:24px; font-size:13px;">
                     ...
                     <?php if($exam_code!=34 && $exam_code!=160 && $exam_code!=58 && $exam_code!=101){?>
                      <?php
 if($exam_code == $this->config->item('examCodeCaiib') || $exam_code == $this->config->item('examCodeJaiib') || $exam_code == $this->config->item('examCodeDBF') || $exam_code == $this->config->item('examCodeSOB') || in_array($exam_code,$elective)) {   //priyanka d - 20-feb-23
 ?>
 *Seat No. will be allotted at examination hall &nbsp;
 <?php } ?>
                ...
                <td>
					...
					<?php if($vcenter == 3){ if($exam_code == 991){ ?>

                         <p><strong>In case of any technical issues, please dial 8956684118 / 8956684119 (available on exam day and previous day only). For all other queries email to iibfexam@cscacademy.org

                        </strong></p>

                  <?php }else if($exam_code == 997){ ?>

                      <p><strong>
                        <!-- In case of any technical issues, please dial 8956684118 / 8956684119 (available on exam day and previous day only). For all other queries email to ippbexam@cscacademy.org -->

                        In case of any Technical Issue/Problem please dial 9720445220 or 011-49754975 Ext. 662  (available on exam day and the previous day only). for all other queries email to ippbexam@cscacademy.org. 
                 ...
                 <?php }else{
                    ...
                    <?php if($vcenter == 4){ if($exam_code == 991 ){ ?>

                    <p><strong>In case of any technical issues, please dial 8956684118 / 89566 84119 (available on exam day and previous day only). For all other queries email to iibfexam@cscacademy.org
...
<p><strong>For any Technical support / Query please contact on 8956684118 / 8956684119 10.00 AM to 5 PM as on the day of the exam</strong></p>
...
<?php }?>
         ...
         <?php
 if($exam_code != $this->config->item('examCodeCaiib') && $exam_code != $this->config->item('examCodeJaiib') && $exam_code != $this->config->item('examCodeDBF') && $exam_code != $this->config->item('examCodeSOB')) {   //priyanka d - 20-feb-23
 ?>
		<!-- <tr>

				<td style="text-align:left; padding:7px;"><p><strong>Kindly go through the Exam Rules & Regulations carefully before appearing for the Examination</strong><br><br>
				The cut-off date of guidelines / instructions issued by the regulator(s) and important developments in banking and finance up to 31st December,2022 will only be considered for the purpose of inclusion in the question papers.</p></td>
                  ...
                  <td colspan="2" style="padding-left:30px;">
                    <table cellpadding="0" cellspacing="0" border="0">
                      ...
                      <tr>
                        ...
                        <td style="">Candidates have to compulsory return any papers given including that given for rough work to invigilator. 
                      </tr>
                     <tr>
...
<?php if($exam_code == 991  || $exam_code == 997){?>
