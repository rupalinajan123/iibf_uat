...
<div class="container">
  <section class="content-header box-header with-border" style="height: 45px; background-color: #1287C0; ">
    <h1 class="register">Apply for Associate Chartered Banker Qualification</h1>
    <br />
  </section>
  <div> 
    <!-- Start Get Details -->
...
if ($this->session->flashdata('error') != '') {?>
        ...
        <?php } ?>
        <form name="getDetailsForm" autocomplete="off" id="getDetailsForm" method="post" action="<?php echo base_url(); ?>caiib_jaiib_reg">
          <br />
          <?php
...
?>" <?php if (isset($row['regnumber'])) { echo "readonly='readonly'";} elseif (set_value('regnumber')) { echo "readonly='readonly'"; } ?> style="border-color:#000;" title="Membership No.">
        ...
        ?>
              <a href="<?php echo base_url();?>caiib_jaiib_reg" class="btn btn-info" id="modify" style="height: 32px; width: 150px">Modify</a>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-info">
              ...
              <input type="hidden" autocomplete="false" class="form-control" id="exam_code" name="exam_code" value="<?php if (isset($row['exam_code'])) { echo $row['exam_code'];} else { echo set_value('exam_code'); }?>">
              <input type="hidden" autocomplete="false" class="form-control" id="exam_period" name="exam_period" value="<?php if (isset($row['exam_period'])) { echo $row['exam_period'];} else { echo set_value('exam_period'); }?>">
          ...
          if (isset($row['dateofbirth'])) {echo $newDate;} ?>"  required readonly="readonly">
            ...
            <div class="form-group">
                  <label for="roleid" class="col-sm-4 control-label">Staff Number&nbsp;<span style="color:#F00">*</span>&nbsp;:</label>
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="staffnumber" name="staffnumber" placeholder="Staff Number"  value="<?php if (isset($staff_number)){echo $staff_number;} ?>" data-parsley-type="number"  data-parsley-maxlength="30" maxlength="30"  required />
                    <span class="error"></span> </div>
                </div>
                 <div class="form-group">
                  <label for="roleid" class="col-sm-4 control-label">Organisation Name&nbsp;<span style="color:#F00">*</span>&nbsp;:</label>
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="organisation" name="organisation" placeholder="Organisation Name"  value="<?php if (isset($organisation)){echo $organisation;} ?>"  data-parsley-maxlength="30" maxlength="30"  required />
                    <span class="error"></span></div>
                </div>
                <div class="form-group">
                  <label for="roleid" class="col-sm-4 control-label">Department&nbsp;<span style="color:#F00">*</span>&nbsp;:</label>
                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="department" name="department" placeholder="Department"  value="<?php if (isset($department)){echo $department;} ?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/"  data-parsley-maxlength="30" maxlength="30"  required/>
                    <span class="error"></span></div>
                </div>
...
?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" maxlength="30" readonly="readonly">
            ...
            ?>
                    ...
                    <input type="hidden" autocomplete="false" class="form-control" id="state" name="state" required value="<?php
if (isset($row['state'])) { echo $row['state'];}?>">
                    <input hidden="statepincode" autocomplete="false" id="statepincode" value="" >
                  </div>
...
if (isset($row['designation'])) {echo $row['designation'];}?>">
    ...
    echo $row['mobile'];} ?>"  required  data-parsley-trigger-after-failure="focusout" readonly="readonly">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="radio" class="minimal" id="U" attr="optedu" name="optedu_1" value="CAIIB" <?php if(isset($row['qualification']) && $row['qualification'] == 'CAIIB'){echo "checked='checked'";}?> disabled="disabled" <?php //if (isset($row['qualification']) && $row['qualification'] == ''){echo "required='required'"; }?>>
                    CAIIB
                    <input type="radio" class="minimal" id="G"  attr="optedu" name="optedu_2" value="JAIIB" <?php if(isset($row['qualification']) && $row['qualification'] == 'JAIIB'){echo "checked='checked'";}?> disabled="disabled" <?php //if(isset($row['qualification']) && $row['qualification'] == ''){echo "required='required'";}?>>
                    JAIIB
                    <?php
