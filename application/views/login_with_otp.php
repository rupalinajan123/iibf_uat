  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() 
    {
      ...
      $("#loginFrm").validate({
        ...
        rules: 
        {
          regnumber: { required: true, remote: { url: "<?php echo site_url('login/validation_validate_membership_no/0/1'); ?>", type: "post" } },
        ...
        messages: 
        {
          regnumber: { required: "Please enter Membership No", remote:"Please enter the valid membership number" },
