                    ...
                    <tr>
                      ...
                      <td class="content" width="55%" bgcolor="#d8e4f1">
                        <select name="exam" id="exam" class="text1" style="min-width:218px;">
                          ...
                          <option value="34_728">Anti-Money Laundering And Know Your Customer</option>
                          <option value="58_728">Customer Services & Banking Codes And Standards</option>
                          <option value="160_728">MSME Finance for Bankers</option>
                          <option value="177_728">Prevention of Cyber Crimes and Fraud Management</option>
                        </select>
                      </td>
                    </tr>
                    <tr>
