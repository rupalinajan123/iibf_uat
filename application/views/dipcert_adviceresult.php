        ...
        <tr>
          <td style="border:3px solid #619fda;"><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
              ...
              <?php 
                ...
                if(isset($user_info->address6)){
                  if($user_info->address6 != $user_info->address5 && $user_info->address6!=''){
                      if(isset($user_info->pincode) && $user_info->pincode !="")
                      {
                        echo $user_info->address6.", "."Pin :".$user_info->pincode;
                      }else{
                ...
                if(isset($user_info->pincode)){
                  if(isset($user_info->address6) && $user_info->address6 != $user_info->address5 && $user_info->address6!='')
                  {
            ...
            /*if($exam_code == 1002 || $exam_code == 1003 || $exam_code == 1004 || $exam_code == 1005 || $exam_code == 1006 || $exam_code == 1007 || $exam_code == 1008 || $exam_code == 1009 || $exam_code == 1010 || $exam_code == 1011 || $exam_code == 1012 || $exam_code == 1013 || $exam_code == 1014 || $exam_code == 1017 || $exam_code == 1019 || $exam_code == 1020){
              ...
              echo preg_replace("/\([^)]+\)/","",$exam_name)."- ". $exam_conduct_date[0]." ".$exam_conduct_date[1];
            //}?>
                        </strong>
                      </td>
          ...
          if($exam_code == 1002 || $exam_code == 1003 || $exam_code == 1004 || $exam_code == 1012 ||  $exam_code == 1014 ) { ?>
                  <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;font-weight:bold">
               <p style="font-family:'Times New Roman', Times, serif; font-weight:bold;  font-size:16px;">MINIMUM MARKS FOR PASS IN SUBJECT - 60</p>
               
                </td>
                  <?php }?>
                  <?php if($exam_code == 1009 || $exam_code == 1010 || $exam_code == 1011 || $exam_code == 1013 ||  $exam_code == 1017 ||  $exam_code == 1019 ||  $exam_code == 1020 || $exam_code == 1031 || $exam_code == 1032){?>
                  <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;font-weight:bold">
               ...
               Candidates who have completed Level-1 of the examination are required to enrol for Classroom Learning (Level -2). Please note that as per time limit rule candidates need to complete the Classroom Learning within 15 months from the above result declaration date of Level - 1 examination
                  ...
                  <?php //Added by Priyanka W for Dipcert result as per client's requirement ?>
                    <div style="float:right;margin-right:40px;text-align:center">
                      <p><strong>Yours Faithfully</strong></p>
                      <img src="<?php echo base_url();?>assets/images/iibf_officer_sign1.png" style="max-width:40%" />
                      <p>Joint Director<br />Examinations</p>
              ...
              <?php if(in_array($exam_code,array("32","33","47","52","11","51"))){?>
                <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;font-weight:bold">
                  ...
                  <?php if(in_array($exam_code,array("11"))){?>
                    <?php //Added by Priyanka W for Dipcert result as per client's requirement ?>
                      <div style="float:right;margin-right:40px;text-align:center">
                        <p><strong>Yours Faithfully</strong></p>
                        <img src="<?php echo base_url();?>assets/images/iibf_officer_sign1.png" style="max-width:40%" />
            ...
            <?php if(in_array($exam_code,array('50','78','79','148','149','154','160','162','163','165','166','177','175'))){?>
                  ...
                  <?php if(in_array($exam_code,array("78","79","149","162","163","165","166"))){?>
                    <?php //Added by Priyanka W for Dipcert result as per client's requirement ?>
                      <div style="float:right;margin-right:40px;text-align:center">
                        <p><strong>Yours Faithfully</strong></p>
                        <img src="<?php echo base_url();?>assets/images/iibf_officer_sign1.png" style="max-width:40%" />
          ...
          <?php if(in_array($exam_code,array('24','25','26','135','161'))){?>
                  <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;font-weight:bold">
                   ...
                   <?php if(in_array($exam_code,array("24","25","26"))){?>
                    <?php //Added by Priyanka W for Dipcert result as per client's requirement ?>
                      <div style="float:right;margin-right:40px;text-align:center">
                        <p><strong>Yours Faithfully</strong></p>
                        <img src="<?php echo base_url();?>assets/images/iibf_officer_sign1.png" style="max-width:40%" />
        ...
        <tr>
          <td style="border:3px solid #619fda;"><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
              <tr>
                <td style="padding:10px 0; border-bottom:3px solid #619fda;"><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
                    <tr>
                      <td style="padding-left:18px; vertical-align:top;"><img src="<?php echo  base_url()?>assets/images/iibf_logo_short.png"></td>
                      <td class="login-logo" align="center"><a>INDIAN INSTITUTE OF BANKING &amp; FINANCE<br>
                        <small>An ISO 21001:2018 Certified </small><br />
                        <span style="font-size:18px;">KOHINOOR CITY, COMMERCIAL - II, TOWER - 1, 2ND FLOOR<BR />
                        KIROL ROAD, KURLA (WEST), MUMBAI - 400 070</span></a></td>
                        <td valign="top">
                        <!-- <img src="<?php echo base_url()?>assets/images/register-trademark.png" width="40" height="40" /> -->
                        </td>
              ...
              <tr>
                <td style="border-bottom:3px solid #619fda; padding:10px; font-family:'Times New Roman', Times, serif; font-size:13px;">
                  <table width="100%">
                      <tr>
                          <td width="75%">
                              Membership/Registration No: <?php echo $this->session->userdata('result_mem_no')?><br />
              ...
              <tr>
                <td style="border-bottom:3px solid #619fda; padding:5px 10px; font-family: Tahoma, Geneva, sans-serif; font-size:12px;"><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
                    <tr>
                      <td>
                         <?php
            ...
            //}?>
              ...
              <tr>
                <td style="padding:10px; font-size:13px; font-family:'Times New Roman', Times, serif; font-weight:bold;">DEAR CANDIDATE,<br />
                  <br />
                  WE HERE UNDER ADVISE YOUR RESULT OF THE ABOVE EXAMINATION </td>
              </tr>
              <tr>
                <td style="padding:20px 0; font-family:'Times New Roman', Times, serif; font-size:13px;"><table style="border-collapse:collapse;" width="90%" align="center">
                    <tbody>
                      <tr style="border: 1px #6699CC solid;">
                        <th style="border: 1px #6699CC solid;font-weight:bold; padding:5px 0;" class="text2" bgcolor="#e2e2e2" align="center">Subject</th>
                        <th style="border: 1px #6699CC solid;font-weight:bold;" class="text2" bgcolor="#e2e2e2" align="center">Marks Obtained</th>
              ...
              <tr>
                 ...
                 <?php if($exam_code == 1028){?>
                      <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;font-weight:bold">
                   <p style="font-family:'Times New Roman', Times, serif; font-weight:bold;  font-size:13px;">MINIMUM MARKS FOR PASS IN SUBJECT - 25</p>
                   <div style="float:right;margin-right:40px;text-align:center">
                   <p><strong>Yours Faithfully</strong></p>
                   <img src="<?php echo base_url();?>assets/images/iibf_officer_sign1.png" style="max-width:40%" />
                   <p>Joint Director<br />Examinations</p>
          ...
          if($exam_code == 1002 || $exam_code == 1003 || $exam_code == 1004 || $exam_code == 1012 || $exam_code == 1014 ){?>
                  <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;font-weight:bold">
               <p style="font-family:'Times New Roman', Times, serif; font-weight:bold;  font-size:13px;">MINIMUM MARKS FOR PASS IN SUBJECT - 60</p>
               <div style="float:right;margin-right:40px;text-align:center">
               <p><strong>Yours Faithfully</strong></p>
               <img src="<?php echo base_url();?>assets/images/iibf_officer_sign1.png" style="max-width:40%" />
               <p>Joint Director<br />Examinations</p>
                  ...
                  <?php if($exam_code == 1009 || $exam_code == 1010 || $exam_code == 1011 || $exam_code == 1013 || $exam_code == 1017 || $exam_code == 1019 || $exam_code == 1020 || $exam_code == 1031 || $exam_code == 1032){?>
                  <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;font-weight:bold">
               <p style="font-family:'Times New Roman', Times, serif; font-weight:bold;  font-size:13px;">MINIMUM MARKS FOR PASS IN SUBJECT - 50</p>
               <div style="float:right;margin-right:40px;text-align:center">
               <p><strong>Yours Faithfully</strong></p>
               <img src="<?php echo base_url();?>assets/images/iibf_officer_sign1.png" style="max-width:40%" />
               <p>Joint Director<br />Examinations</p>
              ...
              <?php if(in_array($exam_code,array("20"))){?>
               ...
               <p style="font-family:'Times New Roman', Times, serif; font-weight:bold;  font-size:13px;">Passing marks - 50</p>
               Candidates who have completed Level-1 of the examination are required to enrol for Classroom Learning (Level -2). Please note that as per time limit rule candidates need to complete the Classroom Learning within 15 months from the above result declaration date of Level - 1 examination
               <div style="float:right;margin-right:40px;text-align:center">
               <p><strong>Yours Faithfully</strong></p>
               <img src="<?php echo base_url();?>assets/images/iibf_officer_sign1.png" style="max-width:40%" />
...
<div style="float:right;margin-right:40px;text-align:center">
        ...
        <?php if(in_array($exam_code,array('24','25','26','135','161'))){?>
              ...
              <tr>
                <td style="padding:10px; font-size:13px; border-bottom:3px solid #619fda;">
                
                <p style="font-family:'Times New Roman', Times, serif; font-weight:bold;  font-size:13px;">This result advice is issued subject to what is stated below which may please be noted</p>
                  <ol class="result">
                    <li>As per the rules, no request for revaluation of answer paper will be entertained. The facility of verification of marks for online mode will not be available for Objective Type (Multiple Choice Questions) examinations since the evaluation is computerized. </li>
                    <li>In case a candidate has adopted unfair practices, the declaration of results is only provisional and is subject to cancellation in the event of adoption of unfair practices being established. </li>
                    <li>The result of this examination shall also be liable to be cancelled in the event of it being established that the candidate has adopted unfair practices in any previous examination. </li>
              ...
              <tr>
                <td class="footer" colspan="2" width="43%" valign="middle" height="10">Copyright &copy; 2012. INDIAN INSTITUTE OF BANKING AND FINANCE. All rights reserved. 
              </tr>
            </table>
            <!--Table with Border--></td>
        </tr>
