...
<head>
  ...
  <style>
    ...
    {
      .links_outer a:first-child { float: none; display: block; margin: 0 auto 5px auto; max-width: 115px; }
      ...
      <form class="form-horizontal" action="" method="post" name="loginFrm" id="loginFrm" autocomplete="off">
        ...
        <div style="padding: 10px 15px 20px 15px;max-width: 420px;margin: 0 auto;">
          <div class="form-group">
            ...
            <div class="col-sm-12">
              <input type="text" class="form-control" placeholder="Email Id / Mobile Number *" name="email_mobile" id="email_mobile" value='<?php echo set_value('email_mobile'); ?>' required onkeypress="remove_spaces('email_mobile')" onkeyup="remove_spaces('email_mobile')" onkeydown="remove_spaces('email_mobile')">
              <?php if(form_error('email_mobile')!=""){ ?><div class="clearfix"></div><label class="error"><?php echo form_error('email_mobile'); ?></label><?php } ?>
            </div>
          </div>
          ...
          <div class="btn_outer">
            <div class="row">
              <div class="col-xs-12">
                ...
                <button type="submit" class="btn btn-primary btn-flat btn-block" name="forgot_membership_no" id="forgot_membership_no">Submit</button>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      $("#loginFrm").validate({
        ...
        rules: 
        {
          email_mobile: { required: true, remote: { url: "<?php echo site_url('login/validation_email_mobile_forgot_membership_no/0/1'); ?>", type: "post" } },
          code: { required: true, remote: { url: "<?php echo site_url('login/validation_check_captcha_forgot_membership_no/0/1'); ?>", type: "post" } },          
        },
        messages: 
        {
          email_mobile: { required: "Please enter the Email Id / Mobile Number", remote:"Membership details not found for the provided Email Id / Mobile Number" },
