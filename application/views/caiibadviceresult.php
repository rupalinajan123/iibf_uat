    ...
    <td><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
        <tr>
          <td style="border:3px solid #619fda;"><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
              ...
              <tr>
              <?php
              	$frn = array('500054760','500108284','500124570','500124580','500149043','500168936','500216805','500217069','510185646');
			  ?>
                ...
                <?php if(!in_array($user_info->member_number,$frn)){?>
                    ...
                    You have passed CAIIB and eligible to appear for any one of the remaining Elective subjects of CAIIB as a separate Certificate Examination at the <strong>July 2017</strong> examination. Application can be submitted only through Online Mode, for details visit our website www.iibf.org.in. Last date for applying ONLINE is <strong>29th April, 2017</strong>.
                    </td>
                    <?php }else{?>
                    <?php if($user_info->no_of_attempt == 1 || $user_info->no_of_attempt == 3){?>
                    <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">
                    You will receive the Admit Letter <strong>only through Email</strong> for July, 2017 examination 10 days before its scheduled date. In case of non receipt of the same you may download from our website www.iibf.org.in. Please note that you need not apply for the next examination again as you have already paid the exam fees for 2 attempts.
                    
                    </td>
                    <?php }?>
                    <?php if($user_info->no_of_attempt == 2){?>
                    <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">
                    You have completed the 1st Block of 2 attempts,  you are required to submit the application form for the 2nd Block of 2 attempts for appearing at the July, 2017 examination. Application can be submitted only through Online Mode, for details visit our website www.iibf.org.in. Last date for applying ONLINE is <strong> 29th April, 2017</strong> for CAIIB.
                    
                    </td>
                    <?php }?>
                    <?php if($user_info->no_of_attempt == 4){?>
                    <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">
                    You have completed the 2nd Block of 2 attempts. You are required to submit the examination application form afresh for appearing at the July, 2017 examination. You will not be eligible for credit of subjects passed, if any, earlier. Application can be submitted only through Online Mode for details visit our website www.iibf.org.in. Last date for applying ONLINE is <strong>29th April, 2017</strong> for CAIIB.
                    </td>
                    <?php }?>
                    <?php }?>
                <?php }else{?>    
                	<?php if($scnt == count($record)) {?>
                 	<td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">
                    You have passed CAIIB Examination and eligible to appear for CAIIB Electives - July 2017 examination per the rules for appearing from Foreign Centre. Last date for receiving the application form at the Member Support Services of the Institute Mumbai is 29th April, 2017 for CAIIB Electives.
                    </td>
                 <?php }?>
                 <?php if($scnt != count($record)) {?>
                 <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">
                 You are required to apply afresh for June 2017 Examination as per the rules for appearing from Foreign Centre. Last date for receiving the application form at the Member Support Services of the Institute Mumbai is 29th April, 2017 for CAIIB.
                 </td>
                 <?php }?>
                <?php }?>
				<?php }?>
                
                <?php if(in_array($exam_code,array('62',$this->config->item('examCodeCaiibElective63'),'64','65','66','67',$this->config->item('examCodeCaiibElective68'),$this->config->item('examCodeCaiibElective69'),$this->config->item('examCodeCaiibElective70'),$this->config->item('examCodeCaiibElective71'),'72'))){?>
                <?php if($scnt == count($record)) { ?>
                <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">
                You have passed the above Certificate Examination. Eligible to appear for any one of the remaining Electives of CAIIB at the July, 2017 examination. Application can be submitted <strong>only through Online Mode</strong>, for details visit our website www.iibf.org.in  . Last date for applying ONLINE is <strong>29th April, 2017</strong>.
                </td>
                <?php }elseif($scnt != count($record)){?>
                <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">
                You are eligible to re-appear for the above certificate examination at the July, 2017 examination.  Application can be submitted only through Online Mode, for details visit our website www.iibf.org.in. Last date for applying ONLINE is   <strong>29th April, 2017</strong>.
                </td>
                <?php }?>
                <?php }?>
              </tr>
                ...
                <td style="padding:20px 0;"><table style="border-collapse:collapse;" width="90%" align="center">
                  ...
                  <table width="10%" align="center" border="0" cellpadding="0" cellspacing="0" style="padding:30px 0 0;">
                    <tr>
                      ...
                      <td><a href="<?php echo base_url()?>result/caiib" style="background-color:#ddd; color:#000; text-align:center; padding:10px 15px; text-decoration:none;">Back</a></td>
          ...
          <td style="border:3px solid #619fda;"><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
              ...
              <?php if($exam_code == $this->config->item('examCodeCaiib')){?>
                <?php if(!in_array($user_info->member_number,$frn)){?>
                    ...
                    <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">
                    You have passed CAIIB and eligible to appear for any one of the remaining Elective subjects of CAIIB as a separate Certificate Examination at the <strong>July 2017 </strong>examination. Application can be submitted only through Online Mode, for details visit our website www.iibf.org.in. Last date for applying ONLINE is <strong>29th April, 2017</strong>.
                    <div style="float:right;margin-right:40px;text-align:center;margin-top:15px;">
               <p><strong>Yours Faithfully</strong></p>
               <img src="<?php echo base_url();?>assets/images/iibf_officer_sign.jpg" style="max-width:70%" />
