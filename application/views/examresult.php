    ...
    <td><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
        <tr>
          <td style="border:3px solid #619fda;"><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
                ...
                <td style="padding:10px 0; border-bottom:3px solid #619fda;"><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
                    <tr>
                      ...
                      <td class="login-logo" align="center"><a>INDIAN INSTITUTE OF BANKING &amp; FINANCE<br>
                        <small>An ISO 21001:2018 Certified Organisation</small><br />
              ...
              <tr>
                <td style="border-bottom:3px solid #619fda; padding:10px; font-family:'Times New Roman', Times, serif; font-size:15px;">Membership/Registration No: <?php echo $this->session->userdata('exres_regnumber')?><br />
                  ...
                  <?php 
				  		if($user_info->address3 != $user_info->address2){
				  			echo $user_info->address3."<br/>";
                        }
                  ?>
                  <?php 
				  		if($user_info->address4 != $user_info->address3){
				  			echo $user_info->address4."<br/>";
						}
				  ?>
                  <?php 
				  		if($user_info->state != $user_info->address4){
							echo $user_info->state."<br/>";
						}
				  ?>
                  <?php 
				  		if($user_info->district != $user_info->state){
							echo $user_info->district."<br/>";
						}
				  ?>
                  <?php
				  		if($user_info->city != $user_info->district){
							echo $user_info->city."<br/>";
						}
				  ?>
                ...
                <td style="border-bottom:3px solid #619fda; padding:5px 10px; font-family: Tahoma, Geneva, sans-serif; font-size:14px;"><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
                    <tr>
                      <td><strong>Examination<br />
                        CERTIFICATE EXAMINATION FOR <?php echo $exam_name;?></strong></td>
                      <td style="text-align:right;"><strong><?php echo $user_info->venueadd4?>, Dated</strong><br />
                        <?php echo $user_info->date?></td>
                    </tr>
                  </table></td>
              </tr>
              <tr>
              ...
              <tr>
                <td style="padding:20px 0; font-family:'Times New Roman', Times, serif; font-size:14px;"><table style="border-collapse:collapse;" width="90%" align="center">
                    <tbody>
                      ...
                      <tr>
                        <td style="border: 1px #6699CC solid; padding:5px 10px;" class="text2">Inclusive Banking</td>
                        <td style="border: 1px #6699CC solid;" class="text2" align="center">88</td>
                        <td style="border: 1px #6699CC solid;" class="text21" align="center">PASS</td>
                      </tr>
                    </tbody>
                  </table></td>
              </tr>
              <tr>
                <td style="padding:50px 0 90px 10px; font-family:'Times New Roman', Times, serif; font-size:14px; font-weight:bold; border-bottom:3px solid #619fda;">MINIMUM MARKS FOR PASS IN ANY SUBJECT - 50</td>
              </tr>
              <tr>
                ...
                <td style="padding:20px 0;"><table style="border-collapse:collapse;" width="90%" align="center">
                  ...
                  <table width="10%" align="center" border="0" cellpadding="0" cellspacing="0" style="padding:30px 0 0;">
                    <tr>
                      ...
                      <td><a href="#" style="background-color:#ddd; color:#000; text-align:center; padding:10px 15px; text-decoration:none;">Back</a></td>
                    </tr>
                  </table></td>
              </tr>
              <tr>
              ...
              <tr>
                <td style="padding:20px 0;"><table style="border-collapse:collapse;" width="90%" align="center">
                    <tbody>
                      ...
                      <tr>
                        <td style="border:1px;border-style:solid;border-color:#6699CC; padding:5px; text-align:center;"><a style="text-decoration:underline" href="mailto:care@iibf.org.in">care@iibf.org.in</a></td>
                        <td style="border:1px;border-style:solid;border-color:#6699CC; padding:5px; text-align:center;"><a style="text-decoration:underline" href="mailto:iibez@iibf.org.in">iibfez@iibf.org.in</a></td>
                        <td style="border:1px;border-style:solid;border-color:#6699CC; padding:5px; text-align:center;"><a style="text-decoration:underline" href="mailto:iibsz@iibf.org.in">iibfsz@iibf.org.in</a></td>
                        <td style="border:1px;border-style:solid;border-color:#6699CC; padding:5px; text-align:center;"><a style="text-decoration:underline" href="mailto:iibnz@iibf.org.in">iibfnz@iibf.org.in</a></td>
                      </tr>
                    </tbody>
                  </table>
                  </td>
