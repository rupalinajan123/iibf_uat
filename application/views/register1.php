...
Note:  Do not upload your Credit Card/Debit Card scanned image with the application.
  ...
  <div class="container">
  <img src="../../assets/images/iibf_logo_black.png" class="ifci_logo_black" />
			 ...
			 ?> 
               ...
               <div class="form-group">
                ...
                <label for="roleid" class="col-sm-3 control-label">Last Name</label>
                	<div class="col-sm-5">
                      <input type="text" class="form-control" id="middlename" name="lastname" placeholder="Last Name"  value="<?php echo set_value('lastname');?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" >
...
<div class="box-header with-border nobg">
              ...
              <div class="form-group">
                <label for="roleid" class="col-sm-3 control-label">State *</label>
                    ...
                    <input hidden="statepincode" id="statepincode" value="">
                     ...
                     <div class="col-sm-2">
                        <input type="text" class="form-control" id="pincode" name="pincode" placeholder="Pincode/Zipcode" required value="<?php echo set_value('pincode');?>"  data-parsley-maxlength="6" maxlength="6" size="6" data-parsley-checkpin data-parsley-type="number" > 
                ...
                <label for="roleid" class="col-sm-3 control-label">Date of Birth *</label>
                    ...
                    <div class="col-sm-2 example">
                        <input type="hidden" id="example4" name="dob" required>
                        <?php 
               ...
               <div class="form-group">
                ...
                <label for="roleid" class="col-sm-3 control-label">Qualification *</label>
                	<div class="col-sm-4">
                      <input type="radio" class="minimal" id="U"  attr="optedu"  name="optedu" value="U" onclick="changedu(this.value)" <?php echo set_radio('optedu', 'U'); ?>>
                        Under Graduate
			  ...
			  {echo 'style="display:block"';}?>  id="edu">
				...
				<option value="" selected="selected">--Select--</option>
                	...
                	<div class="col-sm-5"  <?php if(set_value('optedu')=='U'){echo 'style="display:block;"';}else if(!set_value('optedu')){echo 'style="display:none;"';}else{echo 'style="display:none;"';}?> id="UG">
                      <select class="form-control" id="eduqual1" name="eduqual1" required>
                        <option value="">--Select--</option>
         ...
         <div class="form-group">
                <label for="roleid" class="col-sm-3 control-label">Branch/Office *</label>
                	<div class="col-sm-5">
                      <input type="text" class="form-control" id="office" name="office" placeholder="Branch/Office" required value="<?php echo set_value('office');?>"  data-parsley-maxlength="20" >
             ...
             <label for="roleid" class="col-sm-3 control-label">Designation *</label>
              <div class="col-sm-5"  style="display:block" >
                ...
                <label for="roleid" class="col-sm-3 control-label">Email *</label>
                	<div class="col-sm-5">
                      <input type="text" class="form-control" id="email" name="email" placeholder="Email"  data-parsley-type="email" value="<?php echo set_value('email');?>"  data-parsley-maxlength="30" required  data-parsley-emailcheck/ >
                ...
                <label for="roleid" class="col-sm-3 control-label">Phone : STD Code</label>
                	<div class="col-sm-2">
                    	<input type="text" class="form-control pull-right" id="stdcode"  name="stdcode" placeholder="STD Code"  value="<?php echo set_value('stdcode');?>" >
                      <span class="error"><?php //echo form_error('stdcode');?></span>
                    </div>
                     <label for="roleid" class="col-sm-1 control-label"> Phone No</label>
                    <div class="col-sm-2">
                ...
                <label for="roleid" class="col-sm-3 control-label">Mobile *</label>
                	<div class="col-sm-5">
                      <input type="tel" class="form-control" id="mobile" name="mobile" placeholder="Mobile" data-parsley-type="number"  data-parsley-minlength="10" data-parsley-maxlength="12"  value="<?php echo set_value('mobile');?>"  required  data-parsley-mobilecheck >
                ...
                <label for="roleid" class="col-sm-3 control-label">ID No. *</label>
                	<div class="col-sm-5">
                       <input type="text" class="form-control pull-right" id="idNo"  name="idNo" placeholder="ID No." required value="<?php echo set_value('idNo');?>" >
            ...
            <div class="box-body blue_bg">
                ...
                <label for="roleid" class="col-sm-1 control-label"> Note</label>
                	<div class="col-sm-11">
                   1. I declare that I have submitted proof of my identity : Aadhaar ID/ Employer's card/PAN Card/Driving License/Election voter's card/Passport.
		<br>
		2. I hereby declare that all the information given in this application is true, complete and correct. I understand that in the event of any information being found false or incorrect subsequent to allotment of membership, my membership is liable to be cancelled / terminated.
		<br>
		3. I further declare that I have not at any time been a member of the Institute/applied earlier for membership of the Institute.
		<br>
		4. I hereby agree, if admitted, to be bound by the Memorandum and Articles of Association of the Institute. I am aware that, if admitted as an Ordinary Member, as per the provisions of the Articles of Association of the Institute. I shall be liable, in the event of the Institute begin wound up, to contribute towards its liabilities a sum not exceeding Rs. 1725/-
		<br>
		5. I confirm having read and understood the rules and regulations of the Institute and I hereby agree to abide by the same. In case I am desirous of Instituting any legal proceedings against the Institute I hereby agree that such legal proceedings shall be instituted only in courts at Mumbai, New Delhi, Kolkata and Chennai in whose Jurisdiction Zonal office/s of the Institute is situated and my application thereto pertains and not in any other court
                    </div>
                </div>
             ...
             <div class="form-group m_t_15">
                <label for="roleid" class="col-sm-3 control-label">Security Code *</label>
                	<div class="col-sm-2">
                      <input type="text" name="code" id="code" required class="form-control pull-right" >
...
<script type="text/javascript">
	...
	//$('#datepicker').data({date: '2012-08-08'});
	
	/*$('#datepicker').datepicker({format: 'yyyy-mm-dd',autoclose: true,endDate: '-18y',startDate: '-60y'}).on('changeDate', function(){
		$('#doj').datepicker('setStartDate', new Date($(this).val()));
	});*/
