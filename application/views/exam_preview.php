  ...
  <div class="content-wrapper">
    ...
    <?php 
		...
		$function = "Msuccess";	
    ?>
	<form class="form-horizontal" name="member_exam_comApplication" id="member_exam_comApplication"  method="post"  enctype="multipart/form-data" action="<?php echo base_url();?>Home/<?php echo $function;?>/">
   <input type="hidden" name="regid" id="regid" value="<?php echo $this->session->userdata('regid');?>"> 
   <input type="hidden" name="optval" id="optval" value="<?php echo $this->session->userdata['examinfo']['optval'];?>"> 
          ...
          <div class="box box-info">
                  ...
                  <div class="form-group col-md-2">
                      ...
                      <?php 
                            ...
                            {?>
                                        ...
                                        <label class="signlabel">Signature</label>
                                        <?php 
                            }
                            else
                            {?>
            ...
            <div class="box-body">
                <?php if( $this->session->userdata('examcode') == 1009 ) { ?>
                    <div class="form-group">
                        <label for="roleid" class="col-sm-3 control-label">Institute Name
                        </label>
                    	<div class="col-sm-5 ">
             ...
             ?>
			   ...
			   /*if($this->session->userdata['examinfo']['elected_exam_mode']=='E' && base64_decode($this->session->userdata['examinfo']['excd'])!=21 && !in_array(base64_decode($this->session->userdata['examinfo']['excd']),$elective_exam_code))
			  {*/?>
          	      <!--<div class="form-group">
			  ...
			  //}?>
                ...
                <label for="roleid" class="col-sm-3 control-label">Centre Name *</label>
                	<div class="col-sm-2" style="color:red;font-weight: bold; ">
                   <?php 
...
<!--B) Since the Institute will not be sending the Admit Letter(hard copy) through post, Correct E-mail address is mandatory for receipt of Admit Letter/Hall Ticket through e-mail.-->
	...
	<?php  }?>
				   ...
				   <a href="<?php echo base_url();?>Home/comApplication<?php if($this->session->userdata['examinfo']['optval']!='') echo '?optval='.$this->session->userdata['examinfo']['optval']; ?>" class="btn btn-info" id="preview">Back</a>
