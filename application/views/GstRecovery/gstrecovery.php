...
<div class="container">
  <section class="content-header box-header with-border" style="height: 45px; background-color: #1287C0; ">
    <h1 class="register">GST Recovery Form</h1>
    <br />
	</section>
  <section class="">
    <div class="row">
      <div class="col-md-12 col-sm-12" style="">
        <?php if ($this->session->flashdata('flsh_msg') != '') {?>
				...
				<?php }?>
        <form name="getDetailsForm" id="getDetailsForm" method="post" action="<?php echo base_url(); ?>GstRecovery" autocomplete="off" >
          <br />
          <div class="">
						<div class="row">
            <div for="roleid" class="col-sm-12 control-label" style="text-align: right; width:35%;">Membership No.&nbsp;<span style="color:#F00">*</span>&nbsp;:
						</div>
            <div class="col-sm-12 col-md-3">
              <input type="text" class="form-control" id="regnumber" name="regnumber" placeholder="Membership No." required value="<?php if (isset($row['regnumber'])) { echo $row['regnumber'];} else { echo set_value('regnumber'); }
					...
					<?php if(empty($MemberArray)) { ?>
							<div class="row">
								<br/>
								<div for="roleid" class="col-sm-12 control-label" style="text-align: right; width:35%;">Type the exact characters you see in the picture.&nbsp;<span style="color:#F00">*</span>&nbsp;:</div>
								<div class="col-sm-12 col-md-3">
									<input type="text" class="form-control" name="code" autocomplete="off"  style="padding-right:10px !important; margin-bottom:5px;" required>
									<label> 
										<div id="captcha_img"><?php echo $image;?></div>
										<a href="javascript:void(0);" id="new_captcha" class="forget" style="font-weight:500">Change Image</a>
									</label>                
								</div>
							</div>
						<?php }?>
            <div class="row">
							<div class="col-sm-12 control-label" style="text-align: right; width:35%;"><br></div>
							<div class="col-sm-12 col-md-3">
              <?php 
								if (isset($row['regnumber']) || set_value('regnumber')) {
								?>
								<a href="<?php echo base_url();?>GstRecovery" class="btn btn-warning" id="modify" style="margin-top:10px;">Reset</a>
									...
									<?php 
										...
										<tr>
											...
											<td><?php 
												...
												<td><span>&#8377;</span>&nbsp;<?php if($value['fee_amt'] == '8.00'){ echo $value['fee_amt']; } else { echo $value['igst_amt']; } ?></td>
												<td><?php  
													...
													?>
													<a href="<?php echo base_url();?>GstRecovery/stored_details/<?php echo base64_encode($value['gst_recovery_master_pk']); ?>" class="btn btn-info" style="width: 75px;">Pay Now</a>
												<?php }?></td>
										</tr>
										<?php 
											$sr++;
...
$(function(){
		...
		$('#new_captcha').click(function(event){
			...
			$.ajax({
				type: 'POST',
				url: site_url+'GstRecovery/generatecaptchaajax/',
