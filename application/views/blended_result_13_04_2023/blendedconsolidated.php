...
<strong><?php echo $user_info->mem_name?></strong> <br /> <BR />
...
Pin :<?php echo $user_info->pin_code?>
   ...
   <td style=" font-family: Tahoma, Geneva, sans-serif; font-size:13px;">
     <table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
       <tr>
         <td style="border-right:1px solid #28aae2;  padding:5px 10px;"><strong> &nbsp;&nbsp;&nbsp;This is to certify that <?php echo $user_info->mem_name?> has passed <?php echo preg_replace("/\([^)]+\)/","",$exam_name);?> Examination.Following are the details of  the same </strong></td>
       </tr>
      </table>
   </td>
   </tr>
