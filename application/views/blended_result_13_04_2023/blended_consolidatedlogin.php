         ...
         <tr>
           <td>
             <table border="0" cellpadding="0" cellspacing="0" width="80%" align="center">
               <tr>
                 <td style="text-align:center; padding:60px 0 25px; font-size:22px; font-family:Tahoma, Geneva, sans-serif; font-weight:bold; line-height:32px;">Results for Blended  Course</td>
               </tr>
               <tr>
                <td bgcolor="#6699CC">
                    ...
                    <tr>
                      ...
                      <td class="content" width="55%" bgcolor="#d8e4f1">
                        <select name="exam" id="exam" class="text1" style="min-width:218px;">
                          ...
                          <option value="18">CERTIFIED BANK TRAINER</option>
                          <option value="19">CERTIFIED BANKING COMPLIANCE PROFESSIONAL</option>
                          <option value="20">CERTIFIED CREDIT PROFESSIONAL</option>
                          <option value="59">CERTIFIED TREASURY PROFESSIONALS</option>
                          <option value="81">CERTIFICATE IN RISK IN FINANCIAL SERVICES LEVEL-1</option>
                          <option value="164">CERTIFIED ACCOUNTING & AUDIT PROFESSIONAL</option>
                          <option value="1005">CERTIFIED CREDIT PROFESSIONAL-(RPE)</option>
                          <option value="1006">CERTIFIED TREASURY PROFESSIONALS-NEW(RPE)</option>
                          <option value="1007">CERTIFICATE IN RISK IN FINANCIAL SERVICES LEVEL-1 -(RPE)</option>
                          <option value="1008">CERTIFIED ACCOUNTING & AUDIT PROFESSIONAL-(RPE)</option>
                        </select>
                      </td>
                    </tr>
                    <tr>
