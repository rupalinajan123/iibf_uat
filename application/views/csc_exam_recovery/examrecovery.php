...
<div class="container">
  <section class="content-header box-header with-border" style="height: 45px; background-color: #1287C0; ">
    <h1 class="register">Exam Recovery Form</h1>
    <br />
  </section>
  <section class="">
    <div class="row">
      <div class="col-md-12 col-sm-12" style="">
        ...
        <?php }?>
        <form name="getDetailsForm" id="getDetailsForm" method="post" action="<?php echo base_url(); ?>Csc_exam_recovery">
          <br />
          <div class="">
            <div for="roleid" class="col-sm-12 control-label" style="text-align: right; width:35%;">Registration Number &nbsp;<span style="color:#F00">*</span>&nbsp;:</div>
            <div class="col-sm-12 col-md-3">
              <input type="text" class="form-control" id="regnumber" name="regnumber" placeholder="Registration Number" required value="<?php if (isset($row['regnumber'])) { echo $row['regnumber'];} else { echo set_value('regnumber'); }
?>" <?php if (isset($row['regnumber'])) { echo "readonly='readonly'";} elseif (set_value('regnumber')) { echo "readonly='readonly'"; } ?> style="border-color:#000;" title="Membership No.">
            ...
            <div class="col-sm-12 col-md-3">
              <?php 
				...
				?>
              <a href="<?php echo base_url();?>Csc_exam_recovery" class="btn btn-warning" id="modify" style="">Reset</a>
                ...
                <tr>
                  ...
                  <td><?php  
                    ...
                    <?php
                        ...
                        ?>
                    <a href="<?php echo base_url();?>Csc_exam_recovery/stored_details/<?php echo base64_encode($value['invoice_id']); ?>" class="btn btn-info" style="width: 75px;">Pay Now</a>
                    <?php }?></td>
                </tr>
                <?php 
			  $sr++;
