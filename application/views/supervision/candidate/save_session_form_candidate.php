...
<html>
    ...
    <?php $this->load->view('supervision/common/inc_loader'); ?>
      ...
      <?php $this->load->view('supervision/candidate/inc_topbar_candidate'); ?>
              ...
              <li class="breadcrumb-item">Masters</li>
							<li class="breadcrumb-item"><a href="<?php echo site_url('supervision/candidate/dashboard_candidate/session_forms'); ?>">Supervision Report</a></li>
          ...
          <div class="row">
							...
							<div class="ibox">
								<div class="ibox-title">
									<div class="ibox-tools">
										<a href="<?php echo site_url('supervision/candidate/dashboard_candidate/session_forms'); ?>" class="btn btn-danger custom_right_add_new_btn">Back</a>
                  </div>
                </div>
                  ...
                  <form method="post" action="<?php echo site_url('supervision/candidate/dashboard_candidate/save_session_form/'.$enc_form_id); ?>" id="add_form" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="row">                      
                      ...
                      <div class="col-xl-6 col-lg-6"><?php /* pdc_zone */ ?>
                        <div class="form-group">
                    ...
                    <div class="row">                      
                      ...
                      <div class="col-xl-6 col-lg-6">
                        <div class="form-group">
                          ...
                          <select class="form-control chosen-select exam_code"  name="exam_code_period" id="exam_code"  required onchange="get_exam_venue_ajax(this.value); validate_input('exam_code'); ">
                          <option value="">Select</option>
                            <?php foreach($exams as $exam) {
                              ?>
                              <option exam_period="<?php echo $exam['exam_code'] ?>" <?php if($mode == "Add") { if(set_value('exam_code') == $exam['exam_code']) echo'selected';  } elseif($form_data[0]['exam_code']==$exam['exam_code']) {echo'selected';} ?> value="<?php echo $exam['exam_code'] ?>-<?php echo $exam['exam_period'] ?>"><?php echo $exam['exam_name'] ?>-<?php echo $exam['exam_month'] ?></option>
                              <?php
                            } ?>
                        </select>
                            ...
                            <select class="form-control chosen-select venue_code" name="venue_code" id="venue_code" required onchange="get_exam_date_ajax(this.value);validate_input('venue_code'); ">
                              <?php $exam_code = '';
                                ...
                                if($exam_code != "")
                                {
                                  ...
                                  $venue_data = $this->master_model->getRecords('supervision_venue_master', array('center_code' => $candidate_data[0]['center_code'],'exam_code' => $exam_code, 'venue_delete' => '0'), 'id, venue_name,venue_code,venue_name,venue_addr1,venue_addr2,venue_addr3,venue_addr4,venue_addr5', array('venue_name'=>'ASC'));
                      ...
                      <div class="col-xl-6 col-lg-6"><?php /* Select exam time */ ?>
                        <div class="form-group">
                          ...
                          <div id="exam_time_outer">
                            <select multiple class="form-control chosen-select exam_time" name="exam_time[]" id="exam_time" required onchange="validate_input('exam_time'); ">
                              <?php $exam_code = $venue_code='';
                                if($mode == "Add")
                                {
                                  if(set_value('exam_code') != "") { $exam_code = set_value('exam_code'); }
                                ...
                                if($exam_code != "" && $venue_code != "" && $exam_date != "")
                                {
                                  ...
                                  <?php foreach($exam_times_data as $exam_time)
                                    { ?>
                                    <option class="<?php echo $i++; ?> " id="<?php echo explode(' ',$exam_time['session_time'])[0]; ?>" value="<?php echo $exam_time['session_time']; ?>" <?php if($mode == "Add") { if(isset($_POST['exam_time']) && in_array($exam_time['session_time'],$_POST['exam_time'])) { echo "selected"; } } else { if(in_array($exam_time['session_time'],$exam_time_arr) ) { echo "selected"; } } ?>><?php echo $exam_time['session_time']; ?></option>
                                    <?php }
                                  }
                                  else
                                  { ?>
                          ...
                          <div style="color:red;font-weight: 700;">Please select all the time slots supervised by you from the drop down</div>
                          ...
                          <div class="form-group">
                            ...
                            <div id="suitable_venue_loc_err">
                              <label class="css_checkbox_radio radio_only"> Yes
                                <input type="radio" value="Yes" name="suitable_venue_loc" required <?php if($mode == "Add") { if(set_value('suitable_venue_loc') == "" || set_value('suitable_venue_loc') == 'Yes') { echo "checked"; } } else { if($form_data[0]['suitable_venue_loc']=='Yes') { echo "checked"; } } ?>>
                                <span class="radiobtn"></span>
                              </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              
                              <label class="css_checkbox_radio radio_only"> No
                                <input type="radio" value="No" name="suitable_venue_loc" required <?php if($mode == "Add") { if( set_value('suitable_venue_loc') == 'No') { echo "checked"; } } else { if($form_data[0]['suitable_venue_loc']=='No') { echo "checked"; } } ?>>
                                <span class="radiobtn"></span>
                              </label>
                            </div>
                        ...
                        <div class="form-group suitable_venue_loc_reason_div" style="<?php if($mode == "Update" && isset($form_data) && $form_data[0]['suitable_venue_loc']=='Yes') { } else echo 'display:none'; ?>">
                          ...
                          <note class="form_note" id="suitable_venue_loc_reason_err"></note>
                        ...
                        <div class="col-xl-6 col-lg-6"><?php /* opened */ ?>
                          <div class="form-group">
                            ...
                            <div id="venue_open_bef_exam_err">
                              <label class="css_checkbox_radio radio_only"> Yes
                                <input type="radio" value="Yes" name="venue_open_bef_exam" required <?php if($mode == "Add") { if(set_value('venue_open_bef_exam') == "" || set_value('venue_open_bef_exam') == 'Yes') { echo "checked"; } } else { if($form_data[0]['venue_open_bef_exam']=='Yes') { echo "checked"; } } ?>>
                                <span class="radiobtn"></span>
                              </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              
                              <label class="css_checkbox_radio radio_only"> No
                                <input type="radio" value="No" name="venue_open_bef_exam" required <?php if($mode == "Add") { if(set_value('venue_open_bef_exam') == 'No') { echo "checked"; } } else { if($form_data[0]['venue_open_bef_exam']=='No') { echo "checked"; } } ?>>
                                <span class="radiobtn"></span>
                              </label>
                            </div>
                        ...
                        <div class="form-group venue_open_bef_exam_reason_div" style="<?php if($mode == "Update" && isset($form_data) && $form_data[0]['venue_open_bef_exam']=='Yes') { } else echo 'display:none'; ?>">
                          ...
                          <note class="form_note" id="venue_open_bef_exam_reason_err"></note>
                      ...
                      <div class="col-xl-12 col-lg-12"><?php /*Number Of PC */ ?>
                        <div class="form-group">
                          ...
                          <note class="form_note" id="no_of_pc_err"></note>
                        ...
                        <div class="col-xl-6 col-lg-6"><?php /* reserved */ ?>
                          <div class="form-group">
                            ...
                            <div id="venue_reserved">
                              <label class="css_checkbox_radio radio_only"> Yes
                                <input type="radio" value="Yes" name="venue_reserved" required <?php if($mode == "Add") { if(set_value('venue_reserved') == "" || set_value('venue_reserved') == 'Yes') { echo "checked"; } } else { if($form_data[0]['venue_reserved']=='Yes') { echo "checked"; } } ?>>
                                <span class="radiobtn"></span>
                              </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              
                              <label class="css_checkbox_radio radio_only"> No
                                <input type="radio" value="No" name="venue_reserved" required <?php if($mode == "Add") { if(set_value('venue_reserved') == 'No') { echo "checked"; } } else { if($form_data[0]['venue_reserved']=='No') { echo "checked"; } } ?>>
                                <span class="radiobtn"></span>
                              </label>
                            </div>
                            <note class="form_note" id="venue_reserved_err"></note>
                        ...
                        <div class="col-xl-6 col-lg-6"><?php /* Reason */ ?>
                          <div class="form-group venue_reserved_reason_div" style="<?php if($mode == "Update" && isset($form_data) && $form_data[0]['venue_reserved']=='Yes') { } else echo 'display:none'; ?>">
                            ...
                            <note class="form_note" id="venue_reserved_reason_err"></note>
                      ...
                      <div class="col-xl-12 col-lg-12"><?php /* power problem */ ?>
                          <div class="form-group">
                            ...
                            <note class="form_note" id="venue_power_problem_err"></note>
                        ...
                        <div class="col-xl-12 col-lg-12"><?php /* sol */ ?>
                          <div class="form-group venue_power_problem_sol_div" style="<?php if($mode == "Update" && isset($form_data) && $form_data[0]['venue_power_problem']=='Yes') { } else echo 'display:none'; ?>">
                            ...
                            <note class="form_note" id="venue_power_problem_sol_err"></note>
                      ...
                      <div class="col-xl-12 col-lg-12"><?php /* sol */ ?>
                          <div class="form-group">
                            ...
                            <note class="form_note" id="no_of_supervisors_err"></note>
                      ...
                      <div class="col-xl-6 col-lg-6"><?php /* registration */ ?>
                          <div class="form-group">
                            ...
                            <div id="registration_process">
                              <label class="css_checkbox_radio radio_only"> Yes
                                <input type="radio" value="Yes" name="registration_process" required <?php if($mode == "Add") { if(set_value('registration_process') == "" || set_value('registration_process') == 'Yes') { echo "checked"; } } else { if($form_data[0]['registration_process']=='Yes') { echo "checked"; } } ?>>
                                <span class="radiobtn"></span>
                              </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              
                              <label class="css_checkbox_radio radio_only"> No
                                <input type="radio" value="No" name="registration_process" required <?php if($mode == "Add") { if( set_value('registration_process') == 'No') { echo "checked"; } } else { if($form_data[0]['registration_process']=='No') { echo "checked"; } } ?>>
                                <span class="radiobtn"></span>
                              </label>
                            </div>
                            <note class="form_note" id="registration_process_err"></note>
                        ...
                        <div class="col-xl-6 col-lg-6"><?php /* Reason */ ?>
                          <div class="form-group registration_process_reason_div" style="<?php if($mode == "Update" && isset($form_data) && $form_data[0]['registration_process']=='Yes') { } else echo 'display:none'; ?>">
                            ...
                            <note class="form_note" id="registration_process_reason_err"></note>
                      ...
                      <div class="col-xl-6 col-lg-6"><?php /* frisking */ ?>
                          <div class="form-group">
                            ...
                            <div id="frisking">
                              <label class="css_checkbox_radio radio_only"> Yes
                                <input type="radio" value="Yes" name="frisking" required <?php if($mode == "Add") { if(set_value('frisking') == "" || set_value('frisking') == 'Yes') { echo "checked"; } } else { if($form_data[0]['frisking']=='Yes') { echo "checked"; } } ?>>
                                <span class="radiobtn"></span>
                              </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              
                              <label class="css_checkbox_radio radio_only"> No
                                <input type="radio" value="No" name="frisking" required <?php if($mode == "Add") { if( set_value('frisking') == 'No') { echo "checked"; } } else { if($form_data[0]['frisking']=='No') { echo "checked"; } } ?>>
                                <span class="radiobtn"></span>
                              </label>
                            </div>
                            <note class="form_note" id="frisking_err"></note>
                        ...
                        <div class="col-xl-6 col-lg-6"><?php /* Reason */ ?>
                          <div class="form-group frisking_reason_div" style="<?php if($mode == "Update" && isset($form_data) && $form_data[0]['frisking']=='Yes') { } else echo 'display:none'; ?>">
                            ...
                            <note class="form_note" id="frisking_reason_err"></note>
                      ...
                      <div class="col-xl-6 col-lg-6"><?php /* frisking lady */ ?>
                          <div class="form-group">
                            ...
                            <div id="frisking">
                              <label class="css_checkbox_radio radio_only"> Yes
                                <input type="radio" value="Yes" name="frisking_lady" required <?php if($mode == "Add") { if(set_value('frisking_lady') == "" ||  set_value('frisking_lady') == 'Yes') { echo "checked"; } } else { if($form_data[0]['frisking_lady']=='Yes') { echo "checked"; } } ?>>
                                <span class="radiobtn"></span>
                              </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              
                              <label class="css_checkbox_radio radio_only"> No
                                <input type="radio" value="No" name="frisking_lady" required <?php if($mode == "Add") { if(set_value('frisking_lady') == 'No') { echo "checked"; } } else { if($form_data[0]['frisking_lady']=='No') { echo "checked"; } } ?>>
                                <span class="radiobtn"></span>
                              </label>
                            </div>
                            <note class="form_note" id="frisking_lady_err"></note>
                        ...
                        <div class="col-xl-6 col-lg-6"><?php /* Reason */ ?>
                          <div class="form-group frisking_lady_reason_div"  style="<?php if($mode == "Update" && isset($form_data) && $form_data[0]['frisking_lady']=='Yes') { } else echo 'display:none'; ?>">
                            ...
                            <note class="form_note" id="frisking_lady_reason_err"></note>
                      ...
                      <div class="col-xl-6 col-lg-6"><?php /* mobile_allowed */ ?>
                          <div class="form-group">
                            ...
                            <note class="form_note" id="mobile_allowed_err"></note>
                        ...
                        <div class="col-xl-6 col-lg-6"><?php /* Reason */ ?>
                          <div class="form-group mobile_allowed_reason_div"  style="<?php if($mode == "Update" && isset($form_data) && $form_data[0]['mobile_allowed']=='Yes') { } else echo 'display:none'; ?>">
                            ...
                            <note class="form_note" id="mobile_allowed_reason_err"></note>
                      ...
                      <div class="col-xl-6 col-lg-6"><?php /* admit_letter_checked */ ?>
                          <div class="form-group">
                            ...
                            <div id="admit_letter_checked">
                              <label class="css_checkbox_radio radio_only"> Yes
                                <input type="radio" value="Yes" name="admit_letter_checked" required <?php if($mode == "Add") { if(set_value('admit_letter_checked') == "" ||  set_value('admit_letter_checked') == 'Yes') { echo "checked"; } } else { if($form_data[0]['admit_letter_checked']=='Yes') { echo "checked"; } } ?>>
                                <span class="radiobtn"></span>
                              </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              
                              <label class="css_checkbox_radio radio_only"> No
                                <input type="radio" value="No" name="admit_letter_checked" required <?php if($mode == "Add") { if(set_value('admit_letter_checked') == 'No') { echo "checked"; } } else { if($form_data[0]['admit_letter_checked']=='No') { echo "checked"; } } ?>>
                                <span class="radiobtn"></span>
                              </label>
                            </div>
                            <note class="form_note" id="admit_letter_checked_err"></note>
                        ...
                        <div class="col-xl-6 col-lg-6"><?php /* Reason */ ?>
                          <div class="form-group admit_letter_checked_reason_div"  style="<?php if($mode == "Update" && isset($form_data) && $form_data[0]['admit_letter_checked']=='Yes') { } else echo 'display:none'; ?>">
                            ...
                            <note class="form_note" id="admit_letter_checked_reason_err"></note>
                      ...
                      <div class="col-xl-6 col-lg-6"><?php /* exam_without_admit_letter */ ?>
                          <div class="form-group">
                            ...
                            <note class="form_note" id="exam_without_admit_letter_err"></note>
                        ...
                        <div class="col-xl-6 col-lg-6"><?php /* Give Details */ ?>
                          <div class="form-group exam_without_admit_letter_detils_div"  style="<?php if($mode == "Update" && isset($form_data) && $form_data[0]['exam_without_admit_letter']=='Yes') { } else echo 'display:none'; ?>">
                            ...
                            <note class="form_note" id="exam_without_admit_letter_detils_err"></note>
                      ...
                      <div class="col-xl-6 col-lg-6"><?php /* seat_no_written */ ?>
                          <div class="form-group">
                            ...
                            <div id="seat_no_written">
                              <label class="css_checkbox_radio radio_only"> Yes
                                <input type="radio" value="Yes" name="seat_no_written" required <?php if($mode == "Add") { if(set_value('seat_no_written') == "" || set_value('seat_no_written') == 'Yes') { echo "checked"; } } else { if($form_data[0]['seat_no_written']=='Yes') { echo "checked"; } } ?>>
                                <span class="radiobtn"></span>
                              </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              
                              <label class="css_checkbox_radio radio_only"> No
                                <input type="radio" value="No" name="seat_no_written" required <?php if($mode == "Add") { if(set_value('seat_no_written') == 'No') { echo "checked"; } } else { if($form_data[0]['seat_no_written']=='No') { echo "checked"; } } ?>>
                                <span class="radiobtn"></span>
                              </label>
                            </div>
                            <note class="form_note" id="seat_no_written_err"></note>
                        ...
                        <div class="col-xl-6 col-lg-6"><?php /* Give Details */ ?>
                          <div class="form-group seat_no_written_reason_div"  style="<?php if($mode == "Update" && isset($form_data) && $form_data[0]['seat_no_written']=='Yes') { } else echo 'display:none'; ?>">
                            ...
                            <note class="form_note" id="seat_no_written_reason_err"></note>
                      ...
                      <div class="col-xl-6 col-lg-6"><?php /* candidate_seated */ ?>
                          <div class="form-group">
                            ...
                            <div id="candidate_seated">
                              <label class="css_checkbox_radio radio_only"> Yes
                                <input type="radio" value="Yes" name="candidate_seated" required <?php if($mode == "Add") { if(set_value('candidate_seated') == "" ||set_value('candidate_seated') == 'Yes') { echo "checked"; } } else { if($form_data[0]['candidate_seated']=='Yes') { echo "checked"; } } ?>>
                                <span class="radiobtn"></span>
                              </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              
                              <label class="css_checkbox_radio radio_only"> No
                                <input type="radio" value="No" name="candidate_seated" required <?php if($mode == "Add") { if( set_value('candidate_seated') == 'No') { echo "checked"; } } else { if($form_data[0]['candidate_seated']=='No') { echo "checked"; } } ?>>
                                <span class="radiobtn"></span>
                              </label>
                            </div>
                            <note class="form_note" id="candidate_seated_err"></note>
                        ...
                        <div class="col-xl-6 col-lg-6"><?php /* reason */ ?>
                          <div class="form-group candidate_seated_reason_div" style="<?php if($mode == "Update" && isset($form_data) && $form_data[0]['candidate_seated']=='Yes') { } else echo 'display:none'; ?>">
                            ...
                            <note class="form_note" id="candidate_seated_reason_err"></note>
                      ...
                      <div class="col-xl-12 col-lg-12"><?php /* scribe_arrange */ ?>
                          <div class="form-group">
                            ...
                            <div id="scribe_arrange">
                              <label class="css_checkbox_radio radio_only"> Yes
                                <input type="radio" value="Yes" name="scribe_arrange" required <?php if($mode == "Add") { if(set_value('scribe_arrange') == "" || set_value('scribe_arrange') == 'Yes') { echo "checked"; } } else { if($form_data[0]['scribe_arrange']=='Yes') { echo "checked"; } } ?>>
                                <span class="radiobtn"></span>
                              </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              
                              <label class="css_checkbox_radio radio_only"> No
                                <input type="radio" value="No" name="scribe_arrange" required <?php if($mode == "Add") { if(set_value('scribe_arrange') == 'No') { echo "checked"; } } else { if($form_data[0]['scribe_arrange']=='No') { echo "checked"; } } ?>>
                                <span class="radiobtn"></span>
                              </label>
                            </div>
                            <note class="form_note" id="scribe_arrange_err"></note>
                        ...
                        <div class="col-xl-12 col-lg-12"><?php /* reason */ ?>
                          <div class="form-group scribe_arrange_reason_div" style="<?php if($mode == "Update" && isset($form_data) && $form_data[0]['scribe_arrange']=='Yes') { } else echo 'display:none'; ?>">
                            ...
                            <note class="form_note" id="scribe_arrange_reason_err"></note>
                      ...
                      <div class="col-xl-12 col-lg-12"><?php /* announcement */ ?>
                          <div class="form-group">
                            ...
                            <note class="form_note" id="announcement_err"></note>
                        ...
                        <div class="col-xl-12 col-lg-12"><?php /* reason */ ?>
                          <div class="form-group announcement_gap_div" ><!--style="<?php if($mode == "Update" && isset($form_data) && $form_data[0]['announcement']=='Yes') { } else echo 'display:none'; ?>" -->
                            ...
                            <note class="form_note" id="announcement_gap_err"></note>
                      ...
                      <div class="col-xl-6 col-lg-6"><?php /* exam_started */ ?>
                          <div class="form-group">
                            ...
                            <note class="form_note" id="exam_started_err"></note>
                            <?php if(form_error('exam_started')!=""){ ?> <div class="clearfix"></div><label class="error"><?php echo form_error('exam_started'); ?></label> <?php } ?>
                          </div>					
                        </div>

                        <div class="col-xl-6 col-lg-6"><?php /* reason */ ?>
                          <div class="form-group exam_started_reason_div" >
                            <label for="exam_started_reason" class="form_label">Reason <sup class="text-danger"></sup></label>
                            <input required type="text" name="exam_started_reason"  id="exam_started_reason" value="<?php if($mode == "Add") { echo set_value('exam_started_reason'); } else { echo $form_data[0]['exam_started_reason']; } ?>" placeholder="Reason" class="form-control custom_input exam_started_reason" maxlength="500"  onchange="validate_input('exam_started_reason')"/>
                            <note class="form_note" id="exam_started_reason_err"></note>
                      ...
                      <div class="col-xl-12 col-lg-12"><?php /* candidate_appeared */ ?>
                          ...
                          <div class="form-group candidate_appeared1 candidate_appeared_div" <?php if($mode == "Add" && isset($_POST['candidate_appeared1']) && $_POST['candidate_appeared1']!='') {                          } 
                          else if($mode == "Update" && isset($_POST['candidate_appeared1']) && $_POST['candidate_appeared1']!='') { }
                          else if($mode == "Update" && $form_data[0]['candidate_appeared1']!='') { }
                            ...
                            <label for="candidate_appeared1" class="form_label">18. No. of candidates appeared at session <span class="session_time_text"></span> <sup class="text-danger">*</sup></label>
                              <input type="text" name="candidate_appeared[1]"  id="candidate_appeared1" value="<?php if($mode == "Add") { echo set_value('candidate_appeared1'); } else { echo $form_data[0]['candidate_appeared1']; } ?>" placeholder="No. of candidates appeared session wise" class="  AM form-control custom_input  candidate_appeared1" maxlength="100"  onchange="validate_input('candidate_appeared1')"/>
                          ...
                          <div class="form-group candidate_appeared2 candidate_appeared_div" <?php if($mode == "Add" && isset($_POST['candidate_appeared2']) && $_POST['candidate_appeared2']!='') {                          } 
                             ...
                             <label for="candidate_appeared1" class="form_label">18. No. of candidates appeared at session <span class="session_time_text"></span> <sup class="text-danger">*</sup></label>
                              <input type="text" name="candidate_appeared[2]"  id="candidate_appeared2" value="<?php if($mode == "Add") { echo set_value('candidate_appeared2'); } else { echo $form_data[0]['candidate_appeared2']; } ?>" placeholder="No. of candidates appeared session wise" class="form-control custom_input candidate_appeared2 11.15 AM" maxlength="100"  onchange="validate_input('candidate_appeared2')"/>
                          ...
                          <div class="form-group candidate_appeared3 candidate_appeared_div" <?php if($mode == "Add" && isset($_POST['candidate_appeared3']) && $_POST['candidate_appeared3']!='') {                          } 
                             ...
                             <label for="candidate_appeared1" class="form_label">18. No. of candidates appeared at session <span class="session_time_text"></span> <sup class="text-danger">*</sup></label>
                              <input type="text" name="candidate_appeared[3]"  id="candidate_appeared3" value="<?php if($mode == "Add") { echo set_value('candidate_appeared3'); } else { echo $form_data[0]['candidate_appeared3']; } ?>" placeholder="No. of candidates appeared session wise" class="form-control custom_input candidate_appeared3 2.00 PM" maxlength="100"  onchange="validate_input('candidate_appeared3')"/>
                        ...
                        <div class="col-xl-6 col-lg-6"><?php /* started_late */ ?>
                          <div class="form-group">
                            ...
                            <note class="form_note" id="started_late_err"></note>
                        ...
                        <div class="col-xl-6 col-lg-6"><?php /* reason */ ?>
                          <div class="form-group started_late_reason_div" style="<?php if($mode == "Update" && isset($form_data) && $form_data[0]['started_late']=='Yes') { } else echo 'display:none'; ?>">
                            ...
                            <note class="form_note" id="started_late_reason_err"></note>
                      ...
                      <div class="col-xl-12 col-lg-12"><?php /* unfair_candidates*/ ?>
                          <div class="form-group">
                            ...
                            <note class="form_note" id="unfair_candidates_err"></note>
                        ...
                        <div class="col-xl-12 col-lg-12"><?php /* pls explain, give details of candidates */ ?>
                          <div class="form-group unfair_candidates_reason_div" style="<?php if($mode == "Update" && isset($form_data) && $form_data[0]['unfair_candidates']=='Yes') { } else echo 'display:none'; ?>">
                            ...
                            <note class="form_note" id="unfair_candidates_reason_err"></note>
                      ...
                      <div class="col-xl-6 col-lg-6"><?php /* rough_sheet */ ?>
                          <div class="form-group">
                            ...
                            <note class="form_note" id="rough_sheet_err"></note>
                        ...
                        <div class="col-xl-6 col-lg-6"><?php /* reason */ ?>
                          <div class="form-group rough_sheet_reason_div"  style="<?php if($mode == "Update" && isset($form_data) && $form_data[0]['rough_sheet']=='Yes') { } else echo 'display:none'; ?>">
                            ...
                            <note class="form_note" id="rough_sheet_reason_err"></note>
                      ...
                      <div class="col-xl-12 col-lg-12"><?php /* action_for_unfair */ ?>
                          <div class="form-group">
                            ...
                            <note class="form_note" id="action_for_unfair_err"></note>
                      ...
                      <div class="col-xl-12 col-lg-12"><?php /* name_mob_exam_contro */ ?>
                          <div class="form-group">
                            ...
                            <note class="form_note" id="name_mob_exam_contro_err"></note>
                      ...
                      <div class="col-xl-12 col-lg-12"><?php /* issue_reported */ ?>
                          <div class="form-group">
                            ...
                            <input  required type="text" name="issue_reported"  id="issue_reported" value="<?php if($mode == "Add") { echo set_value('issue_reported'); } else { echo $form_data[0]['issue_reported']; } ?>" placeholder="Give Details" class="form-control custom_input" maxlength="500"  onchange="validate_input('issue_reported')"/>
                            <note class="form_note" id="issue_reported_err"></note>
                            <?php if(form_error('issue_reported')!=""){ ?> <div class="clearfix"></div><label class="error"><?php echo form_error('issue_reported'); ?></label> <?php } ?>
                        </div>					
                      </div>
                      
                      
                      <div class="col-xl-9 col-lg-9"><?php /* observation */ ?>
                          <div class="form-group">
                            <label for="observation" class="form_label">25. Any other observation /Suggestion if any <sup class="text-danger">*</sup></label>
                            <input  required type="text" name="observation"  id="observation" value="<?php if($mode == "Add") { echo set_value('observation'); } else { echo $form_data[0]['observation']; } ?>" placeholder="Give Details" class="form-control custom_input" maxlength="500"  onchange="validate_input('observation')"/>
                            <note class="form_note" id="observation_err"></note>
                            <?php if(form_error('observation')!=""){ ?> <div class="clearfix"></div><label class="error"><?php echo form_error('observation'); ?></label> <?php } ?>
                        </div>					
                      </div>

                      <div style="margin-top: 3%;" class="col-xl-3 col-lg-3"><?php /* immediate_action */ ?>
                          <div class="form-group">
                          <input type="checkbox" class="form-check-input" value="1" name="immediate_action"  <?php if($mode == "Add") { if( set_value('immediate_action') == '1') { echo "checked"; } } else { if($form_data[0]['immediate_action']=='1') { echo "checked"; } } ?>>

                          <label class="form-check-label " ><span style="color:red; "> Requires immediate action</span>
                      ...
                      <?php if($mode == "Update" && $form_data[0]['downloaded_file']!='') { ?>
                      <div class="col-xl-6 col-lg-6"><?php /* sign */ ?>
                          <div class="form-group">
                            <label for="sign" class="form_label">Upload Signed PDF <sup class="text-danger"></sup></label>
                            <?php if($form_data[0]['uploaded_file']!='') { ?>
                            &nbsp;<i style="float:right;">Previous Signed PDF : <a href="<?php echo base_url(); ?>/supervision/candidate/dashboard_candidate/download_form_pdf/?pdf_file=<?php echo $form_data[0]['uploaded_file'] ?>">Click Here</a></i>
                            <?php } ?>
                            <input  type="file" name="uploaded_file"  id="uploaded_file"  placeholder="" class="form-control custom_input"   onchange="validateFile(event, 'error_uploaded_file_size', '', '300kb')"/>
                            <note class="form_note" id="uploaded_file_err">Please upload PDF file with 300kb in size</note>
                    ...
                    <div class="hr-line-dashed"></div>										
										<div class="row">
											<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" id="submit_btn_outer">
												...
												<a class="btn btn-danger" href="<?php echo site_url('supervision/candidate/dashboard_candidate/session_forms'); ?>">Back</a>	
                      </div>
                    </div>
                  </form>
                </div>
  ...
  <script type="text/javascript">
    ...
    function showhideinputs() {
      ...
      if ($('input[type=radio][name=rough_sheet]:checked').val() == 'Yes') {
        
          $('.rough_sheet_reason_div').show();
          $('.rough_sheet_reason').attr('required','required');
      }
      else if ($('input[type=radio][name=rough_sheet]:checked').val() == 'No') {
    ...
    showhideinputs();
    function get_exam_venue_ajax(exam_code_period)
    {
      $("#page_loader").show();
      var exam_code_period =  exam_code_period.split("-");
      parameters="exam_code="+exam_code_period[0]+'+&exam_period='+exam_code_period[1];
      
      $.ajax({
        type: "POST",
        url: "<?php echo site_url('supervision/candidate/dashboard_candidate/get_exam_venues_ajax'); ?>",
        data: parameters,
        cache: false,
        dataType: 'JSON',
    ...
    {
      $("#page_loader").show();
      var exam_code_period =  $('select.exam_code').val().split("-");
      
      parameters="venue_code="+venue_code+"&exam_code="+exam_code_period[0]+'+&exam_period='+exam_code_period[1];
      
      $.ajax({
        type: "POST",
        url: "<?php echo site_url('supervision/candidate/dashboard_candidate/get_exam_dates_ajax'); ?>",
        data: parameters,
        cache: false,
        dataType: 'JSON',
        success:function(data)
    ...
    function get_exam_time_ajax(exam_date)
    {
      ...
      parameters="exam_date="+exam_date+"&venue_code="+$('.venue_code').val()+"&exam_code="+exam_code_period[0]+'+&exam_period='+exam_code_period[1];
      
      //parameters="exam_date="+exam_date+'&venue_code='+$('.venue_code').val()+'&exam_code='+$('.exam_code').val();
      
      $.ajax({
        type: "POST",
        url: "<?php echo site_url('supervision/candidate/dashboard_candidate/get_exam_times_ajax'); ?>",
        data: parameters,
        cache: false,
        dataType: 'JSON',
        success:function(data)
    ...
    $(document ).ready( function() 
    {
      var form = $("#add_form").validate( 
      {
        ...
        rules:
        {
          ...
          suitable_venue_loc:{ required:true },
          suitable_venue_loc_reason:{ maxlength:500 },

          venue_open_bef_exam:{ required:true },
          venue_open_bef_exam_reason:{ maxlength:500 },

          no_of_pc:{ required: true, maxlength:4,allow_only_numbers:true },

          venue_reserved:{ required:true },
          venue_reserved_reason:{ maxlength:500 },

          venue_power_problem:{ required:true },
          venue_power_problem_sol:{ maxlength:500 },

          no_of_supervisors:{ required:true , maxlength:255},

          registration_process:{ required:true },
          registration_process_reason:{ maxlength:500 },

          frisking:{ required:true },
          frisking_reason:{ maxlength:500 },

          frisking_lady:{ required:true },
          frisking_lady_reason:{ maxlength:500 },

          mobile_allowed:{ required:true },
          mobile_allowed_reason:{ maxlength:500 },

          admit_letter_checked:{ required:true },
          admit_letter_checked_reason:{ maxlength:500 },

          exam_without_admit_letter:{ required:true },
          exam_without_admit_letter_detils:{ maxlength:500 },

          seat_no_written:{ required:true },
          seat_no_written_reason:{ maxlength:500 },

          candidate_seated:{ required:true },
          candidate_seated_reason:{ maxlength:500 },

          scribe_arrange:{ required:true },
          scribe_arrange_reason:{ maxlength:500 },

          announcement:{ required:true },
          announcement_gap:{ maxlength:500 },

          exam_started:{ required:true },
          exam_started_reason:{ required:true,maxlength:500 },

          started_late:{ required:true },
          started_late_reason:{ maxlength:500 },

          unfair_candidates:{ required:true },
          unfair_candidates_reason:{ maxlength:500 },

          rough_sheet:{ required:true },
          rough_sheet_reason:{ maxlength:500 },

          action_for_unfair:{ maxlength:500 },

          name_mob_exam_contro:{ required:true,maxlength:500 },

          issue_reported:{ required:true,maxlength:500 },

          observation:{ required:true,maxlength:500 },
        ...
        messages:
        {
          ...
          suitable_venue_loc: { required: "This field is required"  },
          suitable_venue_loc_reason: { maxlength: "Maximum 500 characters are allowed"  },
          
          venue_open_bef_exam: { required: "This field is required"  },
          venue_open_bef_exam_reason: { maxlength: "Maximum 500 characters are allowed"  },

          no_of_pc: { required: "This field is required",  maxlength: "Please enter 4 numbers",allow_only_numbers: "Only digits are allowed" },
          venue_reserved: { required: "This field is required"  },
          venue_reserved_reason: { maxlength: "Maximum 500 characters are allowed"  },
          
          venue_power_problem: { required: "This field is required"  },
          venue_power_problem_sol: { maxlength: "Maximum 500 characters are allowed"  },

          no_of_supervisors: { required: "This field is required",  maxlength: "Maximum 255 characters are allowed" },

          
          registration_process: { required: "This field is required"  },
          registration_process_reason: { maxlength: "Maximum 500 characters are allowed"  },

          frisking: { required: "This field is required"  },
          frisking_reason: { maxlength: "Maximum 500 characters are allowed"  },

          frisking_lady: { required: "This field is required"  },
          frisking_lady_reason: { maxlength: "Maximum 500 characters are allowed"  },

          mobile_allowed: { required: "This field is required"  },
          mobile_allowed_reason: { maxlength: "Maximum 500 characters are allowed"  },

          admit_letter_checked: { required: "This field is required"  },
          admit_letter_checked_reason: { maxlength: "Maximum 500 characters are allowed"  },

          exam_without_admit_letter: { required: "This field is required"  },
          exam_without_admit_letter_detils: { maxlength: "Maximum 500 characters are allowed"  },

          seat_no_written: { required: "This field is required"  },
          seat_no_written_reason: { maxlength: "Maximum 500 characters are allowed"  },

          candidate_seated: { required: "This field is required"  },
          candidate_seated_reason: { maxlength: "Maximum 500 characters are allowed"  },

          scribe_arrange: { required: "This field is required"  },
          scribe_arrange_reason: { maxlength: "Maximum 500 characters are allowed"  },

          announcement: { required: "This field is required"  },
          announcement_gap: { maxlength: "Maximum 500 characters are allowed"  },

          exam_started: { required: "This field is required"  },
          exam_started_reason: {required: "This field is required", maxlength: "Maximum 500 characters are allowed"  },

          started_late: { required: "This field is required"  },
          started_late_reason: { maxlength: "Maximum 500 characters are allowed"  },

          unfair_candidates: { required: "This field is required"  },
          unfair_candidates_reason: { maxlength: "Maximum 500 characters are allowed"  },

          rough_sheet: { required: "This field is required"  },
          rough_sheet_reason: { maxlength: "Maximum 500 characters are allowed"  },

          
          action_for_unfair: { maxlength: "Maximum 500 characters are allowed"  },

          name_mob_exam_contro: { required: "This field is required" , maxlength: "Maximum 500 characters are allowed"  },
          issue_reported: { required: "This field is required" , maxlength: "Maximum 500 characters are allowed"  },
          observation: { required: "This field is required" , maxlength: "Maximum 500 characters are allowed"  },
        }, 
        errorPlacement: function(error, element) // For replace error 
        {
          if (element.attr("name") == "suitable_venue_loc") { error.insertAfter("#suitable_venue_loc_err"); }
          if (element.attr("name") == "suitable_venue_loc_reason") { error.insertAfter("#suitable_venue_loc_reason_err"); }
          if (element.attr("name") == "venue_open_bef_exam") { error.insertAfter("#venue_open_bef_exam_err"); }
          if (element.attr("name") == "venue_open_bef_exam_reason") { error.insertAfter("#venue_open_bef_exam_reason_err"); }
          
          if (element.attr("name") == "no_of_pc") { error.insertAfter("#no_of_pc_err"); }
          if (element.attr("name") == "venue_reserved") { error.insertAfter("#venue_reserved_err"); }
          if (element.attr("name") == "venue_reserved_reason") { error.insertAfter("#venue_reserved_reason_err"); }
          if (element.attr("name") == "venue_power_problem") { error.insertAfter("#venue_power_problem_err"); }
          
          if (element.attr("name") == "venue_power_problem_sol") { error.insertAfter("#venue_power_problem_sol_err"); }
          if (element.attr("name") == "no_of_supervisors") { error.insertAfter("#no_of_supervisors_err"); }
          if (element.attr("name") == "registration_process") { error.insertAfter("#registration_process_err"); }
          if (element.attr("name") == "registration_process_reason") { error.insertAfter("#registration_process_reason_err"); }
          if (element.attr("name") == "frisking") { error.insertAfter("#frisking_err"); }
          if (element.attr("name") == "frisking_reason") { error.insertAfter("#frisking_reason_err"); }
          if (element.attr("name") == "frisking_lady") { error.insertAfter("#frisking_lady_err"); }
          if (element.attr("name") == "frisking_lady_reason") { error.insertAfter("#frisking_lady_reason_err"); }
          if (element.attr("name") == "mobile_allowed") { error.insertAfter("#mobile_allowed_err"); }
          if (element.attr("name") == "mobile_allowed_reason") { error.insertAfter("#mobile_allowed_reason_err"); }
          if (element.attr("name") == "admit_letter_checked") { error.insertAfter("#admit_letter_checked_err"); }
          if (element.attr("name") == "admit_letter_checked_reason") { error.insertAfter("#admit_letter_checked_reason_err"); }
          if (element.attr("name") == "exam_without_admit_letter") { error.insertAfter("#exam_without_admit_letter_err"); }
          if (element.attr("name") == "exam_without_admit_letter_detils") { error.insertAfter("#exam_without_admit_letter_detils_err"); }
          if (element.attr("name") == "seat_no_written") { error.insertAfter("#seat_no_written_err"); }
          if (element.attr("name") == "seat_no_written_reason") { error.insertAfter("#seat_no_written_reason_err"); }
          if (element.attr("name") == "candidate_seated") { error.insertAfter("#candidate_seated_err"); }
          if (element.attr("name") == "candidate_seated_reason") { error.insertAfter("#candidate_seated_reason_err"); }
          if (element.attr("name") == "scribe_arrange") { error.insertAfter("#scribe_arrange_err"); }
          if (element.attr("name") == "scribe_arrange_reason") { error.insertAfter("#scribe_arrange_reason_err"); }
          if (element.attr("name") == "announcement") { error.insertAfter("#announcement_err"); }
          if (element.attr("name") == "announcement_gap") { error.insertAfter("#announcement_gap_err"); }
          if (element.attr("name") == "exam_started") { error.insertAfter("#exam_started_err"); }
          if (element.attr("name") == "exam_started_reason") { error.insertAfter("exam_started_reason_err"); }
          if (element.attr("name") == "started_late") { error.insertAfter("#started_late_err"); }
          if (element.attr("name") == "started_late_reason") { error.insertAfter("#started_late_reason_err"); }
          if (element.attr("name") == "unfair_candidates") { error.insertAfter("#unfair_candidates_err"); }
          if (element.attr("name") == "unfair_candidates_reason") { error.insertAfter("#unfair_candidates_reason_err"); }
          if (element.attr("name") == "rough_sheet") { error.insertAfter("#rough_sheet_err"); }
          if (element.attr("name") == "rough_sheet_reason") { error.insertAfter("#rough_sheet_reason_err"); }
          if (element.attr("name") == "action_for_unfair") { error.insertAfter("#action_for_unfair_err"); }
          if (element.attr("name") == "name_mob_exam_contro") { error.insertAfter("#name_mob_exam_contro_err"); }
          if (element.attr("name") == "issue_reported") { error.insertAfter("#issue_reported_err"); }
          if (element.attr("name") == "observation") { error.insertAfter("#observation_err"); }
