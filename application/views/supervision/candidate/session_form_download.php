                                        ...
                                        <table cellpadding="0" cellspacing="0" width="100%" border="0" style="border-left:1px solid #fff; border-top:1px solid #fff;">
                                            ...
                                            <tr>
                                                <td style="border-bottom:1px solid #fff; border-right:1px solid #fff; padding:7px;">
                                                    <strong>Name : </strong>    <?php echo $form_details[0]['candidate_name']; ?>                         
                                                </td>
                                ...
                                <div style="background-color:#dcf1fc; padding:7px 0;">
                                    ...
                                    <div>
                                        ...
                                        <div cellpadding="0" cellspacing="0" width="100%" border="0" style="border-left:1px solid #fff; border-top:1px solid #fff;">
                                            ...
                                            <?php if($form_details[0]['suitable_venue_loc']=='No') { ?>
                                                <div>   
                                                <div style="border-bottom:1px solid #fff; border-right:1px solid #fff; padding:7px;">
                                            ...
                                            <?php if($form_details[0]['venue_open_bef_exam']=='No') { ?>
                                                <div>   
                                                <div style="border-bottom:1px solid #fff; border-right:1px solid #fff; padding:7px;">
                                            ...
                                            <?php if($form_details[0]['venue_reserved']=='No') { ?>
                                                <div>   
                                                <div style="border-bottom:1px solid #fff; border-right:1px solid #fff; padding:7px;">
                                            ...
                                            <?php if($form_details[0]['venue_power_problem']=='No') { ?>
                                                <div>   
                                                <div style="border-bottom:1px solid #fff; border-right:1px solid #fff; padding:7px;">
                                            ...
                                            <?php if($form_details[0]['registration_process']=='No') { ?>
                                                <div>   
                                                <div style="border-bottom:1px solid #fff; border-right:1px solid #fff; padding:7px;">
                                            ...
                                            <?php if($form_details[0]['frisking']=='No') { ?>
                                                <div>   
                                                <div style="border-bottom:1px solid #fff; border-right:1px solid #fff; padding:7px;">
                                            ...
                                            <?php if($form_details[0]['frisking_lady']=='No') { ?>
                                                <div>   
                                                <div style="border-bottom:1px solid #fff; border-right:1px solid #fff; padding:7px;">
                                            ...
                                            <?php if($form_details[0]['admit_letter_checked']=='No') { ?>
                                                <div>   
                                                <div style="border-bottom:1px solid #fff; border-right:1px solid #fff; padding:7px;">
                                            ...
                                            <?php if($form_details[0]['seat_no_written']=='No') { ?>
                                                <div>   
                                                <div style="border-bottom:1px solid #fff; border-right:1px solid #fff; padding:7px;">
                                            ...
                                            <?php if($form_details[0]['candidate_seated']=='No') { ?>
                                                <div>   
                                                <div style="border-bottom:1px solid #fff; border-right:1px solid #fff; padding:7px;">
                                            ...
                                            <?php if($form_details[0]['scribe_arrange']=='No') { ?>
                                                <div>   
                                                <div style="border-bottom:1px solid #fff; border-right:1px solid #fff; padding:7px;">
                                        ...
                                        <table style="margin-top: 50px;" width="100%">
                                            <tr>
                                                <td width="60%" style="padding-top: 18px;border-top:1px solid #fff; border-right:1px solid #fff; padding:7px;"><strong>Date : </strong>____________________________</td>
