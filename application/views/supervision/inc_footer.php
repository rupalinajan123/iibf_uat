  ...
  <script src="<?php echo auto_version(base_url('assets/supervision/js/jquery-3.1.1.min.js')); ?>"></script>
  <script src="<?php echo auto_version(base_url('assets/supervision/js/popper.min.js')); ?>"></script>
  <script src="<?php echo auto_version(base_url('assets/supervision/js/bootstrap.js')); ?>"></script>
  <script src="<?php echo auto_version(base_url('assets/supervision/js/plugins/metisMenu/jquery.metisMenu.js')); ?>"></script>
  <script src="<?php echo auto_version(base_url('assets/supervision/js/plugins/slimscroll/jquery.slimscroll.min.js')); ?>"></script>
  <script src="<?php echo auto_version(base_url('assets/supervision/js/plugins/dataTables/datatables.min.js')); ?>"></script>
  <script src="<?php echo auto_version(base_url('assets/supervision/js/plugins/dataTables/dataTables.bootstrap4.min.js')); ?>"></script>	

  <script src="<?php echo auto_version(base_url('assets/supervision/js/bootstrap-toggle.js')); ?>"></script><!-- Toggle -->		
  <script src="<?php echo auto_version(base_url('assets/supervision/js/plugins/chosen/chosen.jquery.js')); ?>"></script>		
  <script src="<?php echo auto_version(base_url('assets/supervision/js/plugins/datapicker/bootstrap-datepicker.js')); ?>"></script>
  <script src="<?php echo auto_version(base_url('assets/supervision/lightbox/lightbox.min.js')); ?>"></script><!-- LIGHTBOX -->		
  <script src="<?php echo auto_version(base_url('assets/supervision/js/plugins/sweetalert/sweetalert.min.js')); ?>"></script>
  <!-- Custom and plugin javascript -->
  <script src="<?php echo auto_version(base_url('assets/supervision/js/inspinia.js')); ?>"></script>
  <script src="<?php echo auto_version(base_url('assets/supervision/js/plugins/pace/pace.min.js')); ?>"></script>
