                        ...
                        <div class="form-group">
                          ...
                          <option value="">Select</option>
                            <?php foreach($exams as $exam) {
                              ?>
                              <option <?php if($mode == "Add") { if(set_value('exam_code_period') == $exam['exam_code_period']) echo'selected';  } elseif($form_data[0]['exam_code']==$exam['exam_code'] && $form_data[0]['exam_period']==$exam['exam_period']) {echo'selected';} ?> value="<?php echo $exam['exam_code'] ?>-<?php echo $exam['exam_period'] ?>"><?php echo $exam['exam_name'] ?> - <?php echo $exam['exam_month'] ?></option>
                              <?php
                            } ?>
                        </select>
