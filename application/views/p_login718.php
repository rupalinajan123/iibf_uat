                    ...
                    <tr>
                      ...
                      <td class="content" width="55%" bgcolor="#d8e4f1">
                        <select name="exam" id="exam" class="text1" style="min-width:218px;">
                          ...
                          <option value="34_718">Anti-Money Laundering And Know Your Customer</option>
                          <option value="58_718">Customer Services & Banking Codes And Standards</option>
                          <option value="160_718">MSME Finance for Bankers</option>
                        </select>
                      </td>
                    </tr>
                    <tr>
