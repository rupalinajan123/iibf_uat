...
?>
  ...
  <form class="form-horizontal" name="visionForm" id="visionForm"  method="post"   action="<?php echo base_url()?>vision">
        ...
        <div class="col-md-12"> 
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input type="email" class="form-control" name="email_id" id="email_id" value="" placeholder="Enter email id" required data-parsley-maxlength="45" data-parsley-trigger-after-failure="" data-parsley-visemailcheck/>(Enter valid and correct email ID to receive communication)
                </div>
              </div>
              <div class="form-group">
                <label for="roleid" class="col-sm-3 control-label">Mobile Number<span style="color:#F00">*</span></label>
                <div class="col-sm-6">
                  <input type="tel" class="form-control" id="contact_no" name="contact_no" placeholder="Enter mobile no" value="" required data-parsley-type="number"  data-parsley-minlength="10" data-parsley-maxlength="10"  maxlength="10" size="10" data-parsley-vismobilecheck>
                  <span class="error">
                  </span> </div>
                </div>
               ...
               <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" id="address_2" name="address_2" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/" placeholder="Enter address 2"  value="" >
                  <span class="error">
                  </span> </div>
               </div>
               ...
               <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" id="address_3" name="address_3" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/" placeholder="Enter address 3"  value=""  >
                  <span class="error">
                  </span> </div>
               </div>
               ...
               <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" id="address_4" name="address_4" data-parsley-pattern="/^[a-zA-Z-0-9/ ]+$/" placeholder="Enter address 4"  value=""  >
                  <span class="error">
                  </span> </div>
               </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" id="pincode" name="pincode"  value=""  required data-parsley-maxlength="6" maxlength="6" size="6" data-parsley-vischeckpin data-parsley-type="number" data-parsley-trigger-after-failure="focusout" placeholder="Enter pincode/zipcode">
                  <span class="error">
                  </span> </div>
               </div>
               ...
               <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" id="subscription_fees" name="subscription_fees"  value="40" readonly="readonly" >
                  <span class="error">
                  </span> </div>
               </div>
          ...
          <div class="box box-info">
            ...
            <div class="box-footer">
              <div class="col-sm-6 col-sm-offset-3"> <a href="javascript:void(0);" class="btn btn-info"onclick="javascript:return vischeckform();" id="preview">Preview and Proceed for Payment</a> 
...
<script src="<?php echo base_url();?>js/validation_vision.js?<?php echo time(); ?>"></script> 
...
$(function(){
    ...
    $('#new_captcha').click(function(event){
		...
		$.ajax({
			type: 'POST',
			url: site_url+'vision/generatecaptchaajax/',
