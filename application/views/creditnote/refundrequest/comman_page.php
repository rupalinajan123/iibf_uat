...
<div class="container">
  <div class="content-wrapper">
    <section class="content-header box-header with-border" style="background-color: #1287C0">
     ...
     <form name="getDetailsForm" id="getDetailsForm" method="post" action="<?php echo base_url(); ?>RefundRequest<?php //echo $batch_code;?>">
...
window.addEventListener('popstate', function(event) {
    window.location.assign(site_url+"refundrequest/");
});
</script>