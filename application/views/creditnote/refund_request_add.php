  ...
  <div class="row">
    <div class="col-xs-12">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-5">
          <input type="text" class="form-control" id="req_member_no" name="req_member_no" placeholder="Member Number" value="<?php echo set_value('req_member_no') ?>" data-parsley-validation-threshold="1" data-parsley-trigger="keyup" 
