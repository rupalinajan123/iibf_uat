...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            <div class="pull-left">
                <p><?php //if($creditnoteuserdata['username']!=''){ echo $creditnoteuserdata['username']; } ?></p>
            </div>
            <div class="pull-left info">
                <p><?php if($creditnoteuserdata['name']!=''){ echo $creditnoteuserdata['name']; } ?></p>
            </div>
        </div>
        <br />
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview <?php if(stristr(current_url(),'MainController')) { echo "active"; } ?>">
                <a href="<?php echo base_url();?>creditnote/admin/MainController">
                    <i class="fa fa-home"></i> <span>Home</span>
                </a>
            </li>
            <?php if($creditnoteuserdata['admin_user_type'] == 'Maker'){ ?>
            ...
            <?php }elseif($creditnoteuserdata['admin_user_type'] == 'ReportAdmin'){ ?>
                  <li class="treeview <?php if(stristr(current_url(),'Checker/refundrequest_list')) { echo "active"; } ?>">
                   <a href="<?php echo base_url();?>creditnote/admin/Checker/refundrequest_list">
                      <i class="fa fa-credit-card"></i> <span>Request List</span>
                   </a>
            ...
            <li class="treeview <?php if(stristr(current_url(),'login/changepassword')) { echo "active"; } ?>">
                   <a href="<?php echo base_url();?>creditnote/admin/login/changepassword">
