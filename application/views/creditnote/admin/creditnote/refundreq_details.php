        ...
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header with-border">
              ...
              <div class="pull-right"> <a href="<?php echo base_url();?>creditnote/admin/Checker/refundrequest_list" class="btn btn-warning">Back</a>
             ...
             if (isset($reuest_list)) {
              ...
              foreach ($reuest_list as $res) { ?>
                ...
                <div id="reason_form" style="display: none">
                  <form action="<?php echo base_url();?>creditnote/admin/creditnote/action_status" method="post"  class=""  enctype="multipart/form-data" data-parsley-validate="parsley">
                    <input type="hidden" name="action" id="action_id" value="3">
                    <input type="hidden" name="id" value="<?=$res['id']?>">
                    <input type="hidden" name="checker_id" value="<?=$creditnoteuserdata['id']?>">
                    <input type="hidden" name="maker_id" value="<?=$res['req_maker_id']?>">
                    <input type="hidden" name="req_id" value="<?=$res['req_id']?>">
                    <table  class="table table-bordered" style="">
                      <tbody>
                        <tr>                    
                            <td width="50%"><strong><p class="reason_class">REASON  *:</p></strong><textarea maxlength="300" required="" class="form-control" name="description"></textarea></td>
               ...
               <div align="center"> 
                 <?php
                  ...
                  if($res['req_status'] == 0 || $res['req_status'] == 6){ ?>
    ...
    <div class="box box-info">
                            ...
                            <div class="box-body">       
                                 <div class="form-group idproof-wrap">
                                     <div class="col-sm-2">
                                         <?php if( !empty( $res["image_name1"] ) ) { ?>
                                            <img src="<?php echo base_url().'uploads/refund_request/'.$res["image_name1"];?>" style="width: 100%;height: auto;"/>
                                         <?php } ?>
                                     </div> 
                                     <div class="col-sm-2">
                                        <?php if( !empty( $res["image_name2"] ) ) { ?>
                                            <img src="<?php echo base_url().'uploads/refund_request/'.$res["image_name2"];?>" style="width: 100%;height: auto;" />
                                         <?php } ?>
                                     </div>
                                     <div class="col-sm-2">
                                        <?php if( !empty( $res["image_name3"] ) ) { ?>
                                            <img src="<?php echo base_url().'uploads/refund_request/'.$res["image_name3"];?>" style="width: 100%;height: auto;" />
                                         <?php } ?>
                                     </div>
                                  
                                     <div class="col-sm-2">
                                        <?php if( !empty( $res["image_name4"] ) ) { ?>
                                            <img src="<?php echo base_url().'uploads/refund_request/'.$res["image_name4"];?>" style="width: 100%;height: auto;" />
                                         <?php } ?>
                                     </div>
                                 </div>
                          </div><!--.box-body-->
