...
<style>.main-footer {padding-left: 10px; padding-right: 0;}</style>
<section class="content">
	
		<div class="col-md-12">  
          <div  class ="row">
		   <div class="form-group"><div class="col-sm-12 text-center"><strong>You are not allowed to download E-Certificate from Mobile devices. Please download it from your Desktop/Laptop.</strong></div></div>
		  </div>
		</div>  
</section>
<?php
