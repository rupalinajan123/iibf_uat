...
<div class="container">
  <section class="content-header box-header with-border" style="height: 45px; background-color: #1287C0; ">
    <h1 class="register">RPE GST Payment</h1>
    <br />
  </section>
  <section class="">
    <div class="row">
      <div class="col-md-12 col-sm-12" style="">
        ...
        <?php }?>
        <form name="getDetailsForm" id="getDetailsForm" method="post" action="<?php echo base_url(); ?>RPEGstRecovery">
          <br />
          <div class="">
            ...
            <div class="col-sm-12 col-md-3">
              <input type="text" class="form-control" id="member_no" name="member_no" placeholder="Membership No." required value="<?php if (isset($row['member_no'])) { echo $row['member_no'];} else { echo set_value('member_no'); }
?>" <?php if (isset($row['member_no'])) { echo "readonly='readonly'";} elseif (set_value('member_no')) { echo "readonly='readonly'"; } ?> style="border-color:#000;" title="Membership No.">
            </div>
            <div class="col-sm-12 col-md-3">
              <?php 
			  	if (isset($row['member_no']) || set_value('member_no')) {
				?>
              <a href="<?php echo base_url();?>RPEGstRecovery" class="btn btn-warning" id="modify" style="">Reset</a>
              <input type="submit" class="btn btn-info" name="btnGetDetails" id="btnGet" value="Get Details" style="display:none;">
              <?php
				} 
				else
				{
				?>
              <input type="submit" class="btn btn-info" name="btnGetDetails" id="btnGetDetails" value="Get Details">
              <?php 
				 } 
				  ?>
            </div>
            ...
            <div class="table-responsive">
			  ...
			  ?>
                <tr>
                  ...
                  <td><span>&#8377;</span>&nbsp;<?php  echo $value['amt_diff'];  ?></td>
                  <td><?php  
                    ...
                    <?php
                        ...
                        ?>
                    <a href="<?php echo base_url();?>RPEGstRecovery/stored_details/<?php echo base64_encode($value['invoice_id']); ?>" class="btn btn-info" style="width: 75px;">Pay Now</a>
                    <?php }?></td>
                </tr>
                <?php 
			  $sr++;
...
window.addEventListener('popstate', function(event) {
    window.location.assign(site_url+"RPEGstRecovery/");
});
