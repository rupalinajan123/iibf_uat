						...
						<tr>
                          ...
                          foreach($exam_name as $exam_name)
                          {
                            ...
                            else
                            {
                              ...
                              {  
                              	 $show_exam_month_year = isset($exam_name->exam_date) && $exam_name->exam_date != "" ? date("M Y",strtotime($exam_name->exam_date)) : "Sep 2025"; 
                                ...
                                {
                                  echo "Admit Letter for Online CERTIFICATE EXAMINATION FOR BUSINESS CORRESPONDENTS/FACILITATORS - Jan 2026"; 
                                  //echo "Admit Letter for Online CERTIFICATE EXAMINATION FOR BUSINESS CORRESPONDENTS/FACILITATORS - ".$show_exam_month_year;
																}
                                  ...
                                  { 
                                    ...
                                    echo preg_replace("/\([^)]+\)/","",$exam_name->description)." "; 
															...
															<?php  } } else { 
																...
																echo "Admit letter for Online".$exam_name->description.' Examination January, 2026'; }?>
															<?php
                          ...
                          $examCdArr = array(0);
                                    ...
                                    echo "Admit Letter for Online CERTIFICATE EXAMINATION FOR BUSINESS CORRESPONDENTS/FACILITATORS - Nov 2019";
																	}
                                      ...
                                      echo $exam_name_new->description; 
																...
																<?php
																	...
																	if($exam_name_new->exm_cd == $this->config->item('examCodeCaiib')){
																		echo "Admit letter for Online CAIIB Examination – Nov/Dec-2024";
																	}
																	if(in_array($exam_name_new->exm_cd,$elective)){
																		echo "Admit letter for Online CAIIB Electives – Nov/Dec-2024";
																	}
																?>
																<br>
														</a>
