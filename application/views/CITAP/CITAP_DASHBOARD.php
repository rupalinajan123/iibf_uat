					...
					<div class="box box-info">
						...
						<table class="table table-bordered">
							...
							<tr>
								...
								<td><?php echo $this->config->item('CITAP_cs_total'); ?></td>
								<td>
								<a href="<?php echo base_url().'Citap/sbi_make_payment/'; ?>" onclick="return confirm('Are you sure to proceed for payment?')">
									Payment
								</a>
								</td>
							</tr>
