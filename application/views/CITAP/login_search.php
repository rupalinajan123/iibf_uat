...
<div class="container">
	<section class="content-header">
		<h1 class="register">Certified Information Technology Audit Professional (CITAP)</h1><br />
	</section>
	<section class="error content-header">
	<?php 
	...
	<?php	
		if($error) {
	?>
	<div class="callout callout-danger" style="color:#FFF !important">
	<?php		
			echo $error;
	?>
	</div>
					...
					<div class="box box-info">
						...
						<div class="box-body">
							...
							<div class="form-group">
								<label class="col-sm-4 control-label">Enter Membership Number<span style="color:#F00">*</span></label>
								<div class="col-sm-5">
							...
							<div class="otp_wrapper">
								...
								<div class="otp_wrapper_body">
									...
									<div class="form-group ">
										...
										<i class="fa fa-eye"></i>
										<span class="help-block ">Otp will expire after 10 minutes. (Please do not share OTP with anyone)</span>
									</div>
									...
									<button type="button" class="btn btn-info verify_otp_btn">Submit & Verify OTP</button> <span id="mobile_timer"></span> <a class="resend_otp resend_hide" href="javascript:void(0);"> Click here to resend OTP</a>
...
<script>
	$(document).ready(function() {
		...
		$('.send_otp').on('click', function() {
			...
			$.ajax({
				url: '<?php echo base_url(); ?>Citap/send_otp',
				type: 'post',
				dataType: "json",
				data: {
					regnumber: regnumber,
		...
		$('.resend_otp').on('click', function() {
			...
			$.ajax({
				url: '<?php echo base_url(); ?>Citap/resend_otp',
				type: 'post',
				dataType: "json",
				data: {
					otp_id: otp_id,
		...
		$('.verify_otp_btn').on('click', function() {
			...
			var otp_id = $('.otp_id').val();
			$.ajax({
				url: '<?php echo base_url(); ?>Citap/verify_otp',
				type: 'post',
				dataType: "json",
				data: {
				...
				success: function(data) {
					if (data.status == 'success') {
						...
						setTimeout(function() {
							window.location.href = "<?php echo base_url(); ?>Citap/dashboard";
						}, 1000);
					} else {
