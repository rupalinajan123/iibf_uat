      ...
      <?php $this->load->view('iibfbcbf/agency/inc_sidebar_agency'); ?>
        ...
        <?php $this->load->view('iibfbcbf/agency/inc_topbar_agency'); ?>
                ...
                <div class="ibox-content">
                  <form method="POST" action="<?php echo base_url("iibfbcbf/agency/reports_agency/get_batch_communication_data_ajax"); ?>" id="search_form" class="search_form_common_all" action="javascript:void(0)" autocomplete="off">
    ...
    <script language="javascript">
      ...
      $(document).ready(function()
          ...
          searching: true,
					...
					"ajax": 
          {
						"url": '<?php echo site_url("iibfbcbf/agency/reports_agency/get_batch_communication_data_ajax"); ?>',
						"type": "POST",	
            "data": function ( d ) 
						{
