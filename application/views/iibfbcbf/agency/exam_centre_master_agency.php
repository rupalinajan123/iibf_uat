      ...
      <?php $this->load->view('iibfbcbf/agency/inc_sidebar_agency'); ?>
        ...
        <?php $this->load->view('iibfbcbf/agency/inc_topbar_agency'); ?>
				...
				<div class="row wrapper border-bottom white-bg page-heading">
					<div class="col-lg-12">
						...
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"><strong>Exam Centre Master</strong></li>
						</ol>
					</div>
				</div>
                ...
                <div class="ibox-content">
                  <form method="POST" action="<?php echo base_url("iibfbcbf/agency/masters_agency/get_exam_centre_master_data_ajax"); ?>" id="search_form" class="search_form_common_all" autocomplete="off">
                  ...
                  <div class="table-responsive">
                          ...
                          <th class="text-center wrap_space">Centre Code</th>
													<th class="text-center wrap_space">Centre Name</th>
													<th class="text-center wrap_space">State Code</th>
													<th class="text-center wrap_space">State Description</th>
													<th class="text-center wrap_space">Mode</th>
												</tr>
											</thead>											
											<tbody></tbody>	
										</table>
    ...
    <script language="javascript">
      $(document).ready(function()
          ...
          searching: true,
					...
					"ajax": 
          {
						"url": '<?php echo site_url("iibfbcbf/agency/masters_agency/get_exam_centre_master_data_ajax"); ?>',
						"type": "POST",	
            "data": function ( d ) 
						{ 
