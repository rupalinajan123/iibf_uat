      ...
      <?php $this->load->view('iibfbcbf/agency/inc_sidebar_agency'); ?>
        ...
        <?php $this->load->view('iibfbcbf/agency/inc_topbar_agency'); ?>
				...
				<div class="row wrapper border-bottom white-bg page-heading">
					<div class="col-lg-12">
						<h2>Candidate Payment Receipt</h2>
						<ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="<?php echo site_url('iibfbcbf/agency/transaction_details_agency'); ?>">Transaction Details</a></li>
							...
							<li class="breadcrumb-item"><a href="<?php echo site_url('iibfbcbf/agency/transaction_details_agency/payment_receipt_candidate_listing_agency/'.$enc_pt_id); ?>">Candidate Listing</a></li>              
							<li class="breadcrumb-item active"> <strong>Candidate Payment Receipt</strong></li>
            </ol>
          </div>
        </div>
				...
				<div class="wrapper wrapper-content animated fadeInRight">
							...
							<div class="ibox">
								<div class="ibox-title">
									<div class="ibox-tools">
										<a href="<?php echo site_url('iibfbcbf/agency/transaction_details_agency/payment_receipt_candidate_listing_agency/'.$enc_pt_id); ?>" class="btn btn-primary custom_right_add_new_btn">Back</a>                    
                  </div>
                </div>
                  ...
                  <div class="table-responsive">
                    <?php 
                      ...
                      $this->load->view('iibfbcbf/common/inc_payment_receipt_candidate_common', $sub_data);
                    ?>
                  </div>                
                </div>
              </div>
