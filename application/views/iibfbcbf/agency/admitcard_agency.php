        ...
        <?php $this->load->view('iibfbcbf/agency/inc_topbar_agency'); ?>
				...
				<div class="row wrapper border-bottom white-bg page-heading">
					<div class="col-lg-12">
						...
						<h2><?php if($center_code_enc != "" && $exam_code_enc != "" && $exam_period_enc != "") { echo 'Download Centrewise Admitcard'; }else{ echo 'Download Admitcard'; } ?></h2> 

						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?php echo site_url('iibfbcbf/agency/dashboard_agency'); ?>">Dashboard</a></li>
							<?php if($center_code_enc != "" && $exam_code_enc != "" && $exam_period_enc != "") { ?><li class="breadcrumb-item"><a href="<?php echo site_url('iibfbcbf/agency/Admitcard_agency'); ?>">Download Admitcard</a></li><?php } ?>
							<li class="breadcrumb-item active"> <strong><?php if($center_code_enc != "" && $exam_code_enc != "" && $exam_period_enc != "") { echo 'Download Centrewise Admitcard'; }else{ echo 'Download Admitcard'; } ?></strong></li>
						</ol>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="ibox">
								...
								<?php if($center_code_enc != "" && $exam_code_enc != "" && $exam_period_enc != "")  { ?>
                  <div class="ibox-title">
                    <div class="ibox-tools"> 
                      <a href="<?php echo site_url('iibfbcbf/agency/Admitcard_agency'); ?>" class="btn btn-danger custom_right_add_new_btn">Back</a> 
                    </div>
                  </div>   
                <?php } ?>
                ...
                <form method="POST" id="search_form" class="search_form_common_all" action="javascript:void(0)" autocomplete="off">
                        ...
                        <select class="form-control search_opt" name="s_centre" id="s_centre" >
                          <option value="">Select Centre</option>
                            <?php if(count($agency_centre_data) > 0)
                            {
                              ...
                              { ?>
                                <option value="<?php echo $res['center_code']; ?>"><?php echo $res['centre_name']; ?></option>
                              <?php }
                            } ?>
                        </select>
                      </div>                    
                  ...
                  <div class="table-responsive">
                          ...
                          <th class="no-sort text-center" style="width:60px;">Sr. No.</th>
													...
													<th class="text-center"><?php if($center_code_enc == "" && $exam_code_enc == "" && $exam_period_enc == ""){ echo "No of Candidates"; }else{ echo "Registration Number"; } ?></th>
    ...
    <script language="javascript">
      ...
      $(document).ready(function()
          ...
          searching: true,
					...
					"ajax": 
          {
						"url": '<?php echo site_url("iibfbcbf/agency/admitcard_agency/get_admitcard_data_ajax"); ?>',
						"type": "POST",	
            "data": function ( d ) 
						{
              ...
              <?php if($center_code_enc != '' && $exam_code_enc != '' && $exam_period_enc != '') { ?> 
              	...
              	d.exam_period_enc = '<?php echo $exam_period_enc; ?>';  
              <?php } ?>
