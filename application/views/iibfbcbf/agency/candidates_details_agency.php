      ...
      <?php $this->load->view('iibfbcbf/agency/inc_sidebar_agency'); ?>		
        ...
        <?php $this->load->view('iibfbcbf/agency/inc_topbar_agency'); ?>
              ...
              { ?>
                ...
                <li class="breadcrumb-item"><a href="<?php echo site_url('iibfbcbf/agency/batch_candidates_agency/index/'.url_encode($form_data[0]['batch_id'])); ?>">Candidate List (<?php echo $batch_data[0]['batch_code']; ?>)</a></li>
              <?php }
              else
              { ?>
                <li class="breadcrumb-item"><a href="<?php echo site_url('iibfbcbf/agency/batch_candidates_agency'); ?>">All Candidates</a></li>
              <?php } ?>  
				...
				<div class="wrapper wrapper-content animated fadeInRight">
                    ...
                    <?php if($enc_batch_id != '0') { ?>
										  <a href="<?php echo site_url('iibfbcbf/agency/batch_candidates_agency/index/'.url_encode($form_data[0]['batch_id'])); ?>" class="btn btn-danger custom_right_add_new_btn">Back</a>
                    <?php }
                    else { ?>
                      <a href="<?php echo site_url('iibfbcbf/agency/batch_candidates_agency'); ?>" class="btn btn-danger custom_right_add_new_btn">Back</a>
                    <?php } ?>
                  </div>
                </div>
                  ...
                  <div class="table-responsive">
                    ...
                    <div class="hr-line-dashed"></div>										
                      ...
                      <?php if($enc_batch_id != '0') { ?>
                        <a href="<?php echo site_url('iibfbcbf/agency/batch_candidates_agency/index/'.url_encode($form_data[0]['batch_id'])); ?>" class="btn btn-danger">Back</a>
                      <?php }
                      else { ?>
                        <a href="<?php echo site_url('iibfbcbf/agency/batch_candidates_agency'); ?>" class="btn btn-danger">Back</a>
                      <?php } ?>
                    </div>
                  </div>                  
                </div>
