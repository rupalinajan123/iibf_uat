        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
          <div class="sidebar-collapse">
            <ul class="nav metismenu side-bg-color" id="side-menu">
              ...
              if(isset($logged_in_agency_data[0]['allow_exam_types']) && ($logged_in_agency_data[0]['allow_exam_types'] == 'Bulk/Individual' || $logged_in_agency_data[0]['allow_exam_types'] == 'Hybrid' || ($logged_in_agency_data[0]['allow_exam_types'] == 'CSC' && isset($_SESSION['IIBF_BCBF_AGENCY_CODE']) && in_array($_SESSION['IIBF_BCBF_AGENCY_CODE'], array('1024')))))
              { ?>
              ...
              <?php if($this->session->userdata('IIBF_BCBF_USER_TYPE') == 'centre') 
              {
                ...
                if(isset($logged_in_agency_data[0]['allow_exam_types']) && ($logged_in_agency_data[0]['allow_exam_types'] == 'CSC') && $logged_in_agency_id == "4")
                { ?> 
                  <li><a target="_blank" href="<?php echo "https://iibf.esdsconnect.com/CSCNonMember/memlogin/?Extype=Mg==&Mtype=Tk0=&ExId=MTA1Mg"; ?>"><i class="fa fa-book"></i> <span class="nav-label">Apply For <?php echo "Apply for BC/BF Exam Advanced (Without Training ID - for BC Agents who have joined Bank as BC before 1st April 2024)"; ?></span></a></li>

                  <li><a target="_blank" href="<?php echo "https://iibf.esdsconnect.com/CSCNonMember/memlogin/?Extype=Mg==&Mtype=Tk0=&ExId=MTA1NA"; ?>"><i class="fa fa-book"></i> <span class="nav-label">Apply For <?php echo "Apply for BC/BF Exam Basic (Without Training ID - for BC Agents who have joined Bank as BC before 1st April 2024)"; ?></span></a></li>
                <?php }
              } ?>
              ...
              <?php if($this->session->userdata('IIBF_BCBF_USER_TYPE') == 'agency' && $logged_in_agency_data[0]['allow_exam_types'] != 'CSC') { ?>
                <li <?php if($act_id == "Reports Agency") { ?>class="active" <?php } ?>>
                  <a href="#"><i class="fa fa-th-large"></i> <span class="nav-label">Reports </span><span class="fa arrow"></span></a>
                  <ul class="nav nav-second-level collapse">  
                    <li <?php if($sub_act_id == "Exam Details Report") { ?>class="active" <?php } ?>><a href="<?php echo site_url('iibfbcbf/agency/reports_agency/exam_details'); ?>"><span class="nav-label">Exam Details Report</span></a></li>
                    <li <?php if($sub_act_id == "Candidate Eligible For Examination") { ?>class="active" <?php } ?>><a href="<?php echo site_url('iibfbcbf/agency/reports_agency/eligible_candidate_for_examination'); ?>"><span class="nav-label">Candidate Eligible For Examination</span></a></li>
                    <li <?php if($sub_act_id == "Training Batch Details Report") { ?>class="active" <?php } ?>><a href="<?php echo site_url('iibfbcbf/agency/reports_agency/training_details_batch'); ?>"><span class="nav-label">Training Batch Details Report</span></a></li>
                    <li <?php if($sub_act_id == "Batch Communication") { ?>class="active" <?php } ?>><a href="<?php echo site_url('iibfbcbf/agency/reports_agency/batch_communication'); ?>"><span class="nav-label">Batch Communication</span></a></li>
                    <li <?php if($sub_act_id == "Candidates Required to re-enroll for Training") { ?>class="active" <?php } ?>><a href="<?php echo site_url('iibfbcbf/agency/reports_agency/candidates_required_re_enroll'); ?>"><span class="nav-label">Candidates Required to re-enroll for Training</span></a></li>
                  </ul>
                </li>
              <?php } ?>
