      ...
      <?php $this->load->view('iibfbcbf/agency/inc_sidebar_agency'); ?>
        ...
        <?php $this->load->view('iibfbcbf/agency/inc_topbar_agency'); ?>
				...
				<div class="row wrapper border-bottom white-bg page-heading">
					<div class="col-lg-12">
						...
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"> <strong>Proforma Invoice List</strong></li>
						</ol>
					</div>
				</div>
                ...
                <div class="ibox-content">                
                  <form method="POST" action="<?php echo base_url("iibfbcbf/agency/transaction_details_agency/get_proforma_invoice_transaction_data_ajax"); ?>"  id="search_form" class="search_form_common_all" autocomplete="off">
                  ...
                  <div class="table-responsive">
                          ...
                          <th class="text-center">Exam Period</th>
													...
													<th class="text-center no-sort" style="width:150px;">Action</th>
												</tr>
											</thead>
    ...
    <script language="javascript">
      ...
      $(document).ready(function()
          ...
          searching: true,
					...
					"ajax": 
          {
						"url": '<?php echo site_url("iibfbcbf/agency/transaction_details_agency/get_proforma_invoice_transaction_data_ajax"); ?>',
						"type": "POST",	
            "data": function ( d ) 
						{
