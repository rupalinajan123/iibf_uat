				...
				<div class="row wrapper border-bottom white-bg page-heading">
					<div class="col-lg-12">
						...
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"> <strong>Online Payment Information</strong></li>
            </ol>
          </div>
        </div>
				...
				<div class="wrapper wrapper-content animated fadeInRight">
							...
							<div class="ibox">
								<div class="ibox-title">
									<div class="ibox-tools">
										<a href="<?php echo site_url('iibfbcbf/agency/transaction_details_agency/proforma_invoice_list'); ?>" class="btn btn-primary custom_right_add_new_btn">Back</a>                    
                  </div>
                </div>
                  ...
                  <div class="table-responsive">
                    <?php 
                      ...
                      $sub_data['enc_pt_id'] = $enc_pt_id;
                      $this->load->view('iibfbcbf/common/inc_online_payment_agency_common', $sub_data); 
                    ?>
                  </div>                
                </div>
              </div>
