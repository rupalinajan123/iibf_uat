...
<html>
  <head>
        ...
        <?php $this->load->view('iibfbcbf/candidate/inc_topbar_candidate'); ?>
          ...
          <div class="row">
              ...
              <div class="ibox-content">
									<form method="post" action="<?php echo site_url('iibfbcbf/candidate/dashboard_candidate/update_profile'); ?>" id="add_candidate_form" enctype="multipart/form-data" autocomplete="off">
                    ...
                    ?>
                      ...
                      <div class="col-xl-3 col-lg-3"><?php /* First Name */ ?>
                        <div class="form-group">
                          ...
                          <input type="text" value="<?php echo $form_data[0]['first_name']; ?>" class="form-control" readonly disabled />
                        </div>					
                      </div>
                      ...
                      <div class="col-xl-3 col-lg-3"><?php /* Middle Name */ ?>
                        <div class="form-group">
                          ...
                          <input type="text" value="<?php echo $form_data[0]['middle_name']; ?>" class="form-control" readonly disabled />
                        </div>					
                      </div>
                      ...
                      <div class="col-xl-3 col-lg-3"><?php /* Last Name */ ?>
                        <div class="form-group">
                          ...
                          <input type="text" value="<?php echo $form_data[0]['last_name']; ?>" class="form-control" readonly disabled />
                        </div>					
                      </div>
                        ...
                        <div class="form-group">
                          ...
                          <div id="qualification_err">   
                            ...
                            if(count($qualification_arr) > 0)
                            {
                              ...
                              {
                                if($form_data[0]['qualification'] == $key) { $disp_qualification = $val; }
                              }
                            } ?>
                            <input type="text" value="<?php echo $disp_qualification; ?>" class="form-control" readonly disabled />
                          </div>
                        </div>					
                      </div>
                    </div>										
                      ...
                      <div class="col-xl-6 col-lg-6"><?php // Qualification Certificate Type ?>
                            ...
                            if(count($qualification_certificate_type_arr) > 0)
                            {
                              ...
                              {
                                if($form_data[0]['qualification_certificate_type'] == $key) { $disp_qualification_certificate_type = $val; }
                              }
                            } ?>
                            ...
                            if(count($id_proof_type_arr) > 0)
                            {
                              ...
                              {
                                if($form_data[0]['id_proof_type'] == $id_proof_type_key) { $disp_id_proof_type = $id_proof_type_val; }
                              }
                            } ?>
                          ...
                          <input type="text" value="<?php echo $form_data[0]['id_proof_number']; ?>" class="form-control" readonly disabled />
												</div>					
											</div>

                      <div class="col-xl-6 col-lg-6"><?php /* Aadhar Number */ ?>
												<div class="form-group">
													<label class="form_label">Aadhar Number <sup class="text-danger"></sup></label>
                          <input type="text" value="<?php echo $form_data[0]['aadhar_no']; ?>" class="form-control" readonly disabled />
											...
											<div class="col-xl-6 col-lg-6 mb-4"><?php // Upload Proof of Identity ?>
												<div class="form-group">
                          <?php if($form_data[0]['id_proof_file'] == "")
                          { ?>
                          ...
                          <?php } ?>
													...
													<div id="id_proof_file_preview" class="upload_img_preview <?php if($form_data[0]['id_proof_file'] == "") { echo 'pull-right'; } ?>">
														<?php 
                      ...
                      <input type="hidden" id="data_lightbox_title_hidden" value="<?php echo $preview_first_name; echo $preview_training_id != ""?" (".$preview_training_id.")":""; ?>">
											...
											<div class="col-xl-6 col-lg-6"><?php // Upload Passport-size Photo ?>
												<div class="form-group">
                          <?php if($form_data[0]['candidate_photo'] == "")
                          { ?>
                            <div class="img_preview_input_outer pull-left">
                          ...
                          <?php } ?>
													...
													<div id="candidate_photo_preview" class="upload_img_preview <?php if($form_data[0]['candidate_photo'] == "") { echo 'pull-right'; } ?>">
														<?php 
                                ...
                                <a href="<?php echo $preview_candidate_photo."?".time(); ?>" class="example-image-link" data-lightbox="candidate_images" data-title="<?php echo 'Passport-size Photo of the Candidate - '.$preview_first_name; echo $preview_training_id != ""?" (".$preview_training_id.")":""; ?>">
                                  <img src="<?php echo $preview_candidate_photo."?".time(); ?>">
											...
											<div class="col-xl-6 col-lg-6"><?php // Upload Signature of the Candidate ?>
												<div class="form-group">
                          <?php if($form_data[0]['candidate_sign'] == "")
                          { ?>
                            <div class="img_preview_input_outer pull-left">
                          ...
                          <?php } ?>
													...
													<div id="candidate_sign_preview" class="upload_img_preview <?php if($form_data[0]['candidate_sign'] == "") { echo 'pull-right'; } ?>">
														<?php 
    ...
    <?php $this->load->view('iibfbcbf/common/inc_cropper_script', array('page_name'=>'bcbf_candidate_update_profile')); ?>
    ...
    <script type="text/javascript">
			...
			function get_city_ajax(state_id)
			{
				...
				{
					type: "POST",
					url: "<?php echo site_url('iibfbcbf/candidate/dashboard_candidate/get_city_ajax'); ?>",
					data: parameters,
					cache: false,
					dataType: 'JSON',
					async:false,
      ...
      //START : JQUERY VALIDATION SCRIPT 
			...
			$(document ).ready( function() 
			{
				...
				var form = $("#add_candidate_form").validate( 
				{
					...
					rules:
					{
						mobile_no:{ required: true, allow_only_numbers:true, first_zero_not_allowed:true, maxlength:10, minlength:10, remote: { url: "<?php echo site_url('iibfbcbf/candidate/dashboard_candidate/validation_check_mobile_exist/0/1'); ?>", type: "post", data: { "enc_candidate_id": function() { return "<?php echo $enc_candidate_id; ?>"; } } } },            
						alt_mobile_no:{ allow_only_numbers:true, first_zero_not_allowed:true, maxlength:10, minlength:10 },
						email_id:{ required: true, maxlength:80, valid_email:true, remote: { url: "<?php echo site_url('iibfbcbf/candidate/dashboard_candidate/validation_check_email_exist/0/1'); ?>", type: "post", data: { "enc_candidate_id": function() { return "<?php echo $enc_candidate_id; ?>"; } } } },
						...
						pincode:{ required: true, allow_only_numbers:true, minlength:6, maxlength: 6, remote: { url: "<?php echo site_url('iibfbcbf/candidate/dashboard_candidate/validation_check_valid_pincode/0/1'); ?>", type: "post", data: { "selected_state_code": function() { return $("#state").val(); } } } },  //check validation for pincode as per selected state
