  ...
  <body >
    ...
    <div class="bcbf_wrap"> 
      ...
      <div class="container">        
        ...
        <div class="admin_login_form animated fadeInDown">
          ...
          <form class="m-t" action="<?php echo site_url('iibfbcbf/login'); ?>" method="post" enctype="multipart/form-data" id="iibf_bcbf_login_form" autocomplete="off">
            <div class="form-group">
              <label for="iibf_bcbf_username" class="form_label">Username <sup class="text-danger">*</sup></label>
              <input type="text" name="iibf_bcbf_username" id="iibf_bcbf_username" value="<?php if (set_value('iibf_bcbf_username') != "") { echo set_value('iibf_bcbf_username'); } else if (isset($COOKIE_IIBF_BCBF_USERNAME) && $COOKIE_IIBF_BCBF_USERNAME != "") { echo $COOKIE_IIBF_BCBF_USERNAME; } ?>" class="form-control" placeholder="Username *" required maxlength="50" onchange="validate_input('iibf_bcbf_username')"/>
            ...
            <div class="form-group">
              ...
              <div class="login_password_common">
                <input type="password" name="iibf_bcbf_password" id="iibf_bcbf_password" value="<?php if (set_value('iibf_bcbf_password') != "") { echo set_value('iibf_bcbf_password'); } else if (isset($COOKIE_IIBF_BCBF_PASSWORD) && $COOKIE_IIBF_BCBF_PASSWORD != "") { echo $COOKIE_IIBF_BCBF_PASSWORD; } ?>" class="form-control" placeholder="Password *" autocomplete="off" required maxlength="20" onchange="validate_input('iibf_bcbf_password')"/>
            ...
            <div class="form-group">
              <div class="text-right">
                <label class="css_checkbox_radio d-block text-left check-bx my-3"> &nbsp;Remember Me
                  <input type="checkbox" id="iibfbcbf_remember_me" name="iibfbcbf_remember_me" <?php echo set_checkbox('iibfbcbf_remember_me', '1'); ?> <?php if ( isset($COOKIE_IIBF_BCBF_USERNAME) && $COOKIE_IIBF_BCBF_USERNAME != "" && isset($COOKIE_IIBF_BCBF_PASSWORD) && $COOKIE_IIBF_BCBF_PASSWORD != "") { echo "checked"; } ?> value="1">
    ...
    <script type="text/javascript">
      function refresh_captcha() 
      {
        ...
        $.ajax({
          type: "POST",
          url: "<?php echo site_url('iibfbcbf/login/refresh_captcha'); ?>",
      ...
      $(document).ready(function() 
      {
        ...
        $("#iibf_bcbf_login_form").validate(
        {
          ...
          rules: 
          { 
            iibf_bcbf_username: { required: true, remote: { url: "<?php echo site_url('iibfbcbf/login/validation_check_username/0/1'); ?>", type: "post" } },
            iibf_bcbf_password: { required: true, remote: { url: "<?php echo site_url('iibfbcbf/login/validation_check_login_details/0/1'); ?>", type: "post", data: { "iibf_bcbf_username": function() { return $("#iibf_bcbf_username").val() } } } },
            iibf_bcbf_captcha: { required: true, remote: { url: "<?php echo site_url('iibfbcbf/login/validation_check_captcha/0/1'); ?>", type: "post" } }
          },
          messages: 
          {
            iibf_bcbf_username: { required: "Please enter the username", remote: "Please enter the valid username" },
