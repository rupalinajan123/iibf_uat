            ...
            <ul class="nav metismenu side-bg-color" id="side-menu">
              ...
              <li <?php if($act_id == "Reports") { ?>class="active" <?php } ?>>
                ...
                <ul class="nav nav-second-level collapse"> 
                  ...
                  <li <?php if($sub_act_id == "Candidate exam application history") { ?>class="active" <?php } ?>><a href="<?php echo site_url('iibfbcbf/admin/candidate_exam_application_history_admin'); ?>"><span class="nav-label">Candidate exam application history</span></a></li> 
