      ...
      <?php $this->load->view('iibfbcbf/admin/inc_sidebar_admin'); ?>
        ...
        <?php $this->load->view('iibfbcbf/admin/inc_topbar_admin'); ?>
                ...
                <div class="ibox-content">
                  <form method="POST" action="<?php echo base_url("iibfbcbf/admin/masters_admin/get_exam_subject_master_data_ajax"); ?>" id="search_form" class="search_form_common_all" autocomplete="off">
                  ...
                  <div class="table-responsive">
                          ...
                          <th class="text-center wrap_space">Subject Code</th>
                          <th class="text-center wrap_space">Subject Description</th>
    ...
    <script language="javascript">
      $(document).ready(function()
          ...
          searching: true,
					...
					"ajax": 
          {
						"url": '<?php echo site_url("iibfbcbf/admin/masters_admin/get_exam_subject_master_data_ajax"); ?>',
						"type": "POST",	
            "data": function ( d ) 
						{ 
