  ...
  <?php $this->load->view('iibfbcbf/common/inc_loader'); ?>
    ...
    <?php $this->load->view('iibfbcbf/admin/inc_sidebar_admin'); ?>		
      ...
      <?php $this->load->view('iibfbcbf/admin/inc_topbar_admin'); ?>
						...
						<div class="col-lg-12">
							<div class="ibox">
								<div class="ibox-content">
									<form method="post" action="<?php echo site_url('iibfbcbf/admin/dashboard_admin/change_password'); ?>" id="change_pass_form" class="admin_form_all" enctype="multipart/form-data" autocomplete="off">										
										<div class="row">
		...
		<?php  
      $this->load->view('iibfbcbf/common/get_logs_common_ajax_call', array('enc_pk_id'=>$enc_login_admin_id, 'module_slug'=>'admin_self_password_action', 'log_title'=>'Admin Change Password Log'));
    ?>
      ...
      function validate_input(input_id) { $("#"+input_id).valid(); }
        ...
        $("#change_pass_form").validate( 
          ...
          onkeyup: function(element) { $(element).valid(); },
					rules:
					{
            current_pass_admin: { required: true, remote: { url: "<?php echo site_url('iibfbcbf/admin/dashboard_admin/validation_check_old_password/0/1') ?>", type: "post" } },
