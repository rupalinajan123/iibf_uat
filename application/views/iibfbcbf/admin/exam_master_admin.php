      ...
      <?php $this->load->view('iibfbcbf/admin/inc_sidebar_admin'); ?>
        ...
        <?php $this->load->view('iibfbcbf/admin/inc_topbar_admin'); ?>
				...
				<div class="row wrapper border-bottom white-bg page-heading">
					<div class="col-lg-12">
						...
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"><strong>Exam Master</strong></li>
						</ol>
					</div>
				</div>
                ...
                <div class="ibox-title">
                    ...
                    <form method="POST" action="<?php echo base_url("iibfbcbf/admin/masters_admin/get_exam_master_data_ajax"); ?>" id="search_form" class="search_form" autocomplete="off">
                ...
                <div class="ibox-content">
                  <div class="table-responsive">
                          ...
                          <th class="no-sort text-center" style="width:60px;">Sr. No.</th>
													...
													<th class="text-center nowrap">Exam Type</th>
												</tr>
											</thead>											
											<tbody></tbody>	
										</table>
    ...
    <script language="javascript">
      $(document).ready(function()
          ...
          searching: true,
					...
					"ajax": 
          {
						"url": '<?php echo site_url("iibfbcbf/admin/masters_admin/get_exam_master_data_ajax"); ?>',
						"type": "POST",	
            "data": function ( d ) 
						{ 
