      ...
      <?php $this->load->view('iibfbcbf/admin/inc_sidebar_admin'); ?>
        ...
        <?php $this->load->view('iibfbcbf/admin/inc_topbar_admin'); ?>
                ...
                <div class="ibox-title">
                    ...
                    <form method="POST" action="<?php echo base_url("iibfbcbf/admin/masters_admin/get_csc_exam_date_master_data_ajax"); ?>" id="search_form" class="search_form" autocomplete="off">
    ...
    <script language="javascript">
      $(document).ready(function()
          ...
          searching: true,
					...
					"ajax": 
          {
						"url": '<?php echo site_url("iibfbcbf/admin/masters_admin/get_csc_exam_date_master_data_ajax"); ?>',
						"type": "POST",	
            "data": function ( d ) 
						{ 
