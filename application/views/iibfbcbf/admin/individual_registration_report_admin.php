        ...
        <?php $this->load->view('iibfbcbf/admin/inc_topbar_admin'); ?>
              ...
              <li class="breadcrumb-item">Reports</li>
                ...
                <div class="ibox-content">
                  <form method="POST" action="<?php echo base_url("iibfbcbf/admin/Reports/get_success_individual_registration_data_ajax"); ?>" id="search_form" class="search_form_common_all" autocomplete="off">
                  ...
                  <div class="table-responsive">
                          ...
                          <th class="text-center nowrap">Email</th> 
													...
													<th class="text-center nowrap">NEFT / UTR No. / Transaction No.</th> 
    ...
    <script language="javascript">
      ...
      $(document).ready(function()
          ...
          searching: true,
					...
					"ajax": 
          {
						"url": '<?php echo site_url("iibfbcbf/admin/Reports/get_success_individual_registration_data_ajax"); ?>',
						"type": "POST",	
            "data": function ( d ) 
						{
          ...
          rowReorder: false,
            ...
            {"targets": [3,5,6,9,10,11,13,14,15,16], "className": "text-center"}, 
					],
					"aaSorting": [],
					"stateSave": false,		          			
				});
