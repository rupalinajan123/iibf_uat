      ...
      <?php $this->load->view('iibfbcbf/admin/inc_sidebar_admin'); ?>
        ...
        <?php $this->load->view('iibfbcbf/admin/inc_topbar_admin'); ?>
                ...
                <div class="ibox-content">
                  <form method="POST" action="<?php echo base_url("iibfbcbf/admin/masters_admin/get_exam_activation_master_data_ajax"); ?>" id="search_form" class="search_form_common_all" autocomplete="off">
                    ...
                    <div class="form-group">
                      <input type="text" class="form-control s_datepicker search_opt" name="s_from_date" id="s_from_date" placeholder="From Date" value="" readonly>
                    </div>

                    <div class="form-group">
                      <input type="text" class="form-control s_datepicker search_opt" name="s_to_date" id="s_to_date" placeholder="To Date" value="" readonly>
                    </div>
                  ...
                  <div class="table-responsive">
                          ...
                          <th class="no-sort text-center" style="width:60px;">Sr. No.</th>
													...
													<th class="text-center nowrap" style="width:60px;">Exam Type</th>
													<th class="text-center nowrap" style="width:60px;">Exam Code</th>
													<th class="text-center nowrap" style="width:60px;">Exam Period</th>
													<th class="text-center nowrap">Start Date & Time</th>
													<th class="text-center nowrap">End Date & Time</th>
												</tr>
											</thead>											
											<tbody></tbody>	
										</table>
    ...
    <script language="javascript">
      ...
      $(document).ready(function()
          ...
          searching: true,
					...
					"ajax": 
          {
						"url": '<?php echo site_url("iibfbcbf/admin/masters_admin/get_exam_activation_master_data_ajax"); ?>',
						"type": "POST",	
            "data": function ( d ) 
						{ 
