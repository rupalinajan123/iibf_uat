      ...
      <?php $this->load->view('iibfbcbf/admin/inc_sidebar_admin'); ?>
        ...
        <?php $this->load->view('iibfbcbf/admin/inc_topbar_admin'); ?>
                ...
                <div class="ibox-content">
                  <form method="POST" action="<?php echo base_url("iibfbcbf/admin/reports/get_inspector_report_data_ajax"); ?>" id="search_form" class="search_form_common_all" action="javascript:void(0)" autocomplete="off">
                  ...
                  <div class="table-responsive">
                          ...
                          <th class="no-sort text-center nowrap" style="width:60px;">Sr. No.</th>
													<th class="text-center nowrap">Name of Inspector</th>
													<th class="text-center nowrap">Designation</th>
													<th class="text-center nowrap">Assigned Centre(s)</th>
													<th class="text-center nowrap">No. of Basic Batches Allotted</th>
													<th class="text-center nowrap">No. of Reports Submitted</th>
													<th class="text-center nowrap">No. of Reports not submitted</th>
			                    <th class="text-center nowrap">No. of Reports Awaited</th> 
			                    <th class="text-center">No. of Advanced Batches Allotted</th> 
			                    <th class="text-center">No. of Reports Submitted</th> 
			                    <th class="text-center">No. of Reports not Submitted</th> 
			                    <th class="text-center">No. of Reports Awaited</th> 
    ...
    <script language="javascript">
      ...
      $(document).ready(function()
          ...
          searching: true,
					...
					"ajax": 
          {
						"url": '<?php echo site_url("iibfbcbf/admin/reports/get_inspector_report_data_ajax"); ?>',
						"type": "POST",	
            "data": function ( d ) 
						{
          ...
          rowReorder: false,
					...
					[
						...
						{"targets": [0, 3, 4, 5, 6, 7, 8, 9, 10, 11], "className": "text-center"}, 
					],
					"aaSorting": [],
					"stateSave": false,		          			
				});
