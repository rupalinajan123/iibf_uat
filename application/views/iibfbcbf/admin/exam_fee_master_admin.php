      ...
      <?php $this->load->view('iibfbcbf/admin/inc_sidebar_admin'); ?>
        ...
        <?php $this->load->view('iibfbcbf/admin/inc_topbar_admin'); ?>
                ...
                <div class="ibox-content">
                  <form method="POST" action="<?php echo base_url("iibfbcbf/admin/masters_admin/get_exam_fee_master_data_ajax"); ?>" id="search_form" class="search_form_common_all" autocomplete="off">
                  ...
                  <div class="table-responsive">
                          ...
                          <th class="no-sort text-center" style="width:60px;">Sr. No.</th>
													...
													<th class="text-center wrap_space">Part No</th>
													<th class="text-center wrap_space">Syllabus Code</th>
													<th class="text-center wrap_space">Member Category</th>
													<th class="text-center wrap_space">Group Code</th>
													<th class="text-center wrap_space">Fee Amount</th>
													<th class="text-center wrap_space">SGST Amount</th>
													<th class="text-center wrap_space">CGST Amount</th>
													<th class="text-center wrap_space">IGST Amount</th>
													<th class="text-center wrap_space">CS Total</th>
													<th class="text-center wrap_space">IGST Total</th>
													<th class="text-center wrap_space">From Date</th>
													<th class="text-center wrap_space">To Date</th>
													<th class="text-center wrap_space">Exempt</th>
												</tr>
											</thead>											
											<tbody></tbody>	
										</table>
    ...
    <script language="javascript">
      $(document).ready(function()
          ...
          searching: true,
					...
					"ajax": 
          {
						"url": '<?php echo site_url("iibfbcbf/admin/masters_admin/get_exam_fee_master_data_ajax"); ?>',
						"type": "POST",	
            "data": function ( d ) 
						{ 
