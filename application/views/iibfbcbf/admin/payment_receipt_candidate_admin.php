        ...
        <div class="row wrapper border-bottom white-bg page-heading">
          <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="<?php echo site_url('iibfbcbf/admin/transaction/transactions_details/'.$enc_pt_id); ?>">NEFT Transactions Details</a></li>              
              ...
              <div class="ibox">
                <div class="ibox-title">
                  <div class="ibox-tools">
                    <a href="<?php echo site_url('iibfbcbf/admin/transaction/transactions_details/'.$enc_pt_id); ?>" class="btn btn-primary custom_right_add_new_btn">Back</a>                    
                  </div>
                </div>
