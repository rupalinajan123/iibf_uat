                ...
                <?php if($this->session->userdata('IIBF_BCBF_USER_TYPE') == 'centre') { /* only centre can add batches */ ?>
                  <div class="ibox-title">
                    <div class="ibox-tools">
                      <a href="<?php echo site_url('iibfbcbf/admin/training_batches/add_training_batch_admin'); ?>" class="btn btn-primary custom_right_add_new_btn">Add Batch</a>                    
                    </div>
                  </div>
                <?php } ?>
    ...
    <script language="javascript">
      ...
      $(document).ready(function()
          ...
          searching: true,
					...
					"ajax": 
          {
						"url": '<?php echo site_url("iibfbcbf/admin/training_batches/get_training_batches_data_ajax"); ?>',
						"type": "POST",	
            "data": function ( d ) 
						{
