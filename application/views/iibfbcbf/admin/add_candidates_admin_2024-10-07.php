                  ...
                  <form method="post" action="<?php echo site_url('iibfbcbf/admin/batch_candidates/add_candidates/'.url_encode($batch_data[0]['batch_id']).'/'.$enc_candidate_id); ?>" id="add_candidate_form" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="col-xl-12 col-lg-12"><?php /* Address Line-4 */ ?>
                      ...
                      <div class="col-xl-6 col-lg-6 bank_associated_outer"><?php /* Bank associated with */ ?>
                          ...
                          <select name="bank_associated" id="bank_associated" class="form-control chosen-selectx " onchange="show_hide_other_section(); validate_input('bank_associated'); " <?php echo $required_bank_associated_flg; ?>>
														<?php if(count($bank_associated_master_data) > 0) { ?>
															...
															<?php foreach($bank_associated_master_data as $res) { ?>
																<option value="<?php echo $res['bank_name']; ?>" <?php if($chk_bank_associated == $res['bank_name']) { echo 'selected'; } ?>><?php echo $res['bank_name']; ?></option>
                              <?php }
                            }
                            else 
                            { ?>
                          ...
                          <div class="form-group">
                            ...
                            <div id="id_proof_file_preview" class="upload_img_preview pull-right">
                              ...
                              if($mode == 'Add' && set_value('id_proof_file_cropper') != "") 
                              {
                                ...
                                { ?>
                                <a href="<?php echo base_url($id_proof_file_path.'/'.$preview_id_proof_file)."?".time(); ?>" class="example-image-link" data-lightbox="candidate_images" data-title="<?php echo 'Proof of Identity - '.$preview_first_name; echo $preview_training_id != ""?" (".$preview_training_id.")":""; ?>">
                          ...
                          <div class="form-group">
                            ...
                            <div id="qualification_certificate_file_preview" class="upload_img_preview pull-right">
                              ...
                              if($mode == 'Add' && set_value('qualification_certificate_file_cropper') != "") 
                              {
                                ...
                                { ?>
                                <a href="<?php echo base_url($qualification_certificate_file_path.'/'.$preview_qualification_certificate_file)."?".time(); ?>" class="example-image-link" data-lightbox="candidate_images" data-title="<?php echo 'Qualification Certificate - '.$preview_first_name; echo $preview_training_id != ""?" (".$preview_training_id.")":""; ?>">
                          ...
                          <div class="form-group">
                            ...
                            <div id="candidate_photo_preview" class="upload_img_preview pull-right">
                              ...
                              if($mode == 'Add' && set_value('candidate_photo_cropper') != "") 
                              {
                                ...
                                { ?>
                                <a href="<?php echo base_url($candidate_photo_path.'/'.$preview_candidate_photo)."?".time(); ?>" class="example-image-link" data-lightbox="candidate_images" data-title="<?php echo 'Passport-size Photo of the Candidate - '.$preview_first_name; echo $preview_training_id != ""?" (".$preview_training_id.")":""; ?>">
                          ...
                          <div class="form-group">
                            ...
                            <div id="candidate_sign_preview" class="upload_img_preview pull-right">
                              ...
                              $preview_candidate_sign = set_value('candidate_sign_cropper'); 
                                ...
                                { ?>
                                <a href="<?php echo base_url($candidate_sign_path.'/'.$preview_candidate_sign)."?".time(); ?>" class="example-image-link" data-lightbox="candidate_images" data-title="<?php echo 'Signature of the Candidate - '.$preview_first_name; echo $preview_training_id != ""?" (".$preview_training_id.")":""; ?>">
    ...
    <script type="text/javascript">
      ...
      $(document ).ready( function() 
      {
        ...
        var form = $("#add_candidate_form").validate( 
        {
          ...
          rules:
          {
            ...
            mobile_no:{ required: true, allow_only_numbers:true, first_zero_not_allowed:true, maxlength:10, minlength:10, remote: { url: "<?php echo site_url('iibfbcbf/admin/batch_candidates/validation_check_mobile_exist/0/1'); ?>", type: "post", data: { "enc_candidate_id": function() { return "<?php echo $enc_candidate_id; ?>"; } } } },            
            alt_mobile_no:{ allow_only_numbers:true, first_zero_not_allowed:true, maxlength:10, minlength:10 },
            email_id:{ required: true, maxlength:80, valid_email:true, remote: { url: "<?php echo site_url('iibfbcbf/admin/batch_candidates/validation_check_email_exist/0/1'); ?>", type: "post", data: { "enc_candidate_id": function() { return "<?php echo $enc_candidate_id; ?>"; } } } },
            ...
            id_proof_number:{ validate_id_proof_number: true, remote: { url: "<?php echo site_url('iibfbcbf/admin/batch_candidates/validation_check_id_proof_number_exist/0/1'); ?>", type: "post", data: { "enc_candidate_id": function() { return "<?php echo $enc_candidate_id; ?>"; } } } },
            ...
            aadhar_no:{ allow_only_numbers:true, maxlength:12, minlength:12, CheckAadharNumberWithIdProof: true, remote: { url: "<?php echo site_url('iibfbcbf/admin/batch_candidates/validation_check_aadhar_no_exist/0/1'); ?>", type: "post", data: { "enc_candidate_id": function() { return "<?php echo $enc_candidate_id; ?>"; } } } },
          },
          messages:
          {
      ...
      function validate_all_details(form_action)
      {
        ...
        if($('input[name="associated_with_any_bank"]:checked').val() == '1') //YES
        {
          ...
          $("#bank_associated").rules("add", { required: true, allow_only_alphabets_and_space:true, maxlength:90 });
        }
        else
        {
          //console.log("4 "+$('input[name="associated_with_any_bank"]:checked').val())
        ...
        $("#id_proof_number").rules("add", { validate_id_proof_number: true, remote: { url: "<?php echo site_url('iibfbcbf/admin/batch_candidates/validation_check_id_proof_number_exist/0/1'); ?>", type: "post", data: { "enc_candidate_id": function() { return "<?php echo $enc_candidate_id; ?>"; } } } });
        ...
        $("#aadhar_no").rules("add", { allow_only_numbers:true, maxlength:12, minlength:12, CheckAadharNumberWithIdProof: true, remote: { url: "<?php echo site_url('iibfbcbf/admin/batch_candidates/validation_check_aadhar_no_exist/0/1'); ?>", type: "post", data: { "enc_candidate_id": function() { return "<?php echo $enc_candidate_id; ?>"; } } } });
