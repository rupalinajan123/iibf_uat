  ...
  <head>
      ...
      <?php $this->load->view('iibfbcbf/admin/inc_sidebar_admin'); ?>		
        ...
        <?php $this->load->view('iibfbcbf/admin/inc_topbar_admin'); ?>
              ...
              <li class="breadcrumb-item">Masters</li>
							<li class="breadcrumb-item"><a href="<?php echo site_url('iibfbcbf/admin/faculty'); ?>">Faculty Master</a></li>
				...
				<div class="wrapper wrapper-content animated fadeInRight">
							...
							<div class="ibox">
								<div class="ibox-title">
									<div class="ibox-tools">
										<a href="<?php echo site_url('iibfbcbf/admin/faculty'); ?>" class="btn btn-danger custom_right_add_new_btn">Back</a>
                  </div>
                </div>
                  ...
                  <div class="table-responsive">
                    ...
                    <div class="hr-line-dashed"></div>										
                      ...
                      <a href="<?php echo site_url('iibfbcbf/admin/faculty'); ?>" class="btn btn-danger">Back</a>	
                    </div>
                  </div>                  
                </div>
              </div>
          ...
          <div class="modal-content">
              ...
              <form method="post" class="form-horizontal" id="reasonForm" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="modal-footer" id="submit_btn_outer"> 
                  <button type="submit" class="btn btn-success" id="btnSubmit" onclick="submit_reason_for_faculty_deactivate();">Submit</button>
    ...
    <script type="text/javascript">
      ...
      function change_faculty_status(enc_id,exist_status,reason_flag=''){
        ...
        if(reason_flag == 'reason_required'){
          reason_for_deactivate = $('#reason_for_deactivate').val();
        }
        ...
        if(enc_id != ""){
          ...
          swal({ title: "Please confirm", text: "Please confirm, do you want to "+status_nm+" the Faculty", type: "warning", showCancelButton: true, confirmButtonColor: "#DD6B55", confirmButtonText: "Yes", closeOnConfirm: false }, function () 
            { 
              ...
              {
                type: "POST",
                url: "<?php echo site_url('iibfbcbf/admin/faculty/change_faculty_status/'); ?>",
