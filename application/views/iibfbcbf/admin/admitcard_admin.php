				...
				<div class="row wrapper border-bottom white-bg page-heading">
					<div class="col-lg-12">
						...
						<ol class="breadcrumb">
							...
							<?php if($center_code_enc != "" && $exam_code_enc != "" && $exam_period_enc != "") { ?><li class="breadcrumb-item"><a href="<?php echo site_url('iibfbcbf/admin/Admitcard'); ?>">Download Admitcard</a></li><?php } ?>
				...
				<div class="wrapper wrapper-content animated fadeInRight">
                  ...
                  <div class="ibox-title">
                    <div class="ibox-tools"> 
                      <a href="<?php echo site_url('iibfbcbf/admin/Admitcard'); ?>" class="btn btn-danger custom_right_add_new_btn">Back</a> 
                    </div>
                  </div>   
                <?php } ?>
    ...
    <script language="javascript">
      ...
      $(document).ready(function()
          ...
          searching: true,
					...
					"ajax": 
          {
						"url": '<?php echo site_url("iibfbcbf/admin/admitcard/get_admitcard_data_ajax"); ?>',
						"type": "POST",	
            "data": function ( d ) 
						{
