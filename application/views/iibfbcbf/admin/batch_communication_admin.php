      ...
      <?php $this->load->view('iibfbcbf/admin/inc_sidebar_admin'); ?>
        ...
        <?php $this->load->view('iibfbcbf/admin/inc_topbar_admin'); ?>
                ...
                <div class="ibox-content">
                  <form method="POST" action="<?php echo base_url("iibfbcbf/admin/reports/get_batch_communication_data_ajax"); ?>" id="search_form" class="search_form_common_all" action="javascript:void(0)" autocomplete="off">
                  ...
                  <div class="table-responsive">
                          ...
                          <th class="no-sort text-center nowrap" style="width:60px;">Sr. No.</th>
													...
													<th class="text-center nowrap">Date and Time</th>
													<th class="text-center nowrap">Communication Shared By Center</th> 
													<th class="text-center">Remarks By Agency</th>
			                    <th class="text-center">Remarks By Admin</th> 
    ...
    <script language="javascript">
      ...
      $(document).ready(function()
          ...
          searching: true,
					...
					"ajax": 
          {
						"url": '<?php echo site_url("iibfbcbf/admin/reports/get_batch_communication_data_ajax"); ?>',
						"type": "POST",	
            "data": function ( d ) 
						{
