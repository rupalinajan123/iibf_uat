      ...
      <?php $this->load->view('iibfbcbf/admin/inc_sidebar_admin'); ?>
        ...
        <?php $this->load->view('iibfbcbf/admin/inc_topbar_admin'); ?>
                ...
                <div class="ibox-content">
                  <form method="POST" action="<?php echo base_url("iibfbcbf/admin/masters_admin/get_exam_venue_master_data_ajax"); ?>" id="search_form" class="search_form_common_all" autocomplete="off">
                  ...
                  <div class="table-responsive">
                          ...
                          <th class="no-sort text-center" style="width:60px;">Sr. No.</th>
													...
													<th class="text-center wrap_space">Exam Date</th>
													<th class="text-center wrap_space">Centre Code</th>
													<th class="text-center wrap_space">Session Time</th>
													<th class="text-center wrap_space">Session Capacity</th>
													<th class="text-center wrap_space">Venue Code</th>
													<th class="text-center wrap_space">Venue Name</th>
													<th class="text-center wrap_space">Venue Address1</th>
													<th class="text-center wrap_space">Venue Address2</th>
													<th class="text-center wrap_space">Venue Address3</th>
													<th class="text-center wrap_space">Venue Address4</th>
													<th class="text-center wrap_space">Venue Address5</th>
													<th class="text-center wrap_space">Venue Pincode</th>
													<th class="text-center wrap_space">Password Enabled</th>
													<th class="text-center wrap_space">Vendor Code</th>
												</tr>
											</thead>											
											<tbody></tbody>	
										</table>
    ...
    <script language="javascript">
      $(document).ready(function()
          ...
          searching: true,
					...
					"ajax": 
          {
						"url": '<?php echo site_url("iibfbcbf/admin/masters_admin/get_exam_venue_master_data_ajax"); ?>',
						"type": "POST",	
            "data": function ( d ) 
						{ 
