      ...
      <?php $this->load->view('iibfbcbf/admin/inc_sidebar_admin'); ?>
        ...
        <?php $this->load->view('iibfbcbf/admin/inc_topbar_admin'); ?>
				...
				<div class="row wrapper border-bottom white-bg page-heading">
					<div class="col-lg-12">
						...
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active"> <strong>Batch MIS</strong></li>
						</ol>
					</div>
				</div>
                ...
                <div class="ibox-content">
                  <form method="POST" action="<?php echo base_url("iibfbcbf/admin/reports/get_batch_mis_data_ajax"); ?>" id="search_form" class="search_form_common_all" action="javascript:void(0)" autocomplete="off">
                  ...
                  <div class="table-responsive">
                          ...
                          <th class="no-sort text-center nowrap" style="width:60px;">Sr. No.</th>
													...
													<th class="text-center">No. of Release Candidates</th>
													<th class="text-center">No. of Hold Candidates</th>
													...
													<th class="text-center">Inspection/Rating(Poor)</th>
			                    <th class="text-center">Inspection/Rating(Average)</th>
			                    <th class="text-center">Inspection/Rating(Good)</th>
			                    <th class="text-center">Inspection/Rating(Excellent)</th> 
    ...
    <script language="javascript">
      ...
      $(document).ready(function()
          ...
          searching: true,
					...
					"ajax": 
          {
						"url": '<?php echo site_url("iibfbcbf/admin/reports/get_batch_mis_data_ajax"); ?>',
						"type": "POST",	
            "data": function ( d ) 
						{
          ...
          rowReorder: false,
					...
					[
						...
						{"targets": [0, 3, 4, 5, 6, 7, 8, 9, 11, 12, 13, 14, 15, 16], "className": "text-center"}, 
					],
					"aaSorting": [],
					"stateSave": false,		          			
				});
