      ...
      <?php $this->load->view('iibfbcbf/admin/inc_sidebar_admin'); ?>
        ...
        <?php $this->load->view('iibfbcbf/admin/inc_topbar_admin'); ?>
				...
				<div class="row wrapper border-bottom white-bg page-heading">
					<div class="col-lg-12">
						<h2>Candidates Required to re-enroll for Training</h2>
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?php echo site_url('iibfbcbf/admin/dashboard_admin'); ?>">Dashboard</a></li>
							<li class="breadcrumb-item">Reports</li>
							<li class="breadcrumb-item active"> <strong>Candidates Required to re-enroll for Training</strong></li>
						</ol>
					</div>
				</div>
                ...
                <div class="ibox-content">
                  <form method="POST" action="<?php echo base_url("iibfbcbf/admin/reports/get_candidates_to_re_enroll_for_training_data_ajax"); ?>" id="search_form" class="search_form_common_all" action="javascript:void(0)" autocomplete="off">
                  ...
                  <div class="table-responsive">
                          ...
                          <th class="no-sort text-center nowrap" style="width:60px;">Sr. No.</th>
			                    ...
			                    <th class="text-center">Training From</th> 
			                    <th class="text-center">Training To</th> 
			                    <!-- <th class="text-center">Release Status (Y/N)</th> --> 
			                    ...
			                    <!-- <th class="text-center">Attempt Remaining</th>  
    ...
    <script language="javascript">
      ...
      $(document).ready(function()
          ...
          searching: true,
					...
					"ajax": 
          {
						"url": '<?php echo site_url("iibfbcbf/admin/reports/get_candidates_to_re_enroll_for_training_data_ajax"); ?>',
						"type": "POST",	
            "data": function ( d ) 
						{
          ...
          rowReorder: false,
					...
					[
						...
						{"targets": [0, 3, 4, 5, 7, 8, 9, 10, 11, 12, 13, 14], "className": "text-center"}, 
					],
					"aaSorting": [],
					"stateSave": false,		          			
				});
