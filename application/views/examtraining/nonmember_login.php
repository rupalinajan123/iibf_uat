...
<label for="text" class="col-md-6">Type the exact characters you see in the picture <span class="red">*</span>.</label>
	...
	<label>     <div id="captcha_img"><?php echo $image;?></div></label>
      ...
      <ul>
        ...
        <?php /*?><?php
        	$exarr = array(20,340,580,59,81,1600,175,177);
...
<table width="100%" cellspacing="0" cellpadding="0" border="1">
  <tbody>
    <tr>
   	  <td><p align="center"><strong>Sl. No.</strong></p></td>
      <td><p align="center"><strong>IIBF Centre Code</strong></p></td>
      <td><p align="center"><strong>Centre Name</strong></p></td>
    </tr>
    <tr>
    	<td valign="top"><p align="center">1</p></td>
      	<td valign="top"><p align="center">192</p></td>
      	<td valign="top"><p align="center">BELGAUM</p></td>
    </tr>
    <tr>
    	<td valign="top"><p align="center">2</p></td>
      	<td valign="top"><p align="center">479</p></td>
      	<td valign="top"><p align="center">THANJAVUR</p></td>
    </tr>
  </tbody>
</table>
</ul>
