            ...
            <div class="box-body">
             ...
             ?>
				...
				{?>
                        ...
                        <a href="<?php echo base_url()?>NonMember/exampdf/">Save as pdf</a> &nbsp; &nbsp;
                      <a href="javascript:void(0);" onclick="print_exam_non_mem_preview()">Continue</a>
					   <a href="<?php echo base_url()?>uploads/Publications _List_IT.xlsx" class='publication' data-attr=<?php echo $applied_exam_info[0]['regnumber'];?>  target="_blank">Publications</a>
                        </div>
					<?php 
				}?>	
                </div>
