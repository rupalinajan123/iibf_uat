...
<form class="form-horizontal" name="usersAddForm" id="usersAddForm"  method="post"  enctype="multipart/form-data" 
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-sm-5">
        <img src="<?php echo base_url();?><?php echo get_img_name($this->session->userdata('nmregnumber'),'pr');?><?php echo '?'.time(); ?>"  height="180" width="100">
        </div>
        </div>
        ...
        <?php echo date('d-m-Y h:i:s A',strtotime($user_info[0]['createdon']));?>
                ...
                <div class="col-sm-3">
                	...
                	<label for="roleid" class="col-sm-3 control-label"><img src="<?php echo base_url();?><?php echo get_img_name($this->session->userdata('nmregnumber'),'p');?><?php echo '?'.time(); ?>" height="100" width="100" ></label>
...
<div style=" background:#000; width:100%; height:1px; margin-bottom:10px;"></div>
	<table width="100%" cellspacing="2" cellpadding="2" border="0" align="center"  style=" position:relative;" class="tablecontent2" >
			...
			<img src="<?php echo base_url();?><?php echo get_img_name($this->session->userdata('nmregnumber'),'p');?>" height="100" width="100" style=" position:absolute; right:15px; top:0px;" >
			</td>
		</tr>
				<tr>
		...
		<tr>
			<td class="tablecontent2">ID Proof :</td>
			<td colspan="3" class="tablecontent2" nowrap="nowrap"><img src="<?php echo base_url();?><?php echo get_img_name($this->session->userdata('nmregnumber'),'pr');?>"  height="180" width="100"></td>
		</tr>

		<tr>
			<td class="tablecontent2">Signature :</td>
			<td colspan="3" class="tablecontent2" nowrap="nowrap"><img src="<?php echo base_url();?><?php echo get_img_name($this->session->userdata('nmregnumber'),'s');?>" height="100" width="100"></td>
		</tr>
