...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1 class="register"> IT & Cyber Security <br/>
        ...
        <div class="col-md-12"> Pl note that if you have  already registered for any examination under Non-member Category in the past,  the same Registration Number allotted to you can be used for registering for other examinations(other than DB&F Exam) applicable for Non-members as per the eligibility criteria given.  Already Registered candidates has to apply for examinations by login using their USER ID and PASSWORD already provided - <a href=<?php echo base_url();?>nonmem><span style="color:#090">Click here for Login</span></a><br/>
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              ...
              <?php if(base64_decode($this->input->get('ExId'))==101)
				{?>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input  type="file" class="" name="scannedphoto" id="scannedphoto" required style="width: 100%;">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input  type="file" class="" name="scannedsignaturephoto" id="scannedsignaturephoto" required style="width: 100%;">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input  type="file" class="" name="idproofphoto" id="idproofphoto" required style="width: 100%;">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9"> 1. Please ensure all images are clear, visible and readable after uploading, if not do  not submit and upload fresh set of images.</br>
                  ...
                  5. Image Dimension of ID Proof should be 400(Width) * 420(Height) Pixel only. Size should be minimum 8KB and maximum 300KB.</br>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="box-body">
              <div class="form-group" style="display:none">
                <div class="col-sm-3" style="display:none">
                  <select name="selCenterName" id="selCenterName" class="form-control" onchange="valCentre(this.value);">
                    <option value="">Select</option>
                    <?php if(count($center) > 0)
					{
						foreach($center as $crow)
						{?>
                    <option value="<?php //echo $crow['center_code']?>" class=<?php //echo $crow['exammode'];?>>
                    <?php //echo $crow['center_name']?>
                    </option>
                    <?php }
					}?>
                  </select>
          ...
          <div class="box box-info">
            <div id="capacitymsg" style="display:none">
              <div class="alert alert-danger" style="font-size:150%"> <?php echo 'Seats are full for this training.'; ?> </div>
            </div>
            <div class="form-group">
              <label for="roleid" class="col-sm-4 control-label">Courses&nbsp;<span style="color:#F00">*</span>&nbsp;:</label>
              <div class="col-sm-5">
                <select class="form-control" id="program" name="program" required onchange="gettrainingtype(this.value);" >
				  ...
				  { 
							...
							{?>
                  <option value="<?php echo $prow['program_code'];?>" <?php echo  set_select('program', $prow['program_code']); ?>><?php echo $prow['program_name'];?></option>
                  <?php } 
				  } ?>
                </select>
              </div>
            ...
            <div class="form-group" style="display:none;" id="showCenter">
              <label for="roleid" class="col-sm-4 control-label">Center&nbsp;:</label>
          ...
          <div class="box box-info">
            ...
            <div class="box-footer">
              <div class="col-sm-6 col-sm-offset-2"> <a href="javascript:void(0);" class="btn btn-info" id="preview" onclick="javascript:return non_mem_trg_checkform();">Preview and Proceed Application</a>
                <!--<input type="submit" class="btn btn-info" name="btnSubmit" id="preview" value="Preview and Proceed Application" onclick="javascript:return non_mem_trg_checkform();">-->
                <button type="reset" class="btn btn-default pull-right"  name="btnReset" id="btnReset" onClick="window.location.reload()">Reset</button>
              </div>
            </div>
          </div>
        </div>
...
<div class="modal fade" id="myModalscrib" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body" style="color:#F00"> The facility of scribe ,on request, is provided to the person with Disability only. </div>
      <div class="modal-footer">
...
<script src="<?php echo base_url();?>js/validation_examtraining.js?<?php echo time();?>"></script>
...
$(function(){
    ...
    $.ajax({
 		type: 'POST',
 		url: site_url+'examtraining/generatecaptchaajax/',
