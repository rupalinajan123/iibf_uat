...
<div class="container">
  <div class="content-wrapper">
    ...
    action="<?php echo base_url()?>examtraining/addmember/">
        ...
        <div class="row">
		 ...
		 <div class="form-group">
            ...
            <div class="box box-info">
              ...
              <div class="form-group">
                <label for="roleid" class="col-sm-3 control-label">Program Name </label>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5"> <?php echo $this->session->userdata['enduserinfo']['blended_center_name'];?> </div>
              </div>
              <div class="form-group">
                <label for="roleid" class="col-sm-3 control-label">Fees</label>
                <div class="col-sm-5"> <?php echo $this->session->userdata['enduserinfo']['blended_fee_amount']; ?> </div>
              </div>
              <div class="form-group">
                <label for="roleid" class="col-sm-3 control-label">Start Date</label>
                <div class="col-sm-5"> <?php echo $this->session->userdata['enduserinfo']['start_date'];?> </div>
              </div>
              <div class="form-group">
                <label for="roleid" class="col-sm-3 control-label">End Date</label>
                <div class="col-sm-5"> <?php echo $this->session->userdata['enduserinfo']['end_date'];?> </div>
              </div>
              <div class="box-footer">
                <div class="col-sm-4 col-xs-offset-3">
                  <input type="submit" class="btn btn-info" name="btnSubmit" id="btnSubmit" value="Proceed Application">
                </div>
              </div>
            </div>
          </div>
