         ...
         <tr>
           <td>
             <table border="0" cellpadding="0" cellspacing="0" width="80%" align="center">
               <tr>
                 <td style="text-align:center; padding:60px 0 25px; font-size:22px; font-family:Tahoma, Geneva, sans-serif; font-weight:bold; line-height:32px;">Results for Diploma/Certificate Examination July 2016</td>
               </tr>
               <tr>
                <td bgcolor="#6699CC">
                    ...
                    <tr>
                      ...
                      <td class="content" width="55%" bgcolor="#d8e4f1">
                        <select name="exam" id="exam" class="text1" style="min-width:218px;">
                          ...
                          <option value="<?php echo $exam->exam_code.'_'.$exam->period ?>"><?php echo $exam->description ?></option>
                          <?php }?><?php */?>
                          <option value="47_116">DIPLOMA IN HOME LOAN ADVISING</option>
                          <option value="32_116">ADVANCED WEALTH MANAGEMENT COURSE</option>
                          <option value="35_116">CERTIFIED INFORMATION SYSTEM BANKER</option>
                          <option value="33_116">DIPLOMA IN TREASURY INVESTMENT AND RISK MANAGEMENT</option>
                          <option value="31_116">CERTIFICATE IN TRADE FINANCE</option>
                          <option value="20_116">CERTIFIED CREDIT OFFICER</option>
                          <option value="19_116">CERTIFIED BANKING COMPLIANCE PROFESSIONAL</option>
                          <option value="18_116">CERTIFIED BANK TRAINER</option>
                          <option value="11_116">DIPLOMA IN INTERNATIONAL BANKING AND FINANCE</option>
                          <option value="8_116">DIPLOMA IN BANKING TECHNOLOGY</option>
                          <option value="52_116">DIPLOMA IN URBAN CO OP BANKING</option>
                          <option value="51_116">DIPLOMA IN COMMODITY DERIVATIVES FOR BANKERS </option>
                          <option value="48_116">CREDIT CARD FOR BANKERS</option>
                          <option value="49_116">QUANTITATIVE METHODS FOR BANKING AND FINANCE</option>
                          <option value="53_116">SME FINANCE FOR BANKERS</option>
                          <option value="59_116">CERTIFIED TREASURY DEALER</option>
                          <option value="74_116">CERTIFICATE COURSE IN FOREIGN EXCHANGE</option>
                          <option value="75_116">CERTIFICATE EXAMINATION IN IT SECURITY</option>
                          <option value="76_116">RURAL BANKING OPERATIONS FOR RRB STAFF</option>
                          <option value="77_116">PREVENTION OF CYBER CRIMES AND FRAUD MANAGEMENT</option>
                          <option value="78_116">FOREIGN EXCHANGE FACILITIES FOR INDIVIDUALS</option>
                          <option value="79_116">CERTIFICATE EXAMINATION IN MICROFINANCE</option>
                          <option value="81_116">CERTIFICATE IN RISK FINANCIAL SERVICES (LEVEL 1)</option>
                          <option value="34_216">ANTI-MONEY LAUNDERING AND KNOW YOUR CUSTOMER</option>
                          <option value="58_216">CUSTOMER SERVICE AND BANKING CODES AND STANDARDS</option>
                        </select>
                      </td>
                    </tr>
                    <tr>
