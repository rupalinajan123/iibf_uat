      ...
      <div class="col-md-12">
        ...
        <form class="form-horizontal" name="getDetailsForm" id="getDetailsForm" method="post" action="" style="padding:10px 0 10px 0">
          <div class="form-group">
            <label for="member_no" class="col-lg-2 col-md-3 col-sm-4 col-xs-12 col-lg-offset-2 control-label">Member No. / Email <span style="color:#F00">*</span></label>
            <div class="col-lg-4 col-md-5 col-sm-4 col-xs-12">
              <input type="text" class="form-control" id="member_no" name="member_no" placeholder="Enter Member No / Email" autofocus value="<?php echo $member_no; ?>" style="margin:0 0px 5px 0;" required autocomplete="off">
                        ...
                        <div style="border:1px solid #ddd; margin-bottom:10px;">
                          <div style="background: #f5f5f5;text-align: center;font-weight: 600;padding: 8px;margin-bottom:10px;">
                            <p style="margin: 0;line-height: 24px;">
                              ...
                              ?>
                              <br>Member No : <?php echo $member_data[0]['regnumber']; ?>
															<br>Email : <?php echo $member_data[0]['email']; ?>
															<br>Mobile : <?php echo $member_data[0]['mobile']; ?>
                            </p>
                          </div>
                          ...
                          <ul class="member_img_outer">                            
                              ...
                              <!-- Declaration added by pratiba borse on 28-3-2022 -->
                              <li>
                                <?php if($declarationphoto != "") { ?>
                                  <a href="<?php echo base_url().$declarationphoto; ?>" target="_blank">
                                    <img src="<?php echo base_url().$declarationphoto; ?>">
                                  </a>
                                <?php } else { ?> <a class="missing_img_outer"> Image Missing </a><?php } ?>
                                <p>Declaration</p>
                              </li>
