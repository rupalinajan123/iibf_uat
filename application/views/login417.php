         ...
         <tr>
           <td>
             <table border="0" cellpadding="0" cellspacing="0" width="80%" align="center">
               <tr>
                 <td style="text-align:center; padding:60px 0 25px; font-size:22px; font-family:Tahoma, Geneva, sans-serif; font-weight:bold; line-height:32px;">Results for Diploma / Certificate Examinations - January 2018</td>
               </tr>
               <tr>
                <td bgcolor="#6699CC">
                      ...
                      <td class="content" width="55%" bgcolor="#d8e4f1">
                        <select name="exam" id="exam" class="text1" style="min-width:218px;">
                          <option value="">Select Exam</option>
                            <option value="8_417"> DIPLOMA IN BANKING TECHNOLOGY </option>
                            <option value="11_417"> DIPLOMA IN INTERNATIONAL BANKING AND FINANCE </option>
                            <option value="18_417"> CERTIFIED BANK TRAINER </option>
                            <option value="19_417"> CERTIFIED BANKING COMPLIANCE PROFESSIONAL </option>
                            <option value="24_417"> CERTIFICATION IN CARD OPERATIONS </option>
                            <option value="25_417"> CERTIFICATION IN FUNCTIONS OF BANKS </option>
                            <option value="26_417"> CERTIFICATION IN BASICS OF BANKING </option>
                            <option value="32_417"> ADVANCED WEALTH MANAGEMENT COURSE </option>
                            <option value="33_417"> DIPLOMA IN TREASURY INVESTMENT AND RISK MANAGEMENT</option>
                            <option value="34_417"> ANTI-MONEY LAUNDERING AND KNOW YOUR CUSTOMER</option>
                            <option value="47_417"> DIPLOMA IN HOME LOAN ADVISING</option>
                            <!--<option value="51_417"> DIPLOMA IN COMMODITY DERIVATIVES FOR BANKERS</option>-->
                            <option value="52_417"> ADVANCED DIPLOMA IN URBAN CO OP BANKING</option>
                            <option value="59_417"> CERTIFIED TREASURY PROFESSIONALS</option>
                            <option value="74_417"> CERTIFICATE COURSE IN FOREIGN EXCHANGE </option>
                            <option value="78_417"> FOREIGN EXCHANGE FACILITIES FOR INDIVIDUALS </option>
                            <option value="79_417"> CERTIFICATE EXAMINATION IN MICROFINANCE </option>
                            <option value="81_417"> CERTIFICATE IN RISK IN FINANCIAL SERVICES</option>
                            <option value="135_417"> CERTIFIED INFORMATION SYSTEM BANKER </option>
                            <option value="148_417"> CERTIFICATE COURSE IN DIGITAL BANKING </option>
                            <option value="149_417"> CERTIFICATE EXAMINATION IN INTRODUCTION TO BANKING </option>
                            <option value="151_417"> DIPLOMA IN TREASURY INVESTMENT AND RISK MANAGEMENT(Revised Syllabus)</option>
                            <option value="153_417"> ADVANCED WEALTH MANAGEMENT(Revised Syllabus)</option>
                            <option value="156_417"> DIPLOMA IN URBAN CO-OP BANKING</option>
                            <option value="158_417"> DIPLOMA IN RETAIL BANKING </option>
                            <option value="161_417"> CERTIFICATE IN INTERNATIONAL TRADE FINANCE </option>
                            <option value="162_417"> CERTIFICATE EXAMINATION IN RURAL BANKING OPERATION </option>
                            <option value="177_417"> PREVENTION OF CYBER CRIMES AND FRAUD MANAGEMENT </option>
                        </select>
                      </td>
                    </tr>
                    <tr>
