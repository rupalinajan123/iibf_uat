                    ...
                    <tr>
                      ...
                      <td class="content" width="55%" bgcolor="#d8e4f1">
                        <select name="exam" id="exam" class="text1" style="min-width:218px;">
                          ...
                          <option value="34_708">Anti-Money Laundering And Know Your Customer</option>
                          <option value="58_708">CUSTOMER SERVICE & BANKING CODES AND STANDARDS</option>
                          <option value="160_708">MSME Finance for Bankers</option>
                        </select>
                      </td>
                    </tr>
                    <tr>
