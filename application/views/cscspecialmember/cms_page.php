...
<style>
.parsley-required {float: left; width: 100%;margin-left: 1.3em;}
</style>
...
<div class="modal fade" id="confirmTwo"  role="dialog" >
  ...
  <div class="content-wrapper">
	...
	<form class="form-horizontal" name="agree_diagree_Form" id="agree_diagree_Form"  method="post"  enctype="multipart/form-data" action="<?php echo base_url();?>CSCSpecialMember/comApplication/"> 
             ...
             <div class="box-footer">
                  <div class="col-sm-4 col-xs-offset-3">
                    ...
                    <input type="submit" class="btn btn-info" name="btnSubmit" id="btnSubmit" value="I Agree" >
                     <a href="<?php echo base_url();?>CSCSpecialMember/dashboard/" class="btn btn-info">I Disagree</a>
                    </div>
              </div>
             </div>
        </div>
