...
?>
  ...
  <div class="content-wrapper">
	...
	<!-- <form class="form-horizontal" name="member_conApplication" id="member_conApplication"  method="post"  enctype="multipart/form-data" action="<?php echo base_url();?>NonMember/preview/"> -->
    	...
    	<form class="form-horizontal" name="member_conApplication" id="member_conApplication"  method="post"  enctype="multipart/form-data" action="<?php echo base_url();?>CSCSpecialMember/csccomApplication/">
          ...
          <div class="box box-info">
            ...
            <?php //echo validation_errors(); ?>
             ...
             <div class="form-group">
                     ...
                     <input type="hidden" name="reg_no" id="reg_no" value="<?php echo $user_info[0]['regnumber'];?>">
                      ...
                      <input type="hidden" id="exname" name="exname"  value=" <?php echo $examinfo[0]['description'];?>">
                       <input type="hidden" id="excd" name="excd"  value="<?php echo base64_encode($this->session->userdata('examcode'));?>">
                         ...
                         <input id="eprid" name="eprid" type="hidden" value="<?php echo $csc_exam_period;?>">
              ...
              ?>
                ...
                <div class="form-group">
                <label for="roleid" class="col-sm-3 control-label">Email <?php //echo $this->session->userdata['enduserinfo']['verified_email_val']; ?> <span style="color:#F00">*</span></label>
                  <div class="col-sm-5">
              ...
              <!-- END: FOR IMAGE EDITOR --> 
                  ...
                  <div id="scannedphoto_preview" class="upload_img_preview">
                    ...
                    if(is_file("uploads/iibfbcbf/photo/".$user_info[0]['candidate_photo'])){
                      $preview_scannedphoto = base_url()."./uploads/iibfbcbf/photo/".$user_info[0]['candidate_photo'];
                      $csc_scannedphoto = "uploads/iibfbcbf/photo/".$user_info[0]['candidate_photo'];
                    }
            ...
            <div class="box-body">
                ...
                <label for="roleid" class="col-sm-3 control-label">Exam Name</label>
                	<div class="col-sm-5 ">
                        <?php echo $examinfo['0']['description']." (".$csc_exam_code." - ".($csc_exam_code == "1039" ? "Advanced":"Basic").")"; ?>
                ...
                <label for="roleid" class="col-sm-3 control-label">Centre Name <span style="color:#F00">*</span></label>
                    ...
                    <?php if(count($center) > 0)
					{
						...
						{?>
								<option value="<?php echo $crow['centre_code']?>" class=<?php echo $crow['exammode'];?>><?php echo $crow['centre_name']?></option>
						<?php }
					}?>
                    </select>
                    </div>
             ...
             <div class="box-footer">
                  <div class="col-sm-4 col-xs-offset-3">
                   ...
                   <a href="<?php echo base_url();?>CSCSpecialMember/csccomApplication/" class="btn btn-info" id="Reset">Reset</a>
