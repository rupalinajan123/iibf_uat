...
<div style="font-size:18px;text-align:center;color:#F00;font-weight:bold;margin:0 6px 0 6px;">
JAIIB online examination for the subject "Principles and Practices for Banking" was conducted on 28, Jan 2017 at BAGALKOT centre.However, due to technical Issue, examination in centre BAGALKOT for the above mentioned subject was cancelled.Institute has decided to re-conduct the examination at BAGALKOT centre for the subject "Principles and Practices for Banking" on 25th February, 2017 (4th Saturday).Institute has already emailed the Admit letters for all the eligible candidates and also sent the SMS for information.
</div>
<div style="font-size:30px;text-align:center;color:#7FD1EA;font-weight:bold;">
Admit letter
</div>
  <!-- /.login-logo -->
