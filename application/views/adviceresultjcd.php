        ...
        <tr>
          <td style="border:3px solid #619fda;"><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
                ...
                <td style="border-bottom:3px solid #619fda; padding:5px 10px; font-family: Tahoma, Geneva, sans-serif; font-size:14px;"><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
                    <tr>
                      <td>
                        ...
                        <?php  echo preg_replace("/\([^)]+\)/","",$exam_name);?> 
                        <?php echo $exam_conduct?>
              ...
              <?php if($exam_code == $this->config->item('examCodeCaiib')){ ?>
                ...
                <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">You have passed CAIIB and eligible to appear for any one of the remaining Elective subjects of CAIIB as a separate Certificate Examination at the Dec 2016 examination. Application can be submitted only through Online Mode, for details visit our website <a href="www.iibf.org.in">www.iibf.org.in</a>. Last date for applying ONLINE is 27th September, 2016</td>
                <?php }else{ ?>
                
              	<?php if($user_info->no_of_attempt == 1 || $user_info->no_of_attempt == 3){?>
                <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">You will receive the Admit Letter only through Email for Dec, 2016 examination 10 days before its scheduled date. In case of non receipt of the same you may download from our website <a href="www.iibf.org.in">www.iibf.org.in</a>. Please note that you need not apply for the next examination again as you have already paid the exam fees for 2 attempts</td>
                <?php }?>
                <?php if($user_info->no_of_attempt == 2){?>
                <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">You have completed the 1st Block of 2 attempts,  you are required to submit the application form for the 2nd Block of 2 attempts for appearing at the Dec, 2016 examination. Application can be submitted only through Online Mode, for details visit our website <a href="www.iibf.org.in">www.iibf.org.in</a>. Last date for applying ONLINE is is 27th September, 2016 for CAIIB</td>
                <?php }?>
                 <?php if($user_info->no_of_attempt == 4){?>
                <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">You have completed the 2nd Block of 2 attempts. You are required to submit the examination application form afresh for appearing at the Dec, 2016 examination. You will not be eligible for credit of subjects passed, if any, earlier. Application can be submitted only through Online Mode for details visit our website www.iibf.org.in. Last date for applying ONLINE is 27th September, 2016 for CAIIB..</td>
                <?php }?>
              ...
              <?php if($exam_code == $this->config->item('examCodeJaiib')){?>
                ...
                <?php if($scnt == count($record)) {?>
                <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">You have passed JAIIB and eligible to appear for CAIIB at the Dec 2016 examination. Application can be submitted only through Online Mode, for details visit our website www.iibf.org.in. Last date for applying ONLINE is 27th September, 2016 for CAIIB</td>
                <?php }else{?>
                
              	<?php if($user_info->no_of_attempt == 1 || $user_info->no_of_attempt == 3){?>
                <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">You will receive the Admit Letter only through Email for Nov 2016 examination one week before its scheduled date (Available on our website). In case of non receipt of the same you may download from our website <a href="http://www.iibf.org.in">www.iibf.org.in</a>. Please note that you need not apply for the same again as you have already paid the exam fees for 2 attempts.</td>
                <?php }?>
                <?php if($user_info->no_of_attempt == 2){?>
                <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">You have completed the 1st Block of 2 attempts,  you are required to submit the application form for the 2nd Block of 2 attempts for appearing at the Nov 2016 examination. Application can be submitted only through Online Mode, for details visit our website <a href="http://www.iibf.org.in">www.iibf.org.in</a>. Last date for applying ONLINE is 06th September, 2016 for JAIIB.</td>
                <?php }?>
                 <?php if($user_info->no_of_attempt == 4){?>
                <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">You have completed the 2nd Block of 2 attempts. You are required to submit the examination application form afresh for appearing at the Nov 2016 examination. You will not be eligible for credit of subjects passed, if any, earlier. Application can be submitted only through Online Mode for details visit our website <a href="http://www.iibf.org.in">www.iibf.org.in</a>. Last date for applying ONLINE is 06th September, 2016 for JAIIB.</td>
                <?php }?>
              ...
              <?php if($exam_code == $this->config->item('examCodeDBF')){?>
              
              <?php if($scnt == count($record)){?>
              <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">You have passed the DB & F Examination. </td>
              <?php }?>
              
              <?php }?>
              
              <?php if($exam_code != $this->config->item('examCodeJaiib') && $exam_code != $this->config->item('examCodeCaiib') && $exam_code != $this->config->item('examCodeDBF')){?>
                
              	<?php if($scnt == 1){ ?>
                <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">You have passed the above Certificate Examination. Eligible to appear for any one of the remaining Electives of CAIIB at the Dec, 2016 examination. Application can be submitted only through Online Mode, for details visit our website <a href="www.iibf.org.in">www.iibf.org.in</a>. Last date for applying ONLINE is 27th September, 2016.</td>
                <?php }else{ ?>
                <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">You are eligible to re-appear for the above certificate examination at the Dec, 2016 examination.  Application can be submitted only through Online Mode, for details visit our website <a href="www.iibf.org.in">www.iibf.org.in</a>. Last date for applying ONLINE is   27th September, 2016.</td>
                <?php }?>
              <?php }?>
              ...
              <tr>
                ...
                <?php if(in_array($exam_code,array($this->config->item('examCodeJaiib'),$this->config->item('examCodeDBF'),$this->config->item('examCodeCaiib')))){?>
                <p style="font-family:'Times New Roman', Times, serif; font-weight:bold;  font-size:16px;">MINIMUM MARKS FOR PASS IN ANY SUBJECT - 50</p>
                <p style="font-family:'Times New Roman', Times, serif; font-size:16px;">
                CANDIDATES SECURING AT LEAST 45 MARKS IN EACH SUBJECT WITH AN AGGREGATE OF 50% MARKS IN ALL THE SUBJECTS OF THE EXAMINATION IN A SINGLE ATTEMPT WOULD BE DECLARED AS HAVING COMPLETED THE EXAMINATION
                </p>
                <?php }?>
                ...
                <td style="padding:20px 0;"><table style="border-collapse:collapse;" width="90%" align="center">
                  ...
                  <table width="10%" align="center" border="0" cellpadding="0" cellspacing="0" style="padding:30px 0 0;">
                    <tr>
                      ...
                      <td><a href="<?php echo base_url()?>examresult/jaiib" style="background-color:#ddd; color:#000; text-align:center; padding:10px 15px; text-decoration:none;">Back</a></td>
                    </tr>
                  </table></td>
              </tr>
              <tr>
