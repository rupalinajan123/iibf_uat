...
<div class="login-box">
  <div class="login-logo">
    ...
    <div><a>INDIAN INSTITUTE OF BANKING &amp; FINANCE<br>
      ...
      <!--<div style="font-size:16px;text-align:center;margin:0 6px 0 6px;color:#F00;font-weight:bold;">
BC/BF online examination was conducted on 27th, May 2017 at Chennai centre.
However, due to technical Issue, examination in centre Chennai for the above mentioned exam was cancelled and somecandidates was not able to complete the examination.
Institute has therefore, decided to re-schedule the examination at Chennai centre on 11th June, 2017 (2nd Sunday) for those candidates who could not give/complete the examination
Institute has already emailed the Admit letters to all the eligible candidates and also sent the SMS to them for information.</div>-->
  </div>
    ...
    <form action="" method="post" name="loginFrm" id="loginFrm">
      ...
      <div class="row"> 
        ...
        <div class="col-xs-4"> 
          ...
          <a href="<?php echo base_url();?>" class="btn btn-info btn-block btn-flat">Back</a> </div>
        <div class="col-xs-12"> <a href="<?php echo base_url();?>login/forgotpassword/" class="forget">Forgot Password/Get password Click Here</a> </div>
        <?php 
$obj = new OS_BR();
if($obj->showInfo('browser')=='Internet Explorer')
{?>
        <br>
        <div class="col-xs-12 message" style="color:#F00"> Portal best viewed in recommended browsers (Mozilla Firefox or Google chrome latest versions) for error free performance. It is suggested Internet explorer not to be used to avoid issues.</div>
        <?php }?>
...
<div style="font-size:15px;float:left">List of Centres merged for the examination </div><a href="<?php echo base_url()?>uploads/admitcardinfo/PENDING_STATUS_21st_JAN_WEB.pdf" target="_blank" ><strong>(Click here)</strong></a>
    ...
    <!--<div style="font-weight:bold;color:#F00;">
      ...
      <a href="<?php echo base_url()?>uploads/admitcardinfo/STATUS_27th May_WEB.pdf" target="_blank" ><strong>(Click here)</strong></a> </div>-->
  </div>
