...
<div style="font-weight:bold;color:#F00;">    
<div style="font-size:15px;float:left">List of Centres merged for the examination </div><a href="<?php echo base_url()?>uploads/admitcardinfo/STATUS_12th May_2018_WEB.pdf" target="_blank" ><strong>(Click here)</strong></a>
</div>
      </div>
      </div>
