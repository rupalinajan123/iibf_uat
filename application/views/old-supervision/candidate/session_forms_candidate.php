      ...
      <?php $this->load->view('supervision/candidate/inc_sidebar_candidate'); ?>
        ...
        <?php $this->load->view('supervision/candidate/inc_topbar_candidate'); ?>
              ...
              <li class="breadcrumb-item">Masters</li>
							<li class="breadcrumb-item active"> <strong>Supervision Report</strong></li>
						</ol>
					</div>
				</div>
				...
				<div class="wrapper wrapper-content animated fadeInRight">
							...
							<div class="ibox">
								<div class="ibox-title">
									<div class="ibox-tools">
										<a href="<?php echo site_url('supervision/candidate/dashboard_candidate/save_session_form'); ?>" class="btn btn-primary custom_right_add_new_btn">Add Supervision Report</a>              
									</div>
								</div>
                  ...
                  <div class="table-responsive">
                          ...
                          <th class="no-sort text-center" style="width:40px;">Sr No.</th>
													...
													<th class="text-center nowrap">Submission Date</th> 
    ...
    <script language="javascript">
      ...
      $(document).ready(function()
          ...
          searching: true,
					...
					"ajax": 
          {
						"url": '<?php echo site_url("supervision/candidate/dashboard_candidate/get_session_form_data_ajax"); ?>',
						"type": "POST",	
            "data": function ( d ) 
						{
