                  ...
                  <form method="post" style="display: inline-block;	vertical-align: top; margin: -5px 0 0 10px; width:99%;">  
                        ...
                        <tr>
                          ...
                          <?php foreach($exams as $exam) {
                            ?>
                              <option <?php if($form_data[0]['exam_code'] == $exam['exam_code']) echo'selected' ?> value="<?php echo $exam['exam_code'] ?>-<?php echo $exam['exam_period'] ?>"><?php echo $exam['exam_name'] ?> - <?php echo $exam['exam_month'] ?></option>
                            <?php
                          } ?>
                          </select>
                          </td>
                          ...
                          <?php foreach($center_master_data as $center) {
                            ?>
                              <option style="display:none;" exam_period="<?php echo $center['exam_period'] ?>"  exam_code="<?php echo $center['exam_name'] ?>" <?php if($form_data[0]['center_code'] == $center['center_code']) echo'selected' ?> value="<?php echo $center['center_code'] ?>"><?php echo $center['center_name'] ?></option>
                            <?php
                          } ?>
                          </select>
                        </td>
