...
<div class="sub_title">
             ...
             <label for="roleid" class="col-sm-3 control-label">Designation <span style="color:#F00">*</span></label>
              <div class="col-sm-5"  style="display:block" id="edu">
                ...
                <label for="roleid" class="col-sm-3 control-label">Mobile <span style="color:#F00">*</span></label>
                	<div class="col-sm-5">
                      <input type="text" class="form-control" id="mobile" name="mobile" placeholder="Mobile" data-parsley-type="number"  data-parsley-minlength="10" data-parsley-maxlength="10"  value="<?php echo $user_info[0]['mobile'];?>"  data-parsley-editmobilecheck data-parsley-trigger-after-failure="focusout" required>
      ...
      <label for="roleid" class="col-sm-3 text-center">
        ...
        <label for="roleid" class="col-sm-3 text-center">
           ...
           <label for="roleid" class="col-sm-12 text-center">Uploaded Declaration </label>
        </label>
      </div>
