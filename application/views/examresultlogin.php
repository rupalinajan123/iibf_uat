         ...
         <tr>
           <td>
             <table border="0" cellpadding="0" cellspacing="0" width="80%" align="center">
               <tr>
                 <td style="text-align:center; padding:60px 0 25px; font-size:22px; font-family:Tahoma, Geneva, sans-serif; font-weight:bold; line-height:32px;">CERTIFICATE EXAMINATION FOR BUSINESS CORRESPONDENTS / FACILITATORS</td>
               </tr>
               <tr>
                <td bgcolor="#6699CC">
                    ...
                    <tr>
                      ...
                      <td class="content" width="55%" bgcolor="#d8e4f1">
                        <select name="exam" id="exam" class="text1" style="min-width:218px;">
                          ...
                          <option value="<?php echo $exam->exam_code ?>"><?php echo $exam->description ?></option>
                          <?php }?>
                        </select>
                      </td>
                    </tr>
              ...
              <tr>
                ...
                <tr>
                  <td>
                    <ol>
                    <li>Printed Result <span class="red"><strong>Advice will NOT be SENT to the candidates.</strong></span> Candidates can <span class="red"><strong>take a print out of the advice</strong></span> available in the website using the print tab. The printed result will contain signature of Dy.CEO of the Institute, however the signature will not be visible when viewed on screen.</li>
