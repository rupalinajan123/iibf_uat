...
?>
<form class="form-horizontal" name="JBIMSForm" id="ampForm"  method="post"  enctype="multipart/form-data" data-parsley-validate="parsley">
  <div class="container">
    <section class="content-header">
      <h1 class="register">Advanced Program on Strategic Leadership for Senior Executives of Banks/FIs - JBIMS (February 2022)<br>
                              Self -Sponsored candidates</h1><br/>
    </section>
    <span class="error right" >* Mandatory Field</span>
    <span class="error">
      <?php
    //   if(validation_errors() != ''){
    //       echo "Please check validation errors on form.To check errors please scroll down.";
    //   }
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              <div class="form-group">
                <label class="col-sm-4 control-label">Name Of Department Email <span style="color:#F00">*</span></label>
                <div class="col-sm-3">
                  <input type="hidden" class="form-control" id="sponsor_email" name="sponsor_email" value="<?php echo set_value('sponsor_email');?>" data-parsley-type="email" data-parsley-maxlength="50" maxlength="50" required >
                ...
                <div class="col-sm-2">
                  <select name="sponsordomainname" id="sponsordomainname" onchange="sponsor_change_email()" required >
                    ...
                    <option value="gmail.com" <?php if(isset($_POST['sponsordomainname']) && $_POST['sponsordomainname']=='gmail.com'){ echo 'selected'; } ?> >@Gamil.com</option>
                    <option value="hotmail.com" <?php if(isset($_POST['sponsordomainname']) && $_POST['sponsordomainname']=='hotmail.com'){ echo 'selected'; } ?> >@Hotmail.com</option>
                    <option value="yahoo.co.in" <?php if(isset($_POST['sponsordomainname']) && $_POST['sponsordomainname']=='yahoo.co.in'){ echo 'selected'; } ?> >@Yahoo.co.in</option>
                    <option value="yahoo.com" <?php if(isset($_POST['sponsordomainname']) && $_POST['sponsordomainname']=='yahoo.com'){ echo 'selected'; } ?> >@Yahoo.com</option>
                  </select>
                </div>(Max 50 Characters) 
              </div>
              <script>
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="sponsor_contact_std" name="sponsor_contact_std" value="<?php echo set_value('sponsor_contact_std');?>" data-parsley-type="number" data-parsley-maxlength="5" maxlength="5" >
                </div>(Max 5 Characters) 
              </div>
            </div>
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="sponsor_contact_mobile" name="sponsor_contact_mobile" value="<?php echo set_value('sponsor_contact_mobile');?>" data-parsley-type="number" data-parsley-maxlength="10" data-parsley-minlength="10" maxlength="10" required >
                </div>(10 digits)
              </div>
            </div>
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <input type="hidden" class="form-control" id="sponsor_contact_email" name="sponsor_contact_email" value="<?php echo set_value('sponsor_contact_email');?>" data-parsley-type="email" data-parsley-maxlength="50" maxlength="50" required >
                ...
                <div class="col-sm-2">
                  <select name="sponsorcontactdomainname" id="sponsorcontactdomainname" onchange="sponsor_contact_change_email()" required >
                    <option value="" >Domain</option>
                    <option value="gmail.com" <?php if(isset($_POST['sponsorcontactdomainname']) && $_POST['sponsorcontactdomainname']=='gmail.com'){ echo 'selected'; } ?> >@Gamil.com</option>
                    <option value="hotmail.com" <?php if(isset($_POST['sponsorcontactdomainname']) && $_POST['sponsorcontactdomainname']=='hotmail.com'){ echo 'selected'; } ?> >@Hotmail.com</option>
                    <option value="yahoo.co.in" <?php if(isset($_POST['sponsorcontactdomainname']) && $_POST['sponsorcontactdomainname']=='yahoo.co.in'){ echo 'selected'; } ?> >@Yahoo.co.in</option>
                    <option value="yahoo.com" <?php if(isset($_POST['sponsorcontactdomainname']) && $_POST['sponsorcontactdomainname']=='yahoo.com'){ echo 'selected'; } ?> >@Yahoo.com</option>
                  </select>
                </div>(Max 50 Characters) 
              </div>
              <script>
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <input style="text-transform:uppercase" type="text" class="form-control" id="name" name="name" value="<?php echo set_value('name');?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" maxlength="30" required >
                </div>(Max 30 Characters) 
              </div>
            </div>
            <div class="box-body">
              <div class="form-group">
                ...
                <input type="radio" id="gender" name="gender" required value="Male" <?php if(isset($_POST['gender']) && $_POST['gender'] == 'Male'){ echo 'checked'; } ?> >Male
                <input type="radio" id="gender" name="gender" required value="Female" <?php if(isset($_POST['gender']) && $_POST['gender'] == 'Female'){ echo 'checked'; } ?> >Female
                
                
                </div><div class="col-sm-3"></div><div class="col-sm-12" style="text-align:center;"><span class="error"><?php echo form_error('gender')?></span></div>
              </div>
            </div>
           ...
           <div class="box-body">
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input style="text-transform:uppercase" type="text" class="form-control" id="address1" name="address1" value="<?php echo set_value('address1'); ?>" required >
                </div>
              </div>
            </div>
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input style="text-transform:uppercase" type="text" class="form-control" id="address2" name="address2" value="<?php echo set_value('address2');?>" >
                </div>
              </div>
            </div>
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input style="text-transform:uppercase" type="text" class="form-control" id="address3" name="address3" value="<?php echo set_value('address3');?>" >
                </div>
              </div>
            </div>
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input style="text-transform:uppercase" type="text" class="form-control" id="address4" name="address4" value="<?php echo set_value('address4');?>" >
                </div>
              </div>
            </div>
            ...
            <div class="form-group">
              <label for="roleid" class="col-sm-4 control-label">City <span style="color:#F00">*</span></label>
                <div class="col-sm-6">
                  <input style="text-transform:uppercase" type="text" class="form-control" id="city" name="city" placeholder="City" required value="<?php echo set_value('city');?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" maxlength="30" >
            ...
            <div class="form-group">
                <label for="roleid" class="col-sm-4 control-label">State<span style="color:#F00">*</span></label>
                  ...
                  <input hidden="statepincode" id="statepincode" value="">
                   ...
                   <div class="col-sm-3">
                    <input type="text" class="form-control" id="pincode_address" name="pincode_address" placeholder="Pincode/Zipcode" required value="<?php echo set_value('pincode_address');?>"  data-parsley-maxlength="6" maxlength="6" size="6" data-parsley-checkpin data-parsley-type="number" data-parsley-trigger-after-failure="focusout"  > (Max 6 digits)
                     <span class="error"><?php echo form_error('pincode_address');?></span>
                  </div>
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <input type="text" class="form-control" id="std_code" name="std_code" value="<?php echo set_value('std_code');?>" data-parsley-maxlength="5" maxlength="5" data-parsley-type="number" >(Maximum 5 digits)
                </div>
                <label class="col-sm-2 control-label">Phone No. </label>
                <div class="col-sm-3">
                  <input type="text" class="form-control" id="phone_no" name="phone_no" value="<?php echo set_value('phone_no');?>"  data-parsley-maxlength="8" maxlength="8" data-parsley-type="number" >(Maximum 8 digits)
                </div>
              </div>
            </div>
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="mobile_no" name="mobile_no" value="<?php echo set_value('mobile_no');?>" data-parsley-maxlength="10" maxlength="10" data-parsley-type="number" data-parsley-minlength="10" data-parsley-check_mobile required >
                </div>(10 digits)
              </div>
            </div>
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="graduation" name="graduation" value="<?php echo set_value('graduation');?>" required >
                </div>
              </div>
            </div>
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="post_graduation" name="post_graduation" value="<?php echo set_value('post_graduation');?>">
                </div>
              </div>
            </div>
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="special_qualification" name="special_qualification" value="<?php echo set_value('special_qualification');?>" >
                </div>
              </div>
            </div>
          </div> 
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input style="text-transform:uppercase" type="text" required class="form-control" id="name_employer" name="name_employer" value="<?php echo set_value('name_employer');?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" maxlength="30" >
                </div>
              </div>
            </div>
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <!--<input type="text" required class="form-control" id="position" name="position" value="<?php echo set_value('position');?>"  data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" maxlength="30" >-->
                
                <!--<input type="radio" id="position" name="position" required value="Junior Management" <?php if(isset($_POST['position']) && $_POST['position'] == 'Junior Management'){ echo 'checked'; } ?> >Junior Management-->
                <!--<input type="radio" id="position" name="position" required value="Middle Management" <?php if(isset($_POST['position']) && $_POST['position'] == 'Middle Management'){ echo 'checked'; } ?> >Middle Management-->
                
                <select name="position"  id="position" class="form-control" required>
                                    <option value="" <?php echo  set_select('position', '', ($examRes["position"] == '') ); ?>>Select</option>
                                    <option value="Assistant General Manager" <?php echo  set_select('position', 'Assistant General Manager', ($examRes["position"] == 'Assistant General Manager') ); ?>>Assistant General Manager</option>
                                    <option value="Deputy General Manager" <?php echo  set_select('position', 'Deputy General Manager', ($examRes["position"] == 'Deputy General Manager' ) ); ?>>Deputy General Manager</option>
                                    <option value="General Manager" <?php echo  set_select('position', 'General Manager', ($examRes["position"]) == 'General Manager' ); ?>>General Manager</option>
                                    <option value="Deputy Vice President" <?php echo  set_select('sel_namesub', 'Deputy Vice President', ($examRes["position"]) == 'Deputy Vice President' ); ?>>Deputy Vice President</option>
                                    <option value="Vice President" <?php echo  set_select('position', 'Vice President', ($examRes["position"]) == 'Vice President' ); ?>>Vice President</option>
                                    <option value="Other Senior Management Position" <?php echo  set_select('position', 'Other Senior Management Position', ($examRes["position"]) == 'Other Senior Management Position' ); ?>>Other Senior Management Position</option>
                                    
                                   </select>
                </div><div class="col-sm-3"></div><div class="col-sm-12" style="text-align:center;"><span class="error"><?php echo form_error('position')?></span></div>
              </div>
            </div>
            <div class="box-body">
              <div class="form-group">
                <label class="col-sm-4 control-label">Current Role/Assignment <span style="color:#F00">*</span></label>
                <div class="col-sm-5">
                  <input style="text-transform:uppercase" type="text" required class="form-control" id="current_role" name="current_role" value="<?php echo set_value('current_role');?>"  data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" maxlength="30" >
               
                </div><div class="col-sm-3"></div><div class="col-sm-12" style="text-align:center;"><span class="error"><?php echo form_error('current_role')?></span></div>
              </div>
            </div>
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="work_experiance" name="work_experiance" value="<?php echo set_value('work_experiance');?>" data-parsley-type="number" data-parsley-maxlength="3"  maxlength="3" data-parsley-minlength="2"  minlength="2" required>
                </div>(More than 15 years experience required)
              </div>
            </div>
          ...
          <div class="box box-info">
            ...
            <span class="error">If the Photo /ID Proof/ Signature is not loaded in appropriate place, your application is liable to get rejected
            <br>Allowed Photo and ID Proof Size - 20KB to 50 KB (Only JPG or jpeg files)
            <br>Allowed Signature Size - 10KB to 20KB (Only JPG or jpeg files)</span>
            <div class="box-body">
              <div class="form-group">
                <label class="col-sm-4 control-label">Photograph of the Candidate <span style="color:#F00">*</span></label>
                <div class="col-sm-5">
                  <input type="file" class="form-control" id="photograph" name="photograph" required value="<?php echo set_value('hiddenphoto');?>">
        ...
        ?>
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="file" class="form-control" id="signature" name="signature" required value="<?php echo set_value('hiddenscansignature');?>">
          ...
          echo '<br/>'.$sign_error;?>
             ...
             <div class="box-body">
              <div class="form-group">
                <label class="col-sm-4 control-label">ID Proof of the Candidate <span style="color:#F00">*</span><br>VoterID/Adharcard</label>
                <div class="col-sm-5">
                  <input type="file" class="form-control" id="idproof" name="idproof" required value="<?php echo set_value('hiddenscanidproof');?>">
                  
                  <input type="hidden" id="hiddenscanidproof" name="hiddenscanidproof">
                  <div id="error_idproof"></div>
                  <div id="error_idproof_size"></div>
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="radio" id="payment" name="payment" required value="full" <?php if(isset($_POST['payment']) && $_POST['payment'] == 'full'){ echo 'checked'; } ?> >Full payment <?php echo $this->config->item('JBIMS_full_cs_total'); ?>/- (Including GST)
              ...
              <!--    <div class="col-sm-6">-->
              <!--       <input type="text" class="form-control" id="gstin_no" name="gstin_no" placeholder="Enter GSTN No"  value=""  data-parsley-maxlength="15" maxlength="15" data-parsley-pattern="\d{2}[A-Z]{5}\d{4}[A-Z]{1}\d[Z]{1}[A-Z\d]{1}">-->
          ...
          <!-- Payment Details box close -->
          	<div class="box box-info">
						<div class="box-header with-border">
							 <input type="checkbox" class="" id="gst_required" name="gst_required" value="" >Optional GST-IN
						</div>
					</div>
					
					<!-- gst  box open -->
					<div class="box box-info" id='gst_div'  <?php if(set_value('gst_bank_name') != ''){ ?> style='display:block' <?php } ?> style='display:none'>
					
						<div class="box-body">
							<div class="form-group">
								<label class="col-sm-4 control-label">Name of Bank</label>
								<div class="col-sm-5">
									<input type="text" class="form-control" id="gst_bank_name" name="gst_bank_name" value="<?php echo set_value('gst_bank_name');?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" maxlength="30" >
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="gst_no" name="gst_no" value="<?php echo set_value('gst_no');?>"  data-parsley-maxlength="30" maxlength="30" >
								</div>
							</div>
						</div>
					</div>
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              <div class="form-group">                
                <div class="col-sm-12">
                  1. I hereby declare that all the information given in this application is true, complete and correct. I understand that in the event of any information being found false or incorrect, my enrollment in the program is liable to be cancelled/ terminated.
                </div>
                <div class="col-sm-12">
                ...
                <div class="col-sm-12">
                  3. If your application rejected by the Institute for enrolment in the program then fee will be refunded.
                </div>
                <div class="col-sm-12">
                  4. I understand that IIBF reserves the right to accept or reject my enrolment in the program without assigning any reason what so ever. 
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="box box-info">
            <div class="form-group">                
              ...
              <div class="col-sm-4">
                <input type="hidden" name="form_type" value="JBIMS_form" />
...
$(document).ready(function() {
  $('#new_captcha').click(function(event){
    ...
    $.ajax({
    type: 'POST',
    url: site_url+'JBIMS/generatecaptchaajax/',
  ...
  $("#gst_required").click(function() {
    if($(this).is(":checked")) {
        $("#gst_div").show();
       // $("#gst_bank_name").attr("required", "true");
       // $("#gst_no").attr("required", "true");
    } else {
        $("#gst_div").hide();
        // $("#gst_bank_name").attr("required", "false");
