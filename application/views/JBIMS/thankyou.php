		...
		<section class="content">
			<div class="row">
				<div class="col-md-12">
					...
					<div class="box box-info">
						<div class="box-header with-border" align="center">
							...
							<h3 class="box-title">Your Membership No is <?php echo $user_info_details[0]['regnumber'];?></h3><br>
							<h3 class="box-title">Please note down your Membership No for further reference.</h3><br>
                      ...
                      <div class="box-body">
                       	 <div class="">
                  	      <label for="roleid" class="col-sm-3 control-label">GSTIN Bank Name</label>
                    		    <div class="col-sm-9">
                    			    <?php echo $user_info_details[0]['gst_bank_name'];?>
                   			     </div>
          			      </div>
              		  </div>
              		  <div class="box-body">
                  	      ...
                  	      <label for="roleid" class="col-sm-3 control-label">GSTIN-NO</label>
                    		    <div class="col-sm-1">
                    			    <?php echo $user_info_details[0]['gst_no'];?>
                   			     </div>
          			      </div>
              		  </div>
                      <div class="box-body">
			   ...
			   {?> 
                        ...
                        <a href="<?php echo base_url()?>JBIMS/exampdf/<?php echo base64_encode($user_info_details[0]['receipt_no']); ?>">Save as pdf</a> &nbsp; &nbsp;
						<a href="http://iibf.org.in/" target="_blank" >Continue</a>
                        </div>
			<?php }?>			 
