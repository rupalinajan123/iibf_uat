...
<!-- data-parsley-validate="parsley"-->
	<div class="container">
		<section class="content-header">
			<h1 class="register">Advanced Program on Strategic Management in association with Jamnalal Bajaj Institute of Management Studies (JBIMS) -May 2022
		...
		<section class="content">
			<div class="row">                                                                           
					...
					<div class="box box-info">
						...
						<div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">State<span style="color:#F00">*</span></label>
									...
									<input hidden="statepincode" id="statepincode" value="">
									 ...
									 <div class="col-sm-3">
										<input type="text" class="form-control" id="bank_pincode" name="bank_pincode" placeholder="Pincode/Zipcode" required value="<?php echo set_value('bank_pincode');?>"  data-parsley-maxlength="6" maxlength="6" size="6" data-parsley-bank_checkpin data-parsley-type="number" data-parsley-trigger-after-failure="focusout"> (Max 6 digits)
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="sponsor_contact_mobile" name="sponsor_contact_mobile" value="<?php echo set_value('sponsor_contact_mobile');?>" data-parsley-type="number" data-parsley-maxlength="10" data-parsley-minlength="10" maxlength="10" >
								</div>(10 digits)
							</div>
						</div>
                ...
                <input type="radio" id="gender" name="gender" required value="Female" <?php if(isset($_POST['gender']) && $_POST['gender'] == 'Female'){ echo 'checked'; } ?> >Female
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-2">
									<input type="hidden" autocomplete="false" class="form-control" id="dob" name="dob" value="<?php echo set_value('dob');?>" required >
						...
						<div class="form-group">
							<label for="roleid" class="col-sm-4 control-label">City <span style="color:#F00">*</span></label>
								<div class="col-sm-6">
									<input style="text-transform:uppercase" type="text" class="form-control" id="city" name="city" placeholder="" required value="<?php echo set_value('city');?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" maxlength="30" >
								  <span class="error"><?php //echo form_error('city');?></span>
								</div>   
						</div>
						<div class="box-body">
					...
					<div class="box box-info">
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input style="text-transform:uppercase" type="text" class="form-control" id="name_employer" name="name_employer" value="<?php echo set_value('name_employer');?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" maxlength="30" required>
								</div>
							</div>
						</div>
                  ...
                  <input style="text-transform:uppercase" type="text" required class="form-control" id="current_role" name="current_role" value="<?php echo set_value('current_role');?>"  data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" maxlength="30" >
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input required type="text" class="form-control" id="work_experiance" name="work_experiance" value="<?php echo set_value('work_experiance');?>" data-parsley-type="number" data-parsley-maxlength="3"  maxlength="3" >
					...
					<div class="box box-info">
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="file" class="form-control" id="photograph" name="photograph" required value="<?php echo set_value('photograph');?>" >
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="file" class="form-control" id="signature" name="signature" required value="<?php echo set_value('signature');?>">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="file" class="form-control" id="idproof" name="idproof" required value="<?php echo set_value('idproof');?>">
                  
                  <input type="hidden" autocomplete="false" id="hiddenscanidproof" name="hiddenscanidproof">
                  ...
                  <img id="image_upload_idproof_preview" height="100" width="100"/>
					...
					<div class="box box-info">
						<div class="form-group">								
							...
							<div class="col-sm-4">
								<input type="hidden" autocomplete="false" name="form_type" value="JBIMS_form" />
								<input type="submit" name="submit" value="Preview" onclick="javascript:return checkform();" />
							</div>
						</div>
					</div>
