...
<?php $this->load->view('google_analytics_script_common'); ?>
    ...
    <title>Welcome to Indian Institute of Banking </title>
			...
			<div class="navbar-custom-menu">
                <ul class="nav navbar-nav navlogo">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="<?php echo  base_url()?>iibfdra/admin/login/Logout" class="dropdown-toggle" ><!--data-toggle="dropdown" added by Manoj-->                           
                            LOGOUT
                        </a>
                    </li>
                </ul>
