...
?>
<form class="form-horizontal" name="" autocomplete="off"  method="post"  enctype="multipart/form-data" action="<?php echo base_url();?>JBIMS/bank_addmember">

<!-- data-parsley-validate="parsley"-->
	<div class="container">
		<section class="content-header">
			<h1 class="register">LEADERSHIP DEVELOPMENT PROGRAMME FOR BANKS/FIs IIBF -JBIMS February 2022
			...
			<div class="row">                                                                           
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-5">
									...
									<img id="image_upload_photograph_preview" height="100" width="100" src='<?php echo base_url();?>/uploads/JBIMS/photograph/<?php echo $this->session->userdata['insertdata']['photograph'];?>' />
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-5">
									...
									<img id="image_upload_signature_preview" height="100" width="100" src='<?php echo base_url();?>/uploads/JBIMS/signature/<?php echo $this->session->userdata['insertdata']['signature'];?>'/>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  ...
                  <img id="image_upload_idproof_preview" height="100" width="100" src='<?php echo base_url();?>/uploads/JBIMS/idproof/<?php echo $this->session->userdata['insertdata']['idproof'];?>' />
					...
					<div class="box box-info">
						<div class="form-group">								
							...
							<div class="col-sm-4">
								...
								<a href='<?php echo base_url();?>JBIMS/bank' type="button" name="back" class="btn btn-info" value="Back" />Back</a>
							</div>
						</div>
					</div>
