              ...
              <table cellpadding="0" cellspacing="0" width="100%" border="0" align="center">
                ...
                <tr>
                  ...
                  <?php 
						...
						//print_r($exam_name);
				  		foreach($exam_name as $exam_name){
							...
							if($pdate >= $today || $numberDays <= 10){
								
							
					  		$isvalid=$this->master_model->checkadmitcarddate($exam_name->exm_cd);
							if($isvalid)
							{
								$dates=$this->master_model->getRecords('admitcard_jaiib_rescheduled',array('exm_cd'=>$exam_name->exm_cd,"mem_mem_no"=>$mid ),'date');
				  ...
				  ?>
                        ...
                        <a href="<?php echo base_url()?>admitcard/jrgetadmitcardsp/<?php echo base64_encode($exam_name->exm_cd)?>">
