    ...
    <td><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
        <tr>
          <td style="border:3px solid #619fda;"><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
                    	...
                    	<tr>
                            ...
                            <?php /*?><td>
                            	<table>
                                    ...
                                    <tr>
                                    	<td>
                                        	<img src="<?php echo base_url();?><?php echo get_img_name($this->session->userdata('result_mem_no'),'s');?><?php echo '?'.time(); ?>" style="max-width:40%" />
                                        </td>
                                    </tr>
                                </table>
                            </td><?php */?>
                    ...
                    <tr>
                      <td>
                        ...
                        <?php 
							...
							$ex_name =  str_replace($arr, '', $exam_name);
							echo preg_replace("/\([^)]+\)/","",$ex_name);
						
						// echo preg_replace("/\([^)]+\)/","",$exam_name);
						 
						?> 
                        <?php if($this->session->userdata('result_period') != 316){
						    echo $exam_conduct;
                         }elseif($this->session->userdata('result_period') == 316){
                        	echo "Oct-2016";
                         }?>
                        </strong>
                      </td>
              ...
              <?php
			  	//echo "###". $this->session->userdata('result_period');
              	if($this->session->userdata('result_period') == 216 || $this->session->userdata('result_period') == 416){ 
			  ?>
              
              <?php if(in_array($exam_code,array("11","32","33","47","51","52"))){?>
              ...
              <?php if(in_array($exam_code,array("31","34"))){?>
              
              <?php if($exam_code == 34 && $this->session->userdata('result_period') == 216){?>
              <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;font-weight:bold">
               <p style="font-family:'Times New Roman', Times, serif; font-weight:bold;  font-size:16px;">Passing marks - 60</p>
                </td>
               <?php }?> 
               <?php if($this->session->userdata('result_period') == 416){?>
               <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;font-weight:bold">
               <p>MINIMUM MARKS FOR PASS IN SUBJECT-60. </p> 
                </td>
               <?php }?>
              ...
              <?php if(in_array($exam_code,array("48","49","53","58","74","75","76","77","78","79","148","149"))){?>
              <?php if($exam_code == 58 && $this->session->userdata('result_period') == 216){?>
              <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;font-weight:bold">
...
Candidates who have completed Level-1 of the examination are required to enrol for Classroom Learning (Level-2). Please note that as per the time limit rule candidate need to complete the Classroom Learning within 15 months from the above result declaration date of Level-1 examination.
              ...
              <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;font-weight:bold">
               <p>MINIMUM MARKS FOR PASS IN SUBJECT-60.</p>
               <p>CANDIDATES SECURING ATLEAST 50 MARKS IN EACH SUBJECT WITH AN AGGREGATE OF 60% MARKS IN ALL THE SUBJECTS IN A SINGLE ATTEMPT WILL ALSO BE DECLARED AS HAVING COMPLETED.
Candidates who have completed Level-1 of the examination are required to enrol for Classroom Learning (Level-2). Please note that as per the time limit rule candidate need to complete the Classroom Learning within 15 months from the above result declaration date of Level-1 examination.
</p> 
                </td>
              <?php }?>
              
              <?php if(in_array($exam_code,array("20","59"))){?>
              <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;font-weight:bold">
               <p>MINIMUM MARKS FOR PASS IN SUBJECT-50.</p>
               <p>Candidates who have completed Level-1 of the examination are required to enrol for Classroom Learning (Level-2). Please note that as per the time limit rule candidate need to complete the Classroom Learning within 15 months from the above result declaration date of Level-1 examination.
</p> 
                </td>
              <?php }?>
              ...
              <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;font-weight:bold">
               <p>MINIMUM MARKS FOR PASS IN SUBJECT-50.</p>
               <p>Candidates who have completed Level-1 of the examination are required to contact CISI, London to enrol for paper 2 examination (Level-2). Please note that CISI will provide the rules & syllabus, courseware, venue and other details for the Level-2 examination.
</p> 
                </td>
              <?php }?>
...
Certificate for completion will be issued only after successfully completing the project work as per the rules of the examination.
              ...
              <?php
              	if($this->session->userdata('result_period') == 116 ){ 
			  ?>
              <td style="padding:10px; font-size:14px; border-bottom:3px solid #619fda; font-weight:bold;">
               <?php if($exam_code == 20){?>
                <p>MINIMUM MARKS FOR PASS IN SUBJECT-50.</p>
               <p>Candidates who have completed Level-1 of the examination are required to enrol for Classroom Learning (Level-2). Please note that as per the time limit rule candidate need to complete the Classroom Learning within 15 months from the above result declaration date of Level-1 examination.
</p> 
...
Candidates who have completed Level-1 of the examination are required to enrol for Classroom Learning (Level-2). Please note that as per the time limit rule candidate need to complete the Classroom Learning within 15 months from the above result declaration date of Level-1 examination.
               ...
               <?php if($exam_code == 81){?>
               <p>As regards paper 2 (Level II) Examination the rules and syllabus, courseware, venue and other detail will be provided directly by CISI, London to all the enrolled candidates for the paper II examination , after passing the level  as stipulated in rules and syllabus of the examination.</p>
                <p style="font-family:'Times New Roman', Times, serif; font-weight:bold;  font-size:16px;">Passing Criteria</p>
                <p>Level - 1 Examination</p>
                <p>Passing marks - 50</p>
               <?php }?>
...
Certificate for completion will be issued only after successfully completing the project work as per the rules of the examination.
               ...
               <p style="font-family:'Times New Roman', Times, serif; font-weight:bold;  font-size:16px;">Passing marks - 50</p>
                ...
                CANDIDATES SECURING AT LEAST 45 MARKS IN EACH SUBJECT WITH AN AGGREGATE OF 50% MARKS IN ALL THE SUBJECT IN A SINGLE ATTEMPT WILL ALSO BE DECLARED AS HAVING COMPLETED.
                </p>
               <?php }?>
               
               <?php if(in_array($exam_code,array("31","34","35"))){?>
               <p style="font-family:'Times New Roman', Times, serif; font-weight:bold;  font-size:16px;">Passing marks - 60</p>
               <?php }?>
                ...
                <td style="padding:20px 0;"><table style="border-collapse:collapse;" width="90%" align="center">
                  ...
                  <table width="10%" align="center" border="0" cellpadding="0" cellspacing="0" style="padding:30px 0 0;">
                    <tr>
                      ...
                      <?php if($exam_code != 101){?>
                      <td>
                      <?php if($this->session->userdata('result_period') == 116){?>
                        ...
                        <?php }elseif(in_array($exam_code,array('11','32','33','47','51','52','8','18','19','20','31','34','35','48','49','53','58','59','74','75','76','77','78','79','81'))){?>
                        ...
                        <?php if($this->session->userdata('result_period') == 216 || $this->session->userdata('result_period') == 416){?>
                        <?php if(in_array($exam_code,array('34','58')) && $this->session->userdata('result_period') == 216){?>
                        <a href="<?php echo base_url()?>examresult/diplomaresult" style="background-color:#ddd; color:#000; text-align:center; padding:10px 15px; text-decoration:none;">Back</a>
                        <?php }else{?>
                        <a href="<?php echo base_url()?>examresult" style="background-color:#ddd; color:#000; text-align:center; padding:10px 15px; text-decoration:none;">Back</a>
                        <?php }?>
                       ...
                       <?php if($this->session->userdata('result_period') == 316){?>
                       <a href="<?php echo base_url()?>result/amlkyc" style="background-color:#ddd; color:#000; text-align:center; padding:10px 15px; text-decoration:none;">Back</a>
                       <?php }?> 
                      </td>
                      <?php }?>
                      <?php if($exam_code == 101){?>
                      <td><a href="<?php echo base_url()?>examresult/bcbf" style="background-color:#ddd; color:#000; text-align:center; padding:10px 15px; text-decoration:none;">Back</a></td>
                      <?php }?>
