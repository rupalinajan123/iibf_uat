...
<form class="form-horizontal" name="usersAddForm" id="usersAddForm"  method="post"  enctype="multipart/form-data" action="<?php echo base_url()?>FinQuest" autocomplete="off">
  <div class="container">
   <section class="content-header box-header with-border" style="height:45px; background-color: #1287C0; ">
      <h1 class="register">Fin@Quest Subscription   </h1>
    </section>
        ...
        <div class="box box-info">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-4">
                <input type="text" class="form-control" id="fname" name="fname" placeholder=" First Name" required 
                        value="<?php echo set_value('name');?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" maxlength="30" >
                <span class="error">
                <?php //echo form_error('firstname');?>
                </span> </div> (Max 30 Characters)  
            </div>
             <div class="form-group">
                <label for="roleid" class="col-sm-4 control-label">Middle Name</label>
                <div class="col-sm-6">
                  <input type="text" class="form-control" id="mname" name="mname" placeholder="Middle Name"  value="<?php echo set_value('middlename');?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" maxlength="30">
                  <span class="error">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input type="text" class="form-control" id="lname" name="lname" placeholder="Last Name"  value="<?php echo set_value('lastname');?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" maxlength="30">
                  <span class="error">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="tel" class="form-control" id="mem_no" name="mem_no" placeholder="Membership Number"  value=""   >
                <span class="error">
                <?php //echo form_error('mobile');?>
                </span> </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                <select class="form-control" id="state" name="state" required  onchange="checksate(this.value);">
                  <option value="">Select</option>
            ...
            <div class="form-group">
              <label for="roleid" class="col-sm-4 control-label">Subscription Fees</label>
              <div class="col-sm-6">
                <input type="text" class="form-control" id="subscription_fees" name="subscription_fees"  value="" readonly="readonly"  required>
                <span class="error"> </span> </div>
            </div>
            <div class="form-group">
              <label for="roleid" class="col-sm-4 control-label">Validity period</label>
              <div class="col-sm-6">
                <input type="text" class="form-control" id="subscription_date" name="subscription_date"  value="<?php 
					$start_date = date('d-M-Y');
			$end_date = date('d-M-Y', strtotime('+1 years'));
			$subscription_range = $start_date." to ".$end_date;
			echo $subscription_range; ?>" readonly="readonly" required >
                <span class="error"> </span> </div>
               
            </div>
           <img src="<?php echo base_url()?>assets/images/bullet2.gif" style="color:#F00"> Your subscription is valid for 1 year from the date of registration.
          </div>
        </div>
...
$(function(){
    ...
    $.ajax({
 		type: 'POST',
 		url: site_url+'FinQuest/generatecaptchaajax/',
