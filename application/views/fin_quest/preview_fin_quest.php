...
<div class="container">
  ...
  <section class="content">
    ...
    <div class="box-body">
      ...
      <?php } 
			 ?>
      <form class="form-horizontal" name="bankquestForm" id="bankquestForm"  method="post"   action="<?php echo base_url()?>FinQuest/addrecord">
  
          <div class="form-group">
            <label for="roleid" class="col-sm-3 control-label">Membership No </label>
            <div class="col-sm-5"> <?php echo $this->session->userdata['enduserinfo']['mem_no']?> 
        ...
        <?php if(isset($this->session->userdata['enduserinfo']['fname']))
		  {
      ...
      <div class="form-group">
        ...
        <div class="form-group">
           <label for="roleid" class="col-sm-3 control-label">Gender *</label>
            ...
            <div class="col-sm-5"> <?php echo $this->session->userdata['enduserinfo']['gender']?> 
              <!--<input type="text" class="form-control" id="email" name="email" placeholder="Email"  data-parsley-type="email" value="<?php echo $this->session->userdata['enduserinfo']['email']?>"  data-parsley-maxlength="30" required>--> 
              <!--(Enter valid and correct email ID to receive communication)--> 
              <span class="error">
              <?php //echo form_error('email');?>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5"> <?php echo $this->session->userdata['enduserinfo']['addressline1'];?> 
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5"> <?php echo $this->session->userdata['enduserinfo']['addressline2'];?> 
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5"> <?php echo $this->session->userdata['enduserinfo']['addressline3'];?> 
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5"> <?php echo $this->session->userdata['enduserinfo']['addressline4'];?> 
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5"> <?php echo $this->session->userdata['enduserinfo']['district']?> 
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5"> <?php echo $this->session->userdata['enduserinfo']['city']?> 
          ...
          <div class="form-group">
            ...
            <div class="col-sm-2">
              <?php if($this->session->userdata['enduserinfo']['state']!='')
					  {
            ...
            <div class="col-sm-2"> <?php echo $this->session->userdata['enduserinfo']['pincode'];?> 
          ...
          <div class="form-group">
			...
			echo $this->session->userdata['enduserinfo']['subscription_fees'];?> 
              <!--<input type="tel" class="form-control" id="mobile" name="mobile" placeholder="Mobile" data-parsley-type="number"  data-parsley-minlength="10" data-parsley-maxlength="12"  value="<?php echo $this->session->userdata['enduserinfo']['mobile'];?>"  required>--> 
              <span class="error">
              <?php //echo form_error('mobile');?>
              </span> </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5"> <?php echo $this->session->userdata['enduserinfo']['subscription_date'];?> 
              <!--<input type="tel" class="form-control" id="mobile" name="mobile" placeholder="Mobile" data-parsley-type="number"  data-parsley-minlength="10" data-parsley-maxlength="12"  value="<?php echo $this->session->userdata['enduserinfo']['mobile'];?>"  required>--> 
