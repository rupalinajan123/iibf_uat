      ...
      <div class="col-md-12"> 
        ...
        <div class="box box-info">
          ...
          <div class="box-body">
            ...
            <div class="col-md-12"> 
           <br>
                    <center><div style="font-size:25px" >  You have successfully subscribed for IIBF Fin@Quest.  </div><br>  
<br>  </center>
              
                    <br><?php $start_date = date('d/m/Y');
$end_date = date('d/m/Y', strtotime('+1 years'));
$subscription_range = $start_date." to ".$end_date;?>
                   <center> <strong>Your subscription number is</strong> <?php echo $subscription_number;?> <strong><br /> Validity of your subscription is for 1 year i.e. from   </strong><?php echo $subscription_range  ?><br>
                    <br>
