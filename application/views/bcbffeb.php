...
<div style="font-weight:bold;color:#F00;">    
<div style="font-size:15px;float:left">List of Centres merged for the examination </div><a href="<?php echo base_url()?>uploads/admitcardinfo/STATUS_WEB_NOTICE_10TH MARCH 2018.pdf" target="_blank" ><strong>(Click here)</strong></a>
</div>
      </div>
      </div>
