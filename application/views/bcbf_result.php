          ...
          <td style="border:3px solid #619fda;"><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
              ...
              <tr>
                <td style="border-bottom:3px solid #619fda; padding:10px; font-family:'Times New Roman', Times, serif; font-size:15px;">
                	<table width="100%">
                    	<tr>
                        	<td width="75%" id="membership_no_outer">
                ...
                <td style="border-bottom:3px solid #619fda; padding:5px 10px; font-family: Tahoma, Geneva, sans-serif; font-size:14px;"><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
                    <tr>
                      <td><strong>Examination<br />
                        <?php  echo preg_replace("/\([^)]+\)/","",$exam_name);?> <?php if(!in_array($exam_code, array(1037,1038,1046,1047))) { echo $exam_conduct; } ?></strong></td>
              ...
              <tr>
                 ...
                 <?php if($exam_code == '1027' ||  $exam_code == '1030'|| $exam_code == '1033' ||  $exam_code == '1034'|| $exam_code == '1031'|| $exam_code == '1043'){?>
               ...
               <img src="<?php echo base_url();?>assets/images/iibf_officer_sign2.png" style="max-width:40%" />
                ...
                <td style="padding:20px 0;"><table style="border-collapse:collapse;" width="90%" align="center">
                  ...
                  <table width="10%" align="center" border="0" cellpadding="0" cellspacing="0" style="padding:30px 0 0;">
                    <tr>
                      ...
                      <td><a href="<?php echo base_url()?>marksheet/bcbf/<?php echo base64_encode($this->session->userdata('result_period'));?>" style="background-color:#ddd; color:#000; text-align:center; padding:10px 15px; text-decoration:none;">Back</a></td>
        ...
        <tr>
          <td style="border:3px solid #619fda;"><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
              ...
              <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">
                <?php if($exam_code == '1027' ||  $exam_code == '1030'|| $exam_code == '1031' || $exam_code == '1033' ||  $exam_code == '1034'|| $exam_code == '1043'){?>
                <p style="font-family:'Times New Roman', Times, serif; font-weight:bold;  font-size:16px;">MINIMUM MARKS FOR PASS IN SUBJECT - 50</p>
                <?php }?>
              ...
              <div style="float:right;margin-right:40px;text-align:center;margin-top:15px;">
               ...
               <img src="<?php echo base_url();?>assets/images/iibf_officer_sign2.png" style="max-width:70%" />
               <p>Joint Director<br />Examinations</p>
               </div>
              </td>
              </tr>
