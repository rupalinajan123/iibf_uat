...
<div class="content-wrapper"> 
  ...
  <?php 
		$function = "add_record";	
    ?>
  <form class="form-horizontal" name="member_exam_comApplication" id="member_exam_comApplication"  method="post"  enctype="multipart/form-data" action="<?php echo base_url();?>Applycaiib_zerofee/<?php echo $function;?>/">
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-2"> <?php echo  $this->session->userdata['examinfo']['selCenterName'];?> </div>
              </div>
