...
?>
<form class="form-horizontal" name=""  method="post"  enctype="multipart/form-data" action="<?php echo base_url();?>Amp/bank_addmember">
			...
			<div class="row">                                                                           
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-5">
									...
									<img id="image_upload_photograph_preview" height="100" width="100" src='<?php echo base_url();?>/uploads/amp/photograph/<?php echo $this->session->userdata['insertdata']['photograph'];?>' />
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-5">
									...
									<img id="image_upload_signature_preview" height="100" width="100" src='<?php echo base_url();?>/uploads/amp/signature/<?php echo $this->session->userdata['insertdata']['signature'];?>'/>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  ...
                  <img id="image_upload_idproof_preview" height="100" width="100" src='<?php echo base_url();?>/uploads/amp/idproof/<?php echo $this->session->userdata['insertdata']['idproof'];?>' />
					...
					<div class="box box-info">
						<div class="form-group">								
							...
							<div class="col-sm-4">
								...
								<a href='<?php echo base_url();?>Amp/bank' type="button" name="back" class="btn btn-info" value="Back" />Back</a>
							</div>
						</div>
					</div>
