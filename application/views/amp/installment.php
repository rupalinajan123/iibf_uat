...
<form class="form-horizontal" name="ampForm" id="ampForm"  method="post"  enctype="multipart/form-data">
	<div class="container">
		<section class="content-header">
			<h1 class="register">AMP <?php echo ucfirst($aCandidate[0]['sponsor']); ?> Sponsored Candidate Details</h1><br/>
		</section>
		<span class="error">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="box box-info">
						...
						<div class="box-body">
							<div class="form-group">
								<label class="col-sm-4 control-label">Registration / Enrolment No.</label>
								<div class="col-sm-5">
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-12">
									...
									<tr>
									<!--<td>course fee</td>-->
									<td>Fee - <?php echo $this->config->item('amp_second_course_fee'); ?>/-</td>
									<td>GST - <?php echo $this->config->item('amp_second_GST_amt'); ?>/-</td>
									<td>Total - <?php echo $this->config->item('amp_second_cs_total'); ?>/-</td>
									</tr>
									</table>
									...
									<tr>
									<!--<td>course fee</td>-->
									<td>Fee - <?php echo $this->config->item('amp_third_course_fee'); ?>/-</td>
									<td>GST - <?php echo $this->config->item('amp_third_GST_amt'); ?>/-</td>
									<td>Total - <?php echo $this->config->item('amp_third_cs_total'); ?>/-</td>
									</tr>
									</table>
									<?php }else{ ?>
									Full Paid
