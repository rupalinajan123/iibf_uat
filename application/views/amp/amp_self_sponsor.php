...
?>
<form class="form-horizontal" name="ampForm" id="ampForm"  method="post"  enctype="multipart/form-data" data-parsley-validate="parsley">
  <div class="container">
    <section class="content-header">
      <h1 class="register">AMP XIV (2025-26) - Registration Form  (For <?php echo $sponsor; ?> Sponsored Candidates)</h1><br/>
    </section>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="work_experiance" name="work_experiance" value="<?php echo set_value('work_experiance');?>" min="60" data-parsley-type="number" data-parsley-maxlength="3"  maxlength="3" data-parsley-minlength="2"  minlength="2" required >
          ...
          <div class="box box-info">
            ...
            <br>Allowed Photo Size - upto 50 KB (Only JPG or jpeg files)
            <br>Allowed Signature Size - upto 20KB (Only JPG or jpeg files)
            <br>Allowed ID Size - upto 300KB (Only JPG or jpeg or png files)</span>
            <div class="box-body">
              <div class="form-group">
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="file" class="form-control" id="signature" name="signature" onchange="validateFile(event, 'error_signature', 'image_upload_signature_preview', '50kb')" required >
                  <span class="note">Please Upload only .jpg, .jpeg, .png  Files upto 50KB</span></br>
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              <div class="form-group">                
                ...
                <div class="col-sm-3">
                  <input type="text" class="form-control" id="captcha" name="captcha" autocomplete="off" required  data-parsley-check_valid_captcha data-parsley-trigger=focusout data-parsley-check_valid_captcha-message="Please enter the correct code as shown in the image" data-parsley-errors-container="#captcha_error">
                  <span class="note-error" id="captcha_error"></span>
                </div>
                <div class="col-sm-3">
...
{
  $('#captcha').parsley();
  window.ParsleyValidator.addValidator('check_valid_captcha', 
  {
    validateString: function(value) 
    {
      return $.ajax({
        url: "<?php echo site_url('Amp/check_captcha_self'); ?>",
        method: "POST",
        async: false,
        data: { code: value },
        dataType: 'JSON',
