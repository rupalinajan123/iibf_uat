...
<!-- data-parsley-validate="parsley"-->
	<div class="container">
		<section class="content-header">
			<h1 class="register">AMP XIV (2025-26) - Registration Form (For Bank Sponsored/Nominated - Registration Only)</h1><br/>
		</section>
			...
			<div class="row">                                                                           
				<div class="col-md-12">
					...
					<div class="box box-info">
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-2">
									<input type="text" class="form-control" id="sponsor_contact_std" name="sponsor_contact_std" value="<?php echo set_value('sponsor_contact_std');?>" onkeypress="return isNumber(event)" data-parsley-type="number" data-parsley-maxlength="5" maxlength="5" >
									(Maximum 5 digits)
								</div>
								<label class="col-sm-3 control-label">Contact person Phone No. </label>
								<div class="col-sm-3">
									<input type="text" class="form-control" id="sponsor_contact_phone" name="sponsor_contact_phone" value="<?php echo set_value('sponsor_contact_phone');?>" onkeypress="return isNumber(event)" data-parsley-type="number" data-parsley-maxlength="8" maxlength="8" >
									(Maximum 8 digits) 
								</div>
							</div>
						</div>
						...
						<div class="box-body">
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" required class="form-control" id="sponsor_contact_mobile" onkeypress="return isNumber(event)" name="sponsor_contact_mobile" value="<?php echo set_value('sponsor_contact_mobile');?>" data-parsley-type="number" data-parsley-maxlength="10" data-parsley-minlength="10" maxlength="10" >
								</div>(10 digits)
							</div>
						</div>
					...
					<div class="box box-info">
						...
						<br>Allowed Photo Size - upto 50KB (Only JPG or jpeg or png files)
						<br>Allowed Signature Size - upto 50KB (Only JPG or jpeg or png files)
