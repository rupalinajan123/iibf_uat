            ...
            <?php } ?>
						...
						<div class="box-body">
							<div class="form-group">
								<label class="col-sm-5 control-label" style="line-height:18px;">Enter Name or Registration / Enrolment No.<span style="color:#F00">*</span></label>
								<div class="col-sm-5">
					...
					<div class="box box-info">
						...
						<table class="table table-bordered">
							<thead>
							<tr>
								<th>Registration / Enrolment No.</th>
								<th>Name</th>
								<th>Email Id</th>
								<th>Mobile No.</th>
								<th>&nbsp;</th>
							...
							<tr>
								...
								<td>
								<a href="<?php echo base_url().'amp/installment/'.$candidate['regnumber']; ?>">
									Payment
								</a>
								</td>
							</tr>
