				...
				<div class="col-md-12">
					...
					<div class="box box-info">
						<div class="box-header with-border" align="center">
							...
							<h3 class="box-title">Your Registration / Enrolment No. is <?php echo $user_info_details[0]['regnumber'];?></h3><br>
							<h3 class="box-title">Please note down your Registration / Enrolment No. for further reference.</h3><br>
							<h3 class="box-title">You can save the system generated application form as PDF for future reference</h3>
						</div>
                        
                        <div class="box-body">
                       	 <div class="">
                  	      <label for="roleid" class="col-sm-3 control-label">Registration / Enrolment No.</label>
                    		    <div class="col-sm-1">
					  ...
					  <div class="box-body">
                       	 <div class="">
                  	      <label for="roleid" class="col-sm-3 control-label">Payment</label>
                    		    <div class="col-sm-6">
                    			    <?php 
									if(strtolower($user_info_details[0]['payment'])=='full'){
										echo 'Full Paid';
									}else{
										echo ucfirst($user_info_details[0]['payment']).' Installment';
									}
									?> (<?php echo $user_info_details[0]['amount'];?>)
                   			     </div>
          			      </div>
              		  </div>
                      ...
                      <div class="box-body">
                  	      ...
                  	      <label for="roleid" class="col-sm-3 control-label">Transaction Number</label>
                    		    <div class="col-sm-1">
                    			    <?php echo $user_info_details[0]['transaction_no'];?>
                   			     </div>
          			      </div>
              		  </div>
                      ...
                      <div class="box-body">
                        ...
                        <div class="box-body">
                  	      ...
                  	      <label for="roleid" class="col-sm-3 control-label">Transaction Status</label>
                    		    <div class="col-sm-1">
                    			       <?php if($user_info_details[0]['status']=='1'){echo 'Success';}else{echo 'Unsuccess';}?>
                   			     </div>
          			      </div>
              		  </div>
                       ...
                       <div class="box-body">
                  	      ...
                  	      <label for="roleid" class="col-sm-3 control-label">Transaction Date</label>
                    		    <div class="col-sm-6">
                    			        <?php echo $user_info_details[0]['date'];?>
                   			     </div>
          			      </div>
              		  </div>
             	<?php if($user_info_details[0]['status']=='1')
			   		{?> 
              	  		<div style="text-align:left">
                        <a href="<?php echo base_url()?>Amp/exampdf/<?php echo base64_encode($user_info_details[0]['receipt_no']); ?>">Save as pdf</a> &nbsp; &nbsp;
                        <?php if($user_info_details[0]['sponsor'] == 'self'){ ?>
                        	<a href="<?php echo base_url('amp/self'); ?>" target="_blank" >Logout</a>
                        <?php } else {?>
							<a href="<?php echo base_url('amp/bank_full_payment'); ?>" target="_blank" >Logout</a>
						<?php }?>
                        </div>
					<?php }?>			 
