...
<div class="container">
  <div class="content-wrapper"> 
    ...
    <section class="content-header box-header with-border" style="background-color: #1287C0">
      <h1 class="register"> Chartered Banker Institute </h1>
    </section>
    ...
    <br />
    <form class="form-horizontal" name="blendedForm" id="blendedForm" method="post" enctype="multipart/form-data" action="<?php echo base_url()?>caiib_jaiib_reg/addmember/">
      <div class="content-wrapper">
...
<div class="form-group">
                  ...
                  <div class="col-sm-3">
                    <?php echo $this->session->userdata['enduserinfo']['staffnumber']; ?>
                     </div>
                </div>
                 <div class="form-group">
                  <label for="roleid" class="col-sm-4 control-label">Organisation Name&nbsp;<span style="color:#F00">*</span>&nbsp;:</label>
                  <div class="col-sm-3">
                    <?php echo $this->session->userdata['enduserinfo']['organisation']; ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                    <?php echo $this->session->userdata['enduserinfo']['department']; ?>
                                       </div>
