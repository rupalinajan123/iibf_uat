    ...
    <td><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
        <tr>
          <td style="border:3px solid #619fda;"><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
              ...
              <tr>
                <td style="border-bottom:3px solid #619fda; padding:5px 10px; font-family: Tahoma, Geneva, sans-serif; font-size:14px;"><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
                    <tr>
                      <td>
                      	<?php
                        	if($this->session->userdata('result_examcode') != 52 && $this->session->userdata('result_examcode') != 162){
						?>
                      	<strong>Examination<br />
                        <?php  echo preg_replace("/\([^)]+\)/","",$exam_name);?> 
                        <?php echo $exam_conduct;?>
                        </strong>
                        <?php }elseif($this->session->userdata('result_examcode') == 52){?>
                        	<strong>
                            <?php echo "Advanced Diploma in Urban Co-op Banking";?>
                            <?php echo $exam_conduct;?>
                            </strong>
                        <?php }elseif($this->session->userdata('result_examcode') == 162){?>
                        	<strong>
                            <?php echo "CERTIFICATE EXAMINATION IN RURAL BANKING OPERATION";?>
                            <?php echo $exam_conduct;?>
                            </strong>
                        <?php }?>
                      </td>
              ...
              <?php if(in_array($exam_code,array("11","32","47","51","52"))){?>
              ...
              <?php if(in_array($exam_code,array("34","161","135"))){?>
              <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;font-weight:bold">
               <p style="font-family:'Times New Roman', Times, serif; font-weight:bold;  font-size:16px;">Passing marks - 60</p>
                </td>
               <?php }?> 
               
               <?php if(in_array($exam_code,array("33","151","153","156","158","160","175","177","162"))){?>
                <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;font-weight:bold">
               ...
               <?php if(in_array($exam_code,array("58","74","78","79","148","149"))){?>
               <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;font-weight:bold">
               <p style="font-family:'Times New Roman', Times, serif; font-weight:bold;  font-size:16px;">Passing marks - 50</p>
                </td>
                <?php }?>
                ...
                <td style="padding:20px 0;"><table style="border-collapse:collapse;" width="90%" align="center">
                  ...
                  <table width="10%" align="center" border="0" cellpadding="0" cellspacing="0" style="padding:30px 0 0;">
                    <tr>
                      ...
                      <td><a href="<?php echo base_url()?>result/diplomacertification" style="background-color:#ddd; color:#000; text-align:center; padding:10px 15px; text-decoration:none;">Back</a></td>
                    </tr>
                  </table></td>
              </tr>
              <tr>
