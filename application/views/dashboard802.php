 ...
 <table border="0" cellpadding="0" cellspacing="0" width="900px" align="center" style=" margin-bottom:10px;">
   ...
   <td rowspan="2" width="75%">
  	<ul>
    	...
    	<?php if($this->session->userdata('result_examcode') == 11 || $this->session->userdata('result_examcode') == 32 || $this->session->userdata('result_examcode') == 33 || $this->session->userdata('result_examcode') == 47 || $this->session->userdata('result_examcode') == 151 || $this->session->userdata('result_examcode') == 153 || $this->session->userdata('result_examcode') == 156 || $this->session->userdata('result_examcode') == 158){?>
    	<li class="resultlink"><a href="<?php echo base_url()?>result/consolidated802" target="_blank">Consolidated Marksheet</a></li>
        <?php }?>
        <li class="resultlink"><a href="<?php echo base_url()?>result/adviceresult802" target="_blank">Result Advice</a></li>
