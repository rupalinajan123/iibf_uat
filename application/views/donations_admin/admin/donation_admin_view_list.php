        ...
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header with-border" style="text-align: center">
              ...
              <div class="pull-right"> <a href="<?php echo base_url();?>donations_admin/admin/Donation_admin/donation_admin_list" class="btn btn-warning">Back</a>
                 ...
                 <div class="table-responsive ">
                  <table class="table table-bordered" style="">
                    ...
                    <tr>                    
                     ...
                     <tr>                    
                      <td width="50%"><strong>FATHER'S/HUSBAND'S NAME:</strong></td>
