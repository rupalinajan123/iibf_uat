...
<label for="text" class="col-md-6">Please verify your humanity by solving the puzzle </label>

       

       <label class="col-md-6 p-o">     <div id="captcha_img">
		   <input type="text" name="val1" class="inputField"  value="<?php echo (rand(1,10))?>" style="width: 30px"> + 
		   <input type="text" name="val2" class="inputField" value="<?php echo (rand(1,10))?>"style="width: 30px"> =
		    <input type="text" class="form-control" name="val3" autocomplete="off"  style="padding-right:10px !important; width: 100px; float: right" required></div></label>
    ...
    <?php /* echo get_ip_address(); */
            ...
            { ?> 
              <input type="hidden" class="form-control" name="code" autocomplete="off" value="<?php echo $_SESSION['mem_applyexam_captcha']; ?>" required />   
      <?php }else{
        ?>
              <div class="form-group has-feedback clearfix"> 
    ...
    <ul>
        ...
        <?php if(base64_decode($this->input->get('ExId')) == '101' || base64_decode($this->input->get('ExId')) == '1046' || base64_decode($this->input->get('ExId')) == '1047'){ ?>
          <li>If you have attended the mandatory training program of BCBF, <a class="disability forget" href="<?php echo base_url()?>iibfbcbf/apply_exam_individual/">please register for examination through this link</a></li>
        <?php } ?>
	...
	<?php 
      ...
      <?php
		...
		?>	
        <p><a href="https://iibf.esdsconnect.com/CmsComplaint" target="_blank">Click here for registering Queries regarding exam application</a></p>
