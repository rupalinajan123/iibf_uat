			...
			<?php 
                ...
                <label for="roleid" class="col-sm-3 control-label">Centre Name <span style="color:#F00">*</span></label>
                    ...
                    <?php 
						if($this->session->userdata('mregnumber_applyexam') == '510226859'){
							echo 'PUNE';
							$venue_tmp = 'Nice Computer Institute Of Technology & Design';
						}elseif($this->session->userdata('mregnumber_applyexam') == '510067565'){
							echo 'RANCHI';
							$venue_tmp = 'TISSA TECHNOLOGY';
						}
						?>
                    </div>
                   </div>
                              ...
                              <div class="form-group">
                          	  <label for="roleid" class="col-sm-3 control-label">MICROFINANCE<span style="color:#F00">*</span></label>
                                <div class="col-sm-2">
                                <label for="roleid" class="col-sm-3 control-label">Venue<span style="color:#F00">*</span></label>
                                <select name="venue[155]" id="venue_1" class="form-control venue_cls"   onchange="venue(this.value,'date_1','time_1','155','seat_capacity_1');" attr-data='155'>
                                ...
                                <select name="date[155]" id="date_1" class="form-control date_cls"   onchange="date(this.value,'venue_1','time_1');">
                                <option value="">2020-01-19</option>
                                </select>
                                </div>
                                
                                <div class="col-sm-2">
                                <label for="roleid" class="col-sm-3 control-label">Time<span style="color:#F00">*</span></label>
                                <select name="time[155]" id="time_1" class="form-control time_cls"  onchange="time(this.value,'venue_1','date_1','seat_capacity_1');">
