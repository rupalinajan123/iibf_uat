      ...
      <div class="row">
        ...
        <li><b>Please note that the admit letters will be available for download on the Institute’s website as well as in the candidate login 10 days before the exam.</b></li>
          ...
          <div id="printAcknowId" class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <div class="box-body <?php if($applied_exam_info[0]['exam_code']==210) echo'col-md-6';else echo'col-md-7'; ?>" >
              ...
              <?php if($applied_exam_info[0]['exam_code'] == 101 || $applied_exam_info[0]['exam_code'] == 1046 || $applied_exam_info[0]['exam_code'] == 1047){ ?>
                ...
                <label for="roleid" class="col-sm-3 control-label">Name :</label>
                  <div class="col-sm-5">
                  <?php if(isset($applied_exam_info[0]['firstname']) && $applied_exam_info[0]['firstname'] != ""){echo $applied_exam_info[0]['firstname']." ".$applied_exam_info[0]['lastname'];}?>
                    </div>
                </div>
              <?php } ?>
          ...
          ?>
             ...
             ?>
			  ...
			  if($this->session->userdata['examinfo']['elected_exam_mode']=='E' && base64_decode($this->session->userdata['examinfo']['excd'])!=$this->config->item('examCodeJaiib') && !in_array(base64_decode($this->session->userdata['examinfo']['excd']),$elective_exam_code))
			  {?>
          	      <div class="form-group">
              ...
              <div style="text-align:left">
               <?php 
				...
				?> 
                        ...
                        <?php 
						if($applied_exam_info[0]['exam_code']!=101 && $applied_exam_info[0]['exam_code']!=1046 && $applied_exam_info[0]['exam_code']!=1047 && $admit_card_details[0]['admitcard_image'] != '')
						{
							?>
                 <?php 
                      if(!in_array($applied_exam_info[0]['exam_code'],$this->config->item('skippedAdmitCardForExams'))) { //priyanka d >>27-dec-24 >> by default selecting venue for jaiib/caiiib as we don't have to create admitcard from filled form now >> exam_cd
                       ?> 
                        <a class="noprintelm" href="<?php echo base_url()?>/uploads/admitcardpdf/<?php echo $admit_card_details[0]['admitcard_image']?>" target="_blank">Download admitcard</a>
          ...
          <?php } ?>
			...
			<?php } ?> 
                ...
                <a class="noprintelm" style="font-weight: bold;" href="<?php echo  base_url()?>Home/Dashboard/">Home</a>&nbsp;&nbsp;
                <a class="noprintelm" style="font-weight: bold;" href="<?php echo  base_url()?>Login/logout/">Logout</a>
            ...
            <?php /* <a target="_blank" href="https://bookscape.com/publishers/macmillan-education-india"><img style="margin-top: 30px;    width: 95%;"  src="https://iibf.esdsconnect.com/uploads/jaiib-books-banner.png"></a> */ ?>
            ...
            <a class="noprintelm" href="javascript:void(0)" redirect_to="https://bookscape.com/product-details/jaiib-special-value-pack-9789356667846"  onclick="buy_book_link(210,this)"><img style="margin-top: 30px; width: 95%;"  src="https://iibf.esdsconnect.com/uploads/jaiib-books-banner.png"></a>
              ...
              if(in_array($applied_exam_info[0]['exam_code'],$bannerexamcodes)) { ?>
                ...
                <a href="javascript:void(0)" redirect_to="https://bookscape.com/product-details/jaiib-special-value-pack-9789356667846" onclick="buy_book_link(600,this)"><img style="margin-top: 30px; width: 95%;"  src="https://iibf.esdsconnect.com/uploads/caiib-books-banner.png"></a>
                  </div> 
                  <?php } 
  ...
  function buy_book_link(exam=0,elem) 
      {
        ...
        var parameters = { "module_name":"controller Apply, function details", "description":"JAIIB Success Page","exam":exam }
