...
?>
  ...
  <div class="content-wrapper">
	...
	<form class="form-horizontal" name="member_conApplication" id="member_conApplication"  method="post"  enctype="multipart/form-data" action="<?php echo base_url();?>ApplyexamMK909/comApplication/">
          ...
          <div class="box box-info">
             ...
             <div class="form-group">
               ...
               <div class="form-group">
                ...
                <label for="roleid" class="col-sm-3 control-label">Mobile <span style="color:#F00">*</span></label>
                	<div class="col-sm-5">
                      <input type="tel" class="form-control" id="mobile" name="mobile" placeholder="Mobile" data-parsley-type="number"  data-parsley-minlength="10" data-parsley-maxlength="12"  value="<?php echo $user_info[0]['mobile'];?>"  data-parsley-editmobilecheckexamapply  data-parsley-trigger-after-failure="focusout" >
                ...
                <label for="roleid" class="col-sm-3 control-label">Email <span style="color:#F00">*</span></label>
                	<div class="col-sm-5">
                    <input class="form-control" id="email" name="email" placeholder="Email" data-parsley-type="email" value="<?php echo $user_info[0]['email'];?>" data-parsley-maxlength="45" ="" data-parsley-editemailcheckexamapply  type="text" data-parsley-trigger-after-failure="focusout" >
            ...
            <div class="box-body">
                ...
                <!--    <div style="color:#F00">select center first</div>-->
						...
						<!--2400 + GST as applicable-->
                        <?php 
						
							echo '6000 + GST as applicable';
			...
			<?php 
                ...
                <label for="roleid" class="col-sm-3 control-label">Centre Name <span style="color:#F00">*</span></label>
                    ...
                    <?php 
							...
							echo 'MADURAI';
							$venue_tmp = 'SOLAMALAI COLLEGE OF ENGINEERING';
						...
						?>
                              ...
                              <div class="form-group">
                          	  <label for="roleid" class="col-sm-3 control-label">TREASURY OPERATIONS<span style="color:#F00">*</span></label>
                                <div class="col-sm-2">
                                <label for="roleid" class="col-sm-3 control-label">Venue<span style="color:#F00">*</span></label>
                                <select name="venue[147]" id="venue_1" class="form-control venue_cls"   onchange="venue(this.value,'date_1','time_1','147','seat_capacity_1');" attr-data='155'>
                                <option value=""><?php echo $venue_tmp;?></option>
                                </select>
                                </div>
                                
                                <div class="col-sm-2">
                                <label for="roleid" class="col-sm-3 control-label">Date<span style="color:#F00">*</span></label>
                                <select name="date[147]" id="date_1" class="form-control date_cls"   onchange="date(this.value,'venue_1','time_1');">
                                <option value="">2019-12-28</option>
                                </select>
                                </div>
                                
                                <div class="col-sm-2">
                                <label for="roleid" class="col-sm-3 control-label">Time<span style="color:#F00">*</span></label>
                                <select name="time[147]" id="time_1" class="form-control time_cls"  onchange="time(this.value,'venue_1','date_1','seat_capacity_1');">
                ...
                <label for="roleid" class="col-sm-3 control-label">Exam Mode <span style="color:#F00">*</span></label>
                  ...
                  <div name="optmode1" id="optmode1" style="display: block;">Exam will be in ONLINE mode only, Read Important Instructions on the website.</div>
        ...
        <?php 
				...
				{?>
                    ...
                    <label for="roleid" class="col-sm-3 control-label">Place of Work <span style="color:#F00">*</span></label>
                        <div class="col-sm-3">
                          <input type="text" name="placeofwork" id="placeofwork"  class="form-control" data-parsley-maxlength="30" maxlength="30" value="Duburi">
                        </div>
                        (Max 30 Characters)  
                      </div>
                    ...
                    <label for="roleid" class="col-sm-3 control-label">State (Place of Work)<span style="color:#F00">*</span></label>
                        <div class="col-sm-3">
                        <select class="form-control" id="state" name="state_place_of_work"  >
                     ...
                     <label for="roleid" class="col-sm-3 control-label">Pin Code (Place of Work)<span style="color:#F00">*</span></label>
                        <div class="col-sm-3">
                         <input class="form-control" id="pincode_place_of_work" name="pincode_place_of_work" value="755026">
