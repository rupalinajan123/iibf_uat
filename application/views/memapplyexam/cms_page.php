...
$('#confirmTwo').modal({backdrop: 'static', keyboard: false}, 'show');
} 
</script>
      ...
      <div class="modal-body">
          ...
          <br />
            <div class="message" style="color:#F00; text-align:justify;font-size:16px;"> Candidates are requested to take utmost care and precaution in selecting the center as there is not provision to change the same after successful submission of the exam application<br />
              ...
              <br />
              Note: FEES ONCE PAID WILL NOT BE REFUNDED OR ADJUSTED ON ANY ACCOUNT.
            </div>
      </div>
...
<div class="modal fade" id="confirmTwo"  role="dialog" >
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <br />
        <br />
        <?php if(!in_array(base64_decode($this->input->get('ExId')),$this->config->item('skippedAdmitCardForExams'))) {
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
 	...
 	<form class="form-horizontal" name="agree_diagree_Form" id="agree_diagree_Form"  method="post"  enctype="multipart/form-data" action="<?php echo base_url();?>Applyexam/comApplication/">
          ...
          <div class="box-body">
            ...
            <?php //echo validation_errors(); ?>
			 ...
			 ?> 
                ...
                <div class="form-group">
                	<div class="col-sm-12">
                    <input style="cursor: pointer;" name="declaration1" value="1" id="agree" type="checkbox" required>&nbsp;<label for="agree" style="cursor: pointer;">I
...
Regulations and Instructions</label>
  ...
  function chk_agree_diagree_Form() { 
      $("#parsley-id-multiple-declaration1").css({"margin-top": "32px", "margin-left": "18px"}); 
  } 
  setInterval(chk_agree_diagree_Form, 100);
