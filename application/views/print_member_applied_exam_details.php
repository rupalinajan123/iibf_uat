...
<form class="form-horizontal" name="usersAddForm" id="usersAddForm"  method="post"  enctype="multipart/form-data" 
    ...
    <section class="content">
	   ...
	   $useradd=$finalstr1.$finalstr2;
		...
		?>
             ...
             <div class="col-sm-9">
               ...
               <div class="form-group">
                <label style="text-align: left;" for="roleid" class="col-sm-5 control-label">First Name </label>
                	<div class="col-sm-5">
                  <?php 
				  $username=$user_info[0]['namesub'].' '.$user_info[0]['firstname'].' '.$user_info[0]['middlename'].' '.$user_info[0]['lastname'];
				  $userfinalstrname= preg_replace('#[\s]+#', ' ', $username);
        ...
        <div class="col-sm-5">
        <?php if(isset($idtype_master[0]['name'])){echo $idtype_master[0]['name'];}?>
        </div>
        </div>
        ...
        <div class="form-group">
        <label style="text-align: left;" for="roleid" class="col-sm-5 control-label">Exam Name.</label>
        <div class="col-sm-5">
        ...
        <div class="form-group">
        <label style="text-align: left;" for="roleid" class="col-sm-5 control-label">Amount.</label>
        <div class="col-sm-5">
        ...
        <div class="form-group">
        <label style="text-align: left;" for="roleid" class="col-sm-5 control-label">Exam Preiod </label>
        <div class="col-sm-5">
        ...
        <div class="form-group">
        <label style="text-align: left;" for="roleid" class="col-sm-5 control-label">Mode</label>
        <div class="col-sm-5">
        <?php echo $mode;?>
        </div>
        </div>
        ...
        <div class="form-group">
        <label style="text-align: left;" for="roleid" class="col-sm-5 control-label">Medium</label>
        <div class="col-sm-5">
        ...
        <div class="form-group">
        <label style="text-align: left;" for="roleid" class="col-sm-5 control-label">Centre Name</label>
        <div class="col-sm-5">
     ...
     <?php 
	  ...
	  {?>
    		<div class="form-group">
            <label style="text-align: left;" for="roleid" class="col-sm-5 control-label">Elective Subject Name</label>
            <div class="col-sm-5">
            <?php echo $elective_subject_name;?>
            </div>
            </div>
      <?php
	  }?>	
      	...
      	<?php 
			...
			{?>
                <div class="form-group">
                <label style="text-align: left;" for="roleid" class="col-sm-5 control-label">Place of Work</label>
                <div class="col-sm-5">
                <?php echo $applied_exam_info[0]['place_of_work'];?>
                  ...
                  <div class="form-group">
                <label style="text-align: left;" for="roleid" class="col-sm-5 control-label">State (Place of Work)</label>
                <div class="col-sm-5">
                 <?php 
					  if(count($states) > 0)
						{
                  ...
                  <div class="form-group">
                <label style="text-align: left;" for="roleid" class="col-sm-5 control-label">Pin Code (Place of Work)</label>
                <div class="col-sm-5">
...
<label style="text-align: left;" for="roleid" class="col-sm-5 control-label"><img src="<?php echo base_url();?><?php echo get_img_name($this->session->userdata('regnumber'),'p');?><?php echo '?'.time(); ?>" height="100" width="100" ></label>
...
<div style=" background:#000; width:100%; height:1px; margin-bottom:10px;"></div>
	<table width="100%" cellspacing="2" cellpadding="2" border="0" align="center"  style=" position:relative;" class="tablecontent2" >
	  ...
	  {?>
        ...
        <td colspan="3" class="tablecontent2" nowrap="nowrap"><?php echo $elective_subject_name;?></td>
        </tr>
	  <?php
	  }?>
			...
			{?>
                <tr>
            	    <td class="tablecontent2">Place of Work :</td>
            		    <td colspan="3" class="tablecontent2" nowrap="nowrap"><?php echo $applied_exam_info[0]['place_of_work'];?></td>
                </tr>
