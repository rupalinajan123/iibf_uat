									...
									<div class="col-sm-2">
										<div class="form-group">
											...
											<select class="custom_filter form-control" name="searchBy" id="searchBy" required="">
												...
												<option value="01" <?php if ($searchBy == '01') {
																		echo 'selected';
																	} ?>>Scrib URN</option>
												<option value="02" <?php if ($searchBy == '02') {
																		echo 'selected';
																	} ?>>Member no</option>
												<option value="03" <?php if ($searchBy == '03') {
																		echo 'selected';
																	} ?>>Exam</option>
												<option value="04" <?php if ($searchBy == '04') {
																		echo 'selected';
																	} ?>>Exam Date</option>
												<option value="05" <?php if ($searchBy == '05') {
																		echo 'selected';
																	} ?>>Scribe Name</option>
												<option value="06" <?php if ($searchBy == '06') {
																		echo 'selected';
																	} ?>>Scribe Mobile</option>
											</select>
										</div>
									</div>
									<div class="col-sm-3">
