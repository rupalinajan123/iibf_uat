    ...
    <div class="wrapper">
            ...
            <div class="content-wrapper" style="min-kash: 946px;">
                <section class="content">
                    ...
                    <?php if(!empty($scribe_show[0]['scribe_approve']) && $scribe_show[0]['scribe_approve'] == 1){ ?>
                      <h4 class="title_common">Special Approved List</h4>
                    <?php } elseif (!empty($scribe_show[0]['scribe_approve']) && $scribe_show[0]['scribe_approve'] == 3) { ?>
                      <h4 class="title_common">Special Rejected List</h4>
                    <?php } ?>
          ...
          <div class="box-header">
            <!-- <div class="box-header with-border"> -->
               ...
               <!-- CHECK FOR APPROVED/REJECTED SCRIBE  -->
                <?php if(!empty($scribe_show[0]['scribe_approve']) && $scribe_show[0]['scribe_approve'] == 1){ ?>
                      <h3 class="page-title">Special Approved list</h3>  <!-- FOR APPROVED LIST -->
                <?php } elseif (!empty($scribe_show[0]['scribe_approve']) && $scribe_show[0]['scribe_approve'] == 3) { ?>
                      <h3 class="page-title">Special Rejected list</h3> <!-- FOR REJECTED LIST -->
                <?php } ?>
            <!-- </div> -->
            ...
            <div class="collapsee" id="collapseExample">
              ...
              <?php if(!empty($scribe_show[0]['scribe_approve']) && $scribe_show[0]['scribe_approve'] == 1)
              { ?> <!-- FORM APPROVED LIST -->
                <form class="form-control" name="searchScribeDetails" id=" " action="<?php echo base_url('scribe_dashboard/Scribe_list/special_approved_list'); ?>" method="post">
              ...
              <?php } 
              elseif (!empty($scribe_show[0]['scribe_approve']) && $scribe_show[0]['scribe_approve'] == 3) 
                { ?><!-- FORM REJECTED LIST -->
              <form class="form-control" name="searchScribeDetails" id=" " action="<?php echo base_url('scribe_dashboard/Scribe_list/special_rejected_list'); ?>" method="post"> 
