...
?>
  ...
  <div class="content-wrapper">
	...
	<form class="form-horizontal" name="member_conApplication" id="member_conApplication"  method="post"  enctype="multipart/form-data" action="<?php echo base_url()."Remote_exam/examdetails/?ExId=".$this->input->get('ExId')."&Extype=".$this->input->get('Extype')."&Exprd=".$this->input->get('Exprd')?>">
