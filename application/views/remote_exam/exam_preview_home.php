  ...
  <div class="content-wrapper">
    ...
    <?php 
		...
		}elseif($this->session->userdata['examinfo']['elearning_flag'] == 'N'){
	...
	<form class="form-horizontal" name="member_exam_comApplication" id="member_exam_comApplication"  method="post"  enctype="multipart/form-data" action="<?php echo base_url();?>Remote_exam_home/<?php echo $function;?>/">
             ...
             ?>
                ...
                <label for="roleid" class="col-sm-3 control-label">GSTIN No.</label>
                  ...
                  <?php 
						...
						if(isset($this->session->userdata['examinfo']['gstin_no']))

						{

						echo $this->session->userdata['examinfo']['gstin_no'];
