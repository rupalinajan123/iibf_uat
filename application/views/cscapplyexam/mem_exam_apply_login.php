...
<label for="text" class="col-md-6">Type the exact characters you see in the picture <span class="red">*</span>.</label>
	...
	<?php 
	  ...
	  $examarray=array($this->config->item('examCodeJaiib'),62,$this->config->item('examCodeCaiibElective63'),64,65,66,67,$this->config->item('examCodeCaiibElective68'),$this->config->item('examCodeCaiibElective69'),70,$this->config->item('examCodeCaiibElective71'),72,19,$this->config->item('examCodeCaiib'));
	 if(in_array(base64_decode($this->input->get('ExId')),$examarray))
	  { ?>  
				<ul>

     <p style="text-align:center"><strong>Indian Institute of Banking & Finance</strong></p>
<p>Registration for CAIIB/CAIIB Elective June, 2019 examination:</p>
...
<table width="100%" cellspacing="0" cellpadding="0" border="1">
  <tbody>
    <tr>
      <td><p align="center"><strong>Centre</strong></p></td>
      <td><p align="center"><strong>Nearest Centre</strong></p></td>
    </tr>
    <tr>
      <td valign="top"><p align="center">MIDNAPORE</p></td>
      <td valign="top"><p align="center">KOLKATTA,HOWRAH</p></td>
    </tr>
    <tr>
...
<!--<table width="100%" cellspacing="0" cellpadding="0" border="1">
  <tbody>
        <tr>
      <th><p align="center"><strong>Centre </strong></p></th>
      <th><p align="center"><strong>City Code </strong></p></th>
      <th><p align="center"><strong>Region</strong></p></th>
      <th><p align="center"><strong>State</strong></p></th>
    </tr>
   	
    <tr>
      <td valign="top"><p align="center">JORHAT</p></td>
      <td valign="top"><p align="center">50</p></td>
      <td valign="top"><p align="center">EAST</p></td>
      <td valign="top"><p align="center">ASSAM</p></td>
    </tr>
    <tr>
      <td valign="top"><p align="center">MIDNAPORE</p></td>
      <td valign="top"><p align="center">578</p></td>
      <td valign="top"><p align="center">EAST</p></td>
      <td valign="top"><p align="center">WEST BENGAL</p></td>
    </tr>
    <tr>
      <td valign="top"><p align="center">NAHARLAGUN(ITANAGAR)</p></td>
      <td valign="top"><p align="center">590</p></td>
      <td valign="top"><p align="center">EAST</p></td>
      <td valign="top"><p align="center">ARUNACHAL PRADESH</p></td>
    </tr>
    <tr>
      <td colspan="4" valign="top"><p><strong>Note : Merged North Lakhimpur &amp; Itanagar .</strong></p></td>
    </tr>
  </tbody>
</table>-->
...
<script>
  ...
  $(function () {
    ...
    $.ajax({
 		type: 'POST',
 		url: site_url+'CSCApplyexam/generatecaptchaajax/',
