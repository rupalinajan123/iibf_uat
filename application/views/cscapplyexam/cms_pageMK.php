...
<div class="modal fade" id="confirmTwo"  role="dialog" >
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
 	...
 	<form class="form-horizontal" name="agree_diagree_Form" id="agree_diagree_Form"  method="post"  enctype="multipart/form-data" action="<?php echo base_url();?>ApplyexamMK/comApplication/">
