  ...
  <div class="content-wrapper">
	...
	<form class="form-horizontal" name="member_exam_comApplication" id="member_exam_comApplication"  method="post"  enctype="multipart/form-data" action="<?php echo base_url();?>CSCApplyexam/Msuccess/">
              ...
              <?php 
               ...
               <?php 
				...
				?> 
                        ...
                        <?php 
						if($applied_exam_info[0]['exam_code']!=101 && $admit_card_details[0]['admitcard_image'] != '')
						{
							?>
