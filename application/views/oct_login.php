         ...
         <tr>
           <td>
             <table border="0" cellpadding="0" cellspacing="0" width="80%" align="center">
               <tr>
                 <td style="text-align:center; padding:60px 0 25px; font-size:22px; font-family:Tahoma, Geneva, sans-serif; font-weight:bold; line-height:32px;">Results for October Examination 2017</td>
               </tr>
               <tr>
                <td bgcolor="#6699CC">
                    ...
                    <tr>
                      ...
                      <td class="content" width="55%" bgcolor="#d8e4f1">
                        ...
                        <option value="">Select Exam</option>
                          <option value="20_217">CERTIFIED CREDIT OFFICER</option>
                          <option value="34_317">ANTI-MONEY LAUNDERING AND KNOW YOUR CUSTOMER</span></option>
                          <option value="58_317">CUSTOMER SERVICE AND BANKING CODES AND STANDARDS</span></option>
                          <option value="59_217">CERTIFIED TREASURY PROFESSIONALS</option>
                          <option value="81_217">CERTIFICATE EXAMINATION IN RISK IN FINANCIAL SERVICES</option>
                        </select>
                      </td>
                    </tr>
                    <tr>
