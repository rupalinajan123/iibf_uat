              ...
              <table cellpadding="0" cellspacing="0" width="100%" border="0" align="center">
                      ...
                      <tr>
                        ...
                        <td align="center">
                          <table cellpadding="0" cellspacing="0" border="0">
                            <tr>
                              <td>
                              <?php if($exam_code == 1017 || $exam_code == 1018){ ?>
                ...
                <tr>
                  ...
                  <tr style="background-color:#dcf1fc;">
                      ...
                      <td style="text-align:left; padding:7px; border-bottom:1px solid #198cc3; border-right:1px solid #198cc3;"><?php if($exam_code ==$this->config->item('examCodeDBF')){echo 'NA';}else{ echo $subject->seat_identification;}?></td>
                    </tr>
                  <?php }?>  
                  </tbody>
                  </table>
...
<? if($exam_code != 101)
{?>
<?php if($exam_code == 996 || $exam_code == 994 || $exam_code == 1055 || $exam_code == 1056){?>
...
<?php if($exam_code == 20 || $exam_code == 59 || $exam_code == 81 || $exam_code == 340  || $exam_code == 580  || $exam_code == 74  || $exam_code == 164  ){?>
