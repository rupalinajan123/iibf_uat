      ...
      <td style="background-color:#fff;">
        ...
        <table cellpadding="0" cellspacing="0" width="100%" border="0" align="center">
          ...
          ?>
            ...
            }elseif($exam_code == 210  ){

              echo "Admit letter for JAIIB/DBF May-June, 2024 examination"; ;
          ...
          ?>
              ...
              <?php
                ...
                if($this->router->fetch_method()=='getadmitcardsp_new' || $this->router->fetch_method()=='getadmitcardjd') { ?>
                  <div align="right">
                   ...
                   <?php if($this->router->fetch_method()=='getadmitcardsp_new') {
                    ...
                    ?>
                    <a href="<?php echo base_url();?>Admitcard/getadmitcardpdfjd/<?php echo base64_encode($exam_code)?>/<?php echo $mem_exam_id;?>" style="color:#F00">Save as pdf</a>&nbsp;
                    <?php
                   } ?>
                ...
                <tr>
                  ...
                  <thead>
                    ...
                    <tr style="background-color:#7fd1ea;">
                      ...
                      <th style="text-align:left; padding:7px; border-bottom:1px solid #198cc3; border-right:1px solid #198cc3;">
                      <?php if($selected_vendor=='nseit') echo'NSEIT Venue Address#';
          ...
          <?php if($vcenter == 3){ if($exam_code == 991){ ?>
                  ...
                  <?php }else if($exam_code == 997){ ?>
                    ...
                    <?php if($selected_vendor=='nseit') {
                     ...
                     In case of any Technical Issue/Problem please dial 8956684118 / 8956684119 Ext. 662 (available on exam day and the previous day only). for all other queries email to ippbexam@cscacademy.org.
          ...
          <td style="background-color:#dcf1fc; padding:7px 0; border:1px solid #1287c0; font-size:10px;" >
            <table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin:7px;width:99%">
              <tr>
                ...
                <td width="5" style="margin-top:7px;">8.</td>
                <td><strong>Rules, Penalities for Misconduct / Unfair Practices :</strong></td>
              </tr><!--8.-->
