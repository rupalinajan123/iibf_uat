...
<table border="0" cellpadding="0" cellspacing="0" width="900px" align="center" style=" margin-bottom:10px;">
  <tr>
    <td style="padding:10px 0;"><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
        <tr>
          <td align="right"><a onclick="javascript:printDiv();"> <img src="<?php echo  base_url()?>assets/images/print-icon.png"> </a></td>
        </tr>
      </table>
  </tr>
  <tr>
    <td><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
        <tr>
          <td style="border:3px solid #619fda;"><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
              ...
              <tr>
                <td style="border-bottom:3px solid #619fda; padding:10px; font-family:'Times New Roman', Times, serif; font-size:15px;"><table width="100%">
                    <tr>
                      <td width="75%"> Membership/Registration No: <?php echo $this->session->userdata('result_mem_no')?><br />
                        <?php echo $user_info->firstname." ".$user_info->middlename." ".$user_info->lastname?>
                         <br />
                        ...
                        ?>
                        Pin :<?php echo $user_info->pincode?></td>
                    </tr>
                  </table></td>
              </tr>
              <tr>
                      ...
                      <td><strong>Examination<br />
                        <?php
                        	if($exam_code != 160){
								...
								$ename = 'CERTIFICATE COURSE ON MSME';
							}
						?>
                        <?php  echo preg_replace("/\([^)]+\)/","",$ename)." ".$exam_conduct;?>
                        </strong></td>
              ...
              <tr>
                <td style="padding:20px 0; font-family:'Times New Roman', Times, serif; font-size:14px;"><table style="border-collapse:collapse;" width="90%" align="center">
                    <tbody>
					  ...
					  ?>
                      <tr>
                        <td style="border: 1px #6699CC solid; padding:5px 10px;" class="text2"><?php echo $record['subject_name']?></td>
              ...
              <tr>
                ...
                <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;font-weight:bold"><p style="font-family:'Times New Roman', Times, serif; font-weight:bold;  font-size:16px;">MINIMUM MARKS FOR PASS IN SUBJECT - 60</p></td>
                <?php }?>
                <?php if(in_array($exam_code,array("58"))){?>
                <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;font-weight:bold"><p style="font-family:'Times New Roman', Times, serif; font-weight:bold;  font-size:16px;">MINIMUM MARKS FOR PASS IN SUBJECT - 50</p></td>
                <?php }?>
              ...
              <tr>
                <td style="padding:10px; font-size:14px; border-bottom:3px solid #619fda;"><p style="font-family:'Times New Roman', Times, serif; font-weight:bold;  font-size:16px;">This result advice is issued subject to what is stated below which may please be noted</p>
                  <ol class="result">
                ...
                <td style="padding:20px 0;"><table style="border-collapse:collapse;" width="90%" align="center">
                  ...
                  <table width="10%" align="center" border="0" cellpadding="0" cellspacing="0" style="padding:30px 0 0;">
                    <tr>
                      ...
                      <td>
                      <?php
                      	if($this->session->userdata('result_period') > 743){
					  ?>
                      <a href="<?php echo base_url()?>marksheet/pdcresult/<?php echo base64_encode($this->session->userdata('result_period'))?>" style="background-color:#ddd; color:#000; text-align:center; padding:10px 15px; text-decoration:none;">Back</a>
                      <?php }else{?>
                      <a href="<?php echo base_url()?>marksheet/pdc<?php echo $this->session->userdata('result_period')?>" style="background-color:#ddd; color:#000; text-align:center; padding:10px 15px; text-decoration:none;">Back</a>
                      <?php }?>
                      </td>
                    </tr>
                  </table></td>
...
<div id="print_div" style="display: none;">
  <table border="0" cellpadding="0" cellspacing="0" width="900px" align="center" style=" margin-bottom:10px;">
    <tr>
      <td style="padding:10px 0;"><!--Logo Table--></td>
    </tr>
    <tr>
      <td><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
          <tr>
            <td style="border:3px solid #619fda;"><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
                  ...
                  <td style="padding:10px 0; border-bottom:3px solid #619fda;"><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
                      <tr>
                        ...
                        <td class="login-logo" align="center"><a>INDIAN INSTITUTE OF BANKING &amp; FINANCE<br>
                          ...
                          <span style="font-size:20px;">KOHINOOR CITY, COMMERCIAL - II, TOWER - 1, 2ND FLOOR<BR />
                          KIROL ROAD, KURLA (WEST), MUMBAI - 400 070</span></a></td>
                        <td valign="top"><img src="<?php echo base_url()?>assets/images/register-trademark.png" width="40" height="40" /></td>
                        <td><img src="<?php echo base_url()?>assets/images/90 Year of Service [IIBF]_Logo _Final_08062017.png" width="100" height="100" /></td>
                      </tr>
                    </table>
                ...
                <tr>
                  <td style="border-bottom:3px solid #619fda; padding:5px 10px; font-family: Tahoma, Geneva, sans-serif; font-size:14px;"><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
                      <tr>
						...
						?>
                          <?php echo preg_replace("/\([^)]+\)/","",$ename)." ".$exam_conduct;?> </strong></td>
                        <td style="text-align:right;"><strong>MUMBAI, Dated</strong><br />
                          <?php  echo $result_date; ?></td>
                      </tr>
                    </table></td>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style="border: 1px #6699CC solid;" class="text2" align="center"><?php
							 ...
							 ?></td>
                          <td style="border: 1px #6699CC solid;" class="text21" align="center"><?php 
								if($record['status'] == 'P'){
									echo "PASS";
								}elseif($record['status'] == 'F'){
									echo "FAIL";
                ...
                <tr>
                  <?php if(in_array($exam_code,array("34"))){?>
                  <td style="padding:0px 0 15px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;font-weight:bold"><p style="font-family:'Times New Roman', Times, serif; font-weight:bold;  font-size:16px;">MINIMUM MARKS FOR PASS IN SUBJECT - 60</p>
                  ...
                  <?php }?>
                  <?php if(in_array($exam_code,array("58"))){?>
                  <td style="padding:0px 0 15px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;font-weight:bold"><p style="font-family:'Times New Roman', Times, serif; font-weight:bold;  font-size:16px;">MINIMUM MARKS FOR PASS IN SUBJECT - 50</p>
                    <div style="float:right;margin-right:40px;text-align:center">
                      <p><strong>Yours Faithfully</strong></p>
                      <img src="<?php echo base_url();?>assets/images/iibf_officer_sign.jpg" style="max-width:40%" />
                      <p>Joint Director<br />
                  ...
                  <?php }?>
                  <?php if(in_array($exam_code,array("160"))){?>
                  <td style="padding:0px 0 15px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;font-weight:bold"><p style="font-family:'Times New Roman', Times, serif; font-weight:bold;  font-size:16px;">Passing marks - 50</p>
                    <div style="float:right;margin-right:40px;text-align:center">
                      <p><strong>Yours Faithfully</strong></p>
                      <img src="<?php echo base_url();?>assets/images/iibf_officer_sign.jpg" style="max-width:40%" />
                      <p>Joint Director<br />
