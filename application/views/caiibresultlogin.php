...
<td>
<?php
	$prd = base64_decode($this->uri->segment(3));
?>
<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
   <tr>
           ...
           <td>
             <table border="0" cellpadding="0" cellspacing="0" width="80%" align="center">
               <tr>
                 ...
                 <?php if($prd == 119){?>
                 Results for CAIIB & CAIIB Electives – June 2019
                 <?php }elseif($prd == 219){?>
                 Results for CAIIB & CAIIB Electives – December-2019 
                 <?php }elseif($prd == 220){?>
                 Results for CAIIB & CAIIB Electives – Dec 2020
                 <?php }?>
                    ...
                    <tr>
                      ...
                      <td class="content" width="55%" bgcolor="#d8e4f1">
                        <select name="exam" id="exam" class="text1" style="min-width:218px;">
                          ...
                          <option value="<?php echo $this->config->item('examCodeCaiib'); ?>">
              CAIIB                          </option>
                                                    <!-- <option value="62">
              CERTIFICATE IN CORPORATE BANKING                          </option> -->
                                                    <option value="<?php echo $this->config->item('examCodeCaiibElective63'); ?>">
              CERTIFICATE IN RURAL BANKING                          </option>
                                                    <!-- <option value="64">
              CERTIFICATE IN INTERNATIONAL BANKING                          </option> -->
                                                    <option value="65">
              CERTIFICATE IN RETAIL BANKING                          </option>
                                                    <!-- <option value="66">
              CERTIFICATE IN CO-OPERATIVE BANKING                          </option>
                                                    <option value="67">
              CERTIFICATE IN FINANCIAL ADVISING                          </option> -->
                                                    <option value="<?php echo $this->config->item('examCodeCaiibElective68'); ?>">
              CERTIFICATE IN HUMAN RESOURCES MANAGEMENT                          </option>
                                                    <option value="<?php echo $this->config->item('examCodeCaiibElective69'); ?>">
              CERTIFICATE IN INFORMATION TECHNOLOGY                          </option>
                                                    <option value="<?php echo $this->config->item('examCodeCaiibElective70'); ?>">
              CERTIFICATE IN RISK MANAGEMENT                          </option>
                                                    <option value="<?php echo $this->config->item('examCodeCaiibElective71'); ?>">
              CERTIFICATE IN CENTRAL BANKING                          </option>
                                                    <!-- <option value="72">
              CERTIFICATE IN TREASURY MANAGEMENT                          </option> -->
                        </select>
                      </td>
                    </tr>
                    <tr>
