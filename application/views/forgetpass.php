...
<head>
  ...
  <title>IIBF - Forgot Password</title>
  ...
  <div class="login-box">
    ...
    <div class="login-box-body">
      <?php 
        ...
        if ($this->session->flashdata('success_message')) { $show_msg = $this->session->flashdata('success_message'); $alert_cls = 'success'; } 
      ...
      <form class="form-horizontal" action="" method="post" name="forgetFrm" id="forgetFrm" autocomplete="off">
        <div style="background-color: #7fd1ea;color: #fff;padding: 6px 10px;margin-bottom: 10px;font-size: 20px;text-align: center;font-weight: 600;text-transform: uppercase;border-bottom:1px solid #1287c0;">Forgot Password?</div>
        ...
        <div style="padding: 10px 15px 20px 15px;max-width: 420px;margin: 0 auto;">
          <div class="form-group">
            ...
            <div class="col-sm-12">
              <input type="text" class="form-control" placeholder="Membership No. *" name="memno" id="memno" value='<?php echo set_value('memno'); ?>' required onkeypress="remove_spaces('memno')" onkeyup="remove_spaces('memno')" onkeydown="remove_spaces('memno')">
              <?php if(form_error('memno')!=""){ ?><div class="clearfix"></div><label class="error"><?php echo form_error('memno'); ?></label><?php } ?>
            </div>
          </div>
            ...
            <div class="row">
              <div class="col-xs-12">
                <div class="links_outer">
                  ...
                  <a href="<?php echo site_url('login'); ?>" class="linksx forget">Back to Login</a>
                  <div class="clearfix"></div>
                </div>

                <button type="submit" class="btn btn-primary btn-flat btn-block" name="forgot_pass" id="forgot_pass">Submit</button>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() 
    {
      $("#forgetFrm").validate({
        ...
        rules: 
        {
          memno: { required: true, digits: true, remote: { url: "<?php echo site_url('login/validation_check_member_no_forgot_password/0/1'); ?>", type: "post" } },
          code: { required: true, remote: { url: "<?php echo site_url('login/validation_check_captcha_forgot_password/0/1'); ?>", type: "post" } },          
        },
        messages: 
        {
          memno: { required: "Please enter Membership No", digits: "Please enter only numbers", remote: "Membership details not found for the provided Membership Number" },
    ...
    function change_captcha_image() 
    {
      ...
      $.ajax({
        type: 'POST',
        url: site_url + 'Login/generate_captcha_ajax_forgotpassword',
