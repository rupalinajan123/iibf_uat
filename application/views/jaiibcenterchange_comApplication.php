...
<div class="content-wrapper"> 
  ...
  <form class="form-horizontal" name="member_conApplication" id="member_conApplication"  method="post"  enctype="multipart/form-data" action="<?php echo base_url();?>Applyjaiib_centerchange_special/comApplication/">
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5 "> <?php echo '221'; ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  <select name="selCenterName" id="selCenterName" class="form-control" required onchange="valCentre(this.value);">
                    <option value="<?php //echo $compulsory_subjects[0]['center_code'];?>"><?php //echo $compulsory_subjects[0]['center_name'];?></option>
                    <?php 
						if(count($center) > 0){
							foreach($center as $crow){
					?>
                    <option value="<?php echo $crow['center_code'];?>" class=<?php echo $crow['exammode'];?> <?php if($crow['center_code'] == $old_center){?><?php }?> ><?php echo $crow['center_name']?></option>
                    <?php }
					}?>
                  </select>
                </div>
              </div> 
              <?php  //print_r($new_date);
				   if(count($compulsory_subjects) > 0 && $this->session->userdata('examcode')!=101)
				   {
					   ...
					   foreach($compulsory_subjects as $subject)
					   {
						  $date = $new_date[$i-1];
							...
							$venue = $this->master_model->getRecords('venue_master','','venue_name,venue_code');
							//echo $new_date.'***'.$this->db->last_query();
			 ...
			 ?>
              <div class="form-group">
                ...
                <div class="col-sm-2">
                  ...
                  <select name="venue[<?php echo $subject['sub_cd']?>]" id="venue_<?php echo $i;?>" class="form-control venue_cls" required  onchange="venue(this.value,'date_<?php echo $i;?>','time_<?php echo $i;?>','<?php echo $subject['sub_cd']?>','seat_capacity_<?php echo $i;?>');" attr-data='<?php echo $subject['sub_cd']?>'>
                    <option value="<?php //echo $venue[0]['venue_code']?>"><?php //echo $venue[0]['venue_name']?></option>
                  </select>
                </div>
                <div class="col-sm-2">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-2">
                  <input type="text" name="txtCenterCode" id="txtCenterCode"  class="form-control pull-right" readonly="readonly" value="<?php echo $compulsory_subjects[0]['center_code'];?>"><?php //echo $compulsory_subjects[0]['center_code'];?>
