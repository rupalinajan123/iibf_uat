    ...
    <?php $this->load->view('kyc/inc_sidebar_admin'); ?>		
      ...
      <?php $this->load->view('kyc/inc_topbar_admin'); ?>
				...
				<div class="row wrapper border-bottom white-bg page-heading">
					<div class="col-lg-10">
						<h2><?php echo 'KYC '.$dispName['disp_sidebar_name'].' Log - '.$dispName['disp_name']; ?></h2>
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?php echo site_url('kyc/kyc_dashboard'); ?>">Dashboard</a></li>
							<li class="breadcrumb-item active"> <strong><?php echo 'KYC '.$dispName['disp_sidebar_name'].' Log - '.$dispName['disp_name']; ?></strong></li>
						</ol>
					</div>
                ...
                <div class="ibox-content">
                  ...
                  <div class="table-responsive">
                          ...
                          <th class="no-sort text-center">Sr. No.</th>
													...
													<th class="text-center nowrap">Registration Number</th>
    ...
    <script language="javascript">
      $(document).ready(function()
          ...
          searching: true,
					...
					"ajax": 
          {
						"url": '<?php echo site_url("kyc/kyc_log/get_kyc_log_data_ajax"); ?>',
						"type": "POST",	
            "data": function ( d ) 
						{
