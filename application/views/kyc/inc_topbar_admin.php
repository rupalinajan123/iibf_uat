  ...
  <div class="row border-bottom top-fix">
    <div class="col-xl-12 col-lg-12 px-0">
      ...
      <ul class="nav navbar-top-links navbar-right">
        <li><a href="<?php echo site_url('kyc/kyc_dashboard'); ?>" title="<?php echo $dispName['disp_name']; ?>" alt="<?php echo $dispName['disp_name']; ?>">Welcome <?php echo substr($dispName['disp_name'],0,20); ?></a></li>			
        <li><a href="<?php echo site_url('kyc/login/logout'); ?>" title="Logout" alt="Logout"><i class="fa fa-sign-out"></i></a></li>
      </ul>
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
          <a class="dropdown-item" href="<?php echo site_url('kyc/kyc_dashboard'); ?>">Dashboard</a>
          <a class="dropdown-item" href="<?php echo site_url('kyc/login/logout'); ?>">Log out</a>
        </div>
      </div>
    </nav>
    </div>
