...
<html>
  ...
  <?php $this->load->view('iibfbcbf/common/inc_loader'); ?>
        ...
        function get_kyc_radio_btn_details($member_data=array(),$input_name='')
        {
          ...
          return $data;
                ...
                <?php } ?>
                  ...
                  <form method="post" action="<?php echo site_url('kyc/kyc_all/process_kyc'); ?>" id="kyc_form" enctype="multipart/form-data" autocomplete="off">
                      ...
                      <table class="table table-bordered" style="width:100%">
                        <thead>
                          <tr> 
                            ...
                            <th class="text-center nowrap">Regnumber</th>
                        ...
                        <tbody>
                          <?php 
                          $empty_photo_flag = $empty_sign_flag = $empty_id_proof_flag = '';
                          if(count($mem_data) > 0)
                          { ?>
                            <tr>
                              <td><?php /* Name */ ?>
                            ...
                            <tr>
                              ...
                              <td><?php /* Id Proof */ ?>
                                <?php 
                                $kyc_radio_btn_details_id_proof = get_kyc_radio_btn_details($mem_data[0],'kyc_id_proof_flag');
    ...
    $this->load->view('kyc/common/get_logs_common_ajax_call', array('enc_pk_id'=>$enc_pk_id, 'module_slug'=>$module_slug, 'log_title'=>'KYC Logs', 'module_name'=>$module_name));
  ?>
