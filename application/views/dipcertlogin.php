           ...
           <td>
             <table border="0" cellpadding="0" cellspacing="0" width="80%" align="center">
               <tr>
                 ...
                 <?php
                 if(base64_decode($this->uri->segment(3)) != 901 && base64_decode($this->uri->segment(3)) != 907 && base64_decode($this->uri->segment(3)) != 777){
         ?>

                  Result – Certificate / Blended Examinations – <?php echo $month." ".$year;?> – (<?php echo $experiod; ?>) Remote Proctored Examination.   
                 <?php }elseif(base64_decode($this->uri->segment(3)) == 901 || base64_decode($this->uri->segment(3)) == 907){?>
                  Results for Certificate Examinations - <?php echo $month." ".$year;?>
                 <?php }elseif(base64_decode($this->uri->segment(3)) == 777){?>
                 Results for Remote Proctored Examinations  <?php //echo $month."/July ".$year;?>
                 <?php }?>
                 </td>
               </tr>
               <tr>
                ...
                <form action="" method="post" name="loginFrm" id="loginFrm">
                  <table id="Table4" width="100%" cellspacing="1" cellpadding="2" border="0">
                    ...
                    <tr> 
                      <td class="content" width="45%" bgcolor="#d8e4f1">Exam&nbsp; <?php echo '---'; ?></td>
                      <td class="content" width="55%" bgcolor="#d8e4f1">

                        <select name="exam" id="exam" class="text1" style="min-width:218px;">
                          <option value="">Select Exam</option>
                          	<?php foreach($excode as $excode){?>
                            <option value="<?php echo $excode['exam_code'];?>" <?php if(set_value('exam') == trim($excode['exam_code'])) { echo 'selected="selected"'; } ?>> <?php echo strtoupper($excode['exam_name_full']);?></option>
                            <?php }?>
                        </select> 
                      </td>
                    </tr>
                    <tr>
                     ...
                     <tr>
                      ...
                      Password.&nbsp;</td>
                      <td class="text1" bgcolor="#d8e4f1">
                        <input class="text4" name="Password" id="Password" value='<?php echo set_value('Password'); ?>' type="Password">
                      </td>
                    </tr>
                    <tr>
...
<?php }?>
              ...
              <tr>
                ...
                <tr>
                <?php if( base64_decode($this->uri->segment(3)) != 777){?>
                  <td>
                    <ol>
                  ...
                  <?php if(base64_decode($this->uri->segment(3)) == 777){?>
                    ...
                    <ol>
                    <li>
                    Printed Result <span class="red"><strong>Advice will NOT be SENT to the candidates.</strong></span> Candidates can <span class="red"><strong> take a print out of the advice</strong></span> available in the website using the print tab. The printed result will contain signature of Joint Director - Examinations of the Institute, however the signature will not be visible when viewed on screen.
                    </li>
                    <li>CANDIDATES <strong>PASSING THE EXAMINATION</strong> WILL BE ISSUED <span class="red"><strong>e-CERTIFICATES THROUGH E-MAIL</strong></span></li>
                    <li> <strong> Candidates are required to update their correct e-mail address and mobile number with the Institute since Institute </strong> <span class="red"><strong> will be sending the e-CERTIFICATES </strong></span> <strong> and other important communications </strong> <span class="red"><strong> through e-mail </strong></span> <strong> and SMS. For updating the same candidate can login using their login id and password to access their EDIT Profile given under Members/Others on the home page of Institute's web site <a href="http://iibf.org.in/"> www.iibf.org.in </a> or inform the respective Zonal Office of the Institute.</strong></li>
                    </ol>
                  	</td>
                  <?php }?>
                </tr>
