        ...
        <tr>
          <td style="border:3px solid #619fda;"><table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
              ...
              <?php if($scnt == count($record)) {?>
                ...
                You have passed JAIIB and eligible to appear for CAIIB at the June 2019 examination. Application can be submitted only through Online Mode, for details visit our website www.iibf.org.in.
                </td>
              <?php }else{ ?>
              
              <?php if($user_info->no_of_attempt == 1){?>
              <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">You have completed the 1st attempt, you are required to submit the application form for the next attempt – May 2019 examination. Application can be submitted through Online Mode, for details visit our website www.iibf.org.in.</td>
              <?php }?>
              <?php if($user_info->no_of_attempt == 2 ){?>
              <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">You have completed the 2nd attempt, you are required to submit the application form for the next attempt - May 2019 examination. Application can be submitted through Online Mode, for details visit our website www.iibf.org.in.</td>
              <?php }?>
              <?php if($user_info->no_of_attempt == 3 ){?>
              <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">You have completed the 3rd attempt, you are required to submit the application form for the next attempt - May 2019 examination. Application can be submitted through Online Mode, for details visit our website www.iibf.org.in.</td>
              <?php }?>
              <?php if($user_info->no_of_attempt == 4 ){?>
              <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">You have completed all 4 attempts, you are required to submit the examination application form afresh for appearing at the May 2019 examination. You will not be eligible for credit of subjects passed, if any, earlier. Application can be submitted only through Online Mode for details visit our website www.iibf.org.in.</td>
              <?php }?>
              ...
              <?php }else{?>
              	 <?php if($scnt == count($record)) {?>
                 	<td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">
                    You have passed JAIIB Examination and eligible to appear for CAIIB - June 2019 examination as per the rules for appearing from Foreign Centre.
                    </td>
                 <?php }?>
                 <?php if($scnt != count($record)) {?>
                 <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">
                ...
                <td style="padding:20px 0;"><table style="border-collapse:collapse;" width="90%" align="center">
                  ...
                  <table width="10%" align="center" border="0" cellpadding="0" cellspacing="0" style="padding:30px 0 0;">
                    <tr>
                      ...
                      <td><a href="<?php echo base_url()?>marksheet/jaiibdbf218" style="background-color:#ddd; color:#000; text-align:center; padding:10px 15px; text-decoration:none;">Back</a></td>
