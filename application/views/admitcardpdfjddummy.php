                ...
                <tr>
                  ...
                  <thead>
                    <tr style="background-color:#7fd1ea;">
                      ...
                      <th style="text-align:left; padding:7px; border-bottom:1px solid #198cc3; border-right:1px solid #198cc3;" >Exam Seat No.</th>
                    </tr>
                  </thead>
                  <tbody>
                  <?php 
        ...
        <tr>
          <td colspan="2" style="padding-left:30px;">
            <table cellpadding="0" cellspacing="0" border="0">
              <tr>
                <td width="2%" valign="top" style="font-size:13px;">a.</td>
                <td style="font-size:13px;">After submitting of the question paper provisional score card/result will be displayed on the computer screen. This Score card will be sent within 3 working days from exam date to the Candidate's email ID as registered with the Institute.</td>
              </tr>
              <tr>
                <td width="2%" valign="top" style="font-size:13px;">b.</td>
