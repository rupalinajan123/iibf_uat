...
<div class="content-wrapper">
    ...
    action="<?php echo base_url()?>SplexamNM/addmember/">
       ...
       <!---->
        ...
        <div class="box-body">
            ...
            <br />
              ...
              <span for="roleid" class="col-sm-5 text-center"><?php echo $venue_add_finalstring; ?></span>
            ...
            <div class="col-sm-5 ">
             <?php 
                  ...
                  //  echo date('F',strtotime($month))."-".substr($this->session->userdata['enduserinfo']['eprid'],0,-2);
             ?>
            <div id="error_dob"></div>
             <br>
             <div id="error_dob_size"></div>
            ...
            <div class="col-sm-2">
            <?php 
             			        echo date('d-M-Y',strtotime($this->session->userdata['enduserinfo']['special_exam_date']));?>
 ...
 <script>
  $(document).ready(function(){
	...
	createCookie('non_member_register_form','1','1');
 });
