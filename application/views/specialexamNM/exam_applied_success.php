  ...
  <div class="content-wrapper">
	...
	<form class="form-horizontal" name="member_exam_comApplication" id="member_exam_comApplication"  method="post"  enctype="multipart/form-data" action="<?php echo base_url();?>SpecialExamNm/Msuccess/">
             ...
             ?>
				...
				if($payment_info[0]['status']=='1')
                {
					...
					<div style="text-align:left">
                        <a href="<?php echo base_url()?>SpecialExamNm/exampdf/">Save as pdf</a> &nbsp; &nbsp;
                      <a href="javascript:void(0);" onclick="print_special_exam_non_mem_preview()">Continue</a>&nbsp; &nbsp;
                    <?php if(count($admit_card_details)>0 && $admit_card_details[0]['admitcard_image'] !='')
					{ ?>
                      <a href="<?php echo base_url()?>/uploads/admitcardpdf/<?php echo $admit_card_details[0]['admitcard_image']?>" target="_blank">Download admitcard</a><?php }?>
