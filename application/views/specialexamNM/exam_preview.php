...
?>
  ...
  <div class="content-wrapper">
    ...
    <?php
        ...
        {	$function = "Msuccess";	}
    ?>
	<form class="form-horizontal" name="member_exam_comApplication" id="member_exam_comApplication"  method="post"  enctype="multipart/form-data" action="<?php echo base_url();?>SpecialExamNm/<?php echo $function;?>/">
            ...
            <div class="box-body">
             ...
             ?>
                ...
                <label for="roleid" class="col-sm-3 control-label">Examination Date *</label>
                	<div class="col-sm-2">
                    <?php 
             			        echo date('d-M-Y',strtotime($this->session->userdata['examinfo']['special_exam_date']));?>
                        <?php //echo $this->db->userdata['enduserinfo']['eprid'];?>
