...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    <h1 class="register">(Please read "Instructions to Applicants" before filling up the form) </h1>
    <!--<ol class="breadcrumb">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-6 email">
                  <input type="text" class="form-control" id="email" name="email" placeholder="Email"  data-parsley-type="email" value="<?php echo set_value('email');?>"  required  data-parsley-splnonmememailcheck data-parsley-trigger-after-failure="focusout" />
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  ...
                  <input type="text" class="form-control" id="stdcode"  name="stdcode" data-parsley-type="number" data-parsley-maxlength="4" placeholder="STD Code"  value="<?php echo set_value('stdcode');?>" style="width:55%;" data-parsley-trigger-after-failure="focusout">
                  <span class="error">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" id="mobile" name="mobile" placeholder="Mobile"  data-parsley-type="number" data-parsley-minlength="10" data-parsley-maxlength="10"  value="<?php echo set_value('mobile');?>"  required data-parsley-splnonmobilecheck data-parsley-trigger-after-failure="focusout" />
                  <span class="error">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <?php /*?><input type="text" class="form-control " id="aadhar_card"  name="aadhar_card" placeholder="Aadhar Card Number" required value="<?php echo set_value('aadhar_card');?>" data-parsley-pattern="/^[a-zA-Z0-9][a-zA-Z0-9 ]+$/" data-parsley-maxlength="12" data-parsley-minlength="12"><!--(Max 25 Characters)-->
                      <span class="error"><?php //echo form_error('idNo');?></span><?php */?>
                  <input type="text" class="form-control " id="aadhar_card"  name="aadhar_card" placeholder="Aadhar Card Number"  value="<?php echo set_value('aadhar_card');?>" data-parsley-pattern="/^[a-zA-Z0-9][a-zA-Z0-9 ]+$/" data-parsley-maxlength="12" data-parsley-minlength="12">
                  <!--(Max 25 Characters)--> 
                  <span class="error">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control " id="idNo"  name="idNo" placeholder="ID No." required value="<?php echo set_value('idNo');?>" 
 data-parsley-pattern="/^[a-zA-Z0-9][a-zA-Z0-9 ]+$/" data-parsley-maxlength="25">
                  <!--(Max 25 Characters)--> 
                  <span class="error">
                  <?php //echo form_error('idNo');?>
                  </span> </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9"> 1. Images format should be in JPG 8bit and size should be minimum 8KB and maximum 20KB.</br>
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-5 ">
                  ...
                  <?php echo str_replace("\\'","",html_entity_decode($examinfo[0]['description']));?>
                  <div id="error_dob"></div>
                  <br>
                  <div id="error_dob_size"></div>
                  <span class="dob_proof_text" style="display:none;"></span> <span class="error">
              ...
              <!--<div class="form-group">
                ...
                <div class="col-sm-3">
                  <select name="splexamdate" id="splexamdateNM" class="form-control" required>
                    <option value="">Select</option>
                    <?php
					...
					{	
						...
						//echo $this->ldb->last_query();
							//print_r($examination_total_cn);?>
                    <option value="<?php echo $mrow['examination_date']?>" <?php if($examination_total_cnt==108){echo 'disabled="disabled"';}?>><?php echo date('d-M-Y',strtotime($mrow['examination_date']));?></option>
                    <?php }
					}*/
					?>
                  </select>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-2">
                  <input type="text" name="txtCenterCode" id="txtCenterCode"  class="form-control" readonly="readonly">
                </div>
              </div>
              <div class="form-group">
	...
	<!-- Benchmark Disability Code Start -->
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <ol>
                    <li> I declare that I have submitted proof of my identity : Aadhaar ID/ college ID /PAN Card/Driving License/Election voter's card/Passport. </li>
          ...
          <div class="box box-info">
            ...
            <div class="box-footer">
              <div class="col-sm-6 col-sm-offset-2"> <a href="javascript:void(0);" class="btn btn-info"onclick="javascript:return non_mem_checkform();" id="javascript:return non_mem_checkform()">Preview and Proceed for Payment</a> 
    ...
    <div class="modal fade" id="confirm"  role="dialog" >
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer"> 
            <!--<button type="button" class="btn btn-primary" data-dismiss="modal" onclick="Special_exam_preview();">Confirm</button>-->
            <input type="submit" name="btnSubmit" class="btn btn-primary"  onclick="Special_exam_preview()"  id="btnSubmit" value="Confirm">
          </div>
        </div>
        <!-- /.modal-content --> 
      </div>
...
$(function(){
	...
	if(readCookie('non_member_register_form'))
	{
		$('#error_id').html(''); 
		$('#error_id').removeClass("alert alert-danger alert-dismissible");
		createCookie('non_member_register_form', "", -1);	
	}
