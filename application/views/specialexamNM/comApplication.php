...
?>
  ...
  <div class="content-wrapper">
	...
	<form class="form-horizontal" name="member_conApplication" id="member_conApplication"  method="post"  enctype="multipart/form-data" action="<?php echo base_url();?>SpecialExamNm/comApplication/">
             ...
             <div class="form-group">
               ...
               <div class="form-group">
                ...
                <label for="roleid" class="col-sm-3 control-label">Email <span style="color:#F00">*</span></label>
                    ...
                    <input class="form-control" id="email" name="email" placeholder="Email" data-parsley-type="email" value="<?php echo $user_info[0]['email'];?>" data-parsley-maxlength="45" type="hidden" data-parsley-trigger-after-failure="focusout">
                    <br>
            ...
            <div class="box-body">
 			  ...
 			  <!--<div class="form-group">
                <label for="roleid" class="col-sm-3 control-label">Examination Date<span style="color:#F00">*</span></label>
                	<div class="col-sm-2">
                    <select name="splexamdate" id="splexamdateNMapply" class="form-control" required>
				...
				/*	if(count($special_exam_dates) > 0)
					{
						...
						foreach($special_exam_dates as $mrow)
						{
							   ...
							   ?>
								<option value="<?php echo $mrow['examination_date']?>" <?php if(in_array($mrow['examination_date'],$specialdateapply))
								{
									echo 'disabled="disabled"';
									}elseif($examination_total_cnt==108)
									{
										echo 'disabled="disabled"';
									}?>><?php echo date('d-M-Y',strtotime($mrow['examination_date']));?></option>
						<?php }
					}*/
					?>
                    </select>
                ...
                <label for="roleid" class="col-sm-3 control-label"></label>
                    ...
                    <div style="color:#F00">Registration for  Exam on 11-March-2017 for MUMBAI centre has been closed Select any other dates.</div>
                      <span class="error"><?php //echo form_error('gender');?></span>
                </div>
                <div class="form-group">
                <label for="roleid" class="col-sm-3 control-label"></label>
                
                    <div style="color:#F00">Registration for  Exam on 25-Mar-2017 for MUMBAI centre has been closed Select any other dates.</div>
                      <span class="error"><?php //echo form_error('gender');?></span>
                </div>
                
                <div class="form-group">
                <label for="roleid" class="col-sm-3 control-label"></label>
                    <div style="color:#F00">Registration for  Exam on  08-Apr-2017 for MUMBAI centre has been closed Select any other dates.</div>
                      <span class="error"><?php //echo form_error('gender');?></span>
                </div><?php */?>
                ...
                <label for="roleid" class="col-sm-3 control-label">Photo</label>
					...
					{?> 
                     <img src="<?php echo base_url();?><?php echo get_img_name($this->session->userdata('nmregnumber'),'p');?><?php echo '?'.time(); ?>" height="100" width="100" >			 <?php 
                    }
                    else
                    {?>
...
<!--B) Since the Institute will not be sending the Admit Letter(hard copy) through post, Correct E-mail address is mandatory for receipt of Admit Letter/Hall Ticket through e-mail.-->
             ...
             <div class="box-footer">
                  <div class="col-sm-4 col-xs-offset-3">
                     <!--<a href="javascript:void(0);" class="btn btn-info" onclick="javascript:return login_specialexam_checkform();" id="preview">Preview</a>-->
                      <input type="submit" class="btn btn-info" name="btnPreviewSubmit" id="btnPreviewSubmit" value="Preview" onclick="javascript:return login_specialexam_checkform();">
                   <!-- <input type="submit" class="btn btn-info" name="btnSubmit" id="btnSubmit" value="Save">-->
                   <a href="<?php echo base_url();?>SpecialExamNm/comApplication/" class="btn btn-info" id="Reset">Reset</a>
                     <!--<button type="reset" class="btn btn-info" name="btnReset" id="btnReset">Reset</button>-->
                     <a href="<?php echo base_url();?>SpecialExamNm/examdetails/?excode2=<?php echo base64_encode($this->session->userdata('examcode'));?>" class="btn btn-info" id="preview">Back</a>
                    </div>
              </div>
             </div>
     </div>
