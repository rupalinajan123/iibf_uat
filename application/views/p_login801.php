         ...
         <tr>
           <td>
             <table border="0" cellpadding="0" cellspacing="0" width="80%" align="center">
               <tr>
                 <td style="text-align:center; padding:60px 0 25px; font-size:22px; font-family:Tahoma, Geneva, sans-serif; font-weight:bold; line-height:32px;">Certification Examinations Result April 2018</td>
               </tr>
               <tr>
                <td bgcolor="#6699CC">
                    ...
                    <tr>
                      ...
                      <td class="content" width="55%" bgcolor="#d8e4f1">
                        <select name="exam" id="exam" class="text1" style="min-width:218px;">
                          ...
                          <option value="20_801">CERTIFIED CREDIT PROFESSIONAL</option>
                          <option value="34_801">ANTI-MONEY LAUNDERING AND KNOW YOUR CUSTOMER</option>
                          <option value="58_801">CUSTOMER SERVICE & BANKING CODES AND STANDARDS</option>
                          <option value="59_801">CERTIFIED TREASURY PROFESSIONALS</option>
                          <option value="74_801">CERTIFICATE COURSE IN FOREIGN EXCHANGE</option>
                          <option value="81_801">CERTIFICATE IN RISK IN FINANCIAL SERVICES</option>
                        </select>
                      </td>
                    </tr>
                    <tr>
