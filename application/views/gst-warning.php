...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <!--<h1 class="register">
       Examination Application(Registration) for Non-Member category candidates <br>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              ...
              <a href="javascript:history.back(1);" class="dropdown-toggle" style="float:right;">
