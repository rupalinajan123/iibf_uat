          ...
          <tr>
            <td style="border:3px solid #619fda;">
              <table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
                      <tr>
                        <td><strong>Examination<br />
                            <?php echo preg_replace("/\([^)]+\)/", "", $exam_name); ?> <?php echo $exam_conduct; ?></strong>
                        </td>
                ...
                <?php /* START : CAIIB RESULT MESSAGE UPDATE HERE */ ?>
                <tr>
                  <?php if ($exam_code == $this->config->item('examCodeCaiib')) {
                    if ($scnt == count($printrecord)) { ?>
                      <td style="padding:5px 5px 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">
                        <?php if ($exam_period == 123) { ?>
                          You have passed CAIIB and eligible to appear for CAIIB Electives Examination at the Dec, 2023 examination. Application can be submitted only through Online Mode, for details visit our website www.iibf.org.in.
                        <?php } elseif ($exam_period == 220) { ?>
                          You have passed CAIIB and eligible to appear for CAIIB as a separate Elective in the Nov/Dec, 2022 examination. Application can be submitted only through Online Mode, for details visit our website www.iibf.org.in.
                        <?php } elseif ($exam_period == 122) { ?>
                          You have passed CAIIB and eligible to appear for CAIIB Electives Examination at the Nov/Dec, 2022 examination. Application can be submitted only through Online Mode, for details visit our website www.iibf.org.in.
                        <?php } elseif ($exam_period == 221) { ?>
                          You have passed CAIIB and eligible to appear for CAIIB Electives Examination at the Nov/Dec, 2022 examination. Application can be submitted only through Online Mode, for details visit our website www.iibf.org.in.
                        <?php } ?>
                      </td>
                    <?php } else { ?>
                      <?php /* <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">
                                      <?php if($exam_period == 123){  ?>
                                      You are required to submit the application form for the CAIIB June/July 2023 examination. The CAIIB Examination to be held in June/July 2023 will be under revised syllabus only. Application to be submitted through Online Mode, for details visit our website www.iibf.org.in. 
                                      <?php }elseif($exam_period == 220){  ?>
                                      You are required to submit the application form for the CAIIB June/July 2023 examination. The CAIIB Examination to be held in June/July 2023 will be under revised syllabus only. Application to be submitted through Online Mode, for details visit our website www.iibf.org.in. 
                                      <?php }?>
                      ...
                      <?php if ($user_info->no_of_attempt == 1) { ?>
                        <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">
                          <?php if ($exam_period == 220) { /*  ?>
                                        You have completed the 1st attempt, you are required to submit the application form for the next attempt – Nov/Dec, 2022 examination. Application can be submitted through Online Mode, for details visit our website www.iibf.org.in.
                                      <?php */
                          } elseif ($exam_period == 122) { /*  ?>
                                          You have completed the 1st attempt, you are required to submit the application form for the next attempt – Nov/Dec, 2022 examination. Application can be submitted through Online Mode, for details visit our website www.iibf.org.in. 
                                      <?php */
                          } elseif ($exam_period == 123) { ?>
                            You have completed the 1st attempt, you are required to submit the application form for the next attempt – Dec, 2023 examination. Application can be submitted through Online Mode, for details visit our website www.iibf.org.in.
                          <?php } ?>
                        </td>
                      <?php } ?>
                      ...
                      <?php if ($user_info->no_of_attempt == 2) { ?>
                        <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">
                          <?php if ($exam_period == 123) { ?>
                            You have completed the 2nd attempt, you are required to submit the application form for the next attempt - Dec, 2023 examination. Application can be submitted through Online Mode, for details visit our website www.iibf.org.in.
                          <?php } elseif ($exam_period == 220) { /*  ?>
                                        You have completed the 2nd attempt, you are required to submit the application form for the next attempt Nov/Dec, 2022 examination. Application can be submitted through Online Mode, for details visit our website www.iibf.org.in.
                                      <?php */
                          } elseif ($exam_period == 122) { /*  ?>
                                        You have completed the 2nd attempt, you are required to submit the application form for the next attempt - Nov/Dec, 2022 examination. Application can be submitted through Online Mode, for details visit our website www.iibf.org.in.
                                      <?php */
                      ...
                      <?php if ($user_info->no_of_attempt == 3) { ?>
                        <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">
                          <?php if ($exam_period == 123) { ?>
                            You have completed the 3rd attempt, you are required to submit the application form for the next attempt - Dec, 2023 examination. Application can be submitted through Online Mode, for details visit our website www.iibf.org.in.
                          <?php } elseif ($exam_period == 220) { /*  ?>
                                        You have completed the 3rd attempt, you are required to submit the application form for the next attempt - Nov/Dec, 2022 examination. Application can be submitted through Online Mode, for details visit our website www.iibf.org.in.
                                      <?php */
                          } elseif ($exam_period == 122) { /*  ?>
                                        You have completed the 3rd attempt, you are required to submit the application form for the next attempt - Nov/Dec, 2022 examination. Application can be submitted through Online Mode, for details visit our website www.iibf.org.in.
                                      <?php */
                      ...
                      <?php if ($user_info->no_of_attempt == 4) { ?>
                        <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">
                          <?php if ($exam_period == 123) { ?>
                            You have completed the 4th attempt, you are required to submit the application form for the next attempt - Dec, 2023 examination. Application can be submitted through Online Mode, for details visit our website www.iibf.org.in.
                          <?php } elseif ($exam_period == 220) { /*  ?>
                                        You have completed all 4 attempts, you are required to submit the examination application form afresh for appearing at the Nov/Dec, 2022 examination. You will not be eligible for credit of subjects passed, if any, earlier. Application can be submitted only through Online Mode for details visit our website www.iibf.org.in. 
                                      <?php */
                          } elseif ($exam_period == 122) { /*  ?>
                                        You have completed all 4 attempts, you are required to submit the examination application form afresh for appearing at the Nov/Dec, 2022 examination. You will not be eligible for credit of subjects passed, if any, earlier. Application can be submitted only through Online Mode for details visit our website www.iibf.org.in. 
                                      <?php */
                      ...
                      <?php if ($user_info->no_of_attempt == 5) { ?>
                        <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">
                          <?php if ($exam_period == 123) { ?>
                            You have completed all 5 attempts, you are required to submit the examination application form afresh for appearing at the Dec, 2023 examination. You will not be eligible for credit of subjects passed, if any, earlier. Application can be submitted only through Online Mode for details visit our website www.iibf.org.in.
                          <?php } ?>
                        </td>
                      <?php } ?>
                    <?php }
                    ...
                    if ($scnt == count($printrecord)) { ?>
                      <td style="padding:5px 5px 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">
                        <?php if ($exam_period != 220) { ?>
                          You have passed the above Certificate Examination. Eligible to appear for any one of the remaining Electives of CAIIB at the June/July 2023 examination. Application to be submitted through Online Mode, for details visit our website www.iibf.org.in
                        <?php } elseif ($exam_period == 122) { ?>
                          You have passed CAIIB and eligible to appear for CAIIB Electives Examination at the Nov/Dec, 2022 examination. Application can be submitted only through Online Mode, for details visit our website www.iibf.org.in.
                        <?php } elseif ($exam_period == '') { ?>
                        <?php } ?>
                      </td>
                    <?php } elseif ($scnt != count($printrecord)) { ?>
                      <td style="padding:0px 0 25px 10px; font-family:'Times New Roman', Times, serif; font-size:13px;  border-bottom:3px solid #619fda;">
                        <?php if ($exam_period == 220) { ?>
                          You are eligible to re-appear for the above certificate examination at the June/July 2023 examination. Application to be submitted through Online Mode, for details visit our website www.iibf.org.in
                ...
                <?php /* END : CAIIB RESULT MESSAGE UPDATE HERE */ ?>
                  ...
                  <td style="padding:20px 0;">
                    ...
                    <table width="10%" align="center" border="0" cellpadding="0" cellspacing="0" style="padding:30px 0 0;">
                      <tr>
                        ...
                        <td><a href="<?php echo base_url() ?>marksheet---+/caiibresult/<?php echo base64_encode($exam_period) ?>" style="background-color:#ddd; color:#000; text-align:center; padding:10px 15px; text-decoration:none;">Back</a></td>
                      </tr>
                    </table>
                  </td>
                </tr>
