          ...
          <tr>
            ...
            <td style="border:1px solid #1287c0; padding:5px;">
              ...
              <table cellpadding="0" cellspacing="0" width="100%" border="0" align="center">
                  ...
                  <td style="background-color:#1287c0; color:#fff; text-align:center; font-weight:bold; font-size:14px; padding:10px 0;">
                    ...
                    ?>
                      ...
                      ?>
                        ...
                        <?php if ($exam_code != 101 && $exam_code != 991) {
                          echo "Examination";
                        } ?>
                      ...
                      <tr>
                        ...
                        <td style="padding:0 10px;">
                          ...
                          <table cellpadding="0" cellspacing="0" width="100%" border="0" style="border-left:1px solid #fff; border-top:1px solid #fff;">
                            ...
                            <!-- Commented by pooja mane as name appearing twice -->
                            <tr>
                        ...
                        <td align="center">
                          ...
                          <table cellpadding="0" cellspacing="0" border="0">
                            ...
                            <tr>
                              ...
                              <td>
                                <!-- Added by pooja mane to resize large signature image on 2024-09-06 -->
                ...
                <?php if ($exam_code == 1001 || $exam_code == 1002 || $exam_code == 1003 || $exam_code == 1004 || $exam_code == 1005 || $exam_code == 1006 || $exam_code == 1007 || $exam_code == 1008 || $exam_code == 1009 || $exam_code == 1010 || $exam_code == 1011 || $exam_code == 1012 || $exam_code == 1013 || $exam_code == 1014 ||  $exam_code == 2027 || $exam_code == 1017 || $exam_code == 1019 || $exam_code == 1020 || $exam_code == 1026 || $exam_code == 1027 || $exam_code == 1029 || $exam_code == 1028 || $exam_code == 1030 || $exam_code == 1031 || $exam_code == 1032 || $exam_code == 1033 || $exam_code == 1051 || $exam_code == 1034 || $exam_code == 1043 || $exam_code == 1048 || $exam_code == 1049 || $exam_code == 1050 || $exam_code == 1051 || $exam_code == 1058 || $exam_code == 1059 || $exam_code == 1061 || $exam_code == 1062 || $exam_code == 1063 || $exam_code == 1064 || $exam_code == 1065 || $exam_code == 1066 || $exam_code == 1067 || $exam_code == 1068 || $exam_code == 1069) { ?>
                  <tr>
                    <td><br>
                  ...
                  <td width="100%">
                    ...
                    <table cellpadding="0" cellspacing="0" width="100%" border="0" style="border-top:1px solid #198cc3; border-left:1px solid #198cc3;">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td style="text-align:left; padding:7px; border-right:1px solid #198cc3;">
                            <p>The cut-off date of guidelines / instructions issued by the regulator(s) and important developments in banking and finance up to <?php echo '30th June, 2025'; ?> will only be considered for the purpose of inclusion in the question papers.</p>
                          </td>
                        </tr>
                          ...
                          <td style="border-right:1px solid #198cc3;">
                            ...
                            ?>
                              ...
                              <ul>
                                ...
                                <?php } else if ($exam_code == 1027) {  /*$exam_code == 1003 || $exam_code == 1004 || $exam_code == 1005 || $exam_code == 1009 || $exam_code == 1006 || $exam_code == 1007 || $exam_code == 1008 || $exam_code == 1031 || $exam_code == 1032 || $exam_code == 1033 || $exam_code == 1043 || $exam_code == 1051 || $exam_code == 1027 */ ?>
                    ...
                    <?php }
                              ...
                              <?php } ?>
                              <?php
                              if ($exam_code == 1026 ||$exam_code == 1027 || $exam_code == 1029 || $exam_code == 1028 || $exam_code == 1030 || $exam_code == 1049) {
                              ?>
                                ...
                                <ul>
                                  ...
                                  <li><a href="https://www.iibf.org.in/documents/pdf/111124RPE_CSC_Important_Instructions1-7.pdf" target="_blank">Click here for Important Instructions/ Examination Links for Remote Proctored Examinations.</a></li>
                        ...
                        <tr>
                          <td style="text-align:left; padding:7px; border-bottom:1px solid #198cc3; border-right:1px solid #198cc3; font-weight:bold; color:#0000ff;">
                            <?php
                            if ($exam_code == 1010) {  //  $exam_code == 1002 || $exam_code == 1014 || $exam_code == 1013 ||  $exam_code == 2027 || $exam_code == 1017 || $exam_code == 1019 || $exam_code == 1011 || $exam_code == 1012
                            ?>
                            ...
                            <?php if ($exam_code == 1027 || $exam_code == 1028 || $exam_code == 1029 || $exam_code == 1030) { ?> For technical support write an email to iibfexam@cscacademy.org or call on 9355932123
                              (between 09:30AM to 5:00PM)
                            <?php } ?>

                            <?php if ($exam_code == 103200) { /*$exam_code == 1003 || $exam_code == 1004 || $exam_code == 1005 || $exam_code == 1009 || $exam_code == 1006 || $exam_code == 1007 || $exam_code == 1008 || $exam_code == 1026 || $exam_code == 1029 || $exam_code == 1028 || $exam_code == 1031 || $exam_code == 1032 */ ?> 
                            ...
                            <?php 
                            // || $exam_code == 1048 || $exam_code == 1049 || $exam_code == 1050
                            if ($exam_code == 1033 || $exam_code == 1051 || $exam_code == 1043) { ?> For technical support write an email to iibfexam@cscacademy.org or call on 8956684119/9355932123 (between 09:00AM to 10:00PM)
                            <?php } ?>
                        ...
                        <?php if ($exam_code == 1001 || $exam_code == 1002 || $exam_code == 1003 || $exam_code == 1004 || $exam_code == 1005 || $exam_code == 1006 || $exam_code == 1007 || $exam_code == 1008 || $exam_code == 1009 || $exam_code == 1010 || $exam_code == 1011 || $exam_code == 1012 || $exam_code == 1013 || $exam_code == 1014 || $exam_code == 2027 || $exam_code == 1019 || $exam_code == 1020 || $exam_code == 1031 || $exam_code == 1032 || $exam_code == 1043 || $exam_code == 1048 || $exam_code == 1049 || $exam_code == 1050 || $exam_code == 1051 || $exam_code == 1058 || $exam_code == 1059 || $exam_code == 1051 || $exam_code == 1034 || $exam_code == 1048 || $exam_code == 1049 || $exam_code == 1050 || $exam_code == 1061 || $exam_code == 1062 || $exam_code == 1063 || $exam_code == 1064 || $exam_code == 1065 || $exam_code == 1066 || $exam_code == 1067 || $exam_code == 1068 || $exam_code == 1069) { ?>
                          <table cellpadding="0" cellspacing="0" width="100%" border="0" style="border-top:1px solid #198cc3; border-left:1px solid #198cc3;">
                            <tbody>
                              <tr style="background-color:#dcf1fc;">
                              ...
                              <!-- <tr style="background-color:#dcf1fc;">
                        <td style="text-align:left; padding:7px; border-bottom:1px solid #198cc3; border-right:1px solid #198cc3; font-weight:bold; color:#0000ff;">The payment reference number : <?php //echo $transaction_no; 
                                                                                                                                                                                                    ?></td>
                      </tr> -->
                            </tbody>
                          </table>
