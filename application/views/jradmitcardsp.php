            ...
            <td style="border:1px solid #1287c0; padding:5px;">
              <table cellpadding="0" cellspacing="0" width="100%" border="0" align="center">
                ...
                <tr>
                  ...
                  <?php
                  		if($exam_code == 101){
							echo "Re-Examination Admit Letter for Online CERTIFICATE EXAMINATION FOR BUSINESS CORRESPONDENTS/FACILITATORS - June 2017";
						}else{
				  ?>
                  ...
                  <?php
						...
						if($exam_code == $this->config->item('examCodeCaiib')){
							echo "Admit letter for Online CAIIB Examination – Jan 2022";
						}
						if(in_array($exam_code,$elective)){
							echo "Admit letter for Online CAIIB Electives – Jan 2022";
						}
					?>
                  ...
                  <div align="right">
                  	...
                  	<a href="<?php echo base_url();?>admitcard/jrgetadmitdashboard">Home</a> &nbsp;
                   
                  	<a href="<?php echo base_url();?>admitcard/jrgetadmitcardpdfsp/<?php echo base64_encode($exam_code)?>" style="color:#F00">Save as pdf</a>&nbsp;
            ...
            <td style="border:1px solid #1287c0; padding:5px;">
              <table cellpadding="0" cellspacing="0" width="100%" border="0" align="center">
                ...
                <tr>
                  ...
                  <?php
                  		if($exam_code == 101){
							echo "Re-Examination Admit Letter for Online CERTIFICATE EXAMINATION FOR BUSINESS CORRESPONDENTS/FACILITATORS - Jun 2017";
						}else{
				  ?>
                  ...
                  <?php
						$elective = array("62",$this->config->item('examCodeCaiibElective63'),"64","65","66","67",$this->config->item('examCodeCaiibElective68'),$this->config->item('examCodeCaiibElective69'),$this->config->item('examCodeCaiibElective70'),$this->config->item('examCodeCaiibElective71'),"72");
						if($exam_code == $this->config->item('examCodeCaiib')){
							echo "Admit letter for Online CAIIB Examination – July 2017";
						}
						if(in_array($exam_code,$elective)){
							echo "Admit letter for Online CAIIB Electives – July 2017";
						}
					?>
