...
<div style="font-weight:bold;color:#F00;">    
<div style="font-size:15px;float:left">List of Centres merged for the examination </div><a href="<?php echo base_url()?>uploads/admitcardinfo/STATUS_25th Nov_WEB NOTICE.pdf" target="_blank" ><strong>(Click here)</strong></a>
</div>
      </div>
      </div>
