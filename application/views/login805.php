         ...
         <tr>
           <td>
             <table border="0" cellpadding="0" cellspacing="0" width="80%" align="center">
               <tr>
                 <td style="text-align:center; padding:60px 0 25px; font-size:22px; font-family:Tahoma, Geneva, sans-serif; font-weight:bold; line-height:32px;">Results for Diploma / Certificate Examinations - October 2018</td>
               </tr>
               <tr>
                <td bgcolor="#6699CC">
                      ...
                      <td class="content" width="55%" bgcolor="#d8e4f1">
                        <select name="exam" id="exam" class="text1" style="min-width:218px;">
                          <option value="">Select Exam</option>
                            <option value="20_805"> CERTIFIED CREDIT PROFESSIONAL</option>
                            <option value="34_805"> ANTI-MONEY LAUNDERING AND KNOW YOUR CUSTOMER</option>
                            <option value="58_805"> CUSTOMER SERVICE & BANKING CODES AND STANDARDS</option>
                            <option value="59_805"> CERTIFIED TREASURY PROFESSIONALS</option>
                            <option value="74_805"> CERTIFICATE COURSE IN FOREIGN EXCHANGE</option>
                            <option value="81_805"> CERTIFICATE IN RISK IN FINANCIAL SERVICES LEVEL-1</option>
                            <option value="164_805">CERTIFIED ACCOUNTING & AUDIT PROFESSIONAL</option>
                        </select>
                      </td>
                    </tr>
                    <tr>
