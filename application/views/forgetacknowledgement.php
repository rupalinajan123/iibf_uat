...
<center>(An ISO 21001:2018 Certified)</center>
  ...
  <div class="login-box-body">
    ...
    <!-- <p class="login-box-msg">Password has been sent to your registered email ID.</p> -->
	<p class="login-box-msg">We have received your request for the entered member id. Kindly check your email for new password.</p>
       ...
       <!--<div class="row">
        ...
        <div class="box-footer">
                  ...
                  <a href="<?php echo base_url();?>" class="btn btn-info">Login</a>
