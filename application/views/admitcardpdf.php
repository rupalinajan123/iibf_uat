...
<html lang="en">
                  ...
                  <!--table-3--></td>
                    ...
                    <tbody>
                          ...
                          <?php if(in_array($exam_code, array(1037,1038,1046,1047))) { ?>
                            <td style="text-align:left; padding:7px; border-bottom:1px solid #198cc3; border-right:1px solid #198cc3;"><?php echo $disp_reporting_time;?></td>
													...
													<td style="text-align:left; padding:7px; border-bottom:1px solid #198cc3; border-right:1px solid #198cc3;"><?php
														if($exam_code == $this->config->item('examCodeJaiib') || $exam_code == $this->config->item('examCodeDBF') || $exam_code == $this->config->item('examCodeSOB')){ echo 'NA'; }
                            else if($exam_code == 1037 || $exam_code == 1038 || $exam_code == 1046 || $exam_code == 1047) { echo ''; }
                            else{ echo $subject->seat_identification; }														
													?></td>
								...
								<tr>
									<td style="line-height:24px; font-size:13px;"> 
										<table width="100%" >
											...
											<?php /*<td style="text-align:right;width:50%;" align="right">
                      ...
                      <?php if($exam_code == 1037 || $exam_code == 1038 || $exam_code == 1046 || $exam_code == 1047)
												{   ?>
                        <tr>
                          <td style="text-align:left; padding:7px 0; width:260px; vertical-align:top; line-height:18px; font-size:12px;">*Seat No. will be allotted at examination hall</td>
                          <td style="text-align:right; padding:7px 0; vertical-align:top; line-height:18px; font-size:12px;">@ No candidate/s will be permitted to enter the Examination Venue / hall after the gate closing time for any reason whatsoever.” The exam/reporting time details are shared below</td>
												</tr>
												
                        <tr>
                          <td colspan="2" style="text-align:left; padding:0px 0 3px 0; line-height:18px; font-size:13px;"><strong>#Candidates are advised to check Institute's Website, a day before the Examination Date, for any Information / Notice or Change in Examination Venue.</strong></td>
												</tr>
											<?php } ?>											
										</table>
									</td>
                    ...
                    <tbody>
                      <?php foreach($recordsp as $recordsp){?>
								...
								<tr>
									<td style="padding:8px 0;"><?php if($exam_code == 101  || $exam_code == 1037 || $exam_code == 1038 || $exam_code == 1046 || $exam_code == 1047 || $exam_code == 1010 || $exam_code == 10100 || $exam_code == 101000 || $exam_code == 1010000 || $exam_code == 10100000){?>
    ...
    <?php if($exam_code == 1037 || $exam_code == 1038 || $exam_code == 1046 || $exam_code == 1047) {  ?>
      ...
      <?php /* <table cellpadding="0" cellspacing="0" width="800" border="0" align="center" style="background-color:#fff;">
				<tr>
				<td style="background-color:#7fd1ea; color:#fff; text-align:center; font-weight:bold; font-size:13px; padding:7px 0; text-transform:uppercase;">IMPORTANT INSTRUCTIONS FOR CANDIDATES</td>
				</tr>
				<tr>
    ...
    <p style="margin:5px 0 0 0; font-size:8px;">gen.on.<?php echo date('dmY:H:i:s'); ?></p>
	</body>
</html>