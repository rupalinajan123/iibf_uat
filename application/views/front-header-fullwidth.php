...
<div class="wrapper">
  <header class="main-header">
    ...
    <div class="login-logo"><a>INDIAN INSTITUTE OF BANKING &amp; FINANCE<br><small>(ISO 21001:2018 Certified)</small></a></div>
      <?php 
	
	  if($this->router->fetch_class()!='nonreg' && $this->router->fetch_class()!='SplexamNM' && $this->router->fetch_class()!='Dbfuser' && $this->router->fetch_class()!='Nonreg' && $this->router->fetch_class()!='DupCert' && $this->router->fetch_class()!='Register' && $this->router->fetch_class()!='register' && $this->router->fetch_class()!='Cpd' && $this->router->fetch_class()!='DraRegister' && $this->router->fetch_class()!='Dbftojaiib')
	  {
      ...
      <?php }
       ...
       <div class="loading" style="display:none;" id="page_loader"><img src="<?php echo base_url(); ?>assets/images/loading.gif"></div>