      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info" style=" border: solid 1px #000;">
			...
			format with 0.25" margin from all sides <a href="javascript:void(0);" class="linkfooter" style="color:#000" onclick="javascript:printDiv_DBF();">(Click to Print)</a>
		</span>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
	   ...
	   $useradd=$finalstr1.$finalstr2;
        ...
        <div class="col-sm-5">
        <?php echo date('d-m-Y h:i:s A',strtotime($applied_exam_info[0]['created_on']));?>
        </div>
        </div>
                </div>
                <div class="col-sm-3">
...
<div style=" background:#000; width:100%; height:1px; margin-bottom:10px;"></div>
	<table width="100%" cellspacing="2" cellpadding="2" border="0" align="center"  style=" position:relative;" class="tablecontent2" >
			...
			<img src="<?php echo base_url();?><?php echo get_img_name($this->session->userdata('dbregnumber'),'p');?>" height="100" width="100" style=" position:absolute; right:15px; top:0px;" >
			</td>
		</tr>
		...
		<tr>
			...
			<td colspan="3" class="tablecontent2" nowrap="nowrap">
				<?php echo date('d-m-Y h:i:s A',strtotime($applied_exam_info[0]['created_on']));?>		</td>
		</tr>
