...
<label for="text" class="col-md-6">Type the exact characters you see in the picture <span class="red">*</span>.</label>
      ...
      <ul>
        ...
        <li><a class="disability forget" href="<?php echo base_url()?>Dbfuser/forgotpassword/">Forgot Password/Get password Click Here</a></li>
		<li><a class="disability forget" href="<?php echo base_url()?>Dbfuser/member/?Mtype=<?php echo $this->input->get('Mtype');?>&ExId=<?php echo $this->input->get('ExId');?>">
