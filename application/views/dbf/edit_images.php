  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      DB&F Membership Registration Edit Page 
      </h1>
      <!--<ol class="breadcrumb">
    ...
    action="<?php echo base_url()?>Dbf/editimages/">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
 		...
 		<div class="box box-info">
           ...
           <!-- <a href="<?php //echo base_url();?>Dbf/profile/">Back</a>-->
            </div>
            </div>
          <div class="box-body">
           ...
           <?php 
			...
			{?>
   	      		   <img src="<?php echo base_url();?><?php echo get_img_name($this->session->userdata('dbregnumber'),'s');?>" height="100" width="100">
			<?php 
            }
            else
            {?>
         ...
         <?php 
			...
			{?>
            		<img src="<?php echo base_url();?><?php echo get_img_name($this->session->userdata('dbregnumber'),'pr');?>"  height="100" width="100">
            <?php 
            }
            else
            {?>
           ...
           <?php 
			if(!is_file(get_img_name($this->session->userdata('dbregnumber'),'p')))
			{ //// priyanka d - 28-dec-22 - added this condition to skip if image already uploaded
        ?>
