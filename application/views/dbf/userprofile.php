  ...
  <div class="content-wrapper">
	...
	<form class="form-horizontal" name="NMProfile" id="NMProfile"  method="post"  enctype="multipart/form-data" action="<?php echo base_url();?>Dbf/profile/">
   <input type="hidden" name="regid" id="regid" value="<?php echo $this->session->userdata('dbregid');?>"> 
    <input type="hidden" name="sel_doj" id="sel_doj" value="">
     <input type="hidden" name="doj1" id="doj1" value="">
               ...
               <?php 
                ...
                <label for="roleid" class="col-sm-3 control-label">Name as to appear on Card</label>
                    ...
                    <?php 
					  ...
					  {?>
                          <input type="text" class="form-control" id="nameoncard" name="nameoncard" placeholder="Name as to appear on Card" required 
                          value="<?php echo $user_info[0]['displayname'];?>"  data-parsley-maxlength="35" >
                          <input type="hidden" name="hidd_nameoncard" id="hidd_nameoncard" value="<?php echo $user_info[0]['displayname'];?>">
                      <?php 
					  }
					  else
					  {
							echo $user_info[0]['displayname'];	?> 
							<input type="hidden" name="nameoncard" id="nameoncard" value="<?php echo $user_info[0]['displayname'];?>">
                             <input type="hidden" name="hidd_nameoncard" id="hidd_nameoncard" value="<?php echo $user_info[0]['displayname'];?>">
						<?php 
						}?>
                      <span class="error"><?php //echo form_error('lastname');?></span>
...
<div class="box-header with-border">
              ...
              <div class="form-group">
                <label for="roleid" class="col-sm-3 control-label">State <span style="color:#F00">*</span></label>
                    ...
                    <select class="form-control" id="state" name="state" required >
                     ...
                     <div class="col-sm-2">
                     <input class="form-control" id="pincode" name="pincode" placeholder="Pincode/Zipcode" required="" value="<?php echo $user_info[0]['pincode'];?>" data-parsley-maxlength="6" maxlength="6" size="6" data-parsley-dbfeditcheckpin data-parsley-type="number" autocomplete="off" type="text" data-parsley-trigger-after-failure="focusout">
               ...
               <?php 
                ...
                <?php 
                 ...
                 <input type="hidden" name="" id="gender_hidd" value="<?php echo $user_info[0]['gender'];?>">
                
                  <div class="form-group">
                <label for="roleid" class="col-sm-3 control-label">Qualification <span style="color:#F00">*</span></label>
                	<div class="col-sm-4">
                      <input type="radio" class="minimal" id="U"   name="optedu"  value="U" <?php if($user_info[0]['qualification']=='U'){echo  'checked="checked"';}?>                      onclick="changedu(this.value)" <?php echo set_radio('optedu', 'U'); ?>>
                        Under Graduate
           ...
           <div class="col-sm-5"  <?php if($user_info[0]['qualification']=='G'){echo 'style="display:block"';}else{echo 'style="display:none"';}?> id="GR">
            ...
            <div class="col-sm-5"  <?php if($user_info[0]['qualification']=='P'){echo 'style="display:block"';}else{echo 'style="display:none"';}?>id="PG">
                ...
                <label for="roleid" class="col-sm-3 control-label">Email <span style="color:#F00">*</span></label>
                	<div class="col-sm-5">
                    <input class="form-control" id="email" name="email" placeholder="Email" data-parsley-type="email" value="<?php echo $user_info[0]['email'];?>" data-parsley-maxlength="45" required="" data-parsley-dbfeditemailcheck  autocomplete="off" type="text" data-parsley-trigger-after-failure="focusout">
                ...
                <?php 
                /* --------------------- EMAIL VERIFCATION CODE BY POOJA MANE ON : 2024-11-21---------------------*/
                ...
                <label for="roleid" class="col-sm-3 control-label">Mobile <span style="color:#F00">*</span></label>
                	<div class="col-sm-5">
                      <input type="tel" class="form-control" id="mobile" name="mobile" placeholder="Mobile" data-parsley-type="number"  data-parsley-minlength="10" data-parsley-maxlength="12"  value="<?php echo $user_info[0]['mobile'];?>"  data-parsley-dbfeditmobilecheck data-parsley-trigger-after-failure="focusout" required>
                      <input type="hidden" name="" id="mobile_hidd" value="<?php echo $user_info[0]['mobile'];?>">
                      <span class="error"><?php //echo form_error('mobile');?></span>
                    </div>
                </div>  */?>

                <?php /* --------------------- Mobile VERIFCATION CODE BY POOJA MANE ON : 2024-11-21---------------------*/ ?>
              ...
              <?php /* --------------------- EMAIL VERIFCATION CODE BY POOJA MANE ON : 2024-11-21---------------------*/ ?>
                ...
                <label for="roleid" class="col-sm-3 control-label">Aadhar Card Number<!--<span style="color:#F00">*</span>--></label>
					...
					{?>
                         ...
                         required value="<?php echo $user_info[0]['aadhar_card'];?>" data-parsley-minlength="12" data-parsley-maxlength="12" data-parsley-type="number" size="12" data-parsley-trigger-after-failure="focusout">
					...
					<input type="text" class="form-control " id="aadhar_card"  name="aadhar_card" placeholder="Aadhar Card Number" 
                       value="<?php echo $user_info[0]['aadhar_card'];?>" data-parsley-minlength="12" data-parsley-maxlength="12" data-parsley-type="number" size="12" data-parsley-trigger-after-failure="focusout">
			  ...
			  <div class="col-sm-5">
               ...
               <?php 
				...
				$kyc_info = $this->master_model->getRecords('member_kyc', array('regnumber' => $this->session->userdata('dbregnumber')));
				
			    if(is_file(get_img_name($this->session->userdata('dbregnumber'),'p')))
				{?>
                	<img src="<?php echo base_url();?><?php echo get_img_name($this->session->userdata('dbregnumber'),'p');?><?php echo '?'.time(); ?>" height="100" width="100" >
               <?php 
               ...
               <label for="roleid" class="col-sm-3 control-label">
                <?php 
				if(is_file(get_img_name($this->session->userdata('dbregnumber'),'s')))
				{?>
               <img src="<?php echo base_url();?><?php echo get_img_name($this->session->userdata('dbregnumber'),'s');?><?php echo '?'.time(); ?>" height="100" width="100">
               <?php 
				}
				else if(count($kyc_info) > 0)
				{
                ...
                <label for="roleid" class="col-sm-3 control-label">
                 <?php
                if(is_file(get_img_name($this->session->userdata('dbregnumber'),'pr')))
				{?>
                <img src="<?php echo base_url();?><?php echo get_img_name($this->session->userdata('dbregnumber'),'pr');?><?php echo '?'.time(); ?>"  height="100" width="100">
                 <?php 
				}else if(count($kyc_info) > 0)
				{
		 ...
		 /*if(!file_exists('./uploads/photograph/'.$user_info[0]['scannedphoto']) || !file_exists('./uploads/scansignature/'.$user_info[0]['scannedsignaturephoto']) || !file_exists('./uploads/idproof/'.$user_info[0]['idproofphoto']) ||$user_info[0]['scannedphoto']=='' || $user_info[0]['scannedsignaturephoto']=='' ||  $user_info[0]['idproofphoto']=='')
			...
			{?>
            		<label for="roleid" class="col-sm-3 control-label"><a href="<?php echo base_url();?>Dbf/editimages/">Edit Images</a></label>
        	<?php 
			}?>
            
             <input type="hidden" name="scannedphoto1_hidd" id="scannedphoto1_hidd" value="<?php echo get_actual_img_name($this->session->userdata('dbregnumber'),'p');?>">
            <input type="hidden" name="scannedsignaturephoto1_hidd" id="scannedsignaturephoto1_hidd" value="<?php echo get_actual_img_name($this->session->userdata('dbregnumber'),'s');?>">
            <input type="hidden" name="idproofphoto1_hidd" id="idproofphoto1_hidd" value="<?php echo get_actual_img_name($this->session->userdata('dbregnumber'),'pr');?>">
            </div>
		   ...
		   ?>
              ...
              <div class="box-footer">
                  <div class="col-sm-2 col-xs-offset-5">
                   <input type="submit" class="btn btn-info" name="btnSubmit" id="btnSubmit" value="Save" onclick="javascript:return checkEditDBF();">
	              </div>
           </div>
...
<script>
  ...
  function send_verify_otp_mobile(type,data,selector) {
    $.ajax({
      type : 'POST',
      url  : site_url + 'Dbf/send_otp_mobile/',
