...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1 class="register">
      Examination Application(Registration) for DB&F candidates. <br/>
...
Note:  Do not upload your Credit Card/Debit Card scanned image with the application.
    ...
    <section class="content">
      <div class="row">
        <div class="col-md-12">
          <!-- Horizontal Form -->
          Pl note that Members of the Institute are not eligible for  this Examination.   Non-members who are registering for this Examination first time will be provided with a Registration Number and  the same Registration Number  can be used  for re-registering for the examination if required.  This Registration Number cannot be used for registering any other examinations. Already Registered candidates has to apply for examinations by login using their USER ID and PASSWORD already provided - <a href=<?php echo base_url();?>nonmem><span style="color:#090">Click here for Login</span></a><br/>
               ...
               <div class="form-group">
                ...
                <label for="roleid" class="col-sm-3 control-label">Last Name</label>
                	<div class="col-sm-5">
                      ...
                      <span class="error" id="lastname_error"><?php //echo form_error('lastname');?></span>
                    </div>(Max 30 Characters) 
                </div>
                ...
                <label for="roleid" class="col-sm-3 control-label">Name as to appear on Card <span style="color:#F00">*</span></label>
                	<div class="col-sm-5">
                      <input type="text" class="form-control" id="nameoncard" name="nameoncard" placeholder="Name as to appear on Card" required value="<?php echo set_value('nameoncard');?>"  data-parsley-maxlength="35" >
                      <span class="error"><?php //echo form_error('nameoncard');?></span>
                    </div>(Max 35 Characters) 
                </div>-->
                  <input type="hidden" class="form-control" id="nameoncard" name="nameoncard" placeholder="Name as to appear on Card" required value="<?php echo set_value('nameoncard');?>"  data-parsley-maxlength="35" >
...
<div class="box-header with-border nobg">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <label for="roleid" class="col-sm-3 control-label">Date of Birth <span style="color:#f00">*</span></label>
                    ...
                    <div class="col-sm-4 example">
                        ...
                        <?php 
							...
							$max_year = date('Y', strtotime("- 69 year"));
						?>
                ...
                <label for="roleid" class="col-sm-3 control-label">Qualification <span style="color:#f00">*</span></label>
                 ...
                 <?php //echo '<pre>';print_r($undergraduate); print_r($graduate); echo count($undergraduate);?>
                <div class="form-group">
			  ...
			  {echo 'style="display:block"';}?>  id="edu">
                ...
                <label for="roleid" class="col-sm-3 control-label">Email <span style="color:#f00">*</span></label>
                	<div class="col-sm-6 email">
                      <input type="text" class="form-control" id="email" name="email" placeholder="Email"  data-parsley-type="email" value="<?php echo set_value('email');?>"  required  data-parsley-dbfemailcheck  data-parsley-trigger-after-failure="focusout"/>(Correct/Active E-mail address is mandatory for receipt of Admit Letter and other communication/s through e-mail)
                      <span class="error"><?php //echo form_error('email');?></span>
                    </div>
                </div>  */?>

              <?php /*--- Function added by pooja mane for mobile & email OTP verification 2024-11-20--*/ ?>
							...
							<?php /*--- Function end by pooja mane for mobile & email OTP verification 2024-11-20--*/ ?>
			  ...
			  <div class="form-group" id="other_collage_institute_div" style="display:none;">
                ...
                <label for="roleid" class="col-sm-3 control-label">Phone </label>
                	<div class="col-sm-4">
                      ...
                      <input type="text" class="form-control" id="stdcode"  name="stdcode" placeholder="STD Code"  value="<?php echo set_value('stdcode');?>" style="width:55%;"  data-parsley-type="number" data-parsley-maxlength="4"  data-parsley-trigger-after-failure="focusout">
                    ...
                    <label for="roleid" class="col-sm-4 control-label" style="padding-left:0; text-align:left; padding-right:10px;">Phone No</label>
                      ...
                      data-parsley-type="number" data-parsley-maxlength="12"    value="<?php echo set_value('phone');?>" style="width:65%;" >
                ...
                <label for="roleid" class="col-sm-3 control-label">Mobile <span style="color:#f00">*</span></label>
                	<div class="col-sm-5">
                      <input type="tel" class="form-control" id="mobile" name="mobile" placeholder="Mobile" data-parsley-type="number"  data-parsley-minlength="10" data-parsley-maxlength="12"  value="<?php echo set_value('mobile');?>"  data-parsley-dbfmobilecheck required data-parsley-trigger-after-failure="focusout">
                ...
                <label for="roleid" class="col-sm-3 control-label">Aadhar Card Number <!--<span style="color:#f00">*</span>--></label>
                	<div class="col-sm-5">
                      <?php /*?> <input type="text" class="form-control " id="aadhar_card"  name="aadhar_card" placeholder="Aadhar Card Number" 
                       required value="<?php echo set_value('aadhar_card');?>"  data-parsley-minlength="12" data-parsley-maxlength="12" data-parsley-type="number" size="12" data-parsley-trigger-after-failure="focusout">
                    ...
                    <input type="text" class="form-control " id="aadhar_card"  name="aadhar_card" placeholder="Aadhar Card Number" 
                        value="<?php echo set_value('aadhar_card');?>"  data-parsley-minlength="12" data-parsley-maxlength="12" data-parsley-type="number" size="12" data-parsley-trigger-after-failure="focusout">
                      ...
                      <?php if(count($idtype_master) > 0)
						{
						   ...
						   <?php if(set_value('idproof')){echo set_radio('idproof', $idrow['id'], TRUE);}else{if($i==1){echo 'checked="checked"';}}?>><?php echo $idrow['name'];?><br>
					   <?php 
					   $i++;}
					   }?>	
                ...
                <label for="roleid" class="col-sm-3 control-label">ID No. <span style="color:#f00">*</span></label>
                	<div class="col-sm-5">
                       <input type="text" class="form-control " id="idNo"  name="idNo" placeholder="ID No." required value="<?php echo set_value('idNo');?>"  data-parsley-pattern="/^[a-zA-Z0-9][a-zA-Z0-9 ]+$/" data-parsley-maxlength="25">(Max 25 Characters)
                      <span class="error"><?php //echo form_error('idNo');?></span>
                    </div>
                </div>
                ...
                <label for="roleid" class="col-sm-3 control-label">Upload your id proof <span style="color:#f00">**</span></label>
                 ...
                 <input type="hidden" name="optnletter" value="optnletter">
                <!--<div class="form-group">
                ...
                <label for="roleid" class="col-sm-1 control-label"> Note</label>
                	<div class="col-sm-9">
                    1. Pl ensure all images are clear, visible and readable after uploading, if not do  not submit and upload fresh set of images.
        ...
        <div class="box box-info">
          ...
          <h3 class="box-title">Exam Details:</h3>
           ...
           <!-- <input type='hidden' name='mtype' id='mtype' value="<?php //echo $this->input->get('Mtype');?>"-->
            ...
            <div class="box-body">
               ...
               <input type="hidden" name="elearning_flag" id="elearning_flag_Y" value="N" >
				 ...
				 <?php if(in_array($examinfo['0']['exam_code'],$this->config->item('skippedAdmitCardForExams')))  { ?>
                            <div class="form-group" >
								<label for="roleid" class="col-sm-3 control-label"><b>Eligible Subject<span style="color:#F00">*</span></b></label>
								<div class="col-sm-1">&nbsp;</div>
								<div class="col-sm-3"><b>Exam Date</b></div>
				   ...
				   if(count($compulsory_subjects) > 0)
				   {
					   ...
					   {?>
                            ...
                            <div class="form-group" >
                                ...
                                <?php echo date('d-m-Y',strtotime($subject['exam_date'])) ?>
                                </div>
							</div>	
							<?php } ?>
							<div class="form-group" <?php if(in_array($examinfo['0']['exam_code'],$this->config->item('skippedAdmitCardForExams'))) echo'NOT IN WORK style="display:none;"'?>>
                          	  <label for="roleid" class="col-sm-3 control-label"><?php echo $subject['subject_description']?><span style="color:#F00">*</span></label>
                                <div class="col-sm-2">
			...
			<br />
			<div>PWD CANDIDATES WHO WOULD USE SCRIBE FACILITY DURING THE EXAMINATIONS ARE REQUESTED TO REFER TO THE GUIDELINES GIVEN IN THE WEBSITE UNDER THE TAB. GET DETAILS > <a href="http://www.iibf.org.in/documents/Scribe_Guideliness_R-150219.pdf" target="_blank" >SCRIBE GUIDELINES</a></div><br />
			</div>
        ...
        <div class="box box-info">
            ...
            <div class="box-body">
                ...
                <label for="roleid" class="col-sm-2 control-label"> </label>
                	<div class="col-sm-12">
                    <ol>
                   <li> 	I declare that I have submitted my Aadhar Card Number and Proof of my  Identity : Driving License/ID Card issued by Employer / Pan Card / Passport  as specified above.
		</li>
        ...
        <li>I hereby declare that all the information given in this application is true, complete and correct. I understand that in the event of any information being found false or incorrect subsequent to allotment of registration No, my registration No is liable to be cancelled / terminated.
		</li>
		...
		<li>
		 I confirm having read and understood the rules and regulations of the Institute and I hereby agree to abide by the same. In case I am desirous of Instituting any legal proceedings against the Institute I hereby agree that such legal proceedings shall be instituted only in courts at Mumbai, New Delhi, Kolkata and Chennai in whose Jurisdiction Zonal office/s of the Institute is situated and my application thereto pertains and not in any other court.</li>
        </ol>
                    </div>
                </div>
             ...
             <div class="form-group m_t_15">
              ...
              <div class="box-footer">
                  <div class="col-sm-6 col-sm-offset-3">
                     <a href="javascript:void(0);" class="btn btn-info"onclick="javascript:return dbf_mem_checkform();" id="preview">Preview and Proceed for Payment</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <!-- <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="dbf_mem_preview();">Confirm</button>-->
           <input type="submit" name="btnSubmit" class="btn btn-primary" onclick="dbf_mem_preview()"  id="btnSubmit" value="Confirm">
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div>
...
<script>
	...
	$(document).ready(function() 
	{
		...
		var signature_image=document.getElementById('scannedphoto');
	...
	}); //priyanka d >> 01-aug-23 >> added for dbf
	...
	$(".el_sub_prop").click(function(){
		...
		var el_subject_cnt =  $('.show_el_subject :input[type="checkbox"]:checked').length;
		var datastring_1='subject_cnt='+el_subject_cnt;
		//alert(site_url+'Dbfuser/set_jaiib_elsub_cnt/',);
		$.ajax({
				url:site_url+'Dbfuser/setdbf/',
				data: datastring_1,
				type:'POST',
...
$(function(){
    ...
    $.ajax({
 		type: 'POST',
 		url: site_url+'Dbfuser/generatecaptchaajax/',
...
$('#myModal1').modal('hide');
 ...
 var base_url = '<?php echo base_url();?>'
   function getsub_menue(deptid)
   {
   			$.ajax({
   		type:"POST",
   		url: base_url+"Dbfuser/getsub_menue",
   		data:{deptid:deptid},
   		success:function(data){
   			if(data != "")
   			{   
...
<script type="text/javascript">
	/*--- Function added by pooja mane for mobile & email OTP verification 2024-11-20--*/
	...
	function send_verify_otp_mobile(type,data,selector) {
		$.ajax({
			type : 'POST',
			url  : site_url + 'Dbfuser/send_otp_mobile/',
