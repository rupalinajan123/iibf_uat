...
.img{ width:100%; height:auto; padding:15px;}
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      DB&F Membership Registration Print Page 
      </h1>
      <!--<ol class="breadcrumb">
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info" style=" border: solid 1px #000;">
			...
			format with 0.25" margin from all sides <a href="javascript:void(0);" class="linkfooter" style="color:#000" onclick="javascript:printDiv_DBFMem();">(Click to Print)</a>
		</span>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
        ...
        <div class="col-sm-5">
        <img src="<?php echo base_url();?>uploads/idproof/<?php echo $user_info[0]['idproofphoto'];?><?php echo '?'.time(); ?>"  height="180" width="100">
        </div>
        </div>
        ...
        <div class="col-sm-5">
  		<img src="<?php echo base_url();?>uploads/scansignature/<?php echo $user_info[0]['scannedsignaturephoto'];?><?php echo '?'.time(); ?>" height="100" width="100">
        </div>
        </div>
        ...
        <?php echo date('d-m-Y h:i:s A',strtotime($user_info[0]['createdon']));?>
                ...
                <div class="col-sm-3">
                	...
                	<label for="roleid" class="col-sm-3 control-label"><img src="<?php echo base_url();?>uploads/photograph/<?php echo $user_info[0]['scannedphoto'];?><?php echo '?'.time(); ?>" height="100" width="100" ></label>
...
<div style=" background:#000; width:100%; height:1px; margin-bottom:10px;"></div>
	<table width="100%" cellspacing="2" cellpadding="2" border="0" align="center"  style=" position:relative;" class="tablecontent2" >
			...
			<img src="<?php echo base_url();?>uploads/photograph/<?php echo $user_info[0]['scannedphoto'];?>" height="100" width="100" style=" position:absolute; right:15px; top:0px;" >
			</td>
		</tr>
				<tr>
		...
		<tr>
			<td class="tablecontent2">ID Proof :</td>
			<td colspan="3" class="tablecontent2" nowrap="nowrap">  <img src="<?php echo base_url();?>uploads/idproof/<?php echo $user_info[0]['idproofphoto'];?>"  height="180" width="100"></td>
		</tr>

		<tr>
			<td class="tablecontent2">Signature :</td>
			<td colspan="3" class="tablecontent2" nowrap="nowrap"><img src="<?php echo base_url();?>uploads/scansignature/<?php echo $user_info[0]['scannedsignaturephoto'];?>" height="100" width="100"></td>
		</tr>
...
<script>
function printDiv_DBFMem(divName) {
