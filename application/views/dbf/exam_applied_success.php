  ...
  <div class="content-wrapper">
	...
	<form class="form-horizontal" name="member_exam_comApplication" id="member_exam_comApplication"  method="post"  enctype="multipart/form-data" action="<?php echo base_url();?>Dbf/Msuccess/">
                ...
                <?php if($payment_info[0]['status']=='1')
				{
					...
					?>
                        <div style="text-align:left">
                            <a href="<?php echo base_url()?>Dbf/exampdf/">Save as pdf</a> &nbsp; &nbsp;
                            
                          <a href="javascript:void(0);" onclick="print_exam_dbf_preview()">Continue</a>&nbsp; &nbsp;
                          <!-- <?php if($admit_card_details[0]['admitcard_image'] != ''){ ?>  priyanka d >> 16-jan 25 >>skippedAdmitCardForExams 
