...
<!-- Content Header (Page header) -->
<h1>Please go through the given detail, correction may be made if necessary.
...
<form class="form-horizontal" name="usersAddForm" id="usersAddForm"  method="post"  enctype="multipart/form-data" 
    action="<?php echo base_url()?>Dbfuser/addmember/">
        ...
        <div class="box box-info">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-2"> <?php echo date('d-m-Y',strtotime($this->session->userdata['enduserinfo']['dob']));?> </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-2"> Phone No : <?php echo $this->session->userdata['enduserinfo']['phone'];?> </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-5"> <?php echo $this->session->userdata['enduserinfo']['idNo'];?> </div>
            </div>
        ...
        <div class="box box-info">
          ...
          <div class="box-body">
            ...
            <div class="form-group grayDiv">
              <label for="roleid" class="col-sm-3 text-center"><strong class="black_clr">Eligible Subject</strong></label>
              <?php
                   if(!in_array(($this->session->userdata['enduserinfo']['excd']),$skipped_admitcard_examcodes))  { ?>
              <label for="roleid" class="col-sm-4 text-center"><strong class="black_clr">Venue</strong></label>
              <?php } ?>
              <label for="roleid" class="col-sm-2 text-center"><strong class="black_clr">Exam Date</strong></label>
              <?php
                 if(!in_array(($this->session->userdata['enduserinfo']['excd']),$skipped_admitcard_examcodes))  { ?>           
                    <label for="roleid" class="col-sm-3 text-center"><strong class="black_clr">Time</strong></label>
              <?php } ?>
            </div>
            <br />
            <?php 
				   if(count($compulsory_subjects) > 0)
				   {
					   ...
					   foreach($compulsory_subjects as $k=>$v)
					   {
						...
						$venue_add_finalstring= preg_replace('#[\s]+#', ',', $venue_add);
            ...
            <div class="form-group borderDiv">
              ...
              <?php
                   if(!in_array(($this->session->userdata['enduserinfo']['excd']),$skipped_admitcard_examcodes))  { ?>
              <span for="roleid" class="col-sm-4 text-center"><?php echo $venue_add_finalstring; ?></span>
              <?php } ?>
              <span for="roleid" class="col-sm-2 text-center" style="text-align: right"><?php echo date('d-M-Y',strtotime($v['date']));?></span>
              <?php
                   if(!in_array(($this->session->userdata['enduserinfo']['excd']),$skipped_admitcard_examcodes))  { ?>
              <span for="roleid" class="col-sm-2 text-center" style="text-align: right"><?php echo $v['session_time']; ?></span>
              <?php } ?>
            </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5 "> <?php echo $this->session->userdata['enduserinfo']['fee'];?>
              <div id="error_dob"></div>
              <br>
              <div id="error_dob_size"></div>
              <span class="dob_proof_text" style="display:none;"></span> <span class="error">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-5 ">
              <?php 
                    //$month = date('Y')."-".substr($this->session->userdata['enduserinfo']['eprid'],4)."-".date('d');
          ...
          <div class="form-group">
            ...
            <div class="col-sm-2"> <?php echo $this->session->userdata['enduserinfo']['txtCenterCode'];?> </div>
          </div>
          <div class="form-group">
              ...
              <?php //echo form_error('gender');?>
          	 ...
          	 <?php /*?><div class="form-group">
                    <label for="roleid" class="col-sm-3 control-label">Are you a person with benchmark disability of 40% or above (PwBD)</label>
                        <div class="col-sm-3">
                         <?php 
						 if($this->session->userdata['enduserinfo']['scribe_flag_d']=='Y')
						 {
							echo 'Yes';
						}
						else
					...
					<?php if($this->session->userdata['enduserinfo']['disability_value']!='')
					{?>
					<div class="form-group">
                    <label for="roleid" class="col-sm-3 control-label">Type of Disability </label>
                        ...
                        <div class="col-sm-6">
						 ...
						 if(!empty($disability_value))
						 {
						  ...
						  {
						  if($this->session->userdata['enduserinfo']['disability_value']==$value['code'])
						  {
					...
					<?php }
						if($this->session->userdata['enduserinfo']['Sub_menue_disability']!='')
					{?>
					<div class="form-group">
                    <label for="roleid" class="col-sm-3 control-label">Sub Type of Disability</label>
                        ...
                        <div class="col-sm-6">
						 ...
						 if(!empty($scribe_sub_disability))
						 {
						  ...
						  {
						  if($this->session->userdata['enduserinfo']['Sub_menue_disability']==$value['sub_code'])
						  {
