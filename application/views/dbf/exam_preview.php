...
<div class="content-wrapper"> 
  ...
  <?php
        ...
        {	$function = "Msuccess";	}
    ?>
  <form class="form-horizontal" name="member_exam_comApplication" id="member_exam_comApplication"  method="post"  enctype="multipart/form-data" action="<?php echo base_url();?>Dbf/<?php echo $function;?>/">
          ...
          <div class="box box-info">
            ...
            <div class="form-group col-md-2">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5"> <?php echo $this->session->userdata['examinfo']['mobile'];?> <span class="error">
                  <?php //echo form_error('mobile');?>
                  </span> </div>
              </div>
              <div class="form-group">
                <label for="roleid" class="col-sm-3 control-label">Email :</label>
                <div class="col-sm-5"> <?php echo $this->session->userdata['examinfo']['email'];?><br>
              ...
              <div class="form-group">
                <label for="roleid" class="col-sm-3 control-label">College/Educational Institute you belong to :</label>
                <div class="col-sm-5"> <?php if($this->session->userdata['examinfo']['collage_institute']=='Others') echo $this->session->userdata['examinfo']['other_collage_institute']; else echo $this->session->userdata['examinfo']['collage_institute'];?><br>
                  <!--(For correction/updation of your Email id and Mobile no., use your Edit Profile available under Member Login.)--> 
                  <span class="error">
                  <?php //echo form_error('email');?>
                  </span> </div>
          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              ...
              <div class="form-group grayDiv">
                <label for="roleid" class="col-sm-3 control-label"><strong class="black_clr">Eligible Subject</strong></label>
                <?php
                ...
                <?php } ?>
                <div class="col-sm-2 text-center"> Exam Date </div>
                <?php
              ...
              <?php 
                ...
                $venue_add_finalstring= preg_replace('#[\s]+#', ',', $venue_add);
                  ...
                  ?>
                    ...
                    if(!in_array(base64_decode($this->session->userdata['examinfo']['excd']),$skipped_admitcard_examcodes))  { ?>
                    <div class="col-sm-2 text-center"> <?php echo $v['session_time'];?></div>
                    <?php } ?>
                  </div>
                  <?php 
            }
					}?>
                    <div class="col-sm-12 "></div><!-- priyanka d >> 6-jan-25 skipped_admitcard_examcodes -->
              <!-- Close Exam Details --> 
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5 "> <?php echo $this->session->userdata['examinfo']['fee'];?>
                  <div id="error_dob"></div>
                </div>
              </div>
              <div class="form-group">
			...
			<!-- Benchmark Disability Code Close -->
             ...
             <div class="form-group">
                <div class="col-sm-12">
                  ...
                  <!--B) Since the Institute will not be sending the Admit Letter(hard copy) through post, Correct E-mail address is mandatory for receipt of Admit Letter/Hall Ticket through e-mail. --><span class="error">
                  <?php //echo form_error('gender');?>
                  </span> </div>
              </div>
              <div class="box-footer">
                <div class="col-sm-4 col-xs-offset-3"> 
                  ...
                  <!--  <input type="submit" class="btn btn-info" name="btnPreview" id="btnPreview" value="Pay Online" onclick="javascript:return validate();">--> 
				   ...
				   <a href="<?php echo base_url();?>Dbf/comApplication<?php if($this->session->userdata['examinfo']['optval']!='') echo '?optval='.$this->session->userdata['examinfo']['optval']; ?>" class="btn btn-info" id="preview">Back</a> 
