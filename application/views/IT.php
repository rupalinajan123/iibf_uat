         ...
         <tr>
           <td>
             <table border="0" cellpadding="0" cellspacing="0" width="80%" align="center">
               <tr>
                 <td style="text-align:center; padding:60px 0 25px; font-size:22px; font-family:Tahoma, Geneva, sans-serif; font-weight:bold; line-height:32px;">Results for IT Examination MAY 2017</td>
               </tr>
               <tr>
                <td bgcolor="#6699CC">
                    ...
                    <tr>
                      ...
                      <td class="content" width="55%" bgcolor="#d8e4f1">
                        <select name="exam" id="exam" class="text1" style="min-width:218px;">
                          ...
                          <option value="24_117">CERTIFICATION IN CARD OPERATIONS(FOR EMPLOYEES OF I.T. AND BPO COMPANIES)</option>
                          <option value="25_117">CERTIFICATION IN FUNCTIONS OF BANKS(FOR EMPLOYEES OF I.T. AND BPO COMPANIES)</option>
                          <option value="26_117">CERTIFICATION IN BASICS OF BANKING(FOR EMPLOYEES OF I.T. AND BPO COMPANIES)</option>
                        </select>
                      </td>
                    </tr>
                    <tr>
