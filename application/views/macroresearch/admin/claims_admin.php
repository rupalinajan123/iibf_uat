				...
				<div class="wrapper wrapper-content animated fadeInRight">
                  ...
                  <form method="POST" id="search_form" class="search_form_common_all" action="javascript:void(0)" autocomplete="off">
                    ...
                    <div class="form-group text-left">
                      <select class="form-control search_opt" name="paid_status" id="paid_status" >
                    ...
                    <div class="form-group" style="width:auto;">
                      ...
                      <button type="button" class="btn btn-danger" onclick="clear_search()">Clear</button>
											<button type="button" class="btn btn-sm btn-warning" onclick="export_to_csv()"><i class="fa fa-solid fa-file"></i></button>
                    </div>
                  </form>
										...
										<table class="table table-bordered table-hover dataTables-example" style="width:100%">
											<thead>
												...
												<th class="no-sort text-center" style="width:40px;">Sr No.</th>
													<th class="text-center nowrap">Exam</th> 
													<th class="text-center nowrap">Venue</th> 
													<th class="text-center nowrap">Exam Date</th> 
													<th class="text-center nowrap">No. Of Sessions</th> 
													<th class="text-center nowrap">Center</th> 
    ...
    <script language="javascript">
      ...
      $(document).ready(function()
          ...
          searching: true,
					...
					"ajax": 
          {
						"url": '<?php echo site_url("supervision/admin/candidate/get_claim_data_ajax"); ?>',
						"type": "POST",	
            "data": function ( d ) 
						{
      ...
      { 
        ...
        $('.dataTables-example').DataTable().draw(); 
			...
			function export_to_csv()
			{
				...
				var url = '<?php echo site_url("supervision/admin/candidate/export_to_csv"); ?>?s_from_date='+s_from_date+'&s_to_date='+s_to_date+'&paid_status='+paid_status;
