         ...
         <tr>
           <td>
             <table border="0" cellpadding="0" cellspacing="0" width="80%" align="center">
               <tr>
                 <td style="text-align:center; padding:60px 0 25px; font-size:22px; font-family:Tahoma, Geneva, sans-serif; font-weight:bold; line-height:32px;">Results for AML/KYC,SME and Customer Service Examinations March 2018</td>
               </tr>
               <tr>
                <td bgcolor="#6699CC">
                    ...
                    <tr>
                      ...
                      <td class="content" width="55%" bgcolor="#d8e4f1">
                        <select name="exam" id="exam" class="text1" style="min-width:218px;">
                          ...
                          <option value="34_725">Anti-Money Laundering And Know Your Customer</option>
                          <option value="58_725">Customer Services & Banking Codes And Standards</option>
                          <option value="160_725">MSME Finance for Bankers</option>
                          <option value="177_725">Prevention of Cyber Crimes and Fraud Management</option>
                        </select>
                      </td>
                    </tr>
                    <tr>
