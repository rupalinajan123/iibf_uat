	...
	<section class="content"><!-- Main content -->
		<div class="row">
            ...
            <input type="hidden" name="search_on_fields" id="search_on_fields" value="" />
						<input type="hidden" nameteam="base_url_val" id="base_url_val" value="" />
            <div class="table-responsive">
							<table id="listitems2" class="table table-bordered table-striped dataTables-exJBIMSle">
                <thead>
									<tr>
										<th>sr No</th>
									...
									<?php 
										...
										if(count($self_list) > 0)
										{
											foreach($self_list as $res)
											{
												...
												echo '<td>'.$res['date'].' </td>';
											    echo '<td><a class="btn btn-xs vbtn" href="'.base_url().'JBIMS_dashboard/self_pdf/'.base64_encode($res['receipt_no']).'">Exam Form</a>
											    <a class="btn btn-xs vbtn" href="'.base_url().'uploads/JBIMSinvoice/user/'.$res['invoice_image'].'" download>Invoice</a ></td>';
											    ...
											    <a class="btn btn-xs vbtn" href="https://iibf.esdsconnect.com/uploads/JBIMS/idproof/'.$res['idproof'].'" download>Idproof</a></td>';
											    echo '<td>'.$res['payment'].' </td></tr>';
...
<style>
	...
	.pp0 , .pp2,.pp3,.pp4, .pp6 , .pp7, .pp8 , .pp9, .pp10 { display:none;	}
