...
<div class="container">
  <section class="content-header box-header with-border" style="height: 45px; background-color: #1287C0; ">
    <h1 class="register">Apply for Certified Financial Planner (CFP) Certification-Fast Track Pathway</h1>
    <br />
  </section>
  <div> 
    <!-- Start Get Details -->
...
if ($this->session->flashdata('error') != '') {?>
        ...
        <?php } ?>
        <form name="getDetailsForm" autocomplete="off" id="getDetailsForm" method="post" action="<?php echo base_url(); ?>Cfp_exam">
          <br />
          <?php
...
?>" <?php if (isset($row['regnumber'])) { echo "readonly='readonly'";} elseif (set_value('regnumber')) { echo "readonly='readonly'"; } ?> style="border-color:#000;" title="Membership No.">
        ...
        ?>
              <a href="<?php echo base_url();?>cfp_exam" class="btn btn-info" id="modify" style="height: 32px; width: 150px">Modify</a>
      ...
      <div class="row"> 
        <div class="col-md-12">
          <div class="box box-info">
              ...
              <input type="hidden" autocomplete="false" class="form-control" id="exam_code" name="exam_code" value="1035">
...
if (isset($row['designation'])) {echo $row['designation'];}?>">
    ...
    echo $row['mobile'];} ?>"  required  data-parsley-trigger-after-failure="focusout" readonly="readonly">
                ...
                <div class="form-group">
								...
								<?php /* <div class="col-sm-12" style="text-align:center; color:#F00; font-size:14px;">
            <p style="color:#F00">“The above email and mobile number will be used by GARP for communicating the exam formalities, kindly ensure the details are latest, if not then click on the <a href="javascript:void(0)" onclick="cfp_redirect_edit_profile()"><span style="color:#0000FF;">'Edit Profile'</span></a> button to change the details in your profile.”</p>
            </div> */ ?>
						<?php 
              $link='';
            ...
            <p style="color:#F00">“The above email and mobile number will be used by Financial Planning Standards Board Ltd. (FPSB), India  for communicating the CFP examination enrolment formalities.  Kindly ensure the details are latest, if not then click on the <a href="<?php echo $link ;?>"><span style="color:#0000FF;">'Edit Profile'</span></a> button to change the details in your profile”</p>
            </div>
          ...
          <div class="box box-info">
            <div class="box-header with-border"> <h3 class="box-title" style='color:black'>
			  ...
			  <?php if(set_value('declaration1'))
			  {
				 ...
				 }?>>&nbsp; 	(i)	I hereby confirm that I am having minimum three years of work experience in the BFSI sector
              </h3>
              <h3 class="box-title" style='color:black'>
              <input name="declaration2" value="1" type="checkbox" required="required" 
			  <?php if(set_value('declaration2'))
			  {
				  echo set_radio('declaration2', '1');
				 }?>>&nbsp; 	(ii)	I hereby confirm that all the details mentioned in the form are correct and I am agreeable to IIBF sharing the information to FPSB, India for further process
              </h3>
            </div>
            ...
            <div class="box-footer">
              ...
              <div class="col-sm-6 col-sm-offset-3">
                ...
                <a href="<?php echo base_url();?>Cfp_exam" class="btn btn-default" >Reset</a> </div>
...
$('#reload_captcha').click(function(event){
  ...
  $.ajax({
    type: 'POST',
    url: site_url+'Cfp_exam/generatecaptchaajax/',
