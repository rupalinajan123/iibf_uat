 ...
 <table border="0" cellpadding="0" cellspacing="0" width="900px" align="center" style=" margin-bottom:10px;">
   ...
   <td rowspan="2" width="75%">
  	<ul>
    	...
    	<?php if (in_array($this->session->userdata('result_examcode'),array("11","32","33","47","52","151","153","156","158"))){?>
    	<li class="resultlink"><a href="<?php echo base_url()?>result/dipcertconsolidatedresult" target="_blank">Consolidated Marksheet</a></li>
        <?php }?>
        <li class="resultlink"><a href="<?php echo base_url()?>result/dipcertadviceresult" target="_blank">Result Advice</a></li>
    </ul>
   </td>
   </tr>
   </table>
