...
<tr>
  ...
  <td>
    <?php if($this->session->userdata('NCVET_USER_TYPE') == 'admin' || $this->session->userdata('NCVET_USER_TYPE') == 'agency') { ?>
      <b>Centre Password</b> : <?php echo $this->NCVET_model->password_decryption($centre_data[0]['centre_password']); ?></td>
    <?php } ?>
</tr>
