<link href="<?php echo auto_version(base_url('assets/ncvet/css/plugins/sweetalert/sweetalert.css')); ?>" rel="stylesheet">
<script src="<?php echo auto_version(base_url('assets/ncvet/js/plugins/sweetalert/sweetalert.min.js')); ?>"></script>
