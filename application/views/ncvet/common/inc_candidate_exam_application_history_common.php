                ...
                <tr>
                  ...
                  <td class="text-center">
                    ...
                    if(in_array($res['exam_code'], array(1039,1040,1041,1042,1057)) && $res['admitcard_id'] != "")
                    {
                      ...
                      if(isset($_SESSION['NCVET_USER_TYPE']) && $_SESSION['NCVET_USER_TYPE'] == 'admin')
                      {
                        $download_link = site_url('ncvet/admin/transaction/download_admitcard_pdf/'.url_encode($res['admitcard_id']));
                      }
                      else if(isset($_SESSION['NCVET_USER_TYPE']) && $_SESSION['NCVET_USER_TYPE'] == 'agency')
                      {
                        $download_link = site_url('ncvet/agency/transaction_details_agency/download_admitcard_pdf/'.url_encode($res['admitcard_id']));
                      }
