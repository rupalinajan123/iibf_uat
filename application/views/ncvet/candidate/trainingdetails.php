				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="message" style="color:#F00; text-align:center; font-size:20px;"><strong>VERY IMPORTANT</strong></div>
							...
							<div class="message" style="color:#F00; text-align:justify;font-size:16px;"> Content in module to show<br />
								</div>
						</div>
		...
		<div id="wrapper">
			...
			<div id="page-wrapper" class="gray-bg">				
				...
				<div class="row wrapper border-bottom white-bg page-heading">
					<div class="col-lg-10">
						<h2>Training Application Instructions 
						</h2>	
						<ol class="breadcrumb">
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="ibox float-e-margins text-centerx">
								<div class="ibox-title"><h2>Training Application Instructions </h2>
									
								</div>
									
									<div class="ibox-content">
										<form method="post" action="<?php echo site_url('ncvet/candidate/applytraining/trainingform'); ?>" id="exam_details" enctype="multipart/form-data" autocomplete="off">
											<h4>
