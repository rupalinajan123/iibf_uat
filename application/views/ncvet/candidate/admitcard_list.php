                ...
                <div class="ibox-content">
                  ...
                  <div class="table-responsive">
                          ...
                          <th class="text-center">Application Date</th>
													<th class="text-center no-sort nowrap" style="width:90px;">Download Admitcard</th>
												</tr>
											</thead>
    ...
    <script language="javascript">
      $(document).ready(function()
          ...
          searching: true,
					...
					"ajax": 
          {
						"url": '<?php echo site_url("ncvet/candidate/applyexam/get_admitcard_data_ajax"); ?>',
						"type": "POST",	
            "data": function ( d ) 
						{ 
          ...
          rowReorder: false,
            ...
            { "targets": [1], "className": "text-center" }, // Exam
            { "targets": [2], "className": "text-center" }, // Center 
            { "targets": [3], "className": "text-center" }, // status  
            { "targets": [4], "className": "text-right" }, // Date   
            { "targets": [5], "className": "text-center" },// action   
