            ...
            <div class="col-lg-12">
              <div class="ibox"> 
                <div class="ibox-content">
                  ...
                  <form method="post" action="<?php echo site_url('ncvet/candidate/applyexam/examform'); ?>" id="apply_examform" enctype="multipart/form-data" autocomplete="off">
                    <input id="optmode" name="optmode" value="ON" type="hidden">
                    <input id="examcode" name="examcode" value="<?php echo $exam_details['exam_code']; ?>" type="hidden">
                    <input id="eprid" name="examperiod" value="<?php echo $exam_details['exam_period']; ?>" type="hidden">
                    <input id="grp_code" name="grp_code" value="<?php echo $eligible_details[0]['app_category']; ?>" type="hidden">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xl-6 col-lg-6 exam_name-section"  >
                        <div class="form-group">
                          ...
                          <div id="exam_name_err">   
                            <input type="text" name="exam_name" id="exam_name" value="<?php echo $exam_info[0]['description'] ?>" class="form-control" readonly disabled />
                      ...
                      <div class="col-xl-3 col-lg-3 exam_period-section"  >
                        <div class="form-group">
                          ...
                          <div id="exam_period_err">   
                            <input type="text" name="exam_period" id="exam_period" value="<?php 
                            
                            $month = date('Y')."-".substr($exam_details['exam_month'],4);
                            echo date('F',strtotime($month))."-".substr($exam_details['exam_month'],0,-2); ?>" class="form-control" readonly disabled />
                      ...
                      <div class="col-xl-3 col-lg-3 exam_medium-section"  >
                        <div class="form-group">
                          ...
                          <div id="exam_medium_err">   
                              <select name="exam_medium" id="exam_medium" class="form-control" onchange="valMedium(this.value);" required>
                                <option value="">Select</option>
                                <?php if(count($medium_details) > 0)
                                {
                                  foreach($medium_details as $m)
                                  {?>
                                      <option value="<?php echo $m['medium_code']?>"><?php echo $m['medium_description']?></option>
                                  <?php }
                                }?>
                              </select>
                            <note class="form_note" id="exam_medium_err"></note>
                            <?php if(form_error('exam_medium')!=""){ ?> <div class="clearfix"></div><label class="error exam_medium_error"><?php echo form_error('exam_medium'); ?></label> <?php } ?>
                          </div>
                        </div>          
                      </div>
                      ...
                      <div class="col-xl-3 col-lg-3 exam_center-section"  >
                        <div class="form-group">
                          ...
                          <div id="exam_center_err">   
                              <select name="exam_center" id="exam_center" class="form-control" required onchange="valCentre(this.value);">
                                <option value="">Select</option>
                                <?php if(count($center_details) > 0)
                                {
                                  foreach($center_details as $c)
                                  {?>
                                      <option value="<?php echo $c['center_code']?>"><?php echo $c['center_name']?></option>
                                  <?php }
                                }?>
                              </select>
                            <note class="form_note" id="exam_center_err"></note>
                            <?php if(form_error('exam_center')!=""){ ?> <div class="clearfix"></div><label class="error exam_center_error"><?php echo form_error('exam_center'); ?></label> <?php } ?>
                          </div>
                        </div>          
                      </div>
                      <div class="col-xl-3 col-lg-3 exam_fee-section"  >
                        <div class="form-group">
                          ...
                          <div id="exam_fee_err">   
                              <input type="text" name="exam_fee" id="exam_fee" value="-" class="form-control" readonly  />
                      ...
                      <div class="col-xl-6 col-lg-6 scribe-section"  >
                        <div class="form-group">
                          ...
                          <?php if($form_data[0]['benchmark_disability']=='Y'){ ?>
                            <div style="margin-top: 10px;">
                                <input  type="radio" name="scribe_flag" id="scribe_flag"  value="Y" onclick="showSelect_scribe_flagY();" requried>&nbsp;YES
						                    <input style="margin-left: 10px;" type="radio" name="scribe_flag" id="scribe_flag" value="N" onclick="showSelect_scribe_flagN();" checked="checked">&nbsp;NO
                          </div>
                            <?php } else {
                              ?>
                              <div style="margin-top: 10px;">
                    ...
                    <?php // if (!$isUpdateProfile) {  ?>                 
                      <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center" id="submit_btn_outer2">
                          <input type="submit" class="btn btn-primary" id="submitAll" name="submitAll" value="Submit"> 
                        </div>
                      </div>
                    <?php // } ?>
                  </form>
