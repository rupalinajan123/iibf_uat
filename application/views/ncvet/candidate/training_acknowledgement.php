        ...
        <div class="row wrapper border-bottom white-bg page-heading">
          <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item"><a href="<?php echo site_url('ncvet/candidate/applyexam/examlist'); ?>">Trainings</a></li>
              <li class="breadcrumb-item active"> <strong>Training Re-registration Acknowledgement</strong></li>
            </ol>
          </div>
