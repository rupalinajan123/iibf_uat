	...
	<body class="fixed-sidebar">
		...
		<div id="wrapper">
			...
			<div id="page-wrapper" class="gray-bg">				
                ...
                <div class="ibox-title"><h2>Trainings</h2></div>
						...
						{  
							...
							?>
								<div class="form-group has-feedback">
									<?php echo $i?>:  <a title="<?php echo $row['program_name']." - ".$row['program_code']; ?>" href="<?php echo base_url();?>/ncvet/candidate/applytraining/trainingdetails/?program_code=<?php echo base64_encode($row['program_code']);?>"><?php echo $row['program_name'];?></a>
								</div>
						<?php 
							$i++;
