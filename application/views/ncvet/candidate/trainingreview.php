...
<html>
  ...
  <body class="fixed-sidebar">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
          <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active"> <strong>Trainings Re-Registration</strong></li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              <div class="ibox"> 
                <div class="ibox-content">
                  <form method="post" style="display:none;" action="<?php echo site_url('ncvet/candidate/applytraining/process_application'); ?>" id="apply_trainingform" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xl-6 col-lg-6"  >
                        <div class="form-group">
                          ...
                          <div id="exam_name_err">   
                            <input type="text" name="program_name" id="program_name" value="<?php echo $training_details['program_code'] ?>" class="form-control" readonly  />
                      ...
                      <div class="col-xl-3 col-lg-3 "  >
                        <div class="form-group">
                          ...
                          <div id="exam_name_err">   
                            <input type="text" name="amount" id="amount" value="<?php echo $training_details[0]['amount'] ?>" class="form-control" readonly  />
                            <note class="form_note" id="exam_name_err"></note>
    ...
    <script>
      document.getElementById('apply_trainingform').submit();
      </script>
