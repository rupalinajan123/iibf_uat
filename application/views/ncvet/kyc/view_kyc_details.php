                  ...
                  <form method="post" action="<?php echo site_url('ncvet/kyc/kyc_all/process_kyc_details'); ?>" id="kyc_form" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="table-responsive">
                      <table class="table table-bordered" style="width:100%">
                        ...
                        <tbody>
                          <?php 
                          $empty_fullname_flag = $empty_dob_flag = $empty_aadhar_flag = $empty_apaar_flag = $empty_eligibility_flag = $empty_photo_flag = $empty_sign_flag = $empty_id_proof_flag = $empty_declaration_flag = $empty_institute_idproof_flag = $empty_qualification_certificate_file_flag = $empty_exp_certificate_flag = '';
                            ...
                            <tr>
                              ...
                              <td class="text-center"><?php /* Photo */ ?>
                                ...
                                { ?>
                                  <div id="photo_file_preview" class="upload_img_preview" style="margin:0 auto;">
                                    <a href="<?php echo 'javascript:void(0);';//base_url($photo_path . '/' . $mem_data[0]['photo_file']) . "?" . time(); ?>" class="example-image-link open_lightbox"  data-title="<?php echo 'Photo - '.$disp_name.' ('.$mem_data[0]['training_id'].')'; ?>"  data-target="lightbox_photo"><!--  data-lightbox="candidate_images" -->
                              ...
                              <td class="text-center"><?php /* Signature */ ?>
                                ...
                                { ?>
                                  <div id="sign_file_preview" class="upload_img_preview" style="margin:0 auto;">
                                    <a href="<?php echo 'javascript:void(0);';//base_url($sign_path . '/' . $mem_data[0]['sign_file']) . "?" . time(); ?>" class="example-image-link open_lightbox" data-title="<?php echo 'Signature - '.$disp_name.' ('.$mem_data[0]['training_id'].')'; ?>"  data-target="lightbox_sign"> <!-- data-lightbox="candidate_images"  -->
                              ...
                              <td class="text-center"><?php /* APAAR ID/ABC ID */ ?>
                                ...
                                { 
                                  ...
                                  <div class="lightbox_custom lightbox_appar_id_pdf">
                                    <div class="lightbox_header">
                                      APAAR ID/ABC ID
                                      <span class="close-btn">&times;</span>
                                    </div>
                                    <div class="lightbox_content" style="height: 80% !important;">
                                      <iframe width="100%" height="400px" style="border: none;" src="<?php echo base_url($id_proof_path . '/' . $mem_data[0]['id_proof_file']) . "?" . time(); ?>"></iframe>
                                    </div>
                                    <div class="resizer"></div>
                              ...
                              <td class="text-center"><?php /* Aadhar Card */ ?>
                                ...
                                { 
                                  ...
                                  <div class="lightbox_custom lightbox_aadhar_card_pdf">
                                    ...
                                    <div class="lightbox_content">
                                      <iframe src="<?php echo base_url($aadhar_file_path . '/' . $mem_data[0]['aadhar_file']) . "?" . time(); ?>"></iframe>
                                    </div>
                                    <div class="resizer"></div>
                                    <div class="lightbox_footer" style="display: none;"></div>
                              ...
                              <td class="text-center <?php echo $declaration_show_hide; ?>"><?php /* Declaration */ ?>
                                ...
                                { 
                                  ...
                                  <!-- <a href="javascript:void(0);" class="example-image-link open_lightbox" data-target="lightbox_declaration_pdf">
                                    <div id="id_proof_file_preview" class="upload_img_preview" style="margin:0 auto;"> 
                                      <img src="<?php echo base_url('assets/images/pdf.png'); ?>" width="80" height="80" alt="PDF"> 
                                    </div> 
                                  </a>

                                  <div class="lightbox_custom lightbox_declaration_pdf">
                                    <div class="lightbox_header">
                                      Declaration
                                      <span class="close-btn">&times;</span>
                                    </div>
                                    <div class="lightbox_content">
                                      <iframe src="<?php echo base_url($declaration_path . '/' . $mem_data[0]['declarationform']) . "?" . time(); ?>"></iframe>
                                    </div>
                                    <div class="resizer"></div>
                                  ...
                                  <?php
                                    ...
                                    ?>
                                  <div id="declaration_preview" class="upload_img_preview" style="margin:0 auto;">
                                    <a href="<?php echo 'javascript:void(0);';//base_url($declaration_path . '/' . $mem_data[0]['declarationform']) . "?" . time(); ?>" class="example-image-link open_lightbox" data-title="<?php echo 'Declaration - '.$disp_name.' ('.$mem_data[0]['training_id'].')'; ?>" data-target="lightbox_declaration_img"> <!--  data-lightbox="candidate_images" -->
                              ...
                              <td class="text-center <?php echo $institute_idproof_show_hide; ?>"><?php /* institute_idproof */ ?>
                                ...
                                { 
                                  ...
                                  <?php
                                    ...
                                    ?>
                                  <div id="institute_idproof_preview" class="upload_img_preview" style="margin:0 auto;">
                                    <a href="<?php echo 'javascript:void(0);';//base_url($institute_idproof_path . '/' . $mem_data[0]['institute_idproof']) . "?" . time(); ?>" class="example-image-link open_lightbox" data-title="<?php echo 'Institute Id Proof - '.$disp_name.' ('.$mem_data[0]['training_id'].')'; ?>" data-target="lightbox_institute_idproof_img"> <!-- data-lightbox="candidate_images" -->
                              ...
                              <td class="text-center <?php echo $qualification_certificate_file_show_hide; ?>"><?php /* qualification_certificate_file */ ?>
                                ...
                                { 
                                  ...
                                  <?php
                                    ...
                                    ?>
                                  <div id="qualification_certificate_file_preview" class="upload_img_preview" style="margin:0 auto;">
                                    <a href="<?php echo 'javascript:void(0);';//base_url($qualification_certificate_path . '/' . $mem_data[0]['qualification_certificate_file']) . "?" . time(); ?>" class="example-image-link open_lightbox" data-title="<?php echo 'Qualification Certificate File - '.$disp_name.' ('.$mem_data[0]['training_id'].')'; ?>" data-target="lightbox_qualification_cert_file_img"> <!--  data-lightbox="candidate_images" -->
                              ...
                              <td class="text-center <?php echo $exp_certificate_show_hide; ?>"><?php /* exp_certificate */ ?>
                                ...
                                { 
                                  ...
                                  <?php
                                    ...
                                    ?>
                                  <div id="exp_certificate_preview" class="upload_img_preview" style="margin:0 auto;">
                                    <a href="<?php echo 'javascript:void(0);';//base_url($exp_certificate_path . '/' . $mem_data[0]['exp_certificate']) . "?" . time(); ?>" class="example-image-link open_lightbox" data-title="<?php echo 'Experience Certificate - '.$disp_name.' ('.$mem_data[0]['training_id'].')'; ?>" data-target="lightbox_exp_certificate_img">
                                      <img src="<?php echo base_url($exp_certificate_path . '/' . $mem_data[0]['exp_certificate']) . "?" . time(); ?>"> <!--  data-lightbox="candidate_images" -->
                                    </a>
                                  </div>
