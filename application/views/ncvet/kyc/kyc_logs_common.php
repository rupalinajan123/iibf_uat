                ...
                <div class="ibox-content">
                  ...
                  <div class="table-responsive">
                          ...
                          <th class="no-sort text-center">Sr. No.</th>
													...
													<th class="text-center nowrap">Enrollment Number</th>
													<!-- <th class="text-center nowrap">Exam Code</th> -->
													<th class="text-center nowrap">Description</th>
													<th class="text-center nowrap" style="width: 130px;">Date & Time</th>
												</tr>
											</thead>
    ...
    <script language="javascript">
      $(document).ready(function()
          ...
          searching: true,
					...
					"ajax": 
          {
						"url": '<?php echo site_url("ncvet/kyc/kyc_log/get_kyc_log_data_ajax"); ?>',
						"type": "POST",	
            "data": function ( d ) 
						{
