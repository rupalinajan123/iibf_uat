  ...
  <?php $this->load->view('ncvet/common/inc_loader'); ?>
    ...
    <?php $this->load->view('ncvet/kyc/inc_sidebar_admin'); ?>		
      ...
      <?php $this->load->view('ncvet/kyc/inc_topbar_admin'); ?>
				...
				<div class="wrapper wrapper-content animated fadeInRight">
                  ...
                  <form method="post" action="<?php echo site_url('ncvet/kyc/kyc_all/index/'.$module_name); ?>" id="search_form" class="search_form_common_all" enctype="multipart/form-data" autocomplete="off">
    ...
    <script type="text/javascript">
      function fun_get_member_type_ajax(selected_membership_type)
      {
        ...
        {
          type: "POST",
          url: "<?php echo site_url('ncvet/kyc/kyc_all/get_member_type_ajax'); ?>",
          data: parameters,
          cache: false,
          dataType: 'JSON',
      ...
      function fun_get_exam_code_ajax(selected_member_type)
      {
        ...
        {
          type: "POST",
          url: "<?php echo site_url('ncvet/kyc/kyc_all/get_exam_code_ajax'); ?>",
          data: parameters,
          cache: false,
          dataType: 'JSON',
          success:function(data)
      ...
      function validate_input(input_id) { $("#"+input_id).valid(); }
        ...
        $('#s_membership_type').change(function() 
        {
          if ($(this).val() === 'NM') 
          {
            ...
            //$('#s_exam_code').rules('remove', 'required'); 
          }
        });
      });
		</script>	
