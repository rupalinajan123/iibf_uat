                  ...
                  <!-- <div class="container my-4"> -->
                    ...
                    <div class="row g-3">
                      <div class="col-md-2 col-6">
                        <a href="<?php echo site_url('ncvet/kyc/kyc_all/new_candidate'); ?>"><div class="dashboard-card card-blue">
                          <div>Enrolled <br>Candidates</div>
                          <h2><?php echo $total_enrolled_new; ?></h2>
                        </div></a>
                      </div> 
                      <div class="col-md-2 col-6">
                        <a href="<?php echo site_url('ncvet/kyc/kyc_all/pending_candidate'); ?>"><div class="dashboard-card card-purple">
                          <div>Pending for <br>KYC</div>
                          <h2><?php echo $total_pending_new; ?></h2>
                        </div></a>
                      </div>
                      <div class="col-md-2 col-6">
                        <a href="<?php echo site_url('ncvet/kyc/kyc_all/recommend_candidate'); ?>"><div class="dashboard-card card-orange">
                          <div>Attend <br>Candidates</div>
                          <h2><?php echo $total_recommend_new; ?></h2>
                        </div></a>
                      </div>
                      <div class="col-md-2 col-6">
                        <a href="<?php echo site_url('ncvet/kyc/kyc_all/approved_candidate'); ?>"><div class="dashboard-card card-green">
                      ...
                      <div class="col-md-2 col-6">
                        <a href="<?php echo site_url('ncvet/kyc/kyc_all/rejected_candidate'); ?>"><div class="dashboard-card card-red">
                    ...
                    <div class="row g-3">
                      <div class="col-md-2 col-6">
                        <a href="<?php echo site_url('ncvet/kyc/kyc_all/edit_candidate'); ?>"><div class="dashboard-card card-blue">
                          <div>Re-KYC <br>Candidates</div>
                          <h2><?php echo $total_enrolled_edited; ?></h2>
                        </div></a>
                      </div> 
                      <div class="col-md-2 col-6">
                        <a href="<?php echo site_url('ncvet/kyc/kyc_all/edit_pending_candidate'); ?>"><div class="dashboard-card card-purple">
                          <div>Pending for <br>Re-KYC</div>
                          <h2><?php echo $total_pending_edited; ?></h2>
                        </div></a>
                      </div>
                      <div class="col-md-2 col-6">
                        <a href="<?php echo site_url('ncvet/kyc/kyc_all/edit_recommend_candidate'); ?>"><div class="dashboard-card card-orange">
                          <div>Attend <br>Candidates</div>
                          <h2><?php echo $total_recommend_edited; ?></h2>
                        </div></a>
                      </div>
                      <div class="col-md-2 col-6">
                        <a href="<?php echo site_url('ncvet/kyc/kyc_all/approved_edit_candidate'); ?>"><div class="dashboard-card card-green">
                          <div><?php echo ($this->session->userdata('NCVET_KYC_ADMIN_TYPE') == '1' ? 'Recommended' : 'Approved' ); ?> <br>Candidates</div>
                          <h2><?php echo $total_approved_edited; ?></h2>
                        </div></a>
                      </div>
                      <div class="col-md-2 col-6">
                        <a href="<?php echo site_url('ncvet/kyc/kyc_all/rejected_edit_candidate'); ?>"><div class="dashboard-card card-red">
                          <div>Rejected <br>Candidates</div>
