...
<html>
  ...
  <body >
    ...
    <div class="d-flex logo"><img src="<?php echo base_url('assets/ncvet/images/iibf_logo.png'); ?>" class="img-fluid" title="INDIAN INSTITUTE OF BANKING & FINANCE" alt="INDIAN INSTITUTE OF BANKING & FINANCE"><h3 class="mb-0">INDIAN INSTITUTE OF BANKING & FINANCE - KYC</h3></div>
    <div class="bcbf_wrap"> 
      ...
      <div class="container">        
        ...
        <div class="admin_login_form animated fadeInDown">
          ...
          <form class="m-t" action="<?php echo site_url('ncvet/kyc/login'); ?>" method="post" enctype="multipart/form-data" id="kyc_login_form" autocomplete="off">
    ...
    <script type="text/javascript">
      function refresh_captcha() 
      {
        ...
        $.ajax({
          type: "POST",
          url: "<?php echo site_url('ncvet/kyc/login/refresh_captcha'); ?>",
      ...
      $(document).ready(function() 
      {
        ...
        $("#kyc_login_form").validate(
        {
          ...
          rules: 
          { 
            kyc_username: { required: true, remote: { url: "<?php echo site_url('ncvet/kyc/login/validation_check_username/0/1'); ?>", type: "post" } },
            kyc_password: { required: true, remote: { url: "<?php echo site_url('ncvet/kyc/login/validation_check_login_details/0/1'); ?>", type: "post", data: { "kyc_username": function() { return $("#kyc_username").val() } } } },
            kyc_captcha: { required: true, remote: { url: "<?php echo site_url('ncvet/kyc/login/validation_check_captcha/0/1'); ?>", type: "post" } }
          },
          messages: 
          {
