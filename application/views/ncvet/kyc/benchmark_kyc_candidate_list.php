      ...
      <?php $this->load->view('ncvet/kyc/inc_topbar_admin'); ?>
				...
				<div class="row wrapper border-bottom white-bg page-heading">
					<div class="col-lg-10">
						...
						<ol class="breadcrumb">
							<li class="breadcrumb-item"><a href="<?php echo site_url('ncvet/kyc/benchmark_kyc_dashboard'); ?>">Dashboard</a></li>
    ...
    <script language="javascript">
      $(document).ready(function()
          ...
          searching: true,
					...
					"ajax": 
          {
						"url": '<?php echo site_url("ncvet/kyc/benchmark_kyc_all/".$action_name."/".$kyc_status_list."/".$page_url); ?>',
						"type": "POST",	
            "data": function ( d ) 
						{
