        ...
        <?php $this->load->view('iibfbcbf/admin/inc_topbar_admin'); ?>
              ...
              <li class="breadcrumb-item">Reports</li>
                ...
                <div class="ibox-content">
                  <form method="POST" action="<?php echo base_url("iibfbcbf/admin/Reports/get_success_failure_billdesk_or_neft_data_ajax"); ?>" id="search_form" class="search_form_common_all" autocomplete="off">
    ...
    <script language="javascript">
      ...
      $(document).ready(function()
          ...
          searching: true,
					...
					"ajax": 
          {
						"url": '<?php echo site_url("iibfbcbf/admin/Reports/get_success_failure_billdesk_or_neft_data_ajax"); ?>',
						"type": "POST",	
            "data": function ( d ) 
						{
