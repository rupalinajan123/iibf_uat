				...
				<div class="wrapper wrapper-content animated fadeInRight">
                  ...
                  <!-- <div class="ibox-title">
                    <div class="ibox-tools"> 
                      <a href="<?php echo site_url('ncvet/admin/transaction'); ?>" class="btn btn-danger custom_right_add_new_btn">Back</a> 
                    </div>
                  </div> -->   
    ...
    <script language="javascript">
      $(document).ready(function()
          ...
          searching: true,
					...
					"ajax": 
          {
						"url": '<?php echo site_url("ncvet/admin/transaction/get_transaction_data_ajax"); ?>',
						"type": "POST",	
            "data": function ( d ) 
						{ 
