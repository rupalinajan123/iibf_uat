	...
	<body class="hold-transition skin-blue sidebar-mini">
		<div class="wrapper">
			<header class="main-header">
				<a href="<?php echo site_url('JaiibReschedule_121/dashboard');?>" class="logo">IIBF</a>
					...
					<div class="navbar-custom-menu">
						<ul class="nav navbar-nav navlogo">
							...
							<li class="dropdown user user-menu">
								<a href="<?php echo site_url('JaiibReschedule_121/logout'); ?>" class="dropdown-toggle" >
				...
				<section class="sidebar">
					<ul class="sidebar-menu" style="margin:0;">
						<li class="treeview active">
							<a href="<?php echo site_url('JaiibReschedule_121/dashboard');?>">
								<i class="fa fa-book"></i> <span>Dashboard</span>
							</a>
						</li> 
						<li class="treeview">
							<a href="<?php echo site_url('JaiibReschedule_121/logout'); ?>">
