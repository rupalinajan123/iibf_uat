                  ...
                  <tr>
                    <td style="background-color:#1287c0; color:#fff; text-align:center; font-weight:bold; font-size:14px; padding:10px 0;"><?php
                      ...
                      <div align="right"> <a href="<?php echo base_url();?>admitcard/getadmitdashboard">Home</a> &nbsp; <a href="<?php echo base_url();?>admitcard/getadmitcardpdfsp/<?php echo base64_encode($exam_code)?>" style="color:#F00">Save as pdf</a>&nbsp; 
											...
											<a href="<?php echo base_url()?>admitcard/logout" style="color:#F00">Logout</a> </div></td>
									</tr>
                  <tr>
                    <td height="5"></td>
									</tr>
															...
															<td style="border-bottom:1px solid #fff; border-right:1px solid #fff; padding:7px; text-transform:uppercase; font-weight:bold;"><?php echo $record->mam_nam_1;?>
																...
																<?php 
																	if ($memberDetails[0]['dateofbirth']!='') {
																		echo 'DOB:&nbsp;'.date('d-m-Y',strtotime($memberDetails[0]['dateofbirth']));
																	}
                        ...
                        <thead>
                          <tr style="background-color:#7fd1ea;">
                            ...
                            <?php if(in_array($exam_code, array(1037,1038,1046,1047))) { ?>
															<th width="11%" style="text-align:left; padding:7px; border-bottom:1px solid #198cc3; border-right:1px solid #198cc3;">Reporting Time<sup>@</sup></th>
														<?php } ?>
														
                            <th width="11%" style="text-align:left; padding:7px; border-bottom:1px solid #198cc3; border-right:1px solid #198cc3;">Exam Time<sup>@</sup></th>
                            <th width="12%" style="text-align:left; padding:7px; border-bottom:1px solid #198cc3; border-right:1px solid #198cc3;">Venue Code</th>
                            <th width="30%" style="text-align:left; padding:7px; border-bottom:1px solid #198cc3; border-right:1px solid #198cc3;" >Seat Number *</th>
                            <th width="30%" style="text-align:left; padding:7px; border-bottom:1px solid #198cc3; border-right:1px solid #198cc3;" >Verification Stamp</th>
													</tr>
												</thead>
                        <tbody>
                          <?php 
                            ...
                            <tr style="background-color:#dcf1fc;">
                              ...
                              <td style="text-align:left; padding:7px; border-bottom:1px solid #198cc3; border-right:1px solid #198cc3;">
                                <?php
                                  ...
                                  else if($exam_code == 1037 || $exam_code == 1038 || $exam_code == 1046 || $exam_code == 1047) { echo ''; }
																	else
																	{
                    ...
                    <td style="text-align:right; line-height:24px; font-size:13px;">
                      <?php /* <div style="color:red;">                      
                        **(Refer display board at Test Venue)<br>
                        <?php if($exam_code!=34 && $exam_code!=160 && $exam_code!=58)
												...
												else if($exam_code == 1037 || $exam_code == 1046)
												{
                      ...
                      <div>
                        <?php if($exam_code == 1037 || $exam_code == 1038 || $exam_code == 1046 || $exam_code == 1047)
													{   ?>
                          <div>
                            <div style="float: left; width: 260px; text-align: left; line-height: 18px;">*Seat No. will be allotted at examination hall</div>
                            <div style="float: right; width: 525px; line-height: 18px;">@ No candidate/s will be permitted to enter the Examination Venue/hall after the gate closing time for any reason whatsoever.” The exam/reporting time details are shared below</div>
													</div>
													
                          <div style="float: none; clear: both; text-align: left; line-height: 18px;"><strong>#Candidates are advised to check Institute's Website, a day before the Examination Date, for any Information/Notice or Change in Examination Venue.</strong></div>
												<?php } ?>
											</div>
										</td>
									</tr>
                  ...
                  <tr>
                    <td>
                      <?php if($exam_code == 101 || $exam_code == 1037 || $exam_code == 1038 || $exam_code == 1046 || $exam_code == 1047 || $exam_code == 1010 || $exam_code == 10100 || $exam_code == 101000 || $exam_code == 1010000 || $exam_code == 10100000)
												{ ?>
                        <?php /* <p><strong>In case of any queries regarding venue, please dial 022-62507716 (available on exam day and previous day only). For all other queries email to care@iibf.org.in </strong></p> */ ?>
												
                        <p><strong>In case of any queries regarding venue, please dial 1800 419 2929 (available on exam day and previous day only). For all other queries email to care@iibf.org.in</strong></p>
												<?php }
                        ...
                        <p><strong>In case of any queries regarding venue, please dial 020-66218336/020-66218338 (available on exam day and previous day only). For all other queries email to care@iibf.org.in </strong></p>
												...
												if($exam_code != 101 && $exam_code != 1037 && $exam_code != 1038 && $exam_code != 1046 && $exam_code != 1047 && $exam_code != 1010 & $exam_code != 10100 & $exam_code != 101000 & $exam_code != 1010000 & $exam_code != 10100000)
												{
													if($vcenter == 3)
													{ ?>
    ...
    <?php if($exam_code !=101 && $exam_code !=1037 && $exam_code !=1038 && $exam_code !=1046 && $exam_code !=1047 && $exam_code !=996)
        ...
        <div class="main-container" style="background:#fff; width:680px; border:1px solid #999; padding:30px; margin:600px auto; font-size:14px;">
          ...
          <table width="100%" border="0" cellspacing="5" cellpadding="5" style="margin-top: 20px">
			...
			elseif($exam_code == 101 || $exam_code == 1037 || $exam_code == 1038 || $exam_code == 1046 || $exam_code == 1047 || $exam_code == 1010)
			{ ?>
      <table cellpadding="0" cellspacing="0" width="800" border="0" align="center" style="background-color:#fff;">
        <tr>
          <td style="background-color:#7fd1ea; color:#fff; text-align:center; font-weight:bold; font-size:13px; padding:7px 0; text-transform:uppercase;">IMPORTANT INSTRUCTIONS FOR CANDIDATES</td>
