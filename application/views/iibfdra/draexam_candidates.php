						...
						<div class="box-body">
							...
							<section class="search_form_common_all">
								...
								<div class="form-group" style="">
									...
									<a href="<?php echo site_url('iibfdra/TrainingBatches/allapplicants/'.base64_encode($examcode)); ?>" class="btn btn-primary">Clear</a>
								</div>
							</section>
...
<script type="text/javascript">
	...
	function getTableDataAjax(i_val, chk_val)
	{
		...
		var s_member_no = encodeURIComponent('<?php echo $s_member_no; ?>');
		...
		{
			type: "POST",
			url: "<?php echo site_url('iibfdra/TrainingBatches/getTableDataAjax'); ?>",
			data: parameters,
			cache: false,
			dataType: 'JSON',
	...
	function search_form_submit()
	{
		...
		var redirect_url = "<?php echo site_url('iibfdra/TrainingBatches/allapplicants/'.base64_encode($examcode)) ?>";
		if(search_val != "")
		{
