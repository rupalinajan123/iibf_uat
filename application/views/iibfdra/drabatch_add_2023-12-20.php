          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              ...
              <?php /*?>
                            <div class="form-group">
                                ...
                                <div class="col-sm-3">
                                    <input checked type="radio" class="minimal" id="batch_type" name="batch_type"  required value="Combined" <?php echo set_radio('batch_type', 'Combined'); ?>>
                                    Combine Batch
                                    <input type="radio" class="minimal" id="batch_type" name="batch_type" required value="Separate" <?php echo set_radio('batch_type', 'Separate'); ?>>
                                    Separate Batch 
              ...
              <div class="form-group" id="type_div">
                <label for="batch_type" class="col-sm-3 control-label">Batch Type <span class="mandatory-field">*</span></label>
                <div class="col-sm-3">
                  <label style="margin-right: 10px;"><input type="radio" class="minimal" id="batch_type" name="hours" value="50" <?php if (set_value('hours') == '50') { echo 'checked="checked"'; } ?> style="margin-top: 5px;vertical-align: top;">
                    50 Hour</label>
                  <label><input type="radio" class="minimal" id="batch_type" name="hours" value="100" <?php if (set_value('hours') == '100' || set_value('hours') == '') { echo 'checked="checked"'; } ?> style="margin-top: 5px;vertical-align: top;">
                    100 Hour</label>
                        ...
                        if ($val['renew_pay_status'] != "") { //not empty
                          if (($val['renew_type'] == 'free' && $val['center_type'] == 'R') || ($val['renew_pay_status'] == 1 && $val['center_type'] == 'R')) { ?>
                            ...
                            if ($val['center_validity_from'] == '' && $val['center_validity_to'] == '' && $val['pay_status'] == 1) {
                              ...
                              <option value="<?php echo $val['center_id']; ?>"> <?php echo $val['location_name'] . '( The accreditation period is not defined for this centre, please contact admin. )'; ?></option>
                            <?php } elseif ($val['center_status'] == 'A' && $val['pay_status'] == 0) { ?>
                              <option value="<?php echo $val['center_id']; ?>"><?php echo $val['location_name'] . '(The selected centre is approved by the admin, kindly make the payment for this centre in order to add the batch. )'; ?></option>
                            ...
                            <?php } elseif ($val['center_validity_to'] < date('Y-m-d')  && $val['pay_status'] == 1) { ?>
                              ...
                              <option value="<?php echo $val['center_id']; ?>"><?php echo $val['location_name'] . ' ( The accreditation period for the selected centre is expired, please contact admin. )'; ?></option>
                            <?php } elseif ($val['center_status'] == 'R') { ?>
                              <option value="<?php echo $val['center_id'] ?>"><?php echo $val['location_name'] . ' ( The selected centre is rejected by the admin, please check the centre status in centre list or else contact admin. )'; ?></option>
                            <?php } elseif ($val['center_status'] == 'IR') { ?>
                              <option value="<?php echo $val['center_id'] ?>"><?php echo $val['location_name'] . ' ( IN Review Process. )'; ?></option>
                            <?php } elseif ($val['center_status'] == 'AR') { ?>
                              <option value="<?php echo $val['center_id'] ?>"><?php echo $val['location_name'] . ' ( Approve by Recommender. )'; ?></option>
                            <?php } elseif ($val['center_status'] == 'A' && $val['pay_status'] == 2) { ?>
                              <option value="<?php echo $val['center_id'] ?>"><?php echo $val['location_name'] . ' ( Approve by Approver. )'; ?></option>
                            <?php } elseif ($val['center_validity_from'] > date('Y-m-d')) { ?>
                              <option value="<?php echo $val['center_id'] ?>"><?php echo $val['location_name'] . ' ( Your Accreditation period is not started. )'; ?></option>
                            <?php }
                          } elseif (($val['renew_pay_status'] == 0 || $val['renew_pay_status'] == 2) && $val['center_type'] == 'R' && $val['renew_type'] != 'free') { ?>
                            <option value="<?php echo $val['center_id']; ?>"> <?php echo $val['location_name'] . '( Your renewal process payment is pending. )'; ?><?php echo set_value('location_name'); ?></option>
                          <?php } elseif (($val['renew_pay_status'] == 0 || $val['renew_pay_status'] == 2) && $val['center_type'] == 'T') { ?>
                            <option value="<?php echo $val['center_id']; ?>"> <?php echo $val['location_name'] . '( Your renewal process payment is pending. )'; ?></option>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  ...
                  <input type="text" class="form-control" name="total_net_time" id="total_net_time" placeholder="Total Net Training Time of Duration" value="00:00" readonly="readonly" autocomplete="off">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  ...
                  <select class="form-control" id="first_faculty" name="first_faculty" onchange="get_faculty()" required="">
                    <option value="">Select Faculty</option>
                    <?php foreach ($faculty_data as $key => $value) { ?>
                      <option value="<?php echo $value['faculty_id']; ?>"><?php echo $value['faculty_name']; ?></option>
                    <?php } ?>
                  </select>
                  <span class="note-error" id="first_faculty_error"></span>
                </div>

                <div class="col-sm-4">
                  2nd Faculty (For Soft Skill in Banking) <span class="mandatory-field">*</span>
                  <select class="form-control" id="sec_faculty" name="sec_faculty" last_val="" onchange="get_faculty()" required="" >
                    <option value="">Select Faculty</option>
                    <?php foreach ($faculty_data as $key => $value) { ?>
                      <option value="<?php echo $value['faculty_id']; ?>"><?php echo $value['faculty_name']; ?></option>
                    <?php } ?>
                  </select>
                  <span class="note-error" id="sec_faculty_error"></span>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  ...
                  <span class="note-error" id="additional_first_faculty_error"></span>
                </div>
                ...
                <div class="col-sm-4">
                  ...
                  <span class="note-error" id="additional_sec_faculty_error"></span>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <textarea style="width:100%; text-align:left;" name="remarks" id="remarks"  maxlength="1000" placeholder=" Remark"><?php echo set_value('remarks');?></textarea>
              ...
              <div id="batch_online_users_outer" style="display:none;">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-6">
                    <input type="text" class="form-control" id="platform_link" name="platform_link" value="<?php echo set_value('platform_link'); ?>" autocomplete="off" maxlength="200" placeholder="" data-parsley-trigger="focusin focusout">
            ...
            <div class="box-footer">
              <div class="col-sm-4 col-xs-offset-3">
                ...
                <!-- <a href="<?php //echo base_url('iibfdra/TrainingBatches')
...
<script type="text/javascript">
  ...
  function get_faculty() {
    ...
    $.ajax({
      ...
      url: site_url + 'iibfdra/TrainingBatches/check_faculty_mapping/',
  ...
  $(document).ready(function() {
    ...
    $('.time,#total_brk_time,#net_time,#total_net_time').val('');
    ...
    $("input[name='batch_type']").click(function() {
      ...
      /* var total_net_time = $('#total_net_time').val();
       ...
       if(total_net_time<batch_type){
           $('#total_net_time_error').text('Total Net Training Time should be greather than or equal to '+batch_type);
           return false;
       }
       else{
           $('#total_net_time_error').text('');
