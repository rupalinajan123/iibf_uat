          ...
          <div class="box box-info">
            <div class="box-header with-border">
              ...
              <?php if($request_from != 'Inspector') { ?>
                <div class="pull-right"> <a href="<?php echo base_url();?>iibfdra/faculty" class="btn btn-warning">Back</a> </div>
              <?php }?>
            </div>
            <div class="box-body">
              ...
              <?php } ?>  
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <div class="col-sm-2">
                        ...
                        <a href="<?php echo base_url();?>iibfdra/faculty/faculty_add" class="btn btn-success clear_btn" id="clear_btn" style="margin-left: 5px;">Clear</a>
                      </div> 
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-2">
                      ...
                      <select name="salutation" id="salutation" class="form-control salutation_cls" data-parsley-required>
                        ...
                        <option value="MR" <?php if(!empty($faculty_data[0]['salutation']) && $faculty_data[0]['salutation'] == 'MR') { echo "selected='selected'"; } ?>>MR.</option> 
                        <option value="MRS" <?php if(!empty($faculty_data[0]['salutation']) && $faculty_data[0]['salutation'] == 'MRS') { echo "selected='selected'"; } ?>>MRS.</option>
                        <option value="MISS" <?php if(!empty($faculty_data[0]['salutation']) && $faculty_data[0]['salutation'] == 'MISS') { echo "selected='selected'"; } ?>>MISS.</option>
                      </select>
                    </div>
                ...
                <?php if($action == 'add'){?>
                  ...
                  <div class="col-sm-12 fresh-add-section">
                    <div class="form-group">
                      ...
                      <div class="col-sm-2">
                        <input type="number" class="form-control" id="gross_duration_month0" name="gross_duration_month[]" placeholder="e.g. 1" min="0" max="11" maxlength="2"  value="<?php echo set_value('gross_duration_month0');?>" data-parsley-errors-container="#gross_duration_month_error0" data-parsley-required>
                        <!-- onkeypress="return isNumber(event)" -->
                ...
                <? } 
                  ...
                  <div class="col-sm-12">
                    ...
                    <?php } if(!empty($faculty_data[0]['gross_duration_year1'])){ ?>
                      <div class="col-sm-2">
                  ...
                  <?php } if(!empty($faculty_data[0]['gross_duration_month1'])){ ?>
                       <div class="col-sm-2">
                        <input type="text" class="form-control" id="gross_duration_month0" name="gross_duration_month[]" placeholder="e.g. 1" maxlength="2" value="<?php echo $faculty_data[0]['gross_duration_month1'];?>" data-parsley-errors-container="#gross_duration_month_error0" data-parsley-required >
                        <!-- onkeypress="return isNumber(event)" -->
                        <span class="note-error" id="gross_duration_month_error0"></span>
                      </div>
                    </div>
                  ...
                  <?php if(!empty($faculty_data[0]['work_exp2'])){ ?>
                    <div class="col-sm-12"  id="textbox-label">
                      ...
                      <?php } if(!empty($faculty_data[0]['gross_duration_year2'])){ ?>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="gross_duration_year0" name="gross_duration_year[]" placeholder="e.g. 10" maxlength="2" value="<?php echo $faculty_data[0]['gross_duration_year2'];?>" data-parsley-errors-container="#gross_duration_year_error0" data-parsley-required >
                        <!-- onkeypress="return isNumber(event)"  -->
                        <span class="note-error" id="gross_duration_year_error0"></span>
                      </div>
                      <?php } if(!empty($faculty_data[0]['gross_duration_month2'])){ ?>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="gross_duration_month0" name="gross_duration_month[]" placeholder="e.g. 1" maxlength="2"  value="<?php echo $faculty_data[0]['gross_duration_month2'];?>" data-parsley-errors-container="#gross_duration_month_error0" data-parsley-required >
                        <!-- onkeypress="return isNumber(event)" -->
                        <span class="note-error" id="gross_duration_month_error0"></span>
                      </div>
                    </div>
                  ...
                  <?php if(!empty($faculty_data[0]['work_exp3'])){ ?>
                    <div class="col-sm-12" id="textbox-label">
                     ...
                     <?php } if(!empty($faculty_data[0]['gross_duration_year3'])){ ?>
                        <div class="col-sm-2">
                          <input type="text" class="form-control" id="gross_duration_year0" name="gross_duration_year[]" placeholder="e.g. 10" maxlength="2" value="<?php echo $faculty_data[0]['gross_duration_year3'];?>" data-parsley-errors-container="#gross_duration_year_error0" data-parsley-required >
                          <!-- onkeypress="return isNumber(event)" -->
                          <span class="note-error" id="gross_duration_year_error0"></span>
                        </div>
                    <?php } if(!empty($faculty_data[0]['gross_duration_month3'])){ ?>
                        <div class="col-sm-2">
                          <input type="text" class="form-control" id="gross_duration_month0" name="gross_duration_month[]" placeholder="e.g. 1" maxlength="2" value="<?php echo $faculty_data[0]['gross_duration_month3'];?>"  data-parsley-errors-container="#gross_duration_month_error0" data-parsley-required >
                          <!-- onkeypress="return isNumber(event)" -->
                          <span class="note-error" id="gross_duration_month_error0"></span>
                        </div>
                      </div>
                ...
                <div class="col-sm-12" id="agency_association_period1" style="display: none;">
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                      ...
                      data-parsley-errors-container="#year_error0" data-parsley-required>
                      <!-- onkeypress="return isNumber(event)" -->
                      <span class="note">Note: Please Enter only Number.</span>
                      <span class="note-error" id="year_error0"></span>
                    </div>
                    <div class="col-sm-4">
                      <input type="number" class="form-control" id="month" name="end_date" min="0" max="11" maxlength="2" placeholder="--Month--" value="<?php echo isset($faculty_data[0]['end_date'])?$faculty_data[0]['end_date']:'';?>" data-parsley-errors-container="#month_error0" data-parsley-required>
                      <!-- onkeypress="return isNumber(event)" -->
                      <span class="note">Note: Please Enter only Number.</span>
                ...
                <div class="col-sm-6 col-sm-offset-3">
                  <div class="col-sm-12"> 
                    <center>
                     ...
                     <?php } ?>
                     <a href="<?php echo base_url('iibfdra/faculty'); ?>" class="btn btn-warning mr-2" >Back</a>  
...
<script type="text/javascript">
  ...
  function change_status() 
  {
    ...
    if (err_cnt == 0) 
    {
      ...
      if (status != '' || status != undefined) 
      {
        ...
        $.ajax({
          type: 'POST',
          url: base_url + "iibfdra/faculty/change_status",
          data: {
  ...
  if( action == 'add' ) 
  {
    $('.faculty_btn').click(function()
    {
      ...
      if ($.trim(faculty_code) == '') {
        ...
        $.ajax({
          url: base_url+"iibfdra/faculty/getData",
          method:"POST",
  ...
  window.Parsley.addValidator('pan_no_exist', {
    ...
    validateString: function(value){
      return $.ajax({
        url: base_url+"iibfdra/faculty/check_pan_no",
        method:"POST",
...
*/
  ...
  function removeImg1(faculty_id){
     ...
     /* $.ajax({
        type: 'POST',
        url: base_url+"iibfdra/faculty/removeFile",
