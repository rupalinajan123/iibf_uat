                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                       <div class="col-md-12">
                             ...
                             <?php } ?> 
                            <form action="<?php echo base_url() ?>iibfdra/TrainingBatches/make_neft" method="post" class="form-horizontal" name="neft_pay_form" id="neft_pay_form" autocomplete="off">
		...
		/* $('#utr').on('click', function () 
			...
			if(lvl.length>0)
			{
				...
				$.ajax({
					...
					type: 'POST',
					data: sdata,
					url: site_url+'iibfdra/TrainingBatches/getcount_utrno/',
