	...
	<form class="form-horizontal" autocomplete="off" name="draExamAddFrm" id="draExamAddFrm"  method="post" data-parsley-validate="parsley"  enctype="multipart/form-data" onsubmit ="return form_submit()">
		<section class="content">
			<div class="row">
          		<div class="col-md-12">
					...
					<div class="box box-info">
						...
						<div class="box-body">
							...
							if(count($error_msg)> 0 && is_array($error_msg)){
							...
							<div class="form-group" id="type_div"  >
								...
								<div class="col-sm-3">
									<input  type="radio" class="minimal batch-limit" id="batch_type_50" name="hours" value="50" <?php if($batchs['hours'] == 50) { echo "checked"; } ?>>50 Hour
									<input  type="radio" class="minimal batch-limit" name="hours" id="batch_type_100" value="100" <?php if($batchs['hours'] == 100) { echo "checked"; } ?>>100 Hour
									<br>
									...
									if(!empty($agency_center))
									{
										foreach($agency_center as $val)
										{
											...
											<?php if($val['center_validity_from'] == '' && $val['center_validity_to'] == '' && $val['pay_status']==1){
													...
													elseif($val['center_status'] == 'A' && $val['pay_status'] == 1 && $val['center_validity_to'] > date('Y-m-d') && $val['center_validity_from'] <= date('Y-m-d'))
													{
														$validity_to=$val['center_validity_to'];
														$validity_from=(date('Y-m-d',strtotime("+6 day", strtotime($val['center_validity_from']))));	?>
														<option  <?php echo (set_value('center_id')==$val['center_id'])?" selected=' selected'":""?>   value="<?php echo $val['center_id']; ?>" data-todate="<?php echo $val['center_validity_to']; ?>" <?php if ($val['center_id'] == $batchs['center_id']) { echo "selected"; } ?> ><?php echo $val['location_name']; if($val['center_id'] == '3039') { echo ' - Wagholi'; } ?> </option>
														<?php }elseif( $val['center_validity_to']< date('Y-m-d')  && $val['pay_status'] == 1)
															{ }elseif($val['center_status'] == 'R') { }elseif($val['center_status'] == 'IR'){ }
                  ...
                  <span class="note">Note: Please Select the Date between <?php echo date('Y-m-d', strtotime("0day", strtotime($date_check))); ?> and <?php echo date('Y-m-d', strtotime("+4day", strtotime($date_check))); ?></span></br>
								...
								<div class="col-sm-3">
									...
									<span class="error note-error batch-limit-error" id="batch_to_error">
                  ...
                  <div class="col-sm-2">
                      From
                      <input type="text" class="form-control break-time" id="time1_from" name="time1_from" required value="<?php echo $batchs['brk_from_time1']; ?>" autocomplete="off" maxlength="10"/>
                  </div>
                  <div class="col-sm-2">
                      To
                      <input type="text" class="form-control break-time" id="time1_to" name="time1_to" required value="<?php echo $batchs['brk_to_time1']; ?>" autocomplete="off" maxlength="10"/>
                  </div>
                  <div class="col-sm-3">
                      Duration
                      <input type="text"  id="brk_time1" class="form-control netTime breakTime time_7" name="brk_time1" value="<?php echo $batchs['brk_time1']; ?>" readonly>
              ...
              <div class="form-group datepairbreaktimes">
                  ...
                  <div class="col-sm-2">
                      From
                      <input type="text" class="form-control break-time" id="time2_from" name="time2_from" value="<?php echo $batchs['brk_from_time2']; ?>" autocomplete="off" maxlength="10"/>
                  </div>
                  <div class="col-sm-2">
                      To
                      <input type="text" class="form-control break-time" id="time2_to" name="time2_to" value="<?php echo $batchs['brk_to_time2']; ?>" autocomplete="off" maxlength="10"/>
                  </div>
                  <div class="col-sm-3">
                      Duration
                      <input type="text"  id="brk_time2" class="form-control netTime breakTime time_7" name="brk_time2" value="<?php echo $batchs['brk_time2']; ?>" readonly>
                       <!-- readonly="readonly" autocomplete="off" -->
                      <span class="note-error" id="gross_time_error"></span>
                  </div>
              </div>
              ...
              <div class="form-group datepairbreaktimes">
                  ...
                  <div class="col-sm-2">
                      From
                      <input type="text" class="form-control break-time" id="time3_from" name="time3_from" value="<?php echo $batchs['brk_from_time3']; ?>" autocomplete="off" maxlength="10"/>
                  </div>
                  <div class="col-sm-2">
                      To
                      <input type="text" class="form-control break-time" id="time3_to" name="time3_to" value="<?php echo $batchs['brk_to_time3']; ?>" autocomplete="off" maxlength="10"/>
                  </div>
                  <div class="col-sm-3">
                      Duration
                      <input type="text"  id="brk_time3" class="form-control netTime breakTime time_7" name="brk_time3" value="<?php echo $batchs['brk_time3']; ?>" readonly>
                       <!-- readonly="readonly" autocomplete="off" -->
                      <span class="note-error" id="gross_time_error"></span>
                  </div>
              </div>
		                    ...
		                    <div class="form-group">
		                        ...
		                        <div class="col-sm-3">
		                            ...
		                            <input type="text" class="form-control" name="total_net_time" id="total_net_time" placeholder="Net Training Time of the Batch" value="<?php echo $batchs['total_net_time']; ?>" readonly="readonly">
		                    ...
		                    <div class="form-group">
                              ...
                              1st Faculty (For Basic Banking) <span class="mandatory-field">*</span>
		                            <select class="form-control faculty-section" id="first_faculty" data-error="first_faculty_error" name="first_faculty" onchange="get_faculty(event)"  required="" data-parsley-trigger="focusout">
		                               ...
		                               ?>
		                                <option value="<?php echo $value['faculty_id']; ?>" <?php if(!empty($batchs['first_faculty']) && $batchs['first_faculty'] == $value['faculty_id']){ echo 'selected="selected"'; } ?> data-code="<?php echo $value['faculty_code']; ?>"><?php echo $value['faculty_code']."_".$value['faculty_name'].$facLanguages; ?></option>
		                                <?php }?>
		                            </select>
		                            <span class="first_faculty_error note-error fac-errr" id="first_faculty_error"><?php echo form_error('first_faculty');?></span>
		                        </div>

		                        <div class="col-sm-4">
		                            2nd Faculty (For Soft Skill in Banking) <span class="mandatory-field">*</span>
		                            <select class="form-control faculty-section" id="sec_faculty" data-error="sec_faculty_error" name="sec_faculty" last_val="" onchange="get_faculty(event)"  required="" data-parsley-trigger="focusout">
		                            <option value="">Select Faculty</option>
		                            <?php foreach ($soft_faculty_data as $key => $value) { 
		                            	$facLanguages = $value['languages']!='' ? '_'.str_replace(',', '_', $value['languages']):'';
		                               ?>
		                            <option value="<?php echo $value['faculty_id']; ?>" <?php if(!empty($batchs['sec_faculty']) && $batchs['sec_faculty'] == $value['faculty_id']){ echo 'selected="selected"'; } ?> data-code="<?php echo $value['faculty_code']; ?>"><?php echo $value['faculty_code']."_".$value['faculty_name'].$facLanguages; ?></option>
		                            <?php }?>
		                            </select>
		                          <span class="sec_faculty_error note-error fac-errr" id="sec_faculty_error"><?php echo form_error('sec_faculty');?></span>
		                        </div>  
		                    </div>
		                        ...
		                        <div class="col-sm-4">
		                            ...
		                            <select class="form-control faculty-section" id="additional_first_faculty" data-error="additional_first_faculty_error" last_val="" name="additional_first_faculty" onchange="get_faculty(event)" data-parsley-trigger="focusout">
		                                ...
		                                <?php foreach ($basic_faculty_data as $key => $value) { 
		                                	$facLanguages = $value['languages']!='' ? '_'.str_replace(',', '_', $value['languages']):'';
		                               ?>
		                                <option value="<?php echo $value['faculty_id']; ?>" <?php if(!empty($batchs['additional_first_faculty']) && $batchs['additional_first_faculty'] == $value['faculty_id']){ echo 'selected="selected"'; } ?> data-code="<?php echo $value['faculty_code']; ?>"><?php echo $value['faculty_code']."_".$value['faculty_name'].$facLanguages; ?></option>
		                                <?php }?>
		                            </select>
		                            <span class="first_faculty_error note-error fac-errr" id="additional_first_faculty_error"><?php //echo form_error('faculty_qualification');?></span>
		                        </div>
		                        ...
		                        <div class="col-sm-4">
		                            ...
		                            <select class="form-control faculty-section" id="additional_sec_faculty" data-error="additional_sec_faculty_error" last_val="" name="additional_sec_faculty" onchange="get_faculty(event)" data-parsley-trigger="focusout">
		                                ...
		                                <?php foreach ($soft_faculty_data as $key => $value) { 
		                                	$facLanguages = $value['languages']!='' ? '_'.str_replace(',', '_', $value['languages']):'';
		                               ?>
		                                <option value="<?php echo $value['faculty_id']; ?>" <?php if(!empty($batchs['additional_sec_faculty']) && $batchs['additional_sec_faculty'] == $value['faculty_id']){ echo 'selected="selected"'; } ?> data-code="<?php echo $value['faculty_code']; ?>"><?php echo $value['faculty_code']."_".$value['faculty_name'].$facLanguages; ?></option>
		                                <?php }?>
		                            </select>
		                          <span class="sec_faculty_error note-error fac-errr" id="additional_sec_faculty_error"><?php //echo form_error('faculty_qualification');?></span>
		                        </div>
		                    </div>
               ...
               { ?>
			                ...
			                <div class="form-group">
			                  ...
			                  <div class="col-sm-6">
			                    <input type="text" class="form-control" id="cctv_link" name="cctv_link" autocomplete="off" maxlength="500" placeholder="" data-parsley-trigger="focusin focusout" value="<?php echo $batchs['cctv_link']; ?>" required>
			                ...
			                <div class="form-group">
								<label for="center" class="col-sm-3 control-label"> Batch Center <span class="mandatory-field">*</span></label>
								<div class="col-sm-5">
									<?php if($batchs['city_name']!="")
										{
											$location = $batchs['city_name'];
										...
										$location = $batchs['batch_center_id'] !='' ? $location : 'Select';
									?>
									<select class="form-control netTime" id="batch_center_id" name="batch_center_id" required data-parsley-trigger="focusout">
									<option value="<?php echo $batchs['batch_center_id'];?>"><?php echo $location; ?></option>
									<?php $validity_to=$validity_from='';
									if(!empty($agency_center))
									{
										foreach($agency_center as $val)
										{
											...
											<?php if($val['center_validity_from'] == '' && $val['center_validity_to'] == '' && $val['pay_status']==1){
													...
													elseif($val['center_status'] == 'A' && $val['pay_status'] == 1 && $val['center_validity_to'] > date('Y-m-d') && $val['center_validity_from'] <= date('Y-m-d'))
													{
														$validity_to=$val['center_validity_to'];
														$validity_from=(date('Y-m-d',strtotime("+6 day", strtotime($val['center_validity_from']))));	?>
														<option  <?php echo ($batchs['batch_center_id']==$val['center_id'])?" selected=' selected'":""?>   value="<?php echo $val['center_id']; ?>"><?php echo $val['location_name']; if($val['center_id'] == '3039') { echo ' - Wagholi'; } ?> </option>
														<?php }elseif( $val['center_validity_to']< date('Y-m-d')  && $val['pay_status'] == 1)
															{ }elseif($val['center_status'] == 'R') { }elseif($val['center_status'] == 'IR'){ }
															elseif($val['center_status'] == 'AR'){ }
															elseif($val['center_status'] == 'A' && $val['pay_status'] == 2) { }
									...
									<!-- <div id="validdate" style="display:none;" ><?php echo $validity_to?></div>
									<input type="hidden" autocomplete="false" value="<?php echo $validity_to; ?>" id='validity_to' name='validity_to'/>
									<input type="hidden" autocomplete="false" value="<?php echo $validity_from; ?>" id='validity_from' name='validity_from'/> -->
								</div>
							</div>
			                ...
			                <div class="form-group">
			                  ...
			                  <div class="col-sm-6">
			                    <textarea style="width:100%; text-align:left;" class="form-control" id="center_address" name="center_address" value="<?php echo set_value('center_address'); ?>" autocomplete="off" maxlength="500" placeholder="" data-parsley-trigger="focusin focusout" required> <?php echo $batchs['center_address']; ?> </textarea>
							...
							<div id="batch_online_users_outer" style="display:none;">
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-sm-6">
	                                    <input type="text" class="form-control" id="platform_link" name="platform_link" value="<?php echo $batchs['platform_link']; ?>" autocomplete="off" maxlength="500" placeholder="" data-parsley-trigger="focusin focusout">
	                            ...
	                            <div class="form-group">
	                                ...
	                                <div class="col-sm-6">
	                                    <input type="text" class="form-control" id="preparatory_session_link" name="preparatory_session_link" value="<?php echo $batchs['preparatory_session_link']; ?>" autocomplete="off" maxlength="500" placeholder="" data-parsley-trigger="focusin focusout">
		          		...
		          		<input type="hidden" id="batchLimit_err" value="">
...
<script type="text/javascript">	
  ...
  checkBatchLimit($('input[name="hours"]:checked').val(),$('#batch_from').val(),$('#batch_to').val());

	var base_url = '<?php echo base_url(); ?>';
	var batchId = "<?php echo $bid; ?>";

	var batch_center_id  = "<?php echo $location; ?>";

	$('#batch_center_id').on('change',function() 
  {
    batch_center_id = $('#batch_center_id').val();
  ...
  function getCenrerAddress(batch_center_id)
  {
	...
	$(document).ready(function()
	{
		...
		// simulateChangeEvent('additional_sec_faculty');
	    // simulateChangeEvent('additional_first_faculty');
	    // simulateChangeEvent('sec_faculty');
	    // simulateChangeEvent('first_faculty');
    ...
    $('.period').on('change', debounce(function() {
      ...
      if ($(this).attr('id') == 'batch_from' ||  $(this).attr('id') == 'batch_to') {
	      var fromDate  = $('#batch_from').val();
	      var toDate    = $('#batch_to').val();
    ...
    function simulateChangeEvent(elementId) {
    ...
    function get_faculty(event) 
	{
		...
		{  
		    ...
		    $.ajax({
		      type: 'POST',
		        data: {'faculty_id':value,'type':'edit','batch_id':batchId,'faculty_code':code, 'from_date':from_date, 'to_date':to_date},
		      url: site_url + 'iibfdra/Version_2/TrainingBatches/check_faculty_mapping/',
		        dataType: 'JSON',
  ...
  function validateDate()
  {
	...
	if ($('#brk_time1').val() == 0) {
		$('#time1_from,#time1_to').val('');
	} 
	if ($('#brk_time2').val() == 0) {
		$('#time2_from,#time2_to').val('');
	}
	if ($('#brk_time3').val() == 0) {
		$('#time3_from,#time3_to').val('');
	}    
