...
?>
  <form class="form-horizontal" name="frmDrACenter" id="frmDrACenter"  method="post" action="<?php echo base_url();?>iibfdra/Version_2/Center/edit/<?php if($edit_id != ''){ echo $edit_id; }else{ echo '';} ?>" enctype="multipart/form-data" data-parsley-validate="parsley">
        ...
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header with-border">
              ...
              <div class="pull-right"> <a href="<?php echo base_url();?>iibfdra/Version_2/Center/listing" class="btn btn-warning">Back</a> </div>
            </div>
            <div class="box-body">
              ...
              <div class="T divbox">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <?php if($centerResult[0]['cv1']!='')
                    {?>
                     <a href="<?php echo base_url()?>/uploads/iibfdra/Version_2/agency_center/faculty_cv/<?php echo $centerResult[0]['cv1'];?>" target="_blank"><?php echo $centerResult[0]['cv1'];?></a>
                    <?php 
                     }else{
                     }?>
                ...
                <div class="form-group">
                  ...
                  <?php if($centerResult[0]['cv2']!='')
                    {?>
                     <a href="<?php echo base_url()?>/uploads/iibfdra/Version_2/agency_center/faculty_cv/<?php echo $centerResult[0]['cv2'];?>" target="_blank"><?php echo $centerResult[0]['cv2'];?></a>
                    <?php 
                     }?>
                ...
                <div class="form-group">
                  ...
                  <?php if($centerResult[0]['cv3']!='')
                    {?>
                     <a href="<?php echo base_url()?>/uploads/iibfdra/Version_2/agency_center/faculty_cv/<?php echo $centerResult[0]['cv3'];?>" target="_blank"><?php echo $centerResult[0]['cv3'];?></a>
                    <?php 
                     }?>
                ...
                <div class="form-group">
                  ...
                  <?php if($centerResult[0]['cv4']!='')
                    {?>
                     <a href="<?php echo base_url()?>/uploads/iibfdra/Version_2/agency_center/faculty_cv/<?php echo $centerResult[0]['cv4'];?>" target="_blank"><?php echo $centerResult[0]['cv4'];?></a>
                    <?php 
                     }?>
                ...
                <div class="form-group">
                  ...
                  <?php if($centerResult[0]['cv5']!='')
                    {?>
                     <a href="<?php echo base_url()?>/uploads/iibfdra/Version_2/agency_center/faculty_cv/<?php echo $centerResult[0]['cv5'];?>" target="_blank"><?php echo $centerResult[0]['cv5'];?></a>
                    <?php 
                     }?>
                 ...
                 <div class="form-group">
                  ...
                  <input type="file" name="upload_file1" id="upload_file1" value="<?php echo $centerResult[0]['upload_file1'];?>" onChange="validateFileType('upload_file1')" >  <?php if($centerResult[0]['upload_file1']!='')
				   {?>
                     <a href="<?php echo base_url()?>/uploads/iibfdra/Version_2/agency_center/<?php echo $centerResult[0]['upload_file1'];?>" target="_blank"><?php echo $centerResult[0]['upload_file1'];?></a>
				<?php 
				 }?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5" id="">
                    <input  type="file" name="upload_file2" id="upload_file2" value="<?php echo $centerResult[0]['upload_file2'];?>" onChange="validateFileType('upload_file2')" accept=".jpg,.jpeg,.png,.pdf" > <?php if($centerResult[0]['upload_file2']!='')
				            {?>
                   <a href="<?php echo base_url()?>/uploads/iibfdra/Version_2/agency_center/<?php echo $centerResult[0]['upload_file2'];?>" target="_blank"><?php echo $centerResult[0]['upload_file2'];?></a>
          				<?php 
          				 }?>
...
if(state_code){ 
  $.ajax({
    type:'POST',
    url: site_url+'iibfdra/Version_2/center/getCityedit',
...
console.log(center_type);
	if(city_id != '' && center_type !='' && center_type !='undefined' && center_id != ''){
		$.ajax({
			type:'POST',
			url: site_url+'iibfdra/Version_2/Center/validateEditCity',
