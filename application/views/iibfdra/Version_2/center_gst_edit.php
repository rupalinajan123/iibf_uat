...
<div class="content-wrapper">
  ...
  <form class="form-horizontal" name="center_gst_edit" id="center_gst_edit"  method="post"  enctype="multipart/form-data" 
    action="">
        ...
        <div class="col-md-12">
          <div class="box box-info">
           ...
           if(validation_errors()!=''){?>
            ...
            <?php if(isset($center_view[0]['gstin_no']) && ($center_view[0]['gstin_no'] != '' && $center_view[0]['gstin_no'] != '-')) {?>
            <div class="form-group">
            ...
            <?php } else { ?>
              ...
              <label for="roleid" class="col-sm-4 control-label">GST No</label>
              <div class="col-sm-6">
                <input type="text" class="form-group form-data form-control" name="gstin_no" id="gstin_no" >
              </div>
            </div>
            <?php } ?>              
            
            <?php 
            // if(isset($center_view[0]['gstin_no']) && ($center_view[0]['gstin_no'] != '' && $center_view[0]['gstin_no'] != '-')) {?>
            <div class="form-group"> 
            ...
            <?php // } ?>
            <input type="hidden" name="center_id" value="<?php echo $center_view[0]['center_id']; ?>">
              ...
              <!-- <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input type="radio" class="chk1" id="invoice_flag"  name="invoice_flag"  value="AS" <?php if($centerResult[0]['invoice_flag'] == "AS"){ ?> checked="checked"<?php } ?> required <?php if($center_view[0]['invoice_flag'] == "AS") { echo "checked"; } ?>>
                </div>
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-6">
                  <input type="radio" class="chk2" id="invoice_flag"  name="invoice_flag"  value="CS" <?php if($centerResult[0]['invoice_flag'] == "CS"){ ?> checked="checked" <?php } ?> required <?php if($center_view[0]['invoice_flag'] == "CS") { echo "checked"; }?>>
                </div>
              </div> -->
            ...
            <?php } else { ?>
              ...
              <div class="col-sm-6 col-sm-offset-3">
                <div class="col-sm-12">
                  <center>
                    <input type="submit" class="btn btn-primary" id="edit_gst" name="edit_gst" value="Update"></input>
                  </center>
                </div>
              </div>
            </div>
