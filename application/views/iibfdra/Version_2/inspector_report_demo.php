...
<div class="content-wrapper"> 
  ...
  <section class="content">
    ...
    <form method="post" name="appfrom" action="<?php echo base_url(); ?>iibfdra/Version_2/InspectorHomeDemo/save_inspection_report" id="inspector_from"  enctype="multipart/form-data" >
      <div class="row">
        <div class="col-md-12">
  ...
  $(function () {
    ...
    $('#batch_idss').on('change',function () {
      ...
      if(batch_id != ''){
        ...
        $('#assigned_faculty1').attr('href',site_url+'iibfdra/Version_2/InspectorHomeDemo/faculty_view/'+btoa(assigned_facultyid1));
        $('#additional_faculty1').text(additional_faculty1);
        $('#additional_faculty1').attr('href',site_url+'iibfdra/Version_2/InspectorHomeDemo/faculty_view/'+btoa(additional_facultyid1));
        $('#assigned_faculty2').text(assigned_faculty2);
        $('#assigned_faculty2').attr('href',site_url+'iibfdra/Version_2/InspectorHomeDemo/faculty_view/'+btoa(assigned_facultyid2));
        $('#additional_faculty2').text(additional_faculty2);
        $('#additional_faculty2').attr('href',site_url+'iibfdra/Version_2/InspectorHomeDemo/faculty_view/'+btoa(additional_facultyid2));
        ...
        $.ajax({
          url:site_url+'iibfdra/Version_2/InspectorHomeDemo/get_candidate_data',
    ...
    //           $.ajax(
    //         {
    //             url: site_path+"iibfdra/Version_2/InspectorHomeDemo/save_inspection_report",
    //             type: 'POST',
    //             data: formData,
    //             contentType: false,
    //             cache: false,
