  ...
  <section class="content">
    <div class="row">
      ...
      <?php }?> 
        ...
        <form class="form-horizontal" autocomplete="off" action="<?php echo base_url('iibfdra/Version_2/TrainingBatches/editOtherDetails').'/'.base64_encode($candidate_id).'/'.$redirection; ?>" name="draExamAddFrm" id="draExamAddFrm"  method="post"  enctype="multipart/form-data" data-parsley-validate>
          ...
          <div class="box box-info" id="basic_details_div">
            <div class="box-header with-border">
              ...
              <div class="pull-right">
                  ...
                  { ?>
                    <a href="<?php echo base_url('iibfdra/Version_2/TrainingBatches/allapplicants/'.base64_encode($_SESSION['excode'])); ?>" class="btn btn-warning">Back</a> 
                  <?php } 
                  else 
                  { ?>
                    <a href="<?php echo base_url('iibfdra/Version_2/TrainingBatches/candidate_list/'.base64_encode($examRes['batch_id'])); ?>" class="btn btn-warning">Back</a> 
                  <?php } ?>
                </div>
            </div>
            ...
            <div class="box-body"> 
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  ...
                  <input type="text" name="firstname" id="firstname" class="form-control"   placeholder="First Name" value="<?php echo $candidate_details['firstname'];?>" autocomplete="off" onkeypress="return onlyAlphabets(event)" required maxlength="30" data-parsley-pattern="^[A-Z ]+$" data-parsley-pattern-message="Please enter only uppercase letters." data-parsley-trigger="focusin focusout">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  Middle Name
                  <input type="text" class="form-control" id="middlename" name="middlename" placeholder="Middle Name" value="<?php echo $candidate_details['middlename'];?>" autocomplete="off" onkeypress="return onlyAlphabets(event)" maxlength="30" data-parsley-pattern="^[A-Z ]+$" data-parsley-pattern-message="Please enter only uppercase letters." data-parsley-trigger="focusin focusout">
                ...
                <div class="col-sm-3">
                  ...
                  <input type="text" class="form-control" id="lastname" name="lastname" placeholder="Last Name" value="<?php echo $candidate_details['lastname'];?>" autocomplete="off" onkeypress="return onlyAlphabets(event)" maxlength="30" data-parsley-pattern="^[A-Z ]+$" data-parsley-pattern-message="Please enter only uppercase letters." data-parsley-trigger="focusin focusout">
              ...
              <div class="form-group">
                <label for="source_of_candidate" class="col-sm-3 control-label">Source Of Candidate <span class="mandatory-field">*</span></label>
                <div class="col-sm-2 example">
                  <input type="text" class="form-control" id="source_of_candidate" name="source_of_candidate" placeholder="Source Of Candidate" value="<?php echo $candidate_details['source_of_candidate'];?>" autocomplete="off" data-parsley-required data-parsley-maxlength="50" data-parsley-errors-container="#source_of_candidate_error"/>  
                  
                  <span id="source_of_candidate_error" class="note-error"></span>
                  <span class="error"></span>
                </div>
              </div>
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    ...
                    <input type="text" class="form-control form2_element" id="addressline1" name="addressline1" placeholder="Address line 1" value="<?php echo $candidate_details['address1'];?>"  autocomplete="off" required maxlength="30" data-parsley-maxlength="30" data-parsley-trigger="focusin focusout" readonly>
                    <span class="error"></span>
                  </div> 

                  <div class="col-sm-4">
                    Line 2
                    <input type="text" class="form-control" id="addressline2" name="addressline2" placeholder="Address line 2" value="<?php echo $candidate_details['address2'];?>" autocomplete="off" maxlength="30" data-parsley-maxlength="30" data-parsley-trigger="focusin focusout" readonly>
                    <span class="error"></span>
                  </div> 
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    Line 3
                    <input type="text" class="form-control" id="addressline3" name="addressline3" placeholder="Address line 3"value="<?php echo $candidate_details['address3'];?>" autocomplete="off" maxlength="30" data-parsley-maxlength="30" data-parsley-trigger="focusin focusout" readonly>
                    <span class="error"></span>
                  </div> 

                  <div class="col-sm-4">
                    Line 4
                    <input type="text" class="form-control" id="addressline4" name="addressline4" placeholder="Address line 4"value="<?php echo $candidate_details['address4']; ?>" autocomplete="off" maxlength="30" data-parsley-maxlength="30" data-parsley-trigger="focusin focusout" readonly>
                    <span class="error"></span>
                  </div> 
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <select class="form-control form2_element" id="ccstate" name="state" required onchange="get_city_ajax()" disabled>
                      <option value="">Select</option>
                ...
                <div class="form-group">
                  <label for="district" class="col-sm-3 control-label">District <span class="mandatory-field">*</span></label>
                    <div class="col-sm-4">
                      <input type="text" class="form-control form2_element" id="district" name="district" placeholder="District" required value="<?php echo $candidate_details['district']; ?>"  autocomplete="off" data-parsley-maxlength="30" maxlength="30" data-parsley-trigger="focusin focusout" readonly>
                      <span class="error"></span>
                    </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    <select class="form-control city form2_element" id="city" name="city" required disabled>
              ...
              <div class="box box-info custom_sub_header" id="photo_div">
                ...
                <div class="box-body">
                  ...
                  <div class="form-group idproof-wrap">
                    <label for="id_proof" class="col-sm-3 control-label"></label>
                    <div class="col-sm-5">
                  ...
                  <div class="form-group idproof-wrap">
                    ...
                    <div class="col-sm-5">
                      <?php if (count($idtype_master) > 0) 
                      {
                        ...
                        { ?>
                          <label class="radio_btn_label">
                            <input name="idproof" value="<?php echo $idrow['id']; ?>" type="radio" class="btn_check form2_element" <?php if(isset($examRes['idproof']) && $examRes['idproof'] == $idrow['id']){ echo 'checked="checked"'; } ?> required data-parsley-errors-container="#idproof_error" disabled><?php echo $idrow['name']; ?>
                          </label><br>
                          <?php $i++;
                        }
                      } ?>
                  ...
                  <div class="form-group">
                    <label for="id_proof" class="col-sm-3 control-label">ID Proof No.(No. of selected ID Proof) <span class="mandatory-field">*</span></label>
                    <div class="col-sm-5" id="id_no_proof">
                      <input type="text" class="form-control form2_element" id="idproof_no" name="idproof_no" placeholder="ID Proof No.(No. of selected ID Proof)" value="<?php echo $examRes['idproof_no'];?>" autocomplete="off" required data-parsley-errors-container="#idproof_no_error" data-parsley-idproof_exist data-parsley-trigger= focusout data-parsley-idproof_exist-message="This ID Proof is already Exists." readonly>
                  ...
                  <div class="form-group">
                    <div id="exist_draidproofphoto" <?php echo $style1; ?>>
                      <label for="id_proof" class="col-sm-3 control-label">Proof of Identity (upload copy of selected ID proof) <span class="mandatory-field">*</span></label>
                      <div class="col-sm-5">
                    ...
                    <?php if(!empty($examRes['idproofphoto'])){?> 
                      <div class="col-sm-12" id="idproofphoto_show">
                        <div class="form-group">
                          <label for="exampleInputName1" class="col-sm-3 control-label"><b>Proof of Identity (upload copy of selected ID proof) </b></label>
                          <div class="col-sm-5">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      ...
                      <?php } 
                        ...
                        <label class="radio_btn_label">
                          <input type="radio" class="radiocls form2_element" id="tenth" name="education_qualification" value="tenth" <?php if(isset($examRes['qualification']) && $examRes['qualification'] == 'tenth') { echo 'checked="checked"'; }; ?> required data-parsley-errors-container="#education_qualification_error" disabled>10th Pass
                        </label>
                        <label class="radio_btn_label">
                          <input type="radio" class="radiocls form2_element" id="twelth" name="education_qualification" value="twelth" <?php if(isset($examRes['qualification']) && $examRes['qualification'] == 'twelth') { echo 'checked="checked"'; }; ?> required data-parsley-errors-container="#education_qualification_error" disabled>12th Pass
                        </label>
                      <?php } ?>
                      
                      <label class="radio_btn_label">  
                        <input type="radio" class="radiocls form2_element" id="graduate" name="education_qualification" value="graduate" <?php if(isset($examRes['qualification']) && $examRes['qualification'] == 'graduate') { echo 'checked="checked"'; }; ?> required data-parsley-errors-container="#education_qualification_error" disabled>Graduation
                      </label>
                      <label class="radio_btn_label">  
                        <input type="radio" class="radiocls form2_element" id="post_graduate" name="education_qualification" value="post_graduate" <?php if(isset($examRes['qualification']) && $examRes['qualification'] == 'post_graduate') { echo 'checked="checked"'; }; ?> required data-parsley-errors-container="#education_qualification_error" disabled>Post Graduation
                      </label>
                  ...
                  <div class="form-group">
                    <div id="exist_qualicertificate" <?php echo $style2; ?>>
                      ...
                      <div class="col-sm-5" id="exist_qualicertificate">
                        <input type="file" name="qualicertificate" id="qualicertificate" class="form-control" autocomplete="off" onchange="validateFile(event, 'error_qualicert', 'qualicertificate_preview', '200kb')" <?php if(empty($examRes['quali_certificate'])){ echo 'data-parsley-required'; }?>> (As per educational qualification selected above)
                        ...
                        <span class="note" id="idproof_preview_note">Note: Please Upload only .jpg, .jpeg, .png Files upto 200KB in 100*120 pixel dimensions.</span></br>
                      ...
                      <div class="col-sm-12" id="quali_certificate_show">
                        <div class="form-group">
                          ...
                          <div class="col-sm-5">
                            ...
                            <?php if( isset($candidate_logs[0]['form_type']) && ($candidate_logs[0]['form_type'] == 'invalid_qual' || $candidate_logs[0]['form_type'] == 'invalid_all') ) { ?>
                  ...
                  <div class="form-group">
                    <div id="exist_drascannedphoto" <?php echo $style3; ?>>
                      <label for="photograph" class="col-sm-3 control-label">Recent Photograph of the Candidate (Passport Size) <span class="mandatory-field">*</span></label>
                    ...
                    <?php if(!empty($examRes['scannedphoto'])){?> 
                      <div class="col-sm-12" id="scannedphoto_show">
                        <div class="form-group">
                          <label for="exampleInputName1" class="col-sm-3 control-label"><b>Recent Photograph of the Candidate (Passport Size) </b></label>
                          <div class="col-sm-5">
                            <img style="width: 25%;height: 25%;" src="<?php echo base_url(); ?>uploads/iibfdra/<?php echo $examRes['scannedphoto']; ?>" />
                            <?php if( isset($candidate_logs[0]['form_type']) && ($candidate_logs[0]['form_type'] == 'invalid_photo' || $candidate_logs[0]['form_type'] == 'invalid_all') ) { ?>
          ...
          <?php 
          if($show_form_flag == 0) { redirect(site_url('iibfdra/Version_2/TrainingBatches/candidate_list/'.$batchId)); } ?>
        </form>
      </div>
    </div>
  </section>
...
<script type="text/javascript">
  ...
  function is_mobile_no() 
  {
    ...
    $.ajax({
      url: base_url + "iibfdra/Version_2/TrainingBatches/check_mobile_no",
      method: "POST",
      async: true,
      data: {
        mobile_no: mobile,
  ...
  function is_idproof() 
  {
    ...
    $.ajax({
      url: base_url + "iibfdra/Version_2/TrainingBatches/check_idproof",
      method: "POST",
      async: false,
      data: {
        idproof: idproof,
  ...
  function is_email_check() 
  {
    ...
    var email   = $('#email').val();  
    $.ajax({
      url: base_url + "iibfdra/Version_2/TrainingBatches/check_email",
      method: "POST",
      async: true,
      data: {
        email: email,
  ...
  function is_aadhar_no_check(evt) 
  {
    ...
    $.ajax({
      url: base_url + "iibfdra/Version_2/TrainingBatches/check_aadhar_no",
      method: "POST",
      async: false,
      data: {
        aadhar_no: aadhar_no,
  ...
  function get_city_ajax()
  {
    ...
    if (state_code) 
    {
      ...
      $.ajax({
        type: 'POST',
        async: false,
        url: site_url + 'iibfdra/Version_2/TrainingBatches/getCity',
