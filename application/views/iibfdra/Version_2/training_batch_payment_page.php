...
/* Close Code to dyanamic fees - Gaurav */
														...
														<tr>
															...
															<td style="text-align: left;"><?php echo $row['exam_fee'];?></td>
														</tr>
												...
												<?php }
                                                		...
                                                		<tr>
															...
															<td style="text-align: left;"><?php echo number_format((float)$totalpay, 2, '.', ''); ?></td>
														</tr>
													<?php }
											    } 
											    if( count( $idstopay ) > 0 ) {
                                            ...
                                            <tr>
                                                <!-- <td colspan="3" class="tablecontent1" style="text-align:center;">
													<input type='radio' name='pay_mode' id='pay_mode_neft' value='neft_rtgs' <?php if( count( $idstopay ) < 1 ) { echo "disabled='disabled'"; }?> /> NEFT / RTGS 
                                                	<input type='radio' name='pay_mode' id='pay_mode_online' value='online' <?php if( count( $idstopay ) < 1 ) { echo "disabled='disabled'"; }?> /> Online
                                                 </td> -->
                                            </tr>                                        
                                        </tbody>
                                    </table>
                                      ...
                                      <input type="hidden" name="fresh_count" id="fresh_count" value="<?php echo $unit_R;?>">
                                      <input type="hidden" name="rep_count" id="rep_count" value="<?php echo $unit_S1;?>">

                                      <input type="hidden" name="exam_period" id="exam_period" value="<?php echo base64_encode($exam_period);?>">

                                       <a class="btn btn-warning" target="_blank" href="<?php echo base_url().'iibfdra/Version_2/TrainingBatches/performance_invocie/'.$unit_R.'/'.$unit_S1.'/'.$exam_period;?>"  name="p_invocie" id="">Preview Proforma Invoice</a> 
                                      <input class="btn btn-primary" style="margin-left: 349px;" type="submit" value="Generate Proforma Invoice" name="Proforma_Submit" id="Submit" class="button">
                                </form>
                                <br>
...
$(document).ready(function() {
	...
	$("#payModFrm").submit(function(e) {		
		...
		// if( paymethod == 'online' ) {
		// 	frmaction = base_url+'iibfdra/Version_2/TrainingBatches/generate_proforma';
			
		// } else {
		// 	frmaction = base_url+'iibfdra/Version_2/TrainingBatches/make_neft';
		// }
