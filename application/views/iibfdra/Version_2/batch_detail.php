                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td width="50%"><?php if( $result['batch_type'] != '' )	{?>
                        <?php  echo ($result['batch_type'] == 'Separate') ? 'Separate Batch' : "Combine Batch";  ?>
                    ...
                    <tr>
                      <td width="50%"><strong>Net Training Period:</strong></td>
                    ...
                    <tr>
				        ...
				        ?>
                      	...
                      	<td width="50%"><?php echo $hours.'hr : '.$minutes.'min'; ?></td>
                    </tr>
				    
				    <tr>
				    	<?php $net_time = explode(':', $result['gross_time']);?>
				      	<td width="50%"><strong>Net Training Period Time :</strong></td>
                    ...
                    <tr>
                      ...
                      <td width="50%" > &nbsp; <?php if($result['inspector_report'] != ''){ 
					   echo '<a class="btn btn-info btn-xs vbtn" target="_blank" href="'.base_url().'uploads/iibfdra/Version_2/agency_center/'.$result['inspector_report'].'"> &nbsp; &nbsp;View Inspection Report &nbsp;<i class="fa fa fa-file"></i> &nbsp; &nbsp;</a>  &nbsp; &nbsp;';
            ...
            <div class="table-responsive">
              <table id="listitems" class="table table-bordered table-striped dataTables-example">
				...
				if(count($result_student) > 0){
					...
					echo '<td><a class="btn btn-info btn-xs vbtn" href="'.base_url().'iibfdra/Version_2/batch/candidate_detail/'.$res['regid'].'">View</a </td></tr>';
					$k++;	
				}
			}
				?>
  ...
  // }
	...
	$('.approve_batch').click(function(){ 
		...
		if(add_reason == 1){
			...
			$('.reason').attr("placeholder", "Describe not assigned inspector reason here");	
			$('.reason').show();	
