...
<div class="content-wrapper">
  ...
  <form class="form-horizontal" name="drafrmpreview" id="drafrmpreview"  method="post"  enctype="multipart/form-data" 
    action="<?php echo base_url()?>iibfdra/Version_2/Center/register">
           ...
           <?php 
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6"> <?php echo $this->session->userdata['userinfo']['faculty_name1'];?>
                <?php echo "(".$this->session->userdata['userinfo']['faculty_qualification1']. ")";?>
                 &nbsp; <a class="btn  btn-info btn-xs"  href="<?php echo base_url()?>uploads/iibfdra/Version_2/agency_center/faculty_cv/<?php echo $this->session->userdata['userinfo']['cv1'];?> " target="_blank"> View CV </a>
               </div>
            </div>
            ...
            <?php if($this->session->userdata['userinfo']['faculty_name2']==""){ } else{?>
             <div class="form-group">
              ...
              <?php echo"(".$this->session->userdata['userinfo']['faculty_qualification2'].")";?>&nbsp; <a class="btn  btn-info btn-xs"  href="<?php echo base_url()?>uploads/iibfdra/Version_2/agency_center/faculty_cv/<?php echo $this->session->userdata['userinfo']['cv2'];?> " target="_blank"> View CV </a>   </div>
            </div>
            <?php }
            ...
            ?>
             <div class="form-group">
              ...
              <?php echo "(". $this->session->userdata['userinfo']['faculty_qualification3'].")";?> &nbsp; <a class="btn  btn-info btn-xs"  href="<?php echo base_url()?>uploads/iibfdra/Version_2/agency_center/faculty_cv/<?php echo $this->session->userdata['userinfo']['cv3'];?> " target="_blank"> View CV </a> </div>
            </div>
            ...
            ?>
             <div class="form-group">
              ...
              <div class="col-sm-6"> <?php echo $this->session->userdata['userinfo']['faculty_name4'];?>
               <?php  echo "(". $this->session->userdata['userinfo']['faculty_qualification4'].")"; ?>&nbsp; <a class="btn  btn-info btn-xs"  href="<?php echo base_url()?>uploads/iibfdra/Version_2/agency_center/faculty_cv/<?php echo $this->session->userdata['userinfo']['cv4'];?> " target="_blank"> View CV </a> </div>
            </div>
            ...
            ?>
             <div class="form-group">
              ...
              <div class="col-sm-6"> <?php echo $this->session->userdata['userinfo']['faculty_name5'];?> <?php echo"(". $this->session->userdata['userinfo']['faculty_qualification5'].")";?> &nbsp; <a class="btn  btn-info btn-xs"  href="<?php echo base_url()?>uploads/iibfdra/Version_2/agency_center/faculty_cv/<?php echo $this->session->userdata['userinfo']['cv5'];?> " target="_blank"> View CV </a> </div>
            </div>
            ...
            <?php }?>
             <div class="form-group">
              ...
              <div class="col-sm-6"> 
            <a href="<?php echo base_url()?>uploads/iibfdra/Version_2/agency_center/<?php echo $this->session->userdata['userinfo']['upload_file1'];?>" target="_blank"><?php echo $this->session->userdata['userinfo']['upload_file1'];?></a> 
          </div>
            </div>
             <div class="form-group">
              ...
              <div class="col-sm-6"> 
                ...
                {?>
                    <a href="<?php echo base_url()?>uploads/iibfdra/Version_2/agency_center/<?php echo $this->session->userdata['userinfo']['upload_file2'];?>" target="_blank"><?php echo $this->session->userdata['userinfo']['upload_file2'];?></a>
                <?php }else{ echo"-"; }?>
               </div>
            </div>
            <?php }?>
