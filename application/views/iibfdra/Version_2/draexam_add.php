              ...
              <div class="box-footer">
                  <div class="col-sm-4 col-xs-offset-3">
                   ...
                   <!-- <input type="submit" class="btn btn-info" name="btnSubmit" id="btnSubmit" value="Save">-->
                     <button type="button" class="btn btn-default" name="btnReset" id="btnReset" onclick="window.location='<?php echo base_url();?>iibfdra/Version_2/Version_2/DraExam/add/?exCd=<?php echo trim($_GET['exCd']); ?>'">Reset</button>
                    </div>
              </div>
           </div>
        </div>
	...
	$(document).ready(function() {
		...
		$('#new_captcha').click(function(event){
			...
			$.ajax({
				type: 'POST',
				data: sdata,
				url: site_url+'iibfdra/Version_2/Version_2/DraExam/generatecaptchaajax/',
