                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group idproof-wrap">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-5" id="exist_draidproofphoto">
                                        ...
                                        <input type="hidden" autocomplete="false" id="hiddenidproofphoto" name="hiddenidproofphoto" value="<?=$examRes["idproofphoto"]?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5" id="exist_qualicertificate">
                                       ...
                                       (As per educational qualification selected above)
                                         <input type="hidden" autocomplete="false" id="hiddenqualicertificate" name="hiddenqualicertificate" value="<?=$examRes["quali_certificate"]?>">
                                ...
                                <?php /*?><div class="form-group">
                                    ...
                                    <div class="col-sm-5" id="exist_trainingcertificate">
                                        ...
                                        <input type="hidden" autocomplete="false" id="hiddentrainingcertificate" name="hiddentrainingcertificate" value="<?=$examRes["training_certificate"]?>">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-5" id="exist_drascannedphoto">
                                        ...
                                        <?php } ?>
                                         ...
                                         <input type="hidden" autocomplete="false" id="hiddenphoto" name="hiddenphoto" value="<?=$examRes["scannedphoto"]?>">
                                ...
                                <label for="roleid" class="col-sm-3 control-label"> Signature of the Candidate <span class="required-spn">*</span></label>
                                    <div class="col-sm-5" id="exist_drascannedsignature">
                                        ...
                                        <input type="hidden" autocomplete="false" id="hiddenscansignature" name="hiddenscansignature" value="<?=$examRes["scannedsignaturephoto"]?>">
