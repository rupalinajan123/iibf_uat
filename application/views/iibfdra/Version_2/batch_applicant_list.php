...
$(function () {
  ...
  $('#batch_id').on('change',function () {
    ...
    {
      $.ajax({
        url:site_url+'iibfdra/Version_2/TrainingBatches/get_candidate_data',
          ...
          if(res != '')
          {
            ...
            $.each(JSON.parse(res), function(idx, obj) {
              ...
              if(http.status == 404){
                ...
                var photo_url = site_url+"uploads/iibfdra/"+obj.scannedphoto;
                var photo = '<a href="'+photo_url+'" target="_blank"> <img height="90" width="70" id="photo_'+obj.regid+'" src="'+site_url+"uploads/iibfdra/"+obj.scannedphoto+'" alt=""> </a>';
              }
              ...
              if(http.status == 404){
                ...
                var signature_url = site_url+"uploads/iibfdra/"+obj.scannedsignaturephoto;
                var signature = '<a href="'+signature_url+'" target="_blank"> <img height="90" width="70" id="photo_'+obj.regid+'" src="'+site_url+"uploads/iibfdra/"+obj.scannedsignaturephoto+'" alt=""> </a>';
              }
              ...
              if(http.status == 404){
                ...
                var quali_certificate_url = site_url+"uploads/iibfdra/"+obj.quali_certificate;
                var quali_certificate = '<a href="'+quali_certificate_url+'" target="_blank"><img height="90" width="70" id="photo_'+obj.regid+'" src="'+site_url+"uploads/iibfdra/"+obj.quali_certificate+'" alt=""> </a>';
              }
              ...
              if(http.status == 404){
                ...
                var idproofphoto_url = site_url+"uploads/iibfdra/"+obj.idproofphoto;
                var idproofphoto = ' <a href="'+idproofphoto_url+'" target="_blank"> <img height="90" width="70" id="photo_'+obj.regid+'" src="'+site_url+"uploads/iibfdra/"+obj.idproofphoto+'" alt=""></a>';
              }
