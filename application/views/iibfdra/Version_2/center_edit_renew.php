...
?>
  <form class="form-horizontal" name="frmDrACenter" id="frmDrACenter"  method="post" action="<?php echo base_url();?>iibfdra/Version_2/CenterRenew/edit/<?php if($edit_id != ''){ echo $edit_id; }else{ echo '';} ?>" enctype="multipart/form-data" data-parsley-validate="parsley">
