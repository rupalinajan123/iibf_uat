      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <div class="form-group">
              ...
              if(count($cities) > 0){
                  foreach($cities as $row){   
                      ...
                      {
                        $CenterName = base64_encode($row['city_name']);
                        echo  $row['city_name'];
                      } 
                  } 
                } 
            ...
            <!-- <div class="form-group">
              <label for="roleid" class="col-sm-4 control-label">Center Registration Receipt</label>
              <div class="col-sm-6"><?php if( isset($CenterPayDetails[0]['invoice_image']) && $CenterPayDetails[0]['invoice_image'] != "")
              { ?> 
                <a href="<?php echo base_url('/uploads/drainvoice/supplier/').'/'.$CenterPayDetails[0]['invoice_image']; ?>">Receipt </a>
              <?php }else{ echo $center_view[0]['remarks'];}?> </div>
            </div> -->

            <div class="form-group">
              <label for="roleid" class="col-sm-4 control-label">Invoice Address</label>
              <div class="col-sm-6"> 
               <?php if($center_view[0]['invoice_flag']=='CS')
               {?>
            ...
            <?php if($center_view[0]['pay_status'] == '1' && count($pay_amount)>0){?>
              <!-- Accreditation amount commented by gaurav when center renew module -->
              <!-- <div class="form-group">
            ...
            <div class="box-footer">
              <div class="col-sm-6 col-sm-offset-3">
                <div class="col-sm-12">
                  <center>
                    <a class="btn btn-success" id="make_payment" name="make_payment" href="<?php echo base_url();?>iibfdra/Version_2/Center/goToCenterPayment/<?php echo base64_encode($center_view[0]['center_id']).'/'.$CenterName;?>">Make Payment</a>
                  </center>
                </div>
              </div>
            </div>
            ...
            if($center_view[0]['center_status'] == 'A' && $center_view[0]['pay_status'] != '1' && $center_view[0]['center_type'] == 'R')   	 {  
                    ...
                    <div class="box-footer">
                      <div class="col-sm-6 col-sm-offset-3">
                        <div class="col-sm-12">
                          <center>
                            <a class="btn btn-success" id="make_payment" name="make_payment" href="<?php echo base_url();?>iibfdra/Version_2/CenterRenew/regular">Renew Regular Center</a>
                          </center>
                        </div>
                      </div>
                    </div> 	  
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Center Registration Payment</h3>
            </div>                        
              <div class="box-body">
