...
<table width="980px" border="0" cellspacing="0" cellpadding="0" class="bordeTable" align="center">
  ...
  <tr>
    ...
    <p><strong>State:</strong><span class="uppercaseText"> <?php echo $institute_state?></span></p>
    <p><strong>State Code:</strong> <?php echo $institute_state_code?></p>
    <p><strong>GSTIN / Unique Id: </strong><span class="uppercaseText"><?php echo $institute_gstn?></span></p>
    </td>
    <td>&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td style="border-bottom: none;"><p><?php echo $city_name; ?> Renewal Fee </p></td>
        <td style="border-bottom: none;"><p>999294</p></td>
        <td style="border-bottom: none;"><p><?php echo $MainbaseAmount;?></p></td>
        <td style=" border-bottom: none;"><p><?php echo $qty;?></p></td>
        <td style="border-right: none; border-bottom:none; "><p><?php echo $baseAmount;?></p></td>
      </tr>
      
      <tr>
        <td style="border-left: none; border-bottom: none; border-top: none;"><p>02</p></td>
        <td style="border-bottom: none; border-top: none;"><p><?php echo $city_name; ?> Diligence Fee</p></td>
      ...
      <tr>
        ...
        <td style=" border-bottom: none; border-top: none;">&nbsp;</td>
        <td style=" border-right: none;border-bottom: none; border-top:none;"><p><?php echo $sgst_amt;?></p></td>
      </tr>
      ...
      <tr>
        ...
        <td style=" border-bottom: none; border-top: none;">&nbsp;</td>
        <td style=" border-right: none; border-bottom: none; border-top:none;"><p><?php echo $igst_total;?></p></td>
      </tr>
      ...
      <tr>
        ...
        <td style=" border-top:none;">&nbsp;</td>
        <td style=" border-top:none;">&nbsp;</td>
        <td style=" border-right: none; border-top:none;"><p><strong><?php echo $final_total;?></strong></p></td>
       </tr>
      <tr>
        <td colspan="3" style=" border-bottom: none; border-left: none; border-right: none;"><p style="text-decoration:underline;"><strong>Amount in Words: <?php echo $wmt;?> only. </strong></p>
          <p>&nbsp;</p>
