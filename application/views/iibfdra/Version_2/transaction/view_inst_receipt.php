		...
		<td align='center'>	
			<table border='1' cellspacing='0' cellpadding='5' width='65%' bgcolor='#FFFFCC' style="border-collapse:collapse">
    			<tr>
  				...
  				<tr>
    				<td width='35%'><p><strong>Institute ID: </strong></p></td>
                ...
                <tr>
                	<td width='35%'><p><strong>List of Candidates:</strong> </p></td>
                	<td width='64%'><a target="_blank" href="<?php echo base_url(); ?>iibfdra/Version_2/transaction/mem_receipt_list/<?php echo base64_encode($result['id']); ?>">View</a> &nbsp;&nbsp;&nbsp;</td>
                </tr>
