        ...
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header with-border">
              ...
              <?php }?>
              <?php if($action == 'view') { ?>
                <h3 class="box-title">Faculty Details Page</h3>
              <?php }?>
              <div class="pull-right"> <a href="<?php echo base_url();?>iibfdra/Version_2/faculty" class="btn btn-warning">Back</a> </div>
            </div>
            <div class="box-body">
              
              <form class="form-horizontal" autocomplete="off"  name="frmDrACenter" id="faculty_form" method="post" enctype="multipart/form-data" data-parsley-validate='parsley' onsubmit="return form_submit()"> 
              ...
              <?php if($error!=''){?>
                ...
                <?php if($action == 'edit' || $action == 'view') { ?>
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label for="roleid" class="col-sm-3 control-label">Faculty Code<span style="color:#F00">*</span></label>
                      <div class="col-sm-3">
                        <input type="text" class="form-control" value="<?php echo $faculty_data[0]['faculty_code']; ?>" readonly="readonly">
                      </div>
                    </div>
                  </div>
                  <input type="hidden" name="faculty_code" value="<?php echo isset($faculty_data[0]['faculty_code']) ? $faculty_data[0]['faculty_code'] : ''; ?>">
                  <input type="hidden" name="faculty_number" value="<?php echo isset($faculty_data[0]['faculty_number']) ? $faculty_data[0]['faculty_number'] : ''; ?>">

                  <div class="form-group">
                    <input type="hidden" name="prev_status" id="prev_status" value="<?php echo $faculty_data[0]['status']; ?>">
                  </div>
                <?php } ?>
                <?php if( $action == 'view' && $faculty_data[0]['status'] == 'Active') { ?>
                  <?php if( $faculty_data[0]['faculty_use_status'] == 'InUse' ) { ?>
                    <div class="col-sm-12">
                      <label class="col-sm-3 control-label">Change Status</label>
                      <div class="col-sm-2">
                        <div class="form-check">
                          <label><input type="radio" class="form-check-input radiobtn" id="faculty_use_status" name="faculty_use_status" value="NotInUse">Not In Use</label>
                        </div>
                      ...
                      <div class="col-sm-4">
                        ...
                        &nbsp<input type="button" class="clear-status" value="Clear">
                      </div>
                    </div>
                  ...
                  <div class="col-sm-12" id="reason_div" style="display: none;">
                    ...
                    <div class="col-sm-5" style="margin-top:10px">
                      <textarea rows="4" style="width: 332px; height: 103px;" id="reason"></textarea>
                ...
                <?php } else { ?>
                  ...
                  <div class="col-sm-12">
                    ...
                    <div class="col-sm-2">
                      <div class="form-check">
                        <label><input type="radio" class="form-check-input radiobtn" id="faculty_use_status" name="faculty_use_status" value="InUse">In Use</label>
                      </div>
                      <span class="error" id="status_error"></span>
                    </div>
                    <div class="col-sm-4">
              ...
              <?php } ?>  
                ...
                <?php if($action == 'add') { ?>
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label for="roleid" class="col-sm-3 control-label">Faculty Code/Pan Number</label>
                      <div class="col-sm-3">
                        <input type="text" class="form-control" id="faculty_code" name="faculty_code" placeholder="Faculty Code/Pan Number" value="" maxlength = "10"  data-parsley-maxlength="10">
                      </div>
                      <div class="col-sm-2">
                        <button type="button" class="btn btn-success faculty_btn" id="faculty_btn" >Get Data</button>
                        <a href="<?php echo base_url();?>iibfdra/Version_2/faculty/faculty_add" class="btn btn-success clear_btn" id="clear_btn" style="margin-left: 5px;">Clear</a>
                      </div> 
                    </div>
                  </div>
              
                  <input type="hidden" name="add_type" id="add_type" value="normal">
                  <input type="hidden" name="db_faculty_code" id="db_faculty_code" value="">
                <?php } ?>      
                <div class="col-sm-12">
                  <div class="form-group">
                ...
                <?php if($action == 'add') { ?>
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <div class="col-sm-3 img-display">
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <div class="col-sm-5">
                        <a href="<?php echo base_url('/uploads/photo_document_guidline/Guideline for photo-image loading-final.docx-Annexure.pdf'); ?>" style="text-decoration: underline; color: red;" target="_blank">Photo & Document Upload Guidline</a>
                      </div>
                    </div>  
                  </div>
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="dob" name="dob" placeholder="" value="<?php echo isset($faculty_data[0]['dob'])?$faculty_data[0]['dob']:'';?>" data-parsley-required data-parsley-minimumage="25" data-date-format="dd/mm/yyyy" data-parsley-minimumage-message="Applicant must be at least 25 years of age to apply" data-parsley-pattern="/^([12]\d|0[1-9]|3[01])\D?(0[1-9]|1[0-2])\D?(\d{4})$/"
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="pan_no" name="pan_no" placeholder=""  value="<?php echo isset($faculty_data[0]['pan_no'])?$faculty_data[0]['pan_no']:'';?>" minlength="10" maxlength="10" data-parsley-required data-parsley-pattern="/[A-Z]{5}[0-9]{4}[A-Z]{1}$/" data-parsley-errors-container="#pan_no_error" data-parsley-pan_no_exist data-parsley-trigger="keyup focusin focusout" data-parsley-pan_no_exist-message="This PAN no is already Exists."data-parsley-pattern-message="Please Enter 10 digit PAN No with Valid Alphanumeric Format." >

                       <!-- data-parsley-pattern="/[A-Z]{5}[0-9]{4}[A-Z]{1}$/"  -->
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    <label for="roleid" class="col-sm-3 control-label">Base Location<span style="color:#F00">*</span></label>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="base_location" name="base_location" data-parsley-required  placeholder="City / District / State" value="<?php echo isset($faculty_data[0]['base_location'])?$faculty_data[0]['base_location']:'';?>" maxlength="75">
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    <label for="roleid" class="col-sm-3 control-label">Professional Qualification(s) if any, (including from IIBF) with year of passing<span style="color:#F00">*</span></label>
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="personal_qualification" name="personal_qualification" data-parsley-required placeholder="e.g. MBA (1994)" value="<?php echo isset($faculty_data[0]['personal_qualification'])?$faculty_data[0]['personal_qualification']:'';?>">
                    </div>
                  </div>
                </div>
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <div class="col-sm-2">
                      <label for="roleid" class="control-label">Gross Duration Year</label>
                    </div>
                    <div class="col-sm-2">
                ...
                <?php if($action == 'add'){?>
                  ...
                  <div class="col-sm-12 fresh-add-section">
                    <div class="form-group">
                      <label for="roleid" class="col-sm-3 control-label"></label>
                      <div class="col-sm-2">
                      ...
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="gross_duration_year0" name="gross_duration_year[]" placeholder="e.g. 10"  value="<?php echo set_value('gross_duration_year0');?>" maxlength="2" data-parsley-errors-container="#gross_duration_year_error0" data-parsley-required>
                        <!-- onkeypress="return isNumber(event)" -->
                        <span class="note-error" id="gross_duration_year_error0" ></span>
                      </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="gross_duration_month0" name="gross_duration_month[]" placeholder="e.g. 1" min="0" max="11" maxlength="2"  value="<?php echo set_value('gross_duration_month0');?>" data-parsley-errors-container="#gross_duration_month_error0" data-parsley-required onkeypress="return isNumber(event)">
                        <!-- onkeypress="return isNumber(event)" -->
                        <span class="note-error" id="gross_duration_month_error0" ></span>
                      </div>
                    </div>
                  </div>
                <? } 
                ...
                <?php if (!empty($faculty_data[0]['work_exp1']) || !empty($faculty_data[0]['emp_id1']) || !empty($faculty_data[0]['gross_duration_year1']) || !empty($faculty_data[0]['gross_duration_month1'])) { ?> 
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="gross_duration_year0" name="gross_duration_year[]" placeholder="e.g. 10" maxlength="2" value="<?php echo $faculty_data[0]['gross_duration_year1'];?>" data-parsley-errors-container="#gross_duration_year_error0" data-parsley-required >
                        <!-- onkeypress="return isNumber(event)" -->
                        <span class="note-error" id="gross_duration_year_error0"></span>
                      </div>

                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="gross_duration_month0" name="gross_duration_month[]" placeholder="e.g. 1" maxlength="2" min="0" max="11" value="<?php echo $faculty_data[0]['gross_duration_month1'];?>" data-parsley-errors-container="#gross_duration_month_error0" data-parsley-required onkeypress="return isNumber(event)">
                        <!-- onkeypress="return isNumber(event)" -->
                        <span class="note-error" id="gross_duration_month_error0"></span>
                      </div>
                    </div>
                 ...
                 if (!empty($faculty_data[0]['work_exp2']) || !empty($faculty_data[0]['emp_id2']) || !empty($faculty_data[0]['gross_duration_year2']) || !empty($faculty_data[0]['gross_duration_month2'])) { ?>
                  <div class="col-sm-12"  id="textbox-label">
                    <div class="form-group">
                      <label for="roleid" class="col-sm-3 control-label"></label>
                        <div class="col-sm-2">
                          <input type="text" class="form-control" id="work_exp0" name="work_exp[]" placeholder="e.g. ABC Bank/ABC Agency" value="<?php echo $faculty_data[0]['work_exp2']; ?>" data-parsley-errors-container="#work_exp_error1" data-parsley-required >
                          <span class="note-error" id="work_exp_error1"></span>
                        </div>
                      
                        <div class="col-sm-3">
                          <input type="text" class="form-control" id="emp_id0" name="emp_id[]" placeholder="e.g. Manager - ABC123" value="<?php echo $faculty_data[0]['emp_id2']; ?>" data-parsley-errors-container="#emp_id_error1" data-parsley-required  >
                          <span class="note-error" id="emp_id_error1" ></span>
                        </div>
                      
                        <div class="col-sm-2">
                          <input type="text" class="form-control" id="gross_duration_year0" name="gross_duration_year[]" placeholder="e.g. 10" maxlength="2" value="<?php echo $faculty_data[0]['gross_duration_year2'];?>" data-parsley-errors-container="#gross_duration_year_error1" data-parsley-required >
                          <span class="note-error" id="gross_duration_year_error1"></span>
                        </div>
                      
                        <div class="col-sm-2">
                          <input type="text" class="form-control" id="gross_duration_month0" name="gross_duration_month[]" placeholder="e.g. 1" maxlength="2" min="0" max="11" value="<?php echo $faculty_data[0]['gross_duration_month2'];?>" data-parsley-errors-container="#gross_duration_month_error1" data-parsley-required onkeypress="return isNumber(event)">
                          <span class="note-error" id="gross_duration_month_error1"></span>
                        </div>
                      </div>
                  </div>
                <?php 
                 ...
                 if (!empty($faculty_data[0]['work_exp3']) || !empty($faculty_data[0]['emp_id3']) || !empty($faculty_data[0]['gross_duration_year3']) || !empty($faculty_data[0]['gross_duration_month3'])) { ?>  
                  <div class="col-sm-12" id="textbox-label">
                    <div class="form-group">
                      <label for="roleid" class="col-sm-3 control-label"></label>
                        <div class="col-sm-2">
                          <input type="text" class="form-control" id="work_exp0" name="work_exp[]" placeholder="e.g. ABC Bank/ABC Agency" value="<?php echo $faculty_data[0]['work_exp3']; ?>" data-parsley-errors-container="#work_exp_error2" data-parsley-required >
                          <span class="note-error" id="work_exp_error2"></span>
                        </div>
                      
                      <div class="col-sm-3">
                        <input type="text" class="form-control" id="emp_id0" name="emp_id[]" placeholder="e.g. Manager - ABC123" value="<?php echo $faculty_data[0]['emp_id3']; ?>" data-parsley-errors-container="#emp_id_error2" data-parsley-required  >
                        <span class="note-error" id="emp_id_error2" ></span>
                      </div>
                    
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="gross_duration_year0" name="gross_duration_year[]" placeholder="e.g. 10" maxlength="2" value="<?php echo $faculty_data[0]['gross_duration_year3'];?>" data-parsley-errors-container="#gross_duration_year_error2" data-parsley-required >
                        <!-- onkeypress="return isNumber(event)" -->
                        <span class="note-error" id="gross_duration_year_error2"></span>
                      </div>
                  
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="gross_duration_month0" name="gross_duration_month[]" placeholder="e.g. 1" min="0" max="11" maxlength="2" value="<?php echo $faculty_data[0]['gross_duration_month3'];?>"  data-parsley-errors-container="#gross_duration_month_error2" data-parsley-required onkeypress="return isNumber(event)">
                        <!-- onkeypress="return isNumber(event)" -->
                        <span class="note-error" id="gross_duration_month_error2"></span>
                      </div>
                    </div>
                  </div>
                <?php }  
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    <label for="roleid" class="col-sm-3 control-label">Work Experience in IIBF if Any<span style="color:#F00">*</span></label>
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="work_exp_iibf" name="work_exp_iibf" data-parsley-required placeholder="Work Experience in IIBF"  value="<?php echo isset($faculty_data[0]['work_exp_iibf'])?$faculty_data[0]['work_exp_iibf']:'';?>" maxlength="100" >
                      <!-- onkeypress="return alphanumeric(event)" -->
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    <label for="roleid" class="col-sm-3 control-label">Experience as Faculty in DRA Training, if Any<span style="color:#F00">*</span></label>
                    <div class="col-sm-9">
                      <input type="text" class="form-control" id="DRA_training_faculty_exp" name="DRA_training_faculty_exp" data-parsley-required placeholder="Experience as Faculty in DRA Training, if Any"  value="<?php echo isset($faculty_data[0]['DRA_training_faculty_exp'])?$faculty_data[0]['DRA_training_faculty_exp']:'';?>" maxlength="100">
                      <!-- onkeypress="return alphanumeric(event)" -->
                      <span class="note">Note: Please Enter only 100 characters.</span>
                    </div>
                  </div>
                ...
                <div class="col-sm-12" id="agency_association_period" style="display: none;">
                  <div class="form-group">
                    <label for="roleid" class="col-sm-3 control-label">Period of Association with the agency in providing DRA training<span style="color:#F00">*</span></label>
                    <div class="col-sm-4">
                ...
                <div class="col-sm-12" id="agency_association_period1" style="display: none;">
                  <div class="form-group">
                    <label for="roleid" class="col-sm-3 control-label"></label>
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="year" name="start_date" placeholder="--Year--" value="<?php echo isset($faculty_data[0]['start_date'])?$faculty_data[0]['start_date']:'';?>" maxlength="4"
                      data-parsley-errors-container="#year_error0" onkeypress="return isNumber(event)" data-parsley-required>
                      <!-- onkeypress="return isNumber(event)" -->
                      <span class="note">Note: Please Enter only Number.</span>
                      <span class="note-error" id="year_error0"></span>
                    </div>
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="month" name="end_date" min="0" max="11" maxlength="2" placeholder="--Month--" value="<?php echo isset($faculty_data[0]['end_date'])?$faculty_data[0]['end_date']:'';?>" data-parsley-errors-container="#month_error0" onkeypress="return isNumber(event)" data-parsley-required>
                      <!-- onkeypress="return isNumber(event)" -->
                      <span class="note">Note: Please Enter only Number.</span>
                      <span class="note-error" id="month_error0"></span>
                    </div>
                  </div>
                  <span class="note-error" id="date_error"></span>
                </div>

                <?php if (isset($faculty_count) && $faculty_count>1) { ?>
                  <input type="hidden" name="session_interested_in" value="<?php echo $faculty_data[0]['session_interested_in']; ?>">
                <?php } ?>  
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <div class="form-check">
                        <input type="radio" class="form-check-input radiocls" id="radio1" name="session_interested_in" value="1" data-parsley-errors-container="#session_interested_error" data-parsley-required <?php if(isset($faculty_data[0]['session_interested_in']) && $faculty_data[0]['session_interested_in'] == '1') { echo 'checked="checked"'; };?> <?php if (isset($faculty_count) && $faculty_count>1) { ?> disabled <?php } ?>> Banking Subjects
                        <label class="form-check-label" for="radio1"></label>
                        
                        <input type="radio" class="form-check-input radiocls" id="radio2" name="session_interested_in" value="2" data-parsley-errors-container="#session_interested_error" data-parsley-required <?php if(isset($faculty_data[0]['session_interested_in']) && $faculty_data[0]['session_interested_in'] == '2') { echo 'checked="checked"'; };?> <?php if (isset($faculty_count) && $faculty_count>1) { ?> disabled <?php } ?>>Soft Skill in Banking
                        <label class="form-check-label" for="radio1"></label>
                        
                        <input type="radio" class="form-check-input radiocls" id="radio3" name="session_interested_in" value="3" data-parsley-errors-container="#session_interested_error" data-parsley-required <?php if(isset($faculty_data[0]['session_interested_in']) && $faculty_data[0]['session_interested_in'] == '3') { echo 'checked="checked"'; };?> <?php if (isset($faculty_count) && $faculty_count>1) { ?> disabled <?php } ?>>Banking Subjects and Soft Skill in Banking
                        <label class="form-check-label" for="radio1"></label>
                ...
                <?php if($action != 'view') { ?>
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label for="roleid" class="col-sm-3 control-label">Qualification / Experience in Soft Skill in BFSI Sector, if any<span style="color:#F00">*</span></label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="softskills_banking_exp" name="softskills_banking_exp" data-parsley-required placeholder="Qualification / Experience in Soft Skill in Banking" value="<?php echo isset($faculty_data[0]['softskills_banking_exp'])?$faculty_data[0]['softskills_banking_exp']:'';?>" maxlength="500">
                        <!-- onkeypress="return alphanumeric(event)" -->
                        <span class="note">Note: Please Enter only 500 characters.</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label for="roleid" class="col-sm-3 control-label">Experience/Comments on training specific activities, if any<span style="color:#F00">*</span> </label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="training_activities_exp" name="training_activities_exp" data-parsley-required placeholder="Experience/Comments on training specific activities" value="<?php echo isset($faculty_data[0]['training_activities_exp'])?$faculty_data[0]['training_activities_exp']:'';?>"  maxlength="500">
                         <!-- onkeypress="return alphanumeric(event)" -->
                        <span class="note">Note: Please Enter only 500 characters.</span>
                      </div>
                    </div>
                ...
                <?php } else { ?>
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label for="roleid" class="col-sm-3 control-label">Qualification / Experience in Soft Skill in BFSI Sector, if any<span style="color:#F00">*</span></label>
                      <div class="col-sm-9">
                        <?php echo isset($faculty_data[0]['softskills_banking_exp'])?$faculty_data[0]['softskills_banking_exp']:'';?>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label for="roleid" class="col-sm-3 control-label">Experience/Comments on training specific activities, if any<span style="color:#F00">*</span> </label>
                      <div class="col-sm-9">
                        <?php echo isset($faculty_data[0]['training_activities_exp'])?$faculty_data[0]['training_activities_exp']:'';?>
                      </div>
                    </div>
                  </div>
                <?php } ?>      
                <?php 
                  ...
                  $db_languages = isset($faculty_data[0]['languages']) && $faculty_data[0]['languages']!= '' ? $faculty_data[0]['languages'] : '';
                  $arr_db_langs = [];  
                  if ($db_languages != '') {
                    $arr_db_langs = explode(',',$db_languages);
                  } 
                ?>
                ...
                <?php if($action != 'view') { ?>
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label for="roleid" class="col-sm-3 control-label">Language(s) proficient with<span style="color:#F00">*</span> </label>
                      <div class="col-sm-9">
                        <select class="form-control" data-placeholder="Select Language" name="language[]" id="language" multiple>
                          <option value=""></option>
                          <?php foreach ($language_known_arr as $key => $lang_value) { ?>
                            <option value="<?php echo $lang_value; ?>" <?php if(in_array($lang_value,$arr_db_langs)) { echo 'selected'; } ?>><?php echo $lang_value; ?></option> 
                          <?php } ?>  
                        </select>
                        <span class="note-error error lang-error"></span>  
                      </div>
                    </div>
                  </div>
                <?php } else { ?>
...
<link href="https://iibf.esdsconnect.com/staging/assets/iibfbcbf/css/plugins/chosen/bootstrap-chosen.css?ver=1700633901" rel="stylesheet" />
<script src="https://iibf.esdsconnect.com/staging/assets/iibfbcbf/js/plugins/chosen/chosen.jquery.js?ver=1700633828"></script>

<script>$(document).ready(function() { $('#language').chosen(); }); </script>
...
<script type="text/javascript">
  ...
  {
    var lanvalue = $('#language').val();
    if (lanvalue != '' && lanvalue != null) {
        $('.lang-error').html('');
        return true;
      }
      else {
        $('.lang-error').html('This field is required.');
        return false;
      }
  })
  ...
  {
    $("#faculty_use_status").prop('checked', false);  
    $('#reason_div').hide();
    $('#reason').val();
    $('#reason_error').text('');
  })
  ...
  {
    var err_cnt = 0;
    var status  = $("input[name='faculty_use_status']:checked").val();
    ...
    if (err_cnt == 0) 
    {
      ...
      if (status != '' || status != undefined) 
      {
        ...
        $.ajax({
          type: 'POST',
          url: base_url + "iibfdra/Version_2/faculty/change_status",
          data: {
          ...
          success: function(response) {
            ...
            else if(response.status == 'faculty_error')
            {
              swal({
                title: 'Error',
                text: 'The given faculty is assign on current live batch.',
                icon: 'danger',
                type: 'danger',
                confirmButtonColor: '#3f51b5',
                confirmButtonText: 'OK ',
  ...
  function form_submit() { 
    // console.log($('#add_type').val());
    // alert($('#add_type').val());
    if ($('#add_type').val() == 'normal') 
    {
      var language = $('#language').val();
      if ($("#faculty_form").parsley().isValid() == null) 
      {
  ...
  if( action == 'add' ) 
  {
    $('.faculty_btn').click(function()
    {
      ...
      if ($.trim(faculty_code) == '') {
        alert('Please enter faculty code.');
      } else {
        $.ajax({
          url: base_url+"iibfdra/Version_2/faculty/getData",
          method:"POST",
          data: {'action':action,'faculty_code':faculty_code,'institute_id':institute_id},
          dataType: 'JSON',       
          success:function(response)
          {
            if (response.status == 'success') 
            {
              var faculty_data          = response.data[0];
              var work_exp_html         = response.work_exp_html;
              var session_interested_in = faculty_data['session_interested_in'];
              var faculty_photo_path    = base_url+"uploads/faculty_photo/"+faculty_data['faculty_photo'];
              var pan_photo_path        = base_url+"uploads/pan_photo/"+faculty_data['pan_photo'];

              $('#salutation').val(faculty_data['salutation']);
              $('#faculty_name').val(faculty_data['faculty_name']);
              $('#dob').val(faculty_data['dob']);
              $('#pan_no').val(faculty_data['pan_no']);
              $('#base_location').val(faculty_data['base_location']);
              $('#academic_qualification').val(faculty_data['academic_qualification']);
              $('#personal_qualification').val(faculty_data['personal_qualification']);
              $('#work_exp_iibf').val(faculty_data['work_exp_iibf']);
              $('#DRA_training_faculty_exp').val(faculty_data['DRA_training_faculty_exp']);
              $('#softskills_banking_exp').val(faculty_data['softskills_banking_exp']);
              $('#training_activities_exp').val(faculty_data['training_activities_exp']);

              $('.fresh-add-section').remove();
              $('.work-exp-section').html('');
              $('.work-exp-section').append(work_exp_html);
              $('#faculty_photo_img').attr('src',faculty_photo_path);
              $('#pan_photo_img').attr('src',pan_photo_path);
              
              switch(session_interested_in) {
                  case '1':
              ...
              $('#faculty_name').removeAttr('data-parsley-pattern');
              $('input').attr('readonly',true);
              $('input').attr('disabled',true);
              $('select').attr('disabled',true);
              $('#language').prop('disabled', true).trigger("chosen:updated");
              
              // Set default selected options
              var languageHtml  = '';
              console.log(faculty_data['languages']);
              if (faculty_data['languages'] != '' && faculty_data['languages'] != null && faculty_data['languages'] != undefined) 
              {
                var languageArray = faculty_data['languages'].split(',');
                // var languageHtml  = '';

                
                languageArray.forEach(function(language,index) {
                  languageHtml += '<li class="search-choice"><span>'+language+'</span><a class="search-choice-close" data-option-array-index="'+index+'"></a></li>'   
                });

                $('.chosen-choices').append(languageHtml);
                $('.search-field').hide();
              }
    
              $('#language').removeAttr('data-parsley-required');
              $('#pan_photo').removeAttr('data-parsley-required');
              $('#faculty_photo').removeAttr('data-parsley-required');
              $('input').removeAttr('data-parsley-required');
              $('#pan_no').removeAttr('data-parsley-pan_no_exist');
              $('#faculty_code').attr('readonly',false);
              $('#add_type').val('existed').attr('readonly',false).attr('disabled',false);
              $('#db_faculty_code').val(faculty_data['faculty_code']).attr('readonly',false).attr('disabled',false);
            }
            else 
            {
              alert(response.msg);
  ...
  $(document).ready(function () 
  {
    ...
    $('#btn_add_workex').click(function(){
      ...
      var repeatable_workex = '<div class="col-sm-12" id="textbox-label"><input type="hidden" name="faculty_id[]" id="faculty_id'+newid+'" value=""><div class="form-group"><label for="roleid" class="col-sm-3 control-label"></label><div class="col-sm-2"><input type="text" class="form-control" id="work_exp'+newid+'" name="work_exp[]" placeholder="e.g. ABC Bank/ABC Agency"  value=""><span class="note-error" id="work_exp_error'+newid+'"></span></div><div class="col-sm-3"><input type="text" class="form-control" id="emp_id'+newid+'" name="emp_id[]" placeholder="e.g. Manager - ABC123"  value=""><span class="note-error" id="emp_id_error'+newid+'"></span></div><div class="col-sm-2"> <input type="text" class="form-control" id="gross_duration_year'+newid+'" name="gross_duration_year[]" placeholder="e.g. 10" onkeypress="return isNumber(event)" maxlength="2" value=""><span class="note-error" id="gross_duration_year_error'+newid+'"></span></div><div class="col-sm-2"> <input type="number" class="form-control" id="gross_duration_month'+newid+'" name="gross_duration_month[]" placeholder="e.g. 1" onkeypress="return isNumber(event)" min="0" max="11" maxlength="2" value=""><span class="note-error" id="gross_duration_month_error'+newid+'"></span></div></div></div>';
      ...
      $('#gross_duration_month'+newid).attr('data-parsley-required','true');
      $('#gross_duration_month'+newid).attr('data-parsley-errors-container','#gross_duration_month_error'+newid);

      $('#gross_duration_year'+newid).attr('data-parsley-required','true');
      $('#gross_duration_year'+newid).attr('data-parsley-errors-container','#gross_duration_year_error'+newid);
    ...
    $(document).on('click', '#btn_remove_workex', function() {
      ...
      $('#gross_duration_month').removeAttr('data-parsley-required','true');
      $('#gross_duration_month').removeAttr('data-parsley-errors-container');

      $('#gross_duration_year').removeAttr('data-parsley-required','true');
      $('#gross_duration_year').removeAttr('data-parsley-errors-container');
