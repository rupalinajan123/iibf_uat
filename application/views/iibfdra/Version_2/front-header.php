...
<div class="wrapper">
  <header class="main-header">
    ...
    <?php if( $this->session->userdata('dra_institute') ) {
			$logourl = base_url().'iibfdra/Version_2/InstituteHome/dashboard';
		} else {
			$logourl = base_url().'iibfdra/Version_2/';
		} ?>
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        ...
        <!-- <li><img src="https://iibf.org.in/images/Logo.svg"></li> -->
          
          <li class="dropdown user user-menu">
          	<?php if( $this->session->userdata('dra_institute') ) { ?>
                <a href="<?php echo  base_url()?>iibfdra/Version_2/InstituteLogin/logout" class="dropdown-toggle" >
