                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                       <div class="col-md-12">
                             ...
                             <?php } ?> 
                            <form action="<?php echo base_url() ?>iibfdra/Version_2/TrainingBatches/make_payment" method="post" class="form-horizontal" name="neft_pay_form" id="neft_pay_form" autocomplete="off">
