        ...
        <table class="table table-bordered table-striped" style="word-wrap:anywhere; background:<?php echo $div_class; ?>;">
          <tbody>
            ...
            <tr>
              ...
              <td width="20%"><a href="<?php echo site_url('iibfdra/Version_2/InspectorHomeDemo/faculty_view/'.base64_encode($batch[0]['first_faculty_id'])); ?>" id="assigned_faculty1" target="_blank"><?php echo $batch[0]['first_faculty_name']; ?></a></td>
              <td width="2%"></td>
              <td width="29%"><strong>Assigned Faculty(main 2):</strong></td>
              <td width="20%"><a href="<?php echo site_url('iibfdra/Version_2/InspectorHomeDemo/faculty_view/'.base64_encode($batch[0]['sec_faculty_id'])); ?>" id="assigned_faculty2" target="_blank"><?php echo $batch[0]['sec_faculty_name']; ?></a></td>
            </tr>
            <tr>
              <td width="29%"><strong>Assigned Faculty (additional 1):</strong></td>
              <td width="20%"><a href="<?php echo site_url('iibfdra/Version_2/InspectorHomeDemo/faculty_view/'.base64_encode($batch[0]['add_first_faculty_id'])); ?>" id="additional_faculty1" target="_blank"><?php echo $batch[0]['add_first_faculty_name']; ?></a></td>
              <td width="2%"></td>
              <td width="29%"><strong>Assigned Faculty(additional 2):</strong></td>
              <td width="20%"><a href="<?php echo site_url('iibfdra/Version_2/InspectorHomeDemo/faculty_view/'.base64_encode($batch[0]['add_sec_faculty_id'])); ?>" id="additional_faculty2" target="_blank"><?php echo $batch[0]['add_sec_faculty_name']; ?></a></td>
            </tr>
            <tr>
                ...
                <table class="table table-bordered table-striped" style="word-wrap:anywhere; background:<?php echo $div_class; ?>;">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <!-- <td width="48%"><textarea style="width:100%; text-align:left;" name="assessment" maxlength="100" placeholder=""></textarea> --></td>
                    </tr>
                ...
                <table id="listitems" class="table table-bordered table-striped">
                  ...
                  <tbody class="no-bd-y" id="list">
                    ...
                    <tr>
                      ...
                      <td> 
                        <textarea row="2" col="5" name="remark[<?php echo $regId; ?>][]" id="remark_<?php echo $regId; ?>"><?php echo set_value('remark['.$regId.'][0]'); ?></textarea> </td>  
                    </tr>
                  <?php } ?>  
                  </tbody>
                </table>
...
<script>
  ...
  {  
    ...
    $('#batch_id').on('change',function () {
      if ($(this).val() != '') {
        window.location.href = "https://iibf.esdsconnect.com/iibfdra/Version_2/InspectorHomeDemo/show_batch_inspection_report/"+$(this).val();
      } else {
        window.location.href = "https://iibf.esdsconnect.com/iibfdra/Version_2/InspectorHomeDemo/inspection_report";
      }
    });    
  });
