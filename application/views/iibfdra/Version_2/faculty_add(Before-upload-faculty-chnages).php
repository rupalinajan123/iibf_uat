                ...
                <?php if($action == 'add'){?>
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="gross_duration_year0" name="gross_duration_year[]" placeholder="e.g. 10"  value="<?php echo set_value('gross_duration_year0');?>" maxlength="2" onkeypress="return isNumber(event)" data-parsley-errors-container="#gross_duration_year_error0" data-parsley-required>
                        <span class="note-error" id="gross_duration_year_error0" ></span>
                      </div>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="gross_duration_month0" name="gross_duration_month[]" placeholder="e.g. 1"  value="<?php echo set_value('gross_duration_month0');?>" maxlength="2" onkeypress="return isNumber(event)" data-parsley-errors-container="#gross_duration_month_error0" data-parsley-required>
                ...
                <? } 
                  ...
                  <div class="col-sm-12">
                    ...
                    <?php } if(!empty($faculty_data[0]['gross_duration_year1'])){ ?>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="gross_duration_year0" name="gross_duration_year[]" onkeypress="return isNumber(event)" placeholder="e.g. 10" maxlength="2" value="<?php echo $faculty_data[0]['gross_duration_year1'];?>" data-parsley-errors-container="#gross_duration_year_error0" data-parsley-required >
                        <span class="note-error" id="gross_duration_year_error0"></span>
                      </div>
                  ...
                  <?php } if(!empty($faculty_data[0]['gross_duration_month1'])){ ?>
                       <div class="col-sm-2">
                        <input type="text" class="form-control" id="gross_duration_month0" name="gross_duration_month[]" onkeypress="return isNumber(event)" placeholder="e.g. 1" maxlength="2" value="<?php echo $faculty_data[0]['gross_duration_month1'];?>" data-parsley-errors-container="#gross_duration_month_error0" data-parsley-required >
                        <span class="note-error" id="gross_duration_month_error0"></span>
                      </div>
                    </div>
                  </div>
                  ...
                  <?php if(!empty($faculty_data[0]['work_exp2'])){ ?>
                    <div class="col-sm-12"  id="textbox-label">
                      ...
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="gross_duration_year0" name="gross_duration_year[]" placeholder="e.g. 10" maxlength="2" value="<?php echo $faculty_data[0]['gross_duration_year2'];?>" onkeypress="return isNumber(event)" data-parsley-errors-container="#gross_duration_year_error0" data-parsley-required >
                        <span class="note-error" id="gross_duration_year_error0"></span>
                      </div>
                      <?php } if(!empty($faculty_data[0]['gross_duration_month2'])){ ?>
                      <div class="col-sm-2">
                        <input type="text" class="form-control" id="gross_duration_month0" name="gross_duration_month[]" placeholder="e.g. 1" maxlength="2"  value="<?php echo $faculty_data[0]['gross_duration_month2'];?>" onkeypress="return isNumber(event)" data-parsley-errors-container="#gross_duration_month_error0" data-parsley-required >
                        <span class="note-error" id="gross_duration_month_error0"></span>
                      </div>
                    </div>
                  </div>
                  ...
                  <?php if(!empty($faculty_data[0]['work_exp3'])){ ?>
                    <div class="col-sm-12" id="textbox-label">
                      ...
                      <?php } if(!empty($faculty_data[0]['gross_duration_year3'])){ ?>
                        <div class="col-sm-2">
                          <input type="text" class="form-control" id="gross_duration_year0" name="gross_duration_year[]" placeholder="e.g. 10" maxlength="2" value="<?php echo $faculty_data[0]['gross_duration_year3'];?>" onkeypress="return isNumber(event)" data-parsley-errors-container="#gross_duration_year_error0" data-parsley-required >
                          <span class="note-error" id="gross_duration_year_error0"></span>
                        </div>
                    <?php } if(!empty($faculty_data[0]['gross_duration_month3'])){ ?>
                        <div class="col-sm-2">
                          <input type="text" class="form-control" id="gross_duration_month0" name="gross_duration_month[]" placeholder="e.g. 1" maxlength="2" value="<?php echo $faculty_data[0]['gross_duration_month3'];?>" onkeypress="return isNumber(event)" data-parsley-errors-container="#gross_duration_month_error0" data-parsley-required >
                          <span class="note-error" id="gross_duration_month_error0"></span>
                        </div>
                      </div>
                    </div>
                            ...
                            <table id="example1"  class="table table-bordered dt-responsive table-hover" width="100%">
                              ...
                              <?php foreach($log_data as $key => $value) { ?>
                                <tr>
                                  ...
                                  <td><?php echo date("d-M-Y h:i:s A", strtotime($value['created_on'])); ?></td>
                                </tr> 
                              <?php }?>
                              </tbody>
                            </table>
