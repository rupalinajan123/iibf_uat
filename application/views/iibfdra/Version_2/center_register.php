...
?>
  <form class="form-horizontal" name="frmDrACenter" id="frmDrACenter"  method="post" action="<?php echo base_url();?>iibfdra/Version_2/Center" enctype="multipart/form-data" data-parsley-validate="parsley">
			 ...
			 if(validation_errors()!=''){?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5"><br>
                  ...
                  Regular
                  <input type="radio" class="minimal cls_gender due_diligence" id="Temporary" name="center_type"  value="T" <?php echo (set_value('center_type')=='T')?" checked=' checked'":""?>     <?php echo set_radio('center_type','Temporary'); ?> required disabled>
                  Temporary </div>
              </div>
              <div class="T divbox">
                <div class="form-group">
              ...
              <div class="box-body">
                <div class="form-group">
                     <label for="roleid" class="col-sm-4 control-label">Select to display <span style="color:#090;">'Agency'</span> address on the invoice<span style="color:#F00">*</span></label>
                      <div class="col-sm-6">
                        <input type="radio" class="chk1" id="invoice_flag"  name="invoice_flag"  value="AS" <?php echo set_radio('invoice_flag', 'AS'); ?> required disabled>
                     </div>
                </div>
                <div class="form-group">
                     <label for="roleid" class="col-sm-4 control-label">Select to display <span style="color:#090;">'Accreditation Centre'</span> address on the invoice<span style="color:#F00">*</span></label>
                      <div class="col-sm-6">
                        <input type="radio" class="chk2" id="invoice_flag"  name="invoice_flag"  value="CS" <?php echo set_radio('invoice_flag', 'CS'); ?> checked required >
                      </div>
               </div>
...
if(state_code){
  $.ajax({
    type:'POST',
    url: site_url+'iibfdra/Version_2/center/getCity',
...
console.log(center_type);
	if(city_id != '' && center_type !='' && center_type !='undefined'){
		$.ajax({
			type:'POST',
			url: site_url+'iibfdra/Version_2/Center/validateCity',
...
console.log(center_type);
	if(state != '' && pincode !=''){
		$.ajax({
			type:'POST',
			url: site_url+'iibfdra/Version_2/Center/checkpin',
