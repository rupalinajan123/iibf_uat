...
if($regId != "")
{
  ...
  if (count($candidate_data) > 0) 
  {
    ...
    $source_of_candidate = !empty($candidateArr['source_of_candidate']) ? $candidateArr['source_of_candidate'] : '';

    $addressline1 = !empty($candidateArr['address1']) ? $candidateArr['address1'] : '';
    if($addressline1 != "")
    {
      redirect(site_url('iibfdra/Version_2/TrainingBatches/candidate_list/'.base64_encode($bid)));
    }
  ...
  {
    redirect(site_url('iibfdra/Version_2/TrainingBatches'));
  }
} ?>
      ...
      <div class="col-md-12">
        <form class="form-horizontal" autocomplete="off" name="draExamAddFrm" id="draExamAddFrm" method="post" enctype="multipart/form-data" data-parsley-validate="parsley">
         <input type="hidden" name="submit_form" id="submit_form" value="">
          ...
          // echo '---'.$current_date .'<='. $training_from_date;
          ...
          { ?>
            ...
            <div class="box box-info" id="basic_details_div">
              <div class="box-header with-border">
                ...
                <div class="pull-right"> <a href="<?php echo base_url(); ?>iibfdra/Version_2/TrainingBatches/candidate_list/<?php echo base64_encode($bid); ?>" class="btn btn-warning">Back</a> </div>
              </div>
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-4">
                    ...
                    <input type="text" name="firstname" id="firstname" class="form-control"   placeholder="First Name" value="<?php if($firstname != "") { echo $firstname; } else { echo set_value('firstname'); } ?>" autocomplete="off" onkeypress="return onlyAlphabets(event)" required maxlength="30" data-parsley-pattern="^[A-Z ]+$" data-parsley-pattern-message="Please enter only uppercase letters." data-parsley-trigger="focusin focusout">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    ...
                    <input type="text" class="form-control" id="lastname" name="lastname" placeholder="Last Name" value="<?php if($lastname != "") { echo $lastname; } else { echo set_value('lastname'); } ?>" autocomplete="off" onkeypress="return onlyAlphabets(event)" maxlength="30" data-parsley-pattern="^[A-Z ]+$" data-parsley-pattern-message="Please enter only uppercase letters." data-parsley-trigger="focusin focusout">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2 example">
                    ...
                    <?php
                      ...
                      $end_year = date('Y-m-d', strtotime("- 18 year", strtotime(date('Y-m-d'))));
                    ?>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    ...
                    <!-- <input type="text" class="form-control" id="mobile_no" name="mobile_no" placeholder="Mobile No" value="<?php if($mobile_no != "") { echo $mobile_no; } else { echo set_value('mobile_no'); } ?>" onfocusout="return is_mobile_no(event)" required maxlength="10" data-parsley-type="digits" data-parsley-minlength="10" data-parsley-maxlength="10"   data-parsley-pattern="/^\d{10}$/" data-parsley-errors-container="#mobile_no_error"> -->
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-3">
                    ...
                    <input type="text" class="form-control" id="email" name="email_id" placeholder="Email Id" autocomplete="off" value="<?php if($email_id != "") { echo $email_id; } else { echo set_value('email_id'); } ?>" autocomplete="off" required maxlength="80" data-parsley-type="email" data-parsley-pattern="/^[a-zA-Z0-9.!#$%&’*+/=?^_`{|}~-]+@([a-zA-Z0-9-]+[.]){1,2}[a-zA-Z]{2,10}$/" 
                     data-parsley-maxlength="80" data-parsley-trigger-after-failure="focusout" data-parsley-errors-container="#email_error" data-parsley-email_exist data-parsley-trigger= focusout data-parsley-email_exist-message="This Email ID is already Exists.">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-2 example">
                    ...
                    <input type="text" class="form-control" id="source_of_candidate" name="source_of_candidate" placeholder="Source Of Candidate" value="<?php if($source_of_candidate != "") { echo $source_of_candidate; } else { echo set_value('source_of_candidate'); } ?>" autocomplete="off" data-parsley-required data-parsley-maxlength="50" data-parsley-errors-container="#source_of_candidate_error"/>  
              ...
              <?php if (count($candidate_data) == 0) { ?>
                <div class="box-footer">
                  <div class="col-sm-4 col-xs-offset-3">
                    ...
                    <input type="button" class="btn btn-info btn_submit" id="btnSubmit1" name="btnSubmit1" value="Submit Iss">
                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-5" id="id_no_proof">
                      <input type="text" class="form-control form2_element" id="idproof_no" name="idproof_no" placeholder="ID Proof No.(No. of selected ID Proof)" value="<?php echo set_value('idproof_no'); ?>" autocomplete="off" required data-parsley-errors-container="#idproof_no_error" data-parsley-idproof_exist data-parsley-trigger= focusout data-parsley-idproof_exist-message="This ID Proof is already Exists.">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-5" id="exist_qualicertificate">
                      <input type="file" name="qualicertificate" id="qualicertificate" class="form-control form2_element" autocomplete="off" onchange="validateFile(event, 'error_qualicert', 'qualicertificate_preview', '200kb')" required> (As per educational qualification selected above)
...
<script type="text/javascript">
  ...
  function get_member_details()
  {
    ...
    if (regno != '' && typeof attr == typeof undefined && attr !== "false")
    {
      ...
      $.ajax({
        type: "POST",
        url: site_url + 'iibfdra/Version_2/TrainingBatches/get_memdetails/',
        data: sdata,
