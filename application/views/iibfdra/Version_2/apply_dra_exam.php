    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <form class="form-horizontal" autocomplete="off" name="dra_apply_exam_form" id="dra_apply_exam_form"  method="post"  enctype="multipart/form-data" data-parsley-validate>
          ...
          <input type="hidden" class="form-control" id="reg_no" name="reg_no" value="<?php echo $candidate_details['regnumber'];?>" autocomplete="off" />
                ...
                <table class="table table-bordered table-hover table-condensed">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="width:200px;"><strong>Registration No</strong> : <?php if($examRes['regnumber'] != "") { echo $examRes["regnumber"]; } ?></td>
                    </tr>                 
