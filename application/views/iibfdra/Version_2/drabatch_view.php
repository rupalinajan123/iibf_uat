...
<div class="content-wrapper">
  <section class="content-header">
   ...
   <p>Please go through the given detail, correction may be made if necessary. <a href="<?php //echo base_url().'iibfdra/Version_2/TrainingBatches/edit/'.base64_encode($bid)
                                                                                        ?>">Modify</a></p>
   <?php  } else {
    ...
    <div class="row myview">
          ...
          <div class="box-header with-border">
            ...
            <div class="pull-right">
              <?php if ($menu == 'batch_checklist') { ?>
                <a href="<?php echo base_url(); ?>iibfdra/Version_2/TrainingBatches/batch_checklist" class="btn btn-warning">Back</a>
              <?php } else { ?>
          ...
          <div class="box-body" style="padding: 15px 10px 10px 10px">
            ...
            ?>
              ...
              <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">Batch Status :</label>
                <?php echo $status; ?>
              </div>

              <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">Name of Training Agency :</label>
              ...
              <!--  <div class="form-group">
              <label for="total_candidates" class="col-sm-3 control-label">INSPECTOR NAME :</label>
              <div class="col-sm-8"></div>
            </div> -->

              <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">Batch code - Batch Mode:</label>
                <div class="col-sm-8">
              ...
              <label for="total_candidates" class="col-sm-3 control-label">BATCH TYPE :</label>
              ...
              ?>
                <div class="form-group">
                  <label for="total_candidates" class="col-sm-3 control-label">Reason :</label>
                  <div class="col-sm-8"><?= $reason; ?></div>
                </div>
              <?php }
              ?>
              <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">Batch Training Period :</label>
                <div class="col-sm-8">
                  <?php
              ...
              <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">Holiday(s) :</label>
                <div class="col-sm-8">
              ...
              <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">Net Training Days :</label>
                <div class="col-sm-8">
              ...
              <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">Daily Training Timing :</label>
                <div class="col-sm-8">
              ...
              <div class="form-group">
                ...
                ?>
                <label for="total_candidates" class="col-sm-3 control-label">Gross Training Time Per Day :</label>
                <div class="col-sm-8">
                  <strong>
              ...
              <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">Break Time 1 :</label>
                <div class="col-sm-8">
                  <?php
                  $breakTime1 = '';
              ...
              <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">Break Time 2 :</label>
                <div class="col-sm-8">
                  <?php
                  $breakTime2 = '';
              ...
              <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">Break Time 3 :</label>
                <div class="col-sm-8">
                  <?php
                  $breakTime3 = '';
              ...
              <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">Daily Break Time :</label>
                <div class="col-sm-8">
                  <?php
              ...
              <div class="form-group">
                ...
                ?>
                <label for="total_candidates" class="col-sm-3 control-label">Net Training Time Per Day :</label>
                <div class="col-sm-8">
              ...
              <div class="form-group">
                ...
                ?>
                <label for="total_candidates" class="col-sm-3 control-label">Total Net Training Time :</label>
                <div class="col-sm-8">
              ...
              <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">Training Language :</label>
                <div class="col-sm-8"><?= $batch['training_medium']; ?></div>
              </div>

              <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">Total No. of Candidates (Estimated) :</label>
                <div class="col-sm-8">
              ...
              <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">No.of Registered Candidates (Actual) :</label>
                <div class="col-sm-8">
                <table class="table table-bordered" style="border-color:#ccc; margin:0;">
                <tbody>
                  <tr>
              ...
              <!-- <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">No.of Registered Candidates :</label>
                <div class="col-sm-8"><?php echo $total_registered_candidates; ?></div>
              </div> -->
              
              <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">1st Faculty :</label>
                <div class="col-sm-8"><?php echo $batch['first_faculty_code'].'_'.$batch['first_faculty_name']; ?></div>
              </div>

              <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">2nd Faculty :</label>
                <div class="col-sm-8"><?php
                                      if ($batch['sec_faculty_name'] != '') {
                                        echo $batch['sec_faculty_code'].'_'.$batch['sec_faculty_name'];
                                      }
                                      ?></div>
              </div>

              <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">Additional Faculty I :</label>
                <div class="col-sm-8"><?php echo $batch['add_first_faculty_code'].'_'.$batch['add_first_faculty_name']; ?></div>
              </div>

              <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">Additional Faculty II :</label>
                <div class="col-sm-8"><?php
                                      if ($batch['add_sec_faculty_name'] != '') {
                                        echo $batch['add_sec_faculty_code'].'_'.$batch['add_sec_faculty_name'];
                                      }
                                      ?></div>
              </div>

              <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">Training Schedule :</label>
                <div class="col-sm-8">
              ...
              <?php if($batch['reupdate_schedule'] == 'no' && $batch['batch_status'] != 'In Review') { ?>

              <form autocomplete="off" name="scheduleForm" id="scheduleForm" action="<?php echo base_url('/iibfdra/Version_2/TrainingBatches/upload_training_schedule'); ?>" method="post" data-parsley-validate="parsley"  enctype="multipart/form-data" onsubmit ="return form_submit()">

                <input type="hidden" name="validateDoc_err" id="validateDoc_err" value="0">
                <input type="hidden" name="training_batch_id" id="training_batch_id" value="<?php echo $batch['id']; ?>">
                ...
                <div class="form-group" id="training_schedule_doc">
                  ...
                  <div class="col-sm-5">
                    <input type="file" class="form-control" name="training_schedule" id="training_schedule" onchange="validateDoc(event, 'training_schedule_error')" data-parsley-trigger="focusin focusout" required>
                    <span class="note" id="training_schedule_note">Note: Please Upload only .txt, .doc, .docx, .pdf Files with size upto 5 MB</span></br>

                    <span id="training_schedule_note"><b>Note:</b> Training Schedule can be reuploaded only once.</span></br>
                    <span class="note-error" id="training_schedule_error"> <?php echo form_error('training_schedule'); ?></span>
                  </div>

                  <div class="col-sm-3">
                    <button class="btn btn-primary" type="submit" name="reupload">Reupload</button>
                  </div>  
                </div>
            ...
            <?php } ?>  
              <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">Training Batch State :</label>
              ...
              <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">Training Batch District :</label>
                <div class="col-sm-8"><?= $batch['district']; ?></div>
              </div>
              <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">Training Batch City :</label>
                <div class="col-sm-8"><?= $city_name; ?></div>
              </div>
              <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">Training Batch Pincode :</label>
                <div class="col-sm-8"><?= $batch['pincode']; ?></div>
              </div>

              <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">Training Batch Address Line 1 :</label>
                <div class="col-sm-8"><?= $batch['addressline1']; ?></div>
              </div>
              <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">Training Batch Address Line 2 :</label>
                <div class="col-sm-8"><?= $batch['addressline2']; ?></div>
              </div>
              <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">Training Batch Address Line 3 :</label>
                <div class="col-sm-8"><?= $batch['addressline3']; ?></div>
              </div>
              <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">Training Batch Address Line 4 :</label>
                <div class="col-sm-8"><?= $batch['addressline4']; ?></div>
              </div>

              <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">Batch Coordinator Name :</label>
                <div class="col-sm-8"><?= $batch['contact_person_name']; ?></div>
              </div>

              <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">Batch Coordinator Mobile No : </label>
                <div class="col-sm-8"><?= $batch['contact_person_phone']; ?></div>
              </div>

              <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">Alternative Contact Person Name :</label>
                <div class="col-sm-8"><?= $batch['alt_contact_person_name']; ?></div>
              </div>

              <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">Alternative Contact Person Contact Number :</label>
                <div class="col-sm-8"><?= $batch['alt_contact_person_phone']; ?></div>
              </div>

              <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">Name of Bank / Agency / Mixed (Source of Candidates) :</label>
                <div class="col-sm-8"><?= $batch['name_of_bank']; ?></div>
              </div>

              <div class="form-group">
                <label for="total_candidates" class="col-sm-3 control-label">Remarks :</label>
                <div class="col-sm-8 wrap_text"><?php echo $batch['remarks'];?></div>
              </div>

              <?php if ($batch['batch_online_offline_flag'] == 1) { ?>
                <div class="form-group">
                  <label for="total_candidates" class="col-sm-3 control-label">Online Training Platform :</label>
                  <div class="col-sm-8"><?php echo $batch['online_training_platform']; ?></div>
                </div>

                <div class="form-group">
                  <label for="total_candidates" class="col-sm-3 control-label">Online Training Platform Link :</label>
                  <div class="col-sm-8"><?php echo $batch['platform_link']; ?></div>
                </div>

                <div class="form-group">
                  <label for="total_candidates" class="col-sm-3 control-label">Link For Preparatory Session :</label>
                  <div class="col-sm-8"><?php echo $batch['preparatory_session_link']; ?></div>
                </div>

                <div class="form-group">
                  <label for="total_candidates" class="col-sm-3 control-label">Online Batch Login Details :</label>
                  <div class="col-sm-8">
              ...
              <?php } elseif ($batch['batch_online_offline_flag'] == 0) { ?>

                <div class="form-group">
                  <label for="total_candidates" class="col-sm-3 control-label">CCTV Link :</label>
                  <div class="col-sm-8"><?php echo $batch['cctv_link']; ?></div>
                </div>

                <?php if ($batch['offline_city_name'] != "") {
                  $location = $batch['offline_city_name'];
                } else {
                  $location = $batch['offline_location_name'];
                } ?>

                <div class="form-group">
                  <label for="total_candidates" class="col-sm-3 control-label">Center :</label>
                  <div class="col-sm-8"><?php echo $location; ?></div>
                </div>

                <div class="form-group">
                  <label for="total_candidates" class="col-sm-3 control-label">Center Address :</label>
                  <div class="col-sm-8"><?php echo $batch['center_address']; ?></div>
                </div>

            <?php } } ?>

            <?php 
              $training_to = $batch['batch_to_date'];
              $training_to_plus_5 = date('Y-m-d', strtotime('+5 days', strtotime($training_to)));
              $current_date = date('Y-m-d');
            if ( $menu == 'training_batches' && $batch['batch_status'] == 'Approved' && ($training_to_plus_5 >= $current_date) ) { ?>
                <div class="form-group">
                  <label for="total_candidates" class="col-sm-3 control-label">Batch Communication:</label>
                  <div class="col-sm-8">
              ...
              <?php if (isset($batch_attendance) && count($batch_attendance) > 0 && $batch['batch_status'] != 'In Review') { ?>
              <div class="form-group">
                  <label for="total_candidates" class="col-sm-3 control-label">Batch Attendance :</label>
                  <div class="col-sm-8">
                    <table class="table table-bordered" style="border-color:#ccc; margin:10px 0 15px 0;">
                      <tbody>
                        <tr>
              ...
              <?php if ( $batch['batch_status'] != 'In Review' ) { ?>
              <form autocomplete="off" name="attendanceForm" id="attendanceForm" action="<?php echo base_url('/iibfdra/Version_2/TrainingBatches/upload_attendance'); ?>" method="post" data-parsley-validate="parsley"  enctype="multipart/form-data" onsubmit ="return attendance_form_submit()">

                <input type="hidden" name="validateAttendance_err" id="validateAttendance_err" value="0">
                <input type="hidden" name="validateScreenshot_err" id="validateScreenshot_err" value="0">
                <input type="hidden" name="attendance_batch_id" id="attendance_batch_id" value="<?php echo $batch['id']; ?>">
                <input type="hidden" name="menu" id="menu" value="<?php echo $menu; ?>">

                <div class="form-group">
                  <label for="roleid" class="col-sm-3 control-label">Upload Attentance List<span style="color:#F00">*</span></label>
                  <div class="col-sm-3">
                    <label for="roleid" class="control-label">Attendance Sheet<span style="color:#F00">*</span></label>
                    <input type="file" class="form-control" name="attendance_doc" id="attendance_doc" onchange="validateDoc(event, 'attendance_doc_error')" data-parsley-trigger="focusin focusout" required>
                    <span class="note" id="attendance_doc_note">Note: Please Upload only .txt, .doc, .docx, .pdf .xls .xlsx Files with size upto 5 MB</span></br>
                    <span class="note-error" id="attendance_doc_error"> <?php echo form_error('attendance_doc'); ?></span>
                  </div>

                  <div class="col-sm-3">
                    <label for="roleid" class="control-label">Screenshots<span style="color:#F00">*</span></label>
                    <input type="file" class="form-control" name="screenshot" id="screenshot" onchange="validateDoc(event, 'screenshot_error')" data-parsley-trigger="focusin focusout" required>
                    <span class="note" id="screenshot_note">Note: Please Upload only .jpg, .jpeg, .png, .doc, .docx Files with size upto 5 MB</span></br>
                    <span class="note-error" id="screenshot_error"> <?php echo form_error('screenshot'); ?></span>
                  </div>

                  <!-- <div class="col-sm-3">
                    <label for="roleid" class="control-label">Attendance Date<span style="color:#F00">*</span></label>
                    <input type="date" class="form-control" name="attendance_date" id="attendance_date" data-parsley-trigger="focusin focusout" required>
                    <span class="note-error" id="attendance_date_error"> <?php echo form_error('screenshot'); ?></span>
                  </div> -->  
                </div>
                ...
                <div class="form-group">                
                  ...
                  <div class="col-sm-3">
                    <button class="btn btn-primary" type="submit" name="attendance_submit">Submit</button>
                  </div>
                </div>    
              </form>
            <?php } ?>  
      ...
      <div class="col-xs-12">
        <div class="box box-info batch_checklist" style="display: none;">
          <div class="box-body">
            <div class="form-group">
              <label for="total_candidates" class="col-sm-3 control-label">Take Action</label>
            ...
            <div class="form-group">
              ...
              <label for="total_candidates" class="col-sm-3 control-label"></label>
                ...
                <table id="listitems_logs" class="table table-bordered table-striped">
                  ...
                  <tbody class="no-bd-y" id="list222">
                    <?php foreach ($agency_batch_logs as $res_log) {
                      ...
                      $string = $res_log['title'];

                      if (strpos($string, 'for') !== false) {
                          // Pattern to remove text between "Inspector" and "for"
                          $pattern = '/(Inspector\s).*?\sfor/';
                          $replacement = 'Inspector for';
                      } else {
                          // Pattern to remove text after "Inspector"
                          $pattern = '/(Inspector\s).*/';
                    ...
                    ?>
                      ...
                      <tr>
                        <td><?php echo $k; ?></td>
                        <td><?php echo str_replace("DRA Admin", "", $result) . ' ' . $Accridation_text . ' -  ' . $update_by; ?></td>
                        <td><?php echo date("d-M-Y H:i:s", strtotime($res_log['date'])); ?></td>
...
<script type="text/javascript">
  ...
  function attendance_form_submit() 
  {
    var validateAttendance_err = $('#validateAttendance_err').val();
    var validateScreenshot_err = $('#validateScreenshot_err').val();
    if ( validateAttendance_err == 0 && validateScreenshot_err == 0 ) 
    {
      return true;
    }
    return false;
  ...
  var srcContent;
    function validateDoc(e, error_id)
    {
      ...
      if (error_id == 'training_schedule_error') {
        formErrorId = 'validateDoc_err';
      } else if (error_id == 'attendance_doc_error') {
        formErrorId = 'validateAttendance_err';
      } else {
        formErrorId = 'validateScreenshot_err';
      }
      ...
      if( document.getElementById(srcid).files.length != 0 )
      {
        ...
        if(file.size == 0)
        {
          $('#'+formErrorId).text('Please select valid file');
          $('#'+document.getElementById(srcid).id).val('');
          $('#'+formErrorId).val('1');
        }  
        else
        {
          if (formErrorId == 'validateScreenshot_err') {
            var allowedFiles = [".jpg", ".jpeg", ".png", ".JPG", ".JPEG", ".PNG", ".doc", ".docx"];
          } else {
            var allowedFiles = [".txt", ".doc", ".docx", ".pdf", ".xls", ".xlsx"];            
          }
  ...
  $(document).ready(function() {
    ...
    $('.update_batch_communication').click(function() {
      ...
      if (batch_communication == '') {
        ...
        $.ajax({
          url: site_url + 'iibfdra/Version_2/TrainingBatches/agency_update_batch_communication',
          data: {
            agency_id: agency_id,
            batch_id: batch_id,
  ...
  function change_status() {
    ...
    if (err_cnt == 0) {
      $.ajax({
        type: 'POST',
        url: base_url + "iibfdra/Version_2/TrainingBatches/change_status",
        data: {
          batch_id: batch_id,
          status: status,
          reason: reason
        ...
        success: function(data) {
          ...
          if (data.trim() == 1) {
            ...
            swal({
              title: 'Faculty Error!',
              text: 'The faculty has already been assigned to two batches.',
              icon: 'warning',
              type: 'warning',
              confirmButtonColor: '#3f51b5',
              confirmButtonText: 'OK ',
