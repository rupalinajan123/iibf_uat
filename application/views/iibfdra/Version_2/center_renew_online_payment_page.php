...
?>
  <div class="content-wrapper">
    <form class="form-horizontal demo-form" name="frmDrA" id="frmDrA" method="post" action="<?php echo base_url();?>iibfdra/Version_2/Center/renew" enctype="multipart/form-data" data-parsley-validate="parsley">
