...
<div class="content-wrapper"> 
  ...
  <section class="content">
    ...
    <form method="post" name="appfrom" action="<?php echo base_url(); ?>iibfdra/Version_2/InspectorHome/save_inspection_report" id="inspector_from"  enctype="multipart/form-data" >
      <div class="row">
        <div class="col-md-12">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Your session has expired. Please <strong><a href="<?php echo base_url('iibfdra/Version_2/InspectorLogin'); ?>" onclick="close_modal()" target="_blank">Click Here</a></strong> to login again. After logged in, please revisit the same page and submit your report.
