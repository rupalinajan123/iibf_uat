        ...
        <div class="box box-info">
          ...
          <div class="box-body">
            <form class="form-horizontal" autocomplete="off" name="frmDrACenter" id="faculty_form" method="post" enctype="multipart/form-data" data-parsley-validate>
              ...
              foreach ($faculty_code_data as $ins_key => $value) 
              {
                if ($faculty_code_data[0]['institute_id'] != '') 
                {
                  ...
                  $institute_name .= $ins_srno.".".$institute_data[0]['institute_name'].' ';
                } 
              ...
              <?php 
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <div class="col-sm-9">
                      <?php 
                        foreach ($faculty_code_data as $lan_key => $value) 
                        {
                          $lan_key=$lan_key+1;  
                          if ($faculty_code_data[0]['institute_id'] != '') 
                          {
                            echo $lan_key.". ".$value['inst_name']." : ".$value['languages'].'<br>';
                          }
                        }      
                      ?>  
                    </div>
