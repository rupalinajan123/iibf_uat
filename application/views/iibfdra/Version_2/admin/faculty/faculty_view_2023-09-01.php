          ...
          <div class="box-body">
            <form class="form-horizontal" autocomplete="off" name="frmDrACenter" id="faculty_form" method="post" enctype="multipart/form-data" data-parsley-validate>
              <?php 
                ...
                if ($status == 'In Review') { $labelCls = 'text-warning'; } 
                else if ($status == 'Active') { $labelCls = 'text-success'; } 
                else { $labelCls = 'text-danger'; }
              ?>
              ...
              <div class="col-sm-12">
                ...
                <div class="col-sm-4">
                  <div class="form-check">
                    <?php if ($status == 'In Review' || $status == 'Inactive') { ?>
                      <label><input type="radio" class="form-check-input radiobtn" id="active" name="radiobt" value="Active">Active</label>
                    <?php } ?>

                    <?php if ($status == 'In Review' || $status == 'Active') { ?>
                      <label><input type="radio" class="form-check-input radiobtn" id="inactive" name="radiobt" value="Inactive" onclick="return confirm_action(event)">In active</label>
                    <?php } ?>
                  </div>
              ...
              <div class="col-sm-12">
                <div class="form-group">
                  <label class="col-sm-3 control-label">Work Experience<span style="color:#F00">*</span></label>
                  <div class="col-sm-3">
                    <label class="control-label">Bank/ FI Name</label>
                  </div>
                  <div class="col-sm-3">
                    <label class="control-label">Last Position Employee Id</label>
                  </div>
                  <div class="col-sm-3">
                    <label class="control-label">Gross Duration</label>
                  </div>
                </div>
              </div>
              ...
              if (!empty($faculty_data[0]['emp_id1'])) { ?>
                    <div class="col-sm-3">
              ...
              if (!empty($faculty_data[0]['gross_duration1'])) { ?>
                    <div class="col-sm-3">
                      <input type="text" class="form-control" id="gross_duration0" name="gross_duration[]" placeholder="Gross Duration" value="<?php echo $faculty_data[0]['gross_duration1']; ?>" data-parsley-errors-container="#gross_duration_error0" data-parsley-required>
              ...
              if (!empty($faculty_data[0]['emp_id2'])) { ?>
                    <div class="col-sm-3">
              ...
              if (!empty($faculty_data[0]['gross_duration2'])) { ?>
                    <div class="col-sm-3">
                      <input type="text" class="form-control" id="gross_duration0" name="gross_duration[]" placeholder="Gross Duration" value="<?php echo $faculty_data[0]['gross_duration2']; ?>" data-parsley-errors-container="#gross_duration_error0" data-parsley-required>
                      <span class="note-error" id="gross_duration_error0"></span>
                    </div>
                  </div>
                </div>
              ...
              if (!empty($faculty_data[0]['emp_id3'])) 
              { ?>
                    <div class="col-sm-3">
              ...
              if (!empty($faculty_data[0]['gross_duration3'])) 
              { ?>
                    <div class="col-sm-3">
                      <input type="text" class="form-control" id="gross_duration0" name="gross_duration[]" placeholder="Gross Duration" value="<?php echo $faculty_data[0]['gross_duration3']; ?>" data-parsley-errors-container="#gross_duration_error0" data-parsley-required>
                      <span class="note-error" id="gross_duration_error0"></span>
                    </div>
                  </div>
                </div>
