...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <?php } else{ ?>
            ...
            <li class="treeview <?php if(stristr(current_url(),'BatchMIS')) { echo "active"; } ?>">
                <a href="<?php echo base_url(); ?>iibfdra/Version_2/admin/BatchMIS">
                    <i class="fa fa-check"></i> <span>Batch MIS</span>
                </a>
            </li>
            <li class="treeview <?php if(stristr(current_url(),'BatchSummary')) { echo "active"; } ?>">
                <a href="<?php echo base_url(); ?>iibfdra/Version_2/admin/BatchSummary">
                    <i class="fa fa-check"></i> <span>Batch Summary</span>
                </a>
            </li>
