...
.red {color:#f00;}
  ...
  <div><a>INDIAN INSTITUTE OF BANKING &amp; FINANCE<br><small>(An ISO 9001:2018 Certified)</small></a></div>
  <div><a>DRA - Admin Login </a></div>
            </div>
        ...
        <script type="text/javascript">
			...
			function refresh_captcha_img()
            {
                ...
                {
                    type: 'POST',
                    url: '<?php echo site_url("iibfdra/Version_2/admin/login/generate_captcha_ajax/"); ?>',
                    data: { "session_name":"draadminlogincaptcha" },
                    async: false,
