          ...
          <div class="box">
            <div class="box-header">
              ...
              <div class="pull-right">
              	<input type="submit" class="btn btn-warning btn_download" name="submit" value="Download" style="display:none">
              </div>
			  ...
			  <table id="listitems" class="table table-bordered table-striped dataTables-example">
                <thead>
                    <tr>
                      ...
                      <th id="date">Date</th>
                      <th id="description">Error Description</th>
                    </tr>
                </thead>
...
function searchOnDate()
{
	...
	var listing_url = base_url+'iibfdra/Version_2/admin/report/getFailureReason';
