            ...
            <input type="hidden" name="search_on_fields" id="search_on_fields" value="" />
						...
						<form method="POST" class="search_form_common_all">
							<div class="form-group">
								...
								<input type="text" class="form-control custom_search_cls" name="s_member_no" id="s_member_no" value="">
							</div>
							<div class="form-group">
								<label class="form-label">&nbsp;</label>
								<a href="javascript:void(0)" class="btn btn-primary" onclick="apply_search_val()">Search</a>
            ...
            <div class="table-responsive">
                ...
                <thead>
                                <tr>
										...
										<th class="text-center" id="regnumber">Training Id</th>
										...
										<th class="text-center" id="exam_applied">Applied to Exam</th> 						
...
<script type="text/javascript">
	$(document).ready(function()
	{
		var userDataTable = $('#listitems22').DataTable(
		{
			...
			"serverSide": true,
			"ajax": {
				"url": '<?php echo site_url("iibfdra/Version_2/Batch/get_candidates_data_ajax"); ?>', 
				"type": "POST",
				"data": function ( d ) 
				{
					d.s_batch_id = '<?php echo $batch_id; ?>';
