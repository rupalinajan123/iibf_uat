        ...
        <div class="box box-info box-solid disabled">
          ...
          <div class="box-body" style="display: block;">
            <?php // echo $is_applied;
			   			 ...
			   			 if($result['batch_status'] == 'A' ){ 
					   		$status_text =  'Approved'; 
							if(isset($is_applied)){
								if($is_applied == 0){
							$str_btn = '<textarea name="rejection" maxlength="300" class="rejection" rows="5" cols="40" placeholder="Describe cancel reason here"></textarea></br><a class="cancel_batch btn btn-danger " dataid ="'.$result['id'].'" href="javascript:void(0);">Cancel Batch</a>';	
								}else{
							...
							$div_class = '#d4edda';
							$div_class2 = '#270';
					   }elseif($result['batch_status'] == 'IR' ){ 
					   		$status_text =  'In Review'; 
							$str_btn = '<textarea name="rejection" maxlength="300" class="rejection" rows="5" cols="40" placeholder="Describe rejection reason here"></textarea> <a class="approve_batch btn btn-success " dataid ="'.$result['id'].'" href="javascript:void(0);">Approve</a>&nbsp; &nbsp; &nbsp;<a class="reject_batch btn btn-danger " dataid ="'.$result['id'].'" href="javascript:void(0);">Reject</a> &nbsp; &nbsp;';
							$div_class = '#f8d7da';
							$div_class2 = '#9F6000';
					   }elseif($result['batch_status'] == 'C' ){ 
             ...
             <form method="post" name="appfrom" id="approve_from"  enctype="multipart/form-data">
              ...
              <div class="table-responsive ">
                <table class="table table-bordered table-striped" style="background:<?php echo $div_class; ?>;">
                  <tbody>
                    <tr>
                    ...
                    <tr>
                      ...
                      <td width="50%"><?php echo $result['batch_name']; ?> ( <?php echo $result['batch_code']; ?> )</td>
                    </tr>
                    
                    <tr>
                      <td width="50%"><strong>1st Faculty Name  (Qualification) :</strong></td>
                      <td width="50%">
					<?php  if($result['faculty_name'] != '' && $result['faculty_qualification'] != '' ){
					   echo $result['faculty_name']; ?> ( <?php echo $result['faculty_qualification']; ?> )
                       <?php }else{ echo '--';} ?>
                       </td>
                    </tr>
                    
                     <tr>
                      <td width="50%"><strong>2nd Faculty Name  (Qualification) :</strong></td>
                      <td width="50%">
					<?php  if($result['faculty_name2'] != '' && $result['faculty_qualification2'] != '' ){
					   echo $result['faculty_name2']; ?> ( <?php echo $result['faculty_qualification2']; ?> )
                       <?php }else{ echo '--';} ?>
                       </td>
                    </tr>
                    
                    <tr>
                      <td width="50%"><strong>Name  Of Bank :</strong></td>
                    ...
                    <tr>
                      <td width="50%"><strong>Training Address :</strong></td>
	  ...
	  ?></strong>
                    ...
                    <tr>
                      ...
                      <td width="50%"><?php 
                       if( $result['timing_from'] != ''  && $result['timing_to'] != '')	{?>
                        FROM <strong><?php echo $result['timing_from']; ?> </strong> TO <strong><?php echo $result['timing_to']; ?></strong>
                        <?php
                    ...
                    <tr>
                      ...
                      <td width="50%"><?php if( $result['total_candidates'] != '' )	{?>
                        <?php echo $result['total_candidates']; //medium_description ?>
                         <?php }else{ echo '--';} ?></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <?php  if(($result['batch_status'] == 'A' || $result['batch_status'] == 'C') && $result['inspector_id'] != 0 ){  ?> 
                    <tr>
