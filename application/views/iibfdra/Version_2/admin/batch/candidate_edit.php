                    ...
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">Basic Details</h3>
                             ...
                             <?php 
                            $back_url = base_url('iibfdra/Version_2/batch/candidates_list/');

                            if(isset($url_batch_id) && $url_batch_id > 0)
                            {
                              $back_url = base_url('iibfdra/Version_2/batch/candidates_list/'.base64_encode($url_batch_id));
                            } ?>
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <?php
                                  ...
                                  $dateofbirth = !empty($examRes['dateofbirth']) ? $examRes['dateofbirth'] : '';  
                                ?>
                                
                                <!-- <input type="hidden" autocomplete="false" id="dateofbirth" name="dob" required value="<?php echo $dateofbirth; ?>"> -->

                                <div class="col-sm-5">
                                  <input type="text" class="form-control" id="dob_date" name="dob_date" placeholder="Date of Birth" value="<?php if($dateofbirth != "") { echo $dateofbirth; } else { echo set_value('dob_date'); } ?>" onchange="remove_err_msg('dob_date')" autocomplete="off" required/>  
                                  <span id="dob_date_error" class="error note-error"></span>
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <a href="<?php echo base_url().'uploads/iibfdra/'.$examRes["idproofphoto"].'?'.time();?>" target="_blank" > <img id="idproof_preview" height="100" width="100" src="<?php echo base_url().'uploads/iibfdra/'.$examRes["idproofphoto"].'?'.time();?>" /> </a>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="<?php echo base_url().'uploads/iibfdra/'.$examRes["quali_certificate"].'?'.time();?>" target="_blank" ><img src="<?php echo base_url().'uploads/iibfdra/'.$examRes["quali_certificate"].'?'.time();?>" id="qualicertificate_preview" height="100" width="100"/></a>
                                </div>
                                ...
                                <?php /*?><div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <a href="<?php echo base_url().'uploads/iibfdra/'.$examRes["scannedphoto"].'?'.time();?>" target="_blank"> <img src="<?php echo base_url().'uploads/iibfdra/'.$examRes["scannedphoto"].'?'.time();?>"  id="scanphoto_preview" height="100" width="100"/></a>
                                </div>
                                ...
                                <label for="roleid" class="col-sm-3 control-label"> Signature of the Candidate <span class="required-spn">*</span></label>
                                    ...
                                    <a href="<?php echo base_url().'uploads/iibfdra/'.$examRes["scannedsignaturephoto"].'?'.time();?>" target="_blank"> <img src="<?php echo base_url().'uploads/iibfdra/'.$examRes["scannedsignaturephoto"].'?'.time();?>" id="signature_preview" height="100" width="100"/> </a>
                                </div>
...
*/
    ...
    if(state_code){
      $.ajax({
        type:'POST',
        url: 'https://iibf.esdsconnect.com/iibfdra/Version_2/Batch/getCity',
