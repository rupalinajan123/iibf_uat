                         ...
                         <div class="box box-info">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="radio" id="post_graduate" name="edu_quali" required value="post_graduate" <?php if(set_value('edu_quali')){echo set_radio('edu_quali', 'post_graduate');}else{echo set_radio('edu_quali', 'post_graduate', ($examRes["qualification"] == 'post_graduate'));}?>>
                                        <span class="error"><?php //echo form_error('edu_quali');?></span>
                                    </div>
                                </div>
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group idproof-wrap">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <img id="idproof_preview" height="100" width="100" src="<?php echo base_url().'uploads/iibfdra/'.$examRes["idproofphoto"].'?'.time();?>" />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="<?php echo base_url().'uploads/iibfdra/'.$examRes["quali_certificate"].'?'.time();?>" id="qualicertificate_preview" height="100" width="100"/>
                                </div>
                                ...
                                <?php /*?><div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <img src="<?php echo base_url().'uploads/iibfdra/'.$examRes["scannedphoto"].'?'.time();?>"  id="scanphoto_preview" height="100" width="100"/>
                                </div>
                                ...
                                <label for="roleid" class="col-sm-3 control-label"> Signature of the Candidate <span class="required-spn">*</span></label>
                                    ...
                                    <img src="<?php echo base_url().'uploads/iibfdra/'.$examRes["scannedsignaturephoto"].'?'.time();?>" id="signature_preview" height="100" width="100"/>
                                </div>
