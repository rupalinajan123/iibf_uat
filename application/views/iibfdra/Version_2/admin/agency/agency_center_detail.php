      ...
      <div class="col-md-12">
        ...
        <div class="box box-info box-solid disabled">
          ...
          <div class="box-body" style="display: block;">
            ...
            if($result['center_id'] == '3039') { echo ' - Wagholi'; }
            ...
            if($result['center_id'] == '3039') { echo ' - Wagholi'; }
					  ...
					  <?php if($result['faculty_name1'] != '')
					  		...
					  		{ 
								...
								echo '<li>'.$result['faculty_name1'] .' ('.$result['faculty_qualification1'].')';
							 	...
							 	if($result['cv1'] != ''){
									...
									echo '&nbsp; <a class="btn1 btn-info btn-xs vbtn" target="_blank" href="'.base_url().'uploads/iibfdra/Version_2/agency_center/faculty_cv/'.$result['cv1'].'">&nbsp;View CV &nbsp;<i class="fa fa fa-file"></i> &nbsp;</a>'; 
							...
							{ 
								...
								if($result['cv2'] != ''){
									...
									echo '&nbsp; <a class="btn1 btn-info btn-xs vbtn" target="_blank" href="'.base_url().'uploads/iibfdra/Version_2/agency_center/faculty_cv/'.$result['cv2'].'">&nbsp;View CV &nbsp;<i class="fa fa fa-file"></i> &nbsp;</a>'; 
							...
							{ 
								...
								if($result['cv3'] != ''){
									...
									echo '&nbsp; <a class="btn1 btn-info btn-xs vbtn" target="_blank" href="'.base_url().'uploads/iibfdra/Version_2/agency_center/faculty_cv/'.$result['cv3'].'">&nbsp;View CV &nbsp;<i class="fa fa fa-file"></i> &nbsp;</a>'; 
							...
							{ 
								...
								if($result['cv4'] != ''){
									...
									echo '&nbsp; <a class="btn1 btn-info btn-xs vbtn" target="_blank" href="'.base_url().'uploads/iibfdra/Version_2/agency_center/faculty_cv/'.$result['cv4'].'">&nbsp;View CV &nbsp;<i class="fa fa fa-file"></i> &nbsp;</a>'; 
							...
							{ 
								...
								if($result['cv5'] != ''){
									...
									echo '&nbsp; <a class="btn1 btn-info btn-xs vbtn" target="_blank" href="'.base_url().'uploads/iibfdra/Version_2/agency_center/faculty_cv/'.$result['cv5'].'">&nbsp;View CV &nbsp;<i class="fa fa fa-file"></i> &nbsp;</a>'; 
                    ...
                    <tr>
					  ...
					  echo '  &nbsp; &nbsp; <a class="btn btn-info btn-xs vbtn" target="_blank" href="'.base_url().'uploads/iibfdra/Version_2/agency_center/'.$result['upload_file1'].'"> &nbsp; &nbsp;View document &nbsp;<i class="fa fa fa-book"></i> &nbsp; &nbsp;</a>'; } else {  echo '--'; } ?></td>
                    ...
                    <tr>
                      ...
                      <td width="50%"><?php if($result['upload_file2'] != ''){ 
					   ...
					   echo '  &nbsp; &nbsp; <a class="btn btn-info btn-xs vbtn" target="_blank" href="'.base_url().'uploads/iibfdra/Version_2/agency_center/'.$result['upload_file2'].'"> &nbsp; &nbsp;View document &nbsp;<i class="fa fa fa-book"></i> &nbsp; &nbsp;</a>';
                      ...
                      <td width="50%"><span class="pay_span"><strong>
						...
						if( 1 ){	
							...
							if($result['invoice_image'] != '') {							
								...
								echo '  &nbsp; &nbsp; <a class="btn btn-info btn-xs vbtn" target="_blank" href="'.base_url().'iibfdra/Version_2/agency/training_center_receipt/'.$result['center_id'].'"> &nbsp; &nbsp;View Receipts <i class="fa fa-credit-card"></i> &nbsp; &nbsp;</a>';
                    ...
                    <?php if ($result['center_status'] != 'R') { ?>
	                    <tr>
	                      ...
	                      <td width="50%" style="font-size:16px; ?>;" >
	                      	...
	                      	<input type="radio" class="approve-payment" id="approve_payment" name="payment_required" value="with_payment" /> With Payment
	                      	<input type="radio" class="approve-payment" id="approve_payment" name="payment_required" value="without_payment" /> Without Payment
	                    ...
	                    <?php if ($result['payment_required'] == 'with_payment' || $result['payment_required'] == '') { ?>
		                    <tr id="payment_amount_section">
		                      <td width="50%"><strong>Payment Amount :</strong></td>

		                      <td width="50%" style="font-size:16px; ?>;" >
		                      	<?php if (trim($result['required_amount']) == '' || $result['required_amount'] == null) { ?>
		                      	<input type="radio" id="required_amount" name="required_amount" value="12000" /> Accreditaion Fee(12000)
		                      	<input type="radio" id="required_amount" name="required_amount" value="10000" /> Dilliance Fee(10000)
		                      	<br><input type="radio" id="required_amount" name="required_amount" value="22000" /> Accreditaion+Dilliance(22000)

		                      <?php } elseif ($result['required_amount'] == '12000') {
		                      			echo "Accreditaion Fee(12000)";
		                      	} elseif ($result['required_amount'] == '10000') {
		                      		echo "Dilliance Fee(10000)";
		                      	} elseif ($result['required_amount'] == '22000') {
		                      		echo "Accreditaion+Dilliance(10000)";
		                      	}	?>
...
$('.approve-payment').on('change',function(){
		var pay_type = $(this).val();
		if (pay_type == 'without_payment') {
...
$(function () {
	...
	$('.approve_center').click(function(){  
		...
		var required_amount  = $('input[name="required_amount"]:checked').val();
		...
		if (payment_required == 'with_payment') {
			if (required_amount == '' || required_amount == undefined) {
				alert('Please select payment amount field.');
				return false;	
			}	
		}
	...
	var listing_url = base_url+'iibfdra/Version_2/agency/get_tranning_center_list/'+center_id;
