...
$(function () {
	...
	var listing_url = base_url+'iibfdra/Version_2/admin/transaction/getNeftTransactions';
...
function confirmVerify(id)
{
	...
	var base_url = '<?php echo base_url(); ?>';
	var url = base_url+'iibfdra/Version_2/admin/transaction/getNeftTransactionDetails';
...
function confirmApprove(action)
{
	...
	var base_url = '<?php echo base_url(); ?>';
	var url = base_url+'iibfdra/Version_2/admin/transaction/approveNeftTransactions';
		...
		success: function(res) 
		{
			...
			if(res)
			{
				if(res.success == 'success')
				{
					...
					{					
					var url_admitcard = base_url+'iibfdra/Version_2/admin/transaction/dra_generate_admitcard';
					$.ajax({
							url: url_admitcard,
							type: 'POST',
							dataType:"json",
