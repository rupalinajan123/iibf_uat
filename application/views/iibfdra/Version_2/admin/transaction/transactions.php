              ...
              <div class="box-body">
                ...
                <div class="box-footer">
                    <div class="col-sm-2 col-xs-offset-5">
                      ...
                      <a href="<?php echo base_url().'iibfdra/Version_2/admin/transaction/transactions'; ?>" class="btn btn-default pull-right"  name="btnReset" id="btnReset">Reset</a>
                    </div>
                </div>
             </div>
          </div>
...
$(function () {
	...
	var listing_url = base_url+'iibfdra/Version_2/admin/transaction/getTransactions';
