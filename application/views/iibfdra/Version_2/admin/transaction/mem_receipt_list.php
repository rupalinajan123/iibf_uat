		...
		<td align='center'>	
			<table width="80%" border="1" align="center" cellpadding="5" cellspacing="" style="border-collapse:collapse">
				<tr>
                    ...
                    <td width="40%" align="center">Registration No.</td>
				...
				<tr>
					...
					<!-- <td width="30%" align="center" colspan="2">
						<a target="_blank" href="<?php echo base_url(); ?>iibfdra/Version_2/admin/transaction/mem_receipt/<?php echo base64_encode($txn_id); ?>/<?php echo base64_encode($row['regid']); ?>"> View Receipt </a>
					</td> -->
				</tr>
