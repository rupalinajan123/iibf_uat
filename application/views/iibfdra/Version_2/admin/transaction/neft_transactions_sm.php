...
$(function () {
	...
	var listing_url = base_url+'iibfdra/admin/transaction_sm/getNeftTransactions'; 
...
function confirmVerify(id)
{
	...
	var base_url = '<?php echo base_url(); ?>';
	var url = base_url+'iibfdra/admin/transaction_sm/getNeftTransactionDetails';
...
function confirmApprove(action)
{
	...
	var base_url = '<?php echo base_url(); ?>';
	var url = base_url+'iibfdra/admin/transaction_sm/approveNeftTransactions';
