          ...
          <div class="box">
            ...
            <div class="box-body">
              ...
              <div class="table-responsive">
                <table id="" class="table table-bordered table-striped dataTables-example">
                  <thead>
                    <tr>
                      <th id="srNo">S.No.</th>
                  ...
                  foreach($inspector_list as $res)
                  {
                   ...
                   /*-------------------Multiple Select Dropdown------------------*/
                    /*$this->db->join('agency_center','agency_center.center_id=agency_inspector_center.center_id','left');
                      $this->db->select('agency_inspector_center.*,city_master.city_name');
                      $this->db->join('city_master','agency_inspector_center.city=city_master.id','LEFT');        
                      $location_name= $this->Master_model->getRecords("agency_inspector_center",array('inspector_id'=>$res['id']),'city');
                  ...
                  ?>
                    <tr>
                        ...
                        <td><?php if($city[0]['city'] != 0 || $city[0]['city']!="" ){echo $city[0]['city_name'];} else{ echo"-";}?></td>
                        <td><a href="<?php base_url();?>InspectorMaster/edit/<?php echo base64_encode($res['id']);?>">Edit</a></td>
                        <?php $i++;  }  ?>
                    </tr>
                  </tbody>
                </table>
