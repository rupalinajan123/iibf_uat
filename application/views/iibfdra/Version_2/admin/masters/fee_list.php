          ...
          <div class="box">
            <div class="box-header">
              ...
              <div class="pull-right">
              	<a href="<?php echo base_url();?>iibfdra/Version_2/admin/FeeMaster/add" class="btn btn-warning">Add</a>
                <a href="<?php echo base_url();?>iibfdra/Version_2/admin/FeeMaster/import" class="btn  btn-primary">Import</a>
                <a href="<?php echo base_url();?>iibfdra/Version_2/admin/FeeMaster/download" class="btn  btn-primary">Download</a>
            ...
            <div class="table-responsive">
              <table id="listitems" class="table table-bordered table-striped dataTables-example">
                ...
                <tr>
                  ...
                  <th id="part_no">Part No.</th>
                  <th id="syllabus_code">Syllabus Code</th>
                  <th id="member_category">Member Category</th>
                  <th id="group_code">Group Code</th>
                  <th id="fee_amount">Fee Amount</th>
...
$(function () {
	...
	var listing_url = base_url+'iibfdra/Version_2/admin/FeeMaster/getList';
