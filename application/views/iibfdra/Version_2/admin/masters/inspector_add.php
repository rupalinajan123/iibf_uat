...
<form class="form-horizontal" name="usersAddForm" id="usersAddForm" action="<?php echo base_url();?>iibfdra/Version_2/admin/InspectorMaster/add" method="post">
      ...
      <div class="col-md-12">
        ...
        <div class="box box-info">
          ...
          <div class="box-header with-border">
            ...
            <div class="pull-right"> <a href="<?php echo base_url();?>iibfdra/Version_2/admin/InspectorMaster" class="btn btn-warning">Back</a> </div>
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                ...
                <input type="text" class="form-control" id="inspector_name" name="inspector_name"  placeholder="Inspector Name" data-parsley-maxlength="50" autocomplete="off" maxlength="50" data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" >
              ...
              <div class="col-sm-3">
                ...
                <input type="text" class="form-control" id="inspector_mobile" name="inspector_mobile" value="<?php echo $inspectorRes['inspector_mobile'];?>"  placeholder="Mobile Number" maxlength="10" minlength="10"  onkeypress="return event.charCode >= 46 && event.charCode <= 57 || event.keyCode == 8 || event.keyCode == 46 ">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3">
                ...
                <input type="email" class="form-control" id="inspector_email" name="inspector_email" placeholder="Email Id" >
              ...
              <div class="col-sm-3">
                ...
                <input type="text" class="form-control" id="inspector_designation" maxlength="40" name="inspector_designation"  placeholder="Inspector Designation" pattern="^[A-Za-z -]+$" onkeypress="return validateDec(event)">
								</div>
							</div>
							...
							<div class="form-group">								
								...
								<div class="col-sm-3">
									<label class="radio-inline" style="padding-top: 0;margin-top: -8px; margin-right:20px;">
										<input type="radio" name="batch_online_offline_flag" id="batch_online_offline_flag0" checked <?php echo set_radio('batch_online_offline_flag', '0'); ?> value="0" required onchange="batch_online_location_show(this.value)"> Offline
									</label>
									<label class="radio-inline" style="padding-top: 0;margin-top: -8px;"> 
										<input type="radio" name="batch_online_offline_flag" id="batch_online_offline_flag1" <?php echo set_radio('batch_online_offline_flag', '1'); ?> value="1" required onchange="batch_online_location_show(this.value)"> Online
									</label>
        ...
        <div class="col-md-12">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-3">
              ...
              <select class="form-control" id="city" name="city[]" multiple=""  style="height:260px;"  required>

               <!-- <option value="">Select</option>-->
				<?php /*?><?php if(count($cities) > 0){
	...
	try{
		...
		var validator = $("#usersAddForm").validate({
			...
			rules: {
				...
				inspector_email:{required: true,remote:site_path+'iibfdra/Version_2/admin/InspectorMaster/emailduplication?inspector_email='+inspector_email},

				inspector_mobile:{number: true,required: true,remote:site_path+'iibfdra/Version_2/admin/InspectorMaster/mobileduplication?inspector_mobile='+inspector_mobile},
			...
			messages: {
				...
				inspector_email:{remote: "Email ID already present."},	

				inspector_mobile:{remote: "Mobile Number already present."},	
...
if(state_code){
  ...
  $.ajax({
    ...
    url: site_path+'iibfdra/Version_2/admin/InspectorMaster/getCity',
