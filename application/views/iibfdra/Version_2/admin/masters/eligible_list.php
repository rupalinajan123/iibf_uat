          ...
          <div class="box">
            <div class="box-header">
              ...
              <div class="pull-right">
              	<a href="<?php echo base_url();?>iibfdra/Version_2/admin/EligibleMaster/add" class="btn btn-warning">Add</a>
                <a href="<?php echo base_url();?>iibfdra/Version_2/admin/EligibleMaster/import" class="btn  btn-primary">Import</a>
                <!--<a href="<?php echo base_url();?>iibfdra/Version_2/admin/EligibleMaster/download"><input type="button" class="btn  btn-primary"  value="Download"></a>-->
...
$(function () {
	...
	var listing_url = base_url+'iibfdra/Version_2/admin/EligibleMaster/getList';
