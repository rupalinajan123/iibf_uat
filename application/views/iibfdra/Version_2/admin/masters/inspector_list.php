        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <a href="https://iibf.esdsconnect.com/iibfdra/Version_2/admin/InspectorMaster/generateCsv" class="btn btn-warning">Download Inspector credentials</a>
                <a href="<?php echo base_url();?>iibfdra/Version_2/admin/InspectorMaster/add" class="btn btn-warning">Add New Inspector</a>
                ...
                <table id="isnp_list" class="table table-bordered table-striped dataTables-example">
                  <thead>
                    <tr>
                      ...
                      <th id="inspector_pwd">Password</th>
                  ...
                  ?>
                    <tr>
                        ...
                        <td><?php echo $res['plain_password']; ?></td>
                        <td><?php echo $res['inspector_designation']; ?></td>
                       <?php /*?> <td><?php if($city[0]['city'] != 0 || $city[0]['city']!="" ){echo $city[0]['city_name'];} else{ echo"-";}?></td><?php */?>
                        <td><?php if($res['batch_online_offline_flag'] == 1) { echo "Online"; } else { if($location_string != ''  ) { echo $location_string ; } else{ echo"-";} } ?></td>
                        
                        <td><a href="<?php echo base_url();?>iibfdra/Version_2/admin/InspectorMaster/edit/<?php echo base64_encode($res['id']);?>">Edit</a> | <a href="javascript:void(0);" class="btn tooltip1 btn-info btn-xs vbtn active_deactive_btn insp_<?php echo $res['id'];?>" data-type="<?php echo $res['is_active']==1 ? 'active' : 'Deactive';  ?>"  data-id ="<?php echo $res['id']; ?>">
...
<script type="text/javascript">
 ...
 $('#isnp_list').on('click', '.active_deactive_btn', function() {
		...
		var url = base_url+'iibfdra/Version_2/admin/InspectorMaster/activate_deactivate';
