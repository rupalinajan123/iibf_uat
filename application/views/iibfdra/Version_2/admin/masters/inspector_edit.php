...
<form class="form-horizontal" name="userseditForm" id="userseditForm" action="" method="post">
  <!-- Main content -->
  ...
  jQuery.validator.addMethod("check_password", function(confirm_password, element){
    ...
    var inspector_id = $('#inspector_id').val();
		var validator = $("#userseditForm").validate({
			errorElement: 'div',
			rules: {
				inspector_email:{required: true,remote:site_path+'iibfdra/Version_2/admin/InspectorMaster/emailduplication_edit?inspector_email='+inspector_email+'&inspector_id='+inspector_id},
				inspector_mobile:{number: true,required: true,remote:site_path+'iibfdra/Version_2/admin/InspectorMaster/mobileduplication_edit?inspector_mobile='+inspector_mobile+'&inspector_id='+inspector_id},
