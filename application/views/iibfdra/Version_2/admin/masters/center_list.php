          ...
          <div class="box">
            <div class="box-header">
              ...
              <div class="pull-right">
              	<a href="<?php echo base_url();?>iibfdra/Version_2/admin/CenterMaster/add"  class="btn btn-warning" >Add</a>
                <a href="<?php echo base_url();?>iibfdra/Version_2/admin/CenterMaster/import" class="btn  btn-primary">Import</a>
                <a href="<?php echo base_url();?>iibfdra/Version_2/admin/CenterMaster/download" class="btn  btn-primary">Download</a>
            ...
            <div class="table-responsive">
              <table id="listitems" class="table table-bordered table-striped dataTables-example">
                ...
                <tr>
                  ...
                  <th id="center_code">Center Code</th>
                  <th id="state_code">State Code</th>
                  <th id="state_description">State Description</th>
                  <th id="exammode">Exam Mode</th>
...
$(function () {
	...
	var listing_url = base_url+'iibfdra/Version_2/admin/CenterMaster/getList';
