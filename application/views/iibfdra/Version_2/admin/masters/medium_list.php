          ...
          <div class="box">
            <div class="box-header">
              ...
              <div class="pull-right">
              	<a href="<?php echo base_url();?>iibfdra/Version_2/admin/MediumMaster/add" class="btn btn-warning">Add</a>
                <a href="<?php echo base_url();?>iibfdra/Version_2/admin/MediumMaster/import" class="btn  btn-primary">Import</a>
                <a href="<?php echo base_url();?>iibfdra/Version_2/admin/MediumMaster/download" class="btn  btn-primary">Download</a>
            ...
            <div class="table-responsive">
              <table id="listitems" class="table table-bordered table-striped dataTables-example">
                ...
                <tr>
                  ...
                  <th id="medium_code">Medium Code</th>
                  <th id="medium_description">Medium Description</th>
...
$(function () {
	...
	var listing_url = base_url+'iibfdra/Version_2/admin/MediumMaster/getList';
