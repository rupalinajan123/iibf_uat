          ...
          <div class="box">
            <div class="box-header">
              ...
              <div class="pull-right">
              	<a href="<?php echo base_url();?>iibfdra/Version_2/admin/ExamActiveMaster/add" class="btn btn-warning">Add</a>
                <a href="<?php echo base_url();?>iibfdra/Version_2/admin/ExamActiveMaster/import" class="btn  btn-primary">Import</a>
                <a href="<?php echo base_url();?>iibfdra/Version_2/admin/ExamActiveMaster/download" class="btn  btn-primary">Download</a>
            ...
            <div class="table-responsive">
              <table id="listitems" class="table table-bordered table-striped dataTables-example">
                ...
                <tr>
                  ...
                  <th id="exam_from_date">Exam From Date</th>
                  <th id="exam_from_time">Exam From Time</th>
                  <th id="exam_to_date">Exam To Date</th>
...
$(function () {
	...
	var listing_url = base_url+'iibfdra/Version_2/admin/ExamActiveMaster/getList';
