          ...
          <div class="box">
            <div class="box-header">
              ...
              <div class="pull-right">
              	<a href="<?php echo base_url();?>iibfdra/Version_2/admin/InstitutionMaster/add" class="btn btn-warning">Add</a>
                <a href="<?php echo base_url();?>iibfdra/Version_2/admin/InstitutionMaster/import" class="btn  btn-primary">Import</a>
                <a href="<?php echo base_url();?>iibfdra/Version_2/admin/InstitutionMaster/download" class="btn  btn-primary">Download</a>
            ...
            <div class="table-responsive">
              <table id="listitems" class="table table-bordered table-striped dataTables-example">
                ...
                <tr>
                  ...
                  <th id="srNo">S.No.</th>
                  <th id="institute_code">Institute Code</th>
                  <th id="institute_name">Institute Name</th>
                  <th id="category_code">Category Code</th>
...
$(function () {
	...
	var listing_url = base_url+'iibfdra/Version_2/admin/InstitutionMaster/getList';
