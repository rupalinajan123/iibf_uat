            ...
            <?php echo validation_errors(); ?>
             ...
             <?php } ?> 
                ...
                <label for="exam_code" class="col-sm-2 control-label">Exam Code <span class="red"> *</span></label>
                    ...
                    <label for="exam_description" class="col-sm-2 control-label">Exam Description <span class="red"> *</span></label>
                     <div class="col-sm-3">
                ...
                <div class="form-group">
                	<label for="exam_month" class="col-sm-2 control-label">Qualifying Exam1</label>
                         <div class="col-sm-3">
                            <input type="text" class="form-control" id="qualifying_exam1" name="qualifying_exam1" placeholder="Qualifying Exam1"  value="" onkeypress="return number(event)" data-parsley-type="number">
                    ...
                    <label for="trg_value" class="col-sm-2 control-label">Qualifying Part1</label>
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="qualifying_part1" name="qualifying_part1" placeholder="Qualifying Part1" value="" onkeypress="return number(event)" data-parsley-type="number">
                ...
                <div class="form-group">
                	<label for="exam_month" class="col-sm-2 control-label">Qualifying Exam2</label>
                         <div class="col-sm-3">
                            <input type="text" class="form-control" id="qualifying_exam2" name="qualifying_exam2" placeholder="Qualifying Exam2"  value="" onkeypress="return number(event)" data-parsley-type="number">
                    ...
                    <label for="trg_value" class="col-sm-2 control-label">Qualifying Part2</label>
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="qualifying_part2" name="qualifying_part2" placeholder="Qualifying Part2" value="" onkeypress="return number(event)" data-parsley-type="number">
                ...
                <div class="form-group">
                	<label for="exam_month" class="col-sm-2 control-label">Qualifying Exam3</label>
                         <div class="col-sm-3">
                            <input type="text" class="form-control" id="qualifying_exam3" name="qualifying_exam3" placeholder="Qualifying Exam3"  value="" onkeypress="return number(event)" data-parsley-type="number">
                    ...
                    <label for="trg_value" class="col-sm-2 control-label">Qualifying Part3</label>
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="qualifying_part3" name="qualifying_part3" placeholder="Qualifying Part3" value="" onkeypress="return number(event)" data-parsley-type="number">
                ...
                <div class="form-group">
                    ...
                    <label for="trg_value" class="col-sm-2 control-label">Exam Priority</label>
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="examprty" name="examprty" placeholder="Exam Priority" value="" onkeypress="return (alphanumber(event) && alphanumberctrl(event));" data-parsley-pattern="/^[a-zA-Z0-9 ]+$/">
