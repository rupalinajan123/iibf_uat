...
$(function () {
  ...
  $('#selectall').on('click', function(){
   ...
   $('.btn_hold_release').on('click',function () {
    ...
    if(candidates_checked_array.length > 0){
      $.ajax({
        url:site_url+'iibfdra/admin/InspectionSummary/candidate_hold',
        type: 'POST',
         ...
         swal({
            ...
            if(data != '')
            {
              ...
              $.each(JSON.parse(data), function(idx, obj) {
                ...
                var view = '<a href="'+site_url+"iibfdra/admin/inspectionSummary/details/"+btoa(obj.regid)+'" target="_blank">details </a>'
  ...
  $('#batch_id').on('change',function () {
    ...
    if(batch_id != ''){
      ...
      $('#assigned_faculty1').attr('href',site_url+'iibfdra/admin/InspectionSummary/faculty_view/'+btoa(assigned_facultyid1));
      $('#additional_faculty1').text(additional_faculty1);
      $('#additional_faculty1').attr('href',site_url+'iibfdra/admin/InspectionSummary/faculty_view/'+btoa(additional_facultyid1));
      $('#assigned_faculty2').text(assigned_faculty2);
      $('#assigned_faculty2').attr('href',site_url+'iibfdra/admin/InspectionSummary/faculty_view/'+btoa(assigned_facultyid2));
      $('#additional_faculty2').text(additional_faculty2);
      $('#additional_faculty2').attr('href',site_url+'iibfdra/admin/InspectionSummary/faculty_view/'+btoa(additional_facultyid2));
