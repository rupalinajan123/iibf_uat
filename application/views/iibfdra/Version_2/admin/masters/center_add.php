             ...
             <?php } ?> 
                	...
                	<label for="exammode" class="col-sm-2 control-label">Exam Mode *</label>
                         <div class="col-sm-3">
                            <select class="form-control" id="exammode" name="exammode" required >
                                <option value="">Select</option>
                               	<option value="ON" <?php if($centerRes['exammode'] == "ON"){echo "selected='selected'";} ?>>ONLINE</option>
                                <option value="OFF" <?php if($centerRes['exammode'] == "OFF"){echo "selected='selected'";} ?>>OFFLINE</option>
                            </select>
              ...
              <div class="box-footer">
				...
				?>
                   ...
                   <a href="<?php echo base_url();?>iibfdra/Version_2/admin/CenterMaster" class="btn btn-default pull-right">Back</a>
                    </div>
              </div>
           </div>
        </div>
