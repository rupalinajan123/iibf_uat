 ...
 display:none;	
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
      Admitcard PDF <?php echo $date_str; ?>
      </h1>
      <?php echo $breadcrumb; ?>
    </section>
	<div class="col-md-12">
        ...
        <input type="hidden" name="base_url_val" id="base_url_val" value="" />
          ...
          <div class="box" style='display:none'>
              ...
              <div class="pull-right">
               <!--<a  data-toggle="tooltip" class="btn btn-warning" href="<?php echo base_url('iibfdra/Version_2/Admitcard/download_pdfs'); ?>"> Download All </a>-->
             </div> 
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
<h5><strong>ADMIT LETTER FOR DRA/DRA-TC FOR 8th October,2021</strong></h5>
	...
	<?} ?>
          ...
          <div class="box">
					<div class="box-header with-border">
						<h3 class="box-title">Admitcard pdfs for exam code 1036 - exam period <?php echo $download_admitcard_data[0]['exam_period']; ?> </h3>
					</div>
						
					<div class="box-body">
						<!-- <p style="font-size: 20px;"><b>Notice</b> : Due to operational reasons, the DRA examinations scheduled on 20th September 2025 at Vijayawada, Bengaluru, Hubbali, and Hyderabad have been rescheduled to 29th September 2025. The examination at Malda has been rescheduled to 4th October 2025. Admit letters will be issued to the candidates accordingly.</p><br> -->
									...
									<?php $cnt = 1; 
										...
										{		
											...
											<tr>
												...
												<td class="text-center"><a  href="<?php echo base_url().'/iibfdra/Version_2/Admitcard/centerwise_member_list/'.$res['center_code'].'/'.$res['exm_cd'].'/'.$res['exam_period'] ; ?>"><?php echo $res['center_name']; ?></a></td>
												...
												<td class="text-center">
													...
													<a class="" href="<?php echo base_url().'/iibfdra/Version_2/Admitcard/download_centerwise_pdf/'.$res['center_code'].'/'.$res['exm_cd'].'/'.$res['exam_period'] ; ?>"> Download</a>
												</td>
											</tr>
											<?php	$cnt++;
											}
