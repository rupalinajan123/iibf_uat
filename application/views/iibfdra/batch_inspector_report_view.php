                  ...
                  <div class="col-md-6">
                    <select class="form-control" name="batch_id" id="batch_id">
                      ...
                      <?php 
                        ...
                        ?>
                        <option value="<?php echo $value['id']; ?>" <?php if($batch_id == $value['id']) { echo "selected"; }  ?>><?php echo $value['batch_code']." (".$value['hours']." Hours - ".date("d M Y, h:i A", strtotime($value['created_on'])).") "; ?></option>
                        <?php }
                      ?>
                    </select>
                  </div>
        ...
        <table class="table table-bordered table-striped" style="word-wrap:anywhere; background:<?php echo $div_class; ?>;">
          <tbody>
            ...
            <tr>
              ...
              <td width="20%" id="candidate_count"><?php echo $batch[0]['total_candidates']; ?></td>
            </tr>
            <tr>
              <td width="29%"><strong>Assigned Faculty (main 1):</strong></td>
              <td width="20%"><a href="<?php echo site_url('iibfdra/InspectorHome/faculty_view/'.base64_encode($batch[0]['first_faculty_id'])); ?>" id="assigned_faculty1" target="_blank"><?php echo $batch[0]['first_faculty_name']; ?></a></td>
              <td width="2%"></td>
              <td width="29%"><strong>Assigned Faculty(main 2):</strong></td>
              <td width="20%"><a href="<?php echo site_url('iibfdra/InspectorHome/faculty_view/'.base64_encode($batch[0]['sec_faculty_id'])); ?>" id="assigned_faculty2" target="_blank"><?php echo $batch[0]['sec_faculty_name']; ?></a></td>
            </tr>
            <tr>
              <td width="29%"><strong>Assigned Faculty (additional 1):</strong></td>
              <td width="20%"><a href="<?php echo site_url('iibfdra/InspectorHome/faculty_view/'.base64_encode($batch[0]['add_first_faculty_id'])); ?>" id="additional_faculty1" target="_blank"><?php echo $batch[0]['add_first_faculty_name']; ?></a></td>
              <td width="2%"></td>
              <td width="29%"><strong>Assigned Faculty(additional 2):</strong></td>
              <td width="20%"><a href="<?php echo site_url('iibfdra/InspectorHome/faculty_view/'.base64_encode($batch[0]['add_sec_faculty_id'])); ?>" id="additional_faculty2" target="_blank"><?php echo $batch[0]['add_sec_faculty_name']; ?></a></td>
            </tr>
            <tr>
                ...
                <table class="table table-bordered table-striped" style="word-wrap:anywhere; background:<?php echo $div_class; ?>;">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td width="48%"><strong>
                        <input  type="radio" class="minimal radio11" name="overall_compliance" value="Poor" <?php if(set_value('overall_compliance') == 'Poor') {?> checked <?php } ?>>Poor
                        <input  type="radio" class="minimal radio11" name="overall_compliance" value="Average" <?php if(set_value('overall_compliance') == 'Average') {?> checked <?php } ?>>Average
                        <input  type="radio" class="minimal radio11" name="overall_compliance" value="Good" <?php if(set_value('overall_compliance') == 'Good') {?> checked <?php } ?>>Good
                        <input  type="radio" class="minimal radio11" name="overall_compliance" value="Excellent" <?php if(set_value('overall_compliance') == 'Excellent') {?> checked <?php } ?>>Excellent
                        &nbsp;&nbsp;&nbsp;
                ...
                <table id="listitems" class="table table-bordered table-striped">
                  <thead>
                    <tr>
                      ...
                      <th width="20">Attendance Remark</th>
                      <th width="20">Qualification Certificate</th>
                      <th width="20">Qualification Certificate Verify</th>
                      <th width="20">Qualification Certificate Remark</th>
                    </tr>
                  </thead>
                  <tbody class="no-bd-y" id="list">
                    <?php foreach ($arr_batch_candidates as $key => $batch_candidate) { 
                    ...
                    <td> 
                        ...
                        <input type="radio" class="minimal" id="id_incorrect_<?php echo $regId; ?>" name="quali_verify[<?php echo $regId; ?>][]" value="Incorrect" <?php echo set_radio('quali_verify['.$regId.'][]', 'Incorrect', (set_value('quali_verify['.$regId.'][]') == 'Incorrect')); ?> onclick="return confirmIncorrectQualification();">Incorrect
                    </td>
                    <td> 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        Your session has expired. Please <strong><a href="<?php echo site_url('iibfdra/InspectorLogin'); ?>" onclick="close_modal()" target="_blank">Click Here</a></strong> to login again. After logged in, please revisit the same page and submit your report.
...
<script>
  ...
  function confirmIncorrectQualification() 
  {
  ...
  {  
    ...
    $('#batch_id').on('change',function () {
      if ($(this).val() != '') {
        window.location.href = "https://iibf.esdsconnect.com/staging/iibfdra/InspectorHome/show_batch_inspection_report/"+$(this).val();
      } else {
        window.location.href = "https://iibf.esdsconnect.com/staging/iibfdra/InspectorHome/inspection_report";
      }
    });    
  });
  ...
  $('#btnSubmit').click(function (e) 
  {
    ...
    if(validateDoc==0)
    {
      ...
      $.ajax(
      {
        url: "<?php echo site_url('iibfdra/Check_inspector_session/index'); ?>",
        type: 'POST',
        contentType: false,
        cache: false,
        processData:false,
