                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-info">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <input type="text" class="form-control" id="stdcode"  name="stdcode" placeholder="STD Code"  value="<?php echo ( set_value('stdcode') ) ? set_value('stdcode') : $examRes["stdcode"];?>" data-parsley-maxlength="5" autocomplete="off" size="5" maxlength="5" data-parsley-trigger-after-failure="focusout"/>
                                        <span class="error"><?php //echo form_error('stdcode');?></span>
                                    </div> 
                                    <div class="col-sm-2">
                                        Phone No (Max 8 digits)
                                        <input type="text" class="form-control" id="phone"  name="phone" placeholder="Phone No"  data-parsley-type="number" data-parsley-maxlength="8" value="<?php echo ( set_value('phone') ) ? set_value('phone') : $examRes["phone"];?>" autocomplete="off" size="8" maxlength="8" data-parsley-trigger-after-failure="focusout"/>
                        ...
                        <div class="box box-info">
                         ...
                         <!--start center venue selection-->
                         
                         <div class="box box-info">
                            <div class="box-header with-border">
                                <h3 class="box-title">Center venue Details</h3>
                            </div>
                            <div class="box-body">
                                <input type="hidden" name="examcode" id="examcode" value="<?php echo $_SESSION['excode'];?>">
                                
                                <div class="form-group">
                                    <label for="center" class="col-sm-3 control-label">Exam Center Name <span class="mandatory-field">*</span></label>
                                    <div class="col-sm-5">
                                           <select required class="form-control" name="exam_center" id="exam_center" onchange="valCentre(this.value);" >
                                            <option value="">Select</option>
                                            <?php if(count($center_master) > 0){
                                                foreach($center_master as $centers){     ?>
                                                    <option value="<?php echo $centers['center_code'];?>" <?php if($centers['center_code']==$examRes['exam_center_code']){echo  'selected="selected"';}?>><?php echo $centers['center_name'];?></option>
                                    <?php } } ?>
                                        </select> 
                                 ...
                                 <?php /*?><div class="form-group">
                                    <label for="center" class="col-sm-3 control-label">Exam Center Name </label>
                                    <div class="col-sm-5">
                                           <select name="selCenterName" id="selCenterName" required onchange="valCentre(this.value);" class="form-control" >
                                            <option value="">Select</option>
                                            <?php if(count($dra_admitcard_center_master) > 0){
                                                foreach($dra_admitcard_center_master as $admit_centers){     ?>
                                                    <option value="<?php echo $admit_centers['center_code'];?>"><?php echo $admit_centers['center_name'];?></option>
                                    <?php } } ?>
                                        </select> 
                            ...
                            <?php 
							   if(count($compulsory_subjects) > 0)
							   {
								...
								?>
                                <div class="form-group">
                                    <label for="center" class="col-sm-3 control-label">Select venue <span class="mandatory-field">*</span></label>
                                    <div class="col-sm-5">
                                          <select name="venue[<?php echo $subject['subject_code']?>]" id="venue_<?php echo $i;?>" class="form-control venue_cls" onchange="venue(this.value,'date_<?php echo $i;?>','time_<?php echo $i;?>','<?php echo $subject['subject_code']?>','seat_capacity_<?php echo $i;?>');" attr-data='<?php echo $subject['subject_code']?>' required>
                                              <option value="">Select</option>
                                         </select>
                                    </div>
                                 </div> 
                                 <div class="form-group">  
                                    <label for="center" class="col-sm-3 control-label">Select Date <span class="mandatory-field">*</span></label>
                                    <div class="col-sm-5">
                                          <select name="date[<?php echo $subject['subject_code']?>]" id="date_<?php echo $i;?>" class="form-control date_cls" onchange="date(this.value,'venue_<?php echo $i;?>','time_<?php echo $i;?>');" required>
                                              <option value="">Select</option>
                                         </select>
                                    </div>
                                  </div>  
                                  <div class="form-group">
                                    <label for="center" class="col-sm-3 control-label">Select Time <span class="mandatory-field">*</span></label>
                                    <div class="col-sm-5">
                                          <select name="time[<?php echo $subject['subject_code']?>]" id="time_<?php echo $i;?>" class="form-control time_cls" onchange="time(this.value,'venue_<?php echo $i;?>','date_<?php echo $i;?>','seat_capacity_<?php echo $i;?>');"  required>
                                              <option value="">Select</option>
                                         </select>
                                    </div>
                                   </div>
                         ...
                         <div class="box box-info">
                            ...
                            <div class="box-body">
                                ...
                                <?php 
								// commented by manoj on 4 apr 2019 
								/*?><div class="form-group">
...
<script src="<?php echo base_url()?>js/dra_get_venue.js"></script>
