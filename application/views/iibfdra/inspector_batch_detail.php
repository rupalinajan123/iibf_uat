...
<div class="content-wrapper">
  <section class="content-header">
   ...
   <p>Please go through the given detail, correction may be made if necessary. <a href="<?php //echo base_url().'iibfdra/TrainingBatches/edit/'.base64_encode($bid)?>">Modify</a></p>
   <?php  } else {
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              ...
              <div class="pull-right">
                <a href="<?php echo base_url();?>iibfdra/InspectorHome/batches" class="btn btn-warning">Back</a> 
             </div>
            </div>
            ...
            ?>
             ...
             <div class="form-group">
              ...
              <div class="col-sm-5"> <?=$institute_name;?></div>
            </div>
   ...
   <?php if($batch['hours'] == 100) { ?>
    <div class="form-group">
      <label for="total_candidates" class="col-sm-4 control-label">TENTH PASS CANDIDATES :</label>
      <div class="col-sm-5"><?php echo $batch['tenth_pass_candidates'];?></div>
    </div>

    <div class="form-group">
      <label for="total_candidates" class="col-sm-4 control-label">TWELTH PASS CANDIDATES :</label>
      <div class="col-sm-5"><?php echo $batch['twelth_pass_candidates'];?></div>
    </div>
  <?php }?>

     <div class="form-group">
      <label for="total_candidates" class="col-sm-4 control-label">GRADUATE CANDIDATES :</label>
      <div class="col-sm-5"><?php echo $batch['graduate_candidates'];?></div>
    </div>

    <div class="form-group">
      <label for="total_candidates" class="col-sm-4 control-label">NO.OF CANDIDATES :</label>
      <div class="col-sm-5"><?php echo $batch['total_candidates'];?></div>
    </div>
    
    <div class="form-group">
      <label for="total_candidates" class="col-sm-4 control-label">1st FACULTY DETAILS:</label>
      <div class="col-sm-5"><?php echo $batch['first_faculty_name'].'('. $batch['first_faculty_qualification'].')';?></div>
    </div>
    
    <div class="form-group">
      <label for="total_candidates" class="col-sm-4 control-label">2nd FACULTY DETAILS:</label>
      <div class="col-sm-5"><?php 
	     if($batch['sec_faculty_name'] != '') {echo $batch['sec_faculty_name']; } 
	     if(trim($batch['sec_faculty_qualification']) != ''){ echo '('. $batch['sec_faculty_qualification'].')'; } ?></div>
    </div>

    <div class="form-group">
      <label for="total_candidates" class="col-sm-4 control-label">DETAILS OF ADDITIONAL FACULTY I:</label>
      <div class="col-sm-5"><?php echo $batch['add_first_faculty_name'].'('. $batch['add_first_faculty_qualification'].')';?></div>
    </div>
    
    <div class="form-group">
      <label for="total_candidates" class="col-sm-4 control-label">DETAILS OF ADDITIONAL FACULTY II:</label>
      <div class="col-sm-5"><?php 
       if($batch['add_sec_faculty_name'] != '') {echo $batch['add_sec_faculty_name']; } 
       if(trim($batch['add_sec_faculty_qualification']) != ''){ echo '('. $batch['add_sec_faculty_qualification'].')'; } ?></div>
    </div>

    <div class="form-group">
      <label for="total_candidates" class="col-sm-4 control-label">ADDITIONAL FACULTY 1 :</label>
      <div class="col-sm-5"><?php echo $batch['add_first_faculty_name'].'('. $batch['add_first_faculty_qualification'].')';?></div>
    </div>

    <div class="form-group">
      <label for="total_candidates" class="col-sm-4 control-label">ADDITIONAL FACULTY 2 :</label>
      <div class="col-sm-5"><?php echo $batch['add_sec_faculty_name'].'('. $batch['add_sec_faculty_qualification'].')';?></div>
    </div>
