...
<aside class="main-sidebar">
    ...
    <!-- Sidebar user panel -->
		...
		<ul class="sidebar-menu">
        	<li class="treeview">
                <a href="<?php echo base_url();?>iibfdra/InstituteHome/editprofile">
                    <i class="fa fa-user"></i><span>View Profile</span>
                </a> 
            </li>
             
            <li class="treeview">
                <a href="<?php echo base_url();?>iibfdra/Center/listing">
            ...
            <li class="treeview">
                <a href="<?php echo base_url();?>iibfdra/Faculty">
            ...
            <!-- Added by Priyanka W on 27-10-2022 -->
                <li class="treeview">
                    <a href="<?php echo base_url('iibfdra/TrainingBatches/batch_checklist');?>">
            ...
            <!-- Added by Priyanka w on 06-07-2023 -->
                <li class="treeview">
                    <a href="<?php echo base_url('iibfdra/TrainingBatches/batch_applicant_checklist');?>">
           ...
           /* function get_client_ip() {
                    ...
                    foreach( $active_exams as $exam ) { 
                       ...
                       // $comp_todate = $exam['exam_to_date'];
                        ...
                        if( strtotime($comp_currdate) >= strtotime($comp_frmdate) && strtotime($comp_currdate) <= strtotime($comp_todate)) { ?>
                            <li class="treeview">
                                <a href="<?php echo base_url('iibfdra/TrainingBatches/allapplicants/'.base64_encode($exam['exam_code']));?>">
                                    <?php 
                                    ...
                                    ?>
                                    <i class="fa fa-book"></i> <span>Apply for <?php echo ucwords($desc).' ( Revise<br> Syllabus)';?></span>
                                    <?php } else { ?>
            ...
            <li class="treeview">
                <a href="<?php echo base_url();?>iibfdra/TrainingBatches/reason_search">
                    <i class="fa fa-book"></i> <span>Member Exam Status</span>
                </a>
            </li>  
            <li class="treeview">
                <a href="<?php echo base_url();?>iibfdra/Result/DRA_Result">
                    <i class="fa fa-book"></i> <span>DRA Result</span>
                </a>
            </li>
            <li class="treeview">
                <a href="<?php echo base_url();?>iibfdra/Result/DRA_Revised_Result">
                    <i class="fa fa-book"></i> <span>DRA(Revised Syllabus) Result</span>
                </a>
            </li>  
            <!-- <li class="treeview">
                <a href="<?php echo base_url();?>iibfdra/Result/DRATC_Result">
                    <i class="fa fa-book"></i> <span>DRA-TC Result</span>
                </a>
            </li> -->
            <li class="treeview">
                <a href="<?php echo base_url();?>iibfdra/Admitcard">
                    <i class="fa fa-book"></i> <span>Admitcard PDf</span>
                </a>
            </li>
            <li class="treeview">
                <a href="<?php echo base_url();?>iibfdra/transaction/transactions/">
                    <i class="fa fa-book"></i> <span>Transaction Details</span>
                </a>
            </li>
           <!--  <li class="treeview">
                <a href="<?php ///echo base_url();?>iibfdra/DraExam/search_candidate">
           ...
           <!--  <li class="treeview">
            ...
            <li class="treeview">
                 <a href="<?php echo base_url();?>iibfdra/InstituteHome/changepass">
                    <i class="fa fa-book"></i> <span>Change Password</span>
                </a>
            </li>
            <li class="treeview">
                <a href="<?php echo  base_url()?>iibfdra/InstituteLogin/logout">
