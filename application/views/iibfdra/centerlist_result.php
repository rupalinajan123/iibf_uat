        ...
        <?php foreach($result as $row){ 
         // print_r($row);?>
                <tr>
                  ...
                  <td><a href="<?php echo base_url()?>iibfdra/Result/download_result/<?php echo base64_encode($row['exam_code']);?>/<?php echo base64_encode($row['center_code']);?>/<?php echo base64_encode($row['regnumber']);?>">Download Result</a></td>
                </tr>
