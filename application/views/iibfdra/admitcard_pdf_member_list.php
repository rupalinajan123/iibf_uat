        ...
        <input type="hidden" name="base_url_val" id="base_url_val" value="" />
				...
				<div class="box">
					<div class="box-header with-border">
						<h3 class="box-title">Admitcard pdfs for exam code 45 and 1036- <?php echo $download_admitcard_data[0]['date']; ?> </h3>
					</div>
					
					<div class="box-body">
						<h5 class="text-center" style="margin:5px 0 0 0;"><strong>Admitcard pdfs for exam code 45 and 57</strong></h5>
									...
									<?php $cnt = 1; 
										...
										{		
											...
											<tr>
												...
												<td class="text-center"><?php echo $res['center_name']; ?></td>
												...
												<td class="text-center"><?php echo $res['mem_mem_no']; ?></td>
												
												<td class="text-center">
																								
													<a class=""target='_blank' href="<?php echo base_url().'/iibfdra/Admitcard/download_member_pdf/'.$res['mem_mem_no'].'/'.$res['exm_cd'].'/'.$res['exam_period'] ; ?>"> Download</a>
												</td>
											</tr>
											<?php	$cnt++;
											}
