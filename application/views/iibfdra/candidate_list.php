      ...
      <h1>
       ...
       <div class="pull-right"> 
        <?php 
          ...
          <a href="<?php echo base_url('iibfdra/TrainingBatches/addApplication/'.$batch_id.'/0/1'); ?>" class="btn btn-info">Add Candidate</a>
       <?php }?>
...
<script type="text/javascript">
  ...
  {   
    ...
    var table = $('#listitems').DataTable(
    {
      ...
      'ajax': {
         "url": site_url+"iibfdra/TrainingBatches/candidate_list_ajax/"+batch_id,
         'data': function(data){
