	...
	try{
		...
		var validator = $("#usersAddForm").validate({
			...
			rules: {
				...
				inspector_email:{required: true,remote:site_path+'iibfdra/admin/InspectorMaster/emailduplication?inspector_email='+inspector_email},

				inspector_mobile:{number: true,required: true,remote:site_path+'iibfdra/admin/InspectorMaster/mobileduplication?inspector_mobile='+inspector_mobile},
