          ...
          <div class="box">
            <div class="box-header">
              ...
              <div class="pull-right">
              	<a href="<?php echo base_url();?>iibfdra/admin/InstitutionMaster/add" class="btn btn-warning">Add</a>
                <a href="<?php echo base_url();?>iibfdra/admin/InstitutionMaster/import" class="btn  btn-primary">Import</a>
                <a href="<?php echo base_url();?>iibfdra/admin/InstitutionMaster/download" class="btn  btn-primary">Download</a>
...
$(function () {
	...
	var listing_url = base_url+'iibfdra/admin/InstitutionMaster/getList';
