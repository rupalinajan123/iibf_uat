...
<form class="form-horizontal" name="userseditForm" id="userseditForm" action="<?php echo base_url();?>iibfdra/admin/InspectorMaster/edit" method="post">
  <!-- Main content -->
    ...
    <div class="row">
      ...
      <div class="box-footer">
        <div class="col-sm-3 col-xs-offset-5">
          <input type="hidden" class="form-control" id="inspector_id" name="inspector_id"  value="<?php echo base64_decode($inspector_id)?>">
