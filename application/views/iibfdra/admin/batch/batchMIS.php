...
<div class="content-wrapper">
  <section class="content-header">
    <h1>
      Batch MIS
      <?php if ($batch_id != "") { ?>
        <a href="<?php echo site_url('iibfdra/batch'); ?>" class="btn btn-warning pull-right">Back</a>
      <?php } ?>
      <?php //echo $breadcrumb; 
      ?>
    </h1>
  ...
  <section class="content">
    <div class="row">
      <div class="col-xs-12">
        <div class="box">
          <div class="box-body">
            <form class="form-control border-0" action="<?php echo base_url('iibfdra/admin/batchMIS/get_batch_mis'); ?>" method="post">
              <div class="row">
                <div class="col-md-3 col-sm-6">
                  <div class="form-group">
                    <label class="form-label">From Date</label>
                    <input type="text" class="form-control custom_filter datepicker" name="from_date" id="from_date" value="" autocomplete="off" readonly>
                  </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control custom_filter datepicker" name="to_date" id="to_date" value="" autocomplete="off" readonly>
                  </div>
                </div>
              </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    var dataTable = $('#listitems22').DataTable({
      ...
      "ajax": {
        "url": '<?php echo site_url("iibfdra/admin/BatchMIS/get_batch_mis"); ?>',
        "type": "POST",
        "data": function(data) {
