  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <?php /*<div class="pull-right">
        <a href="<?php echo base_url('iibfdra/admin/faculty_master/faculty_add'); ?>">
          ...
          <input type="hidden" name="base_url_val" id="base_url_val" value="" />
            ...
            <table id="listitems" class="table table-bordered table-striped dataTables-example">
                ...
                <tr>
                  ...
                  <th>Inreview Status Count</th>
                  <th>Active Status Count</th>
                  <th>Inactive Status Count</th>
                  <th>Action</th> 
                </tr>
                </thead>
...
<script type="text/javascript">
  ...
  {   
    var table = $('#listitems').DataTable(
    {
      ...
      'ajax': {
         "url": site_url+"iibfdra/admin/faculty_master/faculty_list",
         'data': function(data){
      ...
      'columns': [
         ...
         { data: 'agency' },
         { data: 'inreview_status_count' },
         { data: 'active_status_count' }, 
         { data: 'inactive_status_count' },
         { data: 'action' },
      ]
    }
    );
