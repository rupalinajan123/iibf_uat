        ...
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header with-border">
              ...
              <div class="pull-right"> <a href="<?php echo base_url('iibfdra/admin/faculty_master');?>" class="btn btn-warning">Back</a> </div>
            </div>
            <div class="box-body">
              ...
              <form class="form-horizontal" autocomplete="off"  name="frmDrACenter" id="faculty_form" method="post" enctype="multipart/form-data" data-parsley-validate>
                <?php if($action == 'add'){ ?>
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label for="roleid" class="col-sm-3 control-label">Institute<span style="color:#F00">*</span></label>
                      <div class="col-sm-6">
                        <select name="institute_id" id="institute_id" class="form-control" data-parsley-required>
                          <option value="">Select Institute</option>
                          <?php foreach ($institute_data as $key => $value) { ?>
                           <option value="<?php echo $value['dra_inst_registration_id']; ?>" <?php if(isset($faculty_data[0]['institute_id']) && $faculty_data[0]['institute_id'] == $value['dra_inst_registration_id']) { echo "selected='selected'"; } ?>><?php echo $value['institute_name']; ?></option> 
                           <?php } ?>
                         </select>
                      </div>
                    </div>
                ...
                <?php if($action == 'edit'){ 
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label for="roleid" class="col-sm-3 control-label">Institute</label>
                      <div class="col-sm-6">
                         <label for="roleid" class=""><b><?php echo $institute_data[0]['institute_name']; ?></b></label>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <div class="col-sm-3">
                      <input type="text" class="form-control" id="faculty_name" name="faculty_number" placeholder="Mr./Mrs./Ms." value="<?php echo isset($faculty_data[0]['faculty_number'])?'F'.$faculty_data[0]['faculty_number']:'F'.$faculty_number;?>" readonly="readonly" >

                      <input type="hidden" class="form-control" id="faculty_number_hidden" name="faculty_number_hidden" placeholder="Faculty Number" value="<?php echo isset($faculty_data[0]['faculty_number'])?$faculty_data[0]['faculty_number']:$faculty_number_hidden;?>" readonly="readonly" >
                    </div>
                  </div>
                </div>
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <div class="col-sm-2">
                      <label for="roleid" class="col-sm-3 control-label">Salutation<span style="color:#F00">*</span></label>
                    </div>
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <div class="col-sm-7">
                      <input type="text" class="form-control" id="faculty_name" name="faculty_name" placeholder="Name" value="<?php echo isset($faculty_data[0]['faculty_name'])?$faculty_data[0]['faculty_name']:'';?>" maxlength = "90" data-parsley-maxlength="90"  data-parsley-required data-parsley-errors-container="#faculty_name_error" onkeypress="return onlyAlphabets(event)">
                  ...
                  <?php if(empty($faculty_data[0]['faculty_photo'])){
                    ...
                    <div class="col-sm-12" >
                      <div class="form-group" id="faculty_upload_image" <?php echo $style; ?>>
                        <label for="roleid" class="col-sm-3 control-label">Upload faculty photo<span style="color:#F00">*</span></label>
                        <div class="col-sm-5">
                          <input type="file" <?php echo $required; ?> class="form-control" name="faculty_photo" id="faculty_photo_edit" onchange="validateFile(event,'faculty_photo_error', 'faculty_photo_img', '20kb', '300', '300')" >
                    ...
                    <?php if(!empty($faculty_data[0]['faculty_photo'])){?> 
                      <div class="col-sm-12" id="faculty_photo_show">
                        <div class="form-group">
                          <label for="exampleInputName1" class="col-sm-3 control-label">Faculty Photo</label>
                          <div class="col-sm-5">
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      ...
                      data-parsley-pattern-message="Please Enter Date in dd/mm/yyyy format" data-parsley-trigger="keyup" >
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="pan_no" name="pan_no" placeholder=""  value="<?php echo isset($faculty_data[0]['pan_no'])?$faculty_data[0]['pan_no']:'';?>" minlength="10" maxlength="10" data-parsley-required data-parsley-errors-container="#pan_no_error" data-parsley-pan_no_exist data-parsley-trigger= focusout data-parsley-pan_no_exist-message="This PAN no is already Exists." data-parsley-pattern="/[A-Z]{5}[0-9]{4}[A-Z]{1}$/" data-parsley-pattern-message="Please Enter 10 digit PAN No with Valid Alphanumeric Format." >
                      <?php if($action != 'view'){ ?>
                  ...
                  <div class="col-sm-12" >
                    ...
                    <?php if(!empty($faculty_data[0]['pan_photo'])){?> 
                      <div class="col-sm-12" id="pan_photo_show">
                        <div class="form-group">
                          <label for="exampleInputName1" class="col-sm-3 control-label">PAN Photo<</label>
                          <div class="col-sm-5">
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <div class="col-sm-6">
                      <input type="text" class="form-control" id="academic_qualification" name="academic_qualification" placeholder="e.g. BE/ MCom etc." value="<?php echo isset($faculty_data[0]['academic_qualification'])?$faculty_data[0]['academic_qualification']:'';?>"   maxlength="100" data-parsley-errors-container="#academic_qualification_error" data-parsley-required>
                ...
                <?php if($action == 'add'){?>
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label for="roleid" class="col-sm-3 control-label"></label>
                      <div class="col-sm-3">
                        <input type="text" class="form-control" id="work_exp0" name="work_exp[]" placeholder="Bank/ FI Name"  value="<?php echo isset($faculty_data['work_exp2'])?$faculty_data['work_exp2']:'';?>" data-parsley-errors-container="#work_exp_error0" data-parsley-required onkeypress="return alphanumeric(event)">
                        <span class="note-error" id="work_exp_error0"></span>
                      </div>
                      <div class="col-sm-3">
                        <input type="text" class="form-control" id="emp_id0" name="emp_id[]" placeholder="Last Position Employee Id" value="<?php echo set_value('emp_id2');?>" data-parsley-errors-container="#emp_id_error0" data-parsley-required onkeypress="return alphanumeric(event)">
                        <span class="note-error" id="emp_id_error0"  ></span>
                      </div>
                      <div class="col-sm-3">
                        <input type="text" class="form-control" id="gross_duration0" name="gross_duration[]" placeholder="Gross Duration"  value="<?php echo set_value('gross_duration2');?>" data-parsley-errors-container="#gross_duration_error0" data-parsley-required onkeypress="return alphanumeric(event)">
                ...
                <? } 
                  ...
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label for="roleid" class="col-sm-3 control-label"></label>
                        <div class="col-sm-3">
                          <input type="text" class="form-control" id="work_exp0" name="work_exp[]" placeholder="Bank/ FI Name" value="<?php echo $faculty_data[0]['work_exp1']; ?>" data-parsley-errors-container="#work_exp_error0" data-parsley-required onkeypress="return alphanumeric(event)">
                          <span class="note-error" id="work_exp_error0"></span>
                        </div>
                      <?php } if(!empty($faculty_data[0]['emp_id1'])){ ?>
                      <div class="col-sm-3">
                        <input type="text" class="form-control" id="emp_id0" name="emp_id[]" placeholder="Last Position Employee Id" value="<?php echo $faculty_data[0]['emp_id1']; ?>" data-parsley-errors-container="#emp_id_error0" data-parsley-required  onkeypress="return alphanumeric(event)">
                        <span class="note-error" id="emp_id_error0" ></span>
                      </div>
                    <?php } if(!empty($faculty_data[0]['gross_duration1'])){ ?>
                      <div class="col-sm-3">
                        <input type="text" class="form-control" id="gross_duration0" name="gross_duration[]" placeholder="Gross Duration"  value="<?php echo $faculty_data[0]['gross_duration1'];?>" data-parsley-errors-container="#gross_duration_error0" data-parsley-required onkeypress="return alphanumeric(event)">
                        <span class="note-error" id="gross_duration_error0"></span>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-sm-12">
                      <div class="form-group">
                        <label for="roleid" class="col-sm-3 control-label"></label>
                          ...
                          <div class="col-sm-3">
                            <input type="text" class="form-control" id="work_exp0" name="work_exp[]" placeholder="Bank/ FI Name" value="<?php echo $faculty_data[0]['work_exp2']; ?>" data-parsley-errors-container="#work_exp_error0" data-parsley-required onkeypress="return alphanumeric(event)">
                            <span class="note-error" id="work_exp_error0"></span>
                          </div>
                        <?php } if(!empty($faculty_data[0]['emp_id2'])){ ?>
                        <div class="col-sm-3">
                          <input type="text" class="form-control" id="emp_id0" name="emp_id[]" placeholder="Last Position Employee Id" value="<?php echo $faculty_data[0]['emp_id2']; ?>" data-parsley-errors-container="#emp_id_error0" data-parsley-required  onkeypress="return alphanumeric(event)">
                          <span class="note-error" id="emp_id_error0" ></span>
                        </div>
                      <?php } if(!empty($faculty_data[0]['gross_duration2'])){ ?>
                        <div class="col-sm-3">
                          <input type="text" class="form-control" id="gross_duration0" name="gross_duration[]" placeholder="Gross Duration"  value="<?php echo $faculty_data[0]['gross_duration2'];?>" data-parsley-errors-container="#gross_duration_error0" data-parsley-required onkeypress="return alphanumeric(event)">
                          <span class="note-error" id="gross_duration_error0"></span>
                        </div>
                     </div>
                    </div>
                  ...
                  <?php if(!empty($faculty_data[0]['work_exp3'])){ ?>
                    <div class="col-sm-12">
                      <div class="form-group">
                        <label for="roleid" class="col-sm-3 control-label"></label>
                          <div class="col-sm-3">
                            <input type="text" class="form-control" id="work_exp0" name="work_exp[]" placeholder="Bank/ FI Name" value="<?php echo $faculty_data[0]['work_exp3']; ?>" data-parsley-errors-container="#work_exp_error0" data-parsley-required onkeypress="return alphanumeric(event)">
                            <span class="note-error" id="work_exp_error0"></span>
                          </div>
                        <?php } if(!empty($faculty_data[0]['emp_id3'])){ ?>
                        <div class="col-sm-3">
                          <input type="text" class="form-control" id="emp_id0" name="emp_id[]" placeholder="Last Position Employee Id" value="<?php echo $faculty_data[0]['emp_id3']; ?>" data-parsley-errors-container="#emp_id_error0" data-parsley-required  onkeypress="return alphanumeric(event)">
                          <span class="note-error" id="emp_id_error0" ></span>
                        </div>
                      <?php } if(!empty($faculty_data[0]['gross_duration3'])){ ?>
                        <div class="col-sm-3">
                          <input type="text" class="form-control" id="gross_duration0" name="gross_duration[]" placeholder="Gross Duration"  value="<?php echo $faculty_data[0]['gross_duration3'];?>" data-parsley-errors-container="#gross_duration_error0" data-parsley-required onkeypress="return alphanumeric(event)">
                          <span class="note-error" id="gross_duration_error0"></span>
                        </div>
                      </div>
                    </div>
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    <label for="roleid" class="col-sm-3 control-label"></label>
                    <div class="col-sm-6">
                     <a href="javascript:void(0);" id="btn_add_workex"><i class="btn btn-primary fa fa-plus-square" title="Add work Experience"></i></a>&nbsp;
                ...
                ?>
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <label for="roleid" class="text-success"><?php echo $status; ?></label>
                      </div>
                    </div>
                  </div>
                <?php } ?>
                ...
                <div class="col-sm-6 col-sm-offset-3">
                  <div class="col-sm-12"> 
                    <center>
                     <?php if($action == 'add' || $action == 'edit') { ?>
                     <button type="submit" class="btn btn-success btn_submit" name="btn_submit" id="btn_submit" onclick="submit_form()">Submit</button>
                     <?php } ?>
                     <a href="<?php echo base_url('iibfdra/admin/faculty_master'); ?>" class="btn btn-danger mr-2" >Cancel</a>  
...
<script>$(document).ready(function() { $('#institute_id').select2(); }); </script>
...
<script type="text/javascript">
  ...
  $(document).ready(function () {
    ...
    $('#btn_add_workex').click(function(){
      ...
      var repeatable_workex = '<div class="col-sm-12" id="textbox-label"><input type="hidden" name="faculty_id[]" id="faculty_id'+newid+'" value=""><div class="form-group"><label for="roleid" class="col-sm-3 control-label"></label><div class="col-sm-3"><input type="text" class="form-control" id="work_exp'+newid+'" name="work_exp[]" placeholder="Bank/ FI Name"  value="" onkeypress="return alphanumeric(event)"><span class="note-error" id="work_exp_error'+newid+'"></span></div><div class="col-sm-3"><input type="text" class="form-control" id="emp_id'+newid+'" name="emp_id[]" placeholder="Last Position Employee Id"  value="" onkeypress="return alphanumeric(event)"><span class="note-error" id="emp_id_error'+newid+'"></span></div><div class="col-sm-3"> <input type="text" class="form-control" id="gross_duration'+newid+'" name="gross_duration[]" placeholder="Gross Duration"  value="" onkeypress="return alphanumeric(event)"><span class="note-error" id="gross_duration_error'+newid+'"></span></div></div></div>';
  ...
  window.Parsley.addValidator('pan_no_exist', {
    ...
    validateString: function(value){
      return $.ajax({
        url: base_url+"iibfdra/admin/faculty_master/check_pan_no",
        method:"POST",
