...
<div class="content-wrapper">
  <section class="content-header">
    <h1>
      Batch Summary
      <?php if ($batch_id != "") { ?>
        <a href="<?php echo site_url('iibfdra/admin/BatchSummary'); ?>" class="btn btn-warning pull-right">Back</a>
      <?php } ?>
      <?php //echo $breadcrumb; 
      ?>
    </h1>
  ...
  <section class="content">
    <div class="row">
      <div class="col-xs-12">
        <div class="box">
          <div class="box-body">
            <form class="form-control border-0" action="<?php echo base_url('iibfdra/admin/BatchSummary/get_batch_mis'); ?>" method="post">
              <div class="row">
...
<script type="text/javascript">
  $(document).ready(function() {
    var dataTable = $('#listitems23').DataTable({
      ...
      "ajax": {
        "url": '<?php echo site_url("iibfdra/admin/BatchSummary/get_batch_mis"); ?>',
        "type": "POST",
        /*"data": function(data) {
