                ...
                <tbody class="no-bd-y" id="list">
                  ...
                  <tr>
                   ...
                   <td><?php
                    ...
                    <td>
                    <a class="btn btn-info btn-xs vbtn" href="<?php echo base_url().'iibfdra/CenterRenew/view/'.$center['center_id'];?>">View</a> &nbsp; &nbsp; 
                    <?php if($center['is_renew'] != '1'){ ?>
                   | &nbsp; &nbsp; <a class="btn btn-info btn-xs vbtn" href="<?php echo base_url().'iibfdra/CenterRenew/edit/'.$center['center_id'];?>">Renew</a>
                   <?php } ?>
