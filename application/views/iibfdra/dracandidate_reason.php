        ...
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header with-border">
              ...
              <div class="pull-right"> <a href="<?php echo base_url();?>iibfdra/TrainingBatches/allcandidates/" class="btn btn-warning"> Back </a> </div>
            </div>
...
//alert(center_id);
      // AJAX request
      $.ajax({
        url:'<?=base_url()?>iibfdra/TrainingBatches/member_search',
        method: 'post',
