						...
						<div class="box-body">
							...
							<section class="search_form_common_all">
								...
								<div class="form-group" style="width: 100%">
									...
									<input type="text" class="form-control custom_search_cls" name="s_member_no" id="s_member_no" value="<?php echo $s_member_no; ?>" placeholder="If you want to enter multiple Member Numbers, then use comma for separation" autocomplete="off">
								</div>
								
								<div class="form-group" style="">
									<a href="javascript:void(0)" class="btn btn-primary" onclick="search_form_submit()" style="margin-right:3px;">Search</a> 
									<a href="<?php echo site_url('iibfdra/TrainingBatches_sm/allapplicants_sm/?exCd='.base64_encode($examcode)); ?>" class="btn btn-primary">Clear</a>
								</div>
							</section>
							
							<!-- <input id="myInput" type="text" placeholder="Search.." style="float: right"><br><br>-->
							<div class="table-responsive">                        
								<table id="listitemsx" class="table table-bordered table-striped dataTables-examplex">
									<thead>
										<tr>
									...
									<tbody>
									<?php 
										if(isset($sort_data) && count($sort_data) > 0)
										{
											$sr_no = 1;
											foreach($sort_data as $res)
											{	?>
												<tr>
													<td> </td>
													<?php echo $res[0]; ?>
...
<script type="text/javascript">
	...
	function search_form_submit()
	{
		...
		var redirect_url = "<?php echo site_url('iibfdra/TrainingBatches_sm/allapplicants_sm/?exCd='.base64_encode($examcode)) ?>";
		if(search_val != "")
		{
