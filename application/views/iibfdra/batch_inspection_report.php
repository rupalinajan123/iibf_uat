...
<div class="content-wrapper"> 
  ...
  <section class="content">
    ...
    <form method="POST" action="<?php echo base_url('iibfdra/InspectorHome/export_to_pdf'); ?>">
    <div class="row">
      <div class="col-md-12">
...
$(function () {
  ...
  $('#batch_id').on('change',function () {
    ...
    if(batch_id != ''){
      ...
      $.ajax({
          url:site_url+'iibfdra/InspectorHome/get_data',
          ...
          success: function(res) {
            ...
            if(data != '')
            {
              ...
              $.each(JSON.parse(data), function(idx, obj) {
                ...
                values = [[j, obj.training_id, obj.name, obj.dateofbirth, obj.mobile_no, photo, obj.present_cnt, obj.absent_cnt, obj.remark,quali,obj.qualification_verify,obj.qualification_remark]];
