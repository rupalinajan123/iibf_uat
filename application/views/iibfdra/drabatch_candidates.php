...
<div class="content-wrapper">
    ...
    <form name="draexampay" autocomplete="off" class="draexampay" method="post" action="<?php echo base_url();?>iibfdra/DraExam/payment/<?php //echo base64_encode($examcode);?>">
...
<script type="text/javascript">
	$(document).ready(function()
	{
		var userDataTable = $('#example1').DataTable(
		{
			...
			"serverSide": true,
			"ajax": {
				"url": '<?php echo site_url("iibfdra/TrainingBatches/get_candidates_data_ajax"); ?>', 
				"type": "POST",
				"data": function ( d ) 
				{
