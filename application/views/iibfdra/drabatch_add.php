            ...
            <div class="box-body">
                      ...
                      foreach ($agency_center as $val) {
                        ...
                        { 
                          ...
                          ?>
                              ...
                              <option <?php echo (set_value('center_id') == $val['center_id']) ? " selected=' selected'" : "" ?> value="<?php echo $val['center_id']; ?>" data-todate="<?php echo $val['center_validity_to']; ?>"><?php echo $val['location_name']; ?> </option>
                          <?php  
                            } 
                          ...
                          <?php 
                            ...
                            { 
                          ?>
                            <option value="<?php echo $val['center_id'] ?>" data-todate="<?php echo $val['center_validity_to']; ?>"><?php echo $val['location_name'] . ' ( Approve by Recommender. )'; ?></option>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  ...
                  <span class="note-error error" id="batch_to_error"></span>
                </div>
                <div class="col-sm-3">
                  Gross Training Days
                ...
                <div class="col-sm-4">
                  ...
                  <select class="form-control faculty-section" id="first_faculty" data-error="first_faculty_error" name="first_faculty" onchange="get_faculty(event)" required="" data-parsley-trigger="focusout">
                    ...
                    <?php foreach ($basic_faculty_data as $key => $value) { ?>
                      <option value="<?php echo $value['faculty_id']; ?>" data-code="<?php echo $value['faculty_code']; ?>"><?php echo $value['faculty_code'].'_'.$value['faculty_name']; ?></option>
                    <?php } ?>
                  </select>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-4">
                  ...
                  <select class="form-control faculty-section" id="additional_first_faculty" last_val="" data-error="additional_first_faculty_error" name="additional_first_faculty" onchange="get_faculty(event)" data-parsley-trigger="focusout">
                    <option value="">Select Faculty</option>
                    <?php foreach ($basic_faculty_data as $key => $value) { ?>
                      <option value="<?php echo $value['faculty_id']; ?>" data-code="<?php echo $value['faculty_code']; ?>"><?php echo $value['faculty_code'].'_'.$value['faculty_name']; ?></option>
                    <?php } ?>
