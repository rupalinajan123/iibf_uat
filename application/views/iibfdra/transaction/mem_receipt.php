		...
		<td align='center'>	
			<table border='1' cellspacing='0' cellpadding='5' width='65%' bgcolor='#FFFFCC' style="border-collapse:collapse">
    			<tr>
  				...
  				<tr>
    				<td width='35%'><p><strong>Membership No. : </strong></p></td>
    				<td width='64%'><?php echo $mem_details['regnumber']; ?></td>
  				</tr>
  				<tr>
    				<td width='35%'><p><strong>Member Name : </strong></p></td>
    				<td width='64%'><?php echo $mem_details['firstname'] . " " . $mem_details['middlename'] . " " . $mem_details['lastname']; ?></td>
  				</tr>
                
                <tr>
    				<td width='35%'><p><strong>Medium : </strong></p></td>
    				<td width='64%'><?php echo $mem_details['mediumname']; ?></td>
  				</tr>
                
                <tr>
    				<td width='35%'><p><strong>Centre Code : </strong></p></td>
    				<td width='64%'><?php echo $mem_details['exam_center_code']; ?></td>
  				</tr>
                
                <tr>
    				<td width='35%'><p><strong>Centre Name : </strong></p></td>
    				<td width='64%'><?php echo $mem_details['centername']; ?></td>
  				</tr>
                
                <tr>
                	<td width='35%'><p><strong>Email Id : </strong></p></td>
                  	<td width='64%'><?php echo $mem_details['email_id']; ?></td>
                </tr>
                <tr>
                	<td width='35%'><p><strong>Customer ID :</strong></p></td>
                	<td width='64%'><?php echo $txn_details['receipt_no']; ?></td>
              	</tr>
                <tr>
                	<td width='35%'><p><strong>Transaction No. :</strong></p></td>
                	<td width='64%'><?php if( $txn_details['gateway'] == '2' ) echo $txn_details['transaction_no']; else echo $txn_details['UTR_no'];?></td>
              	</tr>
                <tr>
