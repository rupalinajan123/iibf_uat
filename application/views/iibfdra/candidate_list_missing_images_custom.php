      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Candidate list for missing images</h3>
          </div>
                  ...
                  foreach ($candidate_data as $res) { ?>
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="<?php echo base_url() . 'iibfdra/candidate_list_missing_images/editCandidate/' . $res['regid']; ?>" target="_blank">Edit </a> |
                        <a href="<?php echo base_url() . 'iibfdra/candidate_list_missing_images/viewApplicant/' . $res['regid']; ?>" target="_blank">View</a>
                      </td>
                    </tr>
                <?php $sr_no++;
                  }
