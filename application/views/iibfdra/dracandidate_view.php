        ...
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header with-border">
              ...
              <div class="pull-right"> <a href="<?php echo base_url('iibfdra/TrainingBatches/candidate_list/'.$batchId);?>" class="btn btn-warning"> Back </a> </div>
            </div>
            <div class="box-body tbl_outer_div">
              ...
              <div class="table-responsive">
                ...
                <div class="text-center"> <a href="<?php echo base_url('iibfdra/TrainingBatches/candidate_list/'.$batchId);?>" class="btn btn-warning"> Back </a> </div>                                
              </div>                      
            </div>
          </div>
