                    ...
                    $i = $key+1; ?>
                      <tr>
                        ...
                        <?php 
                          ...
                          //if(!file_exists('uploads/iibfdra/'.$value['scannedphoto'])) 
                          ...
                          //if(!file_exists(base_url('uploads/iibfdra/'.$value['scannedsignaturephoto']))) 
                          ...
                          //if(!file_exists(base_url('uploads/iibfdra/'.$value['idproofphoto']))) 
                          ...
                          //if(!file_exists(base_url('uploads/iibfdra/'.$value['quali_certificate']))) 
                          if($value['quali_certificate'] != "" && file_exists('uploads/iibfdra/'.$value['quali_certificate']))
                          {
