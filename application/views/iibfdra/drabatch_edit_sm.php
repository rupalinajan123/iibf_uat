...
<div class="content-wrapper">
	...
	<?php if (isset($batchDetails)) {
		...
		<form class="form-horizontal" name="draExamAddFrm" id="draExamAddFrm"  method="post" data-parsley-validate="parsley"  enctype="multipart/form-data" onsubmit="return dravalidateForm()">
          ...
          <div class="col-md-12">
						...
						<div class="box box-info">
							<div class="box-header with-border">
								...
								<!-- <a href="<?php echo base_url().'iibfdra/TrainingBatches/view/'.base64_encode($bid) ?>" class="btn btn-warning">Back</a>--> </div>
							</div>
							<!-- /.box-header --> 
							<!-- form start -->
							<div class="box-body">
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<input <?php if($batchs['batch_type'] == 'C'){ echo 'checked'; } ?> type="radio" class="minimal" id="batch_type" name="batch_type"  required value="C" <?php echo set_radio('batch_type', 'C'); ?>>
										Combine Batch
										<input <?php if($batchs['batch_type'] == 'S'){ echo 'checked'; } ?> type="radio" class="minimal" id="batch_type" name="batch_type" required value="S" <?php echo set_radio('batch_type', 'S'); ?>>
										Separate Batch <span class="error">
											<?php //echo form_error('gender');?>
										</span> </div>
								</div>
								<div class="form-group" id="type_div" <?php if($batchs['batch_type'] == 'S'){ ?> style="display: block;" <?php } else { ?> style="display: none;" <?php } ?> >
									<label for="batch_type" class="col-sm-3 control-label">Batch Type <span class="mandatory-field">*</span></label>
									<div class="col-sm-3">
										<input <?php if($batchs['hours'] == 50){ echo 'checked'; } ?> type="radio" class="minimal" id="batch_type" name="hours"  value="50" <?php echo set_radio('hours', '50');?>>
										50hr
										<input <?php if($batchs['hours'] == 100){ echo 'checked'; } ?> type="radio" class="minimal" id="batch_type" name="hours" value="100" <?php echo set_radio('hours', '100'); ?>>
										100hr <span class="error">
											<?php //echo form_error('gender');?>
										</span> </div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-5">
										...
										<select class="form-control" id="center_id" name="center_id" required >
											<option value="<?=$batchs['center_id']?>"><?php echo $location; ?></option>
                              ...
                              {?>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" id="batch_name" name="batch_name" placeholder="Batch Name" required  value="<?=$batchs['batch_name']?>" data-parsley-maxlength="30" autocomplete="off" maxlength="30" >
										<span class="error">
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										...
										<input type="text" class="form-control" id="batch_from"  name="batch_from_date" placeholder="Training From Date" required value="<?=$batchs['batch_from_date']?>" autocomplete="off"  />
										<span class="error">
											<?php //echo form_error('batch_from_date');?>
										</span>
									</div>
									<div class="col-sm-2">
										...
										<?php
											...
											// $sendstring= '3/5/2019';
										?>
										<input type="text" class="form-control" id="batch_to"  name="batch_to_date" placeholder="Training To Date" required value="<?=$batchs['batch_to_date']?>" autocomplete="off" onChange="chk_days()" />
										<span class="error">
								...
								<div class="form-group datepairtimes">
									<label for="timing_of_training" class="col-sm-3 control-label">
										Timing Of Training<span class="mandatory-field">*</span>
									</label>
									<div class="col-sm-2">
										From                                         
										<input type="text" class="form-control time start timing_from" id="timing_from"  name="timing_from" required value="<?=$batchs['timing_from']?>" autocomplete="off" maxlength="8"  />
									</div>
									<div class="col-sm-2">  To
										<input type="text" class="form-control time end timing_to"  id="timing_to"  name="timing_to"  required value="<?=$batchs['timing_to']?>" autocomplete="off" maxlength="8" onChange="chk_from_time()" />
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-5">
										<select class="form-control" id="training_medium" name="training_medium" >
											<option value="<?=$batchs['training_medium']?>">
												<?=$batchs['training_medium']?>
											</option>
										...
										in the absence of a clear choice English will be presumed as medium opted
									</div>
								</div>
								<div class="form-group">
									<label for="total_candidates" class="col-sm-3 control-label">No. Of Candidates <span class="mandatory-field">*</span></label>
									<div class="col-sm-5">
										<input type="text" class="form-control" id="total_candidates" required name="total_candidates" placeholder="Total Candidates" value="<?=$batchs['total_candidates']?>" autocomplete="off" maxlength="3" minlength="2" >
									<span id="error"></span> </div>
								</div>
								
								<div class="form-group">
									<label for="faculty_name" class="col-sm-3 control-label">Faculty Name (The one who will be conducting the training) <span class="mandatory-field">*</span></label>
									<div class="col-sm-5">
										<input type="text" class="form-control" id="faculty_name" name="faculty_name" placeholder="Faculty Name" required value="<?=$batchs['faculty_name']?>"  autocomplete="off" data-parsley-maxlength="30" maxlength="30">
										<span class="error">
											<?php //echo form_error('faculty_name');?>
										</span> </div>
								</div>
								<div class="form-group">
									<label for="faculty_qualification" class="col-sm-3 control-label">Faculty Qualification <span class="mandatory-field">*</span></label>
									<div class="col-sm-5">
										<input type="text" class="form-control" id="faculty_qualification" name="faculty_qualification" placeholder="Faculty Qualification" required value="<?=$batchs['faculty_qualification']?>"  autocomplete="off" data-parsley-maxlength="30" >
										<span class="error">
											<?php //echo form_error('faculty_qualification');?>
										</span> </div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" id="faculty_name2" name="faculty_name2" placeholder="Faculty Name"  value="<?=$batchs['faculty_name2']?>"  autocomplete="off" data-parsley-maxlength="30" maxlength="30">
									</div>
								</div>
								<div class="form-group">
									<label for="faculty_qualification" class="col-sm-3 control-label">2nd Faculty Qualification </label>
									<div class="col-sm-5">
										<input type="text" class="form-control" id="faculty_qualification2" name="faculty_qualification2" placeholder="Faculty Qualification" value="<?=$batchs['faculty_qualification2']?>"  autocomplete="off" data-parsley-maxlength="30" >
									</div>
								</div>
									...
									<div class="col-sm-5">
										...
										<!--    <select class="form-control" id="csstate" placeholder="State" readonly   name="csstate" required  disabled >
											...
											<?php if(count($states) > 0){
												...
												<option value="<?php if($row1['state_code'] == $batchDetails[0]['state']){ echo $row1['state_code']; } ?>" <?php if($row1['state_code'] == $batchDetails[0]['state']){ ?> selected="selected" <?php } ?>><?php echo $row1['state_name'];?></option>
											<?php } } ?>
										</select> -->
										
										<input type="text" class="form-control" id="cstate" readonly placeholder="State"   name="cstate" value="<?= $batchDetails[0]['state_name']; ?>" >
										<input type="hidden" class="form-control" id="ccstate" readonly placeholder="State"   name="state" value="<?= $batchDetails[0]['state']; ?>" >
									</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-2">
										...
										<input type="hidden" class="form-control" readonly placeholder="City" id="cccity" value="<?php echo $batchDetails[0]['city']; ?>">
										<span class="error">
											<?php //echo form_error('city');?>
										</span> </div>
										<label for="pincode" class="col-sm-2 control-label">Pincode <span class="mandatory-field">*</span></label>
										<div class="col-sm-2">
											<input type="text" class="form-control" name="cpincode" id="cpincode" value="<?=$batchs['pincode']?>" onkeypress="return(number(event) && numberctrl(event));" data-parsley-maxlength="6" maxlength="6" size="6" data-parsley-dracheckpin data-parsley-type="number" autocomplete="off" data-parsley-trigger-after-failure="focusout">
											<span class="error">
								...
								<div class="form-group">
									...
									<div class="col-sm-5">
										<input type="text" class="form-control" readonly id="cdistrict"  placeholder="District" value="<?= $batchDetails[0]['district']; ?>" >
										<span class="error">
								...
								<div class="form-group">
								<label for="address_line1" class="col-sm-3 control-label">Address line 1</span></label>
								<div class="col-sm-5">
									<input type="text" class="form-control address_fields" id="addressline1" name="addressline1" required placeholder="Address line 1"  value="<?=$batchs['addressline1']?>"  data-parsley-maxlength="30" autocomplete="off" maxlength="30">
									<span class="error">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control address_fields" id="addressline2" name="addressline2" placeholder="Address line 2" data-parsley-maxlength="30" value="<?=$batchs['addressline2']?>"  autocomplete="off" maxlength="30">
									<span class="error">
										<?php //echo form_error('addressline2');?>
									</span> </div>
							</div>
							<div class="form-group">
								<label for="address_line3" class="col-sm-3 control-label">Address line 3</label>
								<div class="col-sm-5">
									<input type="text" class="form-control address_fields" id="addressline3" name="addressline3" placeholder="Address line 2" data-parsley-maxlength="30" value="<?=$batchs['addressline3']?>"  autocomplete="off" maxlength="30">
									<span class="error">
										<?php //echo form_error('addressline2');?>
									</span> </div>
							</div>
							<div class="form-group">
								<label for="address_line4" class="col-sm-3 control-label">Address line 4</label>
								<div class="col-sm-5">
									<input type="text" class="form-control address_fields" id="addressline4" name="addressline4" placeholder="Address line 2" data-parsley-maxlength="30" value="<?=$batchs['addressline4']?>" autocomplete="off" maxlength="30">
									<span class="error">
										<?php //echo form_error('addressline2');?>
									</span> </div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="contact_person_name" name="contact_person_name" placeholder="Contact Person Name" value="<?=$batchs['contact_person_name']?>" required  data-parsley-maxlength="30" autocomplete="off" maxlength="30">
									<span class="error">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control" id="name_of_bank" name="name_of_bank" placeholder="Name Of Bank" required value="<?=$batchs['name_of_bank']?>"  autocomplete="off" data-parsley-maxlength="30" maxlength="30">
									<span class="error">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<textarea style="width:100%; text-align:left;" name="remarks" id="remarks" class="control-label" data-parsley-maxlength="500" maxlength="500" ><?php echo $batchs['remarks'];?></textarea>
								</div>
							</div>
							...
							<div id="batch_online_users_outer" style="display:none;">
								<?php for($i=0; $i < 4; $i++)
									{	?>
									<input type="hidden" name="batch_online_user_ids[]" id="batch_online_user_ids" value="<?php if(isset($online_batch_user_details[$i]['user_id']) && $online_batch_user_details[$i]['user_id'] != "") { echo $online_batch_user_details[$i]['user_id']; } ?>">
									<div class="form-group">
										<label class="col-sm-3 control-label"><?php if($i == 0) { echo "User Details <span class='mandatory-field'>*</span>"; } else { echo "&nbsp"; }?></label>
										<div class="col-sm-3">
											<input type="text" class="form-control" id="batch_online_login_ids<?php echo $i; ?>" name="batch_online_login_ids[]" required="" value="<?php if(isset($online_batch_user_details[$i]['login_id']) && $online_batch_user_details[$i]['login_id'] != "") { echo $online_batch_user_details[$i]['login_id']; } ?>" autocomplete="off" maxlength="100" placeholder="Login ID *">
										</div>
										<div class="col-sm-3">
											<input type="password" class="form-control" id="batch_online_login_pass<?php echo $i; ?>" name="batch_online_login_pass[]" required="" value="<?php if(isset($online_batch_user_details[$i]['password']) && $online_batch_user_details[$i]['password'] != "") { echo base64_decode($online_batch_user_details[$i]['password']); } ?>" autocomplete="off" minlength="8" maxlength="100" placeholder="Password *">
										</div>
									</div>
								<?php } ?>
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="text" class="form-control" id="online_training_platform" name="online_training_platform" required="" value="<?php echo $batchs['online_training_platform']; ?>" autocomplete="off" maxlength="250" placeholder="Name of the on-line training platform used *">
          ...
          <!--.box-info-->
            ...
            <div class="box-body">
						...
						<div class="col-sm-2"> <a href="javascript:void(0);" id="new_captcha" >Change Image</a> <span class="error">
						<?php //echo form_error('code');?>
						</span> </div>
						</div>
            </div>
...
<script type="text/javascript">	
	...
	$(document).ready(function() {
      ...
      //alert(center_id);
			...
			//  $.ajax({
			//    url:'<?=base_url()?>iibfdra/TrainingBatches/getinspectorDetails',
			//    method: 'post',
			//    data: {center_id: center_id},
			//    dataType: 'json',
			//    success: function(response){
			...
			//        //alert(data2['inspector_name']);
			//         $('#inspector_id').append('<option value="'+data2['id']+'">'+data2['inspector_name']+'</option>');
			//      });
			//    }
			// });
		});
		...
		{
			if ($(this).val() < 10 ){
				$('span#error').text('No. of candidates are gretar than 10');
				$(this).val('10');
			}
