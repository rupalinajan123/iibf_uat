          ...
          <div class="box box-info">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6"> <?php echo $center_view[0]['faculty_name1'];?> 
                ...
                <a class="btn  btn-info btn-xs"  href="<?php echo base_url()?>uploads/iibfdra/agency_center/faculty_cv/<?php echo $center_view[0]['cv1'];?> " target="_blank"> View CV </a> </div>
            </div>
			<?php } ?>
            ...
            <?php if($center_view[0]['faculty_name2']=="" ){ } else{ ?>
             <div class="form-group">
              ...
              <?php echo"(". $center_view[0]['faculty_qualification2'].")";?>&nbsp; <a class="btn  btn-info btn-xs"  href="<?php echo base_url()?>uploads/iibfdra/agency_center/faculty_cv/<?php echo $center_view[0]['cv2'];?> " target="_blank"> View CV </a> </div>
            </div>
            <?php } ?>
    ...
    color: red;"><?php echo $center_reject_text[0]['rejection'];?> </strong> </div>
            ...
            <div class="box-footer">
              <div class="col-sm-6 col-sm-offset-3">
                <div class="col-sm-12">
                  <center>
                    <a class="btn btn-success" id="make_payment" name="make_payment" href="<?php echo base_url();?>iibfdra/CenterRenew/renew_temporary_center/<?php echo $center_view[0]['center_id'];?>">Make Payment</a>
                  </center>
                </div>
              </div>
            </div>
