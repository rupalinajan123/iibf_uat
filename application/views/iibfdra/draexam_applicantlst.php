<div class="content-wrapper">
	...
	<!-- Main content -->
    <form name="draexampay" class="draexampay" method="post" action="<?php echo base_url();?>iibfdra/DraExam/payment/<?php echo base64_encode($examcode);?>">
				...
				<div class="box">
            		<div class="box-header">
              			...
              			<div class="pull-right">
                            <a href="<?php echo base_url();?>iibfdra/DraExam/add/?exCd=<?php echo base64_encode($examcode);?>" class="btn btn-warning">Add New Application</a>
                             ...
                             <tbody class="no-bd-y" id="list">
								  ...
								  if(count($result)){
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        	<?php if( $row['pay_status'] == 0 || $row['pay_status'] == 2 ) { ?>
                                        	<a href="<?php echo base_url().'iibfdra/DraExam/edit/'.$row['mem_examid'];?>">Edit |</a><a href="<?php echo base_url().'iibfdra/DraExam/delete/'.$row['mem_examid'];?>" onclick="return confirm('Are you sure to delete this record?');">Delete </a>
                                            <?php }?>
                                        </td>
                                    </tr>
                                  <?php $i++; } } ?>                  
