...
if($regId != "")
{
  ...
  if (count($candidate_data) > 0) 
  {
    ...
    if($addressline1 != "")
    {
      redirect(site_url('iibfdra/TrainingBatches/candidate_list/'.base64_encode($bid)));
    }
  ...
  {
    redirect(site_url('iibfdra/TrainingBatches'));
  }
} ?>
          ...
          { ?>
            ...
            <div class="box box-info" id="basic_details_div">
              <div class="box-header with-border">
                ...
                <div class="pull-right"> <a href="<?php echo base_url(); ?>iibfdra/TrainingBatches/candidate_list/<?php echo base64_encode($bid); ?>" class="btn btn-warning">Back</a> </div>
              </div>
              <div class="box-body">
