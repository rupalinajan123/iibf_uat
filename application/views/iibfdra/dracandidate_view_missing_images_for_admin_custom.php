        ...
        <div class="col-md-12">
          <div class="box box-info">
            <div class="box-header with-border">
              ...
              <div class="pull-right"> <a href="<?php echo base_url();?>iibfdra/Candidate_list_missing_images_for_admin" class="btn btn-warning"> Back </a> </div>
            </div>
