 ...
 <?php 				
				...
				if(count($agency_batch_logs) > 0){
					...
					foreach($agency_batch_logs as $res_log){
						...
						if(isset($log_data['rejection'])){	
								...
								$rejection_reasion = '<span class="red">Reason: '.$log_data['rejection'].'</span>';
			...
			if($reject_action_date != '' && $result['batch_status'] == 'R'){
				//modified_on
      ...
      <div class="col-md-12">
        <div class="box box-info box-solid disabled">
          <div class="box-header with-border">
            <h3 class="box-title">Training Batch Basic Details</h3>
              ...
              <div class="table-responsive ">
                <table class="table table-bordered table-striped" style="word-wrap:anywhere; background:<?php echo $div_class; ?>;">
                  <tbody>
                    ...
                    <tr>
                        <td width="50%"><strong>Batch Name ( Batch Code):</strong></td>
                      	<td width="50%">
						<?php echo $result['batch_name']; ?> ( <?php echo $result['batch_code']; ?> ) 
                    ...
                    <tr>
                      ...
                      <td width="50%">
					<?php  if($result['first_faculty_name'] != '' && $result['first_faculty_qualification'] != '' ){
					   echo $result['first_faculty_name']; ?> ( <?php echo $result['first_faculty_qualification']; ?> )
                       <?php }else{ echo '--';} ?>
                       </td>
                    </tr>
                     ...
                     <tr>
                      ...
                      <td width="50%">
					<?php  if($result['sec_faculty_name'] != '' && $result['sec_faculty_qualification'] != '' ){
					   echo $result['sec_faculty_name']; ?> ( <?php echo $result['sec_faculty_qualification']; ?> )
                       <?php }else{ echo '--';} ?>
                       </td>
                    </tr>

                    <tr>
                      <td width="50%"><strong>Details of Additional Faculty I</strong></td>
                      <td width="50%">
					<?php  if($result['add_first_faculty_name'] != '' && $result['add_first_faculty_qualification'] != '' ){
					   echo $result['add_first_faculty_name']; ?> ( <?php echo $result['add_first_faculty_qualification']; ?> )
                       <?php }else{ echo '--';} ?>
                       </td>
                    </tr>
                    
                     <tr>
                      <td width="50%"><strong>Details of Additional Faculty II</strong></td>
                      <td width="50%">
					<?php  if($result['add_sec_faculty_name'] != '' && $result['add_sec_faculty_qualification'] != '' ){
					   echo $result['add_sec_faculty_name']; ?> ( <?php echo $result['add_sec_faculty_qualification']; ?> )
                       <?php }else{ echo '--';} ?>
                       </td>
                    </tr>
                    ...
                    <tr>
                      <td width="50%"><strong>Contact Number of the Coordinator :</strong></td>
                    ...
                    <tr>
                      <td width="50%"><strong>Contact Number of the Contact Person :</strong></td>
                    ...
                    <tr>
                      ...
                      <td width="50%"><?php if( $result['batch_type'] != '' )	{?>
                        <?php  echo ($result['batch_type'] == 'S') ? 'Separate Batch' : "Combine Batch";  ?>
                       (  <?php  echo ($result['hours']) ? $result['hours'] : "0";  ?> hrs )
                         <?php }else{ echo '--';} ?></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td width="50%"><?php if( $result['holidays'] != '' )	{ echo $result['holidays']; }?>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td width="50%"><?php if( $result['brk_time1'] != '' )	{?>
                        <?php echo $result['brk_time1'].'mins, '.$result['brk_time2'].'mins, '.$result['brk_time3'].'mins';} ?></td>
                    </tr>

                    <tr>
				      <td width="50%"><strong>GROSS TIME :</strong></td>
				      <td width="50%"><?php echo $result['gross_time']; ?></td>
				    </tr>
				    
				    <tr>
				      <td width="50%"><strong>NET TIME :</strong></td>
				      <td width="50%"><?php echo $result['net_time']; ?></td>
				    </tr>

                    <tr>
                      <td width="50%"><strong>Total No Of Candidates :</strong></td>
                      <td width="50%"><?php if( $result['total_candidates'] != '' )	{?>
                        <?php echo $result['total_candidates'].' (Under Graduates:'.$result['under_graduate_candidates'].', Graduates:'.$result['graduate_candidates'].')'; } ?></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td width="50%" > &nbsp; <?php if($result['inspector_report'] != ''){ 
					    echo '<a class="btn btn-info btn-xs vbtn" target="_blank" href="'.base_url().'uploads/iibfdra/inspector_report/'.$result['inspector_report'].'"> &nbsp; &nbsp;View Inspection Report &nbsp;<i class="fa fa fa-file"></i> &nbsp; &nbsp;</a>  &nbsp; &nbsp;';
...
$(function () {
	...
	$('.submit_report').click(function(e){
		...
		if($.inArray(ext,['pdf','doc','docx','jpg','png','jpeg','txt']) == -1) {
