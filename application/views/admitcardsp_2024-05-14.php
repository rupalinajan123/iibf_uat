...
<html lang="en">
  ...
  <body style="background-color:#fff; margin:0 auto; padding:0; font-family:Arial, Helvetica, sans-serif; font-size:14px;">
            ...
            <tr>
              <td style="border:1px solid #1287c0; padding:5px;">
                <table cellpadding="0" cellspacing="0" width="100%" border="0" align="center">
                  <tr>
                    <td align="center">
                      <img src="<?php echo base_url();?>assets/images/logo.jpg" width="400" height="66" /> <sup style="position: relative;right: 3px;top: -30px;">®</sup> 
                    ...
                    <td style="background-color:#1287c0; color:#fff; text-align:center; font-weight:bold; font-size:14px; padding:10px 0;"><?php
                      ...
                      if(!in_array($exam_code,$caiib))
                      {
                        ...
                        { ?>
                          ...
                          <?php //echo $exam_name;?>
                          <?php 
                          if($exam_code == '20' && $idate == '29-Oct-17')
                          { 
                          ...
                          if($exam_code != 101 && $exam_code != 1037 && $exam_code != 1038) { echo "Examination"; }?>
                          - <?php echo $examdate;?>
                        <?php } 
                      }
                      ...
                      <div align="right"> <a href="<?php echo base_url();?>admitcard/getadmitdashboard">Home</a> &nbsp; <a href="<?php echo base_url();?>admitcard/getadmitcardpdfsp/<?php echo base64_encode($exam_code)?>" style="color:#F00">Save as pdf</a>&nbsp; 
                        
                      <!--<a href="javascript:void(0);" onclick="javascript:printDiv();" style="color:#F00">Print</a>-->&nbsp; <a href="<?php echo base_url()?>admitcard/logout" style="color:#F00">Logout</a> </div></td>
                  </tr>
                  <tr>
                    <td height="5"></td>
                  </tr>
                        ...
                        <tr>
                          <td style="padding:0 10px;"><table cellpadding="0" cellspacing="0" width="100%" border="0" style="border-left:1px solid #fff; border-top:1px solid #fff;">
                            ...
                            <td style="border-bottom:1px solid #fff; border-right:1px solid #fff; padding:7px; text-transform:uppercase;"><?php if($record->mem_adr_1 != ''){?>
                              ...
                              <?php }?>
                              <?php if($record->mem_adr_6 != '' && ($record->mem_adr_6 != $record->mem_adr_5)){?>
                              <?php echo str_replace(";","",$record->mem_adr_6)."<br/> ";?>
                              <?php }?>
                    ...
                    <td style="text-align:right; line-height:24px; font-size:13px;">
                      <div style="color:red;">                      
                        **(Refer display board at Test Venue)<br>
                        <?php if($exam_code!=34 && $exam_code!=160 && $exam_code!=58)
                        { ?>
                        ...
                        { ?>
                          <div style="float:left">
                            ...
                            if($exam_code == 101)
                            {
                              echo '# Pass mark for BC/BF Examination is 40';
                            }
                            else if($exam_code == 1037)
                            {
                              echo 'Pass mark for BC/BF Examination (Advanced) is 50';
                            }
                            else if( $exam_code == 1038)
                            {
                  ...
                  <tr>
                    <td>
                      <table cellpadding="0" cellspacing="0" border="0" width="100%" style="border-top:1px solid #198cc3; border-left:1px solid #198cc3;">
                        ...
                        <td style="text-align:left; padding:7px; border-bottom:1px solid #198cc3; border-right:1px solid #198cc3; text-transform:uppercase;"><?php echo $records->venueadd1;?> <?php echo $records->venueadd2;?>
                                <?php 
                  ...
                  <tr>
                    <td>
                      <?php if($exam_code == 101 || $exam_code == 1037 || $exam_code == 1038 || $exam_code == 1010 || $exam_code == 10100 || $exam_code == 101000 || $exam_code == 1010000 || $exam_code == 10100000)
                      { ?>
                      ...
                      if($exam_code != 101 && $exam_code != 1037 && $exam_code != 1038 && $exam_code != 1010 & $exam_code != 10100 & $exam_code != 101000 & $exam_code != 1010000 & $exam_code != 10100000)
                      {
                        if($vcenter == 3)
                        { ?>
                  ...
                  <tr>
                    <td width="100%"><table cellpadding="0" cellspacing="0" width="100%" border="0" style="border-top:1px solid #198cc3; border-left:1px solid #198cc3;">
                      ...
                      <tbody>
                        ...
                        <?php if(($exam_code == 1037 || $exam_code == 1038) && $disp_unique_no != "")
                        { ?>
                          <tr style="background-color:#dcf1fc;">
                        ...
                        { $date = date_create($date); $created = date_format($date,"dmYHis"); ?>
                      <tr style="background-color:#dcf1fc;">
    ...
    <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
    <?php if($exam_code !=101 && $exam_code !=1037 && $exam_code !=1038 && $exam_code !=996)
    {
      if($exam_period == 915 )
      { ?>        
    ...
    elseif($exam_code == 101 || $exam_code == 1037 || $exam_code == 1038 || $exam_code == 1010)
    { ?>
      <table cellpadding="0" cellspacing="0" width="800" border="0" align="center" style="background-color:#fff;">
        <tr>
          <td style="background-color:#7fd1ea; color:#fff; text-align:center; font-weight:bold; font-size:13px; padding:7px 0; text-transform:uppercase;">IMPORTANT INSTRUCTIONS FOR CANDIDATES</td>
    ...
    <div class="content-wrapper" id="print_div" style="display: none;">
            ...
            <table cellpadding="0" cellspacing="0" width="100%" border="0" align="center">
              <tr>
                <td style="border:1px solid #1287c0; padding:5px;"><table cellpadding="0" cellspacing="0" width="100%" border="0" align="center">
                  ...
                  <tr>
                    <td style="background-color:#1287c0; color:#fff; text-align:center; font-weight:bold; font-size:14px; padding:10px 0;">
                      ...
                      if(!in_array($exam_code,$caiib))
                      {
                        if($exam_code == 101 || $exam_code == 1037 || $exam_code == 1038)
                        {
                          echo "Admit Letter for Online CERTIFICATE EXAMINATION FOR BUSINESS CORRESPONDENTS/FACILITATORS - DEC 2017";
                        }
                        else
                        { ?>
                          Admit Letter for <?php echo $record->mode;
                        ...
                        <tr>
                          <td style="padding:0 10px;">
                            <table cellpadding="0" cellspacing="0" width="100%" border="0" style="border-left:1px solid #fff; border-top:1px solid #fff;">
                              ...
                              <tr>
                                <td style="border-bottom:1px solid #fff; border-right:1px solid #fff; padding:7px; text-transform:uppercase; font-weight:bold;"><?php echo $record->mam_nam_1;?></td>
                              </tr>
                              <tr>
                                <td style="border-bottom:1px solid #fff; border-right:1px solid #fff; padding:7px; text-transform:uppercase;">
                                  ...
                                  {
                                    echo $record->mem_adr_1."<br/> ";
                                  }
                                  if($record->mem_adr_2 != '')
                                  {
                                    echo $record->mem_adr_2."<br/> ";
                                  }
                                  if($record->mem_adr_3 != '' && ($record->mem_adr_3 != $record->mem_adr_2))
                                  {
                                    echo $record->mem_adr_3."<br/>";
                                  }
                                  if($record->mem_adr_4 != '' && ($record->mem_adr_4 != $record->mem_adr_3))
                                  {
                                    echo str_replace(";","",$record->mem_adr_4)."<br/> ";
                                  }
                                  if($record->mem_adr_5 != '' && ($record->mem_adr_5 != $record->mem_adr_4))
                                  {
                                    echo str_replace(";","",$record->mem_adr_5)."<br/> ";
                                  }
                                  
                                  if($record->mem_pin_cd != '' && strlen($record->mem_pin_cd) == 6)
                                  {
                                    echo "Pincode: ". str_replace(";","",$record->mem_pin_cd)."<br/>";?>
                                  <?php }?>
                                </td>
                              </tr>
                              <tr>
                          ...
                          <td align="center">
                            <table cellpadding="0" cellspacing="0" border="0">
                              ...
                              <tr>
                                <td><img src="<?php echo base_url();?><?php echo get_img_name($mid,'s');?>" width="100" height="50" /></td>
                              </tr>
                            </table>
                          </td>
                        </tr>
                  ...
                  <tr>
                    <td style="text-align:right; line-height:24px; font-size:13px;"> **(Refer display board at Test Venue)<br/>
                      <?php if($exam_code!=34 && $exam_code!=160 && $exam_code!=58){?>
                        @ Refer Reporting Time in the Important Instructions
                      <?php }?></td>
                  </tr>
      ...
      <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
      <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
      <?php if($exam_code !=101 && $exam_code !=1037 && $exam_code !=1038)
      {
        if($exam_code !=34 && $exam_code !=160 && $exam_code !=58 && $exam_code !=81 && $exam_code !=59 && $exam_code !=20 )
        { ?>
          <table cellpadding="0" cellspacing="0" width="800" border="0" align="center" style="background-color:#fff;">
            <tr>
              <td style="background-color:#7fd1ea; color:#fff; text-align:center; font-weight:bold; font-size:13px; padding:7px 0; text-transform:uppercase;">IMPORTANT INSTRUCTIONS FOR CANDIDATES</td>
              ...
              <td style="background-color:#dcf1fc; padding:7px 0; border:1px solid #1287c0;"><table cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                  <td colspan="2" style="padding-left:30px;"><table cellpadding="0" cellspacing="0" border="0">
                    ...
                    <tr>
                      <td width="2%" valign="top" style="font-size:13px;">l.</td>
                      <td style="font-size:13px;">l.	For all Examinations printed result advices (original as well as duplicate) will not be issued but the same will be available on the Institute's website www.iibf.org.in in printable form once the results are declared. Candidates are requested to download the same. </td>
                    </tr>
                    <tr>
                      <td width="2%" valign="top" style="font-size:13px;">&nbsp;</td>
        ...
        <?php }
        if($exam_code == 20 || $exam_code == 34 || $exam_code == 58|| $exam_code == 59|| $exam_code == 81)
        { ?>
          <table cellpadding="0" cellspacing="0" width="800" border="0" align="center" style="background-color:#fff;">
            <tr>
              <td style="background-color:#7fd1ea; color:#fff; text-align:center; font-weight:bold; font-size:13px; padding:7px 0; text-transform:uppercase;">IMPORTANT INSTRUCTIONS FOR CANDIDATES</td>
      ...
      elseif($exam_code ==101 || $exam_code ==1037 || $exam_code ==1038)
      {?>
        <table cellpadding="0" cellspacing="0" width="800" border="0" align="center" style="background-color:#fff;">
          <tr>
            <td style="background-color:#7fd1ea; color:#fff; text-align:center; font-weight:bold; font-size:13px; padding:7px 0; text-transform:uppercase;">IMPORTANT INSTRUCTIONS FOR CANDIDATES</td>
