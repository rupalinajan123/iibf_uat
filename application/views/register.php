				...
				<div class="col-md-12">
					...
					<div class="box box-info">
						...
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control txtuppercase" id="middlename" onchange="createfullname()" onkeyup="createfullname(); convertToUppercaseText(this); validateTotalNameLength();" onblur="createfullname()" name="middlename" placeholder="Middle Name" value="<?php echo set_value('middlename'); ?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" maxlength="30">
									<span class="error">
							...
							<div class="form-group">
								...
								<div class="col-sm-5">
									<input type="text" class="form-control txtuppercase" id="lastname" onchange="createfullname()" onkeyup="createfullname(); convertToUppercaseText(this); validateTotalNameLength();" onblur="createfullname()" name="lastname" placeholder="Last Name" value="<?php echo set_value('lastname'); ?>" data-parsley-pattern="/^[a-zA-Z][a-zA-Z ]+$/" data-parsley-maxlength="30" maxlength="30">
					...
					<div class="box box-info">
						...
						<div class="box-body">
							...
							<div class="form-group">
								<label for="roleid" class="col-sm-4 control-label">Aadhar Card Number <span style="color:#F00">*</span></label><!--<span style="color:#F00" id="mendatory_state">-->
									<?php //echo $star;
									?>
									</span></label>
								<div class="col-sm-5">
