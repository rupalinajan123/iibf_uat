...
class Dokan_Seller_Setup_Wizard extends Dokan_Setup_Wizard {
            ...
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="hidden" name="show_email" id="show_email" class="input-checkbox" value="0">
                    </td>
                </tr>
                <!--<tr>
                    <th scope="row"><label for="show_email"><?php _e( 'Email', 'dokan-lite' ); ?></label></th>
                    <td>
                        <input type="hidden" name="show_email" id="show_email" class="input-checkbox" value="0" <?php echo ( $show_email == 'yes' ) ? 'checked="checked"' : ''; ?>/>
    ...
    public function dokan_setup_payment() {
        ...
        <form method="post">
            ...
            <!-- Code start by neeraj -->
            
            <table class="form-table">
                                    <tbody><tr>
                        <th scope="row"><label>Bank Transfer</label></th>
                        <td>
                                <div class="dokan-form-group">
        <div class="dokan-w8">
            <input type="text" placeholder="Your bank account name" class="dokan-form-control" value="" name="settings[bank][ac_name]">
        </div>
    </div>

    <div class="dokan-form-group">
        <div class="dokan-w8">
            <input type="text" placeholder="Your bank account number" class="dokan-form-control" value="" name="settings[bank][ac_number]">
        </div>
    </div>

    <div class="dokan-form-group">
        <div class="dokan-w8">
            <input type="text" placeholder="Name of bank" class="dokan-form-control" value="" name="settings[bank][bank_name]">
        </div>
    </div>

    <div class="dokan-form-group">
        <div class="dokan-w8">
            <textarea placeholder="Address of your bank" class="dokan-form-control" name="settings[bank][bank_addr]"></textarea>
        </div>
    </div>

    <div class="dokan-form-group">
        <div class="dokan-w8">
            <input type="text" placeholder="IFSC Code" class="dokan-form-control" value="" name="settings[bank][ifsc_code]">
        </div>
    </div>

    <div class="dokan-form-group">
        <div class="dokan-w8">
            <input type="text" placeholder="Micro Code" class="dokan-form-control" value="" name="settings[bank][micro_code]">
        </div>
    </div>

    <div class="dokan-form-group">
        <div class="dokan-w8">
            <input type="text" placeholder="GST No." class="dokan-form-control" name="settings[bank][gstno]" value="">
        </div>
    </div> 
     <div class="dokan-form-group">
        <div class="dokan-w8">
            <input type="text" placeholder="HSN code" class="dokan-form-control" name="settings[bank][swift]" value="">
        </div>
    </div> 
    ...
    public function dokan_setup_payment_save() {
        ...
        if ( isset( $_POST['settings']['bank'] ) ) {
            ...
            $dokan_settings['payment']['bank'] = array(
                ...
                'ifsc_code' => sanitize_text_field( $bank['ifsc_code'] ),
                'micro_code'           => sanitize_text_field( $bank['micro_code'] ),
