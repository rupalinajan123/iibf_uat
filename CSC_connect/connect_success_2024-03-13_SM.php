...
//			CURLOPT_POSTFIELDS => $post
    ...
    if(isset($_SERVER['HTTPS']) && !empty($_SERVER['HTTPS']) && $_SERVER['HTTPS'] != 'off') { $produrl = 'https://'.$_SERVER['HTTP_HOST']; }
		else { $produrl = 'http://'.$_SERVER['HTTP_HOST']; }
		header('location:'.$produrl.'/WalletRedirect/wallet/'.$csc_id	);
	}
