...
//			CURLOPT_CUSTOMREQUEST => 'PUT',
    ...
    if($bridgeResponseMessage){
        $c = @$this->bridgePG->decrypt_wallet_message($bridgeResponseMessage, $d, FALSE);
        if(!$c)
...
public function encrypt($message_text){
    ...
    return $this->bridgePG->encrypt_message_for_wallet($message_text, FALSE);
