...
$("#draExamAddFrm #reg_no").on("focusout", function() {
	...
	$( "#qualicertificate" ).change(function() {
		...
		if(dob_proof_image.value!=""&&  ext3!='jpg' && ext3!='JPG')
		{
			...
			document.getElementById('error_qualicert').innerHTML="Upload JPG or jpg file only.";
			setTimeout(function(){
		...
		else  if(filesize1 || filesize2)
		 {
			...
			document.getElementById('error_qualicert_size').innerHTML="File size should be minimum 50KB and maximum 100KB.";
			setTimeout(function(){
	...
	$( "#trainingcertificate" ).change(function() {
		...
		if(dob_proof_image.value!=""&&  ext3!='jpg' && ext3!='JPG')
		{
			...
			document.getElementById('error_trainingcert').innerHTML="Upload JPG or jpg file only.";
			setTimeout(function(){
	...
	$( "#utr_slip" ).change(function() {
		...
		if(dob_proof_image.value!=""&&  ext3!='jpg' && ext3!='JPG')
		{
			...
			document.getElementById('error_utrslip').innerHTML="Upload JPG or jpg file only.";
			setTimeout(function(){
