$(document).ready(function() {
  ...
  //##------------ check valid pin for address--------------------##
		...
		window.Parsley.addValidator('check_mobile', function (value, requirement) {
			var response = false;
			var msg='';
				var datastring='mobile_no='+value;   
				$.ajax({
				url:site_url+'Amp/mobileduplication/',
				data: datastring,
				type:'POST',
				dataType:'json',
				async: false,
		...
		.addMessage('en','check_mobile','The Mobile number already exists.');
		
		//##------------ Email NO validation -----------------------##
		window.Parsley.addValidator('check_email', function (value, requirement) {
			var response = false;
			var msg='';
				var datastring='email_id='+value;   
				$.ajax({
				url:site_url+'Amp/emailduplication/',
				data: datastring,
				type:'POST',
				dataType:'json',
				async: false,
		...
		.addMessage('en','check_email','The Email already exists.');
