...
/*	function valCentre(cCode)
	...
	*/
	...
	function DBvalCentre(cCode)
	{
		...
		if(cCode!='')
		{
				var datastring='centerCode='+cCode+'&eprid='+eprid+'&excd='+excd+'&grp_code='+grp_code+'&mtype='+mtype+'&mou_code='+mou_code;
			
				$.ajax({
								url:site_url+'Bulk_fee/DBgetFee/',
								data: datastring,
								type:'POST',
								async: false,
								success: function(data) {
								 if(data)
								{
									...
									document.getElementById('fee').value = fee_amt+' +GST as applicable' ;
									document.getElementById('html_fee_id').innerHTML =fee_amt+' +GST as applicable';
								}
							}
						});
