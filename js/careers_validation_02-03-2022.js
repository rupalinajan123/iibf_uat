 	...
 	function checkform()
 	{
		...
		else
		{
			if(dob < '1993-06-30')
			{
				...
				$("#dob_error").html('The maximum age limit to apply is 28 years as on 30.06.2021');
				flag = false;
			}	
			else { $("#dob_error").html(''); }
		}
		...
		{
			if(assistant_director_it_dob < '1981-07-31')
			{
				//alert('The maximum age limit to apply is 28 years as on 01-07-2021');
				$("#assistant_director_it_dob_error").html('The maximum age limit to apply is 40 years as on 31.07.2021');
				flag = false;
			}	
			else { $("#assistant_director_it_dob_error").html(''); }
		}
		...
		{
			if(faculty_member_dob < '1959-07-31') 
			{
				$("#faculty_member_dob_error").html('The minimum age limit to apply is 50 years as on 31.07.2021');
				flag = false;
			}
			else if(faculty_member_dob > '1971-07-31') 
			{
				$("#faculty_member_dob_error").html('The maximum age limit to apply is 62 years as on 31.07.2021');
				flag = false;
			}	
			else { $("#faculty_member_dob_error").html(''); }
		}
