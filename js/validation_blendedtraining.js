 	...
 	function blendedcheckform()
	{
		...
		{
			$.ajax({
				url: site_url+'BlendedTraining/ajax_check_captcha_code',
				type: 'post',
				data:'code='+code,
				async: false,
...
function resetFields(program_code)
{
	...
	if(program_code != "")
	{
		...
		$.ajax({
			type:"POST",
			url: site_url+"BlendedTraining/getTrainingType",
...
function getDates(training_type)
{
	...
	$.ajax({
		type:"POST",
		url: site_url+"BlendedTraining/getdates",
...
function getFees()
{
	...
	$.ajax({
		type:"POST",
		url: site_url+"BlendedTraining/getFees",
...
function getCenters()
{
	...
	if(program_code != "" && batch_code != "")
	{
		$.ajax({
		type:"POST",
		url: site_url+"BlendedTraining/getCenters",
...
function getVenue(center_code)
{
	...
	if(center_code != '' && batch_code != '')
	{
			$.ajax({
			type:"POST",
			url: site_url+"BlendedTraining/getVenue",
